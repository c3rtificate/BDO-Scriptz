...
function Customization_BodyBoneInfo:InitEvent()
  ...
  if _ContentsOption_CH_TatooCheck == true then
    self._ui._slider_ScaleX:addInputEvent("Mouse_LPress", "PaGlobalFunc_Customization_BodyBone_CheckAndUpdateBodyBoneScale()")
    self._ui._slider_ScaleY:addInputEvent("Mouse_LPress", "PaGlobalFunc_Customization_BodyBone_CheckAndUpdateBodyBoneScale()")
    self._ui._slider_ScaleZ:addInputEvent("Mouse_LPress", "PaGlobalFunc_Customization_BodyBone_CheckAndUpdateBodyBoneScale()")
  else
...
function PaGlobalFunc_Customization_BodyBone_CheckAndUpdateBodyBoneScale()
  if _ContentsOption_CH_TatooCheck == true and ToClient_isSelectedBonePickingBanned() == true then
    return
  end
  PaGlobalFunc_Customization_BodyBone_UpdateBodyBoneScale()
end
