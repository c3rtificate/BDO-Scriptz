...
function PaGlobal_CustomizationIsEditable(isEditable, authorUserNo)
  ...
  if false == isEditable and selfplayerUserNo == authorUserNo then
    setShow = true
  end
  ...
  if false == _ContentsGroup_isConsolePadControl then
    ...
    mainButtonInfo[custiomizingIdx].line:SetShow(setShow)
    mainButtonInfo[custiomizingIdx].point:SetShow(setShow)
    mainButtonInfo[custiomizingIdx].tree:SetShow(setShow)
    mainButtonInfo[custiomizingIdx].smallPoint:SetShow(setShow)
    mainButtonInfo[custiomizingIdx].static:SetShow(setShow)
    mainButtonInfo[custiomizingIdx].staticText:SetShow(setShow)
  else
  end
end
