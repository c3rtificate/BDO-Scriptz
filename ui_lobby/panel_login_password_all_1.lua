function PaGlobal_LoginPassword_All:initialize()
  ...
  self._ui._stc_KeyGuideBg = UI.getChildControl(Panel_Login_Password_All, "Static_KeyGuide")
  self._ui._stc_KeyGuideB = UI.getChildControl(self._ui._stc_KeyGuideBg, "StaticText_BButton")
  self._ui._stc_KeyGuideY = UI.getChildControl(self._ui._stc_KeyGuideBg, "StaticText_YButton")
...
function PaGlobal_LoginPassword_All:registEventHandler()
  ...
  if true == _ContentsGroup_RenewUI then
    self._ui._btn_backImport:registerPadEvent(__eConsoleUIPadEvent_Up_A, "HandleEventLUp_LoginPassword_All_Back()")
    self._ui._btn_clearImport:registerPadEvent(__eConsoleUIPadEvent_Up_A, "HandleEventLUp_LoginPassword_All_Clear()")
    self._ui._btn_applyImport:registerPadEvent(__eConsoleUIPadEvent_Up_A, "HandleEventLUp_LoginPassword_All_Apply()")
    self._ui._btn_cancelImport:registerPadEvent(__eConsoleUIPadEvent_Up_A, "HandleEventLUp_LoginPassword_All_Cancel()")
    self._ui._chk_showNum:registerPadEvent(__eConsoleUIPadEvent_Up_A, "HandleEventLUp_LoginPassword_All_ShowNum()")
  else
...
function PaGlobal_LoginPassword_All:prepareOpen(isCreatePassword)
  ...
  PaGlobal_LoginPassword_All:CheckAndSwitchPadUI()
end
...
function PaGlobal_LoginPassword_All:CheckAndSwitchPadUI()
  if nil == Panel_Login_Password_All then
    return
  end
  if false == Panel_Login_Password_All:GetShow() then
    return
  end
  local consoleKeyGuides = {
    self._ui._stc_KeyGuideB,
    self._ui._stc_KeyGuideY
  }
  if false == ToClient_isUsePadSnapping() then
    self._ui._btn_applyImport:SetShow(true)
    self._ui._btn_cancelImport:SetShow(true)
    ...
    self._ui._btn_applyImport:SetShow(false)
    self._ui._btn_cancelImport:SetShow(false)
    self._ui._stc_KeyGuideBg:SetShow(true)
    self._ui._stc_KeyGuideB:SetShow(true)
    self._ui._stc_KeyGuideY:SetShow(true)
    Panel_TermsofGameUse:registerPadEvent(__eConsoleUIPadEvent_Up_Y, "HandleEventLUp_LoginPassword_All_Apply()")
    Panel_TermsofGameUse:registerPadEvent(__eConsoleUIPadEvent_Up_B, "HandleEventLUp_LoginPassword_All_Cancel()")
