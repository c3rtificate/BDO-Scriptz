...
function PaGlobal_LoginNickname_All:registEventHandler()
  ...
  registerEvent("FromClient_LoginNickname_All_SetRecommandNickName", "FromClient_LoginNickname_All_SetRecommandNickName")
...
function PaGlobal_LoginNickname_All:prepareOpen(clearStr)
  ...
  ToClient_GetRecommandNickName()
  self._ui.edit_Nickname:SetEditText("")
  self._ui.edit_Nickname:SetMaxInput(getGameServiceTypeUserNickNameLength())
  if nil ~= PaGlobal_Login_All then
    PaGlobal_Login_All._ui._btn_login:SetAutoDisableTime(5)
    PaGlobal_Login_All._ui._btn_login:DoAutoDisableTime()
  end
end
...
function PaGlobal_LoginNickname_All:setRecommandNickName(recommandNickName)
  if nil == self._ui.edit_Nickname then
    return
  end
  self._ui.edit_Nickname:SetEditText(recommandNickName)
end
