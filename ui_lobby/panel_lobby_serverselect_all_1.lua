function PaGlobal_ServerSelect_All:initialize()
  ...
  self._ui._stc_channelDesc[self._CHANNEL_TYPE.SEASON_NEWBIE_CHANNEL] = UI.getChildControl(self._ui._stc_leftBg, "SEASON_NEWBIE_CHANNEL")
  self._ui._stc_channelDesc[self._CHANNEL_TYPE.HADUM] = UI.getChildControl(self._ui._stc_leftBg, "HADUM_CHANNEL")
  self._ui._stc_channelDesc[self._CHANNEL_TYPE.GUILD_MAINCHANNEL] = UI.getChildControl(self._ui._stc_leftBg, "HADUM_CHANNEL")
  self._ui._stc_channelDesc[self._CHANNEL_TYPE.ELFWAR] = UI.getChildControl(self._ui._stc_leftBg, "ELFWAR_INFO")
  self._ui._stc_channelDesc[self._CHANNEL_TYPE.HARDCORE_CHANNEL] = UI.getChildControl(self._ui._stc_leftBg, "HARDCORECHANNEL_INFO")
  local elfWarTitle = UI.getChildControl(self._ui._stc_channelDesc[self._CHANNEL_TYPE.ELFWAR], "StaticText_Title")
  local elfWarDesc = UI.getChildControl(self._ui._stc_channelDesc[self._CHANNEL_TYPE.ELFWAR], "StaticText_Desc")
  elfWarTitle:SetTextMode(__eTextMode_AutoWrap)
  elfWarTitle:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_ELFWARCHANNEL_SUB_TITLE"))
  elfWarDesc:SetTextMode(__eTextMode_AutoWrap)
  elfWarDesc:SetText([[


]] .. PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_ELFWARCHANNEL_SUB_DESC") .. "\n" .. PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_ELFWARCHANNEL_DATE_SUB_TITLE") .. "\n" .. PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_ELFWARCHANNEL_DATE_SUB_DESC"))
  ...
  self._ui._console._txt_backKey:SetShow(_ContentsGroup_RenewUI)
  ...
  if true == _ContentsGroup_SeasonContents then
    ...
    self:updateChannelDesc(PaGlobal_ServerSelect_All._CHANNEL_TYPE.SEASON_NEWBIE_CHANNEL)
  end
  ...
  self._ui._stc_channelDesc[PaGlobal_ServerSelect_All._CHANNEL_TYPE.SEASON_NEWBIE_CHANNEL]:SetShow(false)
  self._ui._stc_channelDesc[PaGlobal_ServerSelect_All._CHANNEL_TYPE.HADUM]:SetShow(false)
  self:updateChannelDesc(PaGlobal_ServerSelect_All._CHANNEL_TYPE.HADUM)
  self._ui._stc_channelDesc[PaGlobal_ServerSelect_All._CHANNEL_TYPE.HADUM]:SetShow(false)
  ...
  if ToClient_isConsole() == true and ToClient_IsContentsGroupOpen("7") == true then
    self._movieOrder = {
      1,
      2,
      3
  ...
  if true == _ContentsGroup_DracaniaAwaken then
    self._movieURL = {}
    if true == ToClient_isConsole() then
      self._movieLength = {9000, 9000}
    else
    ...
    self._moviePath = {
      "UI_Movie/PC/Loading/Login/login_01.bk2",
      "UI_Movie/PC/Loading/Login/login_02.bk2",
      "UI_Movie/PC/Loading/Login/login_03.bk2",
      "UI_Movie/PC/Loading/Login/login_04.bk2",
      "UI_Movie/PC/Loading/Login/login_05.bk2",
      "UI_Movie/PC/Loading/Login/login_06.bk2",
      "UI_Movie/PC/Loading/Login/login_07.bk2"
    }
    self._movieURL = {
      "coui://UI_Movie/CS/Loading/Login/login_01.webm",
      "coui://UI_Movie/CS/Loading/Login/login_02.webm",
      "coui://UI_Movie/CS/Loading/Login/login_03.webm",
      "coui://UI_Movie/CS/Loading/Login/login_04.webm",
      "coui://UI_Movie/CS/Loading/Login/login_05.webm",
      "coui://UI_Movie/CS/Loading/Login/login_06.webm",
      "coui://UI_Movie/CS/Loading/Login/login_07.webm"
    }
    self._movieOrder = {
      1,
      2,
  ...
  if true == _ContentsGroup_MorningLand then
    self._movieURL = {
      "coui://UI_Movie/CS/Loading/Join/bukgol.webm",
      "coui://UI_Movie/CS/Loading/Join/dokev.webm",
      "coui://UI_Movie/CS/Loading/Join/island.webm",
      "coui://UI_Movie/CS/Loading/Join/nampo.webm"
    }
    if true == ToClient_isConsole() then
      self._movieLength = {9000, 9000}
    else
    ...
    self._moviePath = {
      "UI_Movie/PC/Loading/MorningLand/login_01.bk2",
      "UI_Movie/PC/Loading/MorningLand/login_02.bk2",
      "UI_Movie/PC/Loading/MorningLand/login_03.bk2",
      "UI_Movie/PC/Loading/MorningLand/login_04.bk2"
    }
    self._movieOrder = {
      1,
      2,
  ...
  if true == _ContentsGroup_DragonPalaceOpen then
    self._movieURL = {}
    if true == ToClient_isConsole() then
      self._movieLength = {9000, 9000}
    else
    ...
    self._moviePath = {
      "UI_Movie/YongGoong_01.bk2",
      "UI_Movie/YongGoong_02.bk2",
      "UI_Movie/YongGoong_03.bk2"
    }
    self._movieOrder = {
      1,
      2,
  ...
  if isGameServiceTypeConsole() == false then
    ...
    self._moviePath = {
      "UI_Movie/PC/Loading/Login/login_08.bk2",
      "UI_Movie/PC/Loading/Login/login_09.bk2",
      "UI_Movie/PC/Loading/Login/login_10.bk2"
    }
    self._movieOrder = {
      1,
      2,
    ...
    self._movieURL = {
      "coui://UI_Movie/CS/Loading/Join/login_08.webm",
      "coui://UI_Movie/CS/Loading/Join/login_09.webm",
      "coui://UI_Movie/CS/Loading/Join/login_10.webm"
    }
    if true == ToClient_isConsole() then
      self._movieLength = {9000, 9000}
    else
  ...
  if _ContentsGroup_MorningLand2 == true then
    ...
    self._moviePath = {
      "UI_Movie/PC/Loading/Login/login.bk2"
    }
    self._movieOrder = {1}
  end
...
function PaGlobal_ServerSelect_All:initDesriptionData()
  ...
  self._channelDescriptionData = {
    ...
    [self._CHANNEL_TYPE.SEASON_NEWBIE_CHANNEL] = {
      title = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_SEASONNEWBIE"),
      desc = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_SEASONNEWBIE_DESC")
    },
    [self._CHANNEL_TYPE.HADUM] = {
      title = PAGetString(Defines.StringSheet_GAME, "LUA_SERVERSELECT_HADUM_TITLE"),
      desc = PAGetString(Defines.StringSheet_GAME, "LUA_SERVERSELECT_HADUM_DESC_SIMPLE")
    }
  }
  if _ContentsGroup_HadumCalpheon == true then
    self._channelDescriptionData[self._CHANNEL_TYPE.HADUM].desc = PAGetString(Defines.StringSheet_GAME, "LUA_SERVERSELECT_HADUM_DESC_SIMPLE_CAL")
  end
  if true == self._isConsole then
...
function PaGlobal_ServerSelect_All:prepareOpen()
  ...
  PaGlobal_ServerSelect_All:CheckAndSwitchPadUI()
end
function PaGlobal_ServerSelect_All:CheckAndSwitchPadUI()
  if nil == Panel_Lobby_ServerSelect_All then
    return
  end
  if false == Panel_Lobby_ServerSelect_All:GetShow() then
    return
  end
  ...
  if false == _ContentsGroup_RenewUI and true == _ContentsGroup_UsePadSnapping and false == ToClient_IsPadContollerForPC() then
    for k, value in pairs(self._ui._pc) do
      value:SetShow(true)
    end
    for k, value in pairs(self._ui._console) do
...
function PaGlobal_ServerSelect_All:updateChannelDesc(channelType, subChannelType)
  ...
  elseif channelType == self._CHANNEL_TYPE.ARSHA_CHANNEL then
    ...
    if subChannelType == 2 then
      txt_desc:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_PVPDESC834"))
    end
  ...
  elseif channelType == self._CHANNEL_TYPE.SEASON_NEWBIE_CHANNEL then
    if true == _ContentsGroup_SeasonContents then
      txt_title:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_SEASONNEWBIE_TITLE"))
      if true == self._isConsole then
        txt_desc:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_SEASONNEWBIE_DESC_CONSOLE"))
      else
        txt_desc:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_SEASONNEWBIE_DESC"))
      end
    end
  elseif channelType == self._CHANNEL_TYPE.SEASONCHANNEL then
    if true == _ContentsGroup_SeasonContents then
      ...
      if true == self._isConsole then
        txt_desc:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_SEASON_DESC_CONSOLE"))
      else
...
function PaGlobal_ServerSelect_All:resize()
  ...
  if nil == self._ui_loadingMovie then
    if true == _ContentsGroup_UseVideoContent then
      self._ui_loadingMovie = UI.createControl(__ePAUIControl_VideoContent, self._ui._stc_movieBg, "Static_BgMovie")
    else
      self._ui_loadingMovie = UI.createControl(__ePAUIControl_WebControl, self._ui._stc_movieBg, "Static_BgMovie")
    end
  end
  if self._isConsole then
    self._ui_loadingMovie:SetSize(getOriginScreenSizeX(), getOriginScreenSizeY())
    self._ui_loadingMovie:SetHorizonCenter()
    self._ui_loadingMovie:SetVerticalMiddle()
    local spanSize = self._ui_loadingMovie:GetSpanSize()
    if 0 ~= self._ui_loadingMovie:GetParentPosX() then
      spanSize.x = spanSize.x - self._ui_loadingMovie:GetParentPosX()
    end
    if 0 ~= self._ui_loadingMovie:GetParentPosY() then
      spanSize.y = spanSize.y - self._ui_loadingMovie:GetParentPosY()
    end
    self._ui_loadingMovie:SetSpanSize(spanSize.x, spanSize.y)
  end
  self:initTreeData()
end
function PaGlobal_ServerSelect_All:initTreeData()
  ...
  local isAccessibleMultiNationSiege = ToClient_isMultiSiegeUser()
  local getEnteredNationString = ToClient_getEnteredNationString()
  local isServiceTypeKor = isGameServiceTypeKor()
  ...
  for ii = 1, worldServerCount do
    ...
    local isMultiNationSiegeServer = channelServerData._isMultiNationSiegeSever
    if isMultiNationSiegeServer == true and isAccessibleMultiNationSiege == false then
      needSkip = true
    end
    if needSkip == false then
      ...
      key = key + 1
      if isServiceTypeKor == true and isDev == false then
        local channelServerData = getGameChannelServerDataByIndex(ii - 1, 0)
      ...
      self._restrictedServerData[ii] = {
        serverNo = restrictedServerNo,
        serverGroupNo = 0,
        guildServerGroupNo = 0
      }
      local tempTable = {}
      ...
      local seasonNewbieChannelTable = {}
      local normalNewbieChannelTable = {}
      for jj = 1, channelCount do
        local chData = getGameChannelServerDataByIndex(ii - 1, jj - 1)
        if 0 ~= restrictedServerNo and restrictedServerNo == chData._serverNo then
          self._restrictedServerData[ii].serverGroupNo = chData._serverGroupNo
          self._restrictedServerData[ii].guildServerGroupNo = chData._guildServerGroupNo
        end
        if true == chData._isInstanceChannel then
          if ToClient_IsDevelopment() == true then
            tempTable[#tempTable + 1] = {
              isWorldServer = false,
              worldIndex = ii,
              channelIndex = jj,
              isSpeedChannel = chData._isSpeedChannel,
              serverNo = chData._serverNo
            }
          end
        else
          local isMultiNationSiegeServer = chData._isMultiNationSiegeSever
          if isUseTotalAccountVer2() == true then
            local getAccessNationServerString = chData:getAccessibleNation()
            if getAccessNationServerString == "" or getEnteredNationString == getAccessNationServerString then
              if isMultiNationSiegeServer == true then
                if isAccessibleMultiNationSiege == true then
                  tempTable[#tempTable + 1] = {
                    isWorldServer = false,
                    worldIndex = ii,
                    channelIndex = jj,
              ...
              elseif true == chData._isSpeedChannel then
              ...
              elseif true == _ContentsGroup_SeasonContents and true == chData._isSeasonChannel then
                if chData._isSeasonNewbieChannel == true then
                  seasonNewbieChannelTable[#seasonNewbieChannelTable + 1] = {
                    isWorldServer = false,
                    worldIndex = ii,
                    channelIndex = jj,
                    isSpeedChannel = chData._isSpeedChannel,
                ...
                elseif true == chData:isPVPServer() then
              ...
              elseif chData._isSeasonNewbieChannel == true and chData._isSeasonChannel == false and chData._isSpeedChannel == false then
                normalNewbieChannelTable[#normalNewbieChannelTable + 1] = {
                  isWorldServer = false,
                  worldIndex = ii,
                  channelIndex = jj,
                  isSpeedChannel = chData._isSpeedChannel,
              ...
              elseif __ePlatformType_COUNT == chData._servicePlatformType then
          ...
          elseif isMultiNationSiegeServer == true then
            if isAccessibleMultiNationSiege == true then
              tempTable[#tempTable + 1] = {
                isWorldServer = false,
                worldIndex = ii,
          ...
          elseif true == _ContentsGroup_ConsoleIntegration then
            ...
            if selfPlayerPlatform == chData._servicePlatformType then
              tempTable[#tempTable + 1] = {
                isWorldServer = false,
                worldIndex = ii,
                channelIndex = jj,
      ...
      local worldIndex = ii
      if true == _ContentsGroup_SeasonContents then
        for idx = 1, #seasonNewbieChannelTable do
          worldElement:createChild(toInt64(0, key))
          self._treeData[key] = seasonNewbieChannelTable[idx]
          key = key + 1
        end
      ...
      for ii = 1, #normalNewbieChannelTable do
        worldElement:createChild(toInt64(0, key))
        self._treeData[key] = normalNewbieChannelTable[ii]
        key = key + 1
      end
  ...
  if isServiceTypeKor and isDev == false then
...
function PaGlobal_ServerSelect_All:playMovie()
  ...
  self._ui_loadingMovie:ResetUrl()
  if self._isConsole then
    self._ui_loadingMovie:SetSize(getOriginScreenSizeX(), getOriginScreenSizeY())
    self._ui_loadingMovie:SetHorizonCenter()
    self._ui_loadingMovie:SetVerticalMiddle()
    ...
    if getConsoleUIOffset > 0 then
      ...
      self._ui_loadingMovie:SetPosX(posX - marginX * 0.5 - uiOffsetX)
      self._ui_loadingMovie:SetPosY(posY - marginY * 0.5 - uiOffsetY)
    else
      self._ui_loadingMovie:SetPosX(posX - marginX * 0.5)
      self._ui_loadingMovie:SetPosY(posY - marginY * 0.5)
    end
    self._ui_loadingMovie:SetSize(movieSizeX + marginX, movieSizeY + marginY)
  end
  self._ui_loadingMovie:SetUrl(1920, 1080, "coui://UI_Data/UI_Html/LobbyBG_Movie.html")
end
function PaGlobal_ServerSelect_All:playMovieForVideoControl()
  self._ui._stc_movieBg:SetSize(getOriginScreenSizeX(), getOriginScreenSizeY())
  if nil == self._ui_loadingMovie then
    self._ui_loadingMovie = UI.createControl(__ePAUIControl_VideoContent, self._ui._stc_movieBg, "Static_BgMovie")
  end
  self._ui_loadingMovie:resetVideoView()
  if self._isConsole then
    self._ui_loadingMovie:SetSize(getOriginScreenSizeX(), getOriginScreenSizeY())
    self._ui_loadingMovie:SetHorizonCenter()
    self._ui_loadingMovie:SetVerticalMiddle()
    ...
    self._ui_loadingMovie:SetPosX(tempPosX)
    self._ui_loadingMovie:SetPosY(tempPosY)
    self._ui_loadingMovie:SetSize(movieSizeX, movieSizeY)
  end
  self._ui_loadingMovie:createVideoView(self._moviePath[self._movieOrder[self._currentMovieIndex]], getResolutionSizeX(), getResolutionSizeY(), false, true)
end
function PaGlobal_ServerSelect_All:onMovieEvent(param)
  ...
  if 1 == param then
    ...
    if nil ~= self._ui_loadingMovie then
      self._ui_loadingMovie:TriggerEvent("PlayMovie", self._movieURL[self._movieOrder[self._currentMovieIndex]])
  ...
  elseif 2 == param then
    ...
    if true == _ContentsGroup_UseVideoContent then
      self._ui_loadingMovie:playVideoView(self._moviePath[self._movieOrder[self._currentMovieIndex]], false, true)
    else
      self._ui_loadingMovie:TriggerEvent("PlayMovie", self._movieURL[self._movieOrder[self._currentMovieIndex]])
    end
  end
...
function PaGlobal_ServerSelect_All:createChannelBranch(content, key)
  ...
  local getAccessNationServerString = channelServerData:getAccessibleNation()
  ...
  local stc_OlympicIcon = UI.getChildControl(channelButtonBG, "StaticText_Olympic")
  local stc_SeasonNewbieIcon = UI.getChildControl(channelButtonBG, "StaticText_SeasonNewbie")
  local stc_HadumIcon = UI.getChildControl(channelButtonBG, "StaticText_Hadum")
  local stc_GuildServerIcon = UI.getChildControl(channelButtonBG, "StaticText_GuildServer")
  local stc_Exp_Plus = UI.getChildControl(channelButtonBG, "StaticText_Exp_Plus")
  local stc_ElfWar = UI.getChildControl(channelButtonBG, "StaticText_ElfWarServer")
  local stc_HardCoreChannel = UI.getChildControl(channelButtonBG, "StaticText_HardCoreServer")
  for ii = self._CHANNEL_TYPE.WAR_INFO, self._CHANNEL_TYPE.MAX_COUNT - 1 do
  ...
  local btn_enterance = UI.getChildControl(channelButtonBG, "Button_Enterance")
  btn_enterance:SetShow(false)
  stc_SeasonIcon:SetShow(false)
  stc_OlympicIcon:SetShow(false)
  stc_SeasonNewbieIcon:SetShow(false)
  stc_HadumIcon:SetShow(false)
  stc_GuildServerIcon:SetShow(false)
  stc_Exp_Plus:SetShow(false)
  ...
  txt_enter:SetShow(false)
  txt_waitChangeTime:SetShow(false)
  stc_ElfWar:SetShow(false)
  stc_HardCoreChannel:SetShow(false)
  ...
  if restrictedServerNo ~= 0 then
    ...
    if 0 ~= self._restrictedServerData[worldServerIdx].guildServerGroupNo then
      local curGuildServerNo = ToClient_GetGuildServerGroupNo()
      if 0 ~= curGuildServerNo and channelServerData._guildServerGroupNo == self._restrictedServerData[worldServerIdx].guildServerGroupNo and channelServerData._guildServerGroupNo == curGuildServerNo then
        isAdmission = true
      end
    end
  end
  local isClosedServer = channelServerData:isClosed()
  local admissionDesc = ""
  ...
  elseif channelServerData._isPcroomChannel then
    ...
    if channelServerData._isHadumChannel then
      self:showChannelIcon(channelButtonBG, self._CHANNEL_TYPE.HADUM)
    end
  elseif true == isSeasonChannel and true == _ContentsGroup_SeasonContents then
    serverSlotButton = btn_SeasonSlot
    if channelServerData._isSeasonNewbieChannel then
      self:showChannelIcon(channelButtonBG, self._CHANNEL_TYPE.SEASON_NEWBIE_CHANNEL)
    else
      self:showChannelIcon(channelButtonBG, self._CHANNEL_TYPE.SEASONCHANNEL)
    end
    self:showChannelIcon(channelButtonBG, self._CHANNEL_TYPE.EXP_PLUS)
    if channelServerData:isPVPServer() then
      self:showChannelIcon(channelButtonBG, self._CHANNEL_TYPE.ARSHA_CHANNEL)
    end
  elseif channelServerData:isPVPServer() then
    serverSlotButton = btn_ArshaSlot
    self:showChannelIcon(channelButtonBG, self._CHANNEL_TYPE.ARSHA_CHANNEL)
  elseif channelServerData._isSeasonNewbieChannel == true and channelServerData._isSeasonChannel == false and channelServerData._isSpeedChannel == false then
    self:showChannelIcon(channelButtonBG, self._CHANNEL_TYPE.OLVIA_CHANNEL)
  end
  if _ContentsGroup_HadumField == false and true == channelServerData._isHadumChannel then
    self:showChannelIcon(channelButtonBG, self._CHANNEL_TYPE.HADUM)
  end
  local guildServerNo = ToClient_GetGuildServerGroupNo()
  if 0 ~= guildServerNo and channelServerData._guildServerGroupNo == guildServerNo then
    self:showChannelIcon(channelButtonBG, self._CHANNEL_TYPE.GUILD_MAINCHANNEL)
  end
  if true == isPrepareToStopServer then
    self:showChannelIcon(channelButtonBG, self._CHANNEL_TYPE.READY_MAINTERNANCE)
  elseif busyState == 0 or isClosedServer == true then
    self:showChannelIcon(channelButtonBG, self._CHANNEL_TYPE.MAINTERNANCE)
  end
  if _ContentsGroup_ElfWar == true and channelServerData._elfWarGameNo == true and ToClient_GetElfWarState() == __eElfWar_Start then
    self:showChannelIcon(channelButtonBG, self._CHANNEL_TYPE.ELFWAR)
  end
  if _ContentsGroup_HardCoreChannel == true and channelServerData._isHardCoreChannel == true then
    self:showChannelIcon(channelButtonBG, self._CHANNEL_TYPE.HARDCORE_CHANNEL)
  end
  local isMultiNationSiegeServer = channelServerData._isMultiNationSiegeSever
  if isMultiNationSiegeServer == true then
    txt_State:SetText("")
    isPrepareToStopServer = false
    local iconControl = self:getChannelIcon(channelButtonBG, self._CHANNEL_TYPE.READY_MAINTERNANCE)
    if iconControl ~= nil then
      iconControl:SetShow(false)
    end
    iconControl = self:getChannelIcon(channelButtonBG, self._CHANNEL_TYPE.MAINTERNANCE)
    if iconControl ~= nil then
      iconControl:SetShow(false)
    end
  ...
  btn_enterance:addInputEvent("Mouse_LUp", "HandleEventLUp_ServerSelect_All_EnterButton(" .. key32 .. ")")
  ...
  if key32 == self._currentHoveredKey32 then
    ...
    local enteranceButtonShow = false
    if true == isShowWaitChangeTime then
      enteranceButtonShow = false
    elseif busyState == 0 or isClosedServer == true then
      enteranceButtonShow = false
    else
      enteranceButtonShow = true
    end
    if isMultiNationSiegeServer == true then
      enteranceButtonShow = true
    end
    btn_enterance:SetShow((enteranceButtonShow or isGameServiceTypeDev()) and PaGlobal_ServerSelect_All._BUTTON_STATE.MAINSERVER_SELECT ~= PaGlobal_ServerSelect_All._currentButtonState)
    if true == self._ani._startAnimationFinished then
...
function PaGlobal_ServerSelect_All:enterMemorizedChannel(channelIdx)
  ...
  local isGMClient = ToClient_IsGMClient()
  if channelServerData._isPcroomChannel and false == isGMClient and true == isGameServiceTypeKor() and false == ToClient_isPCRoomLoginUserServerSelect() then
    local messageBoxData = {
      title = PAGetString(Defines.StringSheet_GAME, "LUA_ALERT_DEFAULT_TITLE"),
  ...
  if channelServerData._isSeasonNewbieChannel and false == isGMClient then
    ...
    if false == isAccessible then
      ...
      local newbieStr = ""
      if channelServerData._isSeasonChannel == true then
        newbieStr = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_SEASON_LOWLEVEL_DESC", "level", myTotalLevel)
      elseif channelServerData._isSpeedChannel == true then
        newbieStr = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_NEWOLVIA_LOWLEVEL_DESC", "level", myTotalLevel)
      else
        newbieStr = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_NORMAL_LOWLEVEL_DESC", "level", myTotalLevel)
      end
      local messageBoxData = {
        title = PAGetString(Defines.StringSheet_GAME, "LUA_ALERT_DEFAULT_TITLE"),
        content = newbieStr,
  ...
  if isGameServiceTypeKor() and false == ToClient_IsDevelopment() and false == isGMClient and false == ToClient_CanEnterNonAdultWorld() then
    local messageBoxData = {
      title = PAGetString(Defines.StringSheet_GAME, "LUA_ALERT_DEFAULT_TITLE"),
  ...
  if _ContentsGroup_HadumField == false and channelServerData._isHadumChannel == true then
    for ii = 1, #self._treeData do
      if self._treeData[ii].worldIndex == self._selectedWorldIndex and self._treeData[ii].channelIndex == channelIdx then
        self._selectedChannelIndex = channelIdx
        PaGlobal_Popup_Hadum_Warning_Open(ii)
        break
      end
    end
    return
  end
  if channelServerData._isMultiNationSiegeSever == true and PaGlobal_AsiaChampionshop_Agreement_Open ~= nil then
    PaGlobal_AsiaChampionshop_Agreement_Open(self._selectedWorldIndex - 1, channelIdx - 1)
    return
  end
...
function PaGlobal_ServerSelect_All:initBackGroundImage()
  ...
  local _bgManager = {
    ...
    [bgIndex.snowMountain] = {
      isOpen = ToClient_IsContentsGroupOpen("8"),
      imageCount = 3,
      iconPath = "BlackDesert_Winter_LogIn_0"
    },
    [bgIndex.xmas] = {
    ...
    [bgIndex.KR2Only] = {
      isOpen = _ContentsOption_CH_LOGO and false,
      imageCount = 0,
      iconPath = "bgKR2Only_"
    },
    [bgIndex.SAOnly] = {
    ...
    if value.isOpen then
      ...
      if value.imageCount > 0 then
        ...
        for index = 1, value.imageCount do
          ...
          if v == 10 then
            targetControl:ChangeTextureInfoName("Combine/Loading/" .. value.iconPath .. index - 1 .. ".dds")
          elseif true == _ContentsGroup_ChinaFontColor then
            if "bgCalpeon_1" ~= tostring(value.iconPath .. index) and "bgCalpeon_5" ~= tostring(value.iconPath .. index) then
...
function PaGlobal_ServerSelect_All:getChannelIcon(buttonBG, iconType)
  ...
  elseif self._CHANNEL_TYPE.SEASON_ARSHA_CHANNEL == iconType then
    return UI.getChildControl(buttonBG, "Static_ChannelIcon3_Arsha")
  elseif self._CHANNEL_TYPE.OLYMPIC == iconType then
    return UI.getChildControl(buttonBG, "StaticText_Olympic")
  elseif self._CHANNEL_TYPE.SEASON_NEWBIE_CHANNEL == iconType then
    return UI.getChildControl(buttonBG, "StaticText_SeasonNewbie")
  elseif self._CHANNEL_TYPE.HADUM == iconType then
    return UI.getChildControl(buttonBG, "StaticText_Hadum")
  elseif self._CHANNEL_TYPE.GUILD_MAINCHANNEL == iconType then
    return UI.getChildControl(buttonBG, "StaticText_GuildServer")
  elseif self._CHANNEL_TYPE.EXP_PLUS == iconType then
    return UI.getChildControl(buttonBG, "StaticText_Exp_Plus")
  elseif self._CHANNEL_TYPE.ELFWAR == iconType then
    return UI.getChildControl(buttonBG, "StaticText_ElfWarServer")
  elseif self._CHANNEL_TYPE.HARDCORE_CHANNEL == iconType then
    return UI.getChildControl(buttonBG, "StaticText_HardCoreServer")
  end
end
function PaGlobal_ServerSelect_All:updateChannelIconPos(buttonBG, iconType)
  ...
  if self._CHANNEL_TYPE.OLYMPIC ~= iconType then
    local olympicIcon = self:getChannelIcon(buttonBG, self._CHANNEL_TYPE.OLYMPIC)
    if true == olympicIcon:GetShow() then
      addIconPos = addIconPos + olympicIcon:GetSizeX()
    end
  end
  if self._CHANNEL_TYPE.SEASON_NEWBIE_CHANNEL ~= iconType then
    local seasonNewbieIcon = self:getChannelIcon(buttonBG, self._CHANNEL_TYPE.SEASON_NEWBIE_CHANNEL)
    if true == seasonNewbieIcon:GetShow() then
      addIconPos = addIconPos + seasonNewbieIcon:GetSizeX()
    end
  end
  if self._CHANNEL_TYPE.HADUM ~= iconType then
    local hadumIcon = self:getChannelIcon(buttonBG, self._CHANNEL_TYPE.HADUM)
    if true == hadumIcon:GetShow() then
      addIconPos = addIconPos + hadumIcon:GetSizeX()
    end
  end
  if self._CHANNEL_TYPE.GUILD_MAINCHANNEL ~= iconType then
    local guildServerIcon = self:getChannelIcon(buttonBG, self._CHANNEL_TYPE.GUILD_MAINCHANNEL)
    if true == guildServerIcon:GetShow() then
      addIconPos = addIconPos + guildServerIcon:GetSizeX()
    end
  end
  if self._CHANNEL_TYPE.EXP_PLUS ~= iconType then
    local expIcon = self:getChannelIcon(buttonBG, self._CHANNEL_TYPE.EXP_PLUS)
    if true == expIcon:GetShow() then
      addIconPos = addIconPos + expIcon:GetSizeX()
    end
  end
  if self._CHANNEL_TYPE.ELFWAR ~= iconType then
    local elfWarIcon = self:getChannelIcon(buttonBG, self._CHANNEL_TYPE.ELFWAR)
    if true == elfWarIcon:GetShow() then
      addIconPos = addIconPos + elfWarIcon:GetSizeX()
    end
  end
  if self._CHANNEL_TYPE.HARDCORE_CHANNEL ~= iconType then
    local hardCoreChannelIcon = self:getChannelIcon(buttonBG, self._CHANNEL_TYPE.HARDCORE_CHANNEL)
    if hardCoreChannelIcon:GetShow() == true then
      addIconPos = addIconPos + hardCoreChannelIcon:GetSizeX()
    end
  end
  local iconControl = self:getChannelIcon(buttonBG, iconType)
...
function PaGlobal_ServerSelect_All:initBanners_PC()
  ...
  if true == ToClient_IsContentsGroupOpen("1436") or true == _ContentsGroup_SeasonContents then
    self._ui._stc_bannerSeason:SetShow(true)
    self._ui._stc_bannerSeason:addInputEvent("Mouse_LUp", "PaGlobal_Homepage_SeasonGMNoteOpen()")
...
function PaGlobal_ServerSelect_All:initBanners()
  ...
  elseif ToClient_isUsingProductManagerAPI() == true then
    domainURL = "https://" .. domainURL .. "/Console/Game/InGame/PositionBanner?bannerType=0"
    local regionCode = getGameCountryRegionCode()
    if regionCode == CppEnums.GameCountryRegionCodeType.KR or regionCode == CppEnums.GameCountryRegionCodeType.JP then
      domainURL = domainURL .. "&gameRegion=ASIA"
    elseif regionCode == CppEnums.GameCountryRegionCodeType.US then
      domainURL = domainURL .. "&gameRegion=NA"
    elseif regionCode == CppEnums.GameCountryRegionCodeType.DE or regionCode == CppEnums.GameCountryRegionCodeType.FR or regionCode == CppEnums.GameCountryRegionCodeType.SP then
      domainURL = domainURL .. "&gameRegion=EU"
    else
      _PA_ASSERT(false, "\236\158\152\235\170\187\235\144\156 Region Code \236\158\133\235\139\136\235\139\164.")
      return
    end
  else
    domainURL = "https://" .. domainURL .. "/Ingame/Banner?bannerType=0"
  end
...
function PaGlobal_ServerSelect_All:setResizeResolution()
  if nil == Panel_Lobby_ServerSelect_All then
    return
  end
  local uiScale = getGlobalScale()
