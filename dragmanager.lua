...
function DragManager:isDragging()
  return self.groundClickFunc ~= nil and self.groundClickFunc ~= GroundMouseEmpty or self.dragSlotInfo ~= nil
end
...
function DragManager:getDraggedItemSlotNo()
  if self:isDragging() == false then
    return
  end
  return self.dragSlotInfo
end
