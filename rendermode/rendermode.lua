...
local renderModeBitSet = {
  ...
  allRenderNotSequenceAll = PAUIRenderModeBitSet({
    Defines.RenderMode.eRenderMode_Default,
    Defines.RenderMode.eRenderMode_WorldMap,
    Defines.RenderMode.eRenderMode_Knowledge,
    Defines.RenderMode.eRenderMode_Dialog,
  ...
  allRenderNotSequence = PAUIRenderModeBitSet({
    Defines.RenderMode.eRenderMode_Default,
    Defines.RenderMode.eRenderMode_WorldMap,
    Defines.RenderMode.eRenderMode_Knowledge,
    Defines.RenderMode.eRenderMode_Dialog,
  ...
  allRender_add_Loading = PAUIRenderModeBitSet({
    Defines.RenderMode.eRenderMode_Default,
    Defines.RenderMode.eRenderMode_Loading,
    Defines.RenderMode.eRenderMode_WorldMap,
    Defines.RenderMode.eRenderMode_Knowledge,
    Defines.RenderMode.eRenderMode_Dialog,
    Defines.RenderMode.eRenderMode_Dye,
...
function SETRENDERMODE_BITSET_ALLRENDER_NOT_SEQUENCE_ALL()
  return renderModeBitSet.allRenderNotSequenceAll
end
function SETRENDERMODE_BITSET_ALLRENDER_NOT_SEQUENCE()
  return renderModeBitSet.allRenderNotSequence
end
function SETRENDERMODE_BITSET_ALLRENDER_ADD_LOADING()
  return renderModeBitSet.allRender_add_Loading
end
