...
Defines.UIGroup = {
  ...
  PAGameUIGroup_Window_Progress_Child = 1260,
  PAGameUIGroup_MarniWave = 1270,
  PAGameUIGroup_MarniWave_Channel = 1271,
  ...
  PAGameUIGroup_WorldBossLooting = 2220,
...
Defines.UIMode = {
  ...
  eUIMode_Tutorial = 46,
  eUIMode_DrawEvent = 47,
  eUIMode_NpcSimpleDialog = 48,
  eUIMode_EnterAbyssOne = 49,
  eUIMode_Sequence = 50,
  eUIMode_SequencePlayerControl = 51,
  eUIMode_FieldWalkingCamera = 52,
  eUIMode_ElfWar = 53,
  eUIMode_ElfWarMenu = 54,
  eUIMode_QuickMenuSetting = 55,
  eUIMode_EnterMorningLandPartyBoss = 56,
  eUIMode_Count = 57
}
Defines.u64_const = {
  u64_0 = toUint64(0, 0),
...
Defines.Color = {
  ...
  C_FF74C5FE = 4285842942,
  C_FFFD8C8A = 4294806666,
  C_FFFFEA84 = 4294961796,
  C_FF0C6CBD = 4279004349,
  C_FFAF1B50 = 4289665872,
  ...
  C_FFFF9A38 = 4294941240,
  C_FFFFAD38 = 4294946104,
  C_FFDE8B3A = 4292774714,
  C_FFFF9C00 = 4294941696,
  C_FFB08B29 = 4289760041,
  C_FFF5BA3A = 4294294074,
  C_FFE4A84A = 4293175370,
  C_FFD7986E = 4292319342,
  C_FF6195BD = 4284585405,
  C_FFF5B327 = 4294292263,
  C_FFD0A248 = 4291863112,
  C_FF5AA8EB = 4284131563,
  C_FF87A0FF = 4287078655,
  C_FFABE8FF = 4289456383,
  C_FFFFB3AB = 4294947755,
  C_FFFFAA77 = 4294945399,
  C_FFFFE380 = 4294960000,
  C_FFECB2FF = 4293702399,
  C_FF8AE7F5 = 4287293429,
  C_FFABFF79 = 4289462137,
  C_FF0051C0 = 4278211008,
  C_FFA2D51F = 4288861471,
  C_FF988D83 = 4288187779
}
Defines.RenderMode = {
  ...
  eRenderMode_Video = 9,
  eRenderMode_FieldWalkingCamera = 10,
  eRenderMode_Dye = 11,
  eRenderMode_InGameCashShop = 12,
  eRenderMode_customScreenShot = 13,
  eRenderMode_IngameCustomize = 14,
  eRenderMode_HouseInstallation = 15,
  eRenderMode_CutScene = 16,
  eRenderMode_BlackSpirit = 17,
  eRenderMode_MentalGame = 18,
  eRenderMode_Tutorial = 19,
  eRenderMode_SkillWindow = 20,
  eRenderMode_SniperGame = 21,
  eRenderMode_Sequence = 22,
  eRenderMode_SequencePlayerControl = 23,
  eRenderMode_ElfWar = 24,
  eRenderMode_ElfWarMenu = 25,
  eRenderMode_Count = 26
}
...
Defines.StringSheet_IMAGESLIDE = "IMAGESLIDE"
Defines.StringSheet_CUTSCENE = "CUTSCENE"
Defines.SolrareRank = {
  RANK1_1 = 2401,
  RANK2_1 = 2301,
  RANK2_2 = 2201,
...
Defines.SolrareRankOrder = {
  [Defines.SolrareRank.RANK1_1] = 0,
  [Defines.SolrareRank.RANK2_1] = 1,
  [Defines.SolrareRank.RANK2_2] = 2,
  [Defines.SolrareRank.RANK2_3] = 3,
  [Defines.SolrareRank.RANK3_1] = 4,
  [Defines.SolrareRank.RANK3_2] = 5,
  [Defines.SolrareRank.RANK3_3] = 6,
  [Defines.SolrareRank.RANK4_1] = 7,
  [Defines.SolrareRank.RANK4_2] = 8,
  [Defines.SolrareRank.RANK4_3] = 9,
  [Defines.SolrareRank.RANK5_1] = 10,
  [Defines.SolrareRank.RANK5_2] = 11,
  [Defines.SolrareRank.RANK5_3] = 12,
  [Defines.SolrareRank.RANK6_1] = 13,
  [Defines.SolrareRank.RANK6_2] = 14,
  [Defines.SolrareRank.RANK6_3] = 15,
  [Defines.SolrareRank.RANK6_4] = 16,
  [Defines.SolrareRank.RANK7_1] = 17,
  [Defines.SolrareRank.RANK7_2] = 18,
  [Defines.SolrareRank.RANK7_3] = 19,
  [Defines.SolrareRank.RANK7_4] = 20,
  [Defines.SolrareRank.RANK8_1] = 21
}
Defines.EventNaviType = {EVENT_FISHING = 0, EVENT_COUNT = 1}
Defines.ElfWarTeamNo = {
  KAMASYLVIA = 0,
  ODYLLITA = 1,
  NEUTRAL = 2,
  COUNT = 3
}
Defines.ActionChartLua = {GalleyShipBoostOn = 450, GalleyShipBoostOff = 451}
Defines.ChCsCenterOpenType = {
  CsCenterOpen_Esc = 0,
  CsCenterOpen_PearlShop = 1,
  CsCenterOpen_LoginFail = 2
}
InventoryBottomOpenUIButtonIndex = {
  Equip = 0,
  AlchemyFigureHead = 1,
  AlchemyStone = 2,
  Manufacture = 3,
...
function PaGlobal_Homepage_Open()
  ...
  elseif true == isGameTypeSA() then
    url = "https://www.sa.playblackdesert.com/"
  ...
  elseif true == _ContentsOption_CH_Homepage then
    url = "https://bd.qq.com/cp/a20240715gwyqyy/index.shtml"
  elseif true == isGameTypeASIA() then
    url = ToClient_getIngameBoardURL()
    local startIdx, endIdx = string.find(url, "/Game/InGame")
    local subUrl = string.sub(url, 0, startIdx - 1)
    url = subUrl .. "/Main"
  end
...
function ConvertFromGradeToColor(grade, printType)
  ...
  if nil == printType then
    ...
    elseif 5 == grade then
      returnValue = Defines.Color.C_FFA070EF
    else
      returnValue = Defines.Color.C_FFC4BEBE
    end
  elseif 0 == grade then
  ...
  elseif 5 == grade then
    returnValue = "<PAColor0xFFA070EF>"
  else
    returnValue = "<PAColor0xffc4bebe>"
  end
  return returnValue
end
function CovertSolrareRankScoreToTierGrade(rankScore)
  local rankDefine = Defines.SolrareRank
  if nil == rankScore then
    return rankDefine.RANK7_1
  end
  if rankScore >= rankDefine.RANK1_1 then
    return rankDefine.RANK1_1
  elseif rankScore >= rankDefine.RANK2_1 and rankScore < rankDefine.RANK1_1 then
    return rankDefine.RANK2_1
  elseif rankScore >= rankDefine.RANK2_2 and rankScore < rankDefine.RANK2_1 then
    return rankDefine.RANK2_2
  elseif rankScore >= rankDefine.RANK2_3 and rankScore < rankDefine.RANK2_2 then
    return rankDefine.RANK2_3
  elseif rankScore >= rankDefine.RANK3_1 and rankScore < rankDefine.RANK2_3 then
    return rankDefine.RANK3_1
  elseif rankScore >= rankDefine.RANK3_2 and rankScore < rankDefine.RANK3_1 then
    return rankDefine.RANK3_2
  elseif rankScore >= rankDefine.RANK3_3 and rankScore < rankDefine.RANK3_2 then
    return rankDefine.RANK3_3
  elseif rankScore >= rankDefine.RANK4_1 and rankScore < rankDefine.RANK3_3 then
    return rankDefine.RANK4_1
  elseif rankScore >= rankDefine.RANK4_2 and rankScore < rankDefine.RANK4_1 then
    return rankDefine.RANK4_2
  elseif rankScore >= rankDefine.RANK4_3 and rankScore < rankDefine.RANK4_2 then
    return rankDefine.RANK4_3
  elseif rankScore >= rankDefine.RANK5_1 and rankScore < rankDefine.RANK4_3 then
    return rankDefine.RANK5_1
  elseif rankScore >= rankDefine.RANK5_2 and rankScore < rankDefine.RANK5_1 then
    return rankDefine.RANK5_2
  elseif rankScore >= rankDefine.RANK5_3 and rankScore < rankDefine.RANK5_2 then
    return rankDefine.RANK5_3
  elseif rankScore >= rankDefine.RANK6_1 and rankScore < rankDefine.RANK5_3 then
    return rankDefine.RANK6_1
  elseif rankScore >= rankDefine.RANK6_2 and rankScore < rankDefine.RANK6_1 then
    return rankDefine.RANK6_2
  elseif rankScore >= rankDefine.RANK6_3 and rankScore < rankDefine.RANK6_2 then
    return rankDefine.RANK6_3
  elseif rankScore >= rankDefine.RANK6_4 and rankScore < rankDefine.RANK6_3 then
    return rankDefine.RANK6_4
  elseif rankScore >= rankDefine.RANK7_1 and rankScore < rankDefine.RANK6_4 then
    return rankDefine.RANK7_1
  elseif rankScore >= rankDefine.RANK7_2 and rankScore < rankDefine.RANK7_1 then
    return rankDefine.RANK7_2
  elseif rankScore >= rankDefine.RANK7_3 and rankScore < rankDefine.RANK7_2 then
    return rankDefine.RANK7_3
  elseif rankScore >= rankDefine.RANK7_4 and rankScore < rankDefine.RANK7_3 then
    return rankDefine.RANK7_4
  else
    return rankDefine.RANK8_1
  end
end
function PaGlobal_CheckFantasyHorse(servantKey)
  if 31539 == servantKey then
    return true
  elseif 31558 == servantKey then
    return true
  elseif 31562 == servantKey then
    return true
  elseif 31557 == servantKey then
    return true
  elseif 31559 == servantKey then
    return true
  elseif 31575 == servantKey then
    return true
  elseif 31576 == servantKey then
    return true
  elseif 31577 == servantKey then
    return true
  else
    return false
  end
end
function PaGlobal_CheckIsFamilyEquipSlotNo(itemWhereType, equipSlotNo)
  if _ContentsGroup_LifeEquipmentSlots == false then
    return false
  end
  if itemWhereType ~= __eItemWhereTypeEquip then
    return false
  end
  if equipSlotNo == __eEquipSlotNoAxe or equipSlotNo == __eEquipSlotNoSyringe or equipSlotNo == __eEquipSlotNoHoe or equipSlotNo == __eEquipSlotNoButcheryKnife or equipSlotNo == __eEquipSlotNoSkinKnife or equipSlotNo == __eEquipSlotNoPickAx or equipSlotNo == __eEquipSlotNoFishingRod or equipSlotNo == __eEquipSlotNoBobber or equipSlotNo == __eEquipSlotNoFishingHarpoon then
    return true
  end
  return false
end
