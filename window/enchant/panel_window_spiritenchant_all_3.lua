function PaGlobal_SpiritEnchant_All:caphrasOpen()
  ...
  if true == _ContentsGroup_EnchantRenewer then
    ...
    PaGlobal_SpiritEnchant_All._ui_enchant.stc_enchantBgOld:SetShow(true)
    self._ui_enchant.stc_imageArea:SetShow(false)
    self._ui_enchant.stc_imageAreaOld:SetShow(true)
  ...
  self._ui_enchant.stc_line:SetShow(false)
...
function PaGlobal_SpiritEnchant_All:didSetCaphrasEnchantTarget(itemWrapper, isMonotone, isPromotion)
  ...
  if nil ~= self._slotResult_Caphras.originalForDuelIcon then
    ...
    if true == isOriginalItem then
      self._slotResult_Caphras.originalForDuelIcon:SetShow(true)
    else
      self._slotResult_Caphras.originalForDuelIcon:SetShow(false)
    end
  end
  ...
  self:setCaphrasEnchantMaterial(false, 0)
  ...
  local needCaphrasStone = nextLevelStack - curStack
  if true == isPromotion then
    ...
    if maxLevel == curLevel then
      ...
      if needCaphrasStone <= self._savedCaphrasInvenCount then
        self:setCaphrasEnchantMaterial(false, needCaphrasStone)
      else
        self:setCaphrasEnchantMaterial(false, self._savedCaphrasInvenCount)
      end
      self:checkCaphrasMaterialItem()
    end
        ...
        if stats[idx].val > 0 then
          ...
          if 1 ~= statsCount then
            if false == self._ui_enchant.txt_caphrasStatusTitleL[statsCount - 1]:IsAutoWrapText() and false == self._ui_enchant.txt_caphrasStatusTitleL[statsCount]:IsAutoWrapText() then
              self._ui_enchant.txt_caphrasStatusTitleL[statsCount]:SetPosY(self._ui_enchant.txt_caphrasStatusTitleL[statsCount - 1]:GetPosY() + self._ui_enchant.txt_caphrasStatusTitleL[statsCount - 1]:GetSizeY())
              self._ui_enchant.txt_caphrasStatusValueL[statsCount]:SetPosY(self._ui_enchant.txt_caphrasStatusValueL[statsCount - 1]:GetPosY() + self._ui_enchant.txt_caphrasStatusTitleL[statsCount - 1]:GetSizeY())
            else
              self._ui_enchant.txt_caphrasStatusTitleL[statsCount]:SetPosY(self._ui_enchant.txt_caphrasStatusTitleL[statsCount - 1]:GetPosY() + self._ui_enchant.txt_caphrasStatusTitleL[statsCount - 1]:GetTextSizeY() - 5)
              self._ui_enchant.txt_caphrasStatusValueL[statsCount]:SetPosY(self._ui_enchant.txt_caphrasStatusValueL[statsCount - 1]:GetPosY() + self._ui_enchant.txt_caphrasStatusTitleL[statsCount - 1]:GetTextSizeY() - 5)
            end
          end
    ...
    if stats[idx].val > 0 then
      ...
      if 1 ~= statsCount then
        if false == self._ui_enchant.txt_caphrasStatusTitleR[statsCount - 1]:IsAutoWrapText() and false == self._ui_enchant.txt_caphrasStatusTitleR[statsCount]:IsAutoWrapText() then
          self._ui_enchant.txt_caphrasStatusTitleR[statsCount]:SetPosY(self._ui_enchant.txt_caphrasStatusTitleR[statsCount - 1]:GetPosY() + self._ui_enchant.txt_caphrasStatusTitleR[statsCount - 1]:GetSizeY())
          self._ui_enchant.txt_caphrasStatusValueR[statsCount]:SetPosY(self._ui_enchant.txt_caphrasStatusValueR[statsCount - 1]:GetPosY() + self._ui_enchant.txt_caphrasStatusTitleR[statsCount - 1]:GetSizeY())
        else
          self._ui_enchant.txt_caphrasStatusTitleR[statsCount]:SetPosY(self._ui_enchant.txt_caphrasStatusTitleR[statsCount - 1]:GetPosY() + self._ui_enchant.txt_caphrasStatusTitleR[statsCount - 1]:GetTextSizeY() - 5)
          self._ui_enchant.txt_caphrasStatusValueR[statsCount]:SetPosY(self._ui_enchant.txt_caphrasStatusValueR[statsCount - 1]:GetPosY() + self._ui_enchant.txt_caphrasStatusTitleR[statsCount - 1]:GetTextSizeY() - 5)
        end
      end
...
function PaGlobal_SpiritEnchant_All:setCaphrasEnchantMaterial(isMonotone, count)
  ...
  if false == isMonotone then
    ...
    if nil ~= itemWrapper then
      ...
      self._savedCaphrasCountSetSlot = count
      self._savedCaphrasInvenCount = itemCount
    else
      isMonotone = true
    end
  end
...
function PaGlobal_SpiritEnchant_All:caphrasEnchantApplyButton()
  ...
  elseif true == self._isAnimating then
    ...
    local curStack = self._enchantInfo:ToClient_getCurStack()
    local nextLevelStack = self._enchantInfo:ToClient_getStackForLevel(curLevel)
    local function Depth_10th_Over_Go()
    ...
    local messageBoxData = {
      ...
      functionYes = Depth_10th_Over_Go,
      functionNo = MessageBox_Empty_function
    }
    if curLevel == 10 and nextLevelStack - curStack <= self._savedCaphrasCountSetSlot then
      MessageBox.showMessageBox(messageBoxData)
    else
      Depth_10th_Over_Go()
    end
