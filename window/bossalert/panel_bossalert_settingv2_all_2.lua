...
function PaGlobal_BossAlert_SettingV2_All_ReturnTimeAfterAlertEnd()
  ...
  local currentHour = tonumber(paTime:GetHour())
  local currentMinute = tonumber(paTime:GetMinute())
...
function PaGlobal_BossAlert_SettingV2_All_CheckAlertSetting(lastMinute)
  if 30 == lastMinute and false == PaGlobal_BossAlert_SettingV2_All._ui.btn_30Minutes:IsCheck() then
    return false
  end
  if 15 == lastMinute and false == PaGlobal_BossAlert_SettingV2_All._ui.btn_15Minutes:IsCheck() then
    return false
  end
  if 5 == lastMinute and false == PaGlobal_BossAlert_SettingV2_All._ui.btn_5Minutes:IsCheck() then
    return false
  end
  return true
end
