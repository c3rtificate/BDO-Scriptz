function PaGlobal_ElfWar_NakWarLog:initialize()
  if self._initialize == true then
    return
  end
  self._ui.static_PositiveBox = UI.getChildControl(Panel_ElfWar_Nak_WarLog, "Static_WarLog_PositiveBox")
  self._ui.static_NegativeBox = UI.getChildControl(Panel_ElfWar_Nak_WarLog, "Static_WarLog_NegativeBox")
  self._ui.static_NeutralBox = UI.getChildControl(Panel_ElfWar_Nak_WarLog, "Static_WarLog_NeutralBox")
  self:registEventHandler()
  self:validate()
  self:createTemplate()
  if ToClient_IsParticipateInElfWar() == true or ToClient_IsElfWarObserveMode() == true then
    FromClient_ElfWarNakWarLog_ChangeElfWarState(ToClient_GetElfWarState())
  end
  self._initialize = true
end
function PaGlobal_ElfWar_NakWarLog:createTemplate()
  ...
  for idx = 0, self._maxShowCount do
    ...
    local positiveBox = UI.cloneControl(self._ui.static_PositiveBox, Panel_ElfWar_Nak_WarLog, "Static_WarLog_PositiveBox_Copy_" .. idx)
    ...
    local negativeBox = UI.cloneControl(self._ui.static_NegativeBox, Panel_ElfWar_Nak_WarLog, "Static_WarLog_NegativeBox_Copy_" .. idx)
    ...
    local neutralBox = UI.cloneControl(self._ui.static_NeutralBox, Panel_ElfWar_Nak_WarLog, "Static_WarLog_NeutralBox_Copy_" .. idx)
...
function PaGlobal_ElfWar_NakWarLog:registEventHandler()
  if Panel_ElfWar_Nak_WarLog == nil then
    return
  end
  registerEvent("FromClient_ElfWarWarLogEvent", "FromClient_ElfWarWarLogEvent")
  registerEvent("FromClient_ChangeElfWarState", "FromClient_ElfWarNakWarLog_ChangeElfWarState")
  registerEvent("FromClient_SetElfWarObserveMode", "PaGlobalFunc_ElfWarNakWarLog_Open")
  registerEvent("FromClient_UnsetElfWarObserveMode", "PaGlobalFunc_ElfWarNakWarLog_Close")
  Panel_ElfWar_Nak_WarLog:RegisterUpdateFunc("ElfWar_WarLog_UpdateFrame")
end
function ElfWar_WarLog_UpdateFrame(deltaTime)
  PaGlobal_ElfWar_NakWarLog:updatePerFrame(deltaTime)
end
function PaGlobal_ElfWar_NakWarLog:prepareOpen()
  if Panel_ElfWar_Nak_WarLog == nil then
    return
  end
  self:open()
end
function PaGlobal_ElfWar_NakWarLog:open()
  if Panel_ElfWar_Nak_WarLog == nil then
    return
  end
  Panel_ElfWar_Nak_WarLog:SetShow(true)
end
function PaGlobal_ElfWar_NakWarLog:prepareClose()
  if Panel_ElfWar_Nak_WarLog == nil then
    return
  end
  self:close()
end
function PaGlobal_ElfWar_NakWarLog:close()
  if Panel_ElfWar_Nak_WarLog == nil then
    return
  end
  Panel_ElfWar_Nak_WarLog:SetShow(false)
end
function PaGlobal_ElfWar_NakWarLog:updatePosition()
  local posY = Panel_ElfWar_Nak_WarLog:GetSizeY()
...
function PaGlobal_ElfWar_NakWarLog:updatePerFrame(deltaTime)
...
function PaGlobal_ElfWar_NakWarLog:updateShowingLogUI(deltaTime)
...
function PaGlobal_ElfWar_NakWarLog:setLogInfo(logInfo, logUI)
  ...
  if logInfo._type == __eElfWarWarLogType_Occupy_BattleFierceBattle then
    ...
    positiveBox:AddEffect("fUI_RoseWar_WarLog_01A_Blue", false, 0, 0)
  ...
  elseif logInfo._type == __eElfWarWarLogType_Capture_BattleFierceBattle_Negative then
    ...
    negativeBox:AddEffect("fUI_RoseWar_WarLog_01A_Red", false, 0, 0)
...
function FromClient_ElfWarWarLogEvent(eventType, teamNo, param1, param2)
  local logInfo = {
    _type = eventType,
    _teamNo = teamNo,
    _param1 = param1,
  ...
  if ToClient_IsElfWarObserveMode() == true then
    if teamNo == __eElfWarTeam_Kamasylvia then
      if PaGlobalFunc_ElfWarNakWarLog_L_PushData ~= nil then
        PaGlobalFunc_ElfWarNakWarLog_L_PushData(eventType, teamNo, param1, param2)
      end
    elseif teamNo == __eElfWarTeam_Odyllita then
      table.insert(PaGlobal_ElfWar_NakWarLog._logInfoList, logInfo)
    end
  else
    table.insert(PaGlobal_ElfWar_NakWarLog._logInfoList, logInfo)
  end
end
function PaGlobal_ElfWar_NakWarLog:validate()
  if Panel_ElfWar_Nak_WarLog == nil then
    return
  end
