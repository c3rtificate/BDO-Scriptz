function PaGlobal_LordMenu_All:initialize()
  ...
  self._ui._lordTaxSet._txt_LocalTaxTitle:SetShow(_ContentsGroup_Siege2024 == false)
  ...
  self._ui._lordTaxSet._btn_AllTaxRateSet:SetShow(_ContentsGroup_Siege2024 == false)
  self._ui._lordTaxSet._btn_AllReset:SetShow(_ContentsGroup_Siege2024 == false)
...
function PaGlobal_LordMenu_All:isConsoleUI(isConsole)
  ...
  self._ui._lordTaxSet._btn_AllTaxRateSet:SetShow(not isConsole and _ContentsGroup_Siege2024 == false)
  self._ui._lordTaxSet._btn_AllReset:SetShow(not isConsole and _ContentsGroup_Siege2024 == false)
  ...
  if true == _ContentsOption_CH_Help then
    self._ui._titleArea._btn_Question_PC:SetShow(false)
  end
end
...
function PaGlobal_LordMenu_All:copyLocalTaxSlider()
  ...
  for ii = 0, 4 do
    ...
    if ii == 2 or ii == 3 or ii == 4 then
      needToShow = false
    end
    localTaxInfo._slider:SetShow(_ContentsGroup_Siege2024 == false and needToShow == true)
    localTaxInfo._txt_tradeTax:SetShow(_ContentsGroup_Siege2024 == false and needToShow == true)
    localTaxInfo._txt_LowPercent:SetShow(_ContentsGroup_Siege2024 == false and needToShow == true)
    localTaxInfo._txt_HighPercent:SetShow(_ContentsGroup_Siege2024 == false and needToShow == true)
    localTaxInfo._stc_Progress:SetShow(_ContentsGroup_Siege2024 == false and needToShow == true)
    localTaxInfo._slider_TradeTax:SetShow(_ContentsGroup_Siege2024 == false and needToShow == true)
    localTaxInfo._btn_slider:SetShow(_ContentsGroup_Siege2024 == false and needToShow == true)
  end
end
function PaGlobal_LordMenu_All:updateTerritoryInfoTab()
  ...
  if true == doOccupantExist then
    ...
    occupyingDate = siegeWrapper:getOccupyingDate()
  ...
  if affiliatedUserRate >= 0 and affiliatedUserRate <= 20 then
    ...
    if true == _ContentsGroup_ChinaFontColor then
      affiliatedUserRateColor = "<PAColor0xFFF1A73E>"
    end
  elseif affiliatedUserRate > 20 and affiliatedUserRate <= 40 then
    ...
    if true == _ContentsGroup_ChinaFontColor then
      affiliatedUserRateColor = "<PAColor0xFFF9DC3B>"
    end
