...
local UCT_STATICTEXT = __ePAUIControl_StaticText
...
if true == _ContentsOption_CH_Help then
  QuestHistory._buttonQuestion:SetShow(false)
end
...
function QuestHistory:Init()
  ...
  for questZoneIndex = 1, QuestHistory.questZoneCount - 1 do
    local zoneList = {}
    zoneList.baseBG = UI.createControl(__ePAUIControl_Static, QuestHistory.FrameContent, "create_ZoneSlot_" .. questZoneIndex)
    zoneList.gauge_BG = UI.createControl(__ePAUIControl_Static, zoneList.baseBG, "create_ZoneGauge_BG_" .. questZoneIndex)
    zoneList.gauge = UI.createControl(__ePAUIControl_Progress2, zoneList.baseBG, "create_ZoneGauge_" .. questZoneIndex)
    zoneList.progressTitle = UI.createControl(__ePAUIControl_StaticText, zoneList.baseBG, "create_ZoneProgressTitle_" .. questZoneIndex)
    zoneList.progressValue = UI.createControl(__ePAUIControl_StaticText, zoneList.baseBG, "create_ZonerogressValue_" .. questZoneIndex)
  ...
  for questTypeIndex = 1, QuestHistory.questTypeCount - 1 do
    local typeList = {}
    typeList.baseBG = UI.createControl(__ePAUIControl_Static, QuestHistory.FrameContent, "create_TypeSlot_" .. questTypeIndex)
    typeList.gauge_BG = UI.createControl(__ePAUIControl_Static, typeList.baseBG, "create_TypeGauge_BG_" .. questTypeIndex)
    typeList.gauge = UI.createControl(__ePAUIControl_Progress2, typeList.baseBG, "create_TypeGauge_" .. questTypeIndex)
    typeList.progressTitle = UI.createControl(__ePAUIControl_StaticText, typeList.baseBG, "create_TypeProgressTitle_" .. questTypeIndex)
    typeList.progressValue = UI.createControl(__ePAUIControl_StaticText, typeList.baseBG, "create_TyperogressValue_" .. questTypeIndex)
