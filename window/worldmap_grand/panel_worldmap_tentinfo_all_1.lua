function PaGlobal_Worldmap_TentInfo_All:initialize()
  ...
  self._ui.stc_TimeIcon = UI.getChildControl(stc_RemainArea, "Static_TimeImage")
...
function PaGlobal_Worldmap_TentInfo_All:prepareOpen(householdDataWithInstallationWrapper)
  ...
  Panel_Worldmap_TentInfo_All:SetPosX(Panel_HarvestList_All:GetPosX() + Panel_HarvestList_All:GetSizeX() + 5)
...
function PaGlobal_Worldmap_TentInfo_All:update(householdDataWithInstallationWrapper)
  ...
  local lefttime_hour = Int64toInt32(getLeftSecond_TTime64(expireTime)) / 3600
  if lefttime_hour < 48 then
    self._ui.stc_TimeIcon:SetColor(4294925640)
  elseif lefttime_hour < 168 then
    self._ui.stc_TimeIcon:SetColor(4294962752)
  else
    self._ui.stc_TimeIcon:SetColor(4294967295)
  end
...
function PaGlobal_Worldmap_TentInfo_All:updateFrame(deltaTime)
  ...
  if self._updatePeriodTime < self._updateTime then
    self:update(householdDataWithInstallationWrapper)
    self._updateTime = 0
  end
end
