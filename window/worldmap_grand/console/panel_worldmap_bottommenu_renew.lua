local Window_WorldMap_BottomMenuInfo = {
  ...
  _strConfig = {
    [0] = PAGetString(Defines.StringSheet_GAME, "LUA_WIDGET_TOWNNPCNAVI_NPCTYPETEXT_6"),
    [1] = PAGetString(Defines.StringSheet_GAME, "LUA_WIDGET_TOWNNPCNAVI_NPCTYPETEXT_25"),
    [2] = PAGetString(Defines.StringSheet_GAME, "LUA_WIDGET_TOWNNPCNAVI_NPCTYPETEXT_7"),
    [3] = PAGetString(Defines.StringSheet_GAME, "LUA_WIDGET_TOWNNPCNAVI_NPCTYPETEXT_8"),
    [4] = PAGetString(Defines.StringSheet_GAME, "LUA_WIDGET_TOWNNPCNAVI_NPCTYPETEXT_16"),
    [5] = PAGetString(Defines.StringSheet_GAME, "LUA_WIDGET_TOWNNPCNAVI_NPCTYPETEXT_38"),
    [6] = PAGetString(Defines.StringSheet_GAME, "LUA_WIDGET_TOWNNPCNAVI_NPCTYPETEXT_2"),
    [7] = PAGetString(Defines.StringSheet_GAME, "LUA_WIDGET_TOWNNPCNAVI_NPCTYPETEXT_22"),
    [8] = PAGetString(Defines.StringSheet_GAME, "LUA_WIDGET_TOWNNPCNAVI_NPCTYPETEXT_1"),
    [9] = PAGetString(Defines.StringSheet_GAME, "LUA_WIDGET_TOWNNPCNAVI_NPCTYPETEXT_36"),
    [10] = PAGetString(Defines.StringSheet_GAME, "LUA_WIDGET_TOWNNPCNAVI_NPCTYPETEXT_29"),
    [11] = PAGetString(Defines.StringSheet_GAME, "LUA_WIDGET_TOWNNPCNAVI_NPCTYPETEXT_20"),
    [12] = PAGetString(Defines.StringSheet_GAME, "LUA_WIDGET_TOWNNPCNAVI_NPCTYPETEXT_39"),
    [13] = PAGetString(Defines.StringSheet_GAME, "LUA_WIDGET_TOWNNPCNAVI_NPCTYPETEXT_5"),
    [14] = PAGetString(Defines.StringSheet_GAME, "LUA_WIDGET_TOWNNPCNAVI_NPCTYPETEXT_9"),
    [15] = PAGetString(Defines.StringSheet_GAME, "CHATTING_TAB_GUILD"),
    [16] = PAGetString(Defines.StringSheet_GAME, "LUA_WIDGET_TOWNNPCNAVI_NPCTYPETEXT_17"),
    [17] = PAGetString(Defines.StringSheet_GAME, "LUA_WIDGET_TOWNNPCNAVI_NPCTYPETEXT_18"),
    [18] = PAGetString(Defines.StringSheet_GAME, "LUA_WIDGET_TOWNNPCNAVI_NPCTYPETEXT_19"),
    [19] = PAGetString(Defines.StringSheet_GAME, "LUA_WIDGET_TOWNNPCNAVI_NPCTYPETEXT_21"),
    [20] = PAGetString(Defines.StringSheet_GAME, "LUA_WIDGET_TOWNNPCNAVI_NPCTYPETEXT_35")
  },
  _spawnType = {
    [0] = CppEnums.SpawnType.eSpawnType_WareHouse,
    [1] = CppEnums.SpawnType.eSpawnType_ItemMarket,
    [2] = CppEnums.SpawnType.eSpawnType_Stable,
    [3] = CppEnums.SpawnType.eSpawnType_Wharf,
    [4] = CppEnums.SpawnType.eSpawnType_Potion,
    [5] = CppEnums.SpawnType.eSpawnType_ChurchBuff,
    [6] = CppEnums.SpawnType.eSpawnType_ItemRepairer,
    [7] = CppEnums.SpawnType.eSpawnType_Worker,
    [8] = CppEnums.SpawnType.eSpawnType_SkillTrainer,
    [9] = CppEnums.SpawnType.eSpawnType_TraningVehicleShop,
    [10] = CppEnums.SpawnType.eSpawnType_Cook,
    [11] = CppEnums.SpawnType.eSpawnType_Collect,
    [12] = CppEnums.SpawnType.eSpawnType_SupplyShop,
    [13] = CppEnums.SpawnType.eSpawnType_TradeMerchant,
    [14] = CppEnums.SpawnType.eSpawnType_transfer,
    [15] = CppEnums.SpawnType.eSpawnType_guild,
    [16] = CppEnums.SpawnType.eSpawnType_Weapon,
    [17] = CppEnums.SpawnType.eSpawnType_Jewel,
    [18] = CppEnums.SpawnType.eSpawnType_Furniture,
    [19] = CppEnums.SpawnType.eSpawnType_Fish,
    [20] = CppEnums.SpawnType.eSpawnType_Instrument
  },
  _colorConfig = {
...
function Window_WorldMap_BottomMenuInfo:InitControl()
  ...
  if self._isConsole == true then
    self._config._findCount = 20
    local intrumentControl = UI.getChildControl(self._ui._static_FindBg, "RadioButton_31")
    if intrumentControl ~= nil then
      intrumentControl:SetShow(false)
      intrumentControl:SetIgnore(true)
    end
  end
