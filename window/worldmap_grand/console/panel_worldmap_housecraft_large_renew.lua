      ...
      for idx = 0, eSSCount - 1 do
        ...
        for workerIndex = 0, workingCount - 1 do
          if nil ~= self._currentCraftingWorkerList[workerIndex] then
            local resourceIndex = ToClient_getLargeCraftWorkIndexByWorker(self._currentCraftingWorkerList[workerIndex]:get())
...
function Window_WorldMap_HouseCraftLargeInfo:SetDetailInfo()
  ...
  for index = 0, #self._currentCraftingWorkerList do
    ...
    if nil ~= worker then
      local resourceIndex = ToClient_getLargeCraftWorkIndexByWorker(worker:get())
...
function Window_WorldMap_HouseCraftLargeInfo:InitControl()
  ...
  self._ui._static_Keyguide_Cancel = UI.getChildControl(self._ui._static_BottomBg, "StaticTextLTY_ConsoleUI")
...
function Window_WorldMap_HouseCraftLargeInfo:InitEvent()
  self._ui._list2_ResourceList:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_WorldMap_HouseCraftLarge_List2EventControlCreate_ResourceList")
  self._ui._list2_ResourceList:createChildContent(__ePAUIList2ElementManagerType_List)
  self._ui._list2_WorkerList:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_WorldMap_HouseCraftLarge_List2EventControlCreate_WorkerList")
  self._ui._list2_WorkerList:createChildContent(__ePAUIList2ElementManagerType_List)
  self._ui._list2_CraftingWorker:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_WorldMap_HouseCraftLarge_List2EventControlCreate_CraftingWorkerList")
  self._ui._list2_CraftingWorker:createChildContent(__ePAUIList2ElementManagerType_List)
  ...
  Panel_Worldmap_HouseCraftLarge:registerPadEvent(__eConsoleUIPadEvent_LTPress_Y, "PaGlobalFunc_WorldMap_HouseCraftLarge_CraftCancel()")
...
function PaGlobalFunc_WorldMap_HouseCraftLarge_List2EventControlCreate_CraftingWorkerList(list_content, key)
  ...
  local name = workerWrapperLua:getName()
