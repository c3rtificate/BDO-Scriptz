...
function Window_WorldMap_SellBuyHouseInfo:InitControl()
  ...
  self._ui._staticText_TitleDesc:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui._staticText_subInfoDesc:SetTextMode(__eTextMode_AutoWrap)
...
function Window_WorldMap_SellBuyHouseInfo:InitEvent()
  self._ui._list2_HouseList:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_WorldMap_SellBuyCondition_List2EventControlCreate")
