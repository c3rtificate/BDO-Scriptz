...
function HandleOn_Building_Worker_List(index)
  ...
  if nil ~= npcWaitingWorker then
    ...
    PaGlobalFunc_WorkerManagerTooltip_All_OpenByWorkerNoRaw(Worker_List._data_Table[workerIndex]._workerNo_s64, uiBase)
  end
end
...
function HandleClick_doWork_Building()
  ...
  PaGlobalFunc_WorkerManager_All_RedoWork(3, nil, selected_Worker, plantKey, nil, selected_SubWork, workingCount, nil, houseHoldNo, affiliatedTownKey)
end
