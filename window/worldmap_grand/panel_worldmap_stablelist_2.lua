...
function HandleEventLUp_WorldMap_StableList_ShowBeforeLook_Tooltip(isShow, slotIdx)
  ...
  local calcSlotIdx = slotIdx % PaGlobal_WorldMap_StableList._MAXSLOTCOUNT
  if nil == PaGlobal_WorldMap_StableList._ui._servantSlot[calcSlotIdx] then
    return
  end
  local uiControl = PaGlobal_WorldMap_StableList._ui._servantSlot[calcSlotIdx]._btn_beforeLook
