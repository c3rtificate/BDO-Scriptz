...
function FGlobal_FilterReset()
  ToCleint_findHouseByFilter(CppEnums.HouseOwnerFilter.HOUSE_OWNER_ALL, -1, 1, true)
...
function FGlobal_SelectedFilter()
  ...
  ToCleint_findHouseByFilter(ownerIndex, receipeKey, levelIndex + 1, true)
end
