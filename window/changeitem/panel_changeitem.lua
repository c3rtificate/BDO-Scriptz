...
PaGlobal_Util_RegistHelpTooltipEvent(_buttonQuestion, "\"ClothExchange\"")
...
function FromClient_ShowItemChange()
  ...
  equipSlot.icon:SetShow(false)
  avatarSlot.icon:SetShow(false)
