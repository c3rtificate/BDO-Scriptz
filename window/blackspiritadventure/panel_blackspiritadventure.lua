...
function PaGlobal_BlackSpiritAdventure:initialize()
  ...
  if true == _ContentsOption_CH_Help then
    self._ui._chk_popUp:SetSpanSize(self._ui._btn_Question:GetSpanSize().x, self._ui._btn_Question:GetSpanSize().y)
  end
  if true == _ContentsGroup_UsePadSnapping then
    self._ui._btn_Close:SetShow(false)
    self._webSizeY = self._webSizeY + 50
    Panel_Window_BlackSpiritAdventure:SetSize(Panel_Window_BlackSpiritAdventure:GetSizeX(), Panel_Window_BlackSpiritAdventure:GetSizeY() + 50)
    Panel_Window_BlackSpiritAdventure:ComputePos()
  end
...
function PaGlobal_BlackSpiritAdventure:registerEventHandler()
  ...
  Panel_Window_BlackSpiritAdventure:registerPadEvent(__eConsoleUIPadEvent_LTPress_Y, "Input_BlackSpiritAdventure_ToWebBanner(\"LT_Y\")")
  Panel_Window_BlackSpiritAdventure:registerPadEvent(__eConsoleUIPadEvent_LSClick, "Input_BlackSpiritAdventure_ToWebBanner(\"LS_CLICK\")")
  Panel_Window_BlackSpiritAdventure:registerPadEvent(__eConsoleUIPadEvent_RSClick, "Input_BlackSpiritAdventure_ToWebBanner(\"RS_CLICK\")")
  Panel_Window_BlackSpiritAdventure:registerPadEvent(__eConsoleUIPadEvent_Up_LB, "Input_BlackSpiritAdventure_ToWebBanner(\"LB\")")
  Panel_Window_BlackSpiritAdventure:registerPadEvent(__eConsoleUIPadEvent_Up_RB, "Input_BlackSpiritAdventure_ToWebBanner(\"RB\")")
  Panel_Window_BlackSpiritAdventure:registerPadEvent(__eConsoleUIPadEvent_DpadUp, "Input_BlackSpiritAdventure_ToWebBanner(\"D_UP\")")
  Panel_Window_BlackSpiritAdventure:registerPadEvent(__eConsoleUIPadEvent_DpadDown, "Input_BlackSpiritAdventure_ToWebBanner(\"D_DOWN\")")
  Panel_Window_BlackSpiritAdventure:registerPadEvent(__eConsoleUIPadEvent_DpadLeft, "Input_BlackSpiritAdventure_ToWebBanner(\"D_LEFT\")")
  Panel_Window_BlackSpiritAdventure:registerPadEvent(__eConsoleUIPadEvent_DpadRight, "Input_BlackSpiritAdventure_ToWebBanner(\"D_RIGHT\")")
  Panel_Window_BlackSpiritAdventure:registerPadEvent(__eConsoleUIPadEvent_Up_A, "Input_BlackSpiritAdventure_ToWebBanner(\"A\")")
  Panel_Window_BlackSpiritAdventure:registerPadEvent(__eConsoleUIPadEvent_Up_X, "Input_BlackSpiritAdventure_ToWebBanner(\"X\")")
  Panel_Window_BlackSpiritAdventure:registerPadEvent(__eConsoleUIPadEvent_Up_Y, "Input_BlackSpiritAdventure_ToWebBanner(\"Y\")")
  ...
  registerEvent("FromClient_OpenBlackSpiritAdventure", "FromClient_BlackSpritadventure_Show()")
end
...
function FGlobal_BlackSpiritAdventure_Close_CheckUiSub()
  if Panel_Window_BlackSpiritAdventure == nil then
    return
  end
  if Panel_Window_BlackSpiritAdventure:IsUISubApp() == true then
    return
  end
  BlackSpiritAd_Hide()
end
...
function Input_BlackSpiritAdventure_ToWebBanner(key)
  PaGlobal_BlackSpiritAdventure._Web:TriggerEvent("FromClient_GamePadInputForWebBanner", key)
end
function FromClient_BlackSpritadventure_Show(type)
  if _ContentsGroup_BlackSpiritAdventure == false then
    return
  end
  if type ~= 1 then
    return
  end
  if Panel_Window_EventMarbleGame ~= nil and Panel_Window_EventMarbleGame:GetShow() then
