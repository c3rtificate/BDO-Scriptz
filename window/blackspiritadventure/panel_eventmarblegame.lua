...
function PaGlobal_EventMarbleGame:registerEventHandler()
  ...
  Panel_Window_EventMarbleGame:registerPadEvent(__eConsoleUIPadEvent_LSClick, "Input_EventMarbleGame_ToWebBanner(\"LS_CLICK\")")
  Panel_Window_EventMarbleGame:registerPadEvent(__eConsoleUIPadEvent_RSClick, "Input_EventMarbleGame_ToWebBanner(\"RS_CLICK\")")
  ...
  registerEvent("FromClient_OpenBlackSpiritAdventure", "FromClient_EventMarbleGame_Show()")
end
...
function FromClient_EventMarbleGame_Show(type)
  if _ContentsGroup_EventMarbleGame == false then
    return
  end
  if type ~= 2 then
    return
  end
  if Panel_Window_BlackSpiritAdventure ~= nil and Panel_Window_BlackSpiritAdventure:GetShow() then
    BlackSpiritAd_Hide()
  end
  FGlobal_EventMarbleGame_Open(false)
end
