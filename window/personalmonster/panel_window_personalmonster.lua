...
function PersonalMonster:createControl()
  ...
  self._ui.txt_searchInfo:SetTextMode(__eTextMode_AutoWrap)
  self._ui.txt_searchInfo:SetText(self._ui.txt_searchInfo:GetText())
  _panel:ComputePos()
  self._ui.stc_desc:ComputePos()
  self._ui.txt_desc:ComputePos()
  self._ui._list2_personalMonster:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_PersonalMonster_List2CreateControl")
  self._ui._list2_personalMonster:createChildContent(__ePAUIList2ElementManagerType_List)
...
function PaGlobalFunc_PersonalMonster_List2CreateControl(content, key)
  ...
  dropTitle:SetTextMode(__eTextMode_AutoWrap)
  ...
  if nil ~= self._difficultyIcon[monsterLevel] then
    ...
    difficultyIcon:setRenderTexture(difficultyIcon:getBaseTexture())
...
function PaGlobal_PersonalMonster_SetMonsterZeroState()
  ...
  if 0 == count then
    ...
    self._ui.txt_CloseMessage:SetTextMode(__eTextMode_AutoWrap)
