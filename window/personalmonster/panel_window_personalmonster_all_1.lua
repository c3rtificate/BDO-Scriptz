function PaGlobal_PersonalMonster_ALL:initialize()
  ...
  self._ui.list2_itemList = UI.getChildControl(self._ui.stc_ConsoleItemList, "List2_ItemListBG")
  ...
  local monsterList2Content = UI.getChildControl(self._ui.list2_Monster, "List2_1_Content")
  self._list2ContentSizeY = monsterList2Content:GetSizeY()
  for idx = 0, self._pcRewardSlotCount - 1 do
    local slot = UI.getChildControl(monsterList2Content, "Static_SlotBg_" .. tostring(idx))
    local itemSlot = {}
    SlotItem.new(itemSlot, "rewardSlot_" .. tostring(idx), idx, slot, self._slotConfig)
  ...
  local rewardList2Content = UI.getChildControl(self._ui.list2_itemList, "List2_1_Content")
  local tempBtn = UI.getChildControl(rewardList2Content, "Button_ItemBG")
  local rewardSlot = UI.getChildControl(tempBtn, "Static_SlotBG")
  local itemSlot = {}
  SlotItem.new(itemSlot, "console_RewardSlot_" .. tostring(idx), idx, rewardSlot, self._slotConfig)
  itemSlot:createChild()
  itemSlot.icon:SetSize(40, 40)
  itemSlot.border:SetSize(40, 40)
  itemSlot.border:SetHorizonCenter()
...
function PaGlobal_PersonalMonster_ALL:registEventHandler(isConsole)
  if false == isConsole then
    ...
    self._ui.list2_itemList:registEvent(__ePAUIList2EventType_LuaChangeContent, "FromClient_PersonalMonster_All_UpdateRewardList2")
...
function PaGlobal_PersonalMonster_ALL:prepareOpen()
  ...
  self._selectedMonsterIndexForConsole = -1
