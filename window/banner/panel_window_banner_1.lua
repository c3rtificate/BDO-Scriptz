...
function PaGlobal_Banner:registEventHandler()
  ...
  registerEvent("FromClient_luaLoadCompleteLateUdpate", "FromClient_Banner_luaLoadCompleteLateUdpate")
end
...
function PaGlobal_Banner:wholeUpdateBanner()
  if ToClient_UserHasOverLevelCharacter(60) == false and isGameTypeKR2() == false then
    return
  end
  if ToClient_UserHasOverLevelCharacter(30) == false and isGameTypeKR2() == true then
    return
  end
