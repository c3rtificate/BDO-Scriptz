...
function PaGlobal_PartyList_All:controlPc_Init()
  ...
  self._ui_pc.btn_reset = UI.getChildControl(self._ui.edit_search, "Button_Reset")
  ...
  self._ui_pc.btn_atoraxionMatching = UI.getChildControl(self._ui.stc_topBg, "Button_Match_Atoraxxion")
  UI.setLimitTextAndAddTooltip(self._ui_pc.btn_atoraxionMatching, self._ui_pc.btn_atoraxionMatching:GetText(), "")
end
...
function PaGlobal_PartyList_All:controlSetShow()
  ...
  if false == self._isPadSnap then
    ...
    self._ui_pc.btn_atoraxionMatching:SetShow(true)
    if _ContentsGroup_AtoraxionDesert == false then
      self._ui_pc.btn_atoraxionMatching:SetShow(false)
    end
...
function PaGlobal_PartyList_All:resize()
  ...
  if false == self._isPadSnap then
    ...
    self._ui.edit_search:SetSpanSize(260, 0)
    if _ContentsGroup_AtoraxionDesert == false then
      self._ui.edit_search:SetSize(1090, 40)
      self._ui.edit_search:SetSpanSize(260, 0)
    end
...
function PaGlobal_PartyList_All:prepareOpen()
  ...
  if ToClient_namelessPVPServer() == true then
    Proc_ShowMessage_Ack(PAGetString(Defines.StringSheet_GAME, "LUA_WARNING_ARSHA_SERVER_DONTUSE"))
    return
  end
  ToClient_RequestListPartyRecruitment(false)
...
function PaGlobal_PartyList_All:prepareClose()
  ...
  PaGlobal_PartyList_All._clickedPartyRecruitKey = nil
...
function PaGlobal_PartyList_All:registEventHandler()
  ...
  if false == self._isPadSnap then
    ...
    self._ui_pc.btn_recruite:addInputEvent("Mouse_LUp", "PaGlobalFunc_PartyRecruite_All_Open(false)")
    self._ui_pc.btn_reload:addInputEvent("Mouse_LUp", "PaGlobalFunc_PartyList_All_Update(true)")
    self._ui_pc.btn_close:addInputEvent("Mouse_LUp", "PaGlobalFunc_PartyList_All_Close()")
    self._ui_pc.list2_party:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_PartyList_All_ControlCreate")
    self._ui_pc.list2_party:createChildContent(__ePAUIList2ElementManagerType_List)
    self._ui_pc.btn_atoraxionMatching:addInputEvent("Mouse_LUp", "PaGlobalFunc_PartyContentsRecruit_Open()")
  else
    if true == self._isConsole then
      Panel_PartyList_All:registerPadEvent(__eConsoleUIPadEvent_Up_X, "PadEventXUp_PatyList_All_RecruiteShow()")
    else
      Panel_PartyList_All:registerPadEvent(__eConsoleUIPadEvent_Up_X, "PaGlobalFunc_PartyRecruite_All_Open(false)")
    end
    Panel_PartyList_All:registerPadEvent(__eConsoleUIPadEvent_Up_Y, "PaGlobalFunc_PartyList_All_Update(true)")
    ...
    self._ui_console.list2_party:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_PartyList_All_ControlCreate")
    self._ui_console.list2_party:createChildContent(__ePAUIList2ElementManagerType_List)
  end
  registerEvent("ResponseParty_createPartyList", "PaGlobalFunc_PartyList_All_CreatePartyList")
  registerEvent("ResponseParty_insert", "PaGlobalFunc_PartyList_All_InsertPartyList")
  registerEvent("ResponseParty_withdraw", "PaGlobalFunc_PartyList_All_WithdrawPartyList")
  registerEvent("ResponseParty_changeLeader", "PaGlobalFunc_PartyList_All_ChangePartyLeader")
  ...
  registerEvent("FromClient_PartyLeaderIsNotLogined", "FromClient_PartyList_All_PartyLeaderIsNotLogined")
  registerEvent("FromClient_CheckChinaProhibitedWord_SearchParty", "FromClient_CheckChinaProhibitedWord_SearchParty")
end
...
function PaGlobal_PartyList_All:setButtonText(eType)
  ...
  if false == self._canInvite then
    ...
    Panel_PartyList_All:registerPadEvent(__eConsoleUIPadEvent_Up_X, "")
  else
...
function PaGlobalFunc_PartyList_All_ControlCreate(control, key)
  ...
  server:SetTextMode(__eTextMode_LimitText)
  ...
  if false == PaGlobal_PartyList_All._isPadSnap then
    ...
    if true == ToClient_isTotalGameClient() then
      PaGlobal_PartyList_All:setCrossPlayIcon(platformIcon, partyWrapper:getPlatformType())
    end
  end
  bg:SetShow(true)
  ...
  if platformIcon ~= nil then
    platformIcon:SetSpanSize(leader:GetSpanSize().x - leader:GetTextSizeX() / 2, 0)
  end
  ...
  if nil ~= PaGlobal_PartyList_All._clickedPartyRecruitKey then
    local partyRecruitKey = partyWrapper:getPartyRecruitmentKey()
    if nil ~= partyRecruitKey and tostring(PaGlobal_PartyList_All._clickedPartyRecruitKey) == tostring(partyRecruitKey) then
      content:AddEffect("fUI_PartyList_01A", true, 0, 0)
      PaGlobal_PartyList_All._clickedPartyRecruitKey = nil
    end
  end
  local partyListCount = ToClient_GetRecruitmentPartyListCount()
  if _key == partyListCount - 1 and nil ~= PaGlobal_PartyList_All._clickedPartyRecruitKey then
    Proc_ShowMessage_Ack(PAGetString(Defines.StringSheet_GAME, "LUA_PARTYJOIN_NOPARTY"))
    PaGlobal_PartyList_All._clickedPartyRecruitKey = nil
  end
end
function PaGlobal_PartyList_All:setCrossPlayIcon(targetControl, platformType)
