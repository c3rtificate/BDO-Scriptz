...
function Panel_Window_PartyInvite_info:childControl()
  ...
  local tempBtnGroup = {}
  if true == _ContentsGroup_RenewUI and true == ToClient_isXBox() then
    tempBtnGroup = {
  ...
  if true == ToClient_isPS() or false == _ContentsGroup_RenewUI then
...
function Panel_Window_PartyInvite_info:setIcon(control, classType)
  ...
  if nil ~= classSymbolInfo then
    control:ChangeTextureInfoName(classSymbolInfo.path)
    local x1, y1, x2, y2 = setTextureUV_Func(control, classSymbolInfo.x1, classSymbolInfo.y1, classSymbolInfo.x2, classSymbolInfo.y2)
    control:getBaseTexture():setUV(x1, y1, x2, y2)
    control:setRenderTexture(control:getBaseTexture())
  else
    UI.ASSERT_NAME(false, "classSymbolInfo\176\161 nil\192\204\184\233 \190\200 \181\203\180\207\180\217. \189\197\177\212 \197\172\183\161\189\186\192\206\193\246 \200\174\192\206 \186\206\197\185\181\229\184\179\180\207\180\217.", "\188\173\177\226\191\248")
  end
end
