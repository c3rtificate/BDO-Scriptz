function PaGlobal_GuildPartyList_All:initialize()
  if true == PaGlobal_GuildPartyList_All._initialize then
    return
  end
...
function PaGlobal_GuildPartyList_All:controlAll_Init()
  if nil == Panel_GuildPartyList_All then
    return
  end
  Panel_GuildPartyList_All:SetShow(false, false)
  Panel_GuildPartyList_All:setGlassBackground(true)
  Panel_GuildPartyList_All:SetDragAll(true)
  Panel_GuildPartyList_All:SetIgnore(false)
  self._ui.stc_titleBar = UI.getChildControl(Panel_GuildPartyList_All, "Static_MainTitleBar")
  self._ui.stc_topBg = UI.getChildControl(Panel_GuildPartyList_All, "Static_TopBg_PCUI")
...
function PaGlobal_GuildPartyList_All:controlPc_Init()
  if nil == Panel_GuildPartyList_All then
    return
  end
  ...
  self._ui_pc.stc_listTitleBg = UI.getChildControl(Panel_GuildPartyList_All, "Static_TitleBg_PCUI")
  self._ui_pc.list2_party = UI.getChildControl(Panel_GuildPartyList_All, "List2_PartyList_PCUI")
end
function PaGlobal_GuildPartyList_All:controlConsole_Init()
  if nil == Panel_GuildPartyList_All then
    return
  end
  self._ui_console.stc_listTitleBg = UI.getChildControl(Panel_GuildPartyList_All, "Static_TitleBg_ConsoleUI")
  self._ui_console.stc_bottomBg = UI.getChildControl(Panel_GuildPartyList_All, "Static_BottomBG_ConsoleUI")
  ...
  self._ui_console.list2_party = UI.getChildControl(Panel_GuildPartyList_All, "List2_PartyList_ConsoleUI")
end
function PaGlobal_GuildPartyList_All:controlSetShow()
  if nil == Panel_GuildPartyList_All then
    return
  end
...
function PaGlobal_GuildPartyList_All:resize()
  if nil == Panel_GuildPartyList_All then
    return
  end
  Panel_GuildPartyList_All:SetPosX(getScreenSizeX() / 2 - Panel_GuildPartyList_All:GetSizeX() / 2)
  Panel_GuildPartyList_All:SetPosY(getScreenSizeY() / 2 - Panel_GuildPartyList_All:GetSizeY() / 2 - 100)
  if false == self._isPadSnap then
    self._ui.edit_search:SetSize(840, 40)
    self._ui.edit_search:SetSpanSize(270, 0)
  else
    self._ui.edit_search:SetSize(1220, 40)
    self._ui.edit_search:SetSpanSize(10, 0)
  end
  Panel_GuildPartyList_All:ComputePos()
...
function PaGlobal_GuildPartyList_All:prepareOpen()
  if nil == Panel_GuildPartyList_All then
    return
  end
  ...
  ToClient_RequestListPartyRecruitment(true)
  HandleEventLUp_GuildPartyList_All_Reset()
  PaGlobal_GuildPartyList_All:update()
  PaGlobal_GuildPartyList_All:resize()
  PaGlobal_GuildPartyList_All:open()
end
function PaGlobal_GuildPartyList_All:open()
  if nil == Panel_GuildPartyList_All then
    return
  end
  audioPostEvent_SystemUi(1, 29)
  Panel_GuildPartyList_All:SetShow(true)
end
function PaGlobal_GuildPartyList_All:prepareClose()
  if nil == Panel_GuildPartyList_All then
    return
  end
  PaGlobal_GuildPartyList_All._clickedPartyRecruitKey = nil
  PaGlobalFunc_GuildPartyList_All_ClearFocusEdit()
  ...
  PaGlobal_GuildPartyList_All:close()
end
function PaGlobal_GuildPartyList_All:close()
  if nil == Panel_GuildPartyList_All then
    return
  end
  Panel_GuildPartyList_All:SetShow(false)
end
function PaGlobal_GuildPartyList_All:update()
  if nil == Panel_GuildPartyList_All then
    return
  end
  if false == self._isPadSnap then
    ...
    elseif nil ~= self._clickedPartyRecruitKey then
      Proc_ShowMessage_Ack(PAGetString(Defines.StringSheet_GAME, "LUA_PARTYJOIN_NOPARTY"))
      self._clickedPartyRecruitKey = nil
    end
  else
...
function PaGlobal_GuildPartyList_All:validate()
  if nil == Panel_GuildPartyList_All then
    return
  end
...
function PaGlobal_GuildPartyList_All:registEventHandler()
  if nil == Panel_GuildPartyList_All then
    return
  end
  if false == self._isPadSnap then
    self._ui_pc.btn_reset:addInputEvent("Mouse_LUp", "HandleEventLUp_GuildPartyList_All_Reset()")
    self._ui.edit_search:addInputEvent("Mouse_LUp", "HandleEventLUp_GuildPartyList_All_SearchEdit()")
    self._ui.btn_search:addInputEvent("Mouse_LUp", "HandleEventLUp_GuildPartyList_All_DoSearch()")
    self._ui_pc.btn_recruite:addInputEvent("Mouse_LUp", "PaGlobalFunc_PartyRecruite_All_Open(true)")
    self._ui_pc.btn_reload:addInputEvent("Mouse_LUp", "PaGlobalFunc_GuildPartyList_All_Update(true)")
    self._ui_pc.btn_close:addInputEvent("Mouse_LUp", "PaGlobalFunc_GuildPartyList_All_Close()")
    self._ui_pc.list2_party:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_GuildPartyList_All_ControlCreate")
    self._ui_pc.list2_party:createChildContent(__ePAUIList2ElementManagerType_List)
  else
    if true == self._isConsole then
      Panel_GuildPartyList_All:registerPadEvent(__eConsoleUIPadEvent_Up_X, "PadEventXUp_PatyList_All_RecruiteShow()")
    else
      Panel_GuildPartyList_All:registerPadEvent(__eConsoleUIPadEvent_Up_X, "PaGlobalFunc_PartyRecruite_All_Open(true)")
    end
    Panel_GuildPartyList_All:registerPadEvent(__eConsoleUIPadEvent_Up_Y, "PaGlobalFunc_GuildPartyList_All_Update(true)")
    Panel_GuildPartyList_All:registerPadEvent(__eConsoleUIPadEvent_LTPress_X, "HandleEventLUp_GuildPartyList_All_SearchEdit()")
    if ToClient_IsDevelopment() then
      self._ui.edit_search:RegistReturnKeyEvent("HandleEventLUp_GuildPartyList_All_DoSearch()")
    else
      self._ui.edit_search:setXboxVirtualKeyBoardEndEvent("HandleEventLUp_GuildPartyList_All_DoSearch")
    end
    self._ui_console.list2_party:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_GuildPartyList_All_ControlCreate")
    self._ui_console.list2_party:createChildContent(__ePAUIList2ElementManagerType_List)
  end
  registerEvent("ResponseParty_createPartyList", "PaGlobalFunc_GuildPartyList_All_Update")
  registerEvent("ResponseParty_withdraw", "PaGlobalFunc_GuildPartyList_All_Update")
  registerEvent("ResponseParty_changeLeader", "PaGlobalFunc_GuildPartyList_All_Update")
  registerEvent("FromClient_ResponseGuildPartyRecruitmentInfo", "FromClient_GuildPartyList_All_ResponsePartyRecruitmentInfo")
  registerEvent("FromClient_RequestPartyJoin", "FromClient_GuildPartyList_All_RequestPartyJoin")
  registerEvent("onScreenResize", "FromClient_GuildPartyList_All_Resize")
  registerEvent("FromClient_responseSystemMessageFromTarget", "FromClient_responseSystemMessageFromTarget")
end
function PaGlobal_GuildPartyList_All:checkBlocked(index)
  if nil == index then
    _PA_ASSERT(false, "PaGlobal_GuildPartyList_All:checkBlocked .. \237\140\140\237\139\176 \235\170\168\236\167\145\236\160\149\235\179\180\236\157\152 index\234\176\128 \236\152\172\235\176\148\235\165\180\236\167\128 \236\149\138\236\138\181\235\139\136\235\139\164.")
    return false
  end
...
function PaGlobal_GuildPartyList_All:setButtonText(eType)
  if nil == Panel_GuildPartyList_All then
    return
  end
  ...
  if false == self._canInvite then
    ...
    Panel_GuildPartyList_All:registerPadEvent(__eConsoleUIPadEvent_Up_X, "")
  else
  ...
  PaGlobalFunc_ConsoleKeyGuide_SetAlign(self._keyGuideAlign, self._ui_console.stc_bottomBg, CONSOLEKEYGUID_ALIGN_TYPE.eALIGN_TYPE_RIGHTAUTOWRAP)
end
function PaGlobal_GuildPartyList_All:doAction(index, eType, serverNo, partyNo)
...
function PaGlobal_GuildPartyList_All:isBlockedLeader(xuid)
  return ToClient_IsBlockedLeaderFromMe(xuid)
end
function PaGlobal_GuildPartyList_All:support(index)
  local partyWrapper = self._partySortTable[index]
  if nil == partyWrapper then
    return
  end
...
function PaGlobal_GuildPartyList_All:recruiteCancel()
...
function PaGlobal_GuildPartyList_All:moveServer(serverNo, partyNo)
...
function PaGlobal_GuildPartyList_All:reloadPartyData()
  local partyListCount = ToClient_GetRecruitmentPartyListCount()
  local sortPointer = 0
  local curChannelData = getCurrentChannelServerData()
...
function PaGlobalFunc_GuildPartyList_All_ControlCreate(control, key)
  ...
  local stcTypeParty = UI.getChildControl(control, "StaticText_PartyType_Party")
  local stcTypeRaid = UI.getChildControl(control, "StaticText_PartyType_Raid")
  local _key = Int64toInt32(key)
  local partyWrapper = ToClient_GetRecruitmentPartyListAt(_key)
  if nil == partyWrapper then
    return
  end
  stcTypeParty:SetShow(false)
  stcTypeRaid:SetShow(false)
  local myBg, btnSupport, btnAd, platformIcon
  if false == PaGlobal_GuildPartyList_All._isPadSnap then
    ...
    bg:addInputEvent("Mouse_On", "HandleEventOn_GuildPartyList_All_OnSelectButton(" .. _key .. "," .. PaGlobal_GuildPartyList_All._enum.eTYPE_RECRUITE_NONE .. ")")
    bg:addInputEvent("Mouse_LUp", "")
    platformIcon = UI.getChildControl(control, "Static_PlatformIcon")
    platformIcon:SetShow(false)
    if true == ToClient_isTotalGameClient() then
      PaGlobal_GuildPartyList_All:setCrossPlayIcon(platformIcon, partyWrapper:getPlatformType())
    end
  end
  bg:SetShow(true)
  ...
  local isPartyLeader = RequestParty_isLeader()
  local myPartyNo = ToClient_GetPartyNo()
  if CppEnums.PartyType.ePartyType_Normal == partyWrapper:getPartyType() then
    stcTypeParty:SetShow(true)
    count:SetText(partyWrapper:getCurrentCount() .. "/5")
  elseif CppEnums.PartyType.ePartyType_Large == partyWrapper:getPartyType() then
    stcTypeRaid:SetShow(true)
    count:SetText(partyWrapper:getCurrentCount() .. "/20")
  end
  if currentServerNo == serverNo then
    if myPartyNo == partyNo then
      if true == isPartyLeader then
        if false == PaGlobal_GuildPartyList_All._isPadSnap then
          ...
          btnSupport:addInputEvent("Mouse_LUp", "HandleEventLUp_GuildPartyList_All_Cancle()")
          btnSupport:SetShow(true)
          btnAd:SetShow(true)
          if true == PaGlobal_GuildPartyList_All._isDisable then
            btnAd:SetIgnore(true)
            btnAd:SetMonoTone(true, true)
          else
            btnAd:SetIgnore(false)
            btnAd:SetMonoTone(false, false)
            btnAd:addInputEvent("Mouse_LUp", "HandleEventLUp_GuildPartyList_All_Advertising(" .. _key .. ")")
          end
          content:SetFontColor(Defines.Color.C_FFFFF3AF)
          btnSupport:SetFontColor(Defines.Color.C_FFFFF3AF)
        else
          bg:addInputEvent("Mouse_On", "HandleEventOn_GuildPartyList_All_OnSelectButton(" .. _key .. "," .. PaGlobal_GuildPartyList_All._enum.eTYPE_RECRUITE_CANCEL .. ")")
          bg:addInputEvent("Mouse_LUp", "HandleEventLUp_GuildPartyList_All_ClickSelectButton(" .. _key .. "," .. PaGlobal_GuildPartyList_All._enum.eTYPE_RECRUITE_CANCEL .. ")")
        end
      ...
      if true == isPartyEmpty then
        if false == PaGlobal_GuildPartyList_All._isPadSnap then
          ...
          btnSupport:addInputEvent("Mouse_LUp", "HandleEventLUp_GuildPartyList_All_Support(" .. _key .. ")")
          leader:SetIgnore(false)
          leader:addInputEvent("Mouse_LUp", "HandleEventLUp_GuildPartyList_All_WhisperToLeader(" .. _key .. ")")
          leader:addInputEvent("Mouse_RUp", "HandleEventLUp_GuildPartyList_All_WhisperToLeader(" .. _key .. ")")
        else
          bg:addInputEvent("Mouse_On", "HandleEventOn_GuildPartyList_All_OnSelectButton(" .. _key .. "," .. PaGlobal_GuildPartyList_All._enum.eTYPE_RECRUITE .. ")")
          bg:addInputEvent("Mouse_LUp", "HandleEventLUp_GuildPartyList_All_ClickSelectButton(" .. _key .. "," .. PaGlobal_GuildPartyList_All._enum.eTYPE_RECRUITE .. ")")
        end
      end
      if false == PaGlobal_GuildPartyList_All._isPadSnap then
    ...
    if isAdmission and isPartyEmpty then
      if false == PaGlobal_GuildPartyList_All._isPadSnap then
        ...
        btnSupport:addInputEvent("Mouse_LUp", "HandleEventLUp_GuildPartyList_All_MoveServer(" .. serverNo .. ", " .. partyNo .. ")")
        leader:addInputEvent("Mouse_LUp", "HandleEventLUp_GuildPartyList_All_WhisperToLeader(" .. _key .. ")")
        leader:addInputEvent("Mouse_RUp", "HandleEventLUp_GuildPartyList_All_WhisperToLeader(" .. _key .. ")")
      else
        bg:addInputEvent("Mouse_On", "HandleEventOn_GuildPartyList_All_OnSelectButton(" .. _key .. "," .. PaGlobal_GuildPartyList_All._enum.eTYPE_RECRUITE .. ")")
        bg:addInputEvent("Mouse_LUp", "HandleEventLUp_GuildPartyList_All_ClickSelectButton(" .. _key .. "," .. PaGlobal_GuildPartyList_All._enum.eTYPE_RECRUITE .. "," .. serverNo .. "," .. partyNo .. ")")
      end
    end
  end
  content:EraseAllEffect()
  if nil ~= PaGlobal_GuildPartyList_All._clickedPartyRecruitKey then
    local partyRecruitKey = partyWrapper:getPartyRecruitmentKey()
    if nil ~= partyRecruitKey and tostring(PaGlobal_GuildPartyList_All._clickedPartyRecruitKey) == tostring(partyRecruitKey) then
      content:AddEffect("fUI_PartyList_01A", true, 0, 0)
      PaGlobal_GuildPartyList_All._clickedPartyRecruitKey = nil
    end
  end
  local partyListCount = ToClient_GetRecruitmentPartyListCount()
  if _key == partyListCount - 1 and nil ~= PaGlobal_GuildPartyList_All._clickedPartyRecruitKey then
    Proc_ShowMessage_Ack(PAGetString(Defines.StringSheet_GAME, "LUA_PARTYJOIN_NOPARTY"))
    PaGlobal_GuildPartyList_All._clickedPartyRecruitKey = nil
  end
end
function PaGlobal_GuildPartyList_All:setCrossPlayIcon(targetControl, platformType)
