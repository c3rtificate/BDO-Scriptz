...
function PaGlobal_PartyRecruite_All:controlAll_Init()
  ...
  self._ui.edit_adDescCover = UI.getChildControl(self._ui.stc_centerBg, "MultilineEdit_CoverBox")
  self._ui.stc_level = UI.getChildControl(self._ui.stc_centerBg, "Static_Level")
  self._ui.rdo_PartyNormal = UI.getChildControl(Panel_PartyRecruite_All, "RadioButton_Party")
  self._ui.rdo_PartyLarge = UI.getChildControl(Panel_PartyRecruite_All, "RadioButton_Raid")
  self._panelOriginY = Panel_PartyRecruite_All:GetSizeY()
  self._centerOriginY = self._ui.stc_centerBg:GetSizeY()
end
...
function PaGlobal_PartyRecruite_All:controlConsole_Init()
  ...
  self._ui_console.stc_icon_Y = UI.getChildControl(self._ui_console.stc_bottomBg, "StaticText_Y_ConsoleUI")
end
...
function PaGlobal_PartyRecruite_All:registEventHandler()
  ...
  if false == _ContentsGroup_UsePadSnapping then
    self._ui.edit_adDescCover:addInputEvent("Mouse_LUp", "HandleEventLUp_PartyRecruite_All_TextSet()")
    ...
    Panel_PartyRecruite_All:registerPadEvent(__eConsoleUIPadEvent_Up_Y, "HandleEventLUp_PartyRecruite_All_ChangePartyType()")
...
function PaGlobal_PartyRecruite_All:resize()
  ...
  Panel_PartyRecruite_All:SetPosX(getOriginScreenSizeX() / 2 - Panel_PartyRecruite_All:GetSizeX() / 2)
  Panel_PartyRecruite_All:SetPosY(getOriginScreenSizeY() / 2 - Panel_PartyRecruite_All:GetSizeY() / 2 - 100)
  ...
  if true == _ContentsGroup_UsePadSnapping then
    Panel_PartyRecruite_All:SetSize(Panel_PartyRecruite_All:GetSizeX(), self._panelOriginY - self._ui_pc.btn_admin:GetSizeY())
    self._ui.stc_centerBg:SetSize(self._ui.stc_centerBg:GetSizeX(), self._centerOriginY - self._ui_pc.btn_admin:GetSizeY())
    self._ui_console.stc_bottomBg:ComputePos()
    local tempBtnGroup = {
      self._ui_console.stc_icon_Y,
...
function PaGlobal_PartyRecruite_All:prepareOpen(isGuildParty)
  ...
  self._ui.rdo_PartyNormal:SetCheck(false)
  self._ui.rdo_PartyLarge:SetCheck(false)
  self._ui.rdo_PartyNormal:SetCheck(true)
...
function PaGlobal_PartyRecruite_All:open()
  ...
  if true == _ContentsGroup_UsePadSnapping then
    Panel_PartyRecruite_All:SetShow(true, false)
  else
...
function PaGlobal_PartyRecruite_All:validate()
  ...
  self._ui.edit_adDescCover:isValidate()
  self._ui.edit_adDesc:isValidate()
  self._ui.stc_level:isValidate()
  self._ui.rdo_PartyNormal:isValidate()
  self._ui.rdo_PartyLarge:isValidate()
  if false == _ContentsGroup_UsePadSnapping then
    ...
    self._ui_console.stc_icon_Y:isValidate()
  end
end
