...
function FromClient_Cannon_UpdateCannonStatCount(count, VehicleTpye)
  if not Panel_Cannon_Renew:GetShow() then
    return
  end
...
registerEvent("FromClient_UpdateCannonStatCount", "FromClient_Cannon_UpdateCannonStatCount")
