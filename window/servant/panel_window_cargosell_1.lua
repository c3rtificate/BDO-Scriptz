...
function PaGlobal_CargoSell:registEventHandler()
  ...
  UIScroll.InputEventByControl(Panel_Window_CargoSell, "HandleEvent_PaGlobal_CargoSell_Scroll")
...
function PaGlobal_CargoSell:createSlot()
  ...
  for ii = 0, self._config.slotCount - 1 do
    ...
    if nil == self._blankSlots[ii] then
      ...
      UIScroll.InputEventByControl(slot.empty, "HandleEvent_PaGlobal_CargoSell_Scroll")
