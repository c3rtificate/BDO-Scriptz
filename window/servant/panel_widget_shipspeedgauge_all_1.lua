function PaGlobal_ShipSpeedGauge:initialize()
  ...
  self._ui._stc_okiyluaBlessBG = UI.getChildControl(Panel_Widget_ShipSpeedGauge, "Static_OkiyluaBless_BG")
...
function PaGlobal_ShipSpeedGauge:registEventHandler()
  ...
  registerEvent("FromClient_UpdateOceanCurrent", "FromClient_ShipSpeedGauge_UpdateOceanCurrent")
