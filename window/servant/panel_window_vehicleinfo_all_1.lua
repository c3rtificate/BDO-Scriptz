function PaGlobal_VehicleInfo_All:initialize()
  ...
  self._ui._stc_raceHorseIcon = UI.getChildControl(stc_basicInfo_right, "StaticText_RaceHorse")
  self._ui._stc_twinsIcon = UI.getChildControl(stc_basicInfo_right, "StaticText_Twins")
  self._ui._stc_OnlySpeed = UI.getChildControl(stc_basicInfo_right, "Static_OnlySpeed")
  self._ui._stc_OnlyAcce = UI.getChildControl(stc_basicInfo_right, "Static_OnlyAcce")
  self._ui._stc_OnlyCorner = UI.getChildControl(stc_basicInfo_right, "Static_OnlyCorner")
  self._ui._stc_OnlyBrake = UI.getChildControl(stc_basicInfo_right, "Static_OnlyBrake")
  ...
  self._ui._btn_simulator = UI.getChildControl(stc_basicInfo_right, "Button_Simulator")
  ...
  self._ui._txt_skillChangeConfirmedTitle = UI.getChildControl(stc_specialInfo_left, "StaticText_VehiclePremium_Change")
  self._ui._txt_skillChangeConfirmedValue = UI.getChildControl(stc_specialInfo_left, "StaticText_VehiclePremium_Value")
  ...
  self._ui._btn_returnMasterlessHorse = UI.getChildControl(self._ui._stc_equipSlotGroup, "Button_ReturnBack")
  ...
  self._ui._console.txt_keyGuideRTX = UI.getChildControl(self._ui._console._stc_keyGuideBG, "StaticText_KeyGuideRTX")
  self._keyGuide = {
    self._ui._console.txt_keyGuideRTX,
  ...
  self._selectString = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_GENERIC_KEYGUIDE_XBOX_SELECT")
  self._skillLockString = PAGetString(Defines.StringSheet_RESOURCE, "LUA_SKILL_SKILLROCK")
  ...
  local list2_contents = UI.getChildControl(self._ui._list2_horseSkillList, "List2_1_Content")
  local stc_skillName = UI.getChildControl(list2_contents, "Static_SkillName")
  local txt_skillName = UI.getChildControl(stc_skillName, "StaticText_VehicleName")
  local stc_skillStallionIcon = UI.getChildControl(stc_skillName, "Static_SkillStallionIcon")
  self._skillNameBaseSpanSizeX = txt_skillName:GetSpanSize().x
  self._skillStallionIconBaseSpanSizeX = stc_skillStallionIcon:GetSpanSize().x
  self._speedValueBasePosX = self._ui._txt_speedValue:GetPosX()
  self._acceValueBasePosX = self._ui._txt_speedValue:GetPosX()
  self._cornerValueBasePosX = self._ui._txt_speedValue:GetPosX()
  self._brakeValueBasePosX = self._ui._txt_speedValue:GetPosX()
  self._ui._txt_shape = UI.getChildControl(stc_basicInfo_right, "StaticText_Shape")
  self._ui._txt_shapeValue = UI.getChildControl(stc_basicInfo_right, "StaticText_Shape_Value")
  self._skillChangeConfirmedSpanSizeY = self._ui._txt_skillChangeConfirmedTitle:GetSpanSize().y
  self._ui._sct_tooltip = UI.getChildControl(Panel_Window_VehicleInfo_All, "Static_TooltipBg")
  self._ui._txt_tooltipTitle = UI.getChildControl(self._ui._sct_tooltip, "StaticText_TooltipTitle")
  self._ui._txt_tooltipDesc = UI.getChildControl(self._ui._sct_tooltip, "StaticText_TooltipDesc")
  self._ui._txt_tooltipDesc:SetTextMode(__eTextMode_AutoWrap)
  local tempSkillIcon = UI.getChildControl(self._ui._sct_tooltip, "Static_SkillIcon_Temp")
  local tempSkillName = UI.getChildControl(self._ui._sct_tooltip, "StaticText_SkillName_Temp")
  for index = 1, self._maxStallionSkillCount do
    self._ui._sct_tooltipSkillIcon[index] = UI.createControl(__ePAUIControl_Static, self._ui._sct_tooltip, "Static_TooltipSkillIcon_" .. index)
    CopyBaseProperty(tempSkillIcon, self._ui._sct_tooltipSkillIcon[index])
    self._ui._sct_tooltipSkillIcon[index]:SetShow(false)
    self._ui._txt_tooltipSkillName[index] = UI.createControl(__ePAUIControl_StaticText, self._ui._sct_tooltip, "Static_TooltipSkillName_" .. index)
    CopyBaseProperty(tempSkillName, self._ui._txt_tooltipSkillName[index])
    self._ui._txt_tooltipSkillName[index]:SetShow(false)
    self._ui._txt_tooltipSkillName[index]:SetTextMode(__eTextMode_AutoWrap)
  end
...
function PaGlobal_VehicleInfo_All:registEventHandler()
  ...
  if _ContentsGroup_HorseSimulator == true then
    self._ui._btn_simulator:addInputEvent("Mouse_LUp", "HandleEventLUp_VehicleInfo_All_ToggleServantSimulator()")
  end
  self._ui._btn_simulator:SetShow(_ContentsGroup_HorseSimulator)
  ...
  self._ui._stc_OnlySpeed:addInputEvent("Mouse_On", "HandleEventOnOut_VehicleInfo_All_ShowUseAddStatItemTooltip(true," .. __eServantStatTypeSpeed .. ")")
  self._ui._stc_OnlySpeed:addInputEvent("Mouse_Out", "HandleEventOnOut_VehicleInfo_All_ShowUseAddStatItemTooltip(false)")
  self._ui._stc_OnlyAcce:addInputEvent("Mouse_On", "HandleEventOnOut_VehicleInfo_All_ShowUseAddStatItemTooltip(true," .. __eServantStatTypeAcceleration .. ")")
  self._ui._stc_OnlyAcce:addInputEvent("Mouse_Out", "HandleEventOnOut_VehicleInfo_All_ShowUseAddStatItemTooltip(false)")
  self._ui._stc_OnlyCorner:addInputEvent("Mouse_On", "HandleEventOnOut_VehicleInfo_All_ShowUseAddStatItemTooltip(true," .. __eServantStatTypeCornering .. ")")
  self._ui._stc_OnlyCorner:addInputEvent("Mouse_Out", "HandleEventOnOut_VehicleInfo_All_ShowUseAddStatItemTooltip(false)")
  self._ui._stc_OnlyBrake:addInputEvent("Mouse_On", "HandleEventOnOut_VehicleInfo_All_ShowUseAddStatItemTooltip(true," .. __eServantStatTypeBrake .. ")")
  self._ui._stc_OnlyBrake:addInputEvent("Mouse_Out", "HandleEventOnOut_VehicleInfo_All_ShowUseAddStatItemTooltip(false)")
  registerEvent("FromClient_OpenServantInformation", "FromClient_VehicleInfo_All_OpenSevantInfomation")
  registerEvent("EventSelfServantUpdateUI", "FromClient_VehicleInfo_All_UpdateAll")
  ...
  self._ui._btn_returnMasterlessHorse:addInputEvent("Mouse_LUp", "HandleEventLUp_VehicleInfo_All_ReturnMasterlessHorse()")
  self._ui._btn_returnMasterlessHorse:addInputEvent("Mouse_On", "HandleEventOnOut_VehicleInfo_All_ReturnMasterlessHorseToolTip(true)")
  self._ui._btn_returnMasterlessHorse:addInputEvent("Mouse_Out", "HandleEventOnOut_VehicleInfo_All_ReturnMasterlessHorseToolTip(false)")
end
function PaGlobal_VehicleInfo_All:stallionSkillCheck(actorKeyRaw)
  local servantWrapper = getServantInfoFromActorKey(actorKeyRaw)
  if nil == servantWrapper then
    return
  end
  self._stallionSkillIndex = {}
  local maxSearchCount = 100
  for ii = 1, maxSearchCount do
    local skillWrapper = servantWrapper:getSkill(ii)
    if nil ~= skillWrapper then
      local isStallionSkill = servantWrapper:isStallionSkill(skillWrapper:getKey())
      if true == isStallionSkill then
        table.insert(self._stallionSkillIndex, ii)
      end
    else
      skillWrapper = servantWrapper:getSkillXXX(ii)
      if nil ~= skillWrapper then
        local isStallionSkill = servantWrapper:isStallionSkill(skillWrapper:getKey())
        if true == isStallionSkill then
          table.insert(self._stallionSkillIndex, ii)
...
function PaGlobal_VehicleInfo_All:prepareOpen(viewType, actorKeyRaw)
  ...
  local isShow = Panel_Window_VehicleInfo_All:GetShow()
  self:initSkillList()
  ...
  for index, value in pairs(self._equipConfig._horse) do
    if self._eViewType._normal == viewType and CppEnums.VehicleType.Type_Elephant ~= VehicleType and self._horseShoesIndex ~= value._index then
      ...
      local isCheck = ToClient_IsSetVehicleEquipSlotFlag(actorKeyRaw, value._index)
      self._ui._chk_equipShow[value._index]:SetCheck(isCheck)
    end
  end
  local canFeed = CppEnums.VehicleType.Type_Horse == VehicleType or CppEnums.VehicleType.Type_Donkey == VehicleType or CppEnums.VehicleType.Type_Camel == VehicleType or CppEnums.VehicleType.Type_RidableBabyElephant == VehicleType
  if true == self._isConsole then
  ...
  self:setSkillLockKeyguide(false)
  self._ui._btn_returnMasterlessHorse:SetShow(false)
  if PaGlobalFunc_HorseWithoutOwner_All_CheckMasterlessHorse ~= nil then
    local isMasterlessHorse = PaGlobalFunc_HorseWithoutOwner_All_CheckMasterlessHorse(servantWrapper:getCharacterKeyRaw())
    self._ui._btn_returnMasterlessHorse:SetShow(isMasterlessHorse)
  end
  if true == _ContentsGroup_FamilyInventory and false == isShow then
    PaGlobalFunc_Inventory_All_familyInventoryButtonActive(false)
  end
  Inventory_SetFunctor(PaGlobal_VehicleInfo_All_BasicFilter, nil, PaGlobal_VehicleInfo_All_Close_Inventory, nil)
...
function PaGlobal_VehicleInfo_All:validate()
  ...
  self._ui._stc_OnlyAcce:isValidate()
  self._ui._stc_OnlyCorner:isValidate()
  self._ui._stc_OnlyBrake:isValidate()
  self._ui._txt_skillChangeConfirmedTitle:isValidate()
  self._ui._txt_skillChangeConfirmedValue:isValidate()
end
...
function PaGlobal_VehicleInfo_All:updateBasicInfo_leftBg_noraml()
  ...
  if (__eVehicleType_Horse == servantWrapper:getVehicleType() or CppEnums.VehicleType.Type_RaceHorse == servantWrapper:getVehicleType()) and true == servantWrapper:isDisplayGender() then
...
function PaGlobal_VehicleInfo_All:updateBasicInfo_rightBg_normal()
  ...
  self._ui._stc_raceHorseIcon:SetShow(false)
  self._ui._stc_twinsIcon:SetShow(false)
  ...
  self._ui._txt_accelerationValue:SetPosX(self._acceValueBasePosX)
  self._ui._stc_OnlyCorner:SetShow(false)
  self._ui._txt_corneringValue:SetPosX(self._cornerValueBasePosX)
  self._ui._stc_OnlyBrake:SetShow(false)
  self._ui._txt_brakeValue:SetPosX(self._brakeValueBasePosX)
  if true == self._isConsole then
  ...
  local vehicleType = servantWrapper:getVehicleType()
  local vehicleSubType = servantWrapper:getVehicleSubType()
  local servantTitleName = ToClient_GetServantTitleName(servantWrapper:getCharacterKeyRaw())
  if "" ~= servantTitleName then
    self._ui._txt_shape:SetTextMode(__eTextMode_AutoWrap)
    self._ui._txt_shapeValue:SetTextMode(__eTextMode_AutoWrap)
    self._ui._txt_shape:SetShow(true)
    self._ui._txt_shapeValue:SetShow(true)
    self._ui._txt_shape:SetText(self._ui._txt_shape:GetText())
    self._ui._txt_shapeValue:SetText(servantTitleName)
  else
    self._ui._txt_shape:SetShow(false)
    self._ui._txt_shapeValue:SetShow(false)
  end
  if __eVehicleType_Horse == vehicleType or CppEnums.VehicleType.Type_RaceHorse == vehicleType then
    self._ui._txt_tierValue:SetShow(true)
    if true == self._isConsole then
      self._ui._console.txt_keyGuideLTY:SetShow(true)
      Panel_Window_VehicleInfo_All:registerPadEvent(__eConsoleUIPadEvent_LTPress_Y, "PaGlobalFunc_VehicleInfo_All_ServantTierTooltipForConsole()")
    end
    self._ui._txt_tierValue:SetText("")
    local tierName = servantWrapper:getDisplayTierName()
    if nil ~= tierName then
      self._ui._txt_tierValue:SetText(tierName)
    end
    if servantWrapper:getTier() < 9 and false == servantWrapper:isPcroomOnly() and self._isContentsStallion then
      local isStallion = servantWrapper:isStallion()
      local goodHorseIconShow = 0 < #self._stallionSkillIndex
      self._ui._stc_goodHorseIcon:SetShow(goodHorseIconShow)
      if true == self._isConsole then
      ...
      if true == isStallion then
        ...
        self._ui._stc_raceHorseIcon:SetMonoTone(false)
      else
        self._ui._stc_goodHorseIcon:SetMonoTone(true)
        self._ui._stc_raceHorseIcon:SetMonoTone(true)
      end
    end
    if true == self._isConsole then
    ...
    self._ui._stc_raceHorseIcon:SetPosX(self._ui._txt_tierValue:GetPosX() - self._ui._stc_raceHorseIcon:GetSizeX())
    self._ui._stc_twinsIcon:SetPosX(self._ui._txt_tierValue:GetPosX() - self._ui._stc_raceHorseIcon:GetSizeX())
    if vehicleType == CppEnums.VehicleType.Type_RaceHorse then
      self._ui._stc_raceHorseIcon:SetShow(true)
      self._ui._stc_goodHorseIcon:SetShow(false)
    elseif vehicleType == CppEnums.VehicleType.Type_Horse and vehicleSubType == __eTVehicleSubType_MutationHorse then
      self._ui._stc_twinsIcon:SetShow(true)
      self._ui._stc_goodHorseIcon:SetShow(false)
    else
      self._ui._stc_raceHorseIcon:SetShow(false)
    end
    ...
    if __eVehicleType_Horse == vehicleType then
      local speedAddItemUseCount = servantWrapper:getAddStatItemUseCount(__eServantStatTypeSpeed)
      if speedAddItemUseCount > 0 then
        self._ui._txt_speedValue:SetPosX(self._speedValueBasePosX - self._ui._stc_OnlySpeed:GetSizeX())
        self._ui._stc_OnlySpeed:SetShow(true)
      end
      local acceAddItemUseCount = servantWrapper:getAddStatItemUseCount(__eServantStatTypeAcceleration)
      if acceAddItemUseCount > 0 then
        self._ui._txt_accelerationValue:SetPosX(self._acceValueBasePosX - self._ui._stc_OnlyAcce:GetSizeX())
        self._ui._stc_OnlyAcce:SetShow(true)
      end
      local cornerAddItemUseCount = servantWrapper:getAddStatItemUseCount(__eServantStatTypeCornering)
      if cornerAddItemUseCount > 0 then
        self._ui._txt_corneringValue:SetPosX(self._cornerValueBasePosX - self._ui._stc_OnlyCorner:GetSizeX())
        self._ui._stc_OnlyCorner:SetShow(true)
      end
      local brakeAddItemUseCount = servantWrapper:getAddStatItemUseCount(__eServantStatTypeBrake)
      if brakeAddItemUseCount > 0 then
        self._ui._txt_brakeValue:SetPosX(self._brakeValueBasePosX - self._ui._stc_OnlyBrake:GetSizeX())
  ...
  if CppEnums.VehicleType.Type_Horse == vehicleType or CppEnums.VehicleType.Type_Donkey == vehicleType then
...
function PaGlobal_VehicleInfo_All:updateSpecialInfo_leftBg_normal()
  ...
  elseif servantWrapper:getTier() < 9 then
    ...
    isShowMatingCount = true
  else
    self._ui._txt_matingCountTitle:SetShow(false)
    self._ui._txt_matingCount:SetShow(false)
  end
  local servantType = servantWrapper:getVehicleType()
  if false == servantWrapper:isGuildServant() and true == servantWrapper:doHaveVehicleSkill() and (servantType == CppEnums.VehicleType.Type_Horse or servantType == CppEnums.VehicleType.Type_Camel or servantType == CppEnums.VehicleType.Type_Donkey or servantType == CppEnums.VehicleType.Type_Elephant or servantType == CppEnums.VehicleType.Type_RidableBabyElephant) then
    self._ui._txt_skillChangeConfirmedTitle:SetShow(true)
    self._ui._txt_skillChangeConfirmedValue:SetShow(true)
    if true == isShowMatingCount then
      self._ui._txt_skillChangeConfirmedTitle:SetSpanSize(self._ui._txt_skillChangeConfirmedTitle:GetSpanSize().x, self._skillChangeConfirmedSpanSizeY)
      self._ui._txt_skillChangeConfirmedValue:SetSpanSize(self._ui._txt_skillChangeConfirmedValue:GetSpanSize().x, self._skillChangeConfirmedSpanSizeY)
    else
      self._ui._txt_skillChangeConfirmedTitle:SetSpanSize(self._ui._txt_skillChangeConfirmedTitle:GetSpanSize().x, self._ui._txt_matingCountTitle:GetSpanSize().y)
      self._ui._txt_skillChangeConfirmedValue:SetSpanSize(self._ui._txt_skillChangeConfirmedValue:GetSpanSize().x, self._ui._txt_matingCountTitle:GetSpanSize().y)
    end
    local isMasterlessHorse = servantWrapper:isMasterlessHorse()
    local valueText = ""
    if servantWrapper:getServantSkillChangeConfirmedCount() > 0 or isMasterlessHorse == true then
      valueText = PAGetString(Defines.StringSheet_GAME, "LUA_SERVANT_SKILLCHANGE_COUPON_DISABLE")
    else
      valueText = PAGetString(Defines.StringSheet_GAME, "LUA_SERVANT_SKILLCHANGE_COUPON_ABLE")
    end
    self._ui._txt_skillChangeConfirmedValue:SetText(valueText)
    UI.setLimitTextAndAddTooltip(self._ui._txt_skillChangeConfirmedTitle)
    UI.setLimitTextAndAddTooltip(self._ui._txt_skillChangeConfirmedValue)
  else
    self._ui._txt_skillChangeConfirmedTitle:SetShow(false)
    self._ui._txt_skillChangeConfirmedValue:SetShow(false)
  end
end
...
function PaGlobal_VehicleInfo_All:updateSpecialInfo_rightBg_normal()
  ...
  if servantWrapper:isMasterlessHorse() == true then
    self._ui._txt_sealValue:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_SERVANT_SKILLCHANGE_COUPON_DISABLE"))
    self._ui._txt_remainPeriod:SetText("-")
  end
end
...
function PaGlobal_VehicleInfo_All:updateEquipInfo_data(viewType, slotNoList)
  ...
  for index, value in pairs(slotNoList) do
    ...
    self._ui._stc_equipSlot[value._index]:addInputEvent("Mouse_LUp", "PaGlobal_VehicleInfo_All_ItemAcquireHelper(" .. value._index .. ", " .. tostring(VehicleType) .. " )")
    self._ui._stc_equipSlot[value._index]:addInputEvent("Mouse_On", "PaGlobal_VehicleInfo_All:hadlerEventOnOutEmptySlot( true, " .. value._index .. ", " .. tostring(viewType) .. " )")
    self._ui._stc_equipSlot[value._index]:addInputEvent("Mouse_Out", "PaGlobal_VehicleInfo_All:hadlerEventOnOutEmptySlot()")
...
function PaGlobal_VehicleInfo_All:hadlerEventOnOutEmptySlot(isShow, slotNo, viewType)
  local isShowKeyGuideY = false
  local servantWrapper = getServantInfoFromActorKey(self._actorKeyRaw)
  if nil == servantWrapper then
    return
  end
  local vehicleType = servantWrapper:getVehicleType()
  if self._eViewType._normal == viewType and CppEnums.VehicleType.Type_Elephant ~= vehicleType and self._horseShoesIndex ~= slotNo and self._isConsole == true then
    isShowKeyGuideY = true
  end
  if nil == isShow or false == isShow then
    TooltipSimple_Hide()
    HandleEventOn_VehicleInfo_All_SetKeyGuideY(false)
    return
  end
  ...
  if isShowKeyGuideY == true then
    HandleEventOn_VehicleInfo_All_SetKeyGuideY(true)
  end
end
...
function PaGlobal_VehicleInfo_All:updateSkillInfo_carriage()
  ...
  if self._isFirstOpen == true then
    ...
    self._ui._list2_carriageSkillList:requestUpdateVisible()
    self._ui._list2_horseList:requestUpdateVisible()
  end
end
function PaGlobal_VehicleInfo_All:updateSkill(list2Control, noSkillControl, isNoSkillHide)
  ...
  local learnableSkillCount = 0
  local learnableSkillIndex = listCount
  for ii = 1, maxSearchCount do
    local skillWrapper = servantWrapper:getSkillXXX(ii)
    if nil ~= skillWrapper and false == skillWrapper:isTrainingSkill() then
      learnableSkillCount = learnableSkillCount + 1
      learnableSkillIndex = learnableSkillIndex + 1
      self._skillIndexList[learnableSkillIndex] = ii
      list2Control:getElementManager():pushKey(toInt64(0, learnableSkillIndex))
    end
  end
  local skillDiceCount = 0
  listCount = learnableSkillIndex
  if true == _ContentsGroup_HorseSkillLearnNewWay then
    skillDiceCount = servantWrapper:getServantSkillDiceCount()
    maxSearchCount = maxSearchCount + 1
    local maxDiceSearchCount = maxSearchCount + skillDiceCount - 1
    for ii = maxSearchCount, maxDiceSearchCount do
      listCount = listCount + 1
      self._skillIndexList[listCount] = ii
      list2Control:getElementManager():pushKey(toInt64(0, listCount))
    end
  ...
  local skillCountString = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_SERVANTINFO_SKILLCOUNT", "servantSkillListCnt", listCount - skillDiceCount - learnableSkillCount)
  if nil ~= skillCountString then
    if true == _ContentsGroup_HorseSkillLearnNewWay then
      skillCountString = skillCountString .. " + (" .. tostring(skillDiceCount) .. ")"
    end
    self._ui._txt_skillTitle:SetText(skillCountString)
  end
end
...
function PaGlobal_VehicleInfo_All:updateSkillList(control, key)
  ...
  local skillWrapperXXX = servantWrapper:getSkillXXX(self._skillIndexList[index])
  if nil == skillWrapper and nil == skillWrapperXXX and false == _ContentsGroup_HorseSkillLearnNewWay then
    return
  end
  ...
  local stc_skillStallionIcon = UI.getChildControl(stc_BG, "Static_SkillStallionIcon")
  local skillNameSpanSizeX = self._skillNameBaseSpanSizeX
  local skillStallionIconSpanSizeX = self._skillStallionIconBaseSpanSizeX
  local gabX1 = 8
  local gabX2 = 20
  if nil == skillWrapper and nil == skillWrapperXXX and true == _ContentsGroup_HorseSkillLearnNewWay then
    txt_skillName:SetText("")
    txt_skillDesc:SetTextMode(__eTextMode_Limit_AutoWrap)
    txt_skillDesc:SetText("")
    stc_skillBG:addInputEvent("Mouse_LUp", "HandleEventLUp_VehicleInfo_All_LearnServantSkillByDiceCount(1)")
    stc_skillBG:addInputEvent("Mouse_On", "")
    stc_skillBG:addInputEvent("Mouse_Out", "")
    progress_skillExp:SetShow(false)
    txt_skillPercent:SetShow(false)
    stc_warning:SetShow(false)
    stc_warning:addInputEvent("Mouse_On", "")
    stc_warning:addInputEvent("Mouse_Out", "")
    chk_skillLockIcon:SetShow(false)
  elseif nil ~= skillWrapperXXX then
    control:SetMonoTone(true)
    txt_skillName:SetText(skillWrapperXXX:getName())
    local isStallionSkill = servantWrapper:isStallionSkill(skillWrapperXXX:getKey())
    stc_skillStallionIcon:SetShow(isStallionSkill)
    if true == isStallionSkill then
      skillNameSpanSizeX = skillNameSpanSizeX + stc_skillStallionIcon:GetSizeX() - gabX1
      if false == self._isConsole then
        stc_skillStallionIcon:addInputEvent("Mouse_On", "HandleEventOnOut_VehicleInfo_All_ShowStallionToolTip(true," .. index .. ")")
        stc_skillStallionIcon:addInputEvent("Mouse_Out", "HandleEventOnOut_VehicleInfo_All_ShowStallionToolTip(false)")
      end
    end
    stc_skillStallionIcon:SetSpanSize(skillStallionIconSpanSizeX, stc_skillStallionIcon:GetSpanSize().y)
    txt_skillName:SetSpanSize(skillNameSpanSizeX, txt_skillName:GetSpanSize().y)
    txt_skillDesc:SetTextMode(__eTextMode_Limit_AutoWrap)
    txt_skillDesc:SetText(skillWrapperXXX:getDescription())
    stc_skillBG:ChangeTextureInfoName("Icon/" .. skillWrapperXXX:getIconPath())
    stc_skillBG:addInputEvent("Mouse_LUp", "")
    if true == self._isConsole then
      stc_skillBG:addInputEvent("Mouse_On", "HandleEventOnOut_VehicleInfo_All_SnappingSkill(true, " .. index .. ")")
      stc_skillBG:addInputEvent("Mouse_Out", "HandleEventOnOut_VehicleInfo_All_SnappingSkill(false)")
    else
    ...
    progress_skillExp:SetShow(false)
    txt_skillPercent:SetShow(false)
    if "" ~= skillWrapperXXX:getConditionDescription() then
    ...
    progress_skillExp:SetShow(true)
    txt_skillPercent:SetShow(true)
    ...
    if true == _ContentsGroup_ServantSkill_Lock and false == servantWrapper:isGuildServant() then
      ...
      if ToClient_checkCanBlockVehicleSkillCommand(skillKey) then
        skillNameSpanSizeX = skillNameSpanSizeX + chk_skillLockIcon:GetSizeX()
        skillStallionIconSpanSizeX = skillStallionIconSpanSizeX + gabX2
        ...
        if true == self._isConsole then
          stc_skillBG:addInputEvent("Mouse_LUp", "HandleEventLUp_VehicleInfo_All_ServantSkillLock(" .. index .. ",true)")
        end
      else
        chk_skillLockIcon:SetShow(false)
      end
...
function PaGlobal_VehicleInfo_All:updateServantSkillLock(index, isSkillBGClick)
  local servantWrapper = getServantInfoFromActorKey(self._actorKeyRaw)
  if nil == servantWrapper then
    return
  end
  ...
  local stc_skillBG = UI.getChildControl(stc_BG, "Static_VehicleSkillBG")
  local chk_skillLockIcon = UI.getChildControl(stc_BG, "CheckButton_SkillLockIcon")
  if nil ~= isSkillBGClick and true == isSkillBGClick then
...
function PaGlobal_VehicleInfo_All:updateHorseList(control, key)
  ...
  local stc_horseFemaleIcon = UI.getChildControl(btn_carriageHorse, "Static_VehicleFemale")
  local stc_horseMaleIcon = UI.getChildControl(btn_carriageHorse, "Static_VehicleMale")
  if (__eVehicleType_Horse == servantInfo:getVehicleType() or CppEnums.VehicleType.Type_RaceHorse == servantInfo:getVehicleType()) and true == servantInfo:isDisplayGender() then
    local isMale = servantInfo:isMale()
    stc_horseFemaleIcon:SetShow(not isMale)
    stc_horseMaleIcon:SetShow(isMale)
  else
    stc_horseFemaleIcon:SetShow(false)
    stc_horseMaleIcon:SetShow(false)
  end
  ...
  txt_horseTier:SetText("")
  local tierName = servantInfo:getDisplayTierName()
  if nil ~= tierName then
    txt_horseTier:SetText(tierName)
  end
...
function PaGlobal_VehicleInfo_All:isCheckTank(vehicleType)
  if __eVehicleType_Tank == vehicleType then
    return true
  end
  return false
end
function PaGlobal_VehicleInfo_All:isCheckCarriage(vehicleType)
  if __eVehicleType_Carriage == vehicleType or __eVehicleType_CowCarriage == vehicleType or __eVehicleType_RepairableCarriage == vehicleType then
    return true
  end
  return false
end
...
function PaGlobal_VehicleInfo_All:setSkillLockKeyguide(isSkillLock)
  ...
  if true == self._ui._console.txt_keyGuideA:GetShow() then
    if true == isSkillLock then
      self._ui._console.txt_keyGuideA:SetText(self._skillLockString)
    else
      self._ui._console.txt_keyGuideA:SetText(self._selectString)
    end
  end
  self:setAlignKeyGuide()
end
...
function PaGlobal_VehicleInfo_All_BasicFilter(slotNo, notUse_itemWrappers, whereType)
