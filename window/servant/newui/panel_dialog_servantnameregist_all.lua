PaGlobal_ServantNameRegist_All = {
  _ui = {
    ...
    _stc_KeyGuide_B = nil,
    _stc_OnlySpeed = nil,
    _stc_Mutation_ContentBg = nil,
    _stc_Mutation_HorseImage = nil,
    _stc_Mutation_GenderIcon = nil,
    _txt_Mutation_HpTitle = nil,
    _txt_Mutation_HpValue = nil,
    _txt_Mutation_StaminaTitle = nil,
    _txt_Mutation_StaminaValue = nil,
    _txt_Mutation_WeightTitle = nil,
    _txt_Mutation_WeightValue = nil,
    _txt_Mutation_LeftLifeTitle = nil,
    _txt_Mutation_LeftLifeValue = nil,
    _txt_Mutation_SpeedTitle = nil,
    _txt_Mutation_SpeedValue = nil,
    _txt_Mutation_AccelTitle = nil,
    _txt_Mutation_AccelValue = nil,
    _txt_Mutation_CorneringTitle = nil,
    _txt_Mutation_CorneringValue = nil,
    _txt_Mutation_BreakTitle = nil,
    _txt_Mutation_BreakValue = nil,
    _stc_Mutation_EditNaming = nil,
    _stc_Mutation_KeyGuide_LT = nil,
    _stc_Mutation_KeyGuide_Plus = nil,
    _stc_Mutation_KeyGuide_X = nil
  },
  _ENUM_OPENTYPE = {
    ...
    _REGISTER_RENTAL = CppEnums.ServantRegist.eEventType_RegisterRent
  },
