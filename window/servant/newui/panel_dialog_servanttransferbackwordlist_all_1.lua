...
function PaGlobal_ServantTransferBackwardList_All:update()
  ...
  local servantCount = ToClient_getReverseTransferableListCountByRegionKey(self._currentRegionKey)
  for index = 0, servantCount - 1 do
    self._ui._list2_Servant:getElementManager():pushKey(toInt64(0, index))
  end
...
function PaGlobal_ServantTransferBackwardList_All:list2Update(content, key)
  ...
  local servantInfo = ToClient_getReverseTransferableServantInfo(self._currentRegionKey, key32)
