function PaGlobal_ServantMarket_Rental_Mating_All:initialize()
  ...
  local tempSlot = UI.getChildControl(Panel_Dialog_ServantMarket_Rental_Mating_All, "Static_Slot_1")
...
function PaGlobal_ServantMarket_Rental_Mating_All:registerEventHandler(isConsole)
  ...
  if false == isConsole then
    ...
    self._ui._btn_Reload_PC:SetShow(true)
    ...
    Panel_Dialog_ServantMarket_Rental_Mating_All:registerPadEvent(__eConsoleUIPadEvent_DpadLeft, "HandleEventPadPress_ServantMarket_Rental_Mating_All_MoveSnapping(false)")
    Panel_Dialog_ServantMarket_Rental_Mating_All:registerPadEvent(__eConsoleUIPadEvent_DpadRight, "HandleEventPadPress_ServantMarket_Rental_Mating_All_MoveSnapping(true)")
    self._ui._btn_Reload_PC:SetShow(false)
  end
end
    ...
    if nil ~= auctionServantInfo and slotNo < self._MAXSLOTCOUNT then
      ...
      if __eVehicleType_Horse == servantType then
        ...
        if speedAddItemUseCount > 0 then
          ...
          slot._stc_OnlySpeed:addInputEvent("Mouse_On", "HandleEventOnOut_ServantMarket_Rental_Mating_All_ShowUseAddStatItemTooltip(true," .. slotNo .. "," .. __eServantStatTypeSpeed .. ")")
          slot._stc_OnlySpeed:addInputEvent("Mouse_Out", "HandleEventOnOut_ServantMarket_Rental_Mating_All_ShowUseAddStatItemTooltip(false)")
        end
        ...
        if acceAddItemUseCount > 0 then
          ...
          slot._stc_OnlyAcce:addInputEvent("Mouse_On", "HandleEventOnOut_ServantMarket_Rental_Mating_All_ShowUseAddStatItemTooltip(true," .. slotNo .. "," .. __eServantStatTypeAcceleration .. ")")
          slot._stc_OnlyAcce:addInputEvent("Mouse_Out", "HandleEventOnOut_ServantMarket_Rental_Mating_All_ShowUseAddStatItemTooltip(false)")
        end
        ...
        if cornerAddItemUseCount > 0 then
          ...
          slot._stc_OnlyCorner:addInputEvent("Mouse_On", "HandleEventOnOut_ServantMarket_Rental_Mating_All_ShowUseAddStatItemTooltip(true," .. slotNo .. "," .. __eServantStatTypeCornering .. ")")
          slot._stc_OnlyCorner:addInputEvent("Mouse_Out", "HandleEventOnOut_ServantMarket_Rental_Mating_All_ShowUseAddStatItemTooltip(false)")
        end
        ...
        if brakeAddItemUseCount > 0 then
          ...
          slot._stc_OnlyBrake:addInputEvent("Mouse_On", "HandleEventOnOut_ServantMarket_Rental_Mating_All_ShowUseAddStatItemTooltip(true," .. slotNo .. "," .. __eServantStatTypeBrake .. ")")
          slot._stc_OnlyBrake:addInputEvent("Mouse_Out", "HandleEventOnOut_ServantMarket_Rental_Mating_All_ShowUseAddStatItemTooltip(false)")
        end
      end
...
function PaGlobal_ServantMarket_Rental_Mating_All:list2Update(content, key, slotIdx)
  ...
  if nil ~= skillWrapper then
    ...
    if true == self._isConsole then
      skillIcon:addInputEvent("Mouse_On", "HandleEventOnOut_ServantMarket_Rental_Mating_All_SnappingSkill(true," .. actorKeyRaw .. ", " .. key32 .. ")")
      skillIcon:addInputEvent("Mouse_Out", "HandleEventOnOut_ServantMarket_Rental_Mating_All_SnappingSkill(false)")
    else
    ...
    if true == isStallionSkill then
      ...
      if false == self._isConsole then
        skillStallionIcon:addInputEvent("Mouse_On", "HandleEventOnOut_ServantMarket_Rental_Mating_All_ShowStallionToolTip(true," .. key32 .. "," .. slotIdx .. ")")
        skillStallionIcon:addInputEvent("Mouse_Out", "HandleEventOnOut_ServantMarket_Rental_Mating_All_ShowStallionToolTip(false)")
      end
    end
