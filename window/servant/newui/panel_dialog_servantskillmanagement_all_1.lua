function PaGlobal_ServantSkillManagement_All:initialize()
  ...
  self._ui._btn_Change_Premium = UI.getChildControl(self._ui._stc_Center_WishSKillBg, "Button_Change_Premium")
  ...
  self._ui._stc_KeyGuide_LB_Y = UI.getChildControl(self._ui._stc_BottomBg_Console, "StaticText_LB_Y_ConsoleUI")
  self._ui._stc_KeyGuide_LB_Y:SetShow(false)
...
function PaGlobal_ServantSkillManagement_All:registerEventHandler(isConsole)
  ...
  if false == isConsole then
    ...
    self._ui._btn_Change_Premium:addInputEvent("Mouse_LUp", "HandleEventLUp_ServantSkillManagement_All_SkillChangeConfirmed()")
    Panel_Dialog_ServantSkillManagement_All:SetDragEnable(true)
    Panel_Dialog_ServantSkillManagement_All:SetDragAll(true)
  else
...
function PaGlobal_ServantSkillManagement_All:isConsoleUI(isConsole)
  ...
  self._ui._btn_Change_Premium:SetShow(not isConsole)
...
function PaGlobal_ServantSkillManagement_All:resize()
  ...
  self._ui._btn_Change_Premium:ComputePos()
...
function PaGlobal_ServantSkillManagement_All:updateList2_LearnedSKillTab(content, key)
  if false == Panel_Dialog_ServantSkillManagement_All:GetShow() or nil == Panel_Dialog_ServantSkillManagement_All then
    return
  end
...
function PaGlobal_ServantSkillManagement_All:updateList2_UnLearnSKill(content, key)
  ...
  if false == self._isShowSkillChangeRate then
    ...
    local calculratedRate = PaGlobalFunc_Util_MakeRateDotString(rate, 4, true)
...
function PaGlobal_ServantSkillManagement_All:validate()
  ...
  self._ui._stc_KeyGuide_LB_Y:isValidate()
  self._ui._stc_KeyGuide_X:isValidate()
  self._ui_stc_KeyGuide_Scroll:isValidate()
  self._initailize = true
end
function PaGlobal_ServantSkillManagement_All:getServantInfo()
  if Panel_Dialog_ServantSkillManagement_All == nil then
    return nil
  end
  if self._currentServantNo == nil then
    return nil
  end
  return stable_getServant(self._currentServantNo)
end
