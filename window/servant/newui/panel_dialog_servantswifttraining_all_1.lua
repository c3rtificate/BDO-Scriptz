function PaGlobal_ServantSwiftTraining_All:initialize()
  ...
  Panel_Dialog_ServantSwiftTraining_All:ignorePadSnapMoveToOtherPanel()
  ...
  self._ui._stc_RateGuide = UI.getChildControl(self._ui._txt_Stack, "StaticText_RateGuide")
  ...
  self._ui._chk_skipAni = UI.getChildControl(self._ui._stc_MainBg, "CheckButton_Skip")
  ...
  for i = 0, self._slotCount - 1 do
    ...
    if 0 == i then
      ...
      trainingUI._materialIconSlot.icon:addInputEvent("Mouse_RUp", "HandleEventLUp_ServantSwiftTraining_All_ItemClear(0)")
    elseif 1 == i then
      ...
      trainingUI._materialIconSlot:createChild()
      trainingUI._materialIconSlot.icon:addInputEvent("Mouse_RUp", "HandleEventLUp_ServantSwiftTraining_All_ItemClear(1)")
    else
      ...
      trainingUI._materialIconSlot:createChild()
      trainingUI._materialIconSlot.icon:addInputEvent("Mouse_RUp", "HandleEventLUp_ServantSwiftTraining_All_ItemClear(2)")
    end
...
function PaGlobal_ServantSwiftTraining_All:registerEventHandler(isConsole)
  ...
  self._ui._stc_RateGuide:addInputEvent("Mouse_On", "HandleEventOut_ServantSwiftTraining_All_ShowRateGuide(true)")
  self._ui._stc_RateGuide:addInputEvent("Mouse_Out", "HandleEventOut_ServantSwiftTraining_All_ShowRateGuide(false)")
...
function PaGlobal_ServantSwiftTraining_All:prepareOpen()
  ...
  if nil ~= PaGlobalFunc_ServantInfo_All_CloseEquipInven then
    PaGlobalFunc_ServantInfo_All_CloseEquipInven()
  end
  local isCheckCron = ToClient_getGameUIManagerWrapper():getLuaCacheDataListBool(__eStallionSkillTrainingUseCron)
  self._ui._btn_Check_Cron:SetCheck(isCheckCron)
  self._ui._stc_RateGuide:SetShow(_ContentsGroup_ViewRate == true)
...
function PaGlobal_ServantSwiftTraining_All:updateCronStone()
  ...
  if nil ~= itemSSW then
    ...
    if false == self._isConsole then
      ...
      self._ui._btn_Check_Cron:addInputEvent("Mouse_LUp", "HandleEventLUp_ServantSwiftTraining_All_CronButton()")
    else
...
function PaGlobal_ServantSwiftTraining_All:Awaken_Training_isNineTier()
  ...
  if __eTInventorySlotNoUndefined ~= itemSlotNo then
    if self._ui._btn_Check_Cron:IsCheck() == false or self._cronStoneInfo._isEnableCronStone == false then
...
function PaGlobal_ServantSwiftTraining_All:prepareClose()
  ...
  HandleEventOut_ServantSwiftTraining_All_ShowRateGuide(false)
...
function PaGlobal_ServantSwiftTraining_All:validate()
  ...
  self._ui._stc_RateGuide:isValidate()
