function PaGlobal_ServantMarket_All:initialize()
  ...
  self._ui._stc_ComboBox_Tier_BackStatic = UI.getChildControl(self._ui._stc_ComboBox_TierList, "Combobox_List_Template")
  ...
  self._ui._stc_ComboBox_Skill_BackStatic = UI.getChildControl(self._ui._stc_ComboBox_SkillList, "Combobox_List_Template")
  ...
  self._ui._stc_ComboBox_Gender_BackStatic = UI.getChildControl(self._ui._stc_ComboBox_GenderList, "Combobox_List_Template")
  self._ui._stc_ComboBox_LevelTitle = UI.getChildControl(self._ui._stc_SortBg_PC_UI, "StaticText_LevelFilterTitle")
  self._ui._stc_ComboBox_Level = UI.getChildControl(self._ui._stc_SortBg_PC_UI, "Combobox2_Level")
  self._ui._stc_ComboBox_LevelList = UI.getChildControl(self._ui._stc_ComboBox_Level, "Combobox2_1_List")
  ...
  self._ui._stc_KeyGuide_LS = UI.getChildControl(self._ui._stc_Bottom_KeyGuides, "StaticText_LS_ConsoleUI")
  ...
  for slotIdx = 0, self._MAXSLOTCOUNT - 1 do
    local tempServantSlot = {
      ...
      _txt_skillChangeTitle = nil,
      _txt_skillChangeValue = nil
    }
    ...
    tempServantSlot._stc_OnlyAcce = UI.getChildControl(tempServantSlot._slot, "Static_OnlyAcce")
    tempServantSlot._stc_OnlyCorner = UI.getChildControl(tempServantSlot._slot, "Static_OnlyCorner")
    tempServantSlot._stc_OnlyBrake = UI.getChildControl(tempServantSlot._slot, "Static_OnlyBrake")
    tempServantSlot._txt_skillChangeTitle = UI.getChildControl(tempServantSlot._slot, "StaticText_SkillChangeTitle")
    tempServantSlot._txt_skillChangeValue = UI.getChildControl(tempServantSlot._slot, "StaticText_SkillChangeValue")
    UI.setLimitTextAndAddTooltip(tempServantSlot._txt_skillChangeTitle)
    UI.setLimitTextAndAddTooltip(tempServantSlot._txt_skillChangeValue)
  ...
  local tempSlot = UI.getChildControl(Panel_Dialog_ServantMarket_All, "Static_Slot_1")
  ...
  PaGlobal_ServantMarket_All:isConsoleUI(self._isUsePadSnapping)
  PaGlobal_ServantMarket_All:registerEventHandler(self._isUsePadSnapping)
end
function PaGlobal_ServantMarket_All:registerEventHandler(isUsePadSnapping)
  ...
  self._ui._stc_ComboBox_Level:addInputEvent("Mouse_LUp", "HandleEventLUp_ServantMarket_All_OpenComboBox(4)")
  ...
  self._ui._stc_ComboBox_Level:GetListControl():AddSelectEvent("HandleEventLUp_ServantMarket_All_SelectComboBox(4)")
  ...
  self._ui._stc_ComboBox_Level:setListTextHorizonCenter()
  if false == isUsePadSnapping then
    ...
    Panel_Dialog_ServantMarket_All:registerPadEvent(__eConsoleUIPadEvent_DpadLeft, "HandleEventPadPress_ServantMarket_All_MoveSnapping(false)")
    Panel_Dialog_ServantMarket_All:registerPadEvent(__eConsoleUIPadEvent_DpadRight, "HandleEventPadPress_ServantMarket_All_MoveSnapping(true)")
    self._ui._stc_ComboBox_Tier:addInputEvent("Mouse_On", "PaGlobalFunc_ServantMarket_All_SetSnappingIndex(" .. tostring(PaGlobal_ServantMarket_All._FILTERSLOTINDEX) .. ")")
    self._ui._stc_ComboBox_Skill:addInputEvent("Mouse_On", "PaGlobalFunc_ServantMarket_All_SetSnappingIndex(" .. tostring(PaGlobal_ServantMarket_All._FILTERSLOTINDEX) .. ")")
    self._ui._stc_ComboBox_Gender:addInputEvent("Mouse_On", "PaGlobalFunc_ServantMarket_All_SetSnappingIndex(" .. tostring(PaGlobal_ServantMarket_All._FILTERSLOTINDEX) .. ")")
    self._ui._stc_ComboBox_Level:addInputEvent("Mouse_On", "PaGlobalFunc_ServantMarket_All_SetSnappingIndex(" .. tostring(PaGlobal_ServantMarket_All._FILTERSLOTINDEX) .. ")")
  end
end
function PaGlobal_ServantMarket_All:isConsoleUI(isUsePadSnapping)
  if nil == Panel_Dialog_ServantMarket_All or false == self._initailize then
    return
  end
  self._ui._stc_SortBg_ConsoleUI:SetShow(false)
  self._ui._stc_KeyGuide_LT:SetShow(isUsePadSnapping)
  self._ui._stc_KeyGuide_RT:SetShow(isUsePadSnapping)
  self._ui._stc_PageLeft_Console:SetShow(isUsePadSnapping)
  self._ui._stc_PageRight_Console:SetShow(isUsePadSnapping)
  self._ui._stc_SkillTooltip_KeyGuide_B:SetShow(isUsePadSnapping)
  self._ui._stc_Bottom_KeyGuides:SetShow(isUsePadSnapping)
  self._ui._btn_Close_PC:SetShow(not isUsePadSnapping)
  self._ui._btn_Question_PC:SetShow(not isUsePadSnapping)
  self._ui._btn_Reload_PC:SetShow(not isUsePadSnapping)
  self._ui._stc_KeyGuide_Y:SetShow(isUsePadSnapping)
  self._ui._btn_PageLeft_PC:SetShow(not isUsePadSnapping)
  self._ui._btn_PageRight_PC:SetShow(not isUsePadSnapping)
  self._ui._stc_DiscountRate:SetShow(not isUsePadSnapping)
...
function PaGlobal_ServantMarket_All:prepareOpen(isOpenMenu)
  ...
  self._isFromNpc = ToClient_WorldMapIsShow() == false and (isOpenMenu == nil or isOpenMenu == false)
...
function PaGlobal_ServantMarket_All:createFilter()
  ...
  self._ui._stc_ComboBox_Level:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVANTMARKET_LEVELFILTER_ALL"))
  local uiCount = 1
  ...
  for ii = 0, #self._showServantTier do
    if tierlimit >= self._showServantTier[ii] then
      self._ui._stc_ComboBox_Tier:AddItem(self._string_ServantTier[self._showServantTier[ii]])
      uiCount = uiCount + 1
    end
  end
  ...
  self._ui._stc_ComboBox_Level:DeleteAllItem()
  self._ui._stc_ComboBox_Level:AddItem(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVANTMARKET_LEVELFILTER_ALL"))
  self._ui._stc_ComboBox_Level:AddItem(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVANTMARKET_LEVELFILTER_15UNDER"))
  self._ui._stc_ComboBox_Level:AddItem(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVANTMARKET_LEVELFILTER_15UPPER"))
end
...
function PaGlobal_ServantMarket_All:update()
  ...
  local auctionListCount = myAuctionInfo:getServantAuctionListCount()
  self._selectPage = myAuctionInfo:getCurrentPage()
  self._selectMaxPage = math.floor(auctionListCount / self._MAXSLOTCOUNT) - 1
  if 0 < auctionListCount % self._MAXSLOTCOUNT then
    self._selectMaxPage = self._selectMaxPage + 1
  end
  if 0 > self._selectMaxPage then
    self._selectMaxPage = 0
  end
  local startSlotNo = self._selectPage * self._MAXSLOTCOUNT
  local endSlotNo = startSlotNo + self._MAXSLOTCOUNT - 1
  ...
  for ii = startSlotNo, endSlotNo do
    ...
    if nil ~= auctionServantInfo and slotNo < self._MAXSLOTCOUNT then
      ...
      if 0 < auctionServantInfo:getServantSkillChangeConfirmedCount() then
        slot._txt_skillChangeValue:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_SERVANT_SKILLCHANGE_COUPON_DISABLE"))
      else
        slot._txt_skillChangeValue:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_SERVANT_SKILLCHANGE_COUPON_ABLE"))
      end
      UI.setLimitTextAndAddTooltip(slot._txt_skillChangeValue)
      ...
      if false == PaGlobal_ServantMarket_All._isUsePadSnapping and auctionServantInfo:getBaseIconPath1() ~= auctionServantInfo:getIconPath1() then
      ...
      if servantType == CppEnums.VehicleType.Type_Horse then
        ...
        if true == auctionServantInfo:isDisplayGender() then
            ...
            if CppEnums.ServantStateType.Type_RegisterMarket == servantInfo:getStateType() then
              if isAuctionEnd then
                ...
                if true == self._isUsePadSnapping then
                  ...
                  slot._slot:addInputEvent("Mouse_Out", "PaGlobalFunc_ServantMarket_All_SetKeyGuideText(nil,nil)")
                else
      ...
      elseif true == self._isFromNpc then
        ...
        slot._btn_BUY_PC:SetIgnore(true)
        if true == self._isUsePadSnapping then
          slot._slot:addInputEvent("Mouse_LUp", "")
        end
      end
      slot._stc_OnlySpeed:SetShow(false)
      slot._stc_OnlyAcce:SetShow(false)
      slot._stc_OnlyCorner:SetShow(false)
      slot._stc_OnlyBrake:SetShow(false)
      slot._stc_OnlySpeed:addInputEvent("Mouse_On", "")
      slot._stc_OnlySpeed:addInputEvent("Mouse_Out", "")
      slot._stc_OnlyAcce:addInputEvent("Mouse_On", "")
      slot._stc_OnlyAcce:addInputEvent("Mouse_Out", "")
      slot._stc_OnlyCorner:addInputEvent("Mouse_On", "")
      slot._stc_OnlyCorner:addInputEvent("Mouse_Out", "")
      slot._stc_OnlyBrake:addInputEvent("Mouse_On", "")
      slot._stc_OnlyBrake:addInputEvent("Mouse_Out", "")
      local speedValuePosX = slot._txt_SpeedValue:GetPosX() + slot._txt_SpeedValue:GetTextSizeX()
      local acceValuePosX = slot._txt_AccelValue:GetPosX() + slot._txt_AccelValue:GetTextSizeX()
      local cornerValuePosX = slot._txt_CorneringValue:GetPosX() + slot._txt_CorneringValue:GetTextSizeX()
      local brakeValuePosX = slot._txt_BreakValue:GetPosX() + slot._txt_BreakValue:GetTextSizeX()
      if __eVehicleType_Horse == servantType then
        local speedAddItemUseCount = auctionServantInfo:getAddStatItemUseCount(__eServantStatTypeSpeed)
        if speedAddItemUseCount > 0 then
          slot._stc_OnlySpeed:SetShow(true)
          slot._stc_OnlySpeed:addInputEvent("Mouse_On", "HandleEventOnOut_ServantMarket_All_ShowUseAddStatItemTooltip(true," .. slotNo .. "," .. __eServantStatTypeSpeed .. ")")
          slot._stc_OnlySpeed:addInputEvent("Mouse_Out", "HandleEventOnOut_ServantMarket_All_ShowUseAddStatItemTooltip(false)")
        end
        local acceAddItemUseCount = auctionServantInfo:getAddStatItemUseCount(__eServantStatTypeAcceleration)
        if acceAddItemUseCount > 0 then
          slot._stc_OnlyAcce:SetShow(true)
          slot._stc_OnlyAcce:addInputEvent("Mouse_On", "HandleEventOnOut_ServantMarket_All_ShowUseAddStatItemTooltip(true," .. slotNo .. "," .. __eServantStatTypeAcceleration .. ")")
          slot._stc_OnlyAcce:addInputEvent("Mouse_Out", "HandleEventOnOut_ServantMarket_All_ShowUseAddStatItemTooltip(false)")
        end
        local cornerAddItemUseCount = auctionServantInfo:getAddStatItemUseCount(__eServantStatTypeCornering)
        if cornerAddItemUseCount > 0 then
          slot._stc_OnlyCorner:SetShow(true)
          slot._stc_OnlyCorner:addInputEvent("Mouse_On", "HandleEventOnOut_ServantMarket_All_ShowUseAddStatItemTooltip(true," .. slotNo .. "," .. __eServantStatTypeCornering .. ")")
          slot._stc_OnlyCorner:addInputEvent("Mouse_Out", "HandleEventOnOut_ServantMarket_All_ShowUseAddStatItemTooltip(false)")
        end
        local brakeAddItemUseCount = auctionServantInfo:getAddStatItemUseCount(__eServantStatTypeBrake)
        if brakeAddItemUseCount > 0 then
          slot._stc_OnlyBrake:SetShow(true)
          slot._stc_OnlyBrake:addInputEvent("Mouse_On", "HandleEventOnOut_ServantMarket_All_ShowUseAddStatItemTooltip(true," .. slotNo .. "," .. __eServantStatTypeBrake .. ")")
          slot._stc_OnlyBrake:addInputEvent("Mouse_Out", "HandleEventOnOut_ServantMarket_All_ShowUseAddStatItemTooltip(false)")
        end
      end
      slot._stc_OnlySpeed:SetPosX(speedValuePosX)
      slot._stc_OnlyAcce:SetPosX(acceValuePosX)
      slot._stc_OnlyCorner:SetPosX(cornerValuePosX)
      slot._stc_OnlyBrake:SetPosX(brakeValuePosX)
      slotNo = slotNo + 1
    end
  end
...
function PaGlobal_ServantMarket_All:list2Update(content, key, slotIdx)
  ...
  if nil ~= skillWrapper then
    ...
    if true == self._isUsePadSnapping then
      skillIcon:addInputEvent("Mouse_On", "HandleEventOnOut_ServantMarket_All_SnappingSkill(true," .. actorKeyRaw .. ", " .. key32 .. ")")
      skillIcon:addInputEvent("Mouse_Out", "HandleEventOnOut_ServantMarket_All_SnappingSkill(false)")
    else
    ...
    local isStallionSkill = auctionServantInfo:isStallionSkill(skillWrapper:getKey())
    ...
    if true == isStallionSkill then
      ...
      if false == self._isUsePadSnapping then
        skillStallionIcon:addInputEvent("Mouse_On", "HandleEventOnOut_Dialog_ServantMarket_All_ShowStallionToolTip(true, " .. key32 .. ", " .. slotIdx .. ")")
        skillStallionIcon:addInputEvent("Mouse_Out", "HandleEventOnOut_Dialog_ServantMarket_All_ShowStallionToolTip(false)")
      end
    end
...
function PaGlobal_ServantMarket_All:MarketServant_Tooltip_Open(actorKeyRaw, key32, slotIdx)
  ...
  local servantListIndex = slotIdx + self._selectPage * self._MAXSLOTCOUNT
  local auctionServantInfo = myAuctionInfo:getServantAuctionListAt(servantListIndex)
  if nil == auctionServantInfo then
    return
  end
  local skillWrapper = auctionServantInfo:getSkill(key32)
  ...
  elseif nil ~= PaGlobal_Tooltip_Servant_Open then
    ...
    if true == self._isUsePadSnapping then
      isShowStallionSkillTooltip = auctionServantInfo:isStallionSkill(skillWrapper:getKey())
    end
...
function PaGlobal_ServantMarket_All:moneyUpdate()
  ...
  local invenMoney = selfPlayer:get():getMoneyInventory():getMoney_s64()
...
function PaGlobal_ServantMarket_All:validate()
  ...
  self._ui._stc_ComboBox_LevelTitle:isValidate()
  self._ui._stc_ComboBox_Level:isValidate()
  self._ui._stc_ComboBox_LevelList:isValidate()
  ...
  self._ui._stc_KeyGuide_LS:isValidate()
  for slotIdx = 0, self._MAXSLOTCOUNT - 1 do
    ...
    self._ui._servantSlot[slotIdx]._stc_OnlySpeed:isValidate()
    self._ui._servantSlot[slotIdx]._txt_skillChangeTitle:isValidate()
    self._ui._servantSlot[slotIdx]._txt_skillChangeValue:isValidate()
  end
