function PaGlobal_ServantList_All:initialize()
  ...
  self._ui._btn_SortButton = UI.getChildControl(Panel_Dialog_ServantList_All, "CheckButton_Sort")
  self._ui._stc_SortComponent = UI.getChildControl(Panel_Dialog_ServantList_All, "Static_SortComponent")
  self._ui._stc_MainSort = UI.getChildControl(self._ui._stc_SortComponent, "Static_MainSort")
  self._ui._rdo_SortByDefault = UI.getChildControl(self._ui._stc_MainSort, "RadioButton_Default")
  self._ui._rdo_SortByLevel = UI.getChildControl(self._ui._stc_MainSort, "RadioButton_Level")
  self._ui._rdo_SortByTier = UI.getChildControl(self._ui._stc_MainSort, "RadioButton_Tier")
  self._ui._rdo_SortByMixCount = UI.getChildControl(self._ui._stc_MainSort, "RadioButton_MixCount")
  self._ui._rdo_SortByGender = UI.getChildControl(self._ui._stc_MainSort, "RadioButton_Gender")
  self._ui._stc_SubSort = UI.getChildControl(self._ui._stc_SortComponent, "Static_SubSort")
  self._ui._rdo_Desc = UI.getChildControl(self._ui._stc_SubSort, "RadioButton_Descending")
  self._ui._rdo_Asc = UI.getChildControl(self._ui._stc_SubSort, "RadioButton_Ascending")
  self._isSortAsc = false
  self._sortBase = 0
  ...
  self._ORIGINAL_LISTCOUNT_SPANY = self._ui._txt_ServantListValue:GetSpanSize().y
  self._ORIGINAL_LIST2_SPANY = self._ui._list2_Servant:GetSpanSize().y
  self._ORIGINAL_LIST2_SIZEY = self._ui._list2_Servant:GetSizeY()
...
function PaGlobal_ServantList_All:registerEventHandler(isConsole)
  ...
  registerEvent("FromClient_GuildServantListUpdate", "FromClient_ServantList_All_UpdateVehicleList")
  registerEvent("EventSelfServantUpdateOnlyHp", "FromClient_ServantList_All_Update_ChangeVehicleHP")
  registerEvent("EventSelfServantUpdateOnlyMp", "FromClient_ServantList_All_Update_ChangeVehicleMP")
  ...
  self._ui._btn_SortButton:addInputEvent("Mouse_LUp", "HandleEventLUp_ServantList_All_ToggleSortOptionPanel()")
  self._ui._rdo_SortByDefault:addInputEvent("Mouse_LUp", "HandleEventLUp_ServantList_All_SetSortOptionBase(0)")
  self._ui._rdo_SortByLevel:addInputEvent("Mouse_LUp", "HandleEventLUp_ServantList_All_SetSortOptionBase(1)")
  self._ui._rdo_SortByTier:addInputEvent("Mouse_LUp", "HandleEventLUp_ServantList_All_SetSortOptionBase(2)")
  self._ui._rdo_SortByMixCount:addInputEvent("Mouse_LUp", "HandleEventLUp_ServantList_All_SetSortOptionBase(3)")
  self._ui._rdo_SortByGender:addInputEvent("Mouse_LUp", "HandleEventLUp_ServantList_All_SetSortOptionBase(4)")
  self._ui._rdo_Asc:addInputEvent("Mouse_LUp", "HandleEventLUp_ServantList_All_SetSortOptionAsc(true)")
  self._ui._rdo_Desc:addInputEvent("Mouse_LUp", "HandleEventLUp_ServantList_All_SetSortOptionAsc(false)")
  self._ui._btn_SortButton:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_WINDOW_CARGOLOADING_SORT"))
  self._ui._stc_SortComponent:addInputEvent("Mouse_Out", "HandleEventOut_ServantList_All_HideSortComponent()")
  self._ui._stc_SubSort:addInputEvent("Mouse_Out", "HandleEventOut_ServantList_All_HideSortComponent()")
  self._ui._rdo_SortByDefault:addInputEvent("Mouse_Out", "HandleEventOut_ServantList_All_HideSortComponent()")
  self._ui._rdo_SortByLevel:addInputEvent("Mouse_Out", "HandleEventOut_ServantList_All_HideSortComponent()")
  self._ui._rdo_SortByTier:addInputEvent("Mouse_Out", "HandleEventOut_ServantList_All_HideSortComponent()")
  self._ui._rdo_SortByMixCount:addInputEvent("Mouse_Out", "HandleEventOut_ServantList_All_HideSortComponent()")
  self._ui._rdo_SortByGender:addInputEvent("Mouse_Out", "HandleEventOut_ServantList_All_HideSortComponent()")
  self._ui._rdo_Asc:addInputEvent("Mouse_Out", "HandleEventOut_ServantList_All_HideSortComponent()")
  self._ui._rdo_Desc:addInputEvent("Mouse_Out", "HandleEventOut_ServantList_All_HideSortComponent()")
end
...
function PaGlobal_ServantList_All:prepareOpen()
  ...
  if self._ENUM_NPC_TYPE._SEA == currentNPCType or self._ENUM_NPC_TYPE._GUILD_SEA == currentNPCType then
    ...
    if true == _ContentsGroup_TransportBackward then
      if false == self._isConsole and true == _ContentsGroup_EasyBuy and false == ToClient_IsInstanceFieldPlayerbyContentsType(__eInstanceContentsType_HorseRacing) and ToClient_isConsole() == false then
  ...
  self._ui._list2_Servant:SetSize(self._ui._list2_Servant:GetSizeX(), self._ORIGINAL_LIST2_SIZEY)
  ...
  if self._ENUM_NPC_TYPE._SEA == currentNPCType or self._ENUM_NPC_TYPE._GUILD_SEA == currentNPCType or self._ENUM_NPC_TYPE._GUILD_LAND == currentNPCType then
    self._ui._btn_SortButton:SetShow(false)
    local kDeleteSortButtonSize = 40
    local currentSpan = self._ui._list2_Servant:GetSpanSize()
    self._ui._list2_Servant:SetSize(self._ui._list2_Servant:GetSizeX(), self._ORIGINAL_LIST2_SIZEY + kDeleteSortButtonSize)
    if self._ENUM_NPC_TYPE._SEA == currentNPCType then
      self._ui._txt_ServantListTitle:SetSpanSize(self._ui._txt_ServantListTitle:GetSpanSize().x, self._ORIGINAL_LISTTITLE_SPANY + 10)
      self._ui._list2_Servant:SetSpanSize(currentSpan.x, self._ORIGINAL_LIST2_SPANY - kDeleteSortButtonSize)
    end
    self._ui._txt_ServantListValue:SetSpanSize(self._ui._txt_ServantListValue:GetSpanSize().x, self._ui._txt_ServantListTitle:GetSpanSize().y)
    self._ui._list2_Servant:ComputePos()
    self._ui._btn_BuyWeight:SetPosX(425)
    self._ui._btn_BuyWeight:SetPosY(240)
  else
    self._ui._btn_BuyWeight:SetPosX(425)
    self._ui._btn_BuyWeight:SetPosY(240)
  end
  self._ui._stc_SortComponent:SetShow(false)
  self._ui._btn_SortButton:SetCheck(false)
  self._ui._rdo_SortByLevel:SetCheck(false)
  self._ui._rdo_SortByTier:SetCheck(false)
  self._ui._rdo_SortByMixCount:SetCheck(false)
  self._ui._rdo_SortByGender:SetCheck(false)
  self._ui._rdo_Asc:SetCheck(false)
  self._ui._rdo_Desc:SetCheck(false)
  ...
  if servantInfo ~= nil and PaGlobalFunc_ServantFunction_All_GetIsGuild() == false and servantInfo:isMasterlessHorse() == false then
    ...
    HandleEventOn_ServantList_All_SelectServant(self._ENUM_TYPEUNSEALED, 0)
  else
    HandleEventOn_ServantList_All_SelectServant(self._ENUM_TYPESEALED, 0)
  end
  ...
  if waypointKey ~= nil and (currentNPCType == self._ENUM_NPC_TYPE._LAND or currentNPCType == self._ENUM_NPC_TYPE._SEA) then
    if (PaGlobal_EasyBuy:checkExistCashItem(15, waypointKey) == true or PaGlobal_EasyBuy:checkExistCashItem(78, waypointKey) == true) and ToClient_isConsole() == false then
      self._ui._btn_BuyWeight:SetShow(true)
    else
      self._ui._btn_BuyWeight:SetShow(false)
    end
...
function PaGlobal_ServantList_All:update()
  ...
  local crogCount = 0
  if _ContentsGroup_Crogdalo == true and getSelfPlayer():isInstancePlayer() == false then
    for ii = 0, 2 do
      local servantInfo = ToClient_getServantCrogdaloByIndex(ii)
      if nil ~= servantInfo then
        local state = servantInfo:getStateType()
        if isSiegeStable() == true then
          if CppEnums.ServantStateType.Type_Coma == state then
            crogCount = crogCount + 1
          end
        elseif CppEnums.ServantStateType.Type_Field ~= state then
          crogCount = crogCount + 1
        end
      end
    end
  ...
  if true == PaGlobalFunc_ServantFunction_All_GetIsGuild() then
    ...
    if currentNPCType == self._ENUM_NPC_TYPE._LAND then
      servantCount = servantCount + crogCount
    end
  end
  if self._ENUM_NPC_TYPE._LAND == currentNPCType then
  ...
  if false == isSiegeStable() then
    ...
    self._ui._btn_Regist:SetShow(true)
    local sealedCount = 0
...
function PaGlobal_ServantList_All:setDataList2MYServant(content, key)
  ...
  local isCrogdaloServant = false
  if true == PaGlobalFunc_ServantFunction_All_GetIsGuild() then
    servantInfo = guildStable_getServant(sortedIndex)
  elseif PaGlobal_ServantList_All:isCrogdaloServant(sortedIndex) == false then
    servantInfo = stable_getServant(sortedIndex)
  else
    servantInfo = ToClient_getServantCrogdaloByIndex(math.abs(sortedIndex - tonumber(self._crogdalIndexStart)))
    isCrogdaloServant = true
  end
  if nil ~= servantInfo then
    local servantRegionName = servantInfo:getRegionName()
    if nil == servantRegionName then
      if isCrogdaloServant == true then
        servantRegionName = PAGetString(Defines.StringSheet_GAME, "LUA_SERVANTICON_TREASURETOOLTIP")
      else
        servantRegionName = ""
      end
    end
    ...
    self._tooltipShowList[sortedIndex] = horseIcon
    local vehicleType = servantInfo:getVehicleType()
    local vehicleSubType = servantInfo:getVehicleSubType()
    local isMutationHorse = vehicleType == __eVehicleType_Horse and vehicleSubType == __eTVehicleSubType_MutationHorse
    tier:removeInputEvent("Mouse_On")
    tier:removeInputEvent("Mouse_Out")
    if isMutationHorse == true then
      tier:SetIgnore(false)
      tier:SetTextMode(__eTextMode_LimitText)
      tier:addInputEvent("Mouse_On", "HandleEventOn_ServantList_All_ShowMutationHorseTooltip(" .. sortedIndex .. ")")
      tier:addInputEvent("Mouse_Out", "HandleEventOn_ServantList_All_HideMutationHorseTooltip()")
    end
    ...
    if true == ToClient_IsInstanceFieldPlayerbyContentsType(__eInstanceContentsType_HorseRacing) then
      ...
      name:SetMonoTone(false, false)
      state:SetMonoTone(false, false)
    elseif regionKey ~= self._currentRegionKey and self._currentExploreKey ~= exploerKey then
    ...
    if vehicleType == CppEnums.VehicleType.Type_Horse or vehicleType == CppEnums.VehicleType.Type_RaceHorse then
      if isMutationHorse == true then
        horseIcon:SetShow(true)
        horseIcon:SetMonoTone(false, false)
        local x1, y1, x2, y2
        horseIcon:ChangeTextureInfoName("combine/etc/combine_etc_imperial_horse.dds")
        x1, y1, x2, y2 = setTextureUV_Func(horseIcon, 32, 1, 62, 31)
        horseIcon:getBaseTexture():setUV(x1, y1, x2, y2)
        horseIcon:setRenderTexture(horseIcon:getBaseTexture())
      elseif servantInfo:getTier() < 9 and false == servantInfo:isPcroomOnly() and self._contentsOption._isContentsStallionEnable then
        ...
        if vehicleType == CppEnums.VehicleType.Type_RaceHorse then
    ...
    if tier:GetSizeX() < tier:GetTextSizeX() then
      local horseIconPosX = tier:GetPosX() - horseIcon:GetSizeX() - (tier:GetTextSizeX() - tier:GetSizeX() + 5)
      horseIcon:SetPosX(horseIconPosX)
    else
      local horseIconPosX = tier:GetPosX() - horseIcon:GetSizeX()
      horseIcon:SetPosX(horseIconPosX)
    end
    btn:SetShow(true)
    btn:addInputEvent("Mouse_LUp", "HandleEventOn_ServantList_All_SelectServant(" .. self._ENUM_TYPESEALED .. "," .. key32 .. ")")
...
function PaGlobal_ServantList_All:loadServantList(forTest)
  if nil == Panel_Dialog_ServantList_All then
    return
  end
  ...
  local currentNPCType = PaGlobalFunc_ServantFunction_All_Get_NpcType()
  local useCrogdaloServant = false
  if _ContentsGroup_Crogdalo == true and PaGlobalFunc_ServantFunction_All_GetIsGuild(forTest) == false and currentNPCType == self._ENUM_NPC_TYPE._LAND and crogCount > 0 then
    PaGlobal_ServantList_All:sortingMyServant(maxStableServantCount + crogCount)
    useCrogdaloServant = true
  else
    PaGlobal_ServantList_All:sortingMyServant(maxStableServantCount)
  end
  ToClient_clearReverseTransferList()
  local lastInsertedIndex = 0
  for ii = 1, maxStableServantCount do
    ...
    if nil ~= servantInfo then
      ...
      local vehicleType = servantInfo:getVehicleType()
      self._servantList[ii]._index = ii - 1
      self._servantList[ii]._servantNo = servantInfo:getServantNo()
      self._servantList[ii]._exploreKey = exploreKey
      self._servantList[ii]._areaName = areaName
      self._servantList[ii]._isDead = CppEnums.ServantStateType.Type_Coma == servantInfo:getStateType()
      self._servantList[ii]._exception = CppEnums.VehicleType.Type_Carriage == vehicleType or CppEnums.VehicleType.Type_Elephant == vehicleType or CppEnums.VehicleType.Type_RepairableCarriage == vehicleType or CppEnums.VehicleType.Type_Elephant == vehicleType or CppEnums.VehicleType.Type_RidableBabyElephant == vehicleType or CppEnums.VehicleType.Type_SailingBoat == vehicleType
      self._servantList[ii]._level = servantInfo:getLevel()
      self._servantList[ii]._tier = servantInfo:getTier()
      self._servantList[ii]._isDream = servantInfo:isDreamHorseAnyKind()
      self._servantList[ii]._male = servantInfo:isMale()
      self._servantList[ii]._mixCount = servantInfo:getMatingCount()
      self._servantList[ii]._vehicleType = vehicleType
      self._servantList[ii]._hasLevel = PaGlobal_ServantList_All:checkHasLevel(servantInfo)
      self._servantList[ii]._hasGender = PaGlobal_ServantList_All:checkHasGender(servantInfo)
      self._servantList[ii]._canMating = CppEnums.VehicleType.Type_Horse == vehicleType and self._servantList[ii]._tier ~= 9 and self._servantList[ii]._isDream == false
      if CppEnums.ServantStateType.Type_Stable == servantInfo:getStateType() and false == servantInfo:isChangingRegion() then
        ToClient_pushReverseTransferList(regionKey, servantInfo:getServantNo())
      end
      lastInsertedIndex = ii
    end
  end
  if useCrogdaloServant == true then
    for ii = 0, 2 do
      local servantInfo = ToClient_getServantCrogdaloByIndex(ii)
      if nil ~= servantInfo then
        local state = servantInfo:getStateType()
        ...
        if isSiegeStable() == true then
          isInsert = CppEnums.ServantStateType.Type_Coma == state
        else
          isInsert = CppEnums.ServantStateType.Type_Field ~= state
        end
        if isInsert == true then
          lastInsertedIndex = lastInsertedIndex + 1
          local regionKey = servantInfo:getRegionKeyRaw()
          local regionInfoWrapper = getRegionInfoWrapper(regionKey)
          local exploreKey = 99999
          local areaName = PAGetString(Defines.StringSheet_GAME, "LUA_SERVANTICON_TREASURETOOLTIP")
          local vehicleType = servantInfo:getVehicleType()
          self._servantList[lastInsertedIndex]._index = ii + tonumber(self._crogdalIndexStart)
          self._servantList[lastInsertedIndex]._servantNo = servantInfo:getServantNo()
          self._servantList[lastInsertedIndex]._exploreKey = exploreKey
          self._servantList[lastInsertedIndex]._areaName = areaName
          self._servantList[lastInsertedIndex]._isDead = CppEnums.ServantStateType.Type_Coma == state
          self._servantList[lastInsertedIndex]._exception = true
          self._servantList[lastInsertedIndex]._level = servantInfo:getLevel()
          self._servantList[lastInsertedIndex]._tier = servantInfo:getTier()
          self._servantList[lastInsertedIndex]._isDream = servantInfo:isDreamHorseAnyKind()
          self._servantList[lastInsertedIndex]._male = servantInfo:isMale()
          self._servantList[lastInsertedIndex]._mixCount = servantInfo:getMatingCount()
          self._servantList[ii]._vehicleType = vehicleType
          self._servantList[ii]._hasLevel = PaGlobal_ServantList_All:checkHasLevel(servantInfo)
          self._servantList[ii]._hasGender = PaGlobal_ServantList_All:checkHasGender(servantInfo)
          self._servantList[ii]._canMating = CppEnums.VehicleType.Type_Horse == vehicleType
          maxStableServantCount = maxStableServantCount + 1
        end
      end
    end
  end
  self._stableServantCount = maxStableServantCount
end
function PaGlobal_ServantList_All:defaultSort()
  local sortExplaoreKey = function(a, b)
    return a._exploreKey < b._exploreKey
  end
  local sortCarrageFirstByServantNo = function(lv, rv)
    if PaGlobal_VehicleInfo_All:isCheckCarriage(lv._vehicleType) == true and PaGlobal_VehicleInfo_All:isCheckCarriage(rv._vehicleType) == false then
      return true
    elseif PaGlobal_VehicleInfo_All:isCheckCarriage(lv._vehicleType) == false and PaGlobal_VehicleInfo_All:isCheckCarriage(rv._vehicleType) == true then
      return false
    end
    return lv._servantNo > rv._servantNo
  end
  if #self._servantList > 1 then
    table.sort(self._servantList, sortExplaoreKey)
  end
  ...
  local servantByExplore = {}
  for i = 1, self._stableServantCount do
    local curExploreKey = self._servantList[i]._exploreKey
    if servantByExplore[curExploreKey] == nil then
      servantByExplore[curExploreKey] = {}
    end
    table.insert(servantByExplore[curExploreKey], self._servantList[i])
  end
  for key, value in pairs(servantByExplore) do
    table.sort(value, sortCarrageFirstByServantNo)
  end
  local sIndex = 1
  if servantByExplore[myWayPointKey] ~= nil then
    for idx = 1, #servantByExplore[myWayPointKey] do
      self._servantList[sIndex] = servantByExplore[myWayPointKey][idx]
      sIndex = sIndex + 1
    end
  end
  for key, value in pairs(servantByExplore) do
    if key ~= myWayPointKey then
      for idx = 1, #value do
        self._servantList[sIndex] = value[idx]
        sIndex = sIndex + 1
      end
    end
  end
  local temp = {}
  sIndex = 0
  for servantIndex = 1, self._stableServantCount do
    if false == self._servantList[servantIndex]._exception and true == self._servantList[servantIndex]._isDead then
      temp[sIndex] = self._servantList[servantIndex]
      sIndex = sIndex + 1
    end
  end
  for servantIndex = 1, self._stableServantCount do
    if true == self._servantList[servantIndex]._exception and true == self._servantList[servantIndex]._isDead then
      temp[sIndex] = self._servantList[servantIndex]
      sIndex = sIndex + 1
    end
  end
  ...
  local function sortByTerritory(territoryKey)
    for servantIndex = 1, self._stableServantCount do
      if affiliatedTerritory(self._servantList[servantIndex]._exploreKey) == territoryKey and false == self._servantList[servantIndex]._isDead then
        temp[sIndex] = self._servantList[servantIndex]
        sIndex = sIndex + 1
      end
    end
  ...
  for i = 1, self._stableServantCount do
    self._servantList[i] = temp[i - 1]
  end
end
function PaGlobal_ServantList_All:sortDataUpdate()
  if nil == Panel_Dialog_ServantList_All then
    return
  end
  if PaGlobal_ServantList_All._sortBase == 0 or PaGlobal_ServantList_All._isSortAsc == nil then
    PaGlobal_ServantList_All:defaultSort()
    return
  end
  ...
  local myRegionKey = selfPlayer:getRegionKey():get()
  local myRegionInfoWrapper = getRegionInfoWrapper(myRegionKey)
  local myWayPointKey = myRegionInfoWrapper:getExplorationKey()
  local function sortRoutine(a, b)
    if myWayPointKey == a._exploreKey and myWayPointKey == b._exploreKey then
    elseif myWayPointKey == a._exploreKey then
      return true
    elseif myWayPointKey == b._exploreKey then
      return false
    end
    if PaGlobal_ServantList_All._sortBase == 1 then
      if a._hasLevel == false then
        return false
      elseif b._hasLevel == false then
        return true
      end
      if PaGlobal_ServantList_All._isSortAsc == true then
        return a._level < b._level
      else
        return a._level > b._level
      end
    elseif PaGlobal_ServantList_All._sortBase == 2 then
      if a._tier == 0 then
        return false
      elseif b._tier == 0 then
        return true
      end
      if PaGlobal_ServantList_All._isSortAsc == true then
        if a._tier == 9 and b._tier == 9 then
          if a._isDream == false and b._isDream == true then
            return true
          else
            return false
          end
        ...
        if a._tier == 9 and b._tier == 9 then
          if a._isDream == true and b._isDream == false then
            return true
          else
            return false
          end
    ...
    elseif PaGlobal_ServantList_All._sortBase == 3 then
      if a._canMating == false then
        return false
      elseif b._canMating == false then
        return true
      end
      if a._mixCount == b._mixCount then
        if a._male == true and b._male == false then
          return false
        elseif a._male == false and b._male == true then
          return true
        end
      end
      if PaGlobal_ServantList_All._isSortAsc == true then
        return a._mixCount < b._mixCount
      else
        return a._mixCount > b._mixCount
      end
    else
      if a._hasGender == false then
        return false
      elseif b._hasGender == false then
        return true
      end
      if PaGlobal_ServantList_All._isSortAsc == true and a._male == false and b._male == true then
        return true
      elseif PaGlobal_ServantList_All._isSortAsc == false and a._male == true and b._male == false then
        return true
      else
        return false
      end
  ...
  table.sort(self._servantList, sortRoutine)
end
...
function PaGlobal_ServantList_All:stableList_GetSlotNoByServentNo(servantNo)
  ...
  for k, value in pairs(self._servantList) do
...
function PaGlobal_ServantList_All:sortByWayPointKey(index)
  ...
  if nil == self._servantList[index + 1] then
    return nil
  end
  return self._servantList[index + 1]._index
end
function PaGlobal_ServantList_All:setMyServant()
  ...
  local servantInfo = temporaryWrapper:getUnsealVehicle(stable_getServantType())
  if servantInfo ~= nil and servantInfo:isMasterlessHorse() == false then
    self._ui._stc_NoServant:SetShow(false)
    ...
    self._ui._txt_CurrentServantLocate:SetShow(false)
    self._ui._txt_CurrentServant_Tier:removeInputEvent("Mouse_On")
    self._ui._txt_CurrentServant_Tier:removeInputEvent("Mouse_Out")
    ...
    if servantType == CppEnums.VehicleType.Type_Horse or servantType == CppEnums.VehicleType.Type_RaceHorse then
      if isMutationHorse == true then
        ...
        local x1, y1, x2, y2
        self._ui._icon_CurrentServant_Swift:ChangeTextureInfoName("combine/etc/combine_etc_imperial_horse.dds")
        x1, y1, x2, y2 = setTextureUV_Func(self._ui._icon_CurrentServant_Swift, 32, 1, 62, 31)
        ...
        self._ui._txt_CurrentServant_Tier:SetIgnore(false)
        self._ui._txt_CurrentServant_Tier:SetTextMode(__eTextMode_LimitText)
        self._ui._txt_CurrentServant_Tier:addInputEvent("Mouse_On", "HandleEventOn_ServantList_All_ShowCurrentHorseTooltip()")
        self._ui._txt_CurrentServant_Tier:addInputEvent("Mouse_Out", "HandleEventOn_ServantList_All_HideMutationHorseTooltip()")
      elseif servantTier < 9 and false == isPcroomOnly and self._contentsOption._isContentsStallionEnable then
        self._ui._icon_CurrentServant_Swift:SetShow(true)
    ...
    if self._ui._txt_CurrentServant_Tier:GetSizeX() < self._ui._txt_CurrentServant_Tier:GetTextSizeX() then
      local horseIconPosX = self._ui._txt_CurrentServant_Tier:GetPosX() - self._ui._icon_CurrentServant_Swift:GetSizeX() - (self._ui._txt_CurrentServant_Tier:GetTextSizeX() - self._ui._txt_CurrentServant_Tier:GetSizeX() + 5)
      self._ui._icon_CurrentServant_Swift:SetPosX(horseIconPosX)
    else
      local horseIconPosX = self._ui._txt_CurrentServant_Tier:GetPosX() - self._ui._icon_CurrentServant_Swift:GetSizeX()
      self._ui._icon_CurrentServant_Swift:SetPosX(horseIconPosX)
    end
  ...
  self._ui._btn_CurrentServant:addInputEvent("Mouse_LUp", "HandleEventOn_ServantList_All_SelectServant(" .. self._ENUM_TYPEUNSEALED .. ",0)")
end
...
function PaGlobal_ServantList_All:dataClear()
  ...
  self, _stableServantCount = nil, nil
end
...
function PaGlobal_ServantList_All:subMenuOpen(eType)
  ...
  if eType == self._ENUM_TYPESEALED then
    ...
    if PaGlobal_ServantList_All:isCrogdaloServant(index) == true then
      local crogServantWrapper = ToClient_getServantCrogdaloByIndex(math.abs(index - tonumber(self._crogdalIndexStart)))
      if crogServantWrapper == nil then
        return
      end
      if eServantType.Type_Horse ~= crogServantWrapper:getVehicleType() then
        return
      end
      local getHp = crogServantWrapper:getHp()
      if 0 == getHp then
        if isSiegeStable() == true then
    ...
    elseif regionName == servantRegionName then
      ...
      if true == isLinkedHorse and stallionTraining ~= getState then
        ...
        if false == isPcroomOnly and nowMating ~= getState and regMarket ~= getState and regMating ~= getState and training ~= getState and stallionTraining ~= getState and false == hasRentOwnerFlag and eServantType.Type_RaceHorse ~= vehicleType and isMutationHorse == false then
        ...
        if false == isPcroomOnly and false == hasRentOwnerFlag and nowMating ~= getState and regMarket ~= getState and regMating ~= getState and training ~= getState and stallionTraining ~= getState then
          if (vehicleType == eServantType.Type_Horse or vehicleType == eServantType.Type_Camel or vehicleType == eServantType.Type_Donkey or vehicleType == eServantType.Type_Elephant or vehicleType == eServantType.Type_RidableBabyElephant) and stallionTraining ~= getState and isMutationHorse == false then
        ...
        if false == isPcroomOnly and servantInfo:doImprint() and stallionTraining ~= getState and false == hasRentOwnerFlag and eServantType.Type_RaceHorse ~= vehicleType and vehicleSubType ~= __eTVehicleSubType_MutationHorse then
          PaGlobal_ServantList_All:setSubMenuData(self._subMenuGroup[self._subMenuCount], self._ENUM_SUBMENUTYPE._IMPRINT, index)
        end
        if servantInfo:isChangeableLookUp() == true and false == isPcroomOnly and eServantType.Type_Horse == vehicleType and nowMating ~= getState and regMarket ~= getState and regMating ~= getState and training ~= getState and regionName == servantRegionName and self._contentsOption._isContentsEnable and stallionTraining ~= getState and false == hasRentOwnerFlag and vehicleSubType ~= __eTVehicleSubType_MutationHorse then
        ...
        if false == isPcroomOnly and false == hasRentOwnerFlag and stallionTraining ~= getState then
          if eServantType.Type_Horse == vehicleType or eServantType.Type_Donkey == vehicleType or eServantType.Type_Camel == vehicleType or eServantType.Type_RidableBabyElephant == vehicleType then
            if nowMating ~= getState and regMarket ~= getState and regMating ~= getState and training ~= getState then
              if servantLevel >= 15 and eServantType.Type_Horse == vehicleType and self._contentsOption._isContentsEnableSupply then
                PaGlobal_ServantList_All:setSubMenuData(self._subMenuGroup[self._subMenuCount], self._ENUM_SUBMENUTYPE._SUPPLYHORSE, index)
              elseif stallionTraining ~= getState and isMutationHorse == false then
        ...
        if servantTier < 9 and false == isPcroomOnly and PaGlobal_ServantList_All:check_Show_Rent_Or_ReturnRent_Button(servantInfo, true) and false == isLinkedHorse and eServantType.Type_RaceHorse ~= vehicleType and vehicleSubType ~= __eTVehicleSubType_MutationHorse then
        ...
        if stable_isMarket() and nowMating ~= getState and regMarket ~= getState and regMating ~= getState and training ~= getState and stallionTraining ~= getState and false == hasRentOwnerFlag and (eServantType.Type_Horse == vehicleType or eServantType.Type_Donkey == vehicleType or eServantType.Type_Camel == vehicleType) and regionName == servantRegionName and not servantInfo:isChangingRegion() and isMutationHorse == false and 9113 ~= servantInfo:getCharacterKeyRaw() and 9114 ~= servantInfo:getCharacterKeyRaw() and 9115 ~= servantInfo:getCharacterKeyRaw() and eServantType.Type_RaceHorse ~= vehicleType and true == self._contentsOption._isContentsWorldMarket then
  ...
  elseif eType == self._ENUM_TYPEUNSEALED then
    ...
    elseif (getHp < maxHp or getMp < maxMp) and (eServantType.Type_Horse == vehicleType or CppEnums.VehicleType.Type_RaceHorse == vehicleType or eServantType.Type_Donkey == vehicleType or eServantType.Type_Camel == vehicleType or eServantType.Type_MountainGoat == vehicleType or eServantType.Type_RidableBabyElephant == vehicleType) and not unSealServantInfo:isMatingComplete() and nowMating ~= getState and regMarket ~= getState and regMating ~= getState then
      PaGlobal_ServantList_All:setSubMenuData(self._subMenuGroup[self._subMenuCount], self._ENUM_SUBMENUTYPE._RECOVERYUNSEALED, index)
    end
  end
  PaGlobal_ServantList_All:adjustSubMenu()
  ...
  if eType == self._ENUM_TYPESEALED then
    ...
    if regionName == servantRegionName then
      ...
      elseif CppEnums.ServantStateType.Type_Stable == getState then
        PaGlobal_ServantList_All:setSubMenuData(self._subMenuGroup[self._subMenuCount], self._ENUM_SUBMENUTYPE._UNSEAL, index)
        local isRightReleaseGuildServant = false
        if _ContentsGroup_GuildAuthoritySeparation == true then
          isRightReleaseGuildServant = PaGlobalFunc_Guild_Authorization_RightCheck(__eGuildRightNew_ManageServant)
        else
          isRightReleaseGuildServant = PaGlobalFunc_ServantInfo_All_RightCheck(__eGuildRightType_ChangeServantToReward)
        end
...
function PaGlobal_ServantList_All:shipSubMenuOpen(eType)
  ...
  if eType == self._ENUM_TYPESEALED then
    ...
    if regionName == servantRegionName then
      ...
      if servantInfo:getVehicleType() ~= __eVehicleType_CashPersonalTradeShip then
        PaGlobal_ServantList_All:setSubMenuData(self._subMenuGroup[self._subMenuCount], self._ENUM_SUBMENUTYPE._SELL, index)
      end
...
function PaGlobal_ServantList_All:guildShipSubMenuOpen(eType)
  ...
  if eType == self._ENUM_TYPESEALED then
    ...
    elseif regionName == servantRegionName then
      ...
      if servantInfo ~= nil and ToClient_servantUpgradeCharacterKeyList(servantInfo:getCharacterKeyRaw()) ~= nil then
        PaGlobal_ServantList_All:setSubMenuData(self._subMenuGroup[self._subMenuCount], self._ENUM_SUBMENUTYPE._UPGRADE, index)
      end
    end
  end
...
function PaGlobal_ServantList_All:setGuildPanel(isGuild)
  if true == isGuild then
    ...
    self._ui._txt_ServantListValue:SetSpanSize(self._ui._txt_ServantListTitle:GetSpanSize().x, self._ORIGINAL_LISTCOUNT_SPANY)
    self._ui._list2_Servant:SetSpanSize(self._ui._list2_Servant:GetSpanSize().x, self._ORIGINAL_LIST2_SPANY)
    self._ui._btn_SortButton:SetShow(true)
  end
  ...
  self._ui._btn_IncreaseSlot:ComputePos()
  self._ui._btn_Regist:ComputePos()
  self._ui._btn_SortButton:ComputePos()
end
function PaGlobal_ServantList_All:setSubMenuData(control, menutype, slotIndex)
  ...
  elseif menutype == self._ENUM_SUBMENUTYPE._SUPPLYHORSE then
    ...
    control:addInputEvent("Mouse_LUp", "PaGlobal_ImperialSupplyMSG_Open()")
...
function PaGlobal_ServantList_All:setSnapTarget(idx)
  ...
  elseif idx == 3 then
    ToClient_padSnapChangeToTarget(PaGlobal_ServantList_All._ui._rdo_SortByDefault)
  end
end
  ...
  if true == _ContentsGroup_InstanceHorseRacing then
    ...
    elseif true == self._ui._txt_ServantListValue:GetShow() and false == self._ui._txt_RaceHorseListValue:GetShow() then
      ...
      if false == self._ui._stc_ServantListIcon:GetShow() then
        ...
        self._ui._btn_BuyWeight:SetPosY(205)
      end
    end
  else
    self._ui._txt_ServantListValue:SetPosX(self._defaultTxtServantListValue)
    self._ui._btn_BuyWeight:SetPosY(self._ui._txt_ServantListValue:GetPosY() - 5)
    return
  end
end
...
function PaGlobal_ServantList_All:isCrogdaloServant(sortedIndex)
  local selfPlayer = getSelfPlayer()
  if nil == selfPlayer then
    return false
  end
  if sortedIndex < self._crogdalIndexStart then
    return false
  end
  if _ContentsGroup_Crogdalo == false then
    return false
  end
  if PaGlobalFunc_ServantFunction_All_Get_NpcType() ~= self._ENUM_NPC_TYPE._LAND then
    return false
  end
...
function PaGlobal_ServantList_All:checkHasGender(servantWrapperInfo)
  if servantWrapperInfo == nil then
    return false
  end
  local servantType = servantWrapperInfo:getVehicleType()
  return (servantType == CppEnums.VehicleType.Type_Horse or servantType == CppEnums.VehicleType.Type_RaceHorse) and servantWrapperInfo:isDisplayGender() == true
end
function PaGlobal_ServantList_All:checkHasLevel(servantWrapperInfo)
  if servantWrapperInfo == nil then
    return false
  end
  local servantType = servantWrapperInfo:getVehicleType()
  return servantType == CppEnums.VehicleType.Type_Horse or servantType == CppEnums.VehicleType.Type_Camel or servantType == CppEnums.VehicleType.Type_Donkey or servantType == CppEnums.VehicleType.Type_RidableBabyElephant
end
function PaGlobal_ServantList_All:hilightSelectedServant()
  if Panel_Dialog_ServantList_All == nil then
    return false
  end
  if self._ui._btn_CurrentServant ~= nil then
    self._ui._btn_CurrentServant:ChangeTextureInfoTextureIDAsync("Combine_Btn_Basic_Activating", 0)
    self._ui._btn_CurrentServant:ChangeTextureInfoTextureIDAsync("Combine_Btn_Basic_Over", 1)
    self._ui._btn_CurrentServant:setRenderTexture(self._ui._btn_CurrentServant:getBaseTexture())
  end
  local list2Content, list2ContentBtn
  local list2ContentsSize = self._ui._list2_Servant:getChildContentListSize()
  for ii = 0, list2ContentsSize - 1 do
    list2Content = UI.getChildControl(self._ui._list2_Servant, "List2_Servant_Content_" .. ii)
    if list2Content ~= nil then
      list2ContentBtn = UI.getChildControl(list2Content, "Button_List")
      list2ContentBtn:ChangeTextureInfoTextureIDAsync("Combine_Frame_GradationSlot_Normal", 0)
      list2ContentBtn:ChangeTextureInfoTextureIDAsync("Combine_Frame_GradationSlot_Over", 1)
      list2ContentBtn:setRenderTexture(list2ContentBtn:getBaseTexture())
    end
  end
  if PaGlobal_ServantList_All._currentSealType == PaGlobal_ServantList_All._ENUM_TYPEUNSEALED then
    self._ui._btn_CurrentServant:ChangeTextureInfoTextureIDAsync("Combine_Btn_Basic_OverClick", 0)
    self._ui._btn_CurrentServant:ChangeTextureInfoTextureIDAsync("Combine_Btn_Basic_OverClick", 1)
    self._ui._btn_CurrentServant:setRenderTexture(self._ui._btn_CurrentServant:getBaseTexture())
  else
    list2Content = UI.getChildControl(self._ui._list2_Servant, "List2_Servant_Content_" .. PaGlobal_ServantList_All._selectSlotNo % list2ContentsSize)
    if list2Content ~= nil then
      list2ContentBtn = UI.getChildControl(list2Content, "Button_List")
      list2ContentBtn:ChangeTextureInfoTextureIDAsync("Combine_Frame_GradationSlot_OverClick", 0)
      list2ContentBtn:ChangeTextureInfoTextureIDAsync("Combine_Frame_GradationSlot_OverClick", 1)
      list2ContentBtn:setRenderTexture(list2ContentBtn:getBaseTexture())
    end
  end
end
function PaGlobal_ServantList_All:validate()
  ...
  self._ui._stc_SortComponent:isValidate()
  self._ui._stc_MainSort:isValidate()
  self._ui._rdo_SortByDefault:isValidate()
  self._ui._rdo_SortByLevel:isValidate()
  self._ui._rdo_SortByTier:isValidate()
  self._ui._rdo_SortByMixCount:isValidate()
  self._ui._rdo_SortByGender:isValidate()
  self._ui._stc_SubSort:isValidate()
  self._ui._rdo_Desc:isValidate()
  self._ui._rdo_Asc:isValidate()
