function PaGlobalFunc_Servant_FantasySelect_All_Open(isMale)
  if Panel_Dialog_Servant_FantasySelect_All == nil or Panel_Dialog_Servant_FantasySelect_All:GetShow() == true then
    return
  end
  if _ContentsGroup_ServantFantasyMix == false then
    return
  end
  if PaGlobal_ServantExchange_Fantasy_All._isFantasyMixDoing == true then
    return
  end
