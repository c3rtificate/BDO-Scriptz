...
function FromClient_ServantList_All_Update_ChangeVehicleHP()
  FromClient_ServantList_All_UpdateVehicleList(PaGlobal_ServantList_All._ENUM_UPDATE_FLAG._ONLY_HP)
end
function FromClient_ServantList_All_Update_ChangeVehicleMP()
  FromClient_ServantList_All_UpdateVehicleList(PaGlobal_ServantList_All._ENUM_UPDATE_FLAG._ONLY_MP)
end
function FromClient_ServantList_All_UpdateVehicleList(updateFlag)
  if nil == Panel_Dialog_ServantList_All or false == Panel_Dialog_ServantList_All:GetShow() then
    return
  end
  ...
  if nil == PaGlobal_ServantList_All._selectSlotNo or -1 == PaGlobal_ServantList_All._selectSlotNo then
    ...
    PaGlobalFunc_ServantInfo_All_Open(sortedSlotNo, updateFlag)
  else
...
function FromClient_ServantList_All_Servant_SealFinish(servantNo, regionKey, servantWhereType)
  ...
  local slotNo = PaGlobal_ServantList_All:stableList_GetSlotNoByServentNo(servantNo)
  local sortedSlotNo = PaGlobal_ServantList_All:stableList_SelectSlotNo(slotNo)
  HandleEventOn_ServantList_All_SelectServant(PaGlobal_ServantList_All._ENUM_TYPESEALED, sortedSlotNo)
...
function FromClient_ServantList_All_RegistServantSuccess()
  ...
  if PaGlobal_ServantList_All._currentSealType == PaGlobal_ServantList_All._ENUM_TYPEUNSEALED then
    ...
    HandleEventOn_ServantList_All_SelectServant(PaGlobal_ServantList_All._ENUM_TYPESEALED, PaGlobal_ServantList_All._selectSlotNo)
  end
end
