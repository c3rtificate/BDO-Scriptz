function PaGlobal_ServantExchange_All:initialize()
  ...
  self._ui._stc_MoneyArea = UI.getChildControl(self._ui._stc_Exchange_Bg, "Static_MyMoneyArea")
...
function PaGlobal_ServantExchange_All:prepareOpen()
  ...
  if false == self._isConsole or false == _ContentsGroup_RenewUI then
...
function PaGlobal_ServantExchange_All:moneyUpdate()
  ...
  self._ui._txt_MoneyValue:SetText(makeDotMoney(invenMoney))
end
