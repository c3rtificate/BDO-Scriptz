...
function PaGlobalFunc_ServantExchange_Fantasy_All_UpdateEffect(deltaTime)
  ...
  elseif 1 == PaGlobal_ServantExchange_Fantasy_All._effectType and PaGlobal_ServantExchange_Fantasy_All._elapsedTime > 2 then
    ...
    PaGlobalFunc_ServantSwiftResult_All_fantasyMixEffect(0, PaGlobal_ServantExchange_Fantasy_All._resultCharacterKey)
...
function HandleEventLUp_ServantExchange_Fantasy_All_ItemSet_NumPadOn()
  ...
  if _ContentsGroup_UsePadSnapping == true and __eTInventorySlotNoUndefined ~= PaGlobal_ServantExchange_Fantasy_All._needItemInfo._needItemSlotNo and 0 < PaGlobal_ServantExchange_Fantasy_All._needItemInfo._needItemCount then
    PaGlobal_ServantExchange_Fantasy_All:clearNeedItemCount()
    return
  end
...
function FromClient_ServantExchange_Fantasy_All_UpdateFantasyMixStackCount()
  if Panel_Dialog_ServantExchange_Fantasy_All == nil or Panel_Dialog_ServantExchange_Fantasy_All:GetShow() == false then
    return
  end
  PaGlobal_ServantExchange_Fantasy_All:stackCountUpdate()
end
