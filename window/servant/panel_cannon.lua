...
local _current_cannonCharacterKey = 0
local shiftPosX = 10
...
local fireGuide = {
  ...
  fireGuide_KeyShift5 = UI.getChildControl(Panel_Cannon, "StaticText_Key_Shift5"),
  fireGuide_KeyW = UI.getChildControl(Panel_Cannon, "StaticText_Key_W"),
  fireGuide_KeyF = UI.getChildControl(Panel_Cannon, "StaticText_Key_F"),
  fireGuide_KeyF_2 = UI.getChildControl(Panel_Cannon, "StaticText_Key_F_2"),
  ...
  fireGuide_Text_FocusFire = UI.getChildControl(Panel_Cannon, "StaticText_Focus_Fire"),
  fireGuide_Text_ContinueFire = UI.getChildControl(Panel_Cannon, "StaticText_ContinueFire"),
  fireGuide_Text_FireArrow = UI.getChildControl(Panel_Cannon, "StaticText_FireArrow"),
  fireGuide_Text_ContinueFireArrow = UI.getChildControl(Panel_Cannon, "StaticText_ContinueFireArrow")
}
...
fireGuide.fireGuide_BG:AddChild(fireGuide.fireGuide_KeyShift5)
fireGuide.fireGuide_BG:AddChild(fireGuide.fireGuide_KeyW)
fireGuide.fireGuide_BG:AddChild(fireGuide.fireGuide_KeyF)
fireGuide.fireGuide_BG:AddChild(fireGuide.fireGuide_KeyF_2)
...
fireGuide.fireGuide_BG:AddChild(fireGuide.fireGuide_Text_FocusFire)
fireGuide.fireGuide_BG:AddChild(fireGuide.fireGuide_Text_ContinueFire)
fireGuide.fireGuide_BG:AddChild(fireGuide.fireGuide_Text_FireArrow)
fireGuide.fireGuide_BG:AddChild(fireGuide.fireGuide_Text_ContinueFireArrow)
...
Panel_Cannon:RemoveControl(fireGuide.fireGuide_KeyShift5)
Panel_Cannon:RemoveControl(fireGuide.fireGuide_KeyW)
Panel_Cannon:RemoveControl(fireGuide.fireGuide_KeyF)
Panel_Cannon:RemoveControl(fireGuide.fireGuide_KeyF_2)
...
Panel_Cannon:RemoveControl(fireGuide.fireGuide_Text_FocusFire)
Panel_Cannon:RemoveControl(fireGuide.fireGuide_Text_ContinueFire)
Panel_Cannon:RemoveControl(fireGuide.fireGuide_Text_FireArrow)
Panel_Cannon:RemoveControl(fireGuide.fireGuide_Text_ContinueFireArrow)
fireGuide.fireGuide_Text_Ready:SetSize(fireGuide.fireGuide_Text_Ready:GetTextSizeX(), fireGuide.fireGuide_Text_Ready:GetSizeY())
...
fireGuide.fireGuide_Text_Rapid:SetSize(fireGuide.fireGuide_Text_Rapid:GetTextSizeX(), fireGuide.fireGuide_Text_Rapid:GetSizeY())
fireGuide.fireGuide_Text_Protect:SetSize(fireGuide.fireGuide_Text_Protect:GetTextSizeX(), fireGuide.fireGuide_Text_Protect:GetSizeY())
fireGuide.fireGuide_Text_Charge:SetSize(fireGuide.fireGuide_Text_Charge:GetTextSizeX(), fireGuide.fireGuide_Text_Charge:GetSizeY())
fireGuide.fireGuide_Text_FocusFire:SetSize(fireGuide.fireGuide_Text_FocusFire:GetTextSizeX(), fireGuide.fireGuide_Text_FocusFire:GetSizeY())
...
fireGuide.fireGuide_Text_FireArrow:SetSize(fireGuide.fireGuide_Text_FireArrow:GetTextSizeX(), fireGuide.fireGuide_Text_FireArrow:GetSizeY())
fireGuide.fireGuide_Text_ContinueFireArrow:SetSize(fireGuide.fireGuide_Text_ContinueFireArrow:GetTextSizeX(), fireGuide.fireGuide_Text_ContinueFireArrow:GetSizeY())
...
local function Cannon_Initialize()
  ...
  fireGuide.fireGuide_KeyShift5:SetPosX(10)
  fireGuide.fireGuide_KeyW:SetPosX(65)
  fireGuide.fireGuide_KeyF:SetPosX(10)
  fireGuide.fireGuide_KeyF_2:SetPosX(10)
  ...
  fireGuide.fireGuide_Text_FocusFire:SetPosX(112)
  fireGuide.fireGuide_Text_FireArrow:SetPosX(112)
  fireGuide.fireGuide_Text_ContinueFireArrow:SetPosX(112)
  ...
  fireGuide.fireGuide_KeyShift5:SetFontColor(4294312447)
  fireGuide.fireGuide_KeyW:SetFontColor(4294312447)
  fireGuide.fireGuide_KeyS:SetFontColor(4294312447)
  fireGuide.fireGuide_KeyF_2:SetFontColor(4294312447)
end
local nowCool = 0
local cannon = {}
function FromClient_Cannon_ProgressUpdate()
  ...
  elseif 1 == seatPosition and UI_VT.Type_Train == cannon:get():getVehicleType() then
    progresss:SetAniSpeed(0.5)
    progresss:SetProgressRate(nowCoolTime)
  else
    return
...
function Cannon_KeyGuideBgSizeAlign(BgControl, childList)
  ...
  BgControl:SetSize(resultSizeX + 15, resultSizeY + 10)
end
function Cannon_ShowCannonGuide(show)
  ...
  array:push_back(fireGuide.fireGuide_KeyShift1)
  array:push_back(fireGuide.fireGuide_KeyShift2)
  array:push_back(fireGuide.fireGuide_KeyShift3)
  array:push_back(fireGuide.fireGuide_KeyShift4)
  ...
  array:push_back(fireGuide.fireGuide_Text_Ready)
...
function Cannon_ShowThrowStoneGuide(isShow)
  fireGuide.fireGuide_KeyShift1:SetPosY(basicPosY)
  fireGuide.fireGuide_KeyShift2:SetPosY(basicPosY + keySizeY)
  fireGuide.fireGuide_KeyShift3:SetPosY(basicPosY + keySizeY * 2)
  fireGuide.fireGuide_KeyShift4:SetPosY(basicPosY + keySizeY * 3)
  ...
  fireGuide.fireGuide_Text_Low:SetPosY(basicPosY + keySizeY)
  fireGuide.fireGuide_Text_Ready:SetPosY(basicPosY + keySizeY * 2)
  fireGuide.fireGuide_Text_FireArrow:SetPosY(basicPosY + keySizeY * 2 + mouseSizeY)
  fireGuide.fireGuide_KeyShift1:SetPosX(shiftPosX)
  fireGuide.fireGuide_KeyShift2:SetPosX(shiftPosX)
  fireGuide.fireGuide_KeyShift3:SetPosX(shiftPosX)
  fireGuide.fireGuide_KeyShift4:SetPosX(shiftPosX)
  ...
  fireGuide.fireGuide_Text_High:SetPosX(shiftKeyDescPosX)
  fireGuide.fireGuide_Text_Low:SetPosX(shiftKeyDescPosX)
  fireGuide.fireGuide_Text_FireArrow:SetPosX(shiftMouseDescPosX)
  fireGuide.fireGuide_BG:SetShow(isShow)
  fireGuide.fireGuide_KeyShift1:SetShow(isShow)
  fireGuide.fireGuide_KeyShift2:SetShow(isShow)
  fireGuide.fireGuide_KeyShift3:SetShow(isShow)
  fireGuide.fireGuide_KeyShift4:SetShow(isShow)
  fireGuide.fireGuide_KeyW:SetShow(isShow)
  fireGuide.fireGuide_KeyS:SetShow(isShow)
  fireGuide.fireGuide_MouseL:SetShow(isShow)
  fireGuide.fireGuide_MouseR:SetShow(isShow)
  fireGuide.fireGuide_Text_Ready:SetShow(isShow)
  fireGuide.fireGuide_Text_High:SetShow(isShow)
  fireGuide.fireGuide_Text_Low:SetShow(isShow)
  fireGuide.fireGuide_Text_FireArrow:SetShow(isShow)
  local array = Array.new()
  array:push_back(fireGuide.fireGuide_KeyShift1)
  array:push_back(fireGuide.fireGuide_KeyShift2)
  array:push_back(fireGuide.fireGuide_KeyShift3)
  ...
  array:push_back(fireGuide.fireGuide_Text_High)
  array:push_back(fireGuide.fireGuide_Text_Low)
  array:push_back(fireGuide.fireGuide_Text_FireArrow)
  Cannon_KeyGuideBgSizeAlign(fireGuide.fireGuide_BG, array)
end
function Cannon_ShowUpgradeThrowStoneGuide(isShow)
  fireGuide.fireGuide_KeyShift1:SetPosY(basicPosY)
  fireGuide.fireGuide_KeyW:SetPosY(basicPosY)
  fireGuide.fireGuide_Text_High:SetPosY(basicPosY)
  fireGuide.fireGuide_KeyShift2:SetPosY(basicPosY + keySizeY)
  ...
  fireGuide.fireGuide_MouseR:SetPosY(basicPosY + keySizeY * 3)
  fireGuide.fireGuide_Text_FireArrow:SetPosY(basicPosY + keySizeY * 2 + mouseSizeY)
  fireGuide.fireGuide_KeyShift5:SetPosY(basicPosY + keySizeY * 3 + mouseSizeY)
  fireGuide.fireGuide_KeyF_2:SetPosY(basicPosY + keySizeY * 3 + mouseSizeY)
  fireGuide.fireGuide_Text_ContinueFireArrow:SetPosY(basicPosY + keySizeY * 3 + mouseSizeY)
  fireGuide.fireGuide_KeyShift1:SetPosX(shiftPosX)
  fireGuide.fireGuide_KeyShift2:SetPosX(shiftPosX)
  fireGuide.fireGuide_KeyShift3:SetPosX(shiftPosX)
  fireGuide.fireGuide_KeyShift4:SetPosX(shiftPosX)
  fireGuide.fireGuide_KeyShift5:SetPosX(shiftPosX)
  fireGuide.fireGuide_KeyW:SetPosX(shiftKeyPosX)
  fireGuide.fireGuide_KeyS:SetPosX(shiftKeyPosX)
  fireGuide.fireGuide_KeyF_2:SetPosX(shiftKeyPosX)
  fireGuide.fireGuide_MouseL:SetPosX(shiftKeyPosX)
  fireGuide.fireGuide_MouseR:SetPosX(shiftKeyPosX + 16)
  fireGuide.fireGuide_Text_Ready:SetPosX(shiftDescPosX)
  fireGuide.fireGuide_Text_High:SetPosX(shiftKeyDescPosX)
  fireGuide.fireGuide_Text_Low:SetPosX(shiftKeyDescPosX)
  fireGuide.fireGuide_Text_ContinueFireArrow:SetPosX(shiftKeyDescPosX)
  fireGuide.fireGuide_Text_FireArrow:SetPosX(shiftMouseDescPosX)
  fireGuide.fireGuide_BG:SetShow(isShow)
  fireGuide.fireGuide_KeyShift1:SetShow(isShow)
  fireGuide.fireGuide_KeyShift2:SetShow(isShow)
  fireGuide.fireGuide_KeyShift3:SetShow(isShow)
  fireGuide.fireGuide_KeyShift4:SetShow(isShow)
  fireGuide.fireGuide_KeyShift5:SetShow(isShow)
  fireGuide.fireGuide_KeyW:SetShow(isShow)
  fireGuide.fireGuide_KeyS:SetShow(isShow)
  fireGuide.fireGuide_KeyF_2:SetShow(isShow)
  fireGuide.fireGuide_MouseL:SetShow(isShow)
  fireGuide.fireGuide_MouseR:SetShow(isShow)
  fireGuide.fireGuide_Text_Ready:SetShow(isShow)
  fireGuide.fireGuide_Text_High:SetShow(isShow)
  fireGuide.fireGuide_Text_Low:SetShow(isShow)
  fireGuide.fireGuide_Text_ContinueFireArrow:SetShow(isShow)
  fireGuide.fireGuide_Text_FireArrow:SetShow(isShow)
  local array = Array.new()
  array:push_back(fireGuide.fireGuide_KeyShift1)
  array:push_back(fireGuide.fireGuide_KeyShift2)
  array:push_back(fireGuide.fireGuide_KeyShift3)
  array:push_back(fireGuide.fireGuide_KeyShift4)
  array:push_back(fireGuide.fireGuide_KeyShift5)
  array:push_back(fireGuide.fireGuide_KeyW)
  array:push_back(fireGuide.fireGuide_KeyS)
  array:push_back(fireGuide.fireGuide_KeyF_2)
  array:push_back(fireGuide.fireGuide_MouseL)
  array:push_back(fireGuide.fireGuide_MouseR)
  array:push_back(fireGuide.fireGuide_Text_Ready)
  array:push_back(fireGuide.fireGuide_Text_High)
  array:push_back(fireGuide.fireGuide_Text_Low)
  array:push_back(fireGuide.fireGuide_Text_ContinueFireArrow)
  array:push_back(fireGuide.fireGuide_Text_FireArrow)
  Cannon_KeyGuideBgSizeAlign(fireGuide.fireGuide_BG, array)
end
function Cannon_ShowThrowFireGuide(show)
  isShowFocus = 9088 == _current_cannonCharacterKey or 31073 == _current_cannonCharacterKey or 31074 == _current_cannonCharacterKey or 31075 == _current_cannonCharacterKey or 31132 == _current_cannonCharacterKey or 31133 == _current_cannonCharacterKey
  isShowFocus = true == isShowFocus and true == show
  if true == isShowFocus then
    fireGuide.fireGuide_BG:SetSize(185, 75)
  else
  ...
  fireGuide.fireGuide_KeyF:SetPosX(shiftPosX)
  fireGuide.fireGuide_KeyF:SetPosY(basicPosY + keySizeY)
  fireGuide.fireGuide_Text_Fire:SetPosY(basicPosY)
  fireGuide.fireGuide_Text_Fire:SetPosX(shiftDescPosX)
  fireGuide.fireGuide_Text_FocusFire:SetPosY(basicPosY + keySizeY)
  fireGuide.fireGuide_Text_FocusFire:SetPosX(shiftDescPosX)
  fireGuide.fireGuide_BG:SetShow(show)
  fireGuide.fireGuide_Space:SetShow(show)
  fireGuide.fireGuide_Text_Fire:SetShow(show)
  fireGuide.fireGuide_KeyF:SetShow(isShowFocus)
  fireGuide.fireGuide_Text_FocusFire:SetShow(isShowFocus)
end
...
function Cannon_ShowTrainGuide(show)
  ...
  fireGuide.fireGuide_KeyW:SetPosY(basicPosY)
  fireGuide.fireGuide_KeyS:SetPosY(basicPosY + keySizeY)
  fireGuide.fireGuide_Text_High:SetPosY(basicPosY + keySizeY)
  fireGuide.fireGuide_Text_Low:SetPosY(basicPosY)
  fireGuide.fireGuide_MouseL:SetPosY(basicPosY + keySizeY * 2)
  fireGuide.fireGuide_MouseR:SetPosY(basicPosY + keySizeY * 2)
  fireGuide.fireGuide_Text_Fire:SetPosY(basicPosY + keySizeY * 2)
  fireGuide.fireGuide_MouseL2:SetPosY(basicPosY + keySizeY * 2 + mouseSizeY)
  fireGuide.fireGuide_MouseR2:SetPosY(basicPosY + keySizeY * 2 + mouseSizeY)
  fireGuide.fireGuide_Text_ContinueFire:SetPosY(basicPosY + keySizeY * 2 + mouseSizeY)
  ...
  fireGuide.fireGuide_Text_ContinueFire:SetPosX(shiftKeyPosX)
  fireGuide.fireGuide_BG:SetShow(show)
  fireGuide.fireGuide_KeyW:SetShow(show)
  fireGuide.fireGuide_KeyS:SetShow(show)
  fireGuide.fireGuide_MouseL:SetShow(show)
...
function Cannon_GuideShow(show)
  ...
  fireGuide.fireGuide_BG:SetSize(185, 145)
  if _current_cannonType == _enum_CannonType._cannon then
    Cannon_ShowCannonGuide(show)
  elseif _current_cannonType == _enum_CannonType._throwStone then
    Cannon_ShowThrowStoneGuide(show)
  elseif _current_cannonType == _enum_CannonType._throwStoneUpgrade then
    Cannon_ShowUpgradeThrowStoneGuide(show)
...
function PaGlobal_Cannon_SetControlShowByType(vehicleMainType)
  progresssBG:SetShow(false)
  progresss:SetShow(false)
  progresss_Head:SetShow(false)
  arrowProgressBG:SetShow(false)
...
function FromClient_Cannon_Show(actorKeyRaw)
  ...
  vehicle_characterKeyRaw = vehicleActorProxyWrapper:getCharacterKeyRaw()
  Cannon_Initialize()
  vehicle_actorKeyRaw = actorKeyRaw
  PaGlobal_Cannon_SetControlShowByType(vehicleMainType)
  if Panel_SkillCommand:GetShow() == true then
    Panel_SkillCommand:SetShow(false)
    skillCommandAlreadyShow = true
  end
  local nowCoolTime = 0
  if UI_VT.Type_Cannon == vehicleMainType or UI_VT.Type_PracticeCannon == vehicleMainType or UI_VT.Type_ThrowStone == vehicleMainType or UI_VT.Type_ThrowFire == vehicleMainType or UI_VT.Type_Ballista == vehicleMainType or UI_VT.Type_Train == vehicleMainType then
  ...
  _current_cannonCharacterKey = vehicle_characterKeyRaw
  if UI_VT.Type_Cannon == vehicleMainType or UI_VT.Type_PracticeCannon == vehicleMainType then
    progresss:SetProgressRate(nowCoolTime)
  ...
  elseif UI_VT.Type_ThrowStone == vehicleMainType then
    ...
    elseif vehicleSubType == 1 then
      _current_cannonType = _enum_CannonType._throwStoneUpgrade
    else
      UI.ASSERT_NAME(false, "\235\185\132\236\160\149\236\131\129\236\158\133\235\139\136\235\139\164. \236\139\160\234\184\176\236\160\132\236\157\152 vehicleSubType\236\157\180 0\235\143\132 \236\149\132\235\139\136\234\179\160 1\235\143\132 \236\149\132\235\139\153\235\139\136\235\139\164.", "\236\157\180\236\163\188")
...
function FromClient_UpdateCannonBallCount(count, VehicleTpye)
  ...
  if _ContentsGroup_DontUseCannonBall == true then
    shootCount:SetShow(false)
  else
