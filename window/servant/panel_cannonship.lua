...
function CannonShip_Show(actorKeyRaw)
  ...
  if CppEnums.VehicleType.Type_SailingBoat == isVehicleType or CppEnums.VehicleType.Type_PersonalBattleShip == isVehicleType or CppEnums.VehicleType.Type_PersonTradeShip == isVehicleType or CppEnums.VehicleType.Type_PersonalBoat == isVehicleType or CppEnums.VehicleType.Type_CashPersonalBattleShip == isVehicleType or CppEnums.VehicleType.Type_CashPersonalTradeShip == isVehicleType then
    if 0 ~= seatPosition and 13 ~= seatPosition and 4 ~= seatPosition and 3 ~= seatPosition and 1 ~= seatPosition and 2 ~= seatPosition and ToClient_IsVehiclePaddleSeatIndex(isVehicleType, seatPosition) == false then
...
function FromClient_UpdateCannonShipBallCount(count, VehicleTpye)
  if UI_VT.Type_SailingBoat ~= VehicleTpye and UI_VT.Type_PersonalBattleShip ~= VehicleTpye and UI_VT.Type_PersonTradeShip ~= VehicleTpye and UI_VT.Type_PersonalBoat ~= VehicleTpye and UI_VT.Type_CashPersonalTradeShip ~= VehicleTpye and UI_VT.Type_CashPersonalBattleShip ~= VehicleTpye and UI_VT.Type_Carrack ~= VehicleTpye then
    return
  end
  if ToClient_IsContentsGroupOpen("504") then
    shootCount:SetShow(true)
    shootCount:SetText(count)
  else
...
if ToClient_IsContentsGroupOpen("504") then
  registerEvent("FromClient_UpdateCannonStatCount", "FromClient_UpdateCannonShipBallCount")
else
