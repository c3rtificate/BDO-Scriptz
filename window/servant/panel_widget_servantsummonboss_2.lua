...
function FromAction_ServantSummonBoss_Stack1Crio()
  if nil ~= PaGlobal_ServantSummonBoss._ui._stc_stackGroup_crio and PaGlobal_ServantSummonBoss._ui._stc_stackGroup_crio:GetShow() == false then
...
function FromAction_ServantSummonBoss_Stack1Papu()
  if nil ~= PaGlobal_ServantSummonBoss._ui._stc_stackGroup_papu and PaGlobal_ServantSummonBoss._ui._stc_stackGroup_papu:GetShow() == false then
