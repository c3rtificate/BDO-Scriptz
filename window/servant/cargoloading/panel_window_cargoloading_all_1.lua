function PaGlobal_CargoLoading:initialize()
  ...
  self._ui._stc_keyGuideLB = UI.getChildControl(stc_rdoButtons, "Static_SelectLB_C")
  self._ui._stc_keyGuideRB = UI.getChildControl(stc_rdoButtons, "Static_SelectRB_C")
  ...
  self._ui._stc_keyGuideBG = UI.getChildControl(Panel_Window_CargoLoading_ALL, "Static_Console_KeyGuide_Main")
  self._ui._stc_keyGuideRS = UI.getChildControl(self._ui._stc_keyGuideBG, "StaticText_Console_RS")
  self._ui._stc_keyGuideRSClick = UI.getChildControl(self._ui._stc_keyGuideBG, "StaticText_Console_RSClick")
  self._ui._stc_keyGuideX = UI.getChildControl(self._ui._stc_keyGuideBG, "StaticText_Console_X")
  self._ui._stc_keyGuideY = UI.getChildControl(self._ui._stc_keyGuideBG, "StaticText_Console_Y")
  self._ui._stc_keyGuideA = UI.getChildControl(self._ui._stc_keyGuideBG, "StaticText_Console_A")
  self._ui._stc_keyGuideB = UI.getChildControl(self._ui._stc_keyGuideBG, "StaticText_Console_B")
  self._blankSlots = {}
  self._slots = {}
...
function PaGlobal_CargoLoading:registEventHandler()
  ...
  if true == self._isConsole then
    Panel_Window_CargoLoading_ALL:registerPadEvent(__eConsoleUIPadEvent_LB, "HandleEventPad_CargoLoading_UpdateSlot(false)")
    Panel_Window_CargoLoading_ALL:registerPadEvent(__eConsoleUIPadEvent_RB, "HandleEventPad_CargoLoading_UpdateSlot(true)")
    Panel_Window_CargoLoading_ALL:registerPadEvent(__eConsoleUIPadEvent_RSClick, "HandleEventMLUp_CargoLoading_ToggleBarterInfo()")
    if false == _ContentsGroup_RenewUI then
      Panel_Window_CargoLoading_ALL:registerPadEvent(__eConsoleUIPadEvent_Up_Y, "HandleEventMLUp_CargoLoading_Close()")
    end
  else
...
function PaGlobal_CargoLoading:setConsoleUI()
  if nil == Panel_Window_CargoLoading_ALL then
    return
  end
  if true == self._isConsole then
    ...
    self._ui._btn_barterInfo:SetShow(false)
    self._ui._stc_keyGuideBG:SetShow(true)
    self._ui._stc_keyGuideLB:SetShow(true)
    self._ui._stc_keyGuideRB:SetShow(true)
    if false == _ContentsGroup_RenewUI then
      self._ui._stc_keyGuideY:SetShow(true)
    else
      self._ui._stc_keyGuideY:SetShow(false)
    end
    Panel_Window_CargoLoading_ALL:SetSize(Panel_Window_CargoLoading_ALL:GetSizeX(), Panel_Window_CargoLoading_ALL:GetSizeY() - self._ui._btn_confirm:GetSizeY() - 10)
    self:alignKeyGuide()
  else
    self._ui._btn_close:SetShow(true)
    self._ui._btn_confirm:SetShow(true)
    self._ui._btn_barterInfo:SetShow(true)
...
function PaGlobal_CargoLoading:alignKeyGuide()
  local keyGuide = {
    self._ui._stc_keyGuideRS,
    self._ui._stc_keyGuideRSClick,
...
function PaGlobal_CargoLoading:validate()
  ...
  self._ui._stc_keyGuideRSClick:isValidate()
...
function PaGlobal_CargoLoading:initMyInventorySlot()
  ...
  for ii = 0, self._config.slotCount_w - 1 do
    ...
    if nil == blankSlotList[ii] then
      ...
      if true == self._isConsole then
        slot.empty:registerPadEvent(__eConsoleUIPadEvent_RStickUp, "HandleEventScroll_CargoLoading_WarehouseScroll(true)")
        slot.empty:registerPadEvent(__eConsoleUIPadEvent_RStickDown, "HandleEventScroll_CargoLoading_WarehouseScroll(false)")
      end
    ...
    if nil == slotList[ii] then
      ...
      if false == self._isConsole then
        ...
        slot.icon:registerPadEvent(__eConsoleUIPadEvent_RStickUp, "HandleEventScroll_CargoLoading_WarehouseScroll(true)")
        slot.icon:registerPadEvent(__eConsoleUIPadEvent_RStickDown, "HandleEventScroll_CargoLoading_WarehouseScroll(false)")
      end
    ...
    if nil ~= blankSlot then
      ...
      if true == self._isConsole then
        blankSlot.lock:registerPadEvent(__eConsoleUIPadEvent_RStickUp, "HandleEventScroll_CargoLoading_WarehouseScroll(true)")
        blankSlot.lock:registerPadEvent(__eConsoleUIPadEvent_RStickDown, "HandleEventScroll_CargoLoading_WarehouseScroll(false)")
      end
      local row = math.floor(ii / slotCols)
      local column = ii % slotCols
...
function PaGlobal_CargoLoading:initServantInventorySlot()
  ...
  for ii = 0, self._config.slotCount_s - 1 do
    ...
    if nil == blankSlotList[ii] then
      ...
      blankSlotList[ii] = slot
      if true == self._isConsole then
        slot.empty:registerPadEvent(__eConsoleUIPadEvent_RStickUp, "HandleEventScroll_CargoLoading_ServantScroll(true)")
        slot.empty:registerPadEvent(__eConsoleUIPadEvent_RStickDown, "HandleEventScroll_CargoLoading_ServantScroll(false)")
      end
    end
    blankSlot = blankSlotList[ii]
    if nil == slotList[ii] then
      ...
      if false == self._isConsole then
        ...
        slot.icon:registerPadEvent(__eConsoleUIPadEvent_RStickUp, "HandleEventScroll_CargoLoading_ServantScroll(true)")
        slot.icon:registerPadEvent(__eConsoleUIPadEvent_RStickDown, "HandleEventScroll_CargoLoading_ServantScroll(false)")
      end
    ...
    if nil ~= blankSlot then
      ...
      if true == self._isConsole then
        blankSlot.lock:registerPadEvent(__eConsoleUIPadEvent_RStickUp, "HandleEventScroll_CargoLoading_ServantScroll(true)")
        blankSlot.lock:registerPadEvent(__eConsoleUIPadEvent_RStickDown, "HandleEventScroll_CargoLoading_ServantScroll(false)")
      end
      local row = math.floor(ii / slotCols)
      local column = ii % slotCols
      blankSlot.lock:SetPosX(self._config.slotStartX + self._config.slotGapX * column)
...
function PaGlobal_CargoLoading:updateMyInventorySlot()
  ...
  local lootMaxCount = useMaxCount + useStartSlot - 1
  ...
  if self._ui._chk_sortButton:IsCheck() then
    ...
    sortList:fill(useStartSlot, lootMaxCount)
    ...
    if nil == slot.slotNo then
      ...
      if nil ~= itemWrapper then
        ...
        if false == _ContentsGroup_UsePadSnapping then
          if false == isDuplicatedItem and false == isOriginalForDuel then
            slot.icon:addInputEvent("Mouse_RUp", "HandleEventMRUp_CargoLoading_SlotRClick(" .. PaGlobal_CargoLoading._eSlotType.inventory .. ", " .. ii .. ")")
          else
            slot.icon:addInputEvent("Mouse_RUp", "")
          end
        elseif false == isDuplicatedItem and false == isOriginalForDuel then
          slot.icon:addInputEvent("Mouse_RUp", "HandleEventMOn_CargoLoading_IconOver(" .. PaGlobal_CargoLoading._eSlotType.inventory .. ", " .. ii .. ")")
          slot.icon:addInputEvent("Mouse_LUp", "HandleEventMRUp_CargoLoading_SlotRClick(" .. PaGlobal_CargoLoading._eSlotType.inventory .. ", " .. ii .. ")")
        else
          slot.icon:addInputEvent("Mouse_RUp", "")
        ...
        if true == _ContentsGroup_NewDelivery then
          ...
          if nil ~= itemStatic then
            ...
            if self._eMySlot.myInven == self._currentMySlotType then
              if true == item:isStackableXXX() then
    ...
    if nil == slot.slotNo then
      ...
      if nil ~= itemWrapper then
        ...
        if false == _ContentsGroup_UsePadSnapping then
          ...
          slot.icon:addInputEvent("Mouse_RUp", "HandleEventMOn_CargoLoading_IconOver(" .. PaGlobal_CargoLoading._eSlotType.servant .. ", " .. ii .. ")")
          slot.icon:addInputEvent("Mouse_LUp", "HandleEventMRUp_CargoLoading_SlotRClick(" .. PaGlobal_CargoLoading._eSlotType.servant .. ", " .. ii .. ")")
        end
        local itemCountZero = false
        if true == _ContentsGroup_NewDelivery then
          local itemStatic = itemWrapper:getStaticStatus()
...
function PaGlobal_CargoLoading:checkCurrentRegionWarehouse()
  ...
  if nil == warehouseWrapper then
    if true == self._isConsole then
      self._ui._stc_keyGuideLB:SetShow(false)
      self._ui._stc_keyGuideRB:SetShow(false)
      self._currentSelectedTab = PaGlobal_CargoLoading._eMySlot.myInven
      Panel_Window_CargoLoading_ALL:registerPadEvent(__eConsoleUIPadEvent_LB, "")
      Panel_Window_CargoLoading_ALL:registerPadEvent(__eConsoleUIPadEvent_RB, "")
    end
  ...
  if true == _ContentsGroup_UsePadSnapping then
    self._ui._rdo_myWarehouse:addInputEvent("Mouse_On", "HandleEventMOn_CargoLoading_SetPadScrollEvent(" .. PaGlobal_CargoLoading._eSlotType.inventory .. ")")
    self._ui._rdo_myWarehouse:addInputEvent("Mouse_Out", "HandleEventMOn_CargoLoading_SetPadScrollEvent()")
    self._ui._rdo_MyBag:addInputEvent("Mouse_On", "HandleEventMOn_CargoLoading_SetPadScrollEvent(" .. PaGlobal_CargoLoading._eSlotType.inventory .. ")")
    self._ui._rdo_MyBag:addInputEvent("Mouse_Out", "HandleEventMOn_CargoLoading_SetPadScrollEvent()")
  end
end
