...
function PaGlobalFunc_CharInfoChallenge_All_OpenWithReward()
  if true == _ContentsGroup_RenewUI then
    PaGlobalFunc_ChracterInfo_All_ChangeOpenPosForReward()
    PaGlobal_TotalReward_All_OpenWhenOtherPanel(2)
  end
end
...
function PaGlobalFunc_InGameEventNotice()
  local serviceType = getGameServiceType()
  local resourceType = ToClient_getResourceType()
  local urlList = {
    [1] = "https://www.kr.playblackdesert.com/ko-KR/News/Detail?groupContentNo=12807&countryType=ko-KR",
    [2] = "https://www.kr.playblackdesert.com/ko-KR/News/Detail?groupContentNo=12807&countryType=ko-KR",
    [3] = "https://www.kr.playblackdesert.com/ko-KR/News/Detail?groupContentNo=12807&countryType=ko-KR",
    [5] = "https://www.jp.playblackdesert.com/ja-JP/News/Detail?groupContentNo=9266",
    [6] = "https://www.jp.playblackdesert.com/ja-JP/News/Detail?groupContentNo=9266",
    [7] = "https://www.ru.playblackdesert.com/News/Notice/Detail?boardNo=9803&countryType=ru-RU",
    [8] = "https://www.ru.playblackdesert.com/News/Notice/Detail?boardNo=9803&countryType=ru-RU",
    [10] = "",
    [11] = "https://www.naeu.playblackdesert.com/News/Detail?groupContentNo=7492",
    [12] = "https://www.naeu.playblackdesert.com/News/Detail?groupContentNo=7492",
    [13] = "https://www.tw.playblackdesert.com/zh-TW/News/Detail?groupContentNo=16559&countryType=zh-TW",
    [14] = "https://www.tw.playblackdesert.com/zh-TW/News/Detail?groupContentNo=16559&countryType=zh-TW",
    [15] = "",
    [16] = "",
    [17] = "https://blackdesert.pearlabyss.com/ASIA/en-US/News/Notice/Detail?_boardNo=6414",
    [18] = "https://blackdesert.pearlabyss.com/ASIA/en-US/News/Notice/Detail?_boardNo=6414",
    [19] = "https://blackdesert.pearlabyss.com/ASIA/en-US/News/Notice/Detail?_boardNo=6414",
    [20] = "https://blackdesert.pearlabyss.com/ASIA/en-US/News/Notice/Detail?_boardNo=6414",
    [21] = "https://www.tr.playblackdesert.com/en-US/News/Detail?groupContentNo=11016&countryType=en-US",
    [22] = "https://www.tr.playblackdesert.com/en-US/News/Detail?groupContentNo=11016&countryType=en-US",
    [24] = "",
    [26] = "",
    [28] = "",
    [32] = "",
    [34] = "",
    [35] = "https://blackdesert.pearlabyss.com/ASIA/en-US/News/Notice/Detail?_boardNo=6414",
    [36] = "https://blackdesert.pearlabyss.com/ASIA/en-US/News/Notice/Detail?_boardNo=6414",
    [99] = ""
  }
  local urlListForSA = {
    [8] = "https://www.sa.playblackdesert.com/News/Detail?groupContentNo=5132",
    [11] = "https://www.sa.playblackdesert.com/News/Detail?groupContentNo=5132"
  }
  if serviceType == 15 or serviceType == 16 then
    url = urlListForSA[resourceType]
  else
    url = urlList[serviceType]
  end
  if isGameServiceTypeConsole() == true then
    if CppEnums.ServiceResourceType.eServiceResourceType_KR == resourceType then
      url = "https://www.console.playblackdesert.com/News/Notice/Detail?boardNo=17839&countryType=ko-KR&boardType=4&searchType=&searchText=&currentPage=1"
    elseif CppEnums.ServiceResourceType.eServiceResourceType_DE == resourceType then
      url = "https://www.console.playblackdesert.com/News/Notice/Detail?boardNo=17841&countryType=de-DE&boardType=4&searchType=&searchText=&currentPage=1"
    elseif CppEnums.ServiceResourceType.eServiceResourceType_FR == resourceType then
      url = "https://www.console.playblackdesert.com/News/Notice/Detail?boardNo=17842&countryType=fr-FR&boardType=4&searchType=&searchText=&currentPage=1"
    elseif CppEnums.ServiceResourceType.eServiceResourceType_JP == resourceType then
      url = "https://www.console.playblackdesert.com/News/Notice/Detail?boardNo=17843&countryType=ja-JP&boardType=4&searchType=&searchText=&currentPage=1"
    else
      url = "https://www.console.playblackdesert.com/News/Notice/Detail?boardNo=17840&countryType=en-US&boardType=4&searchType=&searchText=&currentPage=1"
    end
    PaGlobalFunc_WebControl_Open(url)
    return
  end
  ...
  if nil ~= PaGlobal_CharInfoChallenge_All._ui.stc_RewardTable[uiIdx]._selectItem[slotIdx]._bg then
    ...
    for idx = 0, PaGlobal_CharInfoChallenge_All._MAXBGCOUNT - 1 do
      if nil ~= PaGlobal_CharInfoChallenge_All._ui.stc_RewardTable[idx] then
        if idx ~= uiIdx then
          PaGlobal_CharInfoChallenge_All._ui.stc_RewardTable[idx]._selectEffect:EraseAllEffect()
          ...
          PaGlobal_CharInfoChallenge_All._ui.stc_RewardTable[idx]._selectEffect:EraseAllEffect()
          PaGlobal_CharInfoChallenge_All._ui.stc_RewardTable[idx]._selectEffect:AddEffect("fUI_Present_Select_01A", true, 0, 0)
...
function PaGlobalFunc_CharInfoChallenge_All_ReciveAllReward_Complete(inputNumber, challengeKey)
  ...
  if PaGlobal_CharInfoChallenge_All._currentSelected._subItemIdx == nil then
...
function PaGlobalFunc_CharInfoChallenge_All_ReciveAllReward_Try(challengeIdx, maxRewardCount, uiCount)
  if false == _ContentsGroup_ChallengeReward then
    return
  end
  ...
  local selectRewardCount = challengeWrapper:getSelectRewardCount()
  PaGlobal_CharInfoChallenge_All:eraseRewardIconEffect(selectRewardCount)
  if 0 ~= selectRewardCount and nil == currentSelectItemIdx then
    ...
    PaGlobal_CharInfoChallenge_All:remindRewardIconEffect(uiCount, selectRewardCount)
    return
  end
  ...
  if 0 == selectRewardCount and maxRewardCount_edit > 1 then
