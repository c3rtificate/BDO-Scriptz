PaGlobal_Barter = {
  _ui = {
    ...
    _consoleKeyGuideBg = UI.getChildControl(Panel_Window_Barter, "Static_KeyGuide_ConsoleUI")
  },
  _slotConfig = {
    createIcon = true,
    createEnchant = true,
  ...
  _panelSizeBaseDiffY = 0,
  _panelSizeSpecialDiffY = 0,
  _mainBgBaseSizeY = 0,
  _normalBgBaseSizeY = 0,
  _specialBgBaseSizeY = 0,
  _panelSizeX = 0,
  _panelSizeY = 0,
