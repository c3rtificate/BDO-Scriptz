...
function PaGlobal_Barter:checkInventory(fromEnchantItemKey)
  if fromEnchantItemKey == nil then
    return
  end
  self._myFromItemCount_s64 = ToClient_InventoryGetItemCountByType(CppEnums.ItemWhereType.eServantInventory, fromEnchantItemKey)
end
