...
function PaGlobal_Option:CreateEventControl(category, detail)
  ...
  function CreateEventControlXXX(parent, control, controlTypeName, elementName)
    ...
    local isRadioButton = __ePAUIControl_RadioButton == self._elements[elementName]._controlType
    local isSliderButton = __ePAUIControl_Slider == self._elements[elementName]._controlType
    local isButton = __ePAUIControl_Button == self._elements[elementName]._controlType
    local isComboBox = __ePAUIControl_ComboBox == self._elements[elementName]._controlType
    local isCheckButton = __ePAUIControl_CheckButton == self._elements[elementName]._controlType
    if nil == control then
    ...
    for radioIndex = 1, RADIO_CHILD_MAX do
      ...
      if "ScreenShotQuality" == elementName then
        if nil == self._elements[elementName]._tooltipControl then
          self._elements[elementName]._tooltipControl = {}
        end
        self._elements[elementName]._tooltipControl[radioIndex] = eventControlParam[order2]
        eventControlParam[order2]:addInputEvent("Mouse_On", "PaGlobal_Option:ScreenShotQualityTooltip( true, " .. radioIndex .. "," .. "\"" .. elementName .. "\"" .. " )")
        eventControlParam[order2]:addInputEvent("Mouse_Out", "PaGlobal_Option:ScreenShotQualityTooltip(false)")
      end
    end
    ...
    for childIdx = 0, childCount - 1 do
      ...
      if false ~= child:GetShow() then
        ...
        elseif nil ~= elementName and nil ~= self._elements[elementName] and nil ~= desc and "Desc" == desc then
          child:SetTextMode(__eTextMode_AutoWrap)
          child:SetText(child:GetText())
        elseif nil == elementName or nil ~= self._elements[elementName] then
        end
        if false == _ContentsGroup_OceanCurrent and "UiBarterInfo" == elementName then
          child:SetShow(false)
        end
      end
    end
...
function PaGlobal_Option:EventComboBoxOpenXXX(elementName, controlIndex)
  local option = self._elements[elementName]
  if option._controlType ~= __ePAUIControl_ComboBox then
...
function PaGlobal_Option:EventXXX(controlName, controlIndex, order, param)
  ...
  elseif __ePAUIControl_RadioButton == controlType and (nil ~= option.actionInputType or nil ~= option.uiInputType) then
...
function PaGlobal_Option:AntiAliasingContentSet()
  if nil == self._elements.AntiAliasing._eventControl2 then
  ...
  for i, eventControl in pairs(self._elements.AntiAliasing._eventControl1) do
    if true == _ContentsGroup_AntiAliasing then
      eventControl:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_NEWGAMEOPTION_GRAPHIC_QUALITY_AntiAliasing_1"))
    else
      eventControl:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_OPTION_ANTIALIASING_APPLY"))
    end
  end
  for i, eventControl in pairs(self._elements.AntiAliasing._eventControl2) do
    eventControl:SetShow(_ContentsGroup_AntiAliasing)
  end
end
function PaGlobal_Option:SetAntiAliasingLevel2EnableSetting(enable)
  if nil == self._elements.AntiAliasing._eventControl2 then
    _PA_LOG("\237\155\132\236\167\132", "[SetControlSettingTable][ RETURN ] \235\157\188\235\148\148\236\152\164 \235\178\132\237\138\188 \236\187\168\237\138\184\235\161\164 (eventcontrol 1~x) \236\157\180 \236\160\149\236\131\129\236\160\129\236\156\188\235\161\156 \235\167\140\235\147\164\236\150\180\236\167\128\236\167\128 \236\149\138\236\149\152\236\138\181\235\139\136\235\139\164/ xml \235\157\188\235\148\148\236\152\164 \235\178\132\237\138\188 \236\133\139\237\140\133\236\157\132 \237\153\149\236\157\184\237\149\180\236\163\188\236\132\184\236\154\148 : " .. elementName)
    return
  end
...
function PaGlobal_Option:SetControlSettingTable(option, value, elementName)
  ...
  elseif __ePAUIControl_RadioButton == option._controlType then
    for index = 0, option._eventControlCount do
      local controlStr = ""
      if 0 == index then
        controlStr = "_eventControl"
      else
        controlStr = "_eventControl" .. index
      end
      if nil == option[controlStr] then
        _PA_LOG("\237\155\132\236\167\132", "[SetControlSettingTable][ RETURN ] \235\157\188\235\148\148\236\152\164 \235\178\132\237\138\188 \236\187\168\237\138\184\235\161\164 (eventcontrol 1~x) \236\157\180 \236\160\149\236\131\129\236\160\129\236\156\188\235\161\156 \235\167\140\235\147\164\236\150\180\236\167\128\236\167\128 \236\149\138\236\149\152\236\138\181\235\139\136\235\139\164/ xml \235\157\188\235\148\148\236\152\164 \235\178\132\237\138\188 \236\133\139\237\140\133\236\157\132 \237\153\149\236\157\184\237\149\180\236\163\188\236\132\184\236\154\148 : " .. elementName)
        return
      end
      for i, eventControl in pairs(option[controlStr]) do
        eventControl:SetCheck(index == value)
      end
    end
...
function PaGlobal_Option:ResetControlSettingTable(option, elementName)
  ...
  elseif __ePAUIControl_ComboBox == option._controlType then
    ...
    if __ePAUIControl_ComboBox == option._controlType then
    else
    end
  end
end
function PaGlobal_Option:SearchOption(inputString)
  ...
  for index, option in pairs(self._elements) do
    ...
    if nil ~= rv then
      ...
      isblocked = PaGlobal_Option:CheckBlockedSearching(option._string)
...
function PaGlobal_Option:CheckBlockedSearching(inputString)
...
function PaGlobal_Option._elements.ShowSpawnableNPC:EventException()
  local messageboxData = {
...
function PaGlobal_Option._elements.UIFontType:EventException()
  local messageboxData = {
    title = PAGetString(Defines.StringSheet_GAME, "LUA_COMMON_ALERT_NOTIFICATIONS"),
...
function PaGlobal_Option._elements.DataOptimize:EventException()
  local messageboxData = {
    title = PAGetString(Defines.StringSheet_GAME, "LUA_COMMON_ALERT_NOTIFICATIONS"),
...
function PaGlobal_Option:InitValue(gameOptionSetting)
  ...
  elems_.CallHorseByCompleteQuest._initValue = gameOptionSetting:getCallHorseByCompleteQuest()
  ...
  if nil ~= elems_.UIFontType then
    local fontTypeValue = ToClient_GetUIfontType()
    if true == isGameTypeEnglish() and 2 == fontTypeValue then
      fontTypeValue = 1
    end
    elems_.UIFontType._initValue = fontTypeValue
  end
  elems_.ShowNavPathEffectType._initValue = gameOptionSetting:getShowNavPathEffectType()
  if true == gameOptionSetting:getAutomaticGuideSmooth() then
    elems_.AutoNaviMoveType._initValue = 1
  else
    elems_.AutoNaviMoveType._initValue = 0
  end
  if true == gameOptionSetting:getAutomaticGuideSmoothAtGround() then
    elems_.AutoNaviMoveTypeAtGround._initValue = 1
  else
    elems_.AutoNaviMoveTypeAtGround._initValue = 0
  end
  ...
  elems_.RadarArrow._initValue = gameOptionSetting:getRadarArrow()
  ...
  elems_.HPGaugeVisible._initValue = gameOptionSetting:getHPGaugeVisible()
  ...
  elems_.MonsterNameTagVisible._initValue = CppEnums.VisibleNameTagType.eVisibleNameTagType_AllwaysShow == gameOptionSetting:getMonsterNameTagVisible()
  elems_.MonsterHPGaugeVisible._initValue = CppEnums.VisibleNameTagType.eVisibleNameTagType_AllwaysShow == gameOptionSetting:getMonsterHPGaugeVisible()
  ...
  elems_.SkillComboGuide._initValue = gameOptionSetting:getShowSkillComboGuide()
  ...
  elems_.AntiAliasing._initValue = gameOptionSetting:getAntiAliasingIndex()
  ...
  elems_.DataOptimize._initValue = true ~= gameOptionSetting:isUseDynamicBSS()
  ...
  if 1 == elems_.LUT._initValue then
  ...
  if true == _ContentsOption_CH_GameType then
    elems_.WatermarkService._initValue = 6
  end
  ...
  self._contrastValue = elems_.ContrastValue._initValue
  ...
  elems_.EnableAroundPlayMusic._initValue = gameOptionSetting:getEnableAroundPlayMusic()
  ...
  elems_.EnableAudioSequence._initValue = gameOptionSetting:getEnableSequenceSound()
  elems_.VolumeMaster._initValue = self:FromRealValueToSliderValue(gameOptionSetting:getMasterVolume(), 0, 100)
  elems_.VolumeMusicPlay._initValue = self:FromRealValueToSliderValue(gameOptionSetting:getAroundPlayMusicVolume(), 0, 100)
  ...
  elems_.VolumeSequence._initValue = self:FromRealValueToSliderValue(gameOptionSetting:getSequenceVolume(), 0, 100)
  ...
  elems_.ShowRightBottomAlarm._initValue = gameOptionSetting:getShowRightBottomAlarm()
  elems_.AlertElementalBoss._initValue = gameOptionSetting:getAlertElementalBoss()
  ...
  elems_.ShowSpawnableNPC._initValue = gameOptionSetting:getUseSpawnableNpc()
  elems_.FirstEnterCharacterViewMode._initValue = gameOptionSetting:getFirstEnterCharacterViewMode()
  ...
  self._prevUIScale = 0
  self._prevResolutionX = 0
  self._prevResolutionY = 0
end
...
function FGlobal_Option_luaLoadComplete()
  ...
  PaGlobal_Option_InitCheckUIScale()
end
...
function FromClient_UseShowSpawnableNPCUpdate(isEnable)
  PaGlobal_Option:SetControlSetting("UseShowSpawnableNPC", not isEnable)
  setUseOtherPlayerUpdate(isEnable)
  if isEnable then
    Proc_ShowMessage_Ack(PAGetString(Defines.StringSheet_GAME, "LUA_OPTION_TOOLTIP_PLAYERHIDEOFF"))
  else
...
function PaGlobal_Option:ScreenShotQualityTooltip(isShow, idx, elementName)
  ...
  if nil == self._elements[elementName]._tooltipControl[idx] then
    return
  end
  local control, name, desc
  control = self._elements[elementName]._tooltipControl[idx]
  name = ""
  if nil == control then
    return
  end
  desc = PAGetString(Defines.StringSheet_GAME, "LUA_HIGHRESOLUTION_SCREENSHOT_ALERT")
