...
PaGlobal_Option._elements = {
  ...
  AutoFindTarget = {
    _defaultValue = false,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_GAMEOPTION_ATTACKWAY_NAME",
    _desc = "PANEL_GAMEOPTION_ATTACKWAY_DESC"
  },
  UseNewQuickSlot = {
    _defaultValue = false,
    _type = OPTION_TYPE.CHECKBUTTON,
  ...
  CallHorseByCompleteQuest = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_CALLHORSEBYCOMPLETEQUEST",
    _desc = "PANEL_NEWGAMEOPTION_FUNCTION_CONVENIENCE_CALLHORSEBYCOMPLETEQUEST_DESC"
  },
  UIFontSizeType = {
    _defaultValue = 0,
  ...
  AutoNaviMoveType = {
    _defaultValue = 1,
    _type = OPTION_TYPE.RADIOBUTTON,
    _title = "PANEL_NEWGAMEOPTION_AUTONAVIMOVETITLE_SEA",
    _desc = "PANEL_NEWGAMEOPTION_AUTONAVIMOVETITLE_SEA"
  },
  AutoNaviMoveTypeAtGround = {
    _defaultValue = 0,
    _type = OPTION_TYPE.RADIOBUTTON,
    _title = "PANEL_NEWGAMEOPTION_AUTONAVIMOVETITLE_LAND",
    _desc = "PANEL_NEWGAMEOPTION_AUTONAVIMOVETITLE_LAND"
  },
  RefuseRequests = {
    _defaultValue = false,
    _type = OPTION_TYPE.CHECKBUTTON,
  ...
  IsYachtPvpRefuse = {
    _defaultValue = false,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_YACHT_REFUSE",
    _desc = "PANEL_NEWGAMEOPTION_YACHT_REFUSE_DESC"
  },
  GuildWarRefuse = {
    _defaultValue = false,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "LUA_NEWGAMEOPTION_GUILDWAR_REFUSE_TITLE",
    _desc = "LUA_NEWGAMEOPTION_GUILDWAR_REFUSE_DESC"
  },
  SolareCustomGameRefuse = {
    _defaultValue = false,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "LUA_NEWGAMEOPTION_SOLARECUSTOMGAME_REFUSE_TITLE",
    _desc = "LUA_NEWGAMEOPTION_SOLARECUSTOMGAME_REFUSE_DESC"
  },
  RadarArrow = {
    _defaultValue = false,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_QUESTWAYPOINTGUIDE",
    _desc = "PANEL_NEWGAMEOPTION_QUESTWAYPOINTGUIDE_DESC"
  },
  RotateRadarMode = {
    _defaultValue = false,
    _type = OPTION_TYPE.CHECKBUTTON,
  ...
  CrossPlayEnable = {
    ...
    _title = "PANEL_NEWGAMEOPTION_CROSSPLAYENABLE",
    _desc = "PANEL_NEWGAMEOPTION_CROSSPLAYENABLE_DESC"
  },
  CrossPlayCommunication = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _settingRightNow = true,
  ...
  SeasonUiType = {
    _defaultValue = __eSeasonUIType_Default,
    _type = OPTION_TYPE.RADIOBUTTON,
    _title = "PANEL_GAMEOPTION_UI_UI_THEME_SET_TITLE",
    _desc = ""
  },
  EtcOpenBrowser = {
    _defaultValue = true,
    _type = OPTION_TYPE.ETCBUTTON,
    _settingRightNow = true,
    _title = "PANEL_NEWGAMEOPTION_CROSSPLAY_COMMUNICATION_TITLE",
    _desc = "PANEL_NEWGAMEOPTION_CROSSPLAY_COMMUNICATION_DESC"
  },
  ...
  ChatChannelType = {
    _defaultValue = 0,
    _type = OPTION_TYPE.RADIOBUTTON,
    _title = "PANEL_NEWGAMEOPTION_ChatChannelType",
    _desc = ""
  },
  ...
  HPGaugeVisible = {
    _defaultValue = 0,
    _type = OPTION_TYPE.RADIOBUTTON,
    _title = "PANEL_NEWGAMEOPTION_FUNCTION_VIEW_HPGAUGEVISIBLE",
    _desc = ""
  },
  OtherPlayerNameTagVisible = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_OtherPlayerNameTagVisible",
    _desc = "PANEL_NEWGAMEOPTION_FUNCTION_VIEW_OtherPlayerNameTagVisible_DESC"
  },
  MonsterNameTagVisible = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_MonsterNameTagVisible",
    _desc = "PANEL_NEWGAMEOPTION_FUNCTION_VIEW_MonsterNameTagVisible_DESC"
  },
  MonsterHPGaugeVisible = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_MonsterHPGaugeVisible",
    _desc = "PANEL_NEWGAMEOPTION_FUNCTION_VIEW_MonsterHPGaugeVisible_DESC"
  },
  PartyPlayerNameTagVisible = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_PartyPlayerNameTagVisible",
    _desc = "PANEL_NEWGAMEOPTION_FUNCTION_VIEW_PartyPlayerNameTagVisible_DESC"
  },
  GuildPlayerNameTagVisible = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_GuildPlayerNameTagVisible",
    _desc = "PANEL_NEWGAMEOPTION_FUNCTION_VIEW_GuildPlayerNameTagVisible_DESC"
  },
  RankingPlayerNameTagVisible = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_RankingPlayerNameTagVisible",
    _desc = "PANEL_NEWGAMEOPTION_FUNCTION_VIEW_RankingPlayerNameTagVisible_DESC"
  },
  GuideLineZoneChange = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
  ...
  PetRender = {
    _defaultValue = 1,
    _type = OPTION_TYPE.RADIOBUTTON,
    _title = "PANEL_NEWGAMEOPTION_PetRender",
    _desc = ""
  },
  FairyRender = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_FairyRender",
    _desc = ""
  },
  MaidView = {
    _defaultValue = 1,
  ...
  RenderHitEffect = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_RenderHitEffect",
    _desc = "PANEL_NEWGAMEOPTION_FUNCTION_VIEW_RenderHitEffect_DESC"
  },
  RenderGuardEffect = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_RENDER_DEF_EFFECT",
    _desc = "PANEL_NEWGAMEOPTION_FUNCTION_VIEW_RENDER_DEF_EFFECT_DESC"
  },
  RenderMissEffect = {
    _defaultValue = false,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_GAMEOPTION_MISS_EFFECT_NAME",
    _desc = "PANEL_GAMEOPTION_MISS_EFFECT_DESC"
  },
  DamageMeter = {
    _defaultValue = false,
    _type = OPTION_TYPE.CHECKBUTTON,
  ...
  HideMastOnCarrier = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_HideMastOnCarrier",
    _desc = "PANEL_NEWGAMEOPTION_FUNCTION_VIEW_HideMastOnCarrier_DESC"
  },
  WorkerVisible = {
    _defaultValue = false,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_WorkerVisible",
    _desc = "PANEL_NEWGAMEOPTION_FUNCTION_VIEW_WorkerVisible_DESC"
  },
  WorldMapOpenType = {
    _defaultValue = 3,
    _type = OPTION_TYPE.RADIOBUTTON,
  ...
  BloodEffect = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_BloodEffect",
    _desc = "PANEL_NEWGAMEOPTION_BLOODEFFECT_DESC"
  },
  LensBlood = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_LensBlood",
    _desc = "PANEL_NEWGAMEOPTION_LENSBLOOD_DESC"
  },
  VSync = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_VSync",
    _desc = "PANEL_NEWGAMEOPTION_VSync_DESC"
  },
  AutoOptimization = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
  ...
  SelfPlayerOnlyEffect = {
    _defaultValue = false,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_SelfPlayerOnlyEffect",
    _desc = "PANEL_NEWGAMEOPTION_GRAPHIC_QUALITY_SelfPlayerOnlyEffect_DESC"
  },
  ...
  GraphicPreset = {
    _defaultValue = 0,
    _type = OPTION_TYPE.RADIOBUTTON,
    _title = "PANEL_NEWGAMEOPTION_GraphicOption",
    _desc = ""
  },
  Fov = {
    _defaultValue = 0.33333,
    ...
    _sliderValueMax = 70,
    _settingRightNow = true,
    _title = "PANEL_NEWGAMEOPTION_Fov",
    _desc = "PANEL_NEWGAMEOPTION_GRAPHIC_Fov_DESC"
  },
  CameraEffectMaster = {
    _defaultValue = 1,
    _type = OPTION_TYPE.SLIDER,
  ...
  GamePadInvertX = {
    ...
    _desc = "LUA_OPTION_TOOLTIP_PADX"
  },
  GamePadInvertY = {
    _defaultValue = false,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_GamePadInvertY",
    _desc = "LUA_OPTION_TOOLTIP_PADY"
  },
  GamePadSensitivityX = {
    _defaultValue = 0.473684,
    _type = OPTION_TYPE.SLIDER,
  ...
  UseRStickAccelation = {
    _defaultValue = false,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_RStickCameraAccel",
    _desc = "PANEL_NEWGAMEOPTION_INTERFACE_PAD_RStickCameraAccel_DESC"
  },
  ScreenShotQuality = {
    _defaultValue = 0,
    _type = OPTION_TYPE.RADIOBUTTON,
  ...
  ShowFriendLoginMessage = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_GAMEOPTION_FRIENDS_JOINALARM_TITLE",
    _desc = "PANEL_GAMEOPTION_FRIENDS_JOINALARM_DESC"
  },
  ...
  HideOtherPlayerTent = {
    _defaultValue = false,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_FUNCTION_VIEW_TentRender_1",
    _desc = ""
  },
  RefuseFriend = {
    _defaultValue = false,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "LUA_OPTION_BLOCKINVITE_TITLE",
    _desc = "LUA_OPTION_BLOCKINVITE_DESC"
  },
  EnableMusic = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
  ...
  EnableAudioFairy = {
    ...
    _type = OPTION_TYPE.CHECKBUTTON,
    _settingRightNow = true,
    _title = "PANEL_NEWGAMEOPTION_EnableAudioFairy",
    _desc = ""
  },
  EnableAudioSequence = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _settingRightNow = true,
    _title = "LUA_OPTION_TEXT_CUTSCENEVOLUME",
    _desc = ""
  },
  VolumeMaster = {
    _defaultValue = 1,
  ...
  VolumeSequence = {
    ...
    _settingRightNow = true,
    _title = "LUA_OPTION_TEXT_CUTSCENEVOLUME",
    _desc = "LUA_OPTION_TOOLTIP_CUTSCENVOL"
  },
  AlertNormalTrade = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
  ...
  AlertElementalBoss = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_GAMEOPTION_ALRAM_BLACKSHRINE_TITLE",
    _desc = "PANEL_GAMEOPTION_ALRAM_BLACKSHRINE_DESC"
  },
  AutoRunCamera = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
  ...
  ChatFilterWhisper = {
    ...
    _desc = "LUA_CONSOLE_CHATOPTION_TOOLTIP_WHISPER_DESC"
  },
  ChatFilterParty = {
    _defaultValue = true,
    _settingRightNow = true,
  ...
  ChatFilterChannel = {
    ...
    _settingRightNow = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "LUA_CHATOPTION_TOOLTIP_CHANNEL_TITLE",
    _desc = "LUA_CHATOPTION_TOOLTIP_CHANNEL_DESC"
  },
  ChatFilterSystemAll = {
    _defaultValue = true,
    _settingRightNow = true,
  ...
  ChatFilterSystemEnchant = {
    _defaultValue = true,
    _settingRightNow = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "DIALOG_BUTTON_QUEST_ENCHANT",
    _isSystemChat = true,
    _desc = "LUA_CHATOPTION_ENCHANT"
  },
  UseDefaultCostumeOtherPlayer = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_DEFAULT_COSTUME_OTHER_PLAYER_TITLE",
    _desc = "PANEL_NEWGAMEOPTION_DEFAULT_COSTUME_OTHER_PLAYER_DESC"
  },
  UseShowLootingPopupMenu = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_SHOW_LOOTING_POPUP_MENU_TITLE",
    _desc = "PANEL_NEWGAMEOPTION_SHOW_LOOTING_POPUP_MENU_DESC"
  },
  AlertWaitItemMarket = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_AlertWaitItemMarket",
    _desc = "PANEL_NEWGAMEOPTION_FUNCTION_ALERT_AlertWaitItemMarket_DESC"
  },
  AlertHp = {
    _defaultValue = true,
    _type = OPTION_TYPE.CHECKBUTTON,
    _title = "PANEL_NEWGAMEOPTION_AlertHpWarning",
    _desc = "PANEL_NEWGAMEOPTION_FUNCTION_ALERT_AlertHpWarning_DESC"
  }
}
PaGlobal_Option._frames = {
  Performance = {
    Optimize = {
      ...
      {
        _element = PaGlobal_Option._elements.RenderHitEffect
      },
      {
        _element = PaGlobal_Option._elements.RenderGuardEffect
      },
      {
        _element = PaGlobal_Option._elements.RenderMissEffect
      },
      {
        _element = PaGlobal_Option._elements.UseDefaultCostumeOtherPlayer
      },
      {
        _element = PaGlobal_Option._elements.WorkerVisible
      }
    },
    OptimizeBeta = {},
    GraphicQuality = {},
  ...
  Graphic = {
    ...
    Quality = {
      {
        _element = PaGlobal_Option._elements.SelfPlayerOnlyEffect
      },
      {
        _element = PaGlobal_Option._elements.BloodEffect
      },
      {
        _element = PaGlobal_Option._elements.LensBlood
      },
      {
        _element = PaGlobal_Option._elements.VSync,
        _contentsOption = ToClient_isPS5()
      }
    },
    Effect = {
      {
    ...
    Camera = {
      {
        _element = PaGlobal_Option._elements.Fov
      }
    },
    ScreenShot = {},
    HDR = {
      ...
      },
      {
        ...
        _contentsOption = ToClient_isConsolePlatformSpec()
      }
    }
  },
  Sound = {
    ...
    Volume = {
      ...
      {
        _element = PaGlobal_Option._elements.VolumeSequence
      },
      {
      ...
      {
        _element = PaGlobal_Option._elements.EnableAudioFairy,
  ...
  Function = {
    ...
    View = {
      {
        _element = PaGlobal_Option._elements.SelfPlayerNameTagVisible
      },
      {
        _element = PaGlobal_Option._elements.HPGaugeVisible
      },
      {
        _element = PaGlobal_Option._elements.OtherPlayerNameTagVisible
      },
      {
        _element = PaGlobal_Option._elements.MonsterNameTagVisible
      },
      {
        _element = PaGlobal_Option._elements.MonsterHPGaugeVisible
      },
      {
        _element = PaGlobal_Option._elements.PartyPlayerNameTagVisible
      },
      {
        _element = PaGlobal_Option._elements.GuildPlayerNameTagVisible
      },
      {
        _element = PaGlobal_Option._elements.RankingPlayerNameTagVisible
      },
      {
        _element = PaGlobal_Option._elements.RenderHitEffect
      },
      ...
      {
        _element = PaGlobal_Option._elements.FairyRender,
        _contentsOption = _ContentsGroup_isFairy
      },
      {
        _element = PaGlobal_Option._elements.PetRender
      },
      {
        _element = PaGlobal_Option._elements.HideMastOnCarrier
      }
    },
    Alert = {
      {
        _element = PaGlobal_Option._elements.AlertNormalTrade
      },
      {
        _element = PaGlobal_Option._elements.AlertRoyalTrade
      },
      {
        _element = PaGlobal_Option._elements.AlertOtherPlayerGetItem
      },
      {
        _element = PaGlobal_Option._elements.AlertLifeLevelUp
      },
      {
      ...
      {
        _element = PaGlobal_Option._elements.AlertOtherMarket
      },
      {
        _element = PaGlobal_Option._elements.AlertChangeRegion
      },
      {
        _element = PaGlobal_Option._elements.AlertFitnessLevelUp
      },
      {
        _element = PaGlobal_Option._elements.AlertTerritoryWar
      },
      {
        _element = PaGlobal_Option._elements.AlertGuildWar
      },
      {
        _element = PaGlobal_Option._elements.ShowFriendLoginMessage
      },
      {
      ...
      {
        _element = PaGlobal_Option._elements.AlertNearMonster
      },
      {
        _element = PaGlobal_Option._elements.UseShowLootingPopupMenu
      },
      {
        _element = PaGlobal_Option._elements.AlertWaitItemMarket
      },
      {
        _element = PaGlobal_Option._elements.AlertHp
      },
      {
        _element = PaGlobal_Option._elements.AlertElementalBoss
      }
    },
    Worldmap = {},
    Nation = {
      {
        _element = PaGlobal_Option._elements.ChatChannelType
      }
    },
    Etc = {
      {
        _element = PaGlobal_Option._elements.SeasonUiType,
        _contentsOption = _ContentsGroup_SeasonUI
      },
      {
        _element = PaGlobal_Option._elements.CrossPlayEnable,
        _contentsOption = _ContentsGroup_ConsoleIntegration
      },
      {
        _element = PaGlobal_Option._elements.CrossPlayCommunication,
        _contentsOption = _ContentsGroup_ConsoleIntegration
      },
      {
      ...
      {
        _element = PaGlobal_Option._elements.AutoFindTarget
      },
      {
        _element = PaGlobal_Option._elements.ShowNavPathEffectType
      },
      {
        _element = PaGlobal_Option._elements.AutoNaviMoveType,
        _contentsOption = _ContentsGroup_AutomaticGuildeSmooth
      },
      {
        _element = PaGlobal_Option._elements.AutoNaviMoveTypeAtGround,
        _contentsOption = _ContentsGroup_AutomaticGuildeSmooth
      },
      {
      ...
      {
        _element = PaGlobal_Option._elements.IsYachtPvpRefuse,
        _contentsOption = _ContentsGroup_MiniGame_YachtDice_PVP
      },
      {
        _element = PaGlobal_Option._elements.GuildWarRefuse
      },
      {
        _element = PaGlobal_Option._elements.SolareCustomGameRefuse,
        _contentsOption = _ContentsGroup_SolareCustomMode
      },
      {
        _element = PaGlobal_Option._elements.RadarArrow
      },
      {
      ...
      {
        _element = PaGlobal_Option._elements.HideOtherPlayerTent
      },
      {
        _element = PaGlobal_Option._elements.RefuseFriend
      },
      {
        _element = PaGlobal_Option._elements.CallHorseByCompleteQuest,
        _contentsOption = _ContentsGroup_QuestCallHorseOption
      },
      {
  ...
  Interface = {
    ChattingFilter = {
      ...
      {
        _element = PaGlobal_Option._elements.ChatFilterChannel
      },
      {
      ...
      {
        _element = PaGlobal_Option._elements.ChatFilterSystemEnchant
      }
    },
    Action = {
      {
    ...
    Pad = {
      ...
      {
        _element = PaGlobal_Option._elements.UseRStickAccelation
      },
      {
...
function PaGlobal_Option._elements.AutoFindTarget:set(value)
  ToClient_SetToTargetAction(value)
end
...
function PaGlobal_Option._elements.UIFontSizeType:set(value)
  ...
  ToClient_getFontWrapper("RealFont_17_ShadhowITEM"):changeCurrentFontSizeBeMore(addFontSize)
  ToClient_getFontWrapper("RealFont_14_Base"):changeCurrentFontSizeBeMore(addFontSize)
  ToClient_getFontWrapper("RealFont_14_Glow"):changeCurrentFontSizeBeMore(addFontSize)
end
function PaGlobal_Option._elements.CallHorseByCompleteQuest:set(value)
  setCallHorseByCompleteQuest(value)
end
function PaGlobal_Option._elements.ShowNavPathEffectType:set(value)
  setShowNavPathEffectType(value)
end
function PaGlobal_Option._elements.AutoNaviMoveType:set(value)
  ToClient_SetAutomaticGuideSmooth(value)
end
function PaGlobal_Option._elements.AutoNaviMoveTypeAtGround:set(value)
...
function PaGlobal_Option._elements.IsYachtPvpRefuse:set(value)
  setIsYachtPvpRefuse(value)
end
function PaGlobal_Option._elements.GuildWarRefuse:set(value)
  setGuildWarRefuse(value)
end
function PaGlobal_Option._elements.SolareCustomGameRefuse:set(value)
  set.SolareCustomGameRefuse(value)
end
function PaGlobal_Option._elements.RadarArrow:set(value)
  setRadarArrow(value)
end
...
function PaGlobal_Option._elements.SeasonUiType:set(value)
  setSeasonUiType(value)
end
function PaGlobal_Option._elements.CrossPlayEnable:set(value)
  ...
  if isOn ~= value then
    if false == setSamePlatformOnly(value) then
      ...
      if false == value then
        PaGlobal_Option:EventXXX("CheckButton_CrossPlayCommunication", 0)
      end
...
function PaGlobal_Option._elements.CrossPlayCommunication:set(value)
...
function PaGlobal_Option._elements.HPGaugeVisible:set(value)
  setHPGaugeVisible(value)
end
...
function PaGlobal_Option._elements.MonsterNameTagVisible:set(value)
  if true == value then
    value = CppEnums.VisibleNameTagType.eVisibleNameTagType_AllwaysShow
  else
    value = CppEnums.VisibleNameTagType.eVisibleNameTagType_NoShow
  end
  setMonsterNameTagVisible(value)
end
function PaGlobal_Option._elements.MonsterHPGaugeVisible:set(value)
  if true == value then
    value = CppEnums.VisibleNameTagType.eVisibleNameTagType_AllwaysShow
  else
    value = CppEnums.VisibleNameTagType.eVisibleNameTagType_NoShow
  end
  setMonsterHPGaugeVisible(value)
end
...
function PaGlobal_Option._elements.PetRender:set(value)
  local petRenderValue = value + 1
  if petRenderValue > 2 then
    petRenderValue = 2
  end
  setPetRender(petRenderValue)
end
...
function PaGlobal_Option._elements.RenderGuardEffect:set(value)
  ToClient_SetShowPlayerGuardType(value)
end
function PaGlobal_Option._elements.RenderMissEffect:set(value)
  setRenderMissEffect(value)
end
...
function PaGlobal_Option._elements.VSync:set(value)
  setVSync(value)
end
...
function PaGlobal_Option._elements.ColorBlind:set(value)
  ...
  FGlobal_Window_InteractionGathering_ColorBlindUpdate()
  UIMain_QuestUpdate()
end
...
function PaGlobal_Option._elements.ShowFriendLoginMessage:set(value)
  setShowFriendLoginMessage(value)
end
function PaGlobal_Option._elements.ShowGuildLoginMessage:set(value)
  setShowGuildLoginMessage(value)
end
function PaGlobal_Option._elements.HideOtherPlayerTent:set(value)
  setHideOtherPlayerTent(value)
end
function PaGlobal_Option._elements.LUT:set(LUT)
  setCameraLUTFilter(LUT)
end
function PaGlobal_Option._elements.RefuseFriend:set(value)
  setConsoleRefuseDirectFriend(value)
end
function PaGlobal_Option._elements.UseRStickAccelation:set(value)
  ToClient_UseRStickAccelation(not value)
end
...
function PaGlobal_Option._elements.EnableAudioSequence:set(value)
  setEnableSequenceSound(value)
end
...
function PaGlobal_Option._elements.VolumeFx:set(value)
  ...
  setVolumeParamHitFxVolume(100)
  setVolumeParamHitFxWeight(100)
  setVolumeParamOtherPlayer(100)
  setVolumeParamAroundPlayMusic(50)
end
...
function PaGlobal_Option._elements.VolumeSequence:set(value)
  setVolumeSequence(value * 100)
end
...
function PaGlobal_Option._elements.UltraHighDefinition:set(value)
  ...
  if true == rv then
    local messageboxData = {
      title = PAGetString(Defines.StringSheet_GAME, "LUA_COMMON_ALERT_NOTIFICATIONS"),
      content = PAGetString(Defines.StringSheet_GAME, "LUA_COMMON_ALERT_APPLY4KOPTION"),
      functionApply = MessageBox_Empty_function,
      priority = CppEnums.PAUIMB_PRIORITY.PAUIMB_PRIORITY_LOW
    }
    MessageBox.showMessageBox(messageboxData)
  elseif true == value then
    local messageboxData = {
      title = PAGetString(Defines.StringSheet_GAME, "LUA_COMMON_ALERT_NOTIFICATIONS"),
      content = PAGetString(Defines.StringSheet_GAME, "LUA_COMMON_ALERT_CANNOTUSE4KOPTION"),
      functionApply = MessageBox_Empty_function,
      priority = CppEnums.PAUIMB_PRIORITY.PAUIMB_PRIORITY_LOW
    }
    MessageBox.showMessageBox(messageboxData)
...
function PaGlobal_Option._elements.ChatFilterChannel:set(value)
  local chat = ToClient_getChattingPanel(0)
  chat:setShowChatType(CppEnums.ChatType.Channel, value)
end
...
function PaGlobal_Option._elements.ChatFilterSystemEnchant:set(value)
  local chat = ToClient_getChattingPanel(0)
  if true == chat:isShowChatType(CppEnums.ChatType.System) then
    chat:setShowChatSystemType(CppEnums.ChatSystemType.Enchant, value)
  end
end
function PaGlobal_Option._elements.GraphicPreset:set(value)
  ToClient_SetConsoleGraphicPreset(value)
end
function PaGlobal_Option._elements.UseDefaultCostumeOtherPlayer:set(value)
  ToClient_setUseDefaultCostumeOtherPlayer(value)
end
function PaGlobal_Option._elements.UseShowLootingPopupMenu:set(value)
  ToClient_setUseShowLootingPopupMenu(value)
end
function PaGlobal_Option._elements.AlertWaitItemMarket:set(value)
  ToClient_SetAlarmWaitItemMarket(value)
end
function PaGlobal_Option._elements.AlertHp:set(value)
  ToClient_SetAlertHp(value)
end
...
function PaGlobal_Option._elements.AutoFindTarget:get(wrapper)
  return wrapper:getToTargetAction()
end
...
function PaGlobal_Option._elements.CallHorseByCompleteQuest:get(wrapper)
  return wrapper:getCallHorseByCompleteQuest()
end
...
function PaGlobal_Option._elements.AutoNaviMoveType:get(wrapper)
  return wrapper:getAutomaticGuideSmooth()
end
function PaGlobal_Option._elements.AutoNaviMoveTypeAtGround:get(wrapper)
  return wrapper:getAutomaticGuideSmoothAtGround()
end
...
function PaGlobal_Option._elements.IsYachtPvpRefuse:get(wrapper)
  return wrapper:getIsYachtPvpRefuse()
end
function PaGlobal_Option._elements.GuildWarRefuse:get(wrapper)
  return wrapper:getGuildWarRefuse()
end
function PaGlobal_Option._elements.SolareCustomGameRefuse:get(wrapper)
  return wrapper:getSolareCustomGameRefuse()
end
function PaGlobal_Option._elements.RadarArrow:get(wrapper)
  return wrapper:getRadarArrow()
end
...
function PaGlobal_Option._elements.SeasonUiType:get(wrapper)
  return wrapper:getSeasonUiType()
end
function PaGlobal_Option._elements.CrossPlayEnable:get(wrapper)
  if false == ToClient_isCrossNetworkPlayAllowed() then
    setSamePlatformOnly(false)
  end
  return wrapper:getSamePlatformOnly()
end
function PaGlobal_Option._elements.CrossPlayCommunication:get(wrapper)
...
function PaGlobal_Option._elements.HPGaugeVisible:get(wrapper)
  return wrapper:getHPGaugeVisible()
end
...
function PaGlobal_Option._elements.MonsterNameTagVisible:get(wrapper)
  return CppEnums.VisibleNameTagType.eVisibleNameTagType_AllwaysShow == wrapper:getMonsterNameTagVisible()
end
function PaGlobal_Option._elements.MonsterHPGaugeVisible:get(wrapper)
  return CppEnums.VisibleNameTagType.eVisibleNameTagType_AllwaysShow == wrapper:getMonsterHPGaugeVisible()
end
...
function PaGlobal_Option._elements.PetRender:get(wrapper)
  local petRenderValue = wrapper:getPetRender() - 1
  if petRenderValue < 0 then
    petRenderValue = 0
  end
  return petRenderValue
end
...
function PaGlobal_Option._elements.RenderGuardEffect:get(wrapper)
  return wrapper:getShowPlayerGuardType()
end
function PaGlobal_Option._elements.RenderMissEffect:get(wrapper)
  return wrapper:getRenderMissEffect()
end
...
function PaGlobal_Option._elements.VSync:get(wrapper)
  return wrapper:getVSync()
end
...
function PaGlobal_Option._elements.ShowFriendLoginMessage:get(wrapper)
  return wrapper:getShowFriendLoginMessage()
end
function PaGlobal_Option._elements.ShowGuildLoginMessage:get(wrapper)
  return wrapper:getShowGuildLoginMessage()
end
function PaGlobal_Option._elements.HideOtherPlayerTent:get(wrapper)
  return wrapper:getHideOtherPlayerTent()
end
function PaGlobal_Option._elements.LUT:get(wrapper)
  return wrapper:getCameraLUTFilter()
end
function PaGlobal_Option._elements.RefuseFriend:get(wrapper)
  return wrapper:getConsoleRefuseDirectFriend()
end
function PaGlobal_Option._elements.UseRStickAccelation:get(wrapper)
  return not wrapper:getUseRStickCameraAccelation()
end
...
function PaGlobal_Option._elements.EnableAudioSequence:get(wrapper)
  return wrapper:getEnableSequenceSound()
end
...
function PaGlobal_Option._elements.VolumeSequence:get(wrapper)
  return PaGlobal_Option:FromRealValueToSliderValue(wrapper:getSequenceVolume(), 0, 100)
end
...
function PaGlobal_Option._elements.ChatFilterChannel:get()
  local chat = ToClient_getChattingPanel(0)
  return chat:isShowChatType(CppEnums.ChatType.Channel)
end
...
function PaGlobal_Option._elements.ChatFilterSystemEnchant:get()
  local chat = ToClient_getChattingPanel(0)
  return chat:isShowChatSystemType(CppEnums.ChatSystemType.Enchant)
end
function PaGlobal_Option._elements.GraphicPreset:get(wrapper)
  return wrapper:getConsoleGraphicPresetIndex()
end
function PaGlobal_Option._elements.UseDefaultCostumeOtherPlayer:get(wrapper)
  return wrapper:getUseDefaultCostumeOtherPlayer()
end
function PaGlobal_Option._elements.UseShowLootingPopupMenu:get(wrapper)
  return wrapper:getShowLootingPopupMenu()
end
function PaGlobal_Option._elements.AlertWaitItemMarket:get(wrapper)
  return wrapper:getAlertWaitItem()
end
function PaGlobal_Option._elements.AlertHp:get(wrapper)
  return wrapper:getAlertHp()
end
...
elements.AutoNaviMoveTypeAtGround._radioButtonMapping = {
  [0] = {
    _string = "PANEL_NEWGAMEOPTION_FUNCTION_ETC_AUTONAVIMOVETYPE_AT_GROUND_0"
  },
  [1] = {
    _string = "PANEL_NEWGAMEOPTION_FUNCTION_ETC_AUTONAVIMOVETYPE_AT_GROUND_1"
  },
  ["_count"] = 2
}
...
elements.ChatChannelType._radioButtonMapping = {
  [0] = {
    _string = "LUA_OPTION_TEXT_INTERNATIONAL"
  },
  [1] = {
    _string = "PANEL_NEWOPTION_TEXT_EN"
  },
  [2] = {
    _string = "PANEL_NEWOPTION_TEXT_JP"
  },
  [3] = {
    _string = "PANEL_NEWOPTION_TEXT_FR"
  },
  [4] = {
    _string = "PANEL_NEWOPTION_TEXT_DE"
  },
  [5] = {
    _string = "PANEL_NEWOPTION_TEXT_ES"
  },
  [6] = {
    _string = "PANEL_GAMEOPTION_DISPLAY_WATERMARK_TYPE_KOR"
  },
  ["_count"] = 7
}
...
elements.FairyRender._checkButtonMapping = {
  [0] = {
    _string = "PANEL_FAIRY_OPTION_SEE"
  },
  [1] = {
    _string = "PANEL_FAIRY_OPTION_HIDE"
  }
}
elements.HideMastOnCarrier._checkButtonMapping = {}
...
elements.GraphicPreset._radioButtonMapping = {
  [0] = {
