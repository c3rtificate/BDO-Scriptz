...
function PaGlobal_Option:GetEventTypeText(controlTypeEnum)
  local eventType
  if __ePAUIControl_Slider == controlTypeEnum then
    eventType = "Mouse_LPress"
  elseif __ePAUIControl_ComboBox == controlTypeEnum then
    eventType = "Mouse_LUp"
  elseif __ePAUIControl_CheckButton == controlTypeEnum then
    eventType = "Mouse_LUp"
  elseif __ePAUIControl_RadioButton == controlTypeEnum then
    eventType = "Mouse_LUp"
  else
    if __ePAUIControl_Button == controlTypeEnum then
      eventType = "Mouse_LUp"
    else
    end
  end
...
function PaGlobal_Option:SetAntialiasingValue(value)
  local _AntiAliasing = self._elements.AntiAliasing
  if 2 == value then
...
function PaGlobal_Option:getWebLangTypeText()
