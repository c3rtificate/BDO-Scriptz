PaGlobal_Option = {
  ...
  _elements = {
    ...
    CallHorseByCompleteQuest = {_defaultValue = true, _controlType = __ePAUIControl_CheckButton},
    ...
    EtcOpenBrowser = {_defaultValue = true, _controlType = __ePAUIControl_Button},
    ...
    HPGaugeVisible = {_defaultValue = 0, _controlType = __ePAUIControl_RadioButton},
    OtherPlayerNameTagVisible = {_defaultValue = true, _controlType = __ePAUIControl_CheckButton},
    MonsterNameTagVisible = {_defaultValue = true, _controlType = __ePAUIControl_CheckButton},
    MonsterHPGaugeVisible = {_defaultValue = true, _controlType = __ePAUIControl_CheckButton},
    ...
    SkillComboGuide = {_defaultValue = true, _controlType = __ePAUIControl_CheckButton},
    ...
    AlertElementalBoss = {_defaultValue = true, _controlType = __ePAUIControl_CheckButton},
    ...
    UiMoveToWharf = {uiInputType = 60, _controlType = __ePAUIControl_RadioButton}
  },
  ...
  _tempKR2BlockString = {
    ...
    [11] = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_NEWGAMEOPTION_ActionPushToTalk"),
    [12] = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_NEWGAMEOPTION_AudioResourceType"),
    [13] = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_GAMEOPTION_NPCVOICESELECT")
  },
  _tempKRBlockString = {
...
function PaGlobal_Option._functions.RadarArrow(value)
  setRadarArrow(value)
end
...
function PaGlobal_Option._functions.HPGaugeVisible(value)
...
function PaGlobal_Option._functions.MonsterNameTagVisible(value)
  if true == value then
    value = CppEnums.VisibleNameTagType.eVisibleNameTagType_AllwaysShow
  else
...
function PaGlobal_Option._functions.MonsterHPGaugeVisible(value)
  if true == value then
    value = CppEnums.VisibleNameTagType.eVisibleNameTagType_AllwaysShow
  else
    value = CppEnums.VisibleNameTagType.eVisibleNameTagType_NoShow
...
function PaGlobal_Option._functions.SkillComboGuide(value)
...
function PaGlobal_Option._functions.EnableAudioSequence(value)
...
function PaGlobal_Option._functions.VolumeSequence(value)
...
function PaGlobal_Option._functions.AlertElementalBoss(value)
