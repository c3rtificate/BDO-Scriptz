...
PaGlobal_GameOption_All._frames = {
  Performance = {
    ...
    Optimize = {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.RenderMissEffect
      },
      {
  ...
  Graphic = {
    ...
    Quality = {
      ...
      },
      {
        ...
        _contentsOption = _ContentsOption_CH_GameType == false
      },
      {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.UpscaleFSRType,
        _contentsOption = _ContentsGroup_UseAMDFSR
      },
      {
        _element = PaGlobal_GameOption_All._elements.PresentLock
      }
  ...
  Sound = {
    Volume = {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.EnableAudioSequence
      },
      {
        _element = PaGlobal_GameOption_All._elements.VolumeSequence
      },
      {
  ...
  Function = {
    Convenience = {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.AutoFindTarget,
        _contentsOption = _ContentsGroup_ToAutoTargetAction
      },
      {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.CallHorseByCompleteQuest,
    ...
    View = {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.HPGaugeVisible
      },
      {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.MonsterNameTagVisible
      },
      {
        _element = PaGlobal_GameOption_All._elements.MonsterHPGaugeVisible
      },
      {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.BattleFieldNameTagVisible,
        _contentsOption = _ContentsGroup_InstanceLocalWar
      },
      {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.GuideLineOutLine,
        _contentsOption = _ContentsGroup_RenderOutLine
      },
      {
        _element = PaGlobal_GameOption_All._elements.PetRender
      },
      ...
      {
        _element = PaGlobal_GameOption_All._elements.DetachtedHpBar
      },
      {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.RenderGuardEffect,
        _contentsOption = _ContentsGroup_ShowActionStatus
      },
      {
        _element = PaGlobal_GameOption_All._elements.RenderMissEffect
      },
      ...
      {
        _element = PaGlobal_GameOption_All._elements.SkillComboGuide,
        _contentsOption = _ContentsGroup_SkillComboGuide
      },
      {
    ...
    Alert = {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.ShowFriendLoginMessage
      },
      {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.AlertWaitItemMarket
      },
      {
        _element = PaGlobal_GameOption_All._elements.AlertHp
      },
      {
        _element = PaGlobal_GameOption_All._elements.AlertElementalBoss
      }
    },
    Worldmap = {
    ...
    Etc = {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.SeasonUiType,
      ...
      {
        _element = PaGlobal_GameOption_All._elements.IsYachtPvpRefuse,
        _contentsOption = _ContentsGroup_MiniGame_YachtDice_PVP
      },
      {
        _element = PaGlobal_GameOption_All._elements.GuildWarRefuse
      },
      {
        _element = PaGlobal_GameOption_All._elements.SolareCustomGameRefuse,
      ...
      {
        _element = PaGlobal_GameOption_All._elements.RadarArrow
      },
      {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.HideFullUiByAttacked
      },
      {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.EtcOpenBrowser,
  ...
  Interface = {
    ...
    UI = {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.UiFamilyInven
      },
      {
        _element = PaGlobal_GameOption_All._elements.UiMoveToWharf
      }
    },
    QuickSlot = {
    ...
    Function = {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.UiPingTypeAttack
      },
      {
        _element = PaGlobal_GameOption_All._elements.UiPingTypeMove
      },
      {
        _element = PaGlobal_GameOption_All._elements.UiPingTypeReader
      },
      {
        _element = PaGlobal_GameOption_All._elements.UiPingTypeCaution
      }
    },
    Mouse = {
    ...
    Pad = {
      ...
      {
        _element = PaGlobal_GameOption_All._elements.UsePadRenewerUI
      },
      {
