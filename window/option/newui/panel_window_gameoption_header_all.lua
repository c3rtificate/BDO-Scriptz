...
PaGlobal_GameOption_All._elements = {
  ...
  AutoFindTarget = {_defaultValue = false, _controlType = __ePAUIControl_CheckButton},
  ...
  EtcOpenBrowser = {_defaultValue = 0, _controlType = __ePAUIControl_Button},
  SeasonUiType = {
    _defaultValue = 0,
  ...
  IsYachtPvpRefuse = {_defaultValue = false, _controlType = __ePAUIControl_CheckButton},
  ...
  BattleFieldNameTagVisible = {_defaultValue = false, _controlType = __ePAUIControl_CheckButton},
  ...
  UsePadRenewerUI = {_defaultValue = false, _controlType = __ePAUIControl_CheckButton},
  ...
  ShowFriendLoginMessage = {_defaultValue = true, _controlType = __ePAUIControl_CheckButton},
  EnableMusic = {
    _defaultValue = true,
    _controlType = __ePAUIControl_CheckButton,
    _settingRightNow = true
  ...
  AlertWaitItemMarket = {_defaultValue = true, _controlType = __ePAUIControl_CheckButton},
  AlertHp = {_defaultValue = true, _controlType = __ePAUIControl_CheckButton},
  ...
  UiFamilyInven = {uiInputType = 54, _controlType = __ePAUIControl_RadioButton},
  UiPingTypeAttack = {uiInputType = 56, _controlType = __ePAUIControl_RadioButton},
  UiPingTypeMove = {uiInputType = 57, _controlType = __ePAUIControl_RadioButton},
  UiPingTypeReader = {uiInputType = 58, _controlType = __ePAUIControl_RadioButton},
  UiPingTypeCaution = {uiInputType = 59, _controlType = __ePAUIControl_RadioButton},
