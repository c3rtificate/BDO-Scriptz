PaGlobal_GameOption_All._specSettingOption = {
  [PaGlobal_GameOption_All.SPEC.LowNormal] = {
    GraphicOption = PaGlobal_GameOption_All.GRAPHIC.VeryLow,
    isIncrease = false,
    TextureQuality = 0,
    AntiAliasing = 1,
    UseEffectFrameOptimization = true,
    EffectFrameOptimization = 0.9,
    UsePlayerEffectDistOptimization = true,
    PlayerEffectDistOptimization = 0.9,
    UseCharacterUpdateFrameOptimize = true,
    UseOtherPlayerUpdate = true,
    WorkerVisible = false,
    PetRender = 2
  },
  [PaGlobal_GameOption_All.SPEC.MidNormal] = {
    GraphicOption = PaGlobal_GameOption_All.GRAPHIC.Medium,
    isIncrease = false,
    TextureQuality = 1,
    AntiAliasing = 1,
    UseEffectFrameOptimization = true,
    EffectFrameOptimization = 0.6,
    UsePlayerEffectDistOptimization = true,
    PlayerEffectDistOptimization = 0.6,
    UseCharacterUpdateFrameOptimize = true,
    UseOtherPlayerUpdate = true,
    WorkerVisible = false,
    PetRender = 2
  },
  [PaGlobal_GameOption_All.SPEC.HighNormal] = {
    GraphicOption = PaGlobal_GameOption_All.GRAPHIC.VeryHigh,
    isIncrease = true,
    TextureQuality = 2,
    AntiAliasing = 1,
    UseEffectFrameOptimization = true,
    EffectFrameOptimization = 0.3,
    UsePlayerEffectDistOptimization = true,
    PlayerEffectDistOptimization = 0.3,
    UseCharacterUpdateFrameOptimize = true,
    UseOtherPlayerUpdate = false,
    WorkerVisible = false,
    PetRender = 1
  },
  [PaGlobal_GameOption_All.SPEC.HighestNormal] = {
    GraphicOption = PaGlobal_GameOption_All.GRAPHIC.VeryVeryHigh,
    isIncrease = true,
    TextureQuality = 2,
    AntiAliasing = 1,
    UseEffectFrameOptimization = false,
    EffectFrameOptimization = nil,
    UsePlayerEffectDistOptimization = false,
    PlayerEffectDistOptimization = nil,
    UseCharacterUpdateFrameOptimize = false,
    UseOtherPlayerUpdate = false,
    WorkerVisible = true,
    PetRender = 0
  },
  [PaGlobal_GameOption_All.SPEC.LowSiege] = {
    GraphicOption = PaGlobal_GameOption_All.GRAPHIC.VeryLow,
    isIncrease = false,
    TextureQuality = 0,
    AntiAliasing = 1,
    ...
    UsePlayerEffectDistOptimization = true,
    PlayerEffectDistOptimization = 1,
    UseCharacterUpdateFrameOptimize = true,
    UseOtherPlayerUpdate = true,
    WorkerVisible = false,
    PetRender = 2
  },
  [PaGlobal_GameOption_All.SPEC.MidSiege] = {
    GraphicOption = PaGlobal_GameOption_All.GRAPHIC.Medium,
    isIncrease = false,
    TextureQuality = 1,
    AntiAliasing = 1,
    UseEffectFrameOptimization = true,
    EffectFrameOptimization = 0.75,
    UsePlayerEffectDistOptimization = true,
    PlayerEffectDistOptimization = 0.75,
    UseCharacterUpdateFrameOptimize = true,
    UseOtherPlayerUpdate = true,
    WorkerVisible = false,
    PetRender = 2
  },
  [PaGlobal_GameOption_All.SPEC.HighSiege] = {
    GraphicOption = PaGlobal_GameOption_All.GRAPHIC.VeryHigh,
    isIncrease = true,
    TextureQuality = 2,
    AntiAliasing = 1,
    UseEffectFrameOptimization = true,
    EffectFrameOptimization = 0.5,
    UsePlayerEffectDistOptimization = true,
    PlayerEffectDistOptimization = 0.5,
    UseCharacterUpdateFrameOptimize = true,
    UseOtherPlayerUpdate = true,
    WorkerVisible = false,
    PetRender = 1
  },
  [PaGlobal_GameOption_All.SPEC.HighestSiege] = {
    GraphicOption = PaGlobal_GameOption_All.GRAPHIC.VeryVeryHigh,
    isIncrease = true,
    TextureQuality = 2,
    AntiAliasing = 1,
...
function PaGlobal_GameOption_All:GetServiceTypeRadioButtonMap()
  ...
  elseif CppEnums.GameServiceType.eGameServiceType_ASIA_ALPHA == resourceType or CppEnums.GameServiceType.eGameServiceType_ASIA_REAL == resourceType then
    radioMap = {
      [0] = CppEnums.ServiceResourceType.eServiceResourceType_EN,
      [1] = CppEnums.ServiceResourceType.eServiceResourceType_ID,
      [2] = CppEnums.ServiceResourceType.eServiceResourceType_TH
    }
  end
  return radioMap
end
function PaGlobal_GameOption_All:GetChannelChatRadioButtonMap()
  ...
  elseif CppEnums.GameServiceType.eGameServiceType_ASIA_ALPHA == resourceType or CppEnums.GameServiceType.eGameServiceType_ASIA_REAL == resourceType then
    radioMap = {
      ...
      [1] = CppEnums.LangType.LangType_English,
      [2] = CppEnums.LangType.LangType_ID,
      [3] = CppEnums.LangType.LangType_TH
    }
  end
...
function PaGlobal_GameOption_All:radioButtonMapping_AudioResourceType(value, fromRadioButtonToCppEnum)
  if _ContentsOption_CH_GameType == true then
    return CppEnums.ServiceResourceType.eServiceResourceType_CN
  end
...
function PaGlobal_GameOption_All:SetGraphicOption(value, isIncrease)
  ...
  if true == _ContentsGroup_UseAMDFSR then
    local FSRCurrent = PaGlobal_GameOption_All:getOptionValue("UpscaleEnable")
    if FSRCurrent == PaGlobal_GameOption_All._UpScaleType.AMDFSR then
      if nil == _AntiAliasing._curValue then
        _AntiAliasing._curValue = PaGlobal_GameOption_All:getOptionValue("AntiAliasing")
      end
      if value < self.GRAPHIC.UltraLow or _AntiAliasing._curValue < 2 then
        PaGlobal_GameOption_All._elements.UpscaleEnable:set(PaGlobal_GameOption_All._UpScaleType.OFF)
        PaGlobal_GameOption_All:SetControlSetting(PaGlobal_GameOption_All._elements.UpscaleEnable, PaGlobal_GameOption_All._UpScaleType.OFF)
        PaGlobal_GameOption_All:SetMonoToneIgnoreSetting(PaGlobal_GameOption_All._elements.UpscaleFSRType, true, true)
      end
    end
  end
...
function PaGlobal_GameOption_All:SetSpecSetting(value)
  ...
  if value < self.SPEC.LowNormal or value > self.SPEC.HighestSiege then
    return
  end
  if nil == self._specSettingOption or nil == self._specSettingOption[value] then
    _PA_ASSERT(false, "\236\132\164\236\160\149\237\149\152\235\160\164\235\138\148 \236\130\172\236\150\145\236\157\152 \236\131\129\236\132\184 \234\176\146\236\157\180 \236\151\134\236\138\181\235\139\136\235\139\164. PaGlobal_GameOption_All._specSettingOption\236\157\132 \237\153\149\236\157\184\237\149\180\236\163\188\236\132\184\236\154\148.")
    return
  end
  local options = self._elements
  local settings = self._specSettingOption[value]
  options.GraphicOption._curValue = settings.GraphicOption
  self:SetGraphicOption(options.GraphicOption._curValue, settings.isIncrease)
  options.TextureQuality._curValue = settings.TextureQuality
  options.UseEffectFrameOptimization._curValue = settings.UseEffectFrameOptimization
  options.UsePlayerEffectDistOptimization._curValue = settings.UsePlayerEffectDistOptimization
  options.UseCharacterUpdateFrameOptimize._curValue = settings.UseCharacterUpdateFrameOptimize
  options.UseOtherPlayerUpdate._curValue = settings.UseOtherPlayerUpdate
  options.WorkerVisible._curValue = settings.WorkerVisible
  options.PetRender._curValue = settings.PetRender
  if self.SPEC.HighestNormal == value then
    options.EffectFrameOptimization._curValue = self:getOptionValue("EffectFrameOptimization")
    options.PlayerEffectDistOptimization._curValue = self:getOptionValue("PlayerEffectDistOptimization")
  else
    options.EffectFrameOptimization._curValue = settings.EffectFrameOptimization
    options.PlayerEffectDistOptimization._curValue = settings.PlayerEffectDistOptimization
  end
...
function PaGlobal_GameOption_All:EtcOpenBrowser(type)
  local url = ""
  if type == 1 then
    url = "https://bd.qq.com/cp/a20240823zhzx/index.html"
  elseif type == 2 then
    url = "https://game.qq.com/contract.shtml"
  elseif type == 3 then
    url = "https://rule.tencent.com/rule/202408220001"
  elseif type == 4 then
    url = "https://game.qq.com/privacy_guide_children.shtml"
  end
  if url == "" then
    return
  end
  ToClient_OpenRailBrowser(url, 3)
end
