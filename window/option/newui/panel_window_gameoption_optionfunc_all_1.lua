...
function PaGlobal_GameOption_All._elements.AutoFindTarget:get(wrapper)
...
function PaGlobal_GameOption_All._elements.CallHorseByCompleteQuest:get(wrapper)
...
function PaGlobal_GameOption_All._elements.UIFontType:get(wrapper)
  ...
  return fontTypeValue
end
function PaGlobal_GameOption_All._elements.SeasonUiType:get(wrapper)
...
function PaGlobal_GameOption_All._elements.IsYachtPvpRefuse:get(wrapper)
  return wrapper:getIsYachtPvpRefuse()
end
function PaGlobal_GameOption_All._elements.RadarArrow:get(wrapper)
...
function PaGlobal_GameOption_All._elements.HideFullUiByAttacked:get(wrapper)
  return wrapper:getHideFullUiByAttacked()
end
function PaGlobal_GameOption_All._elements.GuildWarRefuse:get(wrapper)
  return wrapper:getGuildWarRefuse()
end
function PaGlobal_GameOption_All._elements.SolareCustomGameRefuse:get(wrapper)
...
function PaGlobal_GameOption_All._elements.HPGaugeVisible:get(wrapper)
  local realValue = wrapper:getHPGaugeVisible()
  for index = 0, 2 do
    if realValue == PaGlobal_GameOption_All._HPGaugeVisibleValue[index] then
      return index
    end
  end
  return 0
...
function PaGlobal_GameOption_All._elements.MonsterNameTagVisible:get(wrapper)
  return CppEnums.VisibleNameTagType.eVisibleNameTagType_AllwaysShow == wrapper:getMonsterNameTagVisible()
end
function PaGlobal_GameOption_All._elements.MonsterHPGaugeVisible:get(wrapper)
...
function PaGlobal_GameOption_All._elements.BattleFieldNameTagVisible:get(wrapper)
  return ToClient_getGameUIManagerWrapper():getLuaCacheDataListBool(__eBattleFieldNameShow)
end
...
function PaGlobal_GameOption_All._elements.GuideLineOutLine:get(wrapper)
  return wrapper:getRenderOutLine()
end
...
function PaGlobal_GameOption_All._elements.DetachtedHpBar:get()
  local isRemasterUI = ToClient_getGameUIManagerWrapper():getLuaCacheDataListBool(__eSwapRemasterUISetting)
  return not isRemasterUI
end
...
function PaGlobal_GameOption_All._elements.RenderGuardEffect:get(wrapper)
...
function PaGlobal_GameOption_All._elements.RenderMissEffect:get(wrapper)
...
function PaGlobal_GameOption_All._elements.SkillComboGuide:get(wrapper)
  return wrapper:getShowSkillComboGuide()
end
...
function PaGlobal_GameOption_All._elements.UpscaleEnable:get(wrapper)
  local isUpscaleOn = wrapper:getUpscaleEnable()
  local isFSROn = wrapper:getFSRUpscaleEnable() and _ContentsGroup_UseAMDFSR
  local value = PaGlobal_GameOption_All._UpScaleType.OFF
  if true == isFSROn then
    value = PaGlobal_GameOption_All._UpScaleType.AMDFSR
  elseif true == isUpscaleOn then
    value = PaGlobal_GameOption_All._UpScaleType.UPSCALE
  end
  return value
end
function PaGlobal_GameOption_All._elements.UpscaleFSRType:get(wrapper)
  return wrapper:getFSRUpscaleType()
end
...
function PaGlobal_GameOption_All._elements.UsePadRenewerUI:get(wrapper)
...
function PaGlobal_GameOption_All._elements.ShowFriendLoginMessage:get(wrapper)
...
function PaGlobal_GameOption_All._elements.EnableAudioSequence:get(wrapper)
...
function PaGlobal_GameOption_All._elements.VolumeSequence:get(wrapper)
  return PaGlobal_GameOption_All:FromRealValueToSliderValue(wrapper:getSequenceVolume(), 0, 100)
end
...
function PaGlobal_GameOption_All._elements.AlertWaitItemMarket:get(wrapper)
  return wrapper:getAlertWaitItem()
end
function PaGlobal_GameOption_All._elements.AlertHp:get(wrapper)
  return wrapper:getAlertHp()
end
function PaGlobal_GameOption_All._elements.AlertElementalBoss:get(wrapper)
...
function PaGlobal_GameOption_All._elements.ChatFilterSystemEnchant:get()
  local chat = ToClient_getChattingPanel(0)
