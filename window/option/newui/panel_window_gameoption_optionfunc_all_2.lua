...
function PaGlobal_GameOption_All._elements.AutoFindTarget:set(value)
...
function PaGlobal_GameOption_All._elements.CallHorseByCompleteQuest:set(value)
...
function PaGlobal_GameOption_All._elements.UIFontType:set(value)
  if 1 == value and true == isGameTypeEnglish() then
    value = 2
  end
...
function PaGlobal_GameOption_All._elements.SeasonUiType:set(value)
...
function PaGlobal_GameOption_All._elements.IsYachtPvpRefuse:set(value)
  setIsYachtPvpRefuse(value)
end
function PaGlobal_GameOption_All._elements.RadarArrow:set(value)
  setRadarArrow(value)
end
...
function PaGlobal_GameOption_All._elements.HideFullUiByAttacked:set(value)
  setHideFullUiByAttacked(value)
end
function PaGlobal_GameOption_All._elements.GuildWarRefuse:set(value)
  setGuildWarRefuse(value)
end
function PaGlobal_GameOption_All._elements.SolareCustomGameRefuse:set(value)
  setSolareCustomGameRefuse(value)
end
...
function PaGlobal_GameOption_All._elements.HPGaugeVisible:set(value)
  if nil == value then
    return
  end
  local realValue = PaGlobal_GameOption_All._HPGaugeVisibleValue[value]
  if nil ~= realValue then
    setHPGaugeVisible(realValue)
  end
end
...
function PaGlobal_GameOption_All._elements.MonsterNameTagVisible:set(value)
  if true == value then
    value = CppEnums.VisibleNameTagType.eVisibleNameTagType_AllwaysShow
  else
...
function PaGlobal_GameOption_All._elements.MonsterHPGaugeVisible:set(value)
  if true == value then
    value = CppEnums.VisibleNameTagType.eVisibleNameTagType_AllwaysShow
  else
    value = CppEnums.VisibleNameTagType.eVisibleNameTagType_NoShow
...
function PaGlobal_GameOption_All._elements.BattleFieldNameTagVisible:set(value)
  ToClient_getGameUIManagerWrapper():setLuaCacheDataListBool(__eBattleFieldNameShow, value, CppEnums.VariableStorageType.eVariableStorageType_User)
  PaGlobalFunc_CharacterNameTag_BattleFieldNameTagVisibleSet(value)
end
...
function PaGlobal_GameOption_All._elements.GuideLineOutLine:set(value)
  ToClient_SetRenderOutLine(value)
end
...
function PaGlobal_GameOption_All._elements.DetachtedHpBar:set(value)
  local isRemasterUI = not value
  ToClient_getGameUIManagerWrapper():setLuaCacheDataListBool(__eSwapRemasterUISetting, isRemasterUI, CppEnums.VariableStorageType.eVariableStorageType_User)
  PaGlobalFunc_UiSet_SetRemasterUIBtn(not isRemasterUI)
end
function PaGlobal_GameOption_All._elements.MaidView:set(value)
  ...
  local finalValue = value * maxMaidValue
  if finalValue < 0 then
    finalValue = PaGlobal_GameOption_All._elements.MaidView._defaultValue
  end
  setMaidView(finalValue)
end
...
function PaGlobal_GameOption_All._elements.RenderGuardEffect:set(value)
...
function PaGlobal_GameOption_All._elements.SkillComboGuide:set(value)
  Toclient_setShowSkillComboGuide(value)
end
function PaGlobal_GameOption_All._elements.HideMastOnCarrier:set(value)
  setHideMastOnCarrier(value)
end
function PaGlobal_GameOption_All._elements.RenderMissEffect:set(value)
...
function PaGlobal_GameOption_All._elements.UpscaleEnable:set(value)
  if PaGlobal_GameOption_All._UpScaleType.OFF == value then
    setUpscaleEnable(false)
    setFSRUpscaleEnable(false)
  elseif PaGlobal_GameOption_All._UpScaleType.UPSCALE == value then
    setFSRUpscaleEnable(false)
    setUpscaleEnable(true)
  elseif PaGlobal_GameOption_All._UpScaleType.AMDFSR == value and true == _ContentsGroup_UseAMDFSR then
    setUpscaleEnable(false)
    setFSRUpscaleEnable(true)
  end
end
function PaGlobal_GameOption_All._elements.UpscaleFSRType:set(value)
  setFSRUpscaleType(value)
end
...
function PaGlobal_GameOption_All._elements.GamePadEnable:set(value)
  if false == value then
    if nil ~= Panel_MiniGame_Find_All and true == Panel_MiniGame_Find_All:GetShow() then
      Proc_ShowMessage_Ack(PAGetString(Defines.StringSheet_GAME, "LUA_PLAYINGMINIGAME_ALERT"))
      return
    end
...
function PaGlobal_GameOption_All._elements.UsePadRenewerUI:set(value)
  if nil ~= Panel_MiniGame_Find_All and true == Panel_MiniGame_Find_All:GetShow() then
    Proc_ShowMessage_Ack(PAGetString(Defines.StringSheet_GAME, "LUA_PLAYINGMINIGAME_ALERT"))
    return
  end
  if true == _ContentsGroup_useUISnappingOption then
    ...
    elseif false == value then
      if false == PaGlobal_GameOption_All:getOptionValue("GamePadEnable") then
...
function PaGlobal_GameOption_All._elements.ColorBlind:set(value)
  ...
  if FGlobal_Radar_SetColorBlindMode ~= nil then
    FGlobal_Radar_SetColorBlindMode()
  end
  if FGlobal_Window_Servant_ColorBlindUpdate ~= nil then
...
function PaGlobal_GameOption_All._elements.ShowFriendLoginMessage:set(value)
...
function PaGlobal_GameOption_All._elements.EnableAudioSequence:set(value)
...
function PaGlobal_GameOption_All._elements.VolumeSequence:set(value)
...
function PaGlobal_GameOption_All._elements.AlertWaitItemMarket:set(value)
  ToClient_SetAlarmWaitItemMarket(value)
end
function PaGlobal_GameOption_All._elements.AlertHp:set(value)
  ToClient_SetAlertHp(value)
end
function PaGlobal_GameOption_All._elements.AlertElementalBoss:set(value)
...
function PaGlobal_GameOption_All._elements.ChatFilterSystemEnchant:set(value)
  local chat = ToClient_getChattingPanel(0)
  if true == chat:isShowChatType(CppEnums.ChatType.System) then
