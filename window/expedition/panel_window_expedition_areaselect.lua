...
function expeditionAreaSelectInfo:createControl()
  ...
  self._ui._list2_region:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_ExpeditionAreaSelectInfo_CreateControlList2")
  ...
  for ii = 0, 3 do
    ...
    for jj = 0, self._config._maxSlot - 1 do
      ...
      slot.background = UI.createControl(__ePAUIControl_Static, self._ui._itemGroup[ii], "DropItemBG_" .. jj)
...
function expeditionAreaSelectInfo:updateList()
