...
function expeditionSettingInfo:createControl()
  for ii = 0, self._config._bgMaxCount - 1 do
    ...
    settingBG._warningText1:SetTextMode(__eTextMode_AutoWrap)
    ...
    settingBG._warningText2:SetTextMode(__eTextMode_AutoWrap)
    ...
    settingBG._imageInfo:SetTextMode(__eTextMode_AutoWrap)
...
function PaGlobalFunc_ExpeditionSettingInfo_SelectCharacterSet(index, characterNo)
  ...
  local isCaptureExist = image:ChangeTextureInfoNameNotDDS(textureName, charType, isExitPhoto)
