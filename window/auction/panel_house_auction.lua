...
PaGlobal_Util_RegistHelpTooltipEvent(_buttonQuestion, "\"HouseAuction\"")
...
function HouseAuctionManager:initialize()
  for y = 0, maxYCount - 1 do
    for x = 0, maxXCount - 1 do
      ...
      local houselist = {}
      houselist._styleBG = UI.createControl(__ePAUIControl_Static, Panel_Auction, "Style_BG_" .. index)
      houselist._cancelButton = UI.createControl(__ePAUIControl_Button, houselist._styleBG, "Button_Cancel_Get_" .. index)
      houselist._bidButton = UI.createControl(__ePAUIControl_Button, houselist._styleBG, "Button_Get_" .. index)
      houselist._styleName = UI.createControl(__ePAUIControl_StaticText, houselist._styleBG, "StaticText_Name_" .. index)
      houselist._nowPrice = UI.createControl(__ePAUIControl_StaticText, houselist._styleBG, "StaticText_NowPrice_" .. index)
      houselist._aucPrice = UI.createControl(__ePAUIControl_StaticText, houselist._styleBG, "StaticText_AucPrice_" .. index)
      houselist._myPrice = UI.createControl(__ePAUIControl_StaticText, houselist._styleBG, "StaticText_MyPrice_" .. index)
      houselist._editInGold = UI.createControl(__ePAUIControl_Edit, houselist._styleBG, "Edit_InGold_" .. index)
      houselist._money = UI.createControl(__ePAUIControl_StaticText, houselist._styleBG, "StaticText_Money_" .. index)
      houselist._styleImage = UI.createControl(__ePAUIControl_Static, houselist._styleBG, "Static_Image_" .. index)
      houselist._styleTime = UI.createControl(__ePAUIControl_StaticText, houselist._styleBG, "StaticText_Time_" .. index)
      houselist._styleArea = UI.createControl(__ePAUIControl_StaticText, houselist._styleBG, "StaticText_Area_" .. index)
      houselist._styleSpecialService = UI.createControl(__ePAUIControl_StaticText, houselist._styleBG, "StaticText_SpecialService_" .. index)
...
function HouseAuctionManager:setHouseData(index)
  ...
  if houseAuctionInfo:getPrice_s64() <= houseAuctionInfo:getHighPrice_s64() then
    self._houseAuctionList[index]._nowPrice:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_HOUSEAUCTION_NOWPRICE") .. " " .. PAGetStringParam1(Defines.StringSheet_GAME, "LUA_COMMON_MONEY", "value", tostring(Uint64toUint32(houseAuctionInfo:getHighPrice_s64()))))
  else
    self._houseAuctionList[index]._nowPrice:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_HOUSEAUCTION_NOWPRICE") .. " " .. PAGetStringParam1(Defines.StringSheet_GAME, "LUA_COMMON_MONEY", "value", tostring(Uint64toUint32(houseAuctionInfo:getPrice_s64()))))
  end
  ...
  self._houseAuctionList[index]._styleSpecialService:SetTextMode(__eTextMode_AutoWrap)
...
function HouseAuctionManager:setBidData(index)
  ...
  self._houseAuctionList[index]._nowPrice:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_HOUSEAUCTION_NOWPRICE") .. PAGetStringParam1(Defines.StringSheet_GAME, "LUA_COMMON_MONEY", "value", tostring(makeDotMoney(bidAuctionInfo:getUpperBidPrice_s64()))))
  self._houseAuctionList[index]._aucPrice:SetShow(true)
  self._houseAuctionList[index]._aucPrice:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_HOUSEAUCTION_BIDPRICE") .. PAGetStringParam1(Defines.StringSheet_GAME, "LUA_COMMON_MONEY", "value", tostring(makeDotMoney(bidAuctionInfo:getMyBidPrice_s64()))))
