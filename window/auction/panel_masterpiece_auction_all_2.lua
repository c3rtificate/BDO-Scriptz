...
function HandleEventLUp_Masterpiece_Auction_All_SetInfomation(idx)
  ...
  PaGlobal_Masterpiece_Auction_All._ui.itemList.txt_masterpieceName:SetTextMode(__eTextMode_AutoWrap)
  ...
  PaGlobal_Masterpiece_Auction_All._ui.itemList.txt_masterpieceAuthor:SetTextMode(__eTextMode_AutoWrap)
  ...
  if PaGlobal_Masterpiece_Auction_All._ui.itemList.txt_masterpieceStory:IsLimitText() then
    PaGlobal_Masterpiece_Auction_All._ui.itemList.txt_masterpieceStory:SetEnableArea(0, 0, PaGlobal_Masterpiece_Auction_All._ui.itemList.txt_masterpieceStory:GetSizeX(), PaGlobal_Masterpiece_Auction_All._ui.itemList.txt_masterpieceStory:GetTextSizeY())
...
function HandleEventLUp_Masterpiece_Auction_All_BidListControlCreate(control, key)
  PaGlobal_Masterpiece_Auction_All:bidListControlCreate(control, key)
end
function HandleEventLUp_Masterpiece_Auction_All_TabSelect()
  if true == PaGlobal_Masterpiece_Auction_All._isOpenEscMenu then
    return
  end
...
function HandleEventLUp_Masterpiece_Auction_All_Reload()
  if PaGlobal_Masterpiece_Auction_All._isItemList == true then
    RequestAuctionListPage()
  else
    RequestBiddingPage()
  end
...
function FromClient_Masterpiece_Auction_All_WarehouseUpdate()
  ...
  if dialog_isEventWarehouseNpc() == true then
    wareHouseMoney = warehouse_moneyFromRegionKey_s64(warehouse_getEventWarehouseRegionKey())
  end
end
