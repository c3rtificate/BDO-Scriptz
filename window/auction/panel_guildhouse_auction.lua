...
function GuildHouseAuction_InitControl()
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(self.btn_Question, "\"HouseAuction\"")
  if true == _ContentsOption_CH_Help then
    self.btn_Question:SetShow(false)
  end
  ...
  self.auctionGuide:SetTextMode(__eTextMode_AutoWrap)
...
function GuildHouseAuctionManager:initialize()
  for y = 0, maxYCount - 1 do
    for x = 0, maxXCount - 1 do
      ...
      local houselist = {}
      houselist._bg = UI.createControl(__ePAUIControl_Static, Panel_GuildHouse_Auction, "Style_BG_" .. index)
      houselist._area = UI.createControl(__ePAUIControl_StaticText, houselist._bg, "StaticText_Area_" .. index)
      houselist._name = UI.createControl(__ePAUIControl_StaticText, houselist._bg, "StaticText_Name_" .. index)
      houselist._partHLine = UI.createControl(__ePAUIControl_Static, houselist._bg, "StaticText_HLine_" .. index)
      houselist._aucPrice = UI.createControl(__ePAUIControl_StaticText, houselist._bg, "StaticText_AucPrice_" .. index)
      houselist._myPrice = UI.createControl(__ePAUIControl_StaticText, houselist._bg, "StaticText_MyPrice_" .. index)
      houselist._editInGold = UI.createControl(__ePAUIControl_Edit, houselist._bg, "Edit_InGold_" .. index)
      houselist._btn_Cancel_Get = UI.createControl(__ePAUIControl_Button, houselist._bg, "Button_Cancel_Get_" .. index)
      houselist._btn_Get = UI.createControl(__ePAUIControl_Button, houselist._bg, "Button_Get_" .. index)
      houselist._specialService = UI.createControl(__ePAUIControl_StaticText, houselist._bg, "StaticText_SpecialService_" .. index)
      houselist._remainCount = UI.createControl(__ePAUIControl_StaticText, houselist._bg, "StaticText_RemainCount_" .. index)
      houselist._aucRemainTime = UI.createControl(__ePAUIControl_StaticText, houselist._bg, "StaticText_Time_" .. index)
      houselist._house_Image = UI.createControl(__ePAUIControl_Static, houselist._bg, "Static_Image_" .. index)
      houselist._aucRemainTime_Icon = UI.createControl(__ePAUIControl_Static, houselist._bg, "Static_Image_TimeIcon_" .. index)
...
function GuildHouseAuctionManager:setHouseData(index)
  ...
  self._houseAuctionList[index]._aucPrice:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_GUILDHOUSE_AUCTION_LOWPRICE") .. PAGetStringParam1(Defines.StringSheet_GAME, "LUA_COMMON_MONEY", "value", tostring(makeDotMoney(houseAuctionInfo:getPrice_s64()))))
  ...
  self._houseAuctionList[index]._specialService:SetTextMode(__eTextMode_AutoWrap)
