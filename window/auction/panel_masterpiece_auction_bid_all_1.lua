...
function PaGlobal_Masterpiece_Auction_Bid_All:setMyMoney()
  ...
  self._ui.stc_wareHousetitle:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_COMMON_MYMONEY"))
  local wareHouseMoney = getSelfPlayer():get():getMoneyInventory():getMoney_s64()
