PaGlobal_UIModify = {
  ...
  _panel = {
    ...
    [14] = {
      ...
      index = CppEnums.PAGameUIType.PAGameUIPanel_KillLog,
    ...
    [15] = {
      ...
      index = CppEnums.PAGameUIType.PAGameUIPanel_ClassResource,
      name = "",
      isChange = false,
      isShow = true,
      showFixed = true,
    ...
    [16] = {
      control = Panel_Widget_HopeGaugeOnOff,
      index = CppEnums.PAGameUIType.PAGameUIPanel_HopeGauge_OnOff,
