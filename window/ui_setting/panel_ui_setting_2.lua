...
function HandleEventLUp_UiSet_PositionCheck(index)
  ...
  elseif index >= PaGlobal_UISetting._panelID.SkillCoolTimeQuickSlot0 and index <= PaGlobal_UISetting._panelID.SkillCoolTimeQuickSlot19 then
    HandleEventLUp_UiSet_PositionCheck_SetPos(index, PaGlobal_UISetting._panelID.SkillCoolTimeQuickSlot0, PaGlobal_UISetting._panelID.SkillCoolTimeQuickSlot19)
  end
end
...
function HandleClicked_UiSet_ConfirmSetting(isShortcuts)
  ...
  if PaGlobal_UISetting._prevRemasterUI ~= PaGlobal_UISetting._isShowRemasterUI then
    FromClient_MainStatus_SwapUIOption(PaGlobal_UISetting._isShowRemasterUI, false)
  end
  ...
  local reset_GameUI = function()
    ...
    for idx = 1, PaGlobal_UISetting._panelCount do
      ...
      elseif idx == panelID.LargeParty then
        panelControl[idx].control:SetShow(panelControl[idx].isShow)
      elseif idx >= panelID.SkillCoolTimeQuickSlot0 and idx <= panelID.SkillCoolTimeQuickSlot19 then
      ...
      if idx >= panelID.SkillCoolTimeQuickSlot0 and idx <= panelID.SkillCoolTimeQuickSlot19 then
