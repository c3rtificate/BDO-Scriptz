...
function PaGlobal_DeliveryInformation:registEventHandler()
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(PaGlobal_DeliveryInformation._ui.buttonQuestion, "\"DeliveryInformation\"")
  ...
  if true == _ContentsOption_CH_Help then
    PaGlobal_DeliveryInformation._ui.buttonQuestion:SetShow(false)
  end
end
