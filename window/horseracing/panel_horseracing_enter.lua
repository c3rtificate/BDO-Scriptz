...
function PaGlobal_HorseRacing_Enter:initialize()
  ...
  self._ui._txt_MatchingName = UI.getChildControl(Panel_HorseRacing_Match_All, "StaticText_State")
  self._ui._txt_MatchingState = UI.getChildControl(Panel_HorseRacing_Match_All, "StaticText_Loading")
  self._ui._btn_MatchingCancel = UI.getChildControl(Panel_HorseRacing_Match_All, "Button_Cancel")
  self._ui._txt_MatchingElapsedTime = UI.getChildControl(Panel_HorseRacing_Match_All, "StaticText_Time")
  self._ui._stc_horseMatchingBg = UI.getChildControl(Panel_HorseRacing_Match_All, "Static_HorseRacing_Bg")
  self._ui._stc_rabbitMatchingBg = UI.getChildControl(Panel_HorseRacing_Match_All, "Static_Rabbit_Bg")
  self._ui._stc_horseIcon = UI.getChildControl(Panel_HorseRacing_Match_All, "Static_Icon")
  self:setNotice()
  self._recordAreaPos = {
...
function PaGlobal_HorseRacing_Enter:registEventHandler()
  ...
  if ToClient_IsInstanceFieldPlayerbyContentsType(__eInstanceContentsType_HorseRacing) == true then
    self._ui.btn_exit:addInputEvent("Mouse_LUp", "PaGlobalFunc_HorseRacing_MatchingState_PrepareClose()")
  else
  ...
  self._ui._btn_MatchingCancel:addInputEvent("Mouse_LUp", "PaGlobalFunc_HorseRacing_MatchingState_PrepareClose()")
  ...
  registerEvent("FromClient_ResponseHorseRacingMatchingStateAck", "FromClient_HorseRacing_MatchingStateUpdate")
end
function PaGlobal_HorseRacing_Enter:prepareOpen()
  ...
  PaGlobal_HorseRacing_Enter:switchMatchingUI(true)
  if ToClient_IsInstanceFieldPlayerbyContentsType(__eInstanceContentsType_HorseRacing) == true then
    if Panel_HorseRacing_Match_Confirm:GetShow() == true or Panel_HorseRacing_Match_All:GetShow() == true then
  ...
  self._ui.btn_Join:SetIgnore(isInstancePlayer)
...
function PaGlobal_HorseRacing_Enter:switchMatchingUI(isHorseRace)
  self._ui._stc_horseMatchingBg:SetShow(isHorseRace == true)
  self._ui._stc_rabbitMatchingBg:SetShow(isHorseRace == false)
  self._ui._stc_horseIcon:SetShow(isHorseRace == true)
  if isHorseRace == true then
    self._ui._txt_MatchingName:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_HORSERACING_TITLE"))
    self._ui._txt_enterMsgString = PAGetString(Defines.StringSheet_GAME, "LUA_HORSERACING_ENTER_LOADING")
    PaGlobal_HorseRacing_MatchingConfirm._ui._multiLineText:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_WINDOW_HORSERACING_MATCH_CONFIRM_DESC"))
  else
    self._ui._txt_MatchingName:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_RABBITLIVERSCRAMBLE_MATCHING"))
    self._ui._txt_enterMsgString = PAGetString(Defines.StringSheet_GAME, "LUA_RABBITLIVERSCRAMBLE_ENTER_LOADING")
    PaGlobal_HorseRacing_MatchingConfirm._ui._multiLineText:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_RABBITLIVERSCRAMBLE_MATCHING_DONE"))
  end
end
...
function PaGlobalFunc_HorseRacingEnter_Join()
  ...
  if hp == maxHp then
    ...
    if _ContentsGroup_HorseRaceMatch == true then
      ToClient_requestJoinMatching(__eMatchMode_Normal, __eInstanceContentsType_HorseRacing, __eHorseRacingMode_Normal, mapKey)
    else
...
function PaGlobalFunc_HorseRacing_MatchingState_Open()
  if true == Panel_HorseRacing_Match_All:GetShow() then
    return
  end
  PaGlobal_HorseRacing_Enter._ui._txt_MatchingElapsedTime:SetText("")
  PaGlobal_HorseRacing_Enter._currentElapsedTime = 0
  PaGlobal_HorseRacing_Enter._currentDeltaTime = 0
  Panel_HorseRacing_Match_All:ClearUpdateLuaFunc()
  Panel_HorseRacing_Match_All:RegisterUpdateFunc("FromClient_HorseRacing_MatchingState_UpdatePerFrame")
  PaGlobal_HorseRacing_Enter._ui._txt_MatchingState:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_BLOODALTAR_MATCHING_WAITING"))
  Panel_HorseRacing_Match_All:ComputePos()
  Panel_HorseRacing_Match_All:SetShow(true)
  PaGlobal_HorseRacing_Enter._ui._btn_MatchingCancel:SetMonoTone(false, false)
  PaGlobal_HorseRacing_Enter._ui._btn_MatchingCancel:SetIgnore(false)
  PaGlobalFunc_HorseRacing_MatchingState_SwitchMatchingBtn(true)
end
function PaGlobalFunc_HorseRacing_MatchingState_PrepareClose()
  if PaGlobal_HorseRacing_Enter._matchingCloseTime < PaGlobal_HorseRacing_Enter._matchingDelayTime then
    local remainSecTime = math.floor(PaGlobal_HorseRacing_Enter._matchingDelayTime - PaGlobal_HorseRacing_Enter._matchingCloseTime)
  ...
  PaGlobalFunc_HorseRacing_MatchingState_SwitchMatchingBtn(false)
  PaGlobal_HorseRacing_Enter._matchingCloseTime = 0
  ToClient_requestCancleMatching()
end
function PaGlobalFunc_HorseRacing_MatchingState_Close()
  Panel_HorseRacing_Match_All:SetShow(false)
  Panel_HorseRacing_Match_All:ClearUpdateLuaFunc()
  PaGlobal_HorseRacing_Enter._currentElapsedTime = 0
  PaGlobal_HorseRacing_Enter._currentDeltaTime = 0
  PaGlobalFunc_HorseRacing_MatchingState_SwitchMatchingBtn(false)
end
function FromClient_HorseRacing_MatchingState_UpdatePerFrame(deltaTime)
  PaGlobal_HorseRacing_Enter._matchingCloseTime = PaGlobal_HorseRacing_Enter._matchingCloseTime + deltaTime
  PaGlobal_HorseRacing_Enter._currentDeltaTime = PaGlobal_HorseRacing_Enter._currentDeltaTime + deltaTime
  if PaGlobal_HorseRacing_Enter._currentDeltaTime > 1 then
    PaGlobal_HorseRacing_Enter._currentElapsedTime = PaGlobal_HorseRacing_Enter._currentElapsedTime + 1
    PaGlobal_HorseRacing_Enter._currentDeltaTime = 0
    PaGlobal_HorseRacing_Enter._ui._txt_MatchingElapsedTime:SetText(convertSecondsToClockTime(PaGlobal_HorseRacing_Enter._currentElapsedTime))
  end
end
function PaGlobalFunc_HorseRacing_MatchingState_SwitchMatchingBtn(isMatching)
  if true == isMatching then
    PaGlobal_HorseRacing_Enter._ui.btn_exit:SetMonoTone(false, false)
    PaGlobal_HorseRacing_Enter._ui.btn_exit:SetIgnore(false)
    PaGlobal_HorseRacing_Enter._ui.btn_Join:SetMonoTone(true)
    PaGlobal_HorseRacing_Enter._ui.btn_Join:SetIgnore(true)
  else
    PaGlobal_HorseRacing_Enter._ui.btn_exit:SetMonoTone(true)
    PaGlobal_HorseRacing_Enter._ui.btn_exit:SetIgnore(true)
    PaGlobal_HorseRacing_Enter._ui.btn_Join:SetMonoTone(false, false)
    PaGlobal_HorseRacing_Enter._ui.btn_Join:SetIgnore(false)
  end
end
function FromClient_HorseRacing_MatchServerConnectSuccess()
  ToClient_requestJoinMatching(__eMatchMode_Count, __eInstanceContentsType_HorseRacing, 0, -1)
end
function FromClient_HorseRacing_SuccessMatchServerLogin()
  if true == ToClient_IsMatchingStateByMatchServer() then
    PaGlobalFunc_HorseRacing_MatchingState_Open()
  elseif Panel_HorseRacing_Match_All:GetShow() == true then
    PaGlobalFunc_HorseRacing_MatchingState_Close()
  end
end
function FromClient_HorseRacing_MatchingSuccess()
  if nil == Panel_HorseRacing_Match_All then
    return
  end
  PaGlobal_HorseRacing_Enter._ui._txt_MatchingState:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SOLARE_FOUND_MATCH_TITLE"))
  PaGlobal_HorseRacing_Enter._ui._btn_MatchingCancel:SetMonoTone(true, true)
  PaGlobal_HorseRacing_Enter._ui._btn_MatchingCancel:SetIgnore(true)
  PaGlobalFunc_HorseRacing_MatchingConfirm_Close()
  if PaGlobal_HorseRacing_Enter._txt_enterMsgString == "" then
    PaGlobal_HorseRacing_Enter._txt_enterMsgString = PAGetString(Defines.StringSheet_GAME, "LUA_HORSERACING_ENTER_LOADING")
  end
  local messageBoxData = {
    title = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_CASH_CUSTOMIZATION_BUYITEM_TITLE"),
    content = PaGlobal_HorseRacing_Enter._txt_enterMsgString,
    priority = CppEnums.PAUIMB_PRIORITY.PAUIMB_PRIORITY_LOW
  }
  MessageBox.showMessageBox(messageBoxData)
end
function FromClient_HorseRacing_SuccessMatchServerLogout()
  PaGlobalFunc_HorseRacing_MatchingState_Close()
  PaGlobalFunc_HorseRacing_MatchingConfirm_Close()
end
function FromClient_HorseRacing_MatchingStateUpdate(isMatching)
  if true == ToClient_IsMatchingStateByMatchServer() then
    PaGlobalFunc_HorseRacing_MatchingState_Open()
  elseif Panel_HorseRacing_Match_All:GetShow() == true then
    PaGlobalFunc_HorseRacing_MatchingState_Close()
