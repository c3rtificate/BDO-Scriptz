...
function PaGlobal_TradeEventNotice_All:InitializeCreateUI()
  ...
  for terrIndex = 0, PaGlobal_TradeEventNotice_All._territoryCount - 1 do
    ...
    if terrIndex > PaGlobal_TradeEventNotice_All._ETerritory._margoria then
      addPosX = (terrIndex - 1) % PaGlobal_TradeEventNotice_All._columnNum * addPosX
      lineNum = math.floor((terrIndex - 1) / PaGlobal_TradeEventNotice_All._columnNum)
    else
...
function PaGlobal_TradeEventNotice_All:UpdateSupplyInfo()
  ...
  for terrIndex = 0, PaGlobal_TradeEventNotice_All._territoryCount - 1 do
    ...
    if 0 < PaGlobal_TradeEventNotice_All._supplyItemCount[terrIndex] and PaGlobal_TradeEventNotice_All._ETerritory._margoria ~= terrIndex then
