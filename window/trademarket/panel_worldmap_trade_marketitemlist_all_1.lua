...
function PaGlobal_WorldMap_TradeItemList_All:prepareOpen()
  ...
  local isOnlySell = false
  local isNormalTradeMerchant = false
  ...
  self._currentTab = 0
  self._ui._rdo_Tab_Buy:SetShow(true)
  self._ui._rdo_Tab_Sell:SetShow(true)
  self._ui._stc_Selected_Line:SetShow(true)
  self._ui._rdo_Tab_Sell:ComputePos()
  self._ui._rdo_Tab_Sell:ComputePos()
