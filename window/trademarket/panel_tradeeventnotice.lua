...
eventDesc:SetTextMode(__eTextMode_AutoWrap)
eventAlert:SetTextMode(__eTextMode_AutoWrap)
...
function TradeEventInfo_Init()
  for terrIndex = 0, terrCount - 1 do
    local temp1 = UI.createControl(__ePAUIControl_StaticText, Panel_TradeMarket_EventInfo, "Static_TerritorySupplyTownName_" .. terrIndex)
    ...
    local tempNavi = UI.createControl(__ePAUIControl_Button, Panel_TradeMarket_EventInfo, "Button_TerritorySupplyNavi_" .. terrIndex)
    ...
    for supplyIndex = 0, maxSlotCount - 1 do
      local temp2 = UI.createControl(__ePAUIControl_Static, Panel_TradeMarket_EventInfo, "Static_TerritorySupplySlotBg" .. terrIndex .. "_" .. supplyIndex)
      ...
      local temp3 = UI.createControl(__ePAUIControl_Static, Panel_TradeMarket_EventInfo, "Static_TerritorySupplySlot" .. terrIndex .. "_" .. supplyIndex)
