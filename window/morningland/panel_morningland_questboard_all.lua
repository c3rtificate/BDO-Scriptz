PaGlobal_MorningLand_QuestBoard_All = {
  ...
  _eQuestTab = {eNormal = 0, eHidden = 1},
  _normalInfo = {
    [1] = {
      _groupId = 8503,
...
runLua("UI_Data/Script/Window/MorningLand/Panel_MorningLand_QuestBoard_All_1.lua")
runLua("UI_Data/Script/Window/MorningLand/Panel_MorningLand_QuestBoard_All_2.lua")
