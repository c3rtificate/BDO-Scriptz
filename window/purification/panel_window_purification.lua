...
function PuriManager:Open()
  ...
  self._ui._text_InvenMoney:SetText(makeDotMoney(getSelfPlayer():get():getMoneyInventory():getMoney_s64()))
...
function PuriManager:Clear()
  ...
  if false == isGameServiceTypeConsole() and nil ~= self._ui._chk_AniSkip then
...
function PuriManager:Initialize()
  ...
  self._ui._text_desc:SetTextMode(__eTextMode_AutoWrap)
