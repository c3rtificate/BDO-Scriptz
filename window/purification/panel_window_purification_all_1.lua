function PaGlobal_Purification_All:initialize()
  ...
  self._ui._stc_MoneyArea = UI.getChildControl(self._ui._stc_ButtonBG, "Static_MyMoneyArea")
  ...
  if textY > bottomBgSizeY then
    ...
    self._ui._stc_MoneyArea:SetPosY(self._ui._stc_MoneyArea:GetPosY() - gap)
