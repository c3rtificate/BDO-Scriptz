function Panel_NumberPad_Show(isShow, s64_moneyMaxNumber, param0, confirmFunction, isExchange, param1, isItemMarket, param2, s64_weightMaxNumber, param3)
  ...
  if false == isShow then
    ...
    if Defines.s64_const.s64_1 == s64_moneyMaxNumber then
      PaGlobal_NumberPad_All:openSetting(param0, confirmFunction, false, param1, param2, param3)
      HandleEventLUp_NumberPad_All_ConfirmButton_Click()
    else
      PaGlobal_NumberPad_All:openSetting(param0, confirmFunction, true, param1, param2, param3)
...
function HandleEventLUp_NumberPad_All_ConfirmButton_Click()
  if PaGlobal_NumberPad_All:checkConfirmEnable() or true == PaGlobal_NumberPad_All._isExchange then
    ...
    if nil ~= numberPad.confirmFunction then
      numberPad.confirmFunction(numberPad.s64_inputNumber, numberPad.param0, numberPad.param1, numberPad.param2, numberPad.param3)
    end
