...
function PaGlobal_NumberPad_All:registEventHandler()
  ...
  if true == ToClient_isConsole() then
    PaGlobal_NumberPad_All._ui.btn_close:SetShow(false)
  else
    PaGlobal_NumberPad_All._ui.btn_close:SetShow(true)
...
function PaGlobal_NumberPad_All:openSetting(param0, confirmFunction, isShow, param1, param2, param3)
  local numberPad = PaGlobal_NumberPad_All._numberPad
  numberPad.param0 = param0
  numberPad.param1 = param1
  numberPad.param2 = param2
  numberPad.param3 = param3
  ...
  if false == PaGlobal_NumberPad_All._isConsole then
    if Panel_Window_NumberPad_All:GetPosY() + Panel_Window_NumberPad_All:GetSizeY() > getScreenSizeY() or Panel_Window_NumberPad_All:GetPosY() < 0 then
  ...
  if Panel_Window_NumberPad_All:GetPosX() + Panel_Window_NumberPad_All:GetSizeX() > getScreenSizeX() or 0 > Panel_Window_NumberPad_All:GetPosX() then
