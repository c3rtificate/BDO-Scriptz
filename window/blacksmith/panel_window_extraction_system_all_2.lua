...
function HandleEventLUp_Extraction_System_All_ListControlCreate(control, key)
  ...
  local slot = {}
  SlotItem.reInclude(slot, "System_Extraction", 0, itemIcon, PaGlobal_Extraction_Crystal_All._listSlotConfig)
  ...
  if nil == PaGlobal_Extraction_System_All._equipNo[key_32] then
    if false == PaGlobal_Extraction_System_All._isConsole then
      slot.icon:addInputEvent("Mouse_LUp", "HandleEventLUp_Extraction_System_All_SystemItem(" .. key_32 .. ")")
      slot.icon:addInputEvent("Mouse_On", "HandleEventOn_Extraction_System_All_ShowListToolTip(false," .. PaGlobal_Extraction_System_All._itemInfo.slotNo[key_32] .. ",true)")
      slot.icon:addInputEvent("Mouse_Out", "HandleEventOn_Extraction_System_All_ShowListToolTip(false," .. PaGlobal_Extraction_System_All._itemInfo.slotNo[key_32] .. ",false)")
    else
    ...
    if false == PaGlobal_Extraction_System_All._isConsole then
      slot.icon:addInputEvent("Mouse_LUp", "HandleEventLUp_Extraction_System_All_equipmentItem(" .. PaGlobal_Extraction_System_All._equipNo[key_32] .. ")")
      slot.icon:addInputEvent("Mouse_On", "HandleEventOn_Extraction_System_All_ShowListToolTip(true," .. PaGlobal_Extraction_System_All._equipNo[key_32] .. ",true)")
      slot.icon:addInputEvent("Mouse_Out", "HandleEventOn_Extraction_System_All_ShowListToolTip(true," .. PaGlobal_Extraction_System_All._equipNo[key_32] .. ",false)")
    else
      btn_item:addInputEvent("Mouse_On", "PaGlobal_Extraction_System_All_ShowDetailKeyGuide(true," .. key_32 .. ")")
      btn_item:addInputEvent("Mouse_Out", "PaGlobal_Extraction_System_All_ShowDetailKeyGuide(false," .. key_32 .. ")")
...
function HandleEventLUp_Extraction_System_All_Extraction()
  ...
  if nil ~= PaGlobal_Extraction_System_All._ui._icon_resultItem.originalForDuelIcon and true == PaGlobal_Extraction_System_All._ui._icon_resultItem.originalForDuelIcon:GetShow() then
    messageBoxMemo = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_EXTRACTIONSYSTEM_COPYITEM_POPUPMSG", "itemName", itemName)
  end
