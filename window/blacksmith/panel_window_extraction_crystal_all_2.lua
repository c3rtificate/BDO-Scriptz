...
function HandleEventLUp_Extraction_Crystal_All_ExtractionListControlCreate(control, key)
  ...
  if nil == PaGlobal_Extraction_Crystal_All._equipNo[key_32] then
    itemWrapper = getInventoryItemByType(whereType, PaGlobal_Extraction_Crystal_All._extractionItemInfo.slotNo[key_32])
  else
  ...
  local slot = {}
  SlotItem.reInclude(slot, "Crystal_Extraction", 0, itemIcon, PaGlobal_Extraction_Crystal_All._listSlotConfig)
  ...
  if nil == PaGlobal_Extraction_Crystal_All._equipNo[key_32] then
    if false == PaGlobal_Extraction_Crystal_All._isConsole then
      slot.icon:addInputEvent("Mouse_LUp", "HandleEventLUp_Extraction_Crystal_All_CrystalItem(" .. key_32 .. ")")
      slot.icon:addInputEvent("Mouse_On", "HandleEventOn_Extraction_Crystal_All_ShowListToolTip(false," .. PaGlobal_Extraction_Crystal_All._extractionItemInfo.slotNo[key_32] .. "," .. whereType .. ",true)")
      slot.icon:addInputEvent("Mouse_Out", "HandleEventOn_Extraction_Crystal_All_ShowListToolTip(false," .. PaGlobal_Extraction_Crystal_All._extractionItemInfo.slotNo[key_32] .. "," .. whereType .. ",false)")
    else
    ...
    if false == PaGlobal_Extraction_Crystal_All._isConsole then
      slot.icon:addInputEvent("Mouse_LUp", "HandleEventLUp_Extraction_Crystal_All_EquipItem(" .. PaGlobal_Extraction_Crystal_All._equipNo[key_32] .. ")")
      slot.icon:addInputEvent("Mouse_On", "HandleEventOn_Extraction_Crystal_All_ShowListToolTip(true," .. PaGlobal_Extraction_Crystal_All._equipNo[key_32] .. "," .. whereType .. ",true)")
      slot.icon:addInputEvent("Mouse_Out", "HandleEventOn_Extraction_Crystal_All_ShowListToolTip(true," .. PaGlobal_Extraction_Crystal_All._equipNo[key_32] .. "," .. whereType .. ",false)")
    else
      btn_item:addInputEvent("Mouse_On", "PaGlobal_Extraction_Crystal_All_ShowDetailKeyGuide(true," .. key_32 .. ")")
      btn_item:addInputEvent("Mouse_Out", "PaGlobal_Extraction_Crystal_All_ShowDetailKeyGuide(false," .. key_32 .. ")")
      btn_item:registerPadEvent(__eConsoleUIPadEvent_Up_X, "HandleEventOn_Extraction_Crystal_All_ShowListToolTip(true," .. PaGlobal_Extraction_Crystal_All._extractionItemInfo.slotNo[key_32] .. "," .. whereType .. ",nil)")
    end
...
function HandleEventLUp_Extraction_Crystal_All_MaterialListControlCreate(control, key)
  ...
  itemText:SetText(itemName)
  PAGlobalFunc_SetItemTextColor(itemText, itemSSW)
