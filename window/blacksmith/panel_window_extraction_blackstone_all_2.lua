...
function HandleEventLUp_Extraction_Blackstone_All_ListControlCreate(control, key)
  ...
  local slot = {}
  SlotItem.reInclude(slot, "BlackStone_Extraction", 0, itemIcon, PaGlobal_Extraction_Blackstone_All._listSlotConfig)
  ...
  if nil == PaGlobal_Extraction_Blackstone_All._equipNo[key_32] then
    if false == PaGlobal_Extraction_Blackstone_All._isConsole then
      slot.icon:addInputEvent("Mouse_LUp", "HandleEventLUp_Extraction_Blackstone_All_BlackstoneItem(" .. key_32 .. ")")
      slot.icon:addInputEvent("Mouse_On", "PaGlobal_Extraction_Blackstone_All_ShowListToolTip(" .. PaGlobal_Extraction_Blackstone_All._itemInfo.slotNo[key_32] .. ",true,false)")
      slot.icon:addInputEvent("Mouse_Out", "PaGlobal_Extraction_Blackstone_All_ShowListToolTip(" .. PaGlobal_Extraction_Blackstone_All._itemInfo.slotNo[key_32] .. ",false,false)")
    else
    ...
    if false == PaGlobal_Extraction_Blackstone_All._isConsole then
      slot.icon:addInputEvent("Mouse_LUp", "HandleEventLUp_Extraction_Blackstone_All_equipmentItem(" .. PaGlobal_Extraction_Blackstone_All._equipNo[key_32] .. ")")
      slot.icon:addInputEvent("Mouse_On", "PaGlobal_Extraction_Blackstone_All_ShowListToolTip(" .. PaGlobal_Extraction_Blackstone_All._equipNo[key_32] .. ",true,true)")
      slot.icon:addInputEvent("Mouse_Out", "PaGlobal_Extraction_Blackstone_All_ShowListToolTip(" .. PaGlobal_Extraction_Blackstone_All._equipNo[key_32] .. ",false,true)")
    else
      btn_item:addInputEvent("Mouse_On", "PaGlobal_Extraction_Blackstone_All_ShowDetailKeyGuide(true" .. key_32 .. ")")
      btn_item:addInputEvent("Mouse_Out", "PaGlobal_Extraction_Blackstone_All_ShowDetailKeyGuide(false)")
...
function PaGlobal_Extraction_Blackstone_All_ResultShowToolTip(isShow)
  ...
  local itemWrapper = getItemEnchantStaticStatus(ItemEnchantKey(16001))
  if nil == itemWrapper then
    return
  end
