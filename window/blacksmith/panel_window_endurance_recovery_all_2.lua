...
function HandleEventLUp_Endurance_Recovery_All_OnceRecovery()
  ...
  function funcYesExe()
    ...
    repair_MaxEndurance(whereType, PaGlobal_Endurance_Recovery_All._recoveryItemSlotNo, whereType, materialItemSlotNo, CppEnums.ItemWhereType.eMoneyInventory, PaGlobal_Endurance_Recovery_All._isUseCashItem)
...
function PaGlobal_Endurance_Recovery_All_FixEquipContinue(slotNo)
  ...
  if mainItemWrapper:checkToRepairItemMaxEndurance() then
    repair_MaxEndurance(whereType, PaGlobal_Endurance_Recovery_All._recoveryItemSlotNo, whereType, slotNo, CppEnums.ItemWhereType.eMoneyInventory, PaGlobal_Endurance_Recovery_All._isUseCashItem)
  else
    PaGlobal_Endurance_Recovery_All._isStreamRecovery = false
    PaGlobal_Endurance_Recovery_All:clearAllSlot()
  end
