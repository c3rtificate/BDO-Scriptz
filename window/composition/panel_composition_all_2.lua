...
function PaGlobal_Composition_All_SetFullMode(isFull)
  ...
  if isFull == true then
    PaGlobal_Composition_All._ui._webControl:TriggerEvent("CompositionNotes_SetFullMode", "true")
  else
    PaGlobal_Composition_All._ui._webControl:TriggerEvent("CompositionNotes_SetFullMode", "false")
  end
end
