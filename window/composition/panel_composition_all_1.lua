...
function PaGlobal_Composition_All:registEventHandler()
  ...
  registerEvent("FromClient_SetFullMode", "FromClient_SetFullMode")
...
function PaGlobal_Composition_All:prepareOpen(musicIndex)
  ...
  ToClient_SetStateMIDIInstrument(true)
...
function PaGlobal_Composition_All:prepareClose()
  ...
  TooltipSimple_Hide()
  self._ui._webControl:ResetUrl()
  ToClient_SetStateMIDIInstrument(false)
...
function FromClient_SetFullMode(isFullMode)
  PaGlobal_Composition_All:setFullMode(isFullMode)
end
