...
function HandleEventOn_House_InstallationMode_ObjectControl_All_ButtonTooltip(eBtnType)
  ...
  elseif PaGlobal_House_InstallationMode_ObjectControl_All._eButtonType.delete == eBtnType then
    local isRemoteRemove = true == ToClient_IsRemoteInstallMode() and true == ToClient_isRemoteRemoveActor()
    if true == PaGlobal_House_InstallationMode_ObjectControl_All._typeIsHavest or true == isRemoteRemove then
