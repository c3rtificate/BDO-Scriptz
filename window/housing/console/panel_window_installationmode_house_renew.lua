...
local Panel_Window_InstallationMode_House_info = {
  _ui = {
    ...
    static_BigHousingPartListBG = nil,
    static_Image_Temp = nil,
    staticText_PartTitle = nil,
    static_BigHousingItemListBG = nil,
    static_BigHousingItem_Focus = nil,
    static_BigHousingItem_Templete = nil,
    scroll_BigHousingItemList = nil,
    ...
    static_Move = nil,
    staticText_InteriorSensePoint = nil
  },
  _value = {
    isMyHouse = false,
    isMansion = false,
  ...
  _pos = {
    ...
    wishSlotSizeX = 0,
    wishSlotSizeY = 0,
    partItemSlotStartX = 0,
    partItemSlotStartY = 0,
    partItemSlotSpace = 15,
    partItemSlotSizeX = 0,
    partItemSlotSizeY = 0
  },
  _config = {
...
function Panel_Window_InstallationMode_House_info:childControl()
  ...
  self._ui.static_BigHousingPartListBG = UI.getChildControl(self._ui.static_House_InstallationMode_Right, "Static_BigHousingPartListBG")
  self._ui.static_Image_Temp = UI.getChildControl(self._ui.static_BigHousingPartListBG, "Static_Image_Temp")
  self._ui.staticText_PartTitle = UI.getChildControl(self._ui.static_BigHousingPartListBG, "StaticText_PartTitle")
  self._ui.static_BigHousingItemListBG = UI.getChildControl(self._ui.static_House_InstallationMode_Right, "Static_BigHousingItemListBG")
  self._ui.static_BigHousingItem_Focus = UI.getChildControl(self._ui.static_BigHousingItemListBG, "Static_Item_Focus")
  self._ui.static_BigHousingItem_Focus:SetShow(false)
  self._ui.static_BigHousingItem_Templete = UI.getChildControl(self._ui.static_BigHousingItemListBG, "Static_Item_Templete")
  self._ui.static_BigHousingItem_Templete:SetShow(false)
  self._pos.partItemSlotStartX = self._ui.static_Item_Templete:GetPosX()
  self._pos.partItemSlotStartY = self._ui.static_Item_Templete:GetPosY()
  self._pos.partItemSlotSizeX = self._ui.static_Item_Templete:GetSizeX()
  self._pos.partItemSlotSizeY = self._ui.static_Item_Templete:GetSizeY()
  self._ui.scroll_BigHousingItemList = UI.getChildControl(self._ui.static_BigHousingItemListBG, "Scroll_HousingItemList")
  UIScroll.InputEvent(self._ui.scroll_HousingItemList, "PaGlobalFunc_InstallationMode_House_ScrollItem")
  self._ui.static_BigHousingPartListBG:SetShow(false)
  self._ui.static_BigHousingItemListBG:SetShow(false)
  ...
  self._ui.list2_HousingCategoryList:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_InstallationMode_House_FilterList")
  self._ui.list2_HousingCategoryList:createChildContent(__ePAUIList2ElementManagerType_List)
  ...
  self._ui.staticText_InteriorSensePoint = UI.getChildControl(Panel_House_InstallationMode, "StaticText_InteriorSensePoint")
end
...
function Panel_Window_InstallationMode_House_info:createPartItemSlot()
  local partTabGapX = self._ui.static_Image_Temp:GetSizeX() + 50
  for index = 0, self._config.partTempTabMaxIndex - 1 do
    self._partTabSlotBG[index] = UI.cloneControl(self._ui.static_Image_Temp, self._ui.static_BigHousingPartListBG, "Static_Image_Temp_" .. tostring(index))
    self._partTabSlotBG[index]:SetSpanSize(-partTabGapX + partTabGapX * index, self._partTabSlotBG[index]:GetSpanSize().y)
    self._partTabSlotBG[index]:addInputEvent("Mouse_LUp", "PaGlobalFunc_InstallationMode_House_MansionInstallationPartSelect(" .. index .. ")")
    self._partTabSlotBG[index]:SetShow(false)
  end
  for index = 0, self._config.partItemMaxIndex - 1 do
    local slotBG = {}
    slotBG.bg = UI.createAndCopyBasePropertyControl(self._ui.static_BigHousingItemListBG, "Static_Item_Templete", self._ui.static_BigHousingItemListBG, "Static_Item_Templete_" .. tostring(index))
    slotBG.bluebg = UI.createAndCopyBasePropertyControl(self._ui.static_BigHousingItem_Templete, "Static_BlueItemSlotBg", slotBG.bg, "Static_BlueItemSlotBg_" .. tostring(index))
    slotBG.check = UI.createAndCopyBasePropertyControl(self._ui.static_BigHousingItem_Templete, "Static_CheckMarkTemplete", slotBG.bg, "Static_CheckMarkTemplete_" .. tostring(index))
    local row = math.floor(index / self._config.partItemSlotCol)
    local col = index % self._config.partItemSlotCol
    slotBG.bg:SetShow(true)
    slotBG.bg:SetPosX(self._pos.partItemSlotStartX + (self._pos.partItemSlotSizeX + self._pos.itemSlotSpace) * col)
    slotBG.bg:SetPosY(self._pos.partItemSlotStartY + (self._pos.partItemSlotSizeY + self._pos.itemSlotSpace) * row)
    if 0 == row then
      slotBG.bg:registerPadEvent(__eConsoleUIPadEvent_DpadUp, "PaGlobalFunc_InstallationMode_House_ScrollItem(true)")
    elseif self._config.partItemSlotRow - 1 == row then
      slotBG.bg:registerPadEvent(__eConsoleUIPadEvent_DpadDown, "PaGlobalFunc_InstallationMode_House_ScrollItem(false)")
    end
    local slot = {}
    SlotItem.new(slot, "Static_Item_" .. index, index, slotBG.bg, self._slotConfig)
    ...
    slot.icon:SetPosY(slot.icon:GetPosY() + 2)
    slotBG.bg:SetChildOrder(slot.icon:GetKey(), slotBG.check:GetKey())
    slotBG.bg:SetChildOrder(slot.icon:GetKey(), self._ui.static_BigHousingItem_Focus:GetKey())
    self._ui.static_HousingItemListBG:SetChildOrder(slotBG.bg:GetKey(), self._ui.static_BigHousingItem_Focus:GetKey())
    self._partItemSlotBG[index] = slotBG
    self._partItemSlot[index] = slot
    self._partItemSlotBG[index].bg:addInputEvent("Mouse_On", "PaGlobalFunc_InstallationMode_House_FocusSlot(true,false," .. index .. ")")
    self._partItemSlotBG[index].bg:addInputEvent("Mouse_Out", "PaGlobalFunc_InstallationMode_House_FocusSlot(false,false," .. index .. ")")
  end
end
...
function Panel_Window_InstallationMode_House_info:clearTab()
  self._ui.static_BigHousingPartListBG:SetShow(false)
  self._ui.static_BigHousingItemListBG:SetShow(false)
  self._value.isMansionPartSlot = false
...
function Panel_Window_InstallationMode_House_info:initPartTab()
  if false == self._value.isMansion then
    return
  end
  self._value.partTabMaxIndex = ToClient_GetSubMeshCount()
  for index = 0, self._config.partTempTabMaxIndex - 1 do
    if index < self._value.partTabMaxIndex then
      local iconPath = ToClient_getPartIconPath(index)
      if nil ~= iconPath then
        local icon = UI.getChildControl(self._partTabSlotBG[index], "Static_Image_Icon")
        if nil ~= icon then
          icon:ChangeTextureInfoNameDefault(iconPath)
          icon:getBaseTexture():setUV(0, 0, 1, 1)
          icon:setRenderTexture(icon:getBaseTexture())
        end
      end
      self._partTabSlotBG[index]:SetShow(true)
    else
      self._partTabSlotBG[index]:SetShow(false)
    end
  end
end
function Panel_Window_InstallationMode_House_info:checkAndShowBigHousingItem()
  self:initPartTab()
  self._ui.static_HousingItemListBG:SetShow(false)
  self._ui.static_BigHousingPartListBG:SetShow(true)
  self._ui.static_BigHousingItemListBG:SetShow(true)
  PaGlobalFunc_InstallationMode_House_MansionInstallationPartSelect(0)
end
...
function Panel_Window_InstallationMode_House_info:setKeyGuide(modeType, isShowMove, isShowFix, isShowDelete, isShowCancel)
  ...
  local isFixed = false
  local isPersonalTent, installationType
  ...
  if nil ~= characterStaticWrapper then
    ...
    if nil ~= objectStaticWrapper then
      ...
      if true == objectStaticWrapper:isInstallableOnWall() then
        isRotatePossible = false
      end
    end
  end
  housing_setRestrictedRatateObject(not isRotatePossible)
  ...
  if nil ~= houseWrapper then
    ...
    if nil ~= houseSS then
      ...
      if nil ~= houseObjectSS then
        isFixed = houseObjectSS:isFixedHouse() or houseObjectSS:isInnRoom() or true == houseObjectSS:isMansionLand()
      end
    end
  end
  self._ui.staticText_LS_ConsoleUI:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_INSTALLMODE_KEYGUIDE_OBJECT_MOVE"))
  if self._mode_Type_Enum.InstallMode_None == self._value.currentMode then
    ...
    if false == ToClient_isCameraControlModeForConsole() then
      ...
      self._ui.staticText_LS_ConsoleUI:SetShow(false)
    else
      ...
      self._ui.staticText_LS_ConsoleUI:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_WATCHINGMODE_MOVE_CAMERA1"))
...
function Panel_Window_InstallationMode_House_info:setTab()
  ...
  elseif self._menu_Top_Enum.AllBaseMaterial == self._value.currentTabIndex then
    if true == self._value.isMansion then
      if true == ToClient_VisitHouseIsMansionLand() then
        return
      end
      self._value.isMansionPartSlot = true
      self:checkAndShowBigHousingItem()
      ToClient_MoveCameraHeightToInstallFloor()
    else
...
function Panel_Window_InstallationMode_House_info:updateItemScroll(isUpScroll)
  ...
  if true == self._value.isMansionPartSlot then
    self._value.startItemIndex = UIScroll.ScrollEvent(self._ui.scroll_BigHousingItemList, isUpScroll, self._config.partItemSlotRow, self._value.itemDataCount, self._value.startItemIndex, self._config.partItemSlotCol)
  else
  ...
  if (_ContentsGroup_UsePadSnapping or ToClient_IsDevelopment()) and beforeSlotIndex ~= self._value.startItemIndex then
...
function Panel_Window_InstallationMode_House_info:setItemScroll()
  if true == self._value.isMansionPartSlot then
    UIScroll.SetButtonSize(self._ui.scroll_BigHousingItemList, self._config.partItemMaxIndex, self._value.itemDataCount)
    self._ui.scroll_BigHousingItemList:SetControlPos(0)
    if self._value.itemDataCount == self._value.startItemIndex + self._config.partItemSlotRow then
      self._ui.scroll_BigHousingItemList:SetControlBottom()
    end
  else
...
function Panel_Window_InstallationMode_House_info:focusItem(isOn, index)
  local itemSlot, itemSlotBG
  if true == self._value.isMansionPartSlot then
    itemSlot = self._partItemSlot[index]
    itemSlotBG = self._partItemSlotBG[index]
  else
    itemSlot = self._itemSlot[index]
    itemSlotBG = self._itemSlotBG[index]
  end
  if nil == itemSlotBG.bg then
    return
  end
  local posX = itemSlotBG.bg:GetPosX()
  local posY = itemSlotBG.bg:GetPosY()
  if true == isOn then
  ...
  if nil ~= itemSlot and nil ~= itemSlot.icon and false == itemSlot.icon:GetShow() then
    self._ui.staticText_A_Select_ConsoleUI:SetShow(false)
  end
end
function Panel_Window_InstallationMode_House_info:setItemSlot()
  if true == self._value.isMansionPartSlot then
    self:setBigHouseItemSlot()
    return
  end
  local houseWrapper = housing_getHouseholdActor_CurrentPosition()
...
function Panel_Window_InstallationMode_House_info:setBigHouseItemSlot()
  local houseWrapper = housing_getHouseholdActor_CurrentPosition()
  if nil == houseWrapper then
    return
  end
  if 0 <= self._value.itemDataCount then
    for index = 0, self._config.partItemMaxIndex - 1 do
      self._partItemSlot[index].icon:addInputEvent("Mouse_On", "")
      self._partItemSlot[index].icon:addInputEvent("Mouse_Out", "")
      self._partItemSlot[index].icon:addInputEvent("Mouse_LUp", "")
      self._partItemSlot[index]:clearItem()
      self._partItemSlot[index].isCash:SetShow(false)
      self._partItemSlotBG[index].bluebg:SetShow(false)
      self._partItemSlotBG[index].bg:SetShow(true)
      self._partItemSlotBG[index].check:SetShow(false)
    end
  end
  if self._config.partItemMaxIndex - 1 < self._value.itemDataCount then
    self._ui.scroll_BigHousingItemList:SetShow(true)
  else
    self._ui.scroll_BigHousingItemList:SetShow(false)
  end
  for index = 0, self._config.partItemMaxIndex - 1 do
    local slotIndex = self._value.startItemIndex + index
    local Data = ToClient_GetFurniture(slotIndex)
    if nil ~= Data then
      ...
      if true == Data._isInstalled then
        ...
        self._partItemSlot[index].icon:addInputEvent("Mouse_On", "PaGlobalFunc_InstallationMode_House_showInstalledItemToolTip(true," .. Data._invenSlotNo .. "," .. index .. ")")
        self._partItemSlot[index].icon:addInputEvent("Mouse_LUp", "HandleEventLUp_InstallationMode_House_InstallFloorWallMansion(" .. Data._invenSlotNo .. ")")
        self._partItemSlot[index].isCash:SetShow(false)
        self._partItemSlotBG[index].bg:registerPadEvent(__eConsoleUIPadEvent_X, "PaGlobalFunc_InstallationMode_House_showInstalledItemToolTip(false," .. Data._invenSlotNo .. "," .. index .. ")")
        self._partItemSlotBG[index].bluebg:SetShow(false)
        self._partItemSlotBG[index].check:SetShow(true)
      elseif false == Data._isCashProduct then
        if index == self._value.currentItemIndex then
          PaGlobalFunc_InstallationMode_House_showToolTip(true, Data._invenType, Data._invenSlotNo, index, self._panelKeyGuideEnum.Select)
        end
        self._partItemSlot[index].icon:addInputEvent("Mouse_On", "PaGlobalFunc_InstallationMode_House_showToolTip(true," .. Data._invenType .. "," .. Data._invenSlotNo .. "," .. index .. "," .. self._panelKeyGuideEnum.Select .. ")")
        self._partItemSlot[index].icon:addInputEvent("Mouse_LUp", "HandleEventLUp_InstallationMode_House_InstallFloorWallMansion(" .. Data._invenType .. "," .. Data._invenSlotNo .. ", false," .. 0 .. ")")
        self._partItemSlot[index].isCash:SetShow(false)
        self._partItemSlotBG[index].bg:registerPadEvent(__eConsoleUIPadEvent_X, "PaGlobalFunc_InstallationMode_House_showToolTip(false," .. Data._invenType .. "," .. Data._invenSlotNo .. "," .. index .. "," .. self._panelKeyGuideEnum.Select .. ")")
        self._partItemSlotBG[index].bluebg:SetShow(false)
        self._partItemSlotBG[index].check:SetShow(false)
      else
        if index == self._value.currentItemIndex then
        ...
        self._partItemSlot[index].icon:registerPadEvent(__eConsoleUIPadEvent_X, "PaGlobalFunc_InstallationMode_House_CashItemShowToolTip(false," .. Data._productNoRaw .. "," .. index .. ")")
        self._partItemSlot[index].icon:addInputEvent("Mouse_On", "PaGlobalFunc_InstallationMode_House_CashItemShowToolTip(true," .. Data._productNoRaw .. "," .. index .. ")")
        self._partItemSlot[index].icon:addInputEvent("Mouse_LUp", "HandleEventLUp_InstallationMode_House_InstallFloorWallMansion(" .. Data._invenType .. "," .. Data._invenSlotNo .. ", true," .. Data._productNoRaw .. ")")
        self._partItemSlot[index].isCash:SetShow(true)
        self._partItemSlotBG[index].bg:registerPadEvent(__eConsoleUIPadEvent_X, "PaGlobalFunc_InstallationMode_House_CashItemShowToolTip(false," .. Data._productNoRaw .. "," .. index .. ")")
        self._partItemSlotBG[index].bluebg:SetShow(true)
        self._partItemSlotBG[index].check:SetShow(false)
      end
      self._partItemSlot[index]:setItemByStaticStatus(Data:getItemStaticStatusWrapper(), 0)
      self._partItemSlot[index].icon:SetAlpha(1)
      self._partItemSlot[index].icon:SetShow(true)
      self._partItemSlot[index].icon:addInputEvent("Mouse_Out", "PaGlobalFunc_InstallationMode_House_HideTooltip()")
    end
    if slotIndex >= self._value.itemDataCount then
      self._partItemSlot[index].icon:addInputEvent("Mouse_LUp", "")
      self._partItemSlot[index].icon:addInputEvent("Mouse_Out", "PaGlobalFunc_InstallationMode_House_HideTooltip()")
      self._partItemSlot[index].icon:SetShow(false)
      self._partItemSlotBG[index].bg:registerPadEvent(__eConsoleUIPadEvent_X, "")
      self._partItemSlotBG[index].bluebg:SetShow(false)
    end
  end
end
function Panel_Window_InstallationMode_House_info:baseMaterialConfirm(invenType, invenSlotNo, isCash, productNo)
  local selectIndex = self._value.prevSelectPart
  local function doit()
    if false == isCash then
      ToClient_InstallMansionBaseMaterial(selectIndex, invenType, invenSlotNo)
    else
      ToClient_InstallMansionBaseMaterialForCashShop(selectIndex, productNo)
    end
    self:updateWishContent()
  end
  local enableInstall = false
  if false == isCash then
    enableInstall = ToClient_checkInstallEnableFromInventory(selectIndex, invenType, invenSlotNo)
  else
    enableInstall = ToClient_checkInstallEnableFromProduct(selectIndex, productNo)
  end
  if false == enableInstall then
    ToClient_errorBaseMaterialInstall()
    return
  end
...
function Panel_Window_InstallationMode_House_info:updateWishScroll(isUpScroll)
  ...
  if (_ContentsGroup_UsePadSnapping or ToClient_IsDevelopment()) and beforeSlotIndex ~= self._value.startWishIndex then
    ToClient_padSnapIgnoreGroupMove()
  end
  self:setWishSlot()
end
...
function Panel_Window_InstallationMode_House_info:mansionInstallationPartSelect(index)
  if false == self._value.isMansion then
    return
  end
  if false == self._value.isMansionPartSlot then
    return
  end
  if index == self._value.prevSelectPart then
    return
  end
  ToClient_Housing_List_ClearFilter()
  self:initItemValue()
  self._value.prevSelectPart = index
  ToClient_SetGuideTexture(index, true)
  local selectedInstallationType = ToClient_ConvertSelectIndexToInstallationType(index)
  if selectedInstallationType == __eInstallationType_WallPaper or selectedInstallationType == __eInstallationType_FloorMaterial then
    ToClient_Housing_List_Filter_InstallType(selectedInstallationType)
  else
    _PA_ASSERT(false, "\236\132\160\237\131\157\235\144\156 \236\158\165\236\155\144 \236\132\164\236\185\152 \237\146\136\235\170\169\236\157\180 Floor or Wall \236\157\180 \236\149\132\235\139\153\235\139\136\235\139\164!" .. tostring(selectedInstallationType))
  end
  self:setItemScroll()
  self:updateItemContent()
end
function Panel_Window_InstallationMode_House_info:clearGuideTexture()
  if -1 ~= self._value.prevSelectPart then
    ToClient_SetGuideTexture(self._value.prevSelectPart, false)
    self._value.prevSelectPart = -1
  end
end
...
function PaGlobalFunc_InstallationMode_House_Show()
  ...
  self._value.isMansion = ToClient_VisitHouseIsMansion()
...
function PaGlobalFunc_InstallationMode_House_UpdatePerFrame(deltaTime)
  ...
  local characterStaticWrapper = housing_getCreatedCharacterStaticWrapper()
  self._ui.staticText_InteriorSensePoint:SetShow(false)
  if nil ~= characterStaticWrapper then
    local interiorSensePoint = housing_getAdditionalInteriorSensePoint()
    if interiorSensePoint > 0 then
      self._ui.staticText_InteriorSensePoint:SetShow(true)
      self._ui.staticText_InteriorSensePoint:SetText(PAGetStringParam1(Defines.StringSheet_GAME, "LUA_INTERIORSENSEPOINT", "point", tostring(interiorSensePoint)))
      self._ui.staticText_InteriorSensePoint:SetPosX(self._ui.static_Move:GetPosX() - self._ui.staticText_InteriorSensePoint:GetTextSizeX() / 2)
      self._ui.staticText_InteriorSensePoint:SetPosY(self._ui.static_Move:GetPosY() - (self._ui.staticText_InteriorSensePoint:GetSizeY() + 15))
    end
  end
  if self._mode_Type_Enum.InstallMode_None == self._value.currentMode then
...
function PaGlobalFunc_InstallationMode_House_ToogleTab(value)
  ...
  local self = Panel_Window_InstallationMode_House_info
  if true == ToClient_VisitHouseIsMansionLand() and self._menu_Top_Enum.AllBaseMaterial == self._value.currentTabIndex + value then
    if value >= 0 then
      value = value + 1
    else
      value = value - 1
...
function PaGlobalFunc_InstallationMode_House_TooglePartItemTab(value)
  if false == Panel_Window_InstallationMode_House_info._value.isMansion then
    return
  end
  if false == Panel_Window_InstallationMode_House_info._value.isMansionPartSlot then
    return
  end
  _AudioPostEvent_SystemUiForXBOX(51, 6)
  local selectPart = Panel_Window_InstallationMode_House_info._value.prevSelectPart + value
  if selectPart >= Panel_Window_InstallationMode_House_info._value.partTabMaxIndex then
    selectPart = 0
  elseif selectPart < 0 then
    selectPart = Panel_Window_InstallationMode_House_info._value.partTabMaxIndex - 1
  end
  PaGlobalFunc_InstallationMode_House_MansionInstallationPartSelect(selectPart)
  PaGlobalFunc_InstallationMode_House_HideTooltip()
end
...
function PaGlobalFunc_InstallationMode_House_installFurniture(invenType, invenSlotNo, iscash, productNo)
  ...
  if true == Panel_Window_InstallationMode_House_info._value.isMansion and Panel_Window_InstallationMode_House_info._menu_Top_Enum.AllBaseMaterial ~= Panel_Window_InstallationMode_House_info._value.currentTabIndex then
    local itemSSW
    if true == iscash then
      local cashProduct = ToClient_GetCashProductStaticStatusWrapperByKeyRaw(productNo)
      if nil ~= cashProduct then
        itemSSW = cashProduct:getItemByIndex(0)
      end
    else
    ...
    if nil ~= itemSSW and nil ~= itemSSW:getCharacterStaticStatus() and nil ~= itemSSW:getCharacterStaticStatus():getObjectStaticStatus() then
      local installationType = itemSSW:getCharacterStaticStatus():getObjectStaticStatus():getInstallationType()
      if installationType == CppEnums.InstallationType.eType_WallPaper or installationType == CppEnums.InstallationType.eType_FloorMaterial then
        Proc_ShowMessage_Ack(PAGetString(Defines.StringSheet_GAME, "LUA_UI_MANTION_CRAFT_CONSOLE"))
        return
      end
    end
  end
...
function PaGlobalFunc_InstallationMode_House_BuyItemAll()
  ...
  if getSelfPlayer():get():isMyHouseVisiting() then
    ...
    messageBoxMemo = PAGetString(Defines.StringSheet_GAME, "LUA_HOUSE_INSTALLATIONMODE_CART_BUYITEMALL_MSGMEMO3")
  end
  local messageBoxData = {
...
function PaGlobalFunc_InstallationMode_House_MansionInstallationPartSelect(index)
  Panel_Window_InstallationMode_House_info:mansionInstallationPartSelect(index)
end
function HandleEventLUp_InstallationMode_House_InstallFloorWallMansion(invenType, invenSlotNo, isCash, productNo)
  ...
  _AudioPostEvent_SystemUiForXBOX(50, 1)
  Panel_Window_InstallationMode_House_info:baseMaterialConfirm(invenType, invenSlotNo, isCash, productNo)
end
...
function FromClient_ChangeHousingInstallMode_House_Renew(preMode, nowMode)
  ...
  if self._mode_Type_Enum.InstallMode_None == self._value.currentMode then
    ToClient_setCameraControlModeForConsole(false)
    Panel_House_InstallationMode:ignorePadSnapUpdate(false)
...
function FromClient_changePadCameraControlMode_House_Renew(canZoom)
  local self = Panel_Window_InstallationMode_House_info
  if self._mode_Type_Enum.InstallMode_None == self._value.currentMode and false == canZoom then
    Panel_House_InstallationMode:ignorePadSnapUpdate(false)
    Panel_Window_InstallationMode_HousePoint:ignorePadSnapUpdate(false)
    self._ui.static_BottomBg:SetShow(true)
  else
