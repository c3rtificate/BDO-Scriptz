...
function Panel_Window_InstallationMode_Item_info:open()
  ...
  self._ui.static_KeyGuide_ConsoleBG:SetShow(not isSiegeKitMode)
end
function Panel_Window_InstallationMode_Item_info:prepareClose()
  if nil ~= Panel_House_InstallationMode_Siege_All and true == Panel_House_InstallationMode_Siege_All:GetShow() then
  ...
  Panel_Window_InstallationMode_Item_info:close()
end
...
function FromClient_ChangeHousingInstallMode_Item_Renew(preMode, nowMode)
  ...
  if nil ~= PaGlobal_House_InstallationSiege_All_SetKeyGuide then
    PaGlobal_House_InstallationSiege_All_SetKeyGuide(self._value.currentMode)
  end
end
