...
function InnerObject_ControlInit()
  ...
  for index = 0, innerObjectCount - 1 do
    temp[index] = {}
    innerObject[index] = {}
    temp[index]._name = UI.createControl(__ePAUIControl_StaticText, Panel_House_WarInformation, "StaticText_InnerObjectName_" .. index)
    ...
    temp[index]._count = UI.createControl(__ePAUIControl_StaticText, Panel_House_WarInformation, "StaticText_InnerObjectCount_" .. index)
    ...
    temp[index]._size = UI.createControl(__ePAUIControl_StaticText, Panel_House_WarInformation, "StaticText_InnerObjectSize_" .. index)
    ...
    temp[index]._maxCount = UI.createControl(__ePAUIControl_StaticText, Panel_House_WarInformation, "StaticText_InnerObjectMaxCount_" .. index)
    ...
    temp[index]._resources = UI.createControl(__ePAUIControl_StaticText, Panel_House_WarInformation, "StaticText_ObjectCount_" .. index)
    ...
    if nil ~= houseWrapper and nil ~= houseWrapper:getStaticStatusWrapper() then
      ...
      if nil ~= buildingInfo then
        ...
        for index = 0, innerObjectCount - 1 do
          ...
          innerObject[index]._resources:SetShow(false)
        ...
        HouseInstallationControl.warCountInnerResourceTitle:SetShow(false)
