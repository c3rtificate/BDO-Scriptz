...
function HandleEventLUp_House_Installation_All_Floor(floor)
  PaGlobal_House_InstallationList_All:clearGuideTexture()
...
function PaGlobalFunc_InstallationMode_IsDetailMode()
  return PaGlobal_House_Installation_All._eModeState.detail == PaGlobal_House_Installation_All._eState
end
function FromClient_House_Installation_All_ChangePadCamera(canZoom)
  if true == PaGlobal_House_Installation_All._isConsole then
    local canSnapPanel = PaGlobal_House_Installation_All._eModeState.none == PaGlobal_House_Installation_All._eState and false == canZoom
    if nil ~= Panel_House_InstallationMode_All then
      Panel_House_InstallationMode_All:ignorePadSnapUpdate(not canSnapPanel)
    end
    if nil ~= Panel_House_InstallationMode_List_All then
      Panel_House_InstallationMode_List_All:ignorePadSnapUpdate(not canSnapPanel)
    end
    if nil ~= Panel_House_InstallationMode_SeedList_All then
      Panel_House_InstallationMode_SeedList_All:ignorePadSnapUpdate(not canSnapPanel)
    end
  end
...
function PaGlobal_House_Installation_All_SetKeyGuide(eState)
  ...
  if nil ~= PaGlobal_House_InstallationSiege_All_SetKeyGuide then
    PaGlobal_House_InstallationSiege_All_SetKeyGuide(eState)
  end
end
