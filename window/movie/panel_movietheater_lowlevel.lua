...
if (isGameTypeJapan() or isGameTypeRussia() or isGameTypeEnglish() or isGameTypeTaiwan()) and getContentsServiceType() == CppEnums.ContentsServiceType.eContentsServiceType_CBT then
  countryType = false
elseif _ContentsOption_CH_GameType == true or isGameTypeTR() or isGameTypeTH() or isGameTypeID() or isGameTypeASIA() then
  countryType = false
else
  countryType = true
end
...
local _movieTheater_640 = UI.createControl(__ePAUIControl_WebControl, Panel_MovieTheater_LowLevel, "WebControl_WorldmapGuide")
...
function FGlobal_Panel_LowLevelGuide_MovePlay_Battle(class)
  local movieNo
  if class == __eClassType_Warrior then
    movieNo = 5
  elseif class == __eClassType_ElfRanger then
    movieNo = 6
  elseif class == __eClassType_Sorcerer then
    movieNo = 7
  elseif class == __eClassType_Giant then
    movieNo = 8
  elseif class == __eClassType_Tamer then
    movieNo = 9
  elseif class == __eClassType_BladeMaster then
    movieNo = 10
  elseif class == __eClassType_Valkyrie then
    movieNo = 11
  elseif class == __eClassType_BladeMasterWoman then
    movieNo = 12
  elseif class == __eClassType_WizardMan then
    movieNo = 13
  elseif class == __eClassType_WizardWoman then
    movieNo = 14
  elseif class == __eClassType_Kunoichi then
    movieNo = 15
  end
