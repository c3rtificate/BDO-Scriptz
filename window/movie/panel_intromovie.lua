...
function InitIntroMoviePanel()
  ...
  if true == _ContentsGroup_SelectStartPosition then
    isNewRoute = ToClient_isNewRoute()
  end
  local isNewSequenceTutorial = _ContentsGroup_NewSequenceTutorial
  if 1 == selfPlayerLevel and false == isSwapCharacter() and false == selfPlayerWrapper:isInstancePlayer() and false == isNewRoute and false == isNewSequenceTutorial and static_IntroMovie == nil then
    ...
    if true == _ContentsGroup_UseInGameVideoContent then
      local moviePath = "UI_Movie/PC/Intro/Intro.bk2"
      local subTitlePath = "UI_Movie/PC/Intro/Intro.srt"
