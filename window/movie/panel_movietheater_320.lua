...
local _movieTheater_320 = UI.createControl(__ePAUIControl_WebControl, Panel_MovieTheater_320, "WebControl_SkillGuide")
...
function Panel_MovieTheater320_ShowToggle()
  ...
  local isWarrior = __eClassType_Warrior == player:getClassType()
  local isRanger = __eClassType_ElfRanger == player:getClassType()
  local isSorcerer = __eClassType_Sorcerer == player:getClassType()
  local isGiant = __eClassType_Giant == player:getClassType()
  local isTamer = __eClassType_Tamer == player:getClassType()
  local isBlader = __eClassType_BladeMaster == player:getClassType()
  local isValkyrie = __eClassType_Valkyrie == player:getClassType()
  local isBladerWomen = __eClassType_BladeMasterWoman == player:getClassType()
  local isWizard = __eClassType_WizardMan == player:getClassType()
  local isWizardWomen = __eClassType_WizardWoman == player:getClassType()
  local isNinjaWomen = __eClassType_Kunoichi == player:getClassType()
  local isNinjaMan = __eClassType_NinjaMan == player:getClassType()
  local isDarkElf = __eClassType_DarkElf == player:getClassType()
  local isCombattant = __eClassType_Combattant == player:getClassType()
  local isCombattantWomen = __eClassType_Mystic == player:getClassType()
  ...
  helpMsg:SetTextMode(__eTextMode_AutoWrap)
  local isShow = false
  ...
  _comboList:SetTextMode(__eTextMode_AutoWrap)
