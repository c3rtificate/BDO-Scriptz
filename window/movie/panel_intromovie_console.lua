...
function InitIntroMoviePanel()
  ...
  if selfPlayerLevel ~= 1 then
    return
  end
  if isSwapCharacter() == true then
    return
  end
  if selfPlayerWrapper:isInstancePlayer() == true then
    return
  end
  if _ContentsGroup_SelectStartPosition == true and ToClient_isNewRoute() == true then
    return
  end
  if _ContentsGroup_NewSequenceTutorial == true then
    return
  end
