...
function HandleEventRUp_PetControl_Order_All(orderType)
  TooltipSimple_Hide()
  HandleEventRUp_PetList_SetOrder_ToAll_All(orderType, PaGlobal_PetControl_All._currentPetIndex)
  PaGlobal_PetControl_All:hideCommandBG()
end
...
function HanedleEventRUp_PetControl_SetPlay_All()
  TooltipSimple_Hide()
  HandleEventRUp_PetList_SetPlay_ToAll_All(PaGlobal_PetControl_All._currentPetIndex)
end
...
function Panel_Widget_PetControl_ShowToggle_All()
  if Panel_Widget_PetControl_All:GetShow() then
    ...
    ToClient_getGameUIManagerWrapper():setLuaCacheDataListBoolNoSave(__ePetIconShowNosave, false)
  else
    PaGlobal_PetControl_All:prepareOpen()
    ToClient_getGameUIManagerWrapper():setLuaCacheDataListBoolNoSave(__ePetIconShowNosave, true)
  end
  local panelParty
