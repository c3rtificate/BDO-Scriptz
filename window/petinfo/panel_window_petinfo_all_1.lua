function PaGlobal_PetInfo_All:initialize()
  ...
  self._ui.stc_progressExpBG = UI.getChildControl(Panel_Window_PetInfo_All, "Static_Progress_EXP_BG")
  ...
  self._ui.stc_progressExpBG:SetShow(not _ContentsGroup_PetLevelDelete)
  self._ui.progress_PetExp:SetShow(not _ContentsGroup_PetLevelDelete)
...
function PaGlobal_PetInfo_All:update()
  ...
  for index = 0, petCount - 1 do
    ...
    if petNo == PcPetData:getPcPetNo() then
      ...
      local isLeader = PcPetData:isLeaderPet()
      ...
      if isLeader == true then
        baseskillindex = ToClient_getLeaderBaseSkill(petNum_s64)
      end
      ...
      if not _ContentsGroup_PetLevelDelete then
        ...
        if self._currentPetLv ~= petLevel then
          if petLevel ~= 0 and petLevel ~= 1 and self._currentPetLv ~= 0 and self._currentPetLv ~= 1 then
            ...
            _PA_ASSERT_NAME(not _ContentsGroup_PetLevelDelete, "\235\176\152\235\160\164\235\143\153\235\172\188 \235\160\136\235\178\168\236\151\133 \236\187\168\237\133\144\236\184\160\234\176\128 \235\139\171\237\152\148\235\138\148\235\141\176 \236\157\180\234\179\179\236\157\132 \237\131\128\235\169\180 \236\149\136\235\144\169\235\139\136\235\139\164.", "\234\182\140\236\132\160\236\154\169")
          end
          self._currentPetLv = petLevel
        end
      end
      ...
      if not _ContentsGroup_PetLevelDelete then
        ...
        self._ui.txt_PetLevel:SetShow(false)
        self._ui.progress_PetExp:SetShow(false)
        self._ui.txt_ExpValue:SetShow(false)
      end
    end
  end
end
...
function PaGlobal_PetInfo_All:validate()
  ...
  self._ui.stc_progressExpBG:isValidate()
