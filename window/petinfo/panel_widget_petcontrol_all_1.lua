...
function PaGlobal_PetControl_All:registEventHandler()
  ...
  self._ui.Btn_Follow:addInputEvent("Mouse_RUp", "HandleEventRUp_PetControl_Order_All(0)")
  ...
  self._ui.Btn_Wait:addInputEvent("Mouse_RUp", "HandleEventRUp_PetControl_Order_All(0)")
  ...
  self._ui.Btn_Find:addInputEvent("Mouse_RUp", "HandleEventRUp_PetControl_Order_All(1)")
  ...
  self._ui.Btn_GetItem:addInputEvent("Mouse_RUp", "HandleEventRUp_PetControl_Order_All(2)")
  ...
  self._ui.Btn_Play:addInputEvent("Mouse_RUp", "HanedleEventRUp_PetControl_SetPlay_All()")
