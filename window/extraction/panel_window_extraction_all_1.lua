...
function PaGlobal_Extraction_All:controlAll_Init()
  ...
  self._ui.btn_lightStone = UI.getChildControl(Panel_Window_Extraction_All, "RadioButton_LightStone")
  ...
  self._ui.btn_lightStone:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui.btn_lightStone:SetText(self._ui.btn_lightStone:GetText())
  self._ui.btn_lightStone:SetShow(true == _ContentsGroup_ArtifactItem)
end
...
function PaGlobal_Extraction_All:registEventHandler()
  ...
  self._ui.btn_lightStone:addInputEvent("Mouse_LUp", "HandleEventLUp_Extraction_All_Button_ExtractionLightStone_Click()")
...
function PaGlobal_Extraction_All:prepareOpen()
  ...
  self:openUiSetting()
  Panel_Window_Extraction_All:EraseAllEffect()
  Panel_Window_Extraction_All:AddEffect("fUI_Servant_Dialog_01A", true, 0, 0)
...
function PaGlobal_Extraction_All:allValidate()
  ...
  self._ui.btn_lightStone:isValidate()
...
function PaGlobal_Extraction_All:openUiSetting()
  ...
  self._ui.btn_lightStone:SetCheck(false)
...
function PaGlobal_Extraction_All:extraction_BtnResize()
  ...
  local btnLightStoneSizeX = self._ui.btn_lightStone:GetSizeX() + padding
  local btnLightStonePosX = btnLightStoneSizeX - btnLightStoneSizeX * 0.5 - self._ui.btn_lightStone:GetTextSizeX() * 0.5
...
function PaGlobal_Extraction_All:BottomButtonPosition()
  ...
  if self._ui.btn_lightStone:GetShow() then
    btnTable[btnCount] = self._ui.btn_lightStone
    funcTable[btnCount] = HandleEventLUp_Extraction_All_Button_ExtractionLightStone_Click
    btnCount = btnCount + 1
  end
