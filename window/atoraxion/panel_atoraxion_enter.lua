PaGlobal_Atoraxion_Enter = {
  ...
  _mapData = {
    ...
    [__eInstanceAtoraxionValley_Hadum] = {
      _itemKey = 757331,
      _itemContentType = __eContentsType_AtoraxionValleyHadumEnter,
      _bgLightTexture = "Combine/Etc/Combine_Etc_Atoraxion_Boss_02.dds",
      _bgLightUV = {
        x1 = 0,
        y1 = 546,
        x2 = 1920,
      ...
      _bgTexture = "Combine/Etc/Combine_Etc_Atoraxion_Boss_02.dds",
      _bgUV = {
        x1 = 0,
        y1 = 0,
        x2 = 1920,
      ...
      _title = PAGetString(Defines.StringSheet_GAME, "LUA_ATORAXION_ENTER_TITLE_2"),
      _desc = PAGetString(Defines.StringSheet_GAME, "LUA_ATORAXION_SEAL_DESC_2"),
      _titleEffect = "fUI_Atoraxion_Title_02A",
      _titleColor = Defines.Color.C_FF58FAFF,
      _reJoinDesc = PAGetString(Defines.StringSheet_GAME, "LUA_ATORAXXTION_ENTER_RE_JUNGLE"),
      _msgKeyLack = PAGetString(Defines.StringSheet_GAME, "LUA_ATORAXXITON_BOSS_ENTER_MSG_KEY_JUNGLE"),
      _centerEffect = "fUI_Atoraxion_All_02A",
      _enterEffect = "fUI_Atoraxion_Button_02A"
    },
    [__eInstanceAtoraxionValley_Normal] = {
      _itemKey = 757324,
      _itemContentType = __eContentsType_AtoraxionValleyNormalEnter,
      _bgLightTexture = "Combine/Etc/Combine_Etc_Atoraxion_Boss_02.dds",
      _bgLightUV = {
        x1 = 0,
        y1 = 546,
...
function PaGlobal_Atoraxion_Enter:prepareOpen()
  ...
  self._ui.btn_EnterBottom:SetMonoTone(false)
  self._ui.btn_EnterBottom:SetIgnore(false)
  ...
  if true == self._instancefieldInfo._isReJoin then
    ...
    for index = 1, partyMemberCount do
      ...
      if nil ~= memberData then
        ...
        if true == memberData:isAtoraxionReady(self._instancefieldInfo._mapKey) then
          if nil ~= self._ui.stc_KeySlot[index] then
            self._ui.stc_KeySlot[index]._slot:setItemByStaticStatus(itemWrapper, 1)
...
function HandleEventLUp_Atoraxion_EnterBossRoom()
  ...
  local function enterAtoraxion()
    ...
    PaGlobal_Atoraxion_Enter._ui.btn_EnterBottom:SetMonoTone(true)
    PaGlobal_Atoraxion_Enter._ui.btn_EnterBottom:SetIgnore(true)
  end
