function PaGlobal_Arsha_Func_All:initialize()
  ...
  self._gameSetMenuControl:push_back(self._ui._gameSet.stc_gameRuleBg)
  self._timeLimit = 5
...
function PaGlobal_Arsha_Func_All:gameSetInitControl()
  ...
  self._ui._gameSet.stc_gameRuleBg = UI.getChildControl(self._ui._gameSet.stc_mainBg, "Static_RuleArea")
  self._ui._gameSet.txt_gameRuleTitle = UI.getChildControl(self._ui._gameSet.stc_gameRuleBg, "StaticText_RuleTitle")
  self._ui._gameSet.rdo_gameRule = {}
  self._ui._gameSet.rdo_gameRule[1] = UI.getChildControl(self._ui._gameSet.stc_gameRuleBg, "RadioButton_NoRule")
  self._ui._gameSet.rdo_gameRule[2] = UI.getChildControl(self._ui._gameSet.stc_gameRuleBg, "RadioButton_Barrier")
end
...
function PaGlobal_Arsha_Func_All:personalUpdateForReplay()
end
...
function PaGlobal_Arsha_Func_All:updateGameSetMenuShow()
  ...
  if CppEnums.CompetitionMatchType.eCompetitionMatchMode_Round == matchType then
    ...
    self._gameSetShowcontrol:push_back(self._ui._gameSet.stc_gameRuleBg)
  elseif CppEnums.CompetitionMatchType.eCompetitionMatchMode_FreeForAll == matchType then
    self._gameSetShowcontrol:push_back(self._ui._gameSet.stc_gameTypeBg)
    self._gameSetShowcontrol:push_back(self._ui._gameSet.stc_gameLevelBg)
...
function PaGlobal_Arsha_Func_All:updateGameSetMenuValue()
  ...
  if true == self._ui._gameSet.stc_gameRuleBg:GetShow() then
    checkInit(self._ui._gameSet.rdo_gameRule)
    local isUseLostRegion = ToClient_IsSetLostRegionMode()
    if false == isUseLostRegion then
      self._ui._gameSet.rdo_gameRule[1]:SetCheck(true)
    else
      self._ui._gameSet.rdo_gameRule[2]:SetCheck(true)
    end
  end
end
function PaGlobal_Arsha_Func_All:registEventHandler()
  ...
  self._ui._gameSet.rdo_gameRule[1]:addInputEvent("Mouse_LUp", "ToClient_RequestArshaLostRegionMode(false)")
  self._ui._gameSet.rdo_gameRule[2]:addInputEvent("Mouse_LUp", "ToClient_RequestArshaLostRegionMode(true)")
  ...
  registerEvent("FromClient_ChangeTeamNameForReplay", "FromClient_Arsha_Func_All_ChangeTeamName_ForReplay")
  registerEvent("FromClient_CompetitionMatchDoneToObserver", "FromClient_Arsha_Func_All_CompetitionMatchDoneToObserver")
  registerEvent("FromClient_InviteCompetitonAuthDenied", "FromClient_InviteCompetitonAuthDenied")
...
function PaGlobal_Arsha_Func_All:validate()
  ...
  self._ui._gameSet.stc_gameRuleBg:isValidate()
  self._ui._gameSet.txt_gameRuleTitle:isValidate()
