...
function PaGlobaFunc_Arsha_Reservation_All_ESCMenuFunc()
  ...
  if selfPlayerWrapper ~= nil then
    ...
    if selfPlayer ~= nil and selfPlayer:isCompetitionDefined() == false and ToClient_IsEnterHadumField() == true then
...
function PaGlobalFunc_ArshaReservation_All_RightCheck(eRightType)
