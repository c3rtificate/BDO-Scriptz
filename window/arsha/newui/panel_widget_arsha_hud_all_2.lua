...
function PaGlobalFunc_Arsha_Hud_All_ChangeTeamNameForReplay(redTeamName, blueTeamName)
  PaGlobal_Arsha_Hud_All:changeTeamNameForReplay(redTeamName, blueTeamName)
end
function PaGlobalFunc_Arsha_Hud_All_setReplayMode(isReplayMode)
  PaGlobal_Arsha_Hud_All:setReplayMode(isReplayMode)
end
function PaGlobalFunc_Arsha_Hud_All_settingPersonalForReplay(teamNo, actorKey)
  PaGlobal_Arsha_Hud_All:settingPersonalForReplay(teamNo, actorKey)
end
function PaGlobalFunc_Arsha_Hud_All_updateUserHp_PersonalForReplay(teamNo, actorKey)
  PaGlobal_Arsha_Hud_All:updateUserHp_PersonalForReplay(teamNo, actorKey)
end
function PaGlobalFunc_Arsha_Hud_All_setShowBuffForPersonal(isShow, teamNo, buffIndex, iconPath)
  PaGlobal_Arsha_Hud_All:setShowBuffForPersonal(isShow, teamNo, buffIndex, iconPath)
end
...
function FromClient_Arsha_Hud_All_UpdateFightState(fightState, isShowingResultMessage)
  ...
  elseif CppEnums.CompetitionFightState.eCompetitionFightState_Done == fightState then
    ...
    if CppEnums.CompetitionMatchType.eCompetitionMatchMode_Round == state_match then
      ...
      PaGlobal_Arsha_Hud_All:showTargetScoreDot(targetScore, 0, 0)
    end
...
function FromClient_ReplayArshaLimitTimeEnd(limitTime)
  PaGlobal_Arsha_Hud_All:setTimeForReplayEnd(limitTime)
end
function FromClient_ArshaHud_UpdateUIOnce_NotReloadUI()
  PaGlobal_Arsha_Hud_All:prepareClose()
end
