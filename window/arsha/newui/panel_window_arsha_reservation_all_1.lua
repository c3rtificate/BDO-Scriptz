...
function PaGlobal_Arsha_Reservation_All:changeReservationInfo(dayIndex, dayValue, dayOfWeekValue, reservationGuildName, guildNo, isReservation)
  ...
  local isRightArshaReservation = false
  if _ContentsGroup_GuildAuthoritySeparation == true then
    isRightArshaReservation = PaGlobalFunc_Guild_Authorization_RightCheck(__eGuildRightNew_Competition)
  else
    isRightArshaReservation = PaGlobalFunc_ArshaReservation_All_RightCheck(__eGuildRightType_Competition)
  end
  ...
  self._reservationSlot[dayIndex].txt_Date:SetText(PAGetStringParam1(Defines.StringSheet_GAME, "LUA_ARSHA_RESERVATION_DAY", "day", tostring(dayValue)))
  ...
  if nil == myGuildInfo or false == isRightArshaReservation or false == self._isArshaAvailable then
...
function PaGlobal_Arsha_Reservation_All:reservation(reservationIndex, isReservation)
  ...
  if false == isRightArshaReservation then
    if _ContentsGroup_GuildAuthoritySeparation == true then
