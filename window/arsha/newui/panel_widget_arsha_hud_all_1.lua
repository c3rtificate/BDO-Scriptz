function PaGlobal_Arsha_Hud_All:initialize()
  ...
  self._ui.txt_teamOneLeftTeamName:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMPETITIONGAME_TEAM_A"))
  self._ui.txt_teamOneRightTeamName = UI.getChildControl(self._ui.stc_teamOneHud, "StaticText_RightTeamName")
  self._ui.txt_teamOneRightTeamName:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMPETITIONGAME_TEAM_B"))
...
function PaGlobal_Arsha_Hud_All:setTimeForReplay(currentTime)
  ...
  if ToClient_IsNotUpdateReplayArshaTime() == true then
    return
  end
...
function PaGlobal_Arsha_Hud_All:setTimeForReplayEnd(currentTime)
  if false == ToClient_IsMyselfInArena() then
    PaGlobal_Arsha_Hud_All:close()
    return
  end
...
function PaGlobal_Arsha_Hud_All:setScoreForReplay(teamNum, scoreValue)
  ...
  PaGlobal_Arsha_Hud_All:showTargetScoreDot(ToClient_GetTargetScore(), tonumber(self._ui.txt_leftPoint:GetText()), tonumber(self._ui.txt_rightPoint:GetText()))
end
...
function PaGlobal_Arsha_Hud_All:registEventHandler()
  ...
  registerEvent("FromClient_ReplayArshaLimitTimeEnd", "FromClient_ReplayArshaLimitTimeEnd")
  ...
  registerEvent("FromClient_UpdateUIOnce_NotReloadUI", "FromClient_ArshaHud_UpdateUIOnce_NotReloadUI")
end
...
function PaGlobal_Arsha_Hud_All:changeTeamNameForReplay(redTeamName, blueTeamName)
  if nil == Panel_Widget_Arsha_Hud_All then
    return
  end
  local redName = redTeamName
  local blueName = blueTeamName
  ...
  self._ui.txt_leftTeam:SetText(redName)
  self._ui.txt_rightTeam:SetText(blueName)
end
