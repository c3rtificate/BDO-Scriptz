...
function PaGlobal_RepairFunc_All:controlAll_Init()
  ...
  self._ui.radio_btn[self._BTN_ENUM.REPAIRALL] = UI.getChildControl(Panel_Dialog_Repair_Function_All, "RadioButton_Function_AllRepair")
  self._ui.radio_btn[self._BTN_ENUM.SETREPAIRALL] = UI.getChildControl(Panel_Dialog_Repair_Function_All, "RadioButton_Function_SetAllRepair")
  self._ui.BTN_SetRepair = UI.getChildControl(self._ui.radio_btn[self._BTN_ENUM.REPAIRALL], "Button_Icon")
  self._ui.STC_AllRepair = UI.getChildControl(self._ui.radio_btn[self._BTN_ENUM.REPAIRALL], "StaticText_AllRepair")
  ...
  self._ui.radio_btn[self._BTN_ENUM.REPAIRALL]:SetTextMode(__eTextMode_AutoWrap)
  self._ui.radio_btn[self._BTN_ENUM.SETREPAIRALL]:SetTextMode(__eTextMode_AutoWrap)
  self._ui.STC_AllRepair:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui.radio_btn[self._BTN_ENUM.REPAIRALL]:SetText(self._ui.radio_btn[self._BTN_ENUM.REPAIRALL]:GetText())
  self._ui.radio_btn[self._BTN_ENUM.SETREPAIRALL]:SetText(self._ui.radio_btn[self._BTN_ENUM.SETREPAIRALL]:GetText())
  self._ui.STC_AllRepair:SetText(self._ui.STC_AllRepair:GetText())
  self._ui.BTN_SetRepair:SetPosX(self._ui.BTN_SetRepair:GetPosX() + self._ui.STC_AllRepair:GetTextSizeX() + 5 + (self._ui.STC_AllRepair:GetSizeX() - self._ui.STC_AllRepair:GetTextSizeX()) / 2)
...
function PaGlobal_RepairFunc_All:controlOtherPanel_Init()
  ...
  if false == _ContentsGroup_RenewUI_InventoryEquip then
    if true == _ContentsGroup_NewUI_Equipment_All then
      ...
      self._uibottomButtonAreaSizeX = PaGlobal_Equipment_All._ui.stc_bottomButtonArea:GetSizeX()
      self._uibottomButtonAreaSizeY = PaGlobal_Equipment_All._ui.stc_bottomButtonArea:GetSizeY()
    else
...
function PaGlobal_RepairFunc_All:prepareOpen(eType)
  ...
  if true == self._isConsole then
    if true == self._isCamping and -1 ~= self._equipmentIndex then
      self._currentTabIndex = 1
      PaGlobal_RepairFunc_All_MoveTab(self._equipmentIndex)
    else
      self._currentTabIndex = self._funcButtonCount
      PaGlobal_RepairFunc_All_MoveTab(1)
    end
  end
  Panel_Dialog_Repair_Function_All:EraseAllEffect()
  Panel_Dialog_Repair_Function_All:AddEffect("fUI_Servant_Dialog_01A", true, 0, 0)
...
function PaGlobal_RepairFunc_All:prepareClose()
  ...
  if nil ~= Panel_Window_SetupRepair_All and true == Panel_Window_SetupRepair_All:GetShow() then
...
function PaGlobal_RepairFunc_All:update(isShow)
  ...
  if false == _ContentsGroup_RenewUI_InventoryEquip then
    if false == isGameTypeKorea() then
      ...
      self._otherPanel._uiRepairInven:SetShow(false)
      self._otherPanel._uiRepairInvenMoney:SetShow(false)
      if false == _ContentsGroup_RenewUI then
        if true == _ContentsGroup_NewUI_Equipment_All then
          PaGlobalFunc_Equipment_All_SetFunctionButtonHide(not isShow)
          if true == false then
            PaGlobal_Equipment_All._ui.stc_bottomButtonArea:SetSize(PaGlobal_Equipment_All._ui.stc_bottomButtonArea:GetSizeX(), PaGlobal_Equipment_All._ui.stc_bottomButtonArea:GetSizeY() - self._otherPanel._uiRepairMessageBG:GetSizeY() - 10)
          else
            PaGlobal_Equipment_All._ui.stc_bottomButtonArea:SetSize(self._uibottomButtonAreaSizeX, self._uibottomButtonAreaSizeY)
          end
        else
  ...
  if true == self._isCamping then
    local canUseHorseRepair = _ContentsGroup_CampHorseEquipRepair
    self._ui.radio_btn[self._BTN_ENUM.HORSE]:SetIgnore(not canUseHorseRepair)
    ...
    self._ui.radio_btn[self._BTN_ENUM.HORSE]:SetShow(canUseHorseRepair)
    self._ui.radio_btn[self._BTN_ENUM.SHIP]:SetShow(false)
    self._ui.radio_btn[self._BTN_ENUM.GUILD]:SetShow(false)
  ...
  self._ui.radio_btn[self._BTN_ENUM.EQUIPMENT]:SetShow(false)
  self._ui.radio_btn[self._BTN_ENUM.INVENTORYALL]:SetShow(false)
  self._ui.radio_btn[self._BTN_ENUM.HORSE]:SetShow(false)
  self._ui.radio_btn[self._BTN_ENUM.SHIP]:SetShow(false)
  self._ui.radio_btn[self._BTN_ENUM.GUILD]:SetShow(false)
  self._ui.radio_btn[self._BTN_ENUM.REPAIRALL]:SetShow(true)
  if _ContentsGroup_UsePadSnapping == true then
    self._ui.BTN_SetRepair:SetShow(false)
    self._ui.STC_AllRepair:SetSpanSize(self._ui.BTN_SetRepair:GetSizeX() / 2, 0)
    self._ui.radio_btn[self._BTN_ENUM.SETREPAIRALL]:SetShow(true)
  else
    self._ui.BTN_SetRepair:SetShow(true)
    self._ui.radio_btn[self._BTN_ENUM.SETREPAIRALL]:SetShow(false)
  end
end
function PaGlobal_RepairFunc_All:validate()
  ...
  self._ui.radio_btn[self._BTN_ENUM.REPAIRALL]:isValidate()
  self._ui.BTN_SetRepair:isValidate()
...
function PaGlobal_RepairFunc_All:registEventHandler()
  ...
  registerEvent("FromClient_CompleteRepairMessage", "FromClient_RepairFunc_All_CompleteRepairMessage")
  ...
  self._ui.radio_btn[self._BTN_ENUM.REPAIRALL]:addInputEvent("Mouse_LUp", "HandleEventLUp_RepairFunc_All_RepairAll()")
  self._ui.STC_AllRepair:addInputEvent("Mouse_LUp", "HandleEventLUp_RepairFunc_All_RepairAll()")
  self._ui.BTN_SetRepair:addInputEvent("Mouse_LUp", "HandleEventLUp_RepairFunc_All_SetRepairAll()")
  self._ui.BTN_SetRepair:addInputEvent("Mouse_On", "HandleEventOnOut_RepairFunc_All_ShowToolTipSetupRepairAll(true)")
  self._ui.BTN_SetRepair:addInputEvent("Mouse_Out", "HandleEventOnOut_RepairFunc_All_ShowToolTipSetupRepairAll(false)")
end
function PaGlobal_RepairFunc_All:resize()
  ...
  if true == self._ui.radio_btn[self._BTN_ENUM.EQUIPMENT]:GetShow() then
    ...
    self._equipmentIndex = showCount
    showCount = showCount + 1
  end
  ...
  if true == self._ui.radio_btn[self._BTN_ENUM.REPAIRALL]:GetShow() then
    btnTable[showCount] = self._ui.radio_btn[self._BTN_ENUM.REPAIRALL]
    funcTable[showCount] = HandleEventLUp_RepairFunc_All_RepairAll
    self._equipmentIndex = showCount
    showCount = showCount + 1
  end
  if true == self._ui.radio_btn[self._BTN_ENUM.SETREPAIRALL]:GetShow() then
    btnTable[showCount] = self._ui.radio_btn[self._BTN_ENUM.SETREPAIRALL]
    funcTable[showCount] = HandleEventLUp_RepairFunc_All_SetRepairAll
    showCount = showCount + 1
  end
