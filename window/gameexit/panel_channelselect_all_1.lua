function PaGlobal_ChannelSelect_All:initialize()
  ...
  self._ui.stc_Icon_SeasonNewbieChannel = UI.getChildControl(Panel_ChannelSelect_All, "StaticText_SeasonNewbie")
  self._ui.stc_Icon_HadumChannel = UI.getChildControl(Panel_ChannelSelect_All, "StaticText_Hadum")
  self._ui.stc_Icon_GuildServer = UI.getChildControl(Panel_ChannelSelect_All, "StaticText_GuildServer")
  self._ui.stc_Icon_Exp_Plus = UI.getChildControl(Panel_ChannelSelect_All, "StaticText_Exp_Plus")
  self._ui.stc_Icon_ElfWar = UI.getChildControl(Panel_ChannelSelect_All, "StaticText_ElfWarServer")
  self._ui.stc_Icon_HardCoreChannel = UI.getChildControl(Panel_ChannelSelect_All, "StaticText_HardCoreServer")
  ...
  self._ui.txt_HadumTitle = UI.getChildControl(self._ui.stc_DescPanel, "StaticText_Hadum_Title")
  self._ui.txt_HadumDesc = UI.getChildControl(self._ui.stc_DescPanel, "StaticText_Hadum_Desc")
  ...
  self._ui.txt_ElfWar = UI.getChildControl(self._ui.stc_DescPanel, "StaticText_Channel_ElfWar")
  self._ui.txt_ElfWarDesc = UI.getChildControl(self._ui.stc_DescPanel, "StaticText_Channel_ElfWarDesc")
  self._ui.txt_ElfWar_Schedule = UI.getChildControl(self._ui.stc_DescPanel, "StaticText_Schedule_ElfWar")
  self._ui.txt_ElfWar_ScheduleDesc = UI.getChildControl(self._ui.stc_DescPanel, "StaticText_Schedule_ElfWarDesc")
  self._ui.txt_HardCoreChannel = UI.getChildControl(self._ui.stc_DescPanel, "StaticText_Channel_HardCoreChannel")
  self._ui.txt_HardCoreChannelDesc = UI.getChildControl(self._ui.stc_DescPanel, "StaticText_Channel_HardCoreChannelDesc")
  ...
  self._ui.stc_Icon_SeasonNewbieChannel:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_SEASONNEWBIE"))
  self._ui.stc_Icon_SeasonNewbieChannel:SetShow(false)
  self._ui.stc_Icon_HadumChannel:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_ICON_HADUM"))
  self._ui.stc_Icon_HadumChannel:SetShow(false)
  self._ui.stc_Icon_GuildServer:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_GUILDMAINSERVER_TITLE"))
  self._ui.stc_Icon_GuildServer:SetShow(false)
  self._ui.stc_Icon_Exp_Plus:SetShow(false)
  ...
  self._ui.txt_HadumTitle:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_SERVERSELECT_HADUM_TITLE"))
  if _ContentsGroup_HadumCalpheon == true then
    self._ui.txt_HadumDesc:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_SERVERSELECT_HADUM_DESC_CAL"))
  else
    self._ui.txt_HadumDesc:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_SERVERSELECT_HADUM_DESC"))
  end
  self._ui.txt_HadumTitle:SetShow(false)
  self._ui.txt_HadumDesc:SetShow(false)
  ...
  if nil ~= temporaryWrapper then
    ...
    if 0 == userType then
      ...
      self._ui.chk_ShowDesc:ChangeTextureInfoName("combine/icon/combine_basic_icon_00.dds")
  ...
  self._isQaModeForGM_XXX = false
  if temporaryWrapper ~= nil and 0 < temporaryWrapper:getTempChannelCountForQA_XXXXX() then
    self._isQaModeForGM_XXX = true
  end
  self:validate()
  self:registEventHandler()
  self:swichPlatform()
  self:createChannelUI()
  self:checkToOpenSpecialChannels()
  self:initServerDesc()
...
function PaGlobal_ChannelSelect_All:swichPlatform()
  ...
  if false == _ContentsGroup_RenewUI then
    ...
    self._ui.txt_HadumDesc:SetSize(self._ui.txt_HadumDesc:GetSizeX() + descSize, self._ui.txt_HadumDesc:GetSizeY())
    self._ui.txt_ElfWar:SetSize(self._ui.txt_ElfWar:GetSizeX() + descSize, self._ui.txt_ElfWar:GetSizeY())
    self._ui.txt_ElfWarDesc:SetSize(self._ui.txt_ElfWarDesc:GetSizeX() + descSize, self._ui.txt_ElfWarDesc:GetSizeY())
    self._ui.txt_ElfWar_Schedule:SetSize(self._ui.txt_ElfWar_Schedule:GetSizeX() + descSize, self._ui.txt_ElfWar_Schedule:GetSizeY())
    self._ui.txt_ElfWar_ScheduleDesc:SetSize(self._ui.txt_ElfWar_ScheduleDesc:GetSizeX() + descSize, self._ui.txt_ElfWar_ScheduleDesc:GetSizeY())
    self._ui.txt_HardCoreChannel:SetSize(self._ui.txt_HardCoreChannel:GetSizeX() + descSize, self._ui.txt_HardCoreChannel:GetSizeY())
    self._ui.txt_HardCoreChannelDesc:SetSize(self._ui.txt_HardCoreChannelDesc:GetSizeX() + descSize, self._ui.txt_HardCoreChannelDesc:GetSizeY())
...
function PaGlobal_ChannelSelect_All:createChannelUI()
  ...
  if true == _ContentsGroup_InstanceSiege then
    totalChannelCount = totalChannelCount + __eInstanceSiegeMode_Count
  end
  if instanceChannelCount <= totalChannelCount and false == ToClient_SelfPlayerIsGM() then
    totalChannelCount = totalChannelCount - instanceChannelCount
  end
  if ToClient_SelfPlayerIsGM() == true and self._isQaModeForGM_XXX == true then
    local temporaryWrapper = getTemporaryInformationWrapper()
    if temporaryWrapper ~= nil then
      totalChannelCount = totalChannelCount + temporaryWrapper:getTempChannelCountForQA_XXXXX()
    end
  end
  ...
  for idx = 0, totalChannelCount - 1 do
    do
      ...
      cloned_ChannelSlot._stc_EventChannel = UI.getChildControl(rdo_Channel, "Static_OlympicIcon")
      cloned_ChannelSlot._stc_SeasonNewbieChannel = UI.getChildControl(rdo_Channel, "Static_SeasonNewbie")
      cloned_ChannelSlot._stc_HadumChannel = UI.getChildControl(rdo_Channel, "Static_Hadum")
      cloned_ChannelSlot._stc_GuildServer = UI.getChildControl(rdo_Channel, "Static_GuildServer")
      cloned_ChannelSlot._stc_ExpPlus = UI.getChildControl(rdo_Channel, "Static_Exp_Plus")
      cloned_ChannelSlot._stc_ElfWar = UI.getChildControl(rdo_Channel, "Static_ElfWarServer")
      cloned_ChannelSlot._stc_HardCoreChannel = UI.getChildControl(rdo_Channel, "Static_HardCoreServer")
      cloned_ChannelSlot._stc_PersonalFieldState_Green = UI.getChildControl(rdo_Channel, "Static_PersonalField_Status_Green")
      cloned_ChannelSlot._stc_PersonalFieldState_Yellow = UI.getChildControl(rdo_Channel, "Static_PersonalField_Status_Yellow")
      cloned_ChannelSlot._stc_PersonalFieldState_Red = UI.getChildControl(rdo_Channel, "Static_PersonalField_Status_Red")
      cloned_ChannelSlot._stc_PersonalFieldState_Locked = UI.getChildControl(rdo_Channel, "Static_PersonalField_Status_Locked")
      if true == self._isChannelCountLow then
      ...
      local initShowValue = false
      if ToClient_SelfPlayerIsGM() == true and self._isQaModeForGM_XXX == true then
        initShowValue = true
      end
      cloned_ChannelSlot._bg:SetShow(initShowValue)
      cloned_ChannelSlot._stc_FriendInvite:SetShow(initShowValue)
      cloned_ChannelSlot._stc_CurrentChannelBg:SetShow(initShowValue)
      cloned_ChannelSlot._stc_CrossPlay:SetShow(initShowValue)
      cloned_ChannelSlot._stc_EventChannel:SetShow(initShowValue)
      cloned_ChannelSlot._stc_SeasonChannel:SetShow(initShowValue)
      cloned_ChannelSlot._stc_SeasonNewbieChannel:SetShow(initShowValue)
      cloned_ChannelSlot._stc_HadumChannel:SetShow(initShowValue)
      cloned_ChannelSlot._stc_GuildServer:SetShow(initShowValue)
      cloned_ChannelSlot._stc_ExpPlus:SetShow(initShowValue)
      cloned_ChannelSlot._stc_PersonalFieldState_Green:SetShow(initShowValue)
      cloned_ChannelSlot._stc_PersonalFieldState_Yellow:SetShow(initShowValue)
      cloned_ChannelSlot._stc_PersonalFieldState_Red:SetShow(initShowValue)
      cloned_ChannelSlot._stc_PersonalFieldState_Locked:SetShow(initShowValue)
      ...
      localFunc_PushTableWithSetShow(cloned_ChannelSlot._stc_EventChannel)
      localFunc_PushTableWithSetShow(cloned_ChannelSlot._stc_SeasonNewbieChannel)
      localFunc_PushTableWithSetShow(cloned_ChannelSlot._stc_HadumChannel)
      localFunc_PushTableWithSetShow(cloned_ChannelSlot._stc_GuildServer)
      localFunc_PushTableWithSetShow(cloned_ChannelSlot._stc_ExpPlus)
      localFunc_PushTableWithSetShow(cloned_ChannelSlot._stc_ElfWar)
      localFunc_PushTableWithSetShow(cloned_ChannelSlot._stc_HardCoreChannel)
...
function PaGlobal_ChannelSelect_All:alignDesc()
  ...
  if true == self._isHadumChannelOpen then
    descTable:push_back(self._ui.txt_HadumTitle)
    descTable:push_back(self._ui.txt_HadumDesc)
    self._ui.txt_HadumTitle:SetShow(true)
    self._ui.txt_HadumDesc:SetShow(true)
  else
    self._ui.txt_HadumTitle:SetShow(false)
    self._ui.txt_HadumDesc:SetShow(false)
  end
  ...
  if _ContentsGroup_ElfWar then
    descTable:push_back(self._ui.txt_ElfWar)
    descTable:push_back(self._ui.txt_ElfWarDesc)
    descTable:push_back(self._ui.txt_ElfWar_Schedule)
    descTable:push_back(self._ui.txt_ElfWar_ScheduleDesc)
    self._ui.txt_ElfWar:SetShow(true)
    self._ui.txt_ElfWarDesc:SetShow(true)
    self._ui.txt_ElfWar_Schedule:SetShow(true)
    self._ui.txt_ElfWar_ScheduleDesc:SetShow(true)
  else
    self._ui.txt_ElfWar:SetShow(false)
    self._ui.txt_ElfWarDesc:SetShow(false)
    self._ui.txt_ElfWar_Schedule:SetShow(false)
    self._ui.txt_ElfWar_ScheduleDesc:SetShow(false)
  end
  if _ContentsGroup_HardCoreChannel == true then
    descTable:push_back(self._ui.txt_HardCoreChannel)
    descTable:push_back(self._ui.txt_HardCoreChannelDesc)
    self._ui.txt_HardCoreChannel:SetShow(true)
    self._ui.txt_HardCoreChannelDesc:SetShow(true)
  else
    self._ui.txt_HardCoreChannel:SetShow(false)
    self._ui.txt_HardCoreChannelDesc:SetShow(false)
  end
  ...
  self._ui.txt_ChannelSelectDesc:SetText(PAGetStringParam1(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_CHANNELSELECTDESC", "minute", ToClient_GetChannelMoveWaitingTimeMinute()))
  ...
  if isGameTypeTH() or isGameTypeID() or isGameTypeASIA() then
  ...
  elseif true == _ContentsOption_CH_GameType or true == isTest then
    for idx = 1, #descTable do
      descTable[idx]:SetShow(false)
    end
...
function PaGlobal_ChannelSelect_All:createServerDesc()
  ...
  local isHadumChannelOpen = self._isHadumChannelOpen
  local warDesc = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_WARCHANNEL_DESC_KAMA")
  local descData = {
    [1] = {
      title = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_CHANNELSELECTTITLE"),
      desc = PAGetStringParam1(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_CHANNELSELECTDESC", "minute", ToClient_GetChannelMoveWaitingTimeMinute()),
      contentsOption = true
    },
    [2] = {
    ...
    [5] = {
      title = PAGetString(Defines.StringSheet_GAME, "LUA_SERVERSELECT_HADUM_TITLE"),
      desc = PAGetString(Defines.StringSheet_GAME, "LUA_SERVERSELECT_HADUM_DESC"),
      contentsOption = isHadumChannelOpen
    },
    [6] = {
    ...
    [8] = {
      title = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_ELFWARCHANNEL_SUB_TITLE"),
      desc = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_ELFWARCHANNEL_SUB_DESC"),
      contentsOption = _ContentsGroup_ElfWar == true
    },
    [9] = {
      title = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_ELFWARCHANNEL_DATE_SUB_TITLE"),
      desc = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_ELFWARCHANNEL_DATE_SUB_DESC"),
      contentsOption = _ContentsGroup_ElfWar == true
    },
    [10] = {
      title = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVER_SELECT_ARSHA_PVP834"),
      desc = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_PVPDESC834"),
      contentsOption = _ContentsGroup_PVPServer == true
    },
    [11] = {
      title = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVER_SELECT_HARDCORE_PVP"),
      desc = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SERVERSELECT_PVPDESC_HARDCORECHANNEL"),
      contentsOption = _ContentsGroup_HardCoreChannel == true
    }
  }
  if _ContentsGroup_HadumCalpheon == true then
    descData[5].desc = PAGetString(Defines.StringSheet_GAME, "LUA_SERVERSELECT_HADUM_DESC_CAL")
  end
  if isGameTypeTH() or isGameTypeID() or isGameTypeASIA() then
  ...
  elseif true == _ContentsOption_CH_GameType or true == isTest then
    ...
    descData[6].contentsOption = true
    descData[7].contentsOption = true
  elseif isGameTypeRussia() or isGameTypeEnglish() or isGameTypeJapan() or isGameTypeTR() or isGameTypeSA() or true == isTawan or true == isKorea then
...
function PaGlobal_ChannelSelect_All:checkToOpenSpecialChannels()
  local curChannelData = getCurrentChannelServerData()
  ...
  for ch_Index = 0, channelCount - 1 do
    ...
    if nil ~= serverData then
      if true == serverData._isSeasonNewbieChannel then
        self._isSeasonNewbieChannelOpen = true
      end
      if true == serverData._isHadumChannel then
        self._isHadumChannelOpen = true
      end
    end
  end
  if false == _ContentsGroup_SeasonContents then
    self._isSeasonNewbieChannelOpen = false
  end
end
function PaGlobal_ChannelSelect_All:alignBottomIcon()
  ...
  if true == self._isSeasonNewbieChannelOpen then
    bottomIconList:push_back(self._ui.stc_Icon_SeasonNewbieChannel)
    self._ui.stc_Icon_SeasonNewbieChannel:SetShow(true)
    isSeasonOpen = true
  else
    self._ui.stc_Icon_SeasonNewbieChannel:SetShow(false)
  end
  if _ContentsGroup_HadumField == false then
    if true == self._isHadumChannelOpen then
      bottomIconList:push_back(self._ui.stc_Icon_HadumChannel)
      self._ui.stc_Icon_HadumChannel:SetShow(true)
    else
      self._ui.stc_Icon_HadumChannel:SetShow(false)
    end
  end
  if true == _ContentsGroup_GuildServerWar then
    bottomIconList:push_back(self._ui.stc_Icon_GuildServer)
    self._ui.stc_Icon_GuildServer:SetShow(true)
  else
    self._ui.stc_Icon_GuildServer:SetShow(false)
  end
  if isSeasonOpen == true then
    bottomIconList:push_back(self._ui.stc_Icon_Exp_Plus)
    self._ui.stc_Icon_Exp_Plus:SetShow(true)
  else
    self._ui.stc_Icon_Exp_Plus:SetShow(false)
  end
  if _ContentsGroup_ElfWar == true then
    bottomIconList:push_back(self._ui.stc_Icon_ElfWar)
    self._ui.stc_Icon_ElfWar:SetShow(true)
  else
    self._ui.stc_Icon_ElfWar:SetShow(false)
  end
  if _ContentsGroup_HardCoreChannel == true then
    bottomIconList:push_back(self._ui.stc_Icon_HardCoreChannel)
    self._ui.stc_Icon_HardCoreChannel:SetShow(true)
  else
    self._ui.stc_Icon_HardCoreChannel:SetShow(false)
  end
  local gabX = 20
  local gabY = 10
  local startPosX = 15
  ...
  if true == _ContentsOption_CH_GameType or true == isGameTypeGT() then
    for idx = 1, #bottomIconList do
      bottomIconList[idx]:SetShow(false)
    end
  end
  local panelStartPosX = Panel_ChannelSelect_All:GetPosX()
  local panelEndPosY = panelStartPosX + Panel_ChannelSelect_All:GetSizeX() - 5
...
function PaGlobal_ChannelSelect_All:prepareOpen(isByPersonalField)
  if nil == Panel_ChannelSelect_All then
    return
  end
  local curChannelData = getCurrentChannelServerData()
  ...
  if self._useFrameDesc == true then
    isShowDesc = self._ui.frame_Desc:GetShow()
  else
    isShowDesc = self._ui.stc_DescPanel:GetShow()
  end
  if isShowDesc == true then
    HandleEventLUp_ChannelSelect_All_ToggleDesc()
  end
  self._elapsedTime = 0
...
function PaGlobal_ChannelSelect_All:update(isByPersonalField)
  local isGMClient = ToClient_IsGMClient() == true and _ContentsOption_CH_GameType == false
  local curChannelData = getCurrentChannelServerData()
  local curWorldData = getGameWorldServerDataByWorldNo(curChannelData._worldNo)
  local channelCount = getGameChannelServerDataCount(curChannelData._worldNo)
  ...
  local seasonNewbieServer = Array.new()
  local seasonArshaServer = Array.new()
  local seasonNormalServer = Array.new()
  local getEnteredNationString = ToClient_getEnteredNationString()
  local isTotalAccountVer2 = isUseTotalAccountVer2()
  if true == _ContentsGroup_SeasonContents then
    ...
    for ch_Index = 0, channelCount - 1 do
      ...
      if nil ~= serverData then
        ...
        if isTotalAccountVer2 == true then
          local getAccessNationServerString = serverData:getAccessibleNation()
          if ToClient_SelfPlayerIsGM() == false and getAccessNationServerString ~= "" and getEnteredNationString ~= getAccessNationServerString then
            canInsert = false
          end
        end
        if canInsert == true and true == serverData._isSeasonChannel then
          if true == serverData._isSeasonNewbieChannel then
            seasonNewbieServer:push_back(ch_Index)
          elseif true == serverData:isPVPServer() then
            seasonArshaServer:push_back(ch_Index)
          else
            seasonNormalServer:push_back(ch_Index)
          end
        end
      end
    end
    for seasonNewbieServer_Idx = 1, #seasonNewbieServer do
      self._serverIndexTable:push_back(seasonNewbieServer[seasonNewbieServer_Idx])
    end
    for seasonNormalServer_Idx = 1, #seasonNormalServer do
      self._serverIndexTable:push_back(seasonNormalServer[seasonNormalServer_Idx])
    end
    for seasonArshaServer_Idx = 1, #seasonArshaServer do
      self._serverIndexTable:push_back(seasonArshaServer[seasonArshaServer_Idx])
    end
  end
  for ch_Index = 0, channelCount - 1 do
    local serverData = getGameChannelServerDataByWorldNo(curChannelData._worldNo, ch_Index)
    if nil ~= serverData then
      ...
      if canInsert == true and serverData._isSeasonNewbieChannel == true and serverData._isSpeedChannel == false and serverData._isSeasonChannel == false then
  ...
  for ch_Index = 0, channelCount - 1 do
    ...
    if nil ~= serverData then
      ...
      if canInsert == true and serverData._isSpeedChannel == true then
        self._serverIndexTable:push_back(ch_Index)
      end
    end
  end
  if false == _ContentsGroup_RenewUI then
    for ch_Index = 0, channelCount - 1 do
      ...
      if nil ~= serverData then
        if isUseTotalAccountVer2() == true then
          local getAccessNationServerString = serverData:getAccessibleNation()
          if true == _ContentsGroup_SeasonContents then
            if (false == serverData._isInstanceChannel or ToClient_SelfPlayerIsGM() == true and _ContentsOption_CH_GameType == false) and serverData._isSpeedChannel == false and serverData._isSeasonChannel == false and serverData._isSeasonNewbieChannel == false then
              if ToClient_SelfPlayerIsGM() == true then
                self._serverIndexTable:push_back(ch_Index)
              elseif getAccessNationServerString == "" or getEnteredNationString == getAccessNationServerString then
                self._serverIndexTable:push_back(ch_Index)
              end
            end
          elseif (serverData._isInstanceChannel == false or ToClient_SelfPlayerIsGM() == true and _ContentsOption_CH_GameType == false) and serverData._isSpeedChannel == false and serverData._isSeasonNewbieChannel == false then
            if ToClient_SelfPlayerIsGM() == true then
              self._serverIndexTable:push_back(ch_Index)
            elseif getAccessNationServerString == "" or getEnteredNationString == getAccessNationServerString then
              self._serverIndexTable:push_back(ch_Index)
        ...
        elseif true == _ContentsGroup_SeasonContents then
          if (false == serverData._isInstanceChannel or ToClient_SelfPlayerIsGM() == true and _ContentsOption_CH_GameType == false) and serverData._isSpeedChannel == false and serverData._isSeasonChannel == false and serverData._isSeasonNewbieChannel == false then
            self._serverIndexTable:push_back(ch_Index)
          end
        elseif (false == serverData._isInstanceChannel or ToClient_SelfPlayerIsGM() == true and _ContentsOption_CH_GameType == false) and serverData._isSpeedChannel == false and serverData._isSeasonNewbieChannel == false then
          self._serverIndexTable:push_back(ch_Index)
        end
      end
    end
    ...
    for ch_Index = 0, channelCount - 1 do
      ...
      if nil ~= serverData then
        ...
        if _ContentsGroup_SeasonContents == true and serverData._isSeasonChannel == true or serverData._isSpeedChannel == true or serverData._isSeasonNewbieChannel == true then
          isInserted = true
        end
        if false == isInserted then
          if __ePlatformType_COUNT == serverData._servicePlatformType then
            if false == serverData._isInstanceChannel or ToClient_SelfPlayerIsGM() == true and _ContentsOption_CH_GameType == false then
  ...
  for ch_Index = 1, #self._serverIndexTable do
    ...
    if nil == _serverData then
      ...
      channelSlot._stc_PK:SetShow(_serverData:isPVPServer() and _serverData._isHardCoreChannel == false)
      channelSlot._stc_CrossPlay:SetShow(false)
      channelSlot._stc_ElfWar:SetShow(_serverData._elfWarGameNo == true and ToClient_GetElfWarState() == __eElfWar_Start)
      channelSlot._stc_HardCoreChannel:SetShow(_serverData._isHardCoreChannel == true)
      channelSlot._stc_PersonalFieldState_Green:SetShow(false)
      channelSlot._stc_PersonalFieldState_Yellow:SetShow(false)
      channelSlot._stc_PersonalFieldState_Red:SetShow(false)
      channelSlot._stc_PersonalFieldState_Locked:SetShow(false)
      if _serverData._isSpeedChannel == true then
        channelSlot._stc_ExpEvent:SetShow(true)
      end
      if _serverData._isSeasonNewbieChannel == true and _serverData._isSpeedChannel == false and _serverData._isSeasonChannel == false then
        channelSlot._stc_ExpEvent:SetShow(true)
      end
      if true == _ContentsGroup_RenewUI then
      ...
      if true == _ContentsGroup_SeasonContents and true == _serverData._isSeasonChannel then
        if true == _serverData._isSeasonNewbieChannel then
          channelSlot._stc_SeasonNewbieChannel:SetShow(true)
        else
          channelSlot._stc_SeasonChannel:SetShow(true)
        end
        channelSlot._stc_ExpPlus:SetShow(true)
      else
        channelSlot._stc_SeasonChannel:SetShow(false)
        channelSlot._stc_SeasonNewbieChannel:SetShow(false)
      end
      channelSlot._stc_EventChannel:SetShow(false)
      if _ContentsGroup_HadumField == false then
        if true == _serverData._isHadumChannel then
          channelSlot._stc_HadumChannel:SetShow(true)
        else
          channelSlot._stc_HadumChannel:SetShow(false)
        end
      end
      local guildWrapper = ToClient_GetMyGuildInfoWrapper()
      local guildMainServerGroupNo = 0
      ...
      if nil ~= guildWrapper then
        ...
        guildMainServerGroupNo = guildWrapper:getGuildMainServerGroupNo()
        if 0 ~= _serverData._guildServerGroupNo and _serverData._guildServerGroupNo == guildMainServerGroupNo and false == isVolunteer then
          channelSlot._stc_GuildServer:SetShow(true)
        else
          channelSlot._stc_GuildServer:SetShow(false)
        end
      end
      ...
      if _serverData._isSpeedChannel then
        if 0 ~= tempWrapper:getMyAdmissionToSpeedServer() and false == isGMClient and false == _ContentsGroup_isConsolePadControl then
      ...
      elseif _serverData._isBalanceChannel then
        if false == ToClient_isAccessableBalanceChannel() and false == isGMClient then
          channelSlot._bg:SetIgnore(true)
        end
      elseif _serverData._isPcroomChannel and false == ToClient_isAccessablePcRoomChannel() and false == isGMClient then
        channelSlot._bg:SetIgnore(true)
      end
      ...
      if true == isSiegeBeing and false == isInSiegeBattle then
        isAdmission = true
      elseif 0 ~= guildMainServerGroupNo and curChannelData._guildServerGroupNo == guildMainServerGroupNo and _serverData._guildServerGroupNo == guildMainServerGroupNo and false == isVolunteer then
        isAdmission = true
      elseif true == _ContentsGroup_PcRoomBenefitCoolTime and true == curChannelData._isPcroomChannel and true == _serverData._isPcroomChannel then
        isAdmission = true
      ...
      if curChannelData._worldNo == _serverData._worldNo and curChannelData._serverNo == _serverData._serverNo then
        ...
        channelSlot._bg:addInputEvent("Mouse_LUp", "HandleEventLUp_ChannelSelect_All_SelectChannel(" .. ch_Index .. "," .. tostring(isByPersonalField) .. ")")
      ...
      for idx = 1, #iconTable do
        if nil ~= iconTable[idx] and true == iconTable[idx]:GetShow() then
          ...
          if false == self._isConsole then
            ...
            iconTable[idx]:SetIgnore(true)
          end
        end
      end
      if true == isByPersonalField then
        channelSlot._txt_Status:SetText("")
        local serverState = __ePersonalFieldServerState_NoEntry
        if true == isPrepereToStop or true == isMaintanance or true == isBeingWar or true == _serverData._isSiegeChannel or true == _serverData:isPVPServer() or true == _serverData._isInstanceChannel then
          serverState = __ePersonalFieldServerState_NoEntry
        else
          serverState = ToClient_GetPersonalFieldServerState(_serverData._serverNo)
        end
        if __ePersonalFieldServerState_NoEntry == serverState then
          channelSlot._stc_PersonalFieldState_Locked:SetShow(true)
          channelSlot._stc_PersonalFieldState_Locked:addInputEvent("Mouse_On", "HandleEventOnOut_ChannelSelect_All_SetShowPersonalFieldStateTooltip(true," .. tostring(ch_Index) .. "," .. tostring(serverState) .. ")")
          channelSlot._stc_PersonalFieldState_Locked:addInputEvent("Mouse_Out", "HandleEventOnOut_ChannelSelect_All_SetShowPersonalFieldStateTooltip(false)")
        elseif __ePersonalFieldServerState_Free == serverState then
          channelSlot._stc_PersonalFieldState_Green:SetShow(true)
          channelSlot._stc_PersonalFieldState_Green:addInputEvent("Mouse_On", "HandleEventOnOut_ChannelSelect_All_SetShowPersonalFieldStateTooltip(true," .. tostring(ch_Index) .. "," .. tostring(serverState) .. ")")
          channelSlot._stc_PersonalFieldState_Green:addInputEvent("Mouse_Out", "HandleEventOnOut_ChannelSelect_All_SetShowPersonalFieldStateTooltip(false)")
        elseif __ePersonalFieldServerState_Busy == serverState then
          channelSlot._stc_PersonalFieldState_Yellow:SetShow(true)
          channelSlot._stc_PersonalFieldState_Yellow:addInputEvent("Mouse_On", "HandleEventOnOut_ChannelSelect_All_SetShowPersonalFieldStateTooltip(true," .. tostring(ch_Index) .. "," .. tostring(serverState) .. ")")
          channelSlot._stc_PersonalFieldState_Yellow:addInputEvent("Mouse_Out", "HandleEventOnOut_ChannelSelect_All_SetShowPersonalFieldStateTooltip(false)")
        else
          channelSlot._stc_PersonalFieldState_Red:SetShow(true)
          channelSlot._stc_PersonalFieldState_Red:addInputEvent("Mouse_On", "HandleEventOnOut_ChannelSelect_All_SetShowPersonalFieldStateTooltip(true," .. tostring(ch_Index) .. "," .. tostring(serverState) .. ")")
          channelSlot._stc_PersonalFieldState_Red:addInputEvent("Mouse_Out", "HandleEventOnOut_ChannelSelect_All_SetShowPersonalFieldStateTooltip(false)")
        end
      end
    end
  end
  if true == _ContentsGroup_InstanceSiege and (nil == isByPersonalField or false == isByPersonalField) then
    local isInstanceServerWarBeing = false
    for ch_Index = 0, channelCount - 1 do
      local serverData = getGameChannelServerDataByWorldNo(curChannelData._worldNo, ch_Index)
      if nil ~= serverData and true == serverData._isInstanceChannel and true == _serverData._isSiegeBeing then
        isInstanceServerWarBeing = true
        break
      end
    end
    local isInInstance = false
    local enterInstanceFieldKey = ToClient_GetEnterToInstanceFieldKey()
    if true == enterInstanceFieldKey:isDefined() then
      isInInstance = true
    end
    local ch_idx = #self._serverIndexTable + 1
    for mode = 0, __eInstanceSiegeMode_Count do
      local channelSlot = self._channelSelectUIPool[ch_idx - 1]
      if nil == channelSlot then
        UI.ASSERT_NAME(false, "instanceSiegeField \236\158\133\236\158\165 \235\178\132\237\138\188 \236\131\157\236\132\177\236\151\144 \237\149\132\236\154\148\237\149\156 channelSlot\236\157\180 nil\236\158\133\235\139\136\235\139\164. idx = " .. tostring(ch_idx - 1), "\236\161\176\234\180\145\235\175\188")
        break
      end
      local instanceSiegeFieldCount = ToClient_GetInstanceFieldTypeInfoCount(__eInstanceContentsType_Siege, mode)
      if instanceSiegeFieldCount > 0 then
        channelSlot._bg:SetShow(true)
        channelSlot._txt_Status:SetText("")
        channelSlot._stc_WarIcon:SetShow(isInstanceServerWarBeing)
        channelSlot._stc_Maintenance:SetShow(false)
        channelSlot._stc_PrepareToStop:SetShow(false)
        channelSlot._stc_ExpEvent:SetShow(false)
        channelSlot._stc_Premium:SetShow(false)
        channelSlot._stc_PK:SetShow(false)
        channelSlot._stc_CrossPlay:SetShow(false)
        channelSlot._stc_FriendInvite:SetShow(false)
        channelSlot._stc_SeasonChannel:SetShow(false)
        channelSlot._stc_SeasonNewbieChannel:SetShow(false)
        ...
        channelSlot._stc_SeasonCoolTime:SetShow(false)
        channelSlot._stc_NormalCoolTime:SetShow(false)
        channelSlot._stc_ExpPlus:SetShow(false)
        channelSlot._bg:addInputEvent("Mouse_LUp", "")
        channelSlot._bg:addInputEvent("Mouse_On", "")
        channelSlot._bg:addInputEvent("Mouse_Out", "")
        channelSlot._bg:SetIgnore(false)
        local channelName = self._instanceSiegeModeName[mode]
        if nil == channelName then
          channelName = ""
        end
        channelSlot._txt_Title:SetText(channelName)
        if true == isInInstance then
          channelSlot._bg:SetIgnore(true)
          if enterInstanceFieldKey:getType() == __eInstanceContentsType_Siege and enterInstanceFieldKey:getMode() == mode then
            channelSlot._stc_CurrentChannelBg:SetShow(true)
          end
        else
          channelSlot._bg:addInputEvent("Mouse_LUp", "HandleEventLUp_ChannelSelect_All_SelectInstanceSiege(" .. mode .. "," .. ch_idx .. ")")
          channelSlot._stc_CurrentChannelBg:SetShow(false)
        end
        local iconTable = channelSlot._IconTable
        local setCount = 1
        ...
        for idx = 1, #iconTable do
          if nil ~= iconTable[idx] and true == iconTable[idx]:GetShow() then
            ...
            setCount = setCount + 1
            if false == self._isConsole then
              iconTable[idx]:addInputEvent("Mouse_On", "HandleEventOnOut_ChannelSelect_All_ServerSlotIcon_Tooltip(" .. idx .. "," .. ch_idx - 1 .. ")")
              iconTable[idx]:addInputEvent("Mouse_Out", "HandleEventOnOut_ChannelSelect_All_ServerSlotIcon_Tooltip()")
            end
          end
        end
...
function PaGlobal_ChannelSelect_All:prepareClose()
  ...
  self._isWithCharacterSwap = false
  TooltipSimple_Hide()
...
function PaGlobal_ChannelSelect_All:validate()
  ...
  self._ui.stc_Icon_ElfWar:isValidate()
  self._ui.stc_Icon_HardCoreChannel:isValidate()
  ...
  self._ui.txt_ElfWar:isValidate()
  self._ui.txt_ElfWarDesc:isValidate()
  self._ui.txt_ElfWar_Schedule:isValidate()
  self._ui.txt_ElfWar_ScheduleDesc:isValidate()
  self._ui.txt_HardCoreChannel:isValidate()
  self._ui.txt_HardCoreChannelDesc:isValidate()
