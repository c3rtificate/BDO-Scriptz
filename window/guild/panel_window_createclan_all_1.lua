...
function PaGlobal_CreateClan_All:setButtonClick()
  ...
  PaGlobal_CreateClan_All._ui.btn_clan:SetShow(false)
  ...
  PaGlobal_CreateClan_All._ui.btn_guild:SetSize(PaGlobal_CreateClan_All._ui.btn_clan:GetSizeX() * 2, PaGlobal_CreateClan_All._ui.btn_guild:GetSizeY())
  local guildIcon = UI.getChildControl(PaGlobal_CreateClan_All._ui.btn_guild, "Static_GuildIcon")
  guildIcon:SetHorizonCenter()
  PaGlobal_CreateClan_All._ui.btn_guild:SetHorizonCenter()
  if false == PaGlobal_CreateClan_All._isConsole then
