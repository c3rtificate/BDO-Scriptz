function PaGlobal_GuildReward_All:initialize()
  ...
  local stc_desc = UI.getChildControl(stc_RewardBG, "Static_Desc")
  self._ui._txt_desc = UI.getChildControl(stc_desc, "StaticText_Desc")
  self._ui._txt_desc:SetTextMode(__eTextMode_AutoWrap)
  local txt_desc = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_MININGREWARD_DESC")
...
function PaGlobalFunc_GuildReward_List2EventControlCreate(list_content, key)
  ...
  stc_TimeValue:SetPosX(stc_RewardTime:GetPosX() + stc_RewardTime:GetTextSizeX() + 5)
