function PaGlobal_MiningFuel_All:initialize()
  ...
  local diffSize = stc_TextDesc:GetTextSizeY() - stc_Desc:GetSizeY()
  if diffSize > 0 then
    local addSize = diffSize + 10
    stc_Desc:SetSize(stc_Desc:GetSizeX(), stc_Desc:GetSizeY() + addSize)
    stc_TextDesc:SetSize(stc_TextDesc:GetSizeX(), stc_TextDesc:GetSizeY() + addSize)
    stc_TextDesc:ComputePos()
    Panel_Guild_MiningFuel_All:SetSize(Panel_Guild_MiningFuel_All:GetSizeX(), Panel_Guild_MiningFuel_All:GetSizeY() + addSize)
    self._ui_pc.btn_Reward:SetPosY(Panel_Guild_MiningFuel_All:GetSizeY() - 100)
  end
