...
function PaGlobal_GuildBattle_SelectAttend:Initialize()
  ...
  ui._list_GuildMembers:registEvent(__ePAUIList2EventType_LuaChangeContent, "CreateListContent_GuildBattle_AttendMember")
  ui._list_GuildMembers:createChildContent(__ePAUIList2ElementManagerType_List)
end
