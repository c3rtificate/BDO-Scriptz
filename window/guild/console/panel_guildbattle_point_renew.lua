PaGlobal_GuildBattlePoint = {
  ...
  _txt_TeamBlack = UI.getChildControl(Panel_GuidlBattle_Point, "StaticText_MyTeamBlack"),
  _txt_TeamRed = UI.getChildControl(Panel_GuidlBattle_Point, "StaticText_MyTeamRed"),
  _txt_RingoutCheck = UI.getChildControl(Panel_GuidlBattle_Point, "StaticText_RingoutTimeCheck"),
  _guildAPoint = nil,
  _guildBPoint = nil,
  _round = {},
  _perFrmaeTimer = 0,
...
function PaGlobal_GuildBattlePoint:setAttendName(teamNo)
  ...
  attendClass:ChangeTextureInfoName(classSymbomInfo.path)
  local x1, y1, x2, y2 = setTextureUV_Func(attendClass, classSymbomInfo.x1, classSymbomInfo.y1, classSymbomInfo.x2, classSymbomInfo.y2)
