function PaGlobal_GuildApplyJoinList:init()
  ...
  self._ui._stc_KeyGuideBG = UI.getChildControl(Panel_Guild_ApplyJoinList, "Static_KeyGuide_Console")
...
function PaGlobal_GuildApplyJoinList:requestDeleteApplicant(index)
  ...
  local wrapper = ToClient_getUserGuildApplicantWrapper(index)
  if nil == wrapper then
    return
  end
