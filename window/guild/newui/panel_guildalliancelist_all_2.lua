...
function FromClient_GuildAlliance_All_List2MemberUpdate(content, key)
  ...
  elseif __eGuildMemberGradeScribe == grade then
    stc_gradeIcon:ChangeTextureInfoName("Combine/Etc/Combine_Etc_Guild_00.dds")
    x1, y1, x2, y2 = setTextureUV_Func(stc_gradeIcon, 500, 44, 543, 70)
    gradeTooltipType = 8
  elseif __eGuildMemberGradeChiefOfStaff == grade then
    stc_gradeIcon:ChangeTextureInfoName("Combine/Etc/Combine_Etc_Guild_00.dds")
    x1, y1, x2, y2 = setTextureUV_Func(stc_gradeIcon, 500, 114, 543, 140)
    gradeTooltipType = 9
  elseif __eGuildMemberGradeMissionOfficer == grade then
    stc_gradeIcon:ChangeTextureInfoName("Combine/Etc/Combine_Etc_Guild_00.dds")
    x1, y1, x2, y2 = setTextureUV_Func(stc_gradeIcon, 500, 141, 543, 167)
    gradeTooltipType = 10
  else
    x1, y1, x2, y2 = setTextureUV_Func(stc_gradeIcon, 468, 219, 511, 245)
  end
