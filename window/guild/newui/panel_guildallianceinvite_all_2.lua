...
function HandleEventLUp_GuildAllianceInvite_All_AddGuildInfo(index)
  ...
  if PaGlobal_GuildAllianceInvite_All._curMemberCount + PaGlobal_GuildAllianceInvite_All._minMemberCount > PaGlobal_GuildAllianceInvite_All._maxAllianceMemberCount then
...
function HandleEventLUp_GuildAllianceInvite_All_MemberCountClick(index)
  PaGlobal_GuildAllianceInvite_All._selectedGuildInfoIdx = index
  local maxLimitMemberCount = PaGlobal_GuildAllianceInvite_All._maxAllianceMemberCount - (PaGlobal_GuildAllianceInvite_All._curMemberCount - PaGlobal_GuildAllianceInvite_All._memberCount[index])
  if maxLimitMemberCount > PaGlobal_GuildAllianceInvite_All._maxMemberCount then
    maxLimitMemberCount = PaGlobal_GuildAllianceInvite_All._maxMemberCount
  end
