...
function PaGlobalFunc_AgreementGuildMaster_RightCheck(eRightType, memberIdx, requesterMemberGrade)
  ...
  if memberInfo:isSelf() == true and (requesterMemberGrade == __eGuildMemberGradeAdviser or requesterMemberGrade == __eGuildMemberGradeScribe or requesterMemberGrade == __eGuildMemberGradeChiefOfStaff) then
    return true
  end
