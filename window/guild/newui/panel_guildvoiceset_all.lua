...
function PaGlobal_GuildVoiceSet_All:update()
  ...
  if _ContentsGroup_GuildAuthoritySeparation == false then
    isRightVoiceSet = PaGlboalFunc_GuildVoiceSet_All_GetRightCheck(__eGuildRightType_VoiceForceSet)
  end
  ...
  if true == isRightVoiceSet and 0 ~= memberGrade then
...
function PaGlboalFunc_GuildVoiceSet_All_GetRightCheck(eRightType)
  ...
  local function OriginalCheck()
    ...
    if __eGuildRightType_VoiceForceSet == eRightType then
      return isMasters
    end
    return false
  end
