...
function PaGlobal_GuildMemberInfo_All:initialize()
  ...
  local bottomBg = UI.getChildControl(Panel_Guild_MemberInfo_All, "Static_BottomBg")
  self._ui.stc_keyGuideB = UI.getChildControl(bottomBg, "StaticText_B_ConsoleUI")
  PaGlobalFunc_ConsoleKeyGuide_SetAlign({
    self._ui.stc_keyGuideB
  }, bottomBg, CONSOLEKEYGUID_ALIGN_TYPE.eALIGN_TYPE_RIGHT)
