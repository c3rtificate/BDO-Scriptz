...
function PaGlobalFunc_Guild_Manufacture_All_Start(index)
  local isRightManufacture = false
  if _ContentsGroup_GuildAuthoritySeparation == true then
    isRightManufacture = PaGlobalFunc_Guild_Authorization_RightCheck(__eGuildRightNew_Manufacture)
  else
    isRightManufacture = PaGlobalFunc_GuildManufacture_All_RightCheck(__eGuildRightType_GuildHouseCraft)
  end
  if true == isRightManufacture then
    ToClient_Guild_Manufacture_Start(index, PaGlobal_Guild_Manufacture_All._slot[index]._productItemEnchantKey)
  elseif _ContentsGroup_GuildAuthoritySeparation == true then
    PaGlobalFunc_Guild_Authorization_ShowErrMessage(__eGuildRightNew_Manufacture)
  else
...
function PaGlobalFunc_GuildManufacture_All_RightCheck(eRightType)
