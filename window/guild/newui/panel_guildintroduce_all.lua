...
function PaGlobal_GuildIntroduce_All:initialize()
  ...
  self._ui.edit_IntroduceCover = UI.getChildControl(self._ui.stc_MainBg, "MultilineEdit_CoverBox")
...
function PaGlobal_GuildIntroduce_All:registerEvent()
  if false == self._isConsole then
    self._ui.edit_IntroduceCover:addInputEvent("Mouse_LUp", "PaGlobalFunc_GuildIntroduce_EditName()")
    ...
    self._ui.edit_IntroduceCover:addInputEvent("Mouse_On", "HandleEventOnOut_GuildIntroduce_Tooltip(false)")
  else
...
function PaGlobalFunc_GuildIntroduce_Open()
  ...
  local isRightIntroduce = false
  if _ContentsGroup_GuildAuthoritySeparation == true then
    isRightIntroduce = PaGlobalFunc_Guild_Authorization_RightCheck(__eGuildRightNew_Promotion)
  else
    isRightIntroduce = PaGlobalFunc_GuildIntroduce_All_RightCheck(__eGuildRightType_Introduction)
  end
  PaGlobal_GuildIntroduce_All._isMaster = isRightIntroduce
  if false == isRightIntroduce then
    PaGlobal_GuildIntroduce_All._ui.edit_IntroduceCover:SetIgnore(true)
    PaGlobal_GuildIntroduce_All._ui.txt_Title:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_GUILD_INTRODUCETITLE"))
  else
    PaGlobal_GuildIntroduce_All._ui.edit_IntroduceCover:SetIgnore(false)
...
function PaGlobalFunc_GuildIntroduce_All_RightCheck(eRightType)
