PaGlobal_GuildQuest_All = {
  _ui = {
    ...
    stc_ArbitratioBG = nil,
    txt_ArbitrationQuestTime = nil,
    txt_ArbitrationQuestName = nil,
    txt_ArbitrationQuestCondition = nil,
    txt_ArbitrationDesc = nil,
    txt_ArbitrationTitle = nil,
    btn_GiveUp = nil,
    btn_Complete = nil,
