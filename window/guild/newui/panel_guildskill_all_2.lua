...
function InputEventLUp_GuildSkill_All_LearnSkill(skillNo)
  ...
  local isRightLearnSkill = false
  if _ContentsGroup_GuildAuthoritySeparation == true then
    isRightLearnSkill = PaGlobalFunc_Guild_Authorization_RightCheck(__eGuildRightNew_GuildSkill)
  else
    isRightLearnSkill = PaGlobalFunc_GuildSkill_All_RightCheck(__eGuildRightType_LearnGuildSkill)
  end
