function PaGlobal_GuildAllianceInvite_All:initialize()
  ...
  if true == _ContentsGroup_AllianceMemberMaxChange then
    self._maxAllianceMemberCount = 150
  else
    self._maxAllianceMemberCount = 100
  end
...
function PaGlobal_GuildAllianceInvite_All:changeMiniDesc()
  local maxMember = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_GUILDALLIANCEINFO_GUILD_LIMIT_MEMBER_COUNT_TITLE_TEXT") .. " (" .. self._curMemberCount .. "/" .. self._maxAllianceMemberCount .. ")  "
