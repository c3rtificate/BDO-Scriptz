...
GuildListInfoPage = {
  ...
  _frameDefaultBG = nil,
  _buttonListBG = nil,
  btn_GuildMasterMandateBG = nil,
  btn_GuildMasterMandate = nil,
  listInfoTitleBG = nil,
...
PaGlobal_GuildIncentive = {
  incentive_InputMoney = nil,
  btn_incentive_Send = nil,
  btn_incentive_Cancle = nil,
  btn_incentive_Help = nil,
  txt_incentive_Title = nil,
  txt_incentive_Deposit = nil,
  txt_incentive_Notify = nil
}
local tempGuildList = {}
...
function _guildListInfoPage_titleTooltipShow(isShow, titleType)
  ...
  elseif 5 == titleType then
    ...
    desc = PAGetStringParam4(Defines.StringSheet_GAME, descStr, "grade1", tostring(siegeGradeCount.grade1), "grade2", tostring(siegeGradeCount.grade2), "grade3", tostring(siegeGradeCount.grade3), "grade4", tostring(siegeGradeCount.grade4))
  end
...
function _guildListInfoPage_MandateTooltipShow(isShow, titleType, controlIdx)
  ...
  elseif PaGlboalFunc_GuildMemberList_All_GetRightCheck ~= nil then
...
function GuildListInfoPage:initialize()
  ...
  self._frameDefaultBG = UI.getChildControl(Panel_Window_Guild, "Static_Frame_ListBG")
  self._buttonListBG = UI.getChildControl(Panel_Guild_List, "Static_FunctionBG")
  self.btn_GuildMasterMandateBG = UI.getChildControl(Panel_Window_Guild, "Static_InfoArea")
  self.btn_GuildMasterMandate = UI.getChildControl(self.btn_GuildMasterMandateBG, "Button_GuildMandate")
  ...
  GuildListInfoPage._btnGiveIncentive:SetTextMode(__eTextMode_LimitText)
  GuildListInfoPage._btnDeposit:SetTextMode(__eTextMode_LimitText)
  GuildListInfoPage._btnPaypal:SetTextMode(__eTextMode_LimitText)
  GuildListInfoPage._btnSiegeReward:SetTextMode(__eTextMode_LimitText)
  GuildListInfoPage._btnWelfare:SetTextMode(__eTextMode_LimitText)
  function createListInfo(pIndex)
    local rtGuildListInfo = {}
    rtGuildListInfo._grade = UI.createControl(__ePAUIControl_StaticText, self._contentGuildList, "StaticText_Grade_" .. pIndex)
    rtGuildListInfo._level = UI.createControl(__ePAUIControl_StaticText, self._contentGuildList, "StaticText_Level_" .. pIndex)
    rtGuildListInfo._class = UI.createControl(__ePAUIControl_StaticText, self._contentGuildList, "StaticText_Class_" .. pIndex)
    rtGuildListInfo._charName = UI.createControl(__ePAUIControl_StaticText, self._contentGuildList, "StaticText_CharName_" .. pIndex)
    rtGuildListInfo._contributedTendency = UI.createControl(__ePAUIControl_StaticText, self._contentGuildList, "StaticText_ContributedTendency_" .. pIndex)
    rtGuildListInfo._activity = UI.createControl(__ePAUIControl_StaticText, self._contentGuildList, "StaticText_Activity_" .. pIndex)
    rtGuildListInfo._contractBtn = UI.createControl(__ePAUIControl_Button, self._contentGuildList, "Button_C_Contract_" .. pIndex)
    rtGuildListInfo._guardHim = UI.createControl(__ePAUIControl_Static, self._contentGuildList, "Static_C_GuardHim_" .. pIndex)
    ...
    if true == isVoiceOpen then
      rtGuildListInfo._saying = UI.createControl(__ePAUIControl_Button, self._contentGuildList, "StaticText_Saying_" .. pIndex)
      rtGuildListInfo._listening = UI.createControl(__ePAUIControl_Button, self._contentGuildList, "StaticText_Listening_" .. pIndex)
    ...
    if isWarGradeOpen then
      rtGuildListInfo._warGradeBtn = UI.createControl(__ePAUIControl_Button, self._contentGuildList, "Button_C_WarGrade_" .. pIndex)
      ...
      rtGuildListInfo._warStateBtn = UI.createControl(__ePAUIControl_Button, self._contentGuildList, "Button_C_WarState" .. pIndex)
  ...
  function createListInfoButton(pIndex)
    ...
    local rtGuildListInfoButton = UI.createControl(__ePAUIControl_Button, self._buttonListBG, "Guild_Menu_Button_" .. pIndex)
...
function GuildListInfoPage:registEventHandler()
  if nil == Panel_Guild_List then
    return
  end
...
function GuildListInfoPage:registMessageHandler()
end
...
function HandleCLicked_AgreementGuildMaster()
  ...
  local self = GuildListInfoPage
  if true == PaGlobal_AgreementGuildMaster_GetShow() then
...
function HandleCLicked_GuildListIncentive_Open()
  ...
  PaGlobal_GuildIncentive_CheckLoadUI()
  PaGlobal_GuildIncentive.incentive_InputMoney:SetEditText("", true)
  PaGlobal_GuildIncentive.txt_incentive_Title:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_GUILDLIST_INCENTIVE_TITLE"))
  PaGlobal_GuildIncentive.txt_incentive_Deposit:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_GUILDLIST_INCENTIVE_DEPOSIT"))
  PaGlobal_GuildIncentive.txt_incentive_Notify:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_GUILDLIST_INCENTIVE_NOTIFY"))
end
function HandleCLicked_GuildListIncentive_Deposit()
  ...
  PaGlobal_GuildIncentive_CheckLoadUI()
  PaGlobal_GuildIncentive.incentive_InputMoney:SetEditText(maxInputValue_s64, true)
  PaGlobal_GuildIncentive.txt_incentive_Title:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_GUILDLIST_DEPOSIT_TITLE"))
  PaGlobal_GuildIncentive.txt_incentive_Deposit:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_GUILDLIST_DEPOSIT_DEPOSIT"))
  PaGlobal_GuildIncentive.txt_incentive_Notify:SetText(PAGetStringParam1(Defines.StringSheet_GAME, "LUA_GUILDLIST_DEPOSIT_NOTIFY", "maxInput", makeDotMoney(maxInputValue_s64)))
end
  ...
  if true == myGuildMemberInfo:isSelf() then
    ...
    if true == isGuildMaster or true == isGuildSubMaster then
      local function handle_SendForceState()
        ...
        ToClient_VoiceChatChangeState(__eVoiceChatType_Guild, tempGuildList[index + 1].userNo, false, isListening, true)
      end
...
function HandleClicked_VoiceChatListening()
  ...
  ToClient_VoiceChatChangeState(__eVoiceChatType_Guild, myGuildMemberInfo:getUserNo(), isSaying, isListening, not isSelf)
...
function HandleClickedGuildMenuButton(index)
  ...
  elseif _UI_Menu_Button.Type_PriceLimit == index then
    PaGlobalFunc_GuildUseFund_All_ShowToggle(_selectIndex, true)
    return
  else
...
function GuildListInfoPage:UpdateData()
  ...
  for index = 0, memberCount - 1 do
    ...
    if true == myGuildMemberInfo:isSelf() or userNo == myUserNo then
      ...
      GuildListInfoPage.btn_GuildMasterMandate:addInputEvent("Mouse_LUp", "HandleClicked_GuildMasterMandate( " .. index .. " )")
      _myindex = index
  ...
  if not self.notice_title:GetShow() then
    GuildMainInfo_Hide()
  end
  self._frameGuildList:UpdateContentScroll()
  self._frameGuildList:UpdateContentPos()
...
function HandleClicked_SetIncentive()
  ...
  SetFocusEdit(PaGlobal_GuildIncentive.incentive_InputMoney)
  inputGuildDepositNum_s64 = toInt64(0, 0)
  PaGlobal_GuildIncentive.incentive_InputMoney:SetEditText("", true)
  PaGlobal_GuildIncentive.incentive_InputMoney:SetNumberMode(true)
end
function FGlobal_GuildIncentive_Close()
  if nil == Panel_Guild_List then
    return
  end
  if false == PaGlobal_GuildIncentive_GetShow() then
    return
  end
  ClearFocusEdit()
  CheckChattingInput()
  PaGlobal_GuildIncentive_CheckCloseUI()
end
...
function HandleClicked_GuildIncentive_Send()
  ...
  local tempMoney = tonumber(PaGlobal_GuildIncentive.incentive_InputMoney:GetEditText())
...
function FGlobal_CheckSaveGuildMoneyUiEdit(targetUI)
  ...
  return nil ~= targetUI and targetUI:GetKey() == PaGlobal_GuildIncentive.incentive_InputMoney:GetKey()
end
...
function _GuildDeposit_InputCheck_Command(number)
  ...
  PaGlobal_GuildIncentive.incentive_InputMoney:SetEditText(tostring(inputGuildDepositNum_s64), true)
end
function _GuildDeposit_InputCheck_BackSpaceCommand()
  ...
  PaGlobal_GuildIncentive.incentive_InputMoney:SetEditText(newStr, true)
end
...
function FromClient_RequestExpelMemberFromGuild()
  ...
  if true == Panel_Window_Guild:GetShow() then
    GuildListInfoPage:UpdateData()
  elseif true == Panel_Window_ClanList_All:GetShow() then
...
function PaGlobal_GuildIncentive:initialize()
  if nil == Panel_GuildIncentive then
    return
  end
  Panel_GuildIncentive:SetShow(false)
  PaGlobal_GuildIncentive.incentive_InputMoney = UI.getChildControl(Panel_GuildIncentive, "Edit_InputIncentiveValue")
  PaGlobal_GuildIncentive.btn_incentive_Send = UI.getChildControl(Panel_GuildIncentive, "Button_Confirm")
  PaGlobal_GuildIncentive.btn_incentive_Cancle = UI.getChildControl(Panel_GuildIncentive, "Button_Cancle")
  PaGlobal_GuildIncentive.btn_incentive_Help = UI.getChildControl(Panel_GuildIncentive, "Button_Question")
  PaGlobal_GuildIncentive.txt_incentive_Title = UI.getChildControl(Panel_GuildIncentive, "StaticText_Title")
  PaGlobal_GuildIncentive.txt_incentive_Deposit = UI.getChildControl(Panel_GuildIncentive, "StaticText_Incentive")
  PaGlobal_GuildIncentive.txt_incentive_Notify = UI.getChildControl(Panel_GuildIncentive, "StaticText_Notify")
  PaGlobal_GuildIncentive.incentive_InputMoney:SetNumberMode(true)
  PaGlobal_GuildIncentive.txt_incentive_Notify:SetTextMode(__eTextMode_AutoWrap)
  PaGlobal_GuildIncentive:registEventHandler()
end
function PaGlobal_GuildIncentive:registEventHandler()
  Panel_GuildIncentive:RegisterCloseLuaFunc(PAUIRenderModeBitSet({
    Defines.CloseType.eCloseType_Escape
  }), "FGlobal_GuildIncentive_Close()")
  PaGlobal_GuildIncentive.incentive_InputMoney:addInputEvent("Mouse_LUp", "HandleClicked_SetIncentive()")
  PaGlobal_GuildIncentive.btn_incentive_Send:addInputEvent("Mouse_LUp", "HandleClicked_GuildIncentive_Send()")
  PaGlobal_GuildIncentive.btn_incentive_Cancle:addInputEvent("Mouse_LUp", "HandleClicked_GuildIncentive_Close()")
  PaGlobal_GuildIncentive.btn_incentive_Help:addInputEvent("Mouse_LUp", "")
  PaGlobal_GuildIncentive.incentive_InputMoney:RegistReturnKeyEvent("FGlobal_SaveGuildMoney_Send()")
end
function PaGlobal_GuildIncentive_CheckLoadUI()
  if false == _ContentsGroup_PanelReload_Develop then
    Panel_GuildIncentive:SetShow(true)
    return
  end
  local rv = reqLoadUI("UI_Data/Window/Guild/Panel_GuildIncentive.XML", "Panel_GuildIncentive", Defines.UIGroup.PAGameUIGroup_Window_Progress, PAUIRenderModeBitSet({
    Defines.RenderMode.eRenderMode_Default
  }))
  if nil ~= rv then
    Panel_GuildIncentive = rv
    rv = nil
    PaGlobal_GuildIncentive:initialize()
  end
  Panel_GuildIncentive:SetShow(true)
end
function PaGlobal_GuildIncentive_CheckCloseUI()
  if false == _ContentsGroup_PanelReload_Develop then
    Panel_GuildIncentive:SetShow(false)
  else
    reqCloseUI(Panel_GuildIncentive)
  end
end
function PaGlobal_GuildIncentive_GetShow()
  if nil == Panel_GuildIncentive then
    return false
  end
  return Panel_GuildIncentive:GetShow()
end
function FromClient_GuildList_Init()
  PaGlobal_GuildList_Init()
  GuildListInfoPage:registMessageHandler()
end
function PaGlobal_GuildList_Init()
  GuildListInfoPage:initialize()
  GuildListInfoPage:registEventHandler()
end
registerEvent("FromClient_luaLoadComplete", "FromClient_GuildList_Init")
