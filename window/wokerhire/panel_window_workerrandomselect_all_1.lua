function PaGlobal_WorkerRandomSelect_All:initialize()
  ...
  PaGlobal_WorkerRandomSelect_All._ui._stc_WorkerTier = UI.getChildControl(PaGlobal_WorkerRandomSelect_All._ui._stc_WokerImg, "Static_Tier")
  ...
  PaGlobal_WorkerRandomSelect_All._ui._stc_MoneyArea = UI.getChildControl(Panel_Window_WorkerRandomSelect_All, "Static_MyMoneyArea")
  PaGlobal_WorkerRandomSelect_All._ui._txt_MoneyValue = UI.getChildControl(PaGlobal_WorkerRandomSelect_All._ui._stc_MoneyArea, "StaticText_MoneyValue")
  ...
  PaGlobal_WorkerRandomSelect_All._isConsole = _ContentsGroup_UsePadSnapping
...
function PaGlobal_WorkerRandomSelect_All:setUIControl()
  ...
  if true == _ContentsOption_CH_Help then
    PaGlobal_WorkerRandomSelect_All._ui._btn_Question_PC:SetShow(false)
  end
...
function PaGlobal_WorkerRandomSelect_All:registerEventHandler()
  if nil ~= Panel_Window_WorkerRandomSelect_All and true == PaGlobal_WorkerRandomSelect_All._initialize then
    ...
    registerEvent("selfPlayer_regionChanged", "FromClient_WorkerRandomSelect_All_UpdateRadioButton()")
    if false == PaGlobal_WorkerRandomSelect_All._isConsole then
      ...
      PaGlobal_Util_RegistHelpTooltipEvent(PaGlobal_WorkerRandomSelect_All._ui._btn_Question_PC, "\"Worker\"")
...
function PaGlobal_WorkerRandomSelect_All:updateRadioButton()
  if nil == Panel_Window_WorkerRandomSelect_All then
    return
  end
end
  ...
  for index = 0, sellCount - 1 do
    ...
    if slotNo == shopItem.shopSlotNo then
      ...
      if nil ~= plantWorkerSS then
        ...
        PaGlobal_WorkerRandomSelect_All._ui._stc_WorkerTier:ChangeTextureInfoName(self._gradePath)
        ...
        self._ui._stc_WorkerImage[0]:SetShow(false)
        self._ui._stc_WorkerImage[1]:SetShow(false)
        self._ui._stc_WorkerTierBg[self._nextIndex]:ChangeTextureInfoName(self._gradePath)
        ...
        self._ui._stc_WorkerTierBg[self._nextIndex]:ChangeTextureInfoName(workerIconPath)
