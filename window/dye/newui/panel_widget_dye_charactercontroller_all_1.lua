...
function PaGlobal_Dye_CharacterController:registEventHandler()
  ...
  if false == self._isConsole then
    ...
    self._ui_pc.btn_Pallet:addInputEvent("Mouse_LUp", "HandleEventLUp_Dye_CharacterController_PaletteToggle()")
    self._ui_pc.btn_Inventory:addInputEvent("Mouse_LUp", "HandleEventLUp_Dye_CharacterController_InventoryToggle()")
  end
end
...
function PaGlobal_Dye_CharacterController:isColorPaletteOpen()
  if nil == Panel_Widget_CharacterController_All then
    return false
  end
  if nil == Panel_Window_ColorPalette_All or false == Panel_Window_ColorPalette_All:IsShow() then
    return false
  else
    return true
  end
