PaGlobal_Dye_All = {
  _ui = {
    ...
    btn_Tokong = nil,
    stc_effectBg = nil,
    stc_effectSlotBg = nil,
    btn_ApplyOrBuyEffect = nil
  },
  _ui_pc = {btn_Dye = nil},
  _ui_console = {
    stc_KeyGuideLB = nil,
  ...
  _onlyChinaHideType = {
    [1] = __eEquipSlotNoAvatarUnderwear
  },
  dyePartString = {
    [0] = {
  ...
  _nowSelectEffectIndex = 0,
  _nowEffectMaxCount = 0,
  _isConsole = false,
  _initialize = false,
  _changedRatio = 1
}
