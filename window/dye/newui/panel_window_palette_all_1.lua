function PaGlobal_Palette_All:initialize()
  ...
  self._ui.txt_SelectedAmpuleName:SetTextMode(__eTextMode_AutoWrap)
...
function PaGlobal_Palette_All:prepareOpen()
  ...
  local posX = invenPosX - Panel_Window_Palette_All:GetSizeX() - 5
  if posX < 0 then
    posX = invenPosX + Panel_Window_Inventory_All:GetSizeX() + 5
  end
  Panel_Window_Palette_All:SetPosX(posX)
...
function PaGlobal_Palette_All:prepareClose()
  ...
  Panel_Window_Palette_All:ignorePadSnapMoveToOtherPanelUpdate(true)
