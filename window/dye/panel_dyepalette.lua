...
function DyePalette:Open()
  ...
  Panel_DyePalette:SetPosX(invenPosX - Panel_DyePalette:GetSizeX())
  Panel_DyePalette:SetPosY(invenPosY)
...
function FGlobal_DyePalette_IsShow()
  if Panel_DyePalette == nil then
    return nil
  end
  return Panel_DyePalette:GetShow()
end
...
function DyePalette:registEventHandler()
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(control._btn_Help, "\"Dye\"")
  if true == _ContentsOption_CH_Help then
    control._btn_Help:SetShow(false)
  end
