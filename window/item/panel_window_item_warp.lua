...
list2_TownList:registEvent(__ePAUIList2EventType_LuaChangeContent, "WarpableTownListControlCreate")
list2_TownList:createChildContent(__ePAUIList2ElementManagerType_List)
