function PaGlobal_SkillGroup_Controller:initialize()
  ...
  self._isConsole = _ContentsGroup_RenewUI or _ContentsGroup_UsePadSnapping
...
function PaGlobal_SkillGroup_Controller:controlInit_All()
  ...
  ui._frame_skillDesc = UI.getChildControl(ui._stc_descBg, "Frame_EffectDesc")
  ui._frame_content = UI.getChildControl(ui._frame_skillDesc, "Frame_Content")
  ui._frame_vscroll = ui._frame_skillDesc:GetVScroll()
  ui._frame_vscroll_ctrlButton = ui._frame_vscroll:GetControlButton()
  ui._txt_skillEffectDesc = UI.getChildControl(ui._frame_content, "StaticText_Skill_EffectDesc")
  ui._txt_keyGuide_Scroll = UI.getChildControl(ui._stc_descBg, "StaticText_keyGuide_Scroll")
  ...
  if true == self._isConsole then
    ui._btn_playSkill:SetShow(false)
    ui._btn_cameraReset:SetShow(false)
    ui._frame_vscroll:SetInterval(2)
  else
    ui._txt_keyGuide_Scroll:SetShow(false)
  end
end
...
function PaGlobal_SkillGroup_Controller:open()
  ...
  self:reset()
  if true == self._isConsole then
    Panel_Window_SkillGroup_Controller:RegisterUpdateFunc("PaGlobal_SkillGroup_Controller_UpdatePerFrame")
  end
...
function PaGlobal_SkillGroup_Controller:close()
  ...
  if true == self._isConsole then
    Panel_Window_SkillGroup_Controller:ClearUpdateLuaFunc()
  end
...
function PaGlobal_SkillGroup_Controller:getSkillInfo(skillNo)
  ...
  local skillInfo = {
    ...
    _consoleCommand = skillTypeStaticWrapper:getConsoleCommand(),
...
function PaGlobal_SkillGroup_Controller:validate()
  ...
  ui._btn_cameraReset:isValidate()
  ui._btn_playBlack:isValidate()
  ui._stc_descBg:isValidate()
  ui._stc_skillIcon:isValidate()
  ui._txt_skillName:isValidate()
  ui._txt_skillDesc:isValidate()
  ui._txt_skillCommandDesc:isValidate()
  ui._txt_skillEffectTitle:isValidate()
  ui._frame_skillDesc:isValidate()
  ui._frame_content:isValidate()
  ui._frame_vscroll:isValidate()
  ui._frame_vscroll_ctrlButton:isValidate()
  ui._txt_skillEffectDesc:isValidate()
  ui._txt_keyGuide_Scroll:isValidate()
  ui._txt_skillNeedResource:isValidate()
  ui._txt_requiredLevel:isValidate()
  ui._txt_requiredSkillPoint:isValidate()
  ui._txt_reuseCycle:isValidate()
end
...
function PaGlobal_SkillGroup_Controller:TooltipShow(index)
  if 0 == index then
    TooltipSimple_Show(self._ui._btn_playSkill, PAGetString(Defines.StringSheet_GAME, "LUA_PLAYSKILL"), nil, false)
  elseif 1 == index then
    TooltipSimple_Show(self._ui._btn_cameraReset, PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SKILL_RESETCAMERA"), nil, false)
  elseif 2 == index then
    TooltipSimple_Show(self._ui._btn_playBlack, PAGetString(Defines.StringSheet_GAME, "LUA_PLAY_BLACKSKILL"), nil, false)
  end
end
