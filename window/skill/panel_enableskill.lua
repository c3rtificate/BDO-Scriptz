...
recommendSkill[__eClassType_Warrior] = {
  [0] = 1021,
  [1] = 1127,
  [2] = 1128,
  [3] = 1129,
...
recommendSkill[__eClassType_ElfRanger] = {
  [0] = 1006,
  [1] = 1091,
  [2] = 1092,
  [3] = 1093,
...
recommendSkill[__eClassType_Sorcerer] = {
  [0] = 310,
  [1] = 311,
  [2] = 312,
  [3] = 1056,
...
recommendSkill[__eClassType_Giant] = {
  [0] = 1044,
  [1] = 1175,
  [2] = 1176,
  [3] = 1177,
...
recommendSkill[__eClassType_Tamer] = {
  [0] = 11,
  [1] = 12,
  [2] = 13,
  [3] = 14,
...
recommendSkill[__eClassType_BladeMaster] = {
  [0] = 1455,
  [1] = 1456,
  [2] = 1457,
  [3] = 1279,
...
recommendSkill[__eClassType_BladeMasterWoman] = {
  [0] = 1591,
  [1] = 1592,
  [2] = 1593,
  [3] = 1539,
...
recommendSkill[__eClassType_Valkyrie] = {
  [0] = 744,
  [1] = 745,
  [2] = 746,
  [3] = 732,
...
recommendSkill[__eClassType_WizardMan] = {
  [0] = 834,
  [1] = 835,
  [2] = 836,
  [3] = 837,
...
recommendSkill[__eClassType_WizardWoman] = {
  [0] = 834,
  [1] = 835,
  [2] = 836,
  [3] = 837,
...
recommendSkill[__eClassType_Kunoichi] = {
  [0] = 949,
  [1] = 950,
  [2] = 951,
  [3] = 1624,
...
recommendSkill[__eClassType_NinjaMan] = {
  [0] = 949,
  [1] = 950,
  [2] = 951,
  [3] = 1624,
...
recommendSkill[__eClassType_DarkElf] = {
  [0] = 2269,
  [1] = 2270,
  [2] = 2271,
  [3] = 2272,
...
recommendSkill[__eClassType_Combattant] = {
  [0] = 2449,
  [1] = 2450,
  [2] = 2451,
  [3] = 2501,
...
recommendSkill[__eClassType_Mystic] = {
  [0] = 2723,
  [1] = 2724,
  [2] = 2725,
  [3] = 2726,
...
recommendSkill[__eClassType_Lhan] = {
  [0] = 3221,
  [1] = 3222,
  [2] = 3223,
  [3] = 3224,
...
recommendSkill[__eClassType_BladeMaster_Reserved1] = {}
recommendSkill[__eClassType_RangerMan] = {
  [0] = 3423,
  [1] = 3424,
  [2] = 3425,
  [3] = 3426,
...
recommendSkill[__eClassType_ShyWaman] = {}
recommendSkill[__eClassType_ShyMan] = {}
recommendSkill[__eClassType_Hashashin] = {}
recommendSkill[__eClassType_Guardian] = {
  [0] = 5011,
  [1] = 5012,
  [2] = 5013,
  [3] = 5014,
...
recommendSkill[__eClassType_Nova] = {}
recommendSkill[__eClassType_Sage] = {}
recommendSkill[__eClassType_Corsair] = {}
recommendSkill[__eClassType_Giant_Reserved0] = {}
recommendSkill[__eClassType_Giant_Reserved2] = {}
recommendSkill[__eClassType_KunoichiOld] = {}
...
function enableSkill_MakeControl(index)
  local ui = {}
  ui._IconBG = UI.createControl(__ePAUIControl_Static, Panel_EnableSkill, "Static_SkillBG_" .. index)
  ...
  ui._RecommendBG = UI.createControl(__ePAUIControl_Static, Panel_EnableSkill, "Static_SkillBlueBG_" .. index)
  ...
  ui._skillIcon = UI.createControl(__ePAUIControl_Static, Panel_EnableSkill, "Static_SkillIcon_" .. index)
  ...
  ui._skillName = UI.createControl(__ePAUIControl_StaticText, Panel_EnableSkill, "StaticText_SkillName_" .. index)
  ...
  ui._needSp = UI.createControl(__ePAUIControl_StaticText, Panel_EnableSkill, "StaticText_SkillNeedSP_" .. index)
  ...
  ui._learnButton = UI.createControl(__ePAUIControl_Button, Panel_EnableSkill, "StaticText_LearnButton_" .. index)
  CopyBaseProperty(CopyUI._base_LearnButton, ui._learnButton)
  ui._learnButton:SetShow(false)
  ui._learnButton:SetIgnore(false)
  ui._learnButton:SetTextMode(__eTextMode_LimitText)
...
function enableSkill_MoveSkill(index)
  ...
  if skillNumber[index + slideIndex]._awaken == 0 then
    PaGlobal_Skill:SkillWindowEffect(rowNumber, colNumber, skillNoNumber, true, __eSkillTypeParam_Normal)
  elseif skillNumber[index + slideIndex]._awaken == 1 then
    PaGlobal_Skill:SkillWindowEffect(rowNumber, colNumber, skillNoNumber, true, __eSkillTypeParam_Awaken)
  elseif skillNumber[index + slideIndex]._awaken == 2 then
    PaGlobal_Skill:SkillWindowEffect(rowNumber, colNumber, skillNoNumber, true, __eSkillTypeParam_Inherit)
  end
end
function enableSkill_GetSkillRow(skillNo)
  local cellTable = {}
  ...
  for idx = 0, #cellTable do
    if nil == cellTable[idx] then
      return
    end
    local cols = cellTable[idx]:capacityX()
    local rows = cellTable[idx]:capacityY()
    for row = 0, rows - 1 do
      for col = 0, cols - 1 do
        local cell = cellTable[idx]:atPointer(col, row)
        local cellSkillNo = cell._skillNo
        if skillNo == cellSkillNo then
          return row
        end
      end
    end
...
function enableSkill_Init()
  mousePosBG = UI.createControl(__ePAUIControl_Static, Panel_EnableSkill, "Static_SkillYellowBG_")
              ...
              if -1 == selectIndex or 0 == selectIndex then
                for i = 0, maxRecommendCount - 1 do
                  if skillNo == recommendSkill[selfPlayer:getClassType()][i] then
                    for ii = learnSkillCount + 1, recommendSkillCount, -1 do
...
PaGlobal_Util_RegistHelpTooltipEvent(_buttonQuestion, "\"PanelEnableSkill\"")
