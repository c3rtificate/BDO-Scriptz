...
function PaGlobal_SkillGroup:consoleInitControl()
  if false == self._isConsole then
    return
  end
  self._ui_console.stc_keyGuideBg = UI.getChildControl(Panel_Window_SkillGroup, "StaticText_KeyGuideBg_ConsoleUI")
  self._ui_console.stc_startSpiritSkillAnimKeyGuide = UI.getChildControl(PaGlobal_SkillGroup._ui_console.stc_keyGuideBg, "StaticText_StartSpiritSkillAnim_ConsoleUI")
  self._ui_console.stc_startSpiritSkillAnimKeyGuideSub = UI.getChildControl(PaGlobal_SkillGroup._ui_console.stc_startSpiritSkillAnimKeyGuide, "StaticText_KeyGuide_LT_ConsoleUI")
  self._ui_console.stc_resetSkillLevelKeyGuide = UI.getChildControl(PaGlobal_SkillGroup._ui_console.stc_keyGuideBg, "StaticText_ResetSkillLevel_ConsoleUI")
  self._ui_console.stc_resetSkillLevelKeyGuideSub = UI.getChildControl(PaGlobal_SkillGroup._ui_console.stc_resetSkillLevelKeyGuide, "StaticText_KeyGuide_LT_ConsoleUI")
  self._ui_console.stc_learnMaxSkillKeyGuide = UI.getChildControl(PaGlobal_SkillGroup._ui_console.stc_keyGuideBg, "StaticText_LearnMaxSkill_ConsoleUI")
  self._ui_console.stc_learnMaxSkillKeyGuideSub = UI.getChildControl(PaGlobal_SkillGroup._ui_console.stc_learnMaxSkillKeyGuide, "StaticText_KeyGuide_LT_ConsoleUI")
  self._ui_console.stc_changeLevelKeyGuide = UI.getChildControl(PaGlobal_SkillGroup._ui_console.stc_keyGuideBg, "StaticText_ChangeLevel_ConsoleUI")
  self._ui_console.stc_changeLevelKeyGuideSub = UI.getChildControl(PaGlobal_SkillGroup._ui_console.stc_changeLevelKeyGuide, "StaticText_KeyGuide_LT_ConsoleUI")
  self._ui_console.stc_resetSkillKeyGuide = UI.getChildControl(PaGlobal_SkillGroup._ui_console.stc_keyGuideBg, "StaticText_ResetSkill_ConsoleUI")
  self._ui_console.stc_learnSkillKeyGuide = UI.getChildControl(PaGlobal_SkillGroup._ui_console.stc_keyGuideBg, "StaticText_LearnSkill_ConsoleUI")
  self._ui_console.stc_skillLockKeyGuide = UI.getChildControl(PaGlobal_SkillGroup._ui_console.stc_keyGuideBg, "StaticText_SkillLock_ConsoleUI")
  self._ui_console.stc_presetMemoGuide = UI.getChildControl(PaGlobal_SkillGroup._ui_console.stc_keyGuideBg, "StaticText_SkillPresetMemo_ConsoleUI")
  self._ui_console.stc_closeKeyGuide = UI.getChildControl(PaGlobal_SkillGroup._ui_console.stc_keyGuideBg, "StaticText_Close_ConsoleUI")
  self._ui_console.stc_CamerakeyGuideBg = UI.getChildControl(Panel_Window_SkillGroup, "StaticText_CameraKeyGuideBg_ConsoleUI")
  self._ui_console.stc_cameraRotationKeyGuide = UI.getChildControl(PaGlobal_SkillGroup._ui_console.stc_CamerakeyGuideBg, "StaticText_CameraRotation_ConsoleUI")
  self._ui_console.stc_resetCameraKeyGuide = UI.getChildControl(PaGlobal_SkillGroup._ui_console.stc_CamerakeyGuideBg, "StaticText_resetCamera_ConsoleUI")
  self._ui_console.stc_startSpiritSkillAnimKeyGuideSub:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_PLAY_BLACKSKILL"))
  self._ui_console.stc_changeLevelKeyGuideSub:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SKILL_CHANGELEVEL"))
  self._ui_console.stc_learnSkillKeyGuide:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SKILLREINFORCE_SELECTSKILL") .. " / " .. PAGetString(Defines.StringSheet_RESOURCE, "PANEL_WINDOW_SKILL_MOUSE_GUIDE_L"))
  self._ui_console.stc_keyGuideBg:ComputePos()
  self._defaultKeyGuideBGSizeX = self._ui_console.stc_keyGuideBg:GetSizeX()
  self:AlignkeyGuide(0)
end
function PaGlobal_SkillGroup:AlignkeyGuide(alignType, key, isLearnedFusionSkill, isCanLearnedFusionSkill, isEnablePresetMemo)
  if false == self._isConsole then
    return
  end
  if nil == alignType then
    return
  end
  if alignType < 2 and alignType == self._curAlignType then
    return
  end
  self._curAlignType = alignType
  if 2 == alignType and nil == key then
    return
  end
  if 3 == alignType and (nil == isLearnedFusionSkill or nil == isCanLearnedFusionSkill) then
    return
  end
  if nil == self._ui_console.stc_keyGuideBg then
    return
  end
  self._ui_console.stc_startSpiritSkillAnimKeyGuide:SetShow(false)
  self._ui_console.stc_resetSkillLevelKeyGuide:SetShow(false)
  self._ui_console.stc_learnMaxSkillKeyGuide:SetShow(false)
  self._ui_console.stc_changeLevelKeyGuide:SetShow(false)
  self._ui_console.stc_resetSkillKeyGuide:SetShow(false)
  self._ui_console.stc_learnSkillKeyGuide:SetShow(false)
  self._ui_console.stc_skillLockKeyGuide:SetShow(false)
  self._ui_console.stc_closeKeyGuide:SetShow(false)
  self._ui_console.stc_presetMemoGuide:SetShow(false)
  if nil ~= self._ui._stc_keyGuideX then
    local x1, y1, x2, y2 = 0, 0, 0, 0
    if 1 == alignType then
      x1, y1, x2, y2 = setTextureUV_Func(self._ui._stc_keyGuideX, 1, 1, 45, 45)
    else
      x1, y1, x2, y2 = setTextureUV_Func(self._ui._stc_keyGuideX, 136, 1, 180, 45)
    end
    self._ui._stc_keyGuideX:getBaseTexture():setUV(x1, y1, x2, y2)
    self._ui._stc_keyGuideX:setRenderTexture(self._ui._stc_keyGuideX:getBaseTexture())
  end
  local curIndex = 1
  local keyGuides = {}
  if 0 == alignType or 1 == alignType then
    self._curSkillShowType = self.eSkillShowTypeIndex.baseSkill
  elseif 3 == alignType then
    local learnSkillKeyGuideString = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SKILLREINFORCE_SELECTSKILL")
    if false == isLearnedFusionSkill then
      if true == isCanLearnedFusionSkill then
      ...
      keyGuides[curIndex] = self._ui_console.stc_resetSkillKeyGuide
      curIndex = curIndex + 1
      self._ui_console.stc_resetSkillKeyGuide:SetShow(true)
    end
    keyGuides[curIndex] = self._ui_console.stc_learnSkillKeyGuide
    curIndex = curIndex + 1
    self._ui_console.stc_learnSkillKeyGuide:SetShow(true)
    self._ui_console.stc_learnSkillKeyGuide:SetText(learnSkillKeyGuideString)
  elseif 2 == alignType then
    local isBlackSpiritSkill = false
    local isSuccessionSkill = false
    local isCanReset = false
    local isCanLevelReset = false
    local isCanLearn = false
    local isLevelSkill = false
    local isCanSkillLock = false
    local skillGroup = self._skillGroupList[key]
    local level = skillGroup._selectLevel
    local maxLevel = skillGroup._maxLevel
    local skillKey = ToClient_getSkillKeyBySkillGroupNo(skillGroup._key, level)
    local skillNo = skillKey:getSkillNo()
    local skillLevelInfo = getSkillLevelInfo(skillNo)
    if nil ~= skillLevelInfo and level >= 1 and true == skillLevelInfo._usable then
      isCanSkillLock = true
    end
    local isSkillTypeShuriken = false
    local isSkillCommandCheck = false
    ...
    if nil ~= skillTypeSSW then
      ...
      if true == skillTypeSSW:isSkillCommandCheck() and false == skillLevelInfo._learnable and skillLevelInfo._usable then
        isSkillCommandCheck = true
      end
    end
    local skillStatic = getSkillStaticStatus(skillNo, 1)
    if nil ~= skillStatic then
      if false == skillStatic:isAutoLearnSkillByLevel() then
        local isBaseLearnSkill = false
        local skilsSS = skillStatic:get()
        if nil == skilsSS or 0 == skilsSS._needSkillPointForLearning then
          isBaseLearnSkill = true
        end
        if level > 1 or false == isBaseLearnSkill and true == ToClient_isLearnedSkill(skillNo) then
          isCanReset = true
          if maxLevel > 1 and level >= 2 then
            isCanLevelReset = true
          end
        end
      end
      ...
      if nil ~= blackSkillTypeSS and true == blackSkillTypeSS:isValidLocalizing() then
        ...
        if nil ~= blackSkillStatic then
          isBlackSpiritSkill = true
        end
      end
      if false == isBlackSpiritSkill then
        ...
        if nil ~= linkSkillTypeSS and true == linkSkillTypeSS:isValidLocalizing() then
          ...
          if nil ~= linkSkillStatic then
            isSuccessionSkill = true
          end
        end
      end
    end
    if true == skillGroup._btn_learn:GetShow() then
      isCanLearn = true
    end
    if true == skillGroup._btn_next:GetShow() then
      isLevelSkill = true
    end
    if true == isBlackSpiritSkill or true == isSuccessionSkill then
      local showSkillTypeText
      if true == isSuccessionSkill then
        showSkillTypeText = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SKILLGROUP_SHOWSUCCESSIONSKILLDESC")
      else
        showSkillTypeText = PAGetString(Defines.StringSheet_GAME, "LUA_PLAY_BLACKSKILL")
      end
      if nil ~= showSkillTypeText then
        self._ui_console.stc_startSpiritSkillAnimKeyGuideSub:SetText(showSkillTypeText)
      end
      keyGuides[curIndex] = self._ui_console.stc_startSpiritSkillAnimKeyGuide
      self._ui_console.stc_startSpiritSkillAnimKeyGuide:SetShow(true)
      curIndex = curIndex + 1
    end
    if true == isCanReset then
      if true == isCanLevelReset then
        keyGuides[curIndex] = self._ui_console.stc_resetSkillLevelKeyGuide
        curIndex = curIndex + 1
        self._ui_console.stc_resetSkillLevelKeyGuide:SetShow(true)
      end
      keyGuides[curIndex] = self._ui_console.stc_resetSkillKeyGuide
      curIndex = curIndex + 1
      self._ui_console.stc_resetSkillKeyGuide:SetShow(true)
    ...
    local learnSkillKeyGuideString = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SKILLREINFORCE_SELECTSKILL")
    if true == isCanLearn then
      if maxLevel > 1 and level + 1 ~= maxLevel and false == isSkillTypeShuriken then
        keyGuides[curIndex] = self._ui_console.stc_learnMaxSkillKeyGuide
        curIndex = curIndex + 1
        self._ui_console.stc_learnMaxSkillKeyGuide:SetShow(true)
      end
      learnSkillKeyGuideString = learnSkillKeyGuideString .. " / " .. PAGetString(Defines.StringSheet_RESOURCE, "PANEL_WINDOW_SKILL_MOUSE_GUIDE_L")
    else
    end
    ...
    self._ui_console.stc_learnSkillKeyGuide:SetShow(true)
    self._ui_console.stc_learnSkillKeyGuide:SetText(learnSkillKeyGuideString)
    if true == isLevelSkill then
      keyGuides[curIndex] = self._ui_console.stc_changeLevelKeyGuide
      curIndex = curIndex + 1
      self._ui_console.stc_changeLevelKeyGuide:SetShow(true)
    end
    if true == isSkillCommandCheck and true == isCanSkillLock then
      keyGuides[curIndex] = self._ui_console.stc_skillLockKeyGuide
      self._ui_console.stc_skillLockKeyGuide:SetShow(true)
      curIndex = curIndex + 1
    end
  elseif 4 == alignType then
    keyGuides[curIndex] = self._ui_console.stc_learnSkillKeyGuide
    curIndex = curIndex + 1
    self._ui_console.stc_learnSkillKeyGuide:SetShow(true)
    self._ui_console.stc_learnSkillKeyGuide:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_GENERIC_KEYGUIDE_XBOX_SELECT"))
    if true == isEnablePresetMemo then
      keyGuides[curIndex] = self._ui_console.stc_presetMemoGuide
      curIndex = curIndex + 1
      self._ui_console.stc_presetMemoGuide:SetShow(true)
    end
  end
  keyGuides[curIndex] = self._ui_console.stc_closeKeyGuide
  curIndex = curIndex + 1
  self._ui_console.stc_closeKeyGuide:SetShow(true)
  PaGlobalFunc_ConsoleKeyGuide_SetAlign(keyGuides, self._ui_console.stc_keyGuideBg, CONSOLEKEYGUID_ALIGN_TYPE.eALIGN_TYPE_TOP, nil, 0)
...
function PaGlobal_SkillGroup:updateViewController(isWindow, isForced)
  ...
  if false == isWindow then
    self:updateEditMode(false, false)
...
function PaGlobal_SkillGroup:controlInit_All()
  ...
  self._tab = {
    ...
    [4] = UI.getChildControl(ui._rdo_groupBg, "RadioButton_Tab_Skill_Upgrade")
  }
  ...
  for ii = 0, #self._tab do
    ...
    self._subGroupSize[ii] = 0
    self._subGroupList[ii] = {}
    self._subGroupButton[ii] = {}
    self._isOpenedSubGroup[ii] = {}
    self._subGroupContentsCount[ii] = {}
  end
  ...
  ui._btn_allReset:addInputEvent("Mouse_On", "PaGlobal_SkillGroup:AlignkeyGuide(0)")
  ui._stc_playShowBG = UI.getChildControl(ui._stc_bottomArea, "Static_1")
  ...
  if false == _ContentsGroup_NewUI_BlackSpiritSkillLock_All then
    ui._btn_lockSpirit:SetShow(false)
  end
  ...
  self._defaultDeepSkillAreaSpanY = self._deepeningSkill.area:GetSpanSize().y
  ...
  if true == _ContentsGroup_SkillFilter then
    ui._btn_skillFilter = UI.getChildControl(ui._stc_TopFuncBg, "Button_Filter")
    ui._btn_skillFilter:addInputEvent("Mouse_LUp", "PaGlobal_SkillFilter_Toggle()")
    ui._btn_skillFilter:addInputEvent("Mouse_On", "PaGlobal_SkillGroup:HandleMOn_FilterButtonOn()")
    ui._btn_skillFilter:addInputEvent("Mouse_Out", "PaGlobal_SkillGroup:HandleMOut_FilterButtonOut()")
    ui._btn_allReset:addInputEvent("Mouse_On", "PaGlobal_SkillGroup:HandleMOn_AllResetButtonOn()")
    ui._btn_allReset:addInputEvent("Mouse_Out", "PaGlobal_SkillGroup:HandleMOut_AllResetButtonOut()")
  end
  ui._stc_keyGuideLB = UI.getChildControl(ui._rdo_groupBg, "Static_SelectLB_C")
  ui._stc_keyGuideRB = UI.getChildControl(ui._rdo_groupBg, "Static_SelectRB_C")
  ui._stc_keyGuideX = UI.getChildControl(ui._edit_search, "StaticText_X_ConsoleUI")
  if true == self._isConsole then
    Panel_Window_SkillGroup:registerPadEvent(__eConsoleUIPadEvent_LB, "PaGlobal_SkillGroup_SelectTabForConsole(false)")
    Panel_Window_SkillGroup:registerPadEvent(__eConsoleUIPadEvent_RB, "PaGlobal_SkillGroup_SelectTabForConsole(true)")
    Panel_Window_SkillGroup:registerPadEvent(__eConsoleUIPadEvent_RTPress_X, "PaGlobal_SkillGroup_SearchSkill()")
    Panel_Window_SkillGroup:registerPadEvent(__eConsoleUIPadEvent_RTPress_A, "PaGlobal_SkillGroup:HandleEventLUp_SearchButton()")
    ui._edit_search:setXboxVirtualKeyBoardEndEvent("PaGlobal_SkillGroup_EndXboxKeyInput")
    Panel_Window_SkillGroup:registerPadEvent(__eConsoleUIPadEvent_RSClick, "PaGlobal_SkillGroup_ResetSkillCamera()")
    ui._btn_search:SetShow(false)
    ui._stc_keyGuideX:SetShow(true)
    ui._btn_question:SetShow(false)
    useGuideGroup:SetShow(false)
    ui._stc_playShow:SetShow(false)
    ui._btn_modify:SetShow(false)
    ui._btn_cooltimeSet:SetShow(false)
    ui._btn_lockSpirit:SetShow(false)
    ui._btn_movie:SetShow(false)
    local checkBg = UI.getChildControl(ui._stc_bottomArea, "Static_1")
    checkBg:SetShow(false)
  else
    ui._stc_keyGuideX:SetShow(false)
    if _ContentsOption_CH_GameType == true or _ContentsGroup_ProjectAbyssOne == true and ToClient_isInAbyssOne() == true then
      ui._btn_movie:SetShow(false)
      local gap = ui._btn_movie:GetSizeX() + 10
      ui._btn_lockSpirit:SetSpanSize(ui._btn_lockSpirit:GetSpanSize().x + gap, ui._btn_lockSpirit:GetSpanSize().y)
      ui._btn_modify:SetSpanSize(ui._btn_modify:GetSpanSize().x + gap, ui._btn_modify:GetSpanSize().y)
      ui._btn_cooltimeSet:SetSpanSize(ui._btn_cooltimeSet:GetSpanSize().x + gap, ui._btn_cooltimeSet:GetSpanSize().y)
      ui._stc_playShowBG:SetSize(ui._stc_playShowBG:GetSizeX() + gap, ui._stc_playShowBG:GetSizeY())
      ui._stc_playShow:SetEnableArea(0, -5, ui._stc_playShowBG:GetSizeX() - 10, 25)
    end
  end
  ...
  if true == _ContentsGroup_SkillPreset then
    ...
    for index = 0, self._presetSlotMaxCount - 1 do
      ...
      if isEnterAbyssOne == true then
        self._skillPreset.btn_presetLock[index]:addInputEvent("Mouse_LUp", "")
      else
      ...
      if true == self._isConsole then
        self._skillPreset.btn_preset[index]:registerPadEvent(__eConsoleUIPadEvent_Up_X, "PaGlobalFunc_SkillPresetMemo_Open( PaGloabal_SkillPresetMemo._OPENTYPE._SKILL, " .. tostring(index) .. ")")
      else
        self._skillPreset.btn_preset[index]:addInputEvent("Mouse_RUp", "PaGlobalFunc_SkillPresetMemo_Open( PaGloabal_SkillPresetMemo._OPENTYPE._SKILL, " .. tostring(index) .. ")")
      end
    end
  ...
  self._upgradeSkillList = UI.getChildControl(Panel_Window_SkillGroup, "List2_Upgrade_List")
  self._upgradeSkillList:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_SkillGroup_OnCreateUpgradeSkillListContent")
  self._upgradeSkillList:createChildContent(__ePAUIList2ElementManagerType_List)
  self._findSkillNpcButton = UI.getChildControl(Panel_Window_SkillGroup, "Button_Navi_SkillMaster")
  self._ui_console.stc_findSkillMasterKeyGuide = UI.getChildControl(Panel_Window_SkillGroup, "StaticText_Navi_SkillMaster_ConsoleUI")
  if self._isConsole == false then
    self._findSkillNpcButton:addInputEvent("Mouse_LUp", "PaGlobalFunc_SkillGroup_OnClickedFindNpcButton()")
  end
  self._ui._stc_skillShiftGuideMain = UI.getChildControl(Panel_Window_SkillGroup, "Static_ShiftGuideMain")
  self._ui._stc_skillShiftGuideBG = UI.getChildControl(self._ui._stc_skillShiftGuideMain, "Static_ShiftGuideBG")
  self._ui._mtxt_skillShiftGuide = UI.getChildControl(self._ui._stc_skillShiftGuideBG, "MultilineText_ShiftGuide")
  self._ui._stc_skillShiftGuideMain:SetSize(self._ui._stc_skillShiftGuideMain:GetSizeX(), getScreenSizeY())
  self._ui._stc_skillShiftGuideMain:ComputePos()
  self._ui._btn_close = UI.getChildControl(self._ui._stc_skillShiftGuideBG, "Button_Close")
  self._ui._stc_skillShiftGuideMain:addInputEvent("Mouse_LUp", "PaGlobalFunc_SkillGroup_OnClickedGuideClose()")
  self._ui._btn_close:addInputEvent("Mouse_LUp", "PaGlobalFunc_SkillGroup_OnClickedGuideClose()")
  self._ui._btn_close:SetPosY(self._ui._mtxt_skillShiftGuide:GetPosY() + self._ui._mtxt_skillShiftGuide:GetTextSizeY() + 10)
  self._ui._stc_skillShiftGuideMain:SetShow(false)
end
function PaGlobal_SkillGroup:shiftKeyGuideShow()
  local selfPlayerWrapper = getSelfPlayer()
  if nil == selfPlayerWrapper then
    return
  end
  local player = selfPlayerWrapper:get()
  local isPlayerLevel = player:getLevel()
  local skillPoint = tonumber(player:getRemainSkillPoint())
  local spInfo = ToClient_getSkillPointInfo(0)
  if nil ~= spInfo then
    local maxSkillPoint = tonumber(spInfo._acquirePoint)
    if skillPoint == maxSkillPoint and isPlayerLevel >= 56 then
      PaGlobal_SkillGroup._ui._stc_skillShiftGuideMain:SetShow(true)
    end
  end
  if PaGlobal_SkillGroup._isConsole == true then
    ToClient_padSnapChangeToTarget(PaGlobal_SkillGroup._ui._btn_close)
  end
end
function PaGlobal_SkillGroup:createUpgradeSkillListContent(content, key)
  if nil == Panel_Window_SkillGroup then
    return
  end
  local selfPlayerWrapper = getSelfPlayer()
  if nil == selfPlayerWrapper then
  ...
  if nil ~= skillSSW then
    ...
    if 1 == effectCount then
      ...
      skillEffect_0:addInputEvent("Mouse_On", "PaGlobalFunc_SkillGroup_ShowUpgradeSkillEffectDescToolTip(true," .. index .. ",0)")
      skillEffect_0:addInputEvent("Mouse_Out", "PaGlobalFunc_SkillGroup_ShowUpgradeSkillEffectDescToolTip(false)")
    ...
    elseif 2 == effectCount then
      ...
      skillEffect_1:addInputEvent("Mouse_On", "PaGlobalFunc_SkillGroup_ShowUpgradeSkillEffectDescToolTip(true," .. index .. ",1)")
      skillEffect_1:addInputEvent("Mouse_Out", "PaGlobalFunc_SkillGroup_ShowUpgradeSkillEffectDescToolTip(false)")
      skillEffect_1:SetShow(true)
    end
  else
...
function PaGlobal_SkillGroup:open()
  ...
  if true == ToClient_IsObserverModeInSolrare() then
  ...
  self._isReverseSkillType = PaGlobalFunc_Util_IsSuccessionFirstLearnClassType(classType)
  if true == _ContentsGroup_SkillFilter then
    PaGlobal_SkillFilter_ResetFilter()
  end
  self:checkIsViewTreeTabIcon()
  local viewTabCount = 5
  ...
  if 0 ~= awakenRoot then
    ...
    if nil ~= skillKey then
      ...
      if nil ~= skillTypeSSW and false == skillTypeSSW:isValidLocalizing() then
        self._tab[self.eTabIndex.awaken]:SetShow(false)
        viewTabCount = viewTabCount - 1
      end
      if false == self._isReverseSkillType then
        ...
        if nil ~= skillSSW then
          ...
          if nil ~= needSkill and nil ~= needSkill[0] then
            local needSkillNo = needSkill[0]:getSkillNo()
            isLearnedAwakenSkill = ToClient_isLearnedSkill(needSkillNo)
          end
        end
      end
    end
  ...
  if 0 ~= successionRoot then
    ...
    if nil ~= skillKey then
      ...
      if false == self._isReverseSkillType then
        ...
        isLearnedSuccessionSkill = ToClient_isLearnedSkill(skillNo)
      end
    end
  end
  local playerLevel = selfPlayerWrapper:get():getLevel()
  local isOpenedUpgradeSkillTab = false
  if playerLevel >= 50 then
    isOpenedUpgradeSkillTab = true
  end
  if true == isOpenedUpgradeSkillTab then
    self._tab[self.eTabIndex.upgrade]:SetShow(true)
    self._upgradeSkillList:SetShow(true)
    self._findSkillNpcButton:SetShow(not self._isConsole)
    self._ui_console.stc_findSkillMasterKeyGuide:SetShow(self._isConsole)
    if self._isConsole == true then
      Panel_Window_SkillGroup:registerPadEvent(__eConsoleUIPadEvent_Up_Y, "PaGlobalFunc_SkillGroup_OnClickedFindNpcButton()")
    end
    if _ContentsGroup_ProjectAbyssOne == true and ToClient_isInAbyssOne() == true then
      self._findSkillNpcButton:SetShow(false)
      self._ui_console.stc_findSkillMasterKeyGuide:SetShow(false)
      Panel_Window_SkillGroup:registerPadEvent(__eConsoleUIPadEvent_Up_Y, "")
    end
    self:refreshUpdateSkillList()
  else
    self._tab[self.eTabIndex.upgrade]:SetShow(false)
    self._upgradeSkillList:SetShow(false)
    self._findSkillNpcButton:SetShow(false)
    self._ui_console.stc_findSkillMasterKeyGuide:SetShow(false)
    Panel_Window_SkillGroup:registerPadEvent(__eConsoleUIPadEvent_Up_Y, "")
    viewTabCount = viewTabCount - 1
  ...
  elseif 0 == playerType and (false == self._isReverseSkillType and 2 == cacheValue or true == self._isReverseSkillType and 3 == cacheValue) then
    self._selectedTree = cacheValue - 1
  else
    self._selectedTree = playerType
  end
  if false == self._isReverseSkillType then
    if true == isLearnedAwakenSkill and false == isLearnedSuccessionSkill then
      self._selectedTree = __eSkillTypeParam_Awaken
    end
  elseif false == isLearnedAwakenSkill and true == isLearnedSuccessionSkill then
  ...
  self:selectTree(-1)
  self:AlignkeyGuide(0)
  self:ChangeTabKeyGuidState()
  ToClient_UpdateOpenUICondition(__eCheckOpenUIType_SkillUI)
  self._isSkillSelect = false
  self._isAwakenGuide = false
  PaGlobal_SkillGroup:shiftKeyGuideShow()
end
function PaGlobal_SkillGroup:ChangeTabKeyGuidState()
  if false == self._isConsole then
    return
  end
  if nil ~= self._ui._stc_keyGuideLB and nil ~= self._ui._stc_keyGuideRB then
    if 1 < #self._useTab then
...
function PaGlobal_SkillGroup:close()
  ...
  if true == _ContentsGroup_SkillFilter and PaGlobal_SkillFilter_GetShow() then
    PaGlobal_SkillFilter_Close()
  end
  self:hideDeepeingSkillSlot()
  if self._isCloseFromDialog == true then
    Panel_Window_SkillGroup:SetShow(false)
    self._isCloseFromDialog = false
  else
  ...
  if true == _ContentsGroup_UsePadSnapping and PaGlobalFunc_ConsoleKeyGuide_SetRideState ~= nil then
...
function PaGlobal_SkillGroup:reset()
  for ii = 0, #self._frame do
    if true == PaGlobalFunc_SkillWindowScrollReset() then
  ...
  for tab = 0, #self._tab do
    for ii = 0, self._subGroupSize[tab] - 1 do
      if nil ~= self._subGroupButton[tab][ii] then
        self._subGroupButton[tab][ii]:SetCheck(true)
      end
    end
  end
  self:selectTab()
...
function PaGlobal_SkillGroup:updateEditMode(isEditMode, callUpdate)
...
function PaGlobal_SkillGroup:update()
  self:updateStat()
  self:updateSlot()
  self:updateDeepeningSkill()
  self:updateFrameControls()
  self:updateSkillTooltip()
end
function PaGlobal_SkillGroup:updateSkillTooltip()
  if Panel_Window_SkillGroup == nil then
    return
  end
  if Panel_Window_SkillGroup:GetShow() == false then
    return
  end
  if Panel_Tooltip_SkillGroup_forLearning:GetShow() == false then
  ...
  local skillKey = ToClient_getSkillKeyBySkillGroupNo(skillGroup._key, skillGroup:getSelectSkillLevel())
...
function PaGlobal_SkillGroup:refreshUpdateSkillList()
  if nil == Panel_Window_SkillGroup then
    return
  end
  if false == self._tab[self.eTabIndex.upgrade]:GetShow() then
    return
  end
  local selfPlayerWrapper = getSelfPlayer()
  if nil == selfPlayerWrapper then
...
function PaGlobal_SkillGroup:createSkillGroupControls(tableWrapper, parent, tab)
  ...
  if self.eTabIndex.weapon == tab or self.eTabIndex.awaken == tab then
    self._subGroupSize[tab] = subGroupSize
    self:createSubGroup(tab)
  else
    self._subGroupSize[tab] = 0
  end
  for index = 0, subGroupSize - 1 do
    local strKey = PAGetString(Defines.StringSheet_GAME, tableWrapper:getAtSubGroupStringKey(index))
    local isActiveItemGroup = false
    if strKey == PAGetString(Defines.StringSheet_GAME, "LUA_SKILLTREE_PANEL_NAME6") then
      isActiveItemGroup = true
    end
    self._subGroupList[tab][index] = {
      _name = strKey,
      _use = true,
      _isActiveItemGroup = isActiveItemGroup
    }
  end
    ...
    for col = 0, colMaxCount - 1 do
      ...
      if nil ~= cellWrapper and true == cellWrapper:isDefined() then
        ...
        if __eSkillGroupCellType_SkillGroup == cellType then
          ...
          if true == skillKey:isDefined() and false == PaGlobalFunc_Skill_IsBlockByConsoleSkill(skillKey:getSkillNo()) then
            self:createCell(parent, key, cellType, row, col, tab, cellWrapper)
          end
        end
      end
...
function PaGlobal_SkillGroup:getSubGroupName(tabIndex, groupIndex)
  if nil == self._subGroupList[tabIndex][groupIndex] then
    return ""
  end
  return self._subGroupList[tabIndex][groupIndex]._name
end
function PaGlobal_SkillGroup:offIndex(tabIndex, groupIndex)
  if nil == self._subGroupList[tabIndex][groupIndex] then
    return
  end
  self._subGroupList[tabIndex][groupIndex]._use = false
end
function PaGlobal_SkillGroup:onIndex(tabIndex, groupIndex)
  if nil == self._subGroupList[tabIndex][groupIndex] then
    return
  end
  self._subGroupList[tabIndex][groupIndex]._use = true
end
function PaGlobal_SkillGroup:getSubGroupCheck(tabIndex, groupIndex)
  if nil == self._subGroupList[tabIndex][groupIndex] then
    return false
  end
  return self._subGroupList[tabIndex][groupIndex]._use
end
function PaGlobal_SkillGroup:isActiveItemSubGroup(tabIndex, groupIndex)
  if nil == self._subGroupList[tabIndex][groupIndex] then
    return false
  end
  return self._subGroupList[tabIndex][groupIndex]._isActiveItemGroup
end
...
function PaGlobal_SkillGroup:updateFrameControls()
  ...
  if true == PaGlobalFunc_SkillGroup_IsSearchState() then
    return
  end
  local selfPlayerWrapper = getSelfPlayer()
  if nil == selfPlayerWrapper then
...
function PaGlobal_SkillGroup:updateSubGroupContentsCount(tableWrapper)
  for ii = 0, self._subGroupSize[self._currentTab] - 1 do
    self._subGroupContentsCount[self._currentTab][ii] = 0
  end
  local colMaxCount = tableWrapper:sizeX()
  local rowMaxCount = tableWrapper:sizeY()
  for row = 0, rowMaxCount - 1 do
    for col = 0, colMaxCount - 1 do
      local cellWrapper = tableWrapper:atWrapper(col, row)
      if nil ~= cellWrapper and true == cellWrapper:isDefined() then
        local cellType = cellWrapper:getType(0)
        local subGroupNo = cellWrapper:getSubGroupNo()
        local key = cellWrapper:getSkillGroupNo()
        if __eSkillGroupCellType_SkillGroup == cellType and nil ~= self._skillGroupList[key] and true == self._skillGroupList[key]._isValidLocalizing then
          self._subGroupContentsCount[self._currentTab][subGroupNo] = self._subGroupContentsCount[self._currentTab][subGroupNo] + 1
        end
      end
    end
  end
...
function PaGlobal_SkillGroup:updateSkillGroupControls(tableWrapper, parent)
  ...
  self:updateSubGroupContentsCount(tableWrapper)
  local colMaxCount = tableWrapper:sizeX()
  local rowMaxCount = tableWrapper:sizeY()
  local posX = 0
  local posY = 10
  ...
  local activeItemSkillStartPosY = 0
  ...
  for row = 0, rowMaxCount - 1 do
    ...
    for col = 0, colMaxCount - 1 do
      ...
      if nil ~= cellWrapper and true == cellWrapper:isDefined() then
        ...
        if self.eTabIndex.weapon == self._currentTab or self.eTabIndex.awaken == self._currentTab then
          if beforsubGroupNo ~= subGroupNo then
            beforsubGroupNo = subGroupNo
            isSubGroupFirstLine = true
          end
          if true == isSubGroupFirstLine then
            local buttonShow = self:updateSubGroup(subGroupNo, posY)
            if true == buttonShow then
              posY = posY + 50
              if PaGlobal_SkillGroup:isActiveItemSubGroup(self._currentTab, subGroupNo) == true then
                activeItemSkillStartPosY = posY
                activeItemSkillCount = 0
              end
            elseif PaGlobal_SkillGroup:isActiveItemSubGroup(self._currentTab, subGroupNo) == true then
              activeItemSkillStartPosY = posY - 80
            end
          end
          if 0 == row and 0 == col and true == self._isOpenedSubGroup[self._currentTab][0] then
            posY = posY - 80
          end
        end
        local cellShow = true
        if self.eTabIndex.weapon == self._currentTab or self.eTabIndex.awaken == self._currentTab then
          cellShow = self._isOpenedSubGroup[self._currentTab][subGroupNo]
        end
        if __eSkillGroupCellType_SkillGroup ~= cellType then
          key = tostring(self._currentTab) .. ":" .. tostring(col) .. "," .. tostring(row)
          for ii = 0, cellTypeSize - 1 do
            cellShow = showTypeIndex >= 0
            if (self.eTabIndex.weapon == self._currentTab or self.eTabIndex.awaken == self._currentTab) and cellShow then
              cellShow = self._isOpenedSubGroup[self._currentTab][subGroupNo]
            end
        ...
        if __eSkillGroupCellType_SkillGroup == cellType then
          ...
          local skillSSW = getSkillStaticStatus(skillNo, 1)
          local skillBranchType = skillSSW:getSkillAwakenBranchType()
          if false == PaGlobalFunc_Skill_IsBlockByConsoleSkill(skillNo) then
            ...
            if self._skillGroupList[key]._isActiveItemSkill == true and ToClient_IsActiveItemLearnSkillExceptAutoLearn(skillKey) == true then
              local tempcol = math.floor(activeItemSkillCount % 3) * 3
              local posItemSkillX = tempcol * 125 - 65 * math.floor(tempcol / 3) + 10
              local posItemSkillY = activeItemSkillStartPosY + math.floor(activeItemSkillCount / 3) * 2 * 40
              local isEquip = false
              for level = 1, self._skillGroupList[key]._maxLevel do
                local skillKey = ToClient_getSkillKeyBySkillGroupNo(self._skillGroupList[key]._key, level)
                isEquip = ToClient_IsActiveItemSkillEquipBySkillKey(skillKey)
                if isEquip == true then
                  self._skillGroupList[key]:selectLevel(level)
                  break
                end
              end
              if cellShow == true and isEquip == true then
                self._skillGroupList[key]:SetPosY(posItemSkillY)
                self._skillGroupList[key]:SetPosX(posItemSkillX)
                self._skillGroupList[key]:SetShow(true)
                activeItemSkillCount = activeItemSkillCount + 1
                posY = posItemSkillY
              else
                self._skillGroupList[key]:SetShow(false)
                if activeItemSkillCount == 0 then
                  posY = activeItemSkillStartPosY
                else
                  posY = posItemSkillY
                end
              end
...
function PaGlobal_SkillGroup:createCell(parent, key, cellType, row, col, tab, cellWrapper)
  ...
  if __eSkillGroupCellType_SkillGroup == cellType then
    if nil == self._skillGroupList[key] then
      ...
      local info = SkillGroup.new(key, parent, subGroupNo, tab)
      info:SetPosX(posX)
      info:SetPosY(posY)
      info:SetShow(true)
...
function PaGlobal_SkillGroup:selectTab(index)
  PaGlobal_SkillGroup:AlignkeyGuide(0)
  ...
  local selfPlayerWrapper = getSelfPlayer()
  local classType = selfPlayerWrapper:getClassType()
  if self._tab[self.eTabIndex.upgrade]:GetShow() == true then
    if index == self.eTabIndex.upgrade then
      self._upgradeSkillList:SetShow(true)
      self._findSkillNpcButton:SetShow(not self._isConsole)
      self._ui_console.stc_findSkillMasterKeyGuide:SetShow(self._isConsole)
      if _ContentsGroup_ClassPassive == true and (classType == __eClassType_Warrior or classType == __eClassType_Valkyrie) then
        if self._isConsole == false then
          self._findSkillNpcButton:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SKILLREINFORCE_TITLE"))
          self._findSkillNpcButton:addInputEvent("Mouse_LUp", "PaGlobalFunc_PaGlobal_ReinforceSkill_All_BySkillGroupPanel()")
        else
          self._ui_console.stc_findSkillMasterKeyGuide:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SKILLREINFORCE_TITLE"))
          Panel_Window_SkillGroup:registerPadEvent(__eConsoleUIPadEvent_Up_Y, "PaGlobalFunc_PaGlobal_ReinforceSkill_All_BySkillGroupPanel()")
        end
      elseif self._isConsole == false then
        self._findSkillNpcButton:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SKILLMASTER_NAVI"))
        self._findSkillNpcButton:addInputEvent("Mouse_LUp", "PaGlobalFunc_SkillGroup_OnClickedFindNpcButton()")
      else
        self._ui_console.stc_findSkillMasterKeyGuide:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SKILLMASTER_NAVI"))
        Panel_Window_SkillGroup:registerPadEvent(__eConsoleUIPadEvent_Up_Y, "PaGlobalFunc_SkillGroup_OnClickedFindNpcButton()")
      end
      if _ContentsGroup_ProjectAbyssOne == true and ToClient_isInAbyssOne() == true then
        self._findSkillNpcButton:SetShow(false)
...
function PaGlobal_SkillGroup:setCloseFromDialog(isCloseFromDialog)
  if false == Panel_Window_SkillGroup:GetShow() then
    return
  end
  self._isCloseFromDialog = isCloseFromDialog
end
...
function PaGlobal_SkillGroup:ShowGroupLearnLastSkillByGroup(skillGroup, isLearnSkill)
  if nil ~= skillGroup then
    ...
    if true ~= isLearnSkill then
      ...
      PaGlobalFunc_Skill_ChangeSkillShowTypeKeyGuide(currentSkillNo)
    end
...
function PaGlobal_SkillGroup:createDeepeningSkillSlot(skillSlotArea, skillSlotBg, skillNo, slotNo, index)
  ...
  if nil ~= skillTypeStaticWrapper and skillTypeStaticWrapper:isValidLocalizing() then
    ...
    if nil ~= slot.icon then
      slot.icon:addInputEvent("Mouse_LUp", "PaGlobal_SkillGroup:DeepeningSkillAction(" .. skillNo .. ")")
      if false == self._isConsole then
...
function PaGlobal_SkillGroup:initDeepeningSkillCellControl(parent)
  ...
  while 0 ~= skillNo do
    ...
    if nil ~= skillTypeStaticWrapper and true == skillTypeStaticWrapper:isValidLocalizing() then
      ...
      self._maxDeepeningSkillCount = self._maxDeepeningSkillCount + 1
      ...
      if nil ~= resultSkillStatic then
        ...
        if lv <= playerLevel then
          ...
          if true == skillLevelInfo._learnable and false == skillLevelInfo._usable then
            ...
            deepeningSkill._resultSlot[slotNo][jj].area:registerPadEvent(__eConsoleUIPadEvent_Up_A, "PaGlobal_SkillGroup:HandleEventLUp_LearnDeepeningSkill(" .. mainSkillNo .. "," .. subSkillNo .. "," .. fusionSkillNo .. "," .. slotNo .. "," .. jj .. ")")
          else
            ...
            deepeningSkill._resultSlot[slotNo][jj].area:registerPadEvent(__eConsoleUIPadEvent_Up_A, "")
          end
        else
          deepeningSkill._resultSlot[slotNo][jj].stc_learnable:SetShow(false)
          deepeningSkill._resultSlot[slotNo][jj].icon:addInputEvent("Mouse_LUp", "")
...
function PaGlobal_SkillGroup:updateDeepeningSkillFilter()
  local frame = self._deepeningSkill.frame
  local frameContent = frame:GetFrameContent()
  for slotNo = 0, self._maxDeepeningSkillCount - 1 do
    local stc_deepSkill = UI.getChildControl(frameContent, "Static_DeepSkill_" .. tostring(slotNo))
    for jj = 0, self._deepeningSkill._maxCount[slotNo] - 1 do
      local rdo_resultSkillSlotArea = UI.getChildControl(stc_deepSkill, "RadioButton_ResultSlot_" .. tostring(jj))
      rdo_resultSkillSlotArea:EraseAllEffect()
      local isShowFilterEffect = false
      local fusionSkillNo = ToClient_getFusionSkillNo(slotNo, jj)
      local skillSSW = getSkillStaticStatus(fusionSkillNo, 1)
      isShowFilterEffect = PaGlobalFunc_SkillFilter_All_isFilterSkill(skillSSW, fusionSkillNo)
      if true == isShowFilterEffect then
        rdo_resultSkillSlotArea:AddEffect("fUI_NewSkill_Guide_03A", true, 0, 0)
      end
    end
  end
end
  ...
  if 0 == skillNo or false == isLearn then
    if nil == container[index] then
      ...
      if nil ~= slot.icon then
        ...
        slot.icon:addInputEvent("Mouse_On", "PaGlobal_SkillGroup:AlignkeyGuide(1," .. index .. ")")
        slot.icon:addInputEvent("Mouse_Out", "")
        slot.icon:addInputEvent("Mouse_PressMove", "")
        slot.icon:addInputEvent("Mouse_RUp", "")
        if true == self._isConsole then
          slot.icon:registerPadEvent(__eConsoleUIPadEvent_Y, "")
        end
        slot.icon:SetPosX(slot.icon:GetPosX() + 1)
      end
    ...
    if nil ~= skillTypeStaticWrapper and skillTypeStaticWrapper:isValidLocalizing() then
      ...
      if nil ~= slot.icon then
        ...
        if true == self._isConsole then
          slot.icon:registerPadEvent(__eConsoleUIPadEvent_Y, "HandleMRUp_DeepeningSkillGroupWindow_ClearButtonClick(" .. skillNo .. ")")
        else
          slot.icon:addInputEvent("Mouse_On", "HandleMOver_SkillWindow_ToolTipShow(" .. skillNo .. ", false, \"SkillBox\")")
          slot.icon:addInputEvent("Mouse_Out", "HandleMOver_SkillWindow_ToolTipHide(" .. skillNo .. ", \"SkillBox\")")
        end
...
function HandleMRUp_DeepeningSkillGroupWindow_ClearButtonClick(skillNo)
  HandleMRUp_SkillGroupWindow_ClearButtonClick(skillNo, false)
end
  ...
  for ii = 0, self._maxDeepeningSkillCount - 1 do
    ...
    for jj = 0, deepeningSkill._maxCount[ii] - 1 do
      ...
      if nil ~= deepSkill then
        ...
        if true == self._isConsole then
          deepeningSkill._mainSlot[ii].areaPanel:addInputEvent("Mouse_LUp", "PaGlobal_SkillGroup:HandleEventLUp_DeepeningSubManSkillSlotClick(" .. mainSkillNo .. ")")
          if false == isLearnedMainSkill then
            deepeningSkill._mainSlot[ii].icon:addInputEvent("Mouse_On", "PaGlobal_SkillGroup:AlignkeyGuide(3, nil, false, false)")
          else
            deepeningSkill._mainSlot[ii].icon:addInputEvent("Mouse_On", "PaGlobal_SkillGroup:AlignkeyGuide(0)")
          end
          deepeningSkill._subSlot[ii][jj].areaPanel:addInputEvent("Mouse_LUp", "PaGlobal_SkillGroup:HandleEventLUp_DeepeningSubManSkillSlotClick(" .. subSkillNo .. ")")
          if false == isLearnedSubSkill then
            deepeningSkill._subSlot[ii][jj].icon:addInputEvent("Mouse_On", "PaGlobal_SkillGroup:AlignkeyGuide(3, nil, false, false)")
          else
            deepeningSkill._subSlot[ii][jj].icon:addInputEvent("Mouse_On", "PaGlobal_SkillGroup:AlignkeyGuide(0)")
          end
          local isCanLearnedFusionSkill = true == isLearnedMainSkill and true == isLearnedSubSkill
          deepeningSkill._resultSlot[ii][jj].areaPanel:addInputEvent("Mouse_On", "PaGlobal_SkillGroup:AlignkeyGuide(3, nil," .. tostring(isLearnedFusionSkill) .. "," .. tostring(isCanLearnedFusionSkill) .. ")")
        end
        ...
        if true == isLearnedFusionSkill then
          ...
          deepeningSkill._resultSlot[ii][jj].area:registerPadEvent(__eConsoleUIPadEvent_Y, "HandleMRUp_DeepeningSkillGroupWindow_ClearButtonClick(" .. fusionSkillNo .. ")")
        ...
        if true == skillLevelInfo._learnable and false == skillLevelInfo._usable then
          ...
          if false == isLearnedMainSkill or false == isLearnedSubSkill then
            ...
            deepeningSkill._resultSlot[ii][jj].area:registerPadEvent(__eConsoleUIPadEvent_Up_A, "")
            ...
            deepeningSkill._resultSlot[ii][jj].area:registerPadEvent(__eConsoleUIPadEvent_Up_A, "PaGlobal_SkillGroup:HandleEventLUp_LearnDeepeningSkill(" .. mainSkillNo .. "," .. subSkillNo .. "," .. fusionSkillNo .. "," .. ii .. "," .. jj .. ")")
          end
        else
          deepeningSkill._resultSlot[ii][jj].stc_learnable:SetShow(false)
        end
...
function PaGlobal_SkillGroup:HandleEventLUp_LearnDeepeningSkill(mainSkillNo, subSkillNo, resultSkillNo, slotNo, index)
  if true == self._isConsole and self._selectSkillNo ~= resultSkillNo then
    return
  end
  ...
  if skillTypeStaticWrapper:isValidLocalizing() then
    ...
    if nil ~= slot then
      ...
      if nil ~= slot.icon then
        ...
        slot.icon:addInputEvent("Mouse_RUp", "HandleMRUp_SkillGroupWindow_ClearButtonClick(" .. skillNo .. ", false)")
...
function PaGlobal_SkillGroup:SkillGroupWindowEffect(posX, posY, skillGroup, isOn, skillType, effectType)
  ...
  if nil ~= self._skillGroupList[skillGroup._key] then
    ...
    local tabIndex = self._skillGroupList[skillGroup._key]._tab
    if false == self._isOpenedSubGroup[tabIndex][subGroupNo] then
      self._subGroupButton[tabIndex][subGroupNo]:SetCheck(true)
      PaGlobal_SkillGroup:updateFrameControls()
    end
...
function PaGlobal_SkillGroup:HandleEventLUp_SkillGroup(key, nextLevelKey)
  ...
  local skillGroup = self._skillGroupList[key]
  if nil ~= nextLevelKey and (false == self._isConsole or true == self._isSkillSelect) then
    PaGlobal_SkillGroup:HandleEventLUpLearnSkill(nextLevelKey)
    return
  end
  self._isSkillSelect = true
  ...
  PaGlobalFunc_Skill_ChangeSkillShowTypeKeyGuide(self._selectSkillNo)
...
function PaGlobal_SkillGroup:HandleEventLUp_EditMode()
  ...
  self:updateEditMode(not self._isEditMode, false)
end
...
function PaGlobal_SkillGroup:HandleEventLUp_PrevLevelButton(key)
  self._skillGroupList[key]:HandleEventLUp_ClickedLevelButton(false)
end
function PaGlobal_SkillGroup:HandleEventLUp_NextLevelButton(key)
  self._skillGroupList[key]:HandleEventLUp_ClickedLevelButton(true)
end
function PaGlobal_SkillGroup:HandleEventLUpLearnSkill(skillNo, soundPlay)
  if true == self._isConsole and false == self._isSkillSelect then
    self._isSkillSelect = true
    return
  end
  local skillTypeStaticWrapper = getSkillTypeStaticStatus(skillNo)
  ...
  local function DolearnSkill(isAll)
    local isSucess = PaGlobal_SkillGroup:SkillGroupWindow_LearnButtonClick(skillNo, isAll)
...
function PaGlobal_SkillGroup:HandleMOver_SkillGroupOn(key)
  if true == self._isConsole and key ~= self._mouseOnSkillGroupNo then
    self._isSkillSelect = false
  end
  local skillGroup = self._skillGroupList[key]
  ...
  if skillGroup._isActiveItemSkill == true then
    skillGroup._btn_prev:SetShow(false)
    skillGroup._btn_next:SetShow(false)
  end
...
function PaGlobal_SkillGroup:HandleMOver_SkillGroupOut(key)
  ...
  skillGroup:showBlackSpiritLock(false)
  skillGroup._btn_prev:SetShow(false)
  skillGroup._btn_next:SetShow(false)
end
...
function PaGlobal_SkillGroup:DefaultPanelResize()
  ...
  for ii = 0, #self._frame do
    ...
    if true == self._isConsole then
      newSizeY = newSizeY + bottomUiSizeY - 20
    end
  ...
  self._upgradeSkillList:SetPosY(self._ui._stc_TopFuncBg:GetSizeY() + self._ui._stc_TopFuncBg:GetPosY() + 1)
  self._upgradeSkillList:SetSize(self._upgradeSkillList:GetSizeX(), screenSizeY - self._upgradeSkillList:GetPosY() - bottomUiSizeY)
  PaGlobal_SkillGroup:setDeepSkillFramePos()
  if true == self._isConsole and nil ~= self._ui_console.stc_CamerakeyGuideBg then
    if false == self._isWindow then
      local spanY = getScreenSizeY() - Panel_Window_SkillGroup:GetSizeY() - 20
      self._ui_console.stc_CamerakeyGuideBg:SetSpanSize(self._ui_console.stc_CamerakeyGuideBg:GetSpanSize().x, -spanY)
      self._ui_console.stc_CamerakeyGuideBg:SetShow(true)
    else
      self._ui_console.stc_CamerakeyGuideBg:SetShow(false)
    end
  end
end
function PaGlobal_SkillGroup:setDeepSkillFramePos()
  local deepSkillArea = self._deepeningSkill.area
  local deepSkillFrame = self._deepeningSkill.frame
  if nil == deepSkillArea or nil == deepSkillFrame then
    return
  end
  local screenSizeY = getScreenSizeY()
  local posY = deepSkillArea:GetPosY() + deepSkillFrame:GetPosY()
  local bottomUiSizeY = self._ui._stc_bottomArea:GetSizeY()
  local newSizeY = screenSizeY - posY - bottomUiSizeY
  deepSkillFrame:SetSize(deepSkillFrame:GetSizeX(), newSizeY)
  self._ui._stc_bottomArea:SetPosY(screenSizeY - bottomUiSizeY)
end
function PaGlobal_SkillGroup:createSubGroup(tab)
  for ii = 0, self._subGroupSize[tab] - 1 do
    if nil == self._subGroupButton[tab][ii] then
      self._subGroupButton[tab][ii] = UI.cloneControl(self._subSkillGroupControl, self._frame[tab]:GetFrameContent(), "SkillSubGroupButton_" .. ii)
      self._subGroupButton[tab][ii]:addInputEvent("Mouse_On", "PaGlobal_SkillGroup:AlignkeyGuide(0)")
      self._subGroupButton[tab][ii]:addInputEvent("Mouse_LUp", "PaGlobal_SkillGroup:updateFrameControls()")
      self._subGroupButton[tab][ii]:SetCheck(true)
      self._isOpenedSubGroup[tab][ii] = true
    end
  end
end
function PaGlobal_SkillGroup:updateSubGroup(subGroupNo, posY)
  ...
  if self.eTabIndex.weapon ~= currentTab and self.eTabIndex.awaken ~= currentTab then
    return false
  end
  local subGroupButton = self._subGroupButton[currentTab][subGroupNo]
  if nil == subGroupButton then
    return false
  end
  local buttonShow = false
  local contentsCount = self._subGroupContentsCount[currentTab][subGroupNo]
  if 0 == contentsCount then
    subGroupButton:SetShow(false)
    subGroupButton:SetCheck(false)
    buttonShow = false
  elseif PaGlobal_SkillGroup:isActiveItemSubGroup(currentTab, subGroupNo) == true and ToClient_IsExistActiveItemSkillEquip() == false then
    subGroupButton:SetShow(false)
    buttonShow = false
  elseif PaGlobal_SkillGroup:isActiveItemSubGroup(currentTab, subGroupNo) == true and ToClient_IsExistActiveItemSkillEquip() == true then
    if PaGlobalFunc_Skill_IsEquipActiveItemSkillExcept() == false then
      subGroupButton:SetShow(false)
      buttonShow = false
    else
      subGroupButton:SetShow(true)
      subGroupButton:SetPosY(posY)
      buttonShow = true
    end
  else
    subGroupButton:SetShow(true)
  ...
  local txt_subGroupName = UI.getChildControl(subGroupButton, "StaticText_SkillSubName")
  if nil ~= txt_subGroupName then
    txt_subGroupName:SetText(self:getSubGroupName(currentTab, subGroupNo))
  end
  self._isOpenedSubGroup[currentTab][subGroupNo] = subGroupButton:IsCheck()
  return buttonShow
end
function PaGlobal_SkillGroup:CheckLearnAbleSkillCount()
  ...
  if classType >= 0 then
    self._learnAbleSkillCount = ToClient_getLearnableSkillCount(classType)
  end
end
...
function PaGlobal_SkillGroup:skillpresetToolTipShow(slotNo)
  ...
  if self._presetSlotMaxCount == slotNo then
    ...
    local isSet, presetMemo = PaGlobalFunc_SkillPresetMemo_IsSetMemo(slotNo)
    if false == isSet then
...
function PaGlobal_SkillGroup:skillpresetSaveOpen()
  if true == _ContentsGroup_SkillPreset and PaGlobal_SkillPreset_Open ~= nil then
...
function PaGlobal_SkillGroup:SelectAwakenTree()
  ...
  if true == self._isReverseSkillType then
    local selfPlayerWrapper = getSelfPlayer()
    if nil ~= selfPlayerWrapper then
      local classType = selfPlayerWrapper:getClassType()
      local awakenRoot = ToClient_getAwakenRootSkillGroupNo(classType)
  ...
  if true == PaGlobal_SkillGroup._isAwakenGuide then
    PaGlobal_SkillGroup:clickTree(__eSkillTypeParam_Awaken)
    PaGlobal_SkillGroup._isAwakenGuide = false
  end
end
...
function PaGlobal_SkillGroup:clickTree(index)
  ...
  if (index == 1 or index == 2) and ToClient_IsInstanceFieldPlayerbyContentsType(__eInstanceContentsType_AbyssOne) == true then
...
function PaGlobal_SkillGroup:selectTree(index)
  ...
  if true == _ContentsGroup_SkillComboGuide and PaGlobal_SkillCombo_UpdateSkillCombo ~= nil then
    PaGlobal_SkillCombo_UpdateSkillCombo()
  end
  if nil ~= Phantom_Locate and true == self._isWindow then
    if nil ~= Panel_MainStatus_Remaster and true == Panel_MainStatus_Remaster:GetShow() then
...
function PaGlobal_SkillGroup:HandleMRUp_SuccessionTreeButtonClick()
  ...
  local successionRoot = ToClient_getSuccessionRootSkillGroupNo(classType)
  local skillKey = ToClient_getSkillKeyBySkillGroupNo(successionRoot, 1)
  HandleMRUp_SkillGroupWindow_ClearButtonClick(skillKey:getSkillNo(), false)
end
...
function PaGlobal_SkillGroup:checkIsViewTreeTabIcon()
  ...
  if 0 == successionRoot then
    ...
    self._deepeningSkill.area:SetSpanSize(self._deepeningSkill.area:GetSpanSize().x, self._defaultDeepSkillAreaSpanY - self._ui._rdo_treeBg:GetSizeY() - 10)
    self:setDeepSkillFramePos()
    return
  end
  ...
  local isLearnedAwakenSkill = ToClient_isLearnedSkill(awakenSkillNo)
  local succesionNeedSkillNo = 0
  local succesionSkillKey = ToClient_getSkillKeyBySkillGroupNo(successionRoot, 1)
  local succesionSkillNo = succesionSkillKey:getSkillNo()
  local skillTypeSSW = getSkillTypeStaticStatus(succesionSkillNo)
  local skillSSW = getSkillStaticStatus(succesionSkillNo, 1)
  if nil ~= skillSSW then
    local needSkill = skillSSW:getAllPreRequiredSkillNoList()
    if nil ~= needSkill and nil ~= needSkill[0] then
      succesionNeedSkillNo = needSkill[0]:getSkillNo()
    end
  end
  if true == self._isReverseSkillType then
    if false == isLearnedAwakenSkill then
      local awakenSkillTypeSSW = getSkillTypeStaticStatus(awakenSkillNo)
      local awakenSkillSSW = getSkillStaticStatus(awakenSkillNo, 1)
      if nil ~= awakenSkillSSW then
        local awakenNeedSkill = awakenSkillSSW:getAllPreRequiredSkillNoList()
        if nil ~= awakenNeedSkill and nil ~= awakenNeedSkill[0] then
          local awakenNeedSkillNo = awakenNeedSkill[0]:getSkillNo()
          isLearnedAwakenSkill = ToClient_isLearnedSkill(awakenNeedSkillNo)
        end
      end
    end
    local isLearnedSuccesionSkill = false
    if 0 == succesionNeedSkillNo then
      isLearnedSuccesionSkill = ToClient_isLearnedSkill(succesionSkillNo)
    else
      isLearnedSuccesionSkill = ToClient_isLearnedSkill(succesionNeedSkillNo)
    end
    self._tree[0]._panel:SetShow(isLearnedAwakenSkill)
    self._tree[0]._lock:SetShow(not isLearnedAwakenSkill)
    self._tree[1]._panel:SetShow(isLearnedSuccesionSkill)
    self._tree[1]._lock:SetShow(not isLearnedSuccesionSkill)
    if false == isLearnedAwakenSkill and false == isLearnedSuccesionSkill then
      self._isShowTreeSelectBookmark = 0
    elseif true == isLearnedAwakenSkill and true == isLearnedSuccesionSkill then
  ...
  local isLearnedSuccesionSkill = ToClient_isLearnedSkill(succesionNeedSkillNo)
  if false == isLearnedSuccesionSkill then
...
function PaGlobal_SkillGroup:HandleMOn_SearchButtonOn()
  TooltipSimple_Show(self._ui._stc_playShow, PAGetString(Defines.StringSheet_GAME, "LUA_SKILLFILTER_DESC"))
end
function PaGlobal_SkillGroup:HandleMOut_SearchButtonOut()
  TooltipSimple_Hide()
end
function PaGlobal_SkillGroup:HandleMOn_FilterButtonOn()
  TooltipSimple_Show(self._ui._stc_playShow, PAGetString(Defines.StringSheet_RESOURCE, "PANEL_SKILLFILTER_TITLE"), PAGetString(Defines.StringSheet_GAME, "LUA_SKILLFILTER_DESC"))
end
function PaGlobal_SkillGroup:HandleMOut_FilterButtonOut()
  TooltipSimple_Hide()
end
function PaGlobal_SkillGroup:HandleMOn_AllResetButtonOn()
  TooltipSimple_Show(self._ui._stc_playShow, PAGetString(Defines.StringSheet_RESOURCE, "PANEL_MARKETPLACE_FAVORITE_ALL_RESET_BTN"))
end
function PaGlobal_SkillGroup:HandleMOut_AllResetButtonOut()
  TooltipSimple_Hide()
  return
end
  ...
  for ii = 0, self._maxDeepeningSkillCount - 1 do
    if nil ~= parent._stc_skillIcon[ii] then
      ...
      if 0 == skillNo then
        parent._stc_skillIcon[ii]:clearSkill()
        parent._stc_skillIcon[ii].icon:SetShow(false)
        parent._stc_skillIcon[ii].icon:addInputEvent("Mouse_LUp", "")
        parent._stc_skillIcon[ii].icon:addInputEvent("Mouse_On", "")
        parent._stc_skillIcon[ii].icon:addInputEvent("Mouse_Out", "")
        parent._stc_skillIcon[ii].icon:addInputEvent("Mouse_PressMove", "")
        parent._stc_skillIcon[ii].icon:addInputEvent("Mouse_RUp", "")
