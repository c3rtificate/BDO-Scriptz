PaGlobal_SkillGroup_CoolTimeSlot = {
  ...
  _copyUI = {
    ...
    _base_Memo = UI.getChildControl(Panel_SkillGroup_CoolTimeSlot, "Static_EditMemoBox")
  },
  ...
  _comboBoxString = {
    ...
    [11] = PAGetString(Defines.StringSheet_GAME, "LUA_UI_SETTING_SKILLCOLLTIMEQUICKSLOT") .. tostring(11),
    [12] = PAGetString(Defines.StringSheet_GAME, "LUA_UI_SETTING_SKILLCOLLTIMEQUICKSLOT") .. tostring(12),
    [13] = PAGetString(Defines.StringSheet_GAME, "LUA_UI_SETTING_SKILLCOLLTIMEQUICKSLOT") .. tostring(13),
    [14] = PAGetString(Defines.StringSheet_GAME, "LUA_UI_SETTING_SKILLCOLLTIMEQUICKSLOT") .. tostring(14),
    [15] = PAGetString(Defines.StringSheet_GAME, "LUA_UI_SETTING_SKILLCOLLTIMEQUICKSLOT") .. tostring(15),
    [16] = PAGetString(Defines.StringSheet_GAME, "LUA_UI_SETTING_SKILLCOLLTIMEQUICKSLOT") .. tostring(16),
    [17] = PAGetString(Defines.StringSheet_GAME, "LUA_UI_SETTING_SKILLCOLLTIMEQUICKSLOT") .. tostring(17),
    [18] = PAGetString(Defines.StringSheet_GAME, "LUA_UI_SETTING_SKILLCOLLTIMEQUICKSLOT") .. tostring(18),
    [19] = PAGetString(Defines.StringSheet_GAME, "LUA_UI_SETTING_SKILLCOLLTIMEQUICKSLOT") .. tostring(19),
    [20] = PAGetString(Defines.StringSheet_GAME, "LUA_UI_SETTING_SKILLCOLLTIMEQUICKSLOT") .. tostring(20)
  },
