...
function PaGlobalFunc_BlackSpiritSkillLock_All_GetShow()
  if Panel_Window_BlackSpiritSkillLock_All == nil then
    return false
  end
  return Panel_Window_BlackSpiritSkillLock_All:GetShow()
end
...
function HandleEventOnOut_BlackSpiritSkillLock_All_Tooltip(isShow, skillNo)
  if false == isShow then
    Panel_SkillTooltip_Hide()
    return
  end
  local content = PaGlobal_BlackSpiritSkillLock_All._ui.list2_skill:GetContentByKey(0)
