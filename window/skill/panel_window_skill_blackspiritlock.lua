...
function PaGlobal_BlackSpiritSkillLock:init()
  self._ui._list2_SkillList:registEvent(__ePAUIList2EventType_LuaChangeContent, "BlackSpiritSkillList")
  self._ui._list2_SkillList:createChildContent(__ePAUIList2ElementManagerType_List)
...
function PaGlobal_BlackSpiritSkillLock:open(whereType)
  ...
  elseif 1 == whereType then
    ...
    if 2 == whereType and false == _ContentsGroup_UISkillGroupTreeLayOut then
...
function PaGlobal_BlackSpiritSkillLock:close()
  ...
  if false == _ContentsGroup_UISkillGroupTreeLayOut and Panel_Window_Skill:GetShow() then
    EnableSkillShowFunc()
  end
end
...
function FGlobal_BlackSpiritSkillLock_GetShow()
  if Panel_Window_Skill_BlackSpiritLock == nil then
    return false
  end
  return Panel_Window_Skill_BlackSpiritLock:GetShow()
end
