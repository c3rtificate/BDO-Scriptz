PaGlobal_SkillGroup = {
  ...
  _ui = {
    ...
    _txt_playShow = nil,
    _focusEffect = nil,
    _stc_skillShiftGuideMain = nil,
    _stc_skillShiftGuideBG = nil,
    _mtxt_skillShiftGuide = nil
  },
  _ui_console = {stc_keyGuideBg = nil, stc_CamerakeyGuideBg = nil},
  _tab = {},
  _useTab = {},
  _frame = {},
  _frameScroll = {},
  ...
  _upgradeSkillList = nil,
  _findSkillNpcButton = nil,
  ...
  _defaultKeyGuideBGSizeX = 0,
  _defaultDeepSkillAreaSpanY = 0,
  _curSkillShowType = 0,
  eSkillShowTypeIndex = {
    baseSkill = 0,
    blackSpiritSkill = 1,
