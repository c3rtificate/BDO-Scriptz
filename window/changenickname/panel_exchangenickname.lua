...
function HandleClicked_ExchangeNickname_Apply()
  ...
  local leftData = getCharacterDataByIndex(self._leftSelectIndex, __ePlayerCreateNormal)
  ...
  local rightData = getCharacterDataByIndex(self._rightSelectIndex, __ePlayerCreateNormal)
