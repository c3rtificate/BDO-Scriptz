...
function changeNickname:init()
  ...
  changeName.desc:SetTextMode(__eTextMode_AutoWrap)
  changeName.alert:SetTextMode(__eTextMode_AutoWrap)
...
function FromClient_ShowChangeNickname(param)
  ...
  if 0 == _nameType then
    ...
    if isGameTypeKorea() or isGameTypeTaiwan() or isGameTypeTH() or isGameTypeRussia() or isGameTypeID() or isGameTypeTR() or isGameTypeASIA() then
