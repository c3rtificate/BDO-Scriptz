PaGlobal_MiniGame_YachtDice = {
  ...
  _currentGameDbType = __eMiniGameDBType_Count,
  _symbolString = {
  ...
  _isTimeOut = false,
  _isPvPFirstTurn = false,
  _timerConterPosToMe_X = 0,
  _timerConterPosToMe_Y = 0,
  _timerConterPosToYou_X = 0,
  _timerConterPosToYou_Y = 0,
  _isOpenByNpc = false,
  _highPointControl = nil,
  _highPointEffectNo = nil,
  _bubbleTextShowTime = 3,
  _isShowPlayerBubbleText = false,
  _isShowNpcBubbleText = false,
  _playerBubbleTextDeltaTime = 0,
  _npcBubbleTextDeltaTime = 0,
  _isConsole = false,
