...
function competitionGameJoinDesc:initialize()
  ...
  self.txt_Desc:SetTextMode(__eTextMode_AutoWrap)
  ...
  for Index = 0, 6 do
    ...
    local temp = {}
    temp._slot_BG = UI.createControl(__ePAUIControl_Static, Panel_CompetitionGame_JoinDesc, "CompetitionReservation_SlotBg_" .. Index)
    ...
    temp._slot_txt_DayOfWeek = UI.createControl(__ePAUIControl_StaticText, temp._slot_BG, "CompetitionReservation_SlotDayOfWeek_" .. Index)
    ...
    temp._slot_txt_Date = UI.createControl(__ePAUIControl_StaticText, temp._slot_BG, "CompetitionReservation_SlotDate_" .. Index)
    ...
    temp._slot_txt_GuildName = UI.createControl(__ePAUIControl_StaticText, temp._slot_BG, "CompetitionReservation_SlotGuildName_" .. Index)
    ...
    temp._slot_btn_Reserve = UI.createControl(__ePAUIControl_Button, temp._slot_BG, "CompetitionReservation_SlotReserveBtn_" .. Index)
    ...
    temp._slot_btn_Reserve:SetTextMode(__eTextMode_LimitText)
...
function FromClient_CompetitionJoin_HandleChangeReservationInfo(dayIndex, dayValue, dayOfWeekValue, reservationGuildName, guildNo, isReservation)
  ...
  local isRightCompetition = false
  if _ContentsGroup_GuildAuthoritySeparation == true then
    isRightCompetition = PaGlobalFunc_Guild_Authorization_RightCheck(__eGuildRightNew_Competition)
  else
    isRightCompetition = PaGlboalFunc_CompetitionGameJoinDesc_GetRightCheck(__eGuildRightType_Competition)
  end
  ...
  if nil == myGuildInfo or false == isRightCompetition then
...
function FGlobal_Panel_CompetitionGame_ReservationArsha(reservationIndex, isReservation)
  ...
  if false == isRightCompetition then
    if _ContentsGroup_GuildAuthoritySeparation == true then
      PaGlobalFunc_Guild_Authorization_ShowErrMessage(__eGuildRightNew_Competition)
    else
...
function PaGlobaFunc_CompetitionGameJoinDesc_ESCMenuFunc()
...
function PaGlboalFunc_CompetitionGameJoinDesc_GetRightCheck(eRightType)
  ...
  local function OriginalCheck()
    ...
    if __eGuildRightType_Competition == eRightType then
