...
function CompetitionGame_TeamUi_Round()
  ...
  for Index = 0, teamCount - 1 do
    ...
    for userIndex = 0, teamUserCount - 1 do
      local temp = {}
      temp._teamBg = UI.createControl(__ePAUIControl_Static, Panel_CompetitionGame_TeamUi, "CompetitionGame_TeamBg_" .. Index .. "_" .. userIndex)
      ...
      temp._classIcon = UI.createControl(__ePAUIControl_Static, temp._teamBg, "CompetitionGame_TeamClassIcon_" .. Index .. "_" .. userIndex)
      CopyBaseProperty(teamMember._classIcon, temp._classIcon)
      temp._gaugeBlackBG = UI.createControl(__ePAUIControl_Static, temp._teamBg, "CompetitionGame_gaugeBlackBG_" .. Index .. "_" .. userIndex)
      CopyBaseProperty(teamMember._gaugeBlackBG, temp._gaugeBlackBG)
      temp._gaugeBlack = UI.createControl(__ePAUIControl_CircularProgress, temp._teamBg, "CompetitionGame_gaugeBlack_" .. Index .. "_" .. userIndex)
      CopyBaseProperty(teamMember._gaugeBlack, temp._gaugeBlack)
      temp._progressBg = UI.createControl(__ePAUIControl_Static, temp._teamBg, "CompetitionGame_TeamClassProgressBg_" .. Index .. "_" .. userIndex)
      ...
      temp._progress = UI.createControl(__ePAUIControl_Progress2, temp._teamBg, "CompetitionGame_TeamClassProgress_" .. Index .. "_" .. userIndex)
      ...
      temp._hpNumber = UI.createControl(__ePAUIControl_StaticText, temp._teamBg, "CompetitionGame_HPNumber_" .. Index .. "_" .. userIndex)
      CopyBaseProperty(teamMember._hpNumber, temp._hpNumber)
      temp._level = UI.createControl(__ePAUIControl_StaticText, temp._teamBg, "CompetitionGame_TeamClassLevel_" .. Index .. "_" .. userIndex)
      CopyBaseProperty(teamMember._level, temp._level)
      temp._name = UI.createControl(__ePAUIControl_StaticText, temp._teamBg, "CompetitionGame_TeamClassName_" .. Index .. "_" .. userIndex)
      CopyBaseProperty(teamMember._name, temp._name)
      temp._leftUserCount = UI.createControl(__ePAUIControl_StaticText, temp._teamBg, "CompetitionGame_LeftUserCount_" .. Index .. "_" .. userIndex)
      CopyBaseProperty(teamMember._leftUserCount, temp._leftUserCount)
      temp._skillIcon1 = UI.createControl(__ePAUIControl_StaticText, temp._teamBg, "CompetitionGame_skillIcon1_" .. Index .. "_" .. userIndex)
      CopyBaseProperty(teamMember._skillIcon1, temp._skillIcon1)
      temp._skillIcon2 = UI.createControl(__ePAUIControl_StaticText, temp._teamBg, "CompetitionGame_skillIcon2_" .. Index .. "_" .. userIndex)
      CopyBaseProperty(teamMember._skillIcon2, temp._skillIcon2)
      temp._skillIcon3 = UI.createControl(__ePAUIControl_StaticText, temp._teamBg, "CompetitionGame_skillIcon3_" .. Index .. "_" .. userIndex)
      CopyBaseProperty(teamMember._skillIcon3, temp._skillIcon3)
      temp._skillIcon4 = UI.createControl(__ePAUIControl_StaticText, temp._teamBg, "CompetitionGame_skillIcon4_" .. Index .. "_" .. userIndex)
      CopyBaseProperty(teamMember._skillIcon4, temp._skillIcon4)
      temp._skillIcon5 = UI.createControl(__ePAUIControl_StaticText, temp._teamBg, "CompetitionGame_skillIcon5_" .. Index .. "_" .. userIndex)
      CopyBaseProperty(teamMember._skillIcon5, temp._skillIcon5)
      temp._gaugeRate = UI.createControl(__ePAUIControl_StaticText, temp._teamBg, "CompetitionGame_gaugeBlackRate_" .. Index .. "_" .. userIndex)
      CopyBaseProperty(teamMember._gaugeRate, temp._gaugeRate)
      temp._border = UI.createControl(__ePAUIControl_Static, temp._teamBg, "CompetitionGame_TeamClassBorder_" .. Index .. "_" .. userIndex)
...
function CompetitionGame_TeamUi_FreeForAll()
  ...
  for teamIndex = 0, teamCount - 1 do
    ...
    local temp = {}
    temp._teamBg = UI.createControl(__ePAUIControl_Static, Panel_CompetitionGame_TeamUi, "CompetitionGame_TeamBg_" .. teamIndex)
    CopyBaseProperty(teamMemberBg, temp._teamBg)
    ...
    temp._teamBg:getBaseTexture():setUV(x1, y1, x2, y2)
    temp._teamBg:setRenderTexture(temp._teamBg:getBaseTexture())
    temp._classIcon = UI.createControl(__ePAUIControl_Static, temp._teamBg, "CompetitionGame_TeamClassIcon_" .. teamIndex)
    CopyBaseProperty(teamMember._classIcon, temp._classIcon)
    temp._gaugeBlackBG = UI.createControl(__ePAUIControl_Static, temp._teamBg, "CompetitionGame_gaugeBlackBG_" .. teamIndex)
    CopyBaseProperty(teamMember._gaugeBlackBG, temp._gaugeBlackBG)
    temp._gaugeBlack = UI.createControl(__ePAUIControl_CircularProgress, temp._teamBg, "CompetitionGame_gaugeBlack_" .. teamIndex)
    CopyBaseProperty(teamMember._gaugeBlack, temp._gaugeBlack)
    temp._progressBg = UI.createControl(__ePAUIControl_Static, temp._teamBg, "CompetitionGame_TeamClassProgressBg_" .. teamIndex)
    CopyBaseProperty(teamMember._progressBg, temp._progressBg)
    temp._progressBg:ChangeTextureInfoName(controlTexture.path)
    local x1, y1, x2, y2 = setTextureUV_Func(temp._progressBg, controlTexture.progressBg[textureIndex][1], controlTexture.progressBg[textureIndex][2], controlTexture.progressBg[textureIndex][3], controlTexture.progressBg[textureIndex][4])
    temp._progressBg:getBaseTexture():setUV(x1, y1, x2, y2)
    temp._progressBg:setRenderTexture(temp._progressBg:getBaseTexture())
    temp._progress = UI.createControl(__ePAUIControl_Progress2, temp._teamBg, "CompetitionGame_TeamClassProgress_" .. teamIndex)
    CopyBaseProperty(teamMember._hpProgress, temp._progress)
    temp._progress:ChangeTextureInfoName(controlTexture.path)
    local x1, y1, x2, y2 = setTextureUV_Func(temp._progress, controlTexture.progress[textureIndex][1], controlTexture.progress[textureIndex][2], controlTexture.progress[textureIndex][3], controlTexture.progress[textureIndex][4])
    temp._progress:getBaseTexture():setUV(x1, y1, x2, y2)
    temp._progress:setRenderTexture(temp._progress:getBaseTexture())
    temp._hpNumber = UI.createControl(__ePAUIControl_StaticText, temp._teamBg, "CompetitionGame_HPNumber_" .. teamIndex)
    CopyBaseProperty(teamMember._hpNumber, temp._hpNumber)
    temp._level = UI.createControl(__ePAUIControl_StaticText, temp._teamBg, "CompetitionGame_TeamClassLevel_" .. teamIndex)
    CopyBaseProperty(teamMember._level, temp._level)
    temp._name = UI.createControl(__ePAUIControl_StaticText, temp._teamBg, "CompetitionGame_TeamClassName_" .. teamIndex)
    CopyBaseProperty(teamMember._name, temp._name)
    temp._leftUserCount = UI.createControl(__ePAUIControl_StaticText, temp._teamBg, "CompetitionGame_LeftUserCount_" .. teamIndex)
    CopyBaseProperty(teamMember._leftUserCount, temp._leftUserCount)
    temp._skillIcon1 = UI.createControl(__ePAUIControl_StaticText, temp._teamBg, "CompetitionGame_skillIcon1_" .. teamIndex)
    CopyBaseProperty(teamMember._skillIcon1, temp._skillIcon1)
    temp._skillIcon2 = UI.createControl(__ePAUIControl_StaticText, temp._teamBg, "CompetitionGame_skillIcon2_" .. teamIndex)
    CopyBaseProperty(teamMember._skillIcon2, temp._skillIcon2)
    temp._skillIcon3 = UI.createControl(__ePAUIControl_StaticText, temp._teamBg, "CompetitionGame_skillIcon3_" .. teamIndex)
    CopyBaseProperty(teamMember._skillIcon3, temp._skillIcon3)
    temp._skillIcon4 = UI.createControl(__ePAUIControl_StaticText, temp._teamBg, "CompetitionGame_skillIcon4_" .. teamIndex)
    CopyBaseProperty(teamMember._skillIcon4, temp._skillIcon4)
    temp._skillIcon5 = UI.createControl(__ePAUIControl_StaticText, temp._teamBg, "CompetitionGame_skillIcon5_" .. teamIndex)
    CopyBaseProperty(teamMember._skillIcon5, temp._skillIcon5)
    temp._gaugeRate = UI.createControl(__ePAUIControl_StaticText, temp._teamBg, "CompetitionGame_gaugeBlackRate_" .. teamIndex)
    CopyBaseProperty(teamMember._gaugeRate, temp._gaugeRate)
    temp._border = UI.createControl(__ePAUIControl_Static, temp._teamBg, "CompetitionGame_TeamClassBorder_" .. teamIndex)
    CopyBaseProperty(teamMember._myBorder, temp._border)
    temp._border:ChangeTextureInfoName(controlTexture.path)
    local x1, y1, x2, y2 = setTextureUV_Func(temp._border, controlTexture.border[textureIndex][1], controlTexture.border[textureIndex][2], controlTexture.border[textureIndex][3], controlTexture.border[textureIndex][4])
    temp._border:getBaseTexture():setUV(x1, y1, x2, y2)
