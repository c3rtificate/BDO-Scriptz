...
function CompetitionGameForTeamChange_Init()
  ...
  self._list_TeamA:registEvent(__ePAUIList2EventType_LuaChangeContent, "CompetitionGame_TeamA_Update")
  self._list_TeamA:createChildContent(__ePAUIList2ElementManagerType_List)
  self._list_TeamB:changeAnimationSpeed(10)
  self._list_TeamB:registEvent(__ePAUIList2EventType_LuaChangeContent, "CompetitionGame_TeamB_Update")
  self._list_TeamB:createChildContent(__ePAUIList2ElementManagerType_List)
  self._list_Entry:changeAnimationSpeed(10)
  self._list_Entry:registEvent(__ePAUIList2EventType_LuaChangeContent, "CompetitionGame_Entry_Update")
  self._list_Entry:createChildContent(__ePAUIList2ElementManagerType_List)
  self._list_Observer:changeAnimationSpeed(10)
  self._list_Observer:registEvent(__ePAUIList2EventType_LuaChangeContent, "CompetitionGame_Observer_Update")
  self._list_Observer:createChildContent(__ePAUIList2ElementManagerType_List)
...
function FromClient_UpdateTeamScore(teamNum, scoreValue, round)
  if 0 == teamNum then
    ...
    local matchMode = ToClient_CompetitionMatchType()
    if 0 == matchMode then
      local teamAlphabet = PAGetString(Defines.StringSheet_GAME, "LUA_COMPETITIONGAME_TEAM_B")
      if 1 == teamNum then
        teamAlphabet = PAGetString(Defines.StringSheet_GAME, "LUA_COMPETITIONGAME_TEAM_A")
      end
...
function FromClient_EntryUserChangeTeam(userInfo)
  ...
  elseif userInfo:getTeamNo() == 2 then
    teamAlphabet = PAGetString(Defines.StringSheet_GAME, "LUA_COMPETITIONGAME_TEAM_B")
  end
