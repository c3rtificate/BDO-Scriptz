...
function AccountLinking:init()
  ...
  self._ui.txt_descTop:SetTextMode(__eTextMode_AutoWrap)
  self._ui.txt_descTop:SetText(self._ui.txt_descTop:GetText())
  self._ui.txt_descBottom:SetTextMode(__eTextMode_AutoWrap)
  ...
  _panel:registerPadEvent(__eConsoleUIPadEvent_Up_Y, "PaGlobalFunc_AccountLinking_PolicyOpen()")
  ...
  registerEvent("FromClient_RequestAccountLinking", "FromClient_RequestAccountLinking")
end
function PaGlobalFunc_AccountLinking_PolicyOpen()
  PaGlobal_PrivacyPolicy:open(1, false)
end
function PaGlobalFunc_AccountLinking_Open()
  if nil ~= PaGlobal_CharInfo_All_SetConsoleDescShow then
...
function AccountLinking:open()
  ...
  if true == Panel_CharacterInfo_All:GetShow() then
    HandleEventLUp_ChracterInfo_All_Close()
  end
  self._pw = ""
  local id = ""
  if false == ToClient_isPS() then
    id = ToClient_getXboxAccountLinkingId()
  else
    id = ToClient_getPSAccountLinkingId()
  end
...
function Input_AccountLinking_Unlink()
  ...
  if false == ToClient_isPS() then
    ...
    ToClient_requestPSAccountLinking(id, pw, false)
  end
end
function Input_AccountLinking_Link()
  ...
  if false == ToClient_isPS() then
    ...
    ToClient_requestPSAccountLinking(id, pw, true)
  end
end
function Input_AccountLinking_SignUp()
  ...
  if false == ToClient_isPS() then
    ...
    ToClient_LaunchNativeWebBrowserPS4()
  end
end
...
function FromClient_RequestAccountLinking()
  if Panel_Window_CouponCode:GetShow() == true then
