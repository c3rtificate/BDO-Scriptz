...
PaGlobal_Util_RegistHelpTooltipEvent(ui._buttonQuestion, "\"PanelSkillAwaken\"")
ui._btn_SwapWin:addInputEvent("Mouse_LUp", "HandleClicked_SwapWindow()")
if true == _ContentsOption_CH_Help then
  ui._buttonQuestion:SetShow(false)
end
...
function awakening.createSlot(index)
  local ui = {}
  ui._IconBG = UI.createControl(__ePAUIControl_Button, _content_SkillList, "Button_AwakenBG_" .. index)
  ...
  ui._Icon = UI.createControl(__ePAUIControl_Static, _content_SkillList, "Static_C_SkillIcon_" .. index)
  CopyBaseProperty(copyUI._copy_Icon, ui._Icon)
  ui._Icon:SetShow(true)
  ui._Icon:addInputEvent("Mouse_LUp", "event_AwakenSkill( " .. index .. " )")
  ui._SkillName = UI.createControl(__ePAUIControl_StaticText, _content_SkillList, "StaticText_C_SkillName_" .. index)
  CopyBaseProperty(copyUI._copy_SkillName, ui._SkillName)
  ui._SkillName:SetShow(true)
  ui._AwakenLv = UI.createControl(__ePAUIControl_StaticText, _content_SkillList, "StaticText_C_AwknLv_" .. index)
  CopyBaseProperty(copyUI._copy_AwakenLv, ui._AwakenLv)
  ui._AwakenLv:SetShow(true)
  ui._AwakenLv:SetAutoResize(true)
  ui._AwakenLv:SetTextMode(__eTextMode_AutoWrap)
  ui._AwakenOption = UI.createControl(__ePAUIControl_StaticText, _content_SkillList, "StaticText_C_AwknOp_" .. index)
  ...
  ui._AwakenOption:SetTextMode(__eTextMode_AutoWrap)
...
function AwakenMng:SkillAwaken_Show()
  ...
  elseif nil ~= Panel_Window_StackExtraction_All and true == Panel_Window_StackExtraction_All:GetShow() then
  ...
  elseif nil ~= Panel_Window_Socket_All and true == Panel_Window_Socket_All:GetShow() then
