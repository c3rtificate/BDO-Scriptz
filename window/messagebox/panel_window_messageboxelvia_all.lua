...
function PaGlobal_Window_MessageBoxElvia_All:initialize()
  ...
  local checkButtonEnableX = self._ui._btn_check:GetSizeX() + self._ui._btn_check:GetTextSizeX()
  local checkButtonEnableY = math.max(self._ui._btn_check:GetSizeY(), self._ui._btn_check:GetTextSizeY())
  self._ui._btn_check:SetEnableArea(0, 0, checkButtonEnableX, checkButtonEnableY)
