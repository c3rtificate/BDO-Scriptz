...
function Event_MessageBox_ChinaCreditPointFail(type)
  ...
  if type == __eChinaCreditPoint_Chatting then
    message = PAGetString(Defines.StringSheet_SymbolNo, "eErrNoCantPassChinaCreditChatting")
  elseif type == __eChinaCreditPoint_Friend then
    message = PAGetString(Defines.StringSheet_SymbolNo, "eErrNoCantPassChinaCreditFriend")
  elseif type == __eChinaCreditPoint_CreateGuild or type == __eChinaCreditPoint_EnterGuild then
    message = PAGetString(Defines.StringSheet_SymbolNo, "eErrNoCantPassChinaCreditGuild")
  elseif type == __eChinaCreditPoint_ItemMarket then
    message = PAGetString(Defines.StringSheet_SymbolNo, "eErrNoCantPassChinaCreditItemMarket")
  else
