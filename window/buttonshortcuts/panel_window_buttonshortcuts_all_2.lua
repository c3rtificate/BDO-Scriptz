function PaGlobalFunc_ButtonShorcuts_All_Open(index)
  ...
  PaGlobal_ButtonShortcuts_All._isShortcutOpen = false
...
function PaGlobalFunc_ButtonShorcuts_All_HelpOpen(isShortcutOpen)
  if nil == isShortcutOpen then
    PaGlobal_ButtonShortcuts_All._isShortcutOpen = false
  end
  PaGlobal_ButtonShortcuts_All._isShortcutOpen = isShortcutOpen
  PaGlobal_ButtonShortcuts_All:prepareOpen()
end
