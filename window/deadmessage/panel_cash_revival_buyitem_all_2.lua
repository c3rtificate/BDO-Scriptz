...
function ToClient_Cash_Revival_BuyItem_All_CashRevivalBuy_Do()
  ...
  ToClient_requestBuyItem(cPSSW:getNoRaw(), 1, cPSSW:getPrice(), CppEnums.BuyItemReqTrType.eBuyItemReqTrType_ImmediatelyUse, toInt64(0, -1), 0, CppEnums.ItemWhereType.eInventory, false, CppEnums.ItemWhereType.eCount, __eTInventorySlotNoUndefined)
end
