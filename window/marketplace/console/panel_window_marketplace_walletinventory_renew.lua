...
local MarketPlace_WalletInven = {
  _ui = {
    stc_walletSortBg = UI.getChildControl(_panel, "Static_WalletSortBg"),
...
function MarketPlace_WalletInven:initControl()
  self._ui.txt_Weight = UI.getChildControl(self._ui.stc_walletSortBg, "StaticText_WeightIcon")
...
function MarketPlace_WalletInven:initEvent()
  ...
  self._ui.btn_sortOption:addInputEvent("Mouse_LUp", "PaGlobalFunc_MarketPlace_Wallet_ToggleSortOptionView()")
end
...
function PaGlobalFunc_MarketPlace_Wallet_ToggleSortOptionView()
  local self = MarketPlace_WalletInven
  if self == nil then
    return
  end
...
function MarketPlaceMyWallet_updateSlotData_Console()
  local self = MarketPlace_WalletInven
  if self == nil then
    return
  end
...
function PaGlobalFunc_MarketPlace_WalletInven_Open()
  ...
  PaGlobalFunc_AutoSortFunctionPanel_LinkPanel(InvenSortLinkPanelIndex.MarketPlaceWallet, mainPanel, self._ui.btn_sortOption, self._ui.chk_sort, nil, nil, "Static_SortComponent_Wallet")
  PaGlobalFunc_AutoSortFunctionPanel_LoadSortOptionAndDoSort(InvenSortLinkPanelIndex.MarketPlaceWallet, false)
