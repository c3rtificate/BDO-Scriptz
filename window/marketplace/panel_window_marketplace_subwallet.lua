...
function MarketPlace_SubWallet:initEvent()
  self._ui.list2_BiddingItem:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_MarketPlace_SubWallet_CreateControlMyBiddingList")
...
function PaGlobal_SubWallet_SellBidding_Calculate(idx)
  ...
  if false == isPremiumUser and false == itemSSW:get():isCash() and false == _ContentsGroup_ChinaOnly then
