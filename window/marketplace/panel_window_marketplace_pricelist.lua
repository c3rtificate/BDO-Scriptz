...
function MarketPlacePriceList:createControl()
  self._ui._list2_SelectThing:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_MarketPlacePriceList_List2CreateControl")
  self._ui._list2_SelectThing:createChildContent(__ePAUIList2ElementManagerType_List)
...
function PaGlobalFunc_MarketPlacePriceList_List2CreateControl(content, value)
  ...
  if 0 < button_UpPrice:GetTextSizeX() then
    local result = txt_StandPrice:GetTextSizeX() / 2 + button_UpPrice:GetTextSizeX() + 15
    if result > button_UpPrice:GetSizeX() / 2 then
  ...
  if 0 < button_DownPrice:GetTextSizeX() then
    ...
    if result > button_DownPrice:GetSizeX() / 2 then
  ...
  elseif true == _ContentsGroup_ChinaFontColor then
    txt_StandPrice:SetFontColor(Defines.Color.C_FFFF9A38)
  else
