function PaGlobal_MarKetPlace_BuyProductInCashShop:initialize()
  ...
  PaGlobal_MarKetPlace_BuyProductInCashShop._ui._txt_guide:SetTextMode(__eTextMode_AutoWrap)
  ...
  PaGlobal_MarKetPlace_BuyProductInCashShop._ui._list_products:registEvent(__ePAUIList2EventType_LuaChangeContent, "Paglobal_MarketPlace_BuyProductInCashShop_updateListContent")
  PaGlobal_MarKetPlace_BuyProductInCashShop._ui._list_products:createChildContent(__ePAUIList2ElementManagerType_List)
...
function Paglobal_MarketPlace_BuyProductInCashShop_updateListContent(contents, index)
  ...
  productUiInfo._name:SetTextMode(__eTextMode_Limit_AutoWrap)
...
function PaGlobal_MarKetPlace_BuyProductInCashShop:borderChange(border, tagType)
  if 7 == tagType then
    border:ChangeTextureInfoName("new_ui_common_forlua/window/ingamecashshop/CashShop_04.dds")
  else
