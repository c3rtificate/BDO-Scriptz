function PaGlobal_FriendMessangerManager_All:createMessanger(messangerId, userName, isOnline)
  ...
  function messanger:prepareControl(messangerId, userName, isOnline)
    ...
    messanger._mainPanel:registerPadEvent(__eConsoleUIPadEvent_RStickLeft, "FriendMessanger_AlphaSliderForPad(" .. messangerId .. ",false)")
    messanger._mainPanel:registerPadEvent(__eConsoleUIPadEvent_RStickRight, "FriendMessanger_AlphaSliderForPad(" .. messangerId .. ",true)")
...
function FriendMessanger_AlphaSliderForPad(messangerId, isUp)
  local messanger = PaGlobal_FriendMessangerManager_All._messangerList[messangerId]
  if nil == messanger then
    return
  end
...
function FriendMessanger_CheckCurrentUiEdit(targetUI)
  ...
  local messanger = PaGlobal_FriendMessangerManager_All._messangerList[PaGlobal_FriendMessangerManager_All._currentFocusId]
  if nil == messanger then
    return
  end
...
function FromClient_FriendListOpenMessanger(messangerId, userName, isOnline)
  if nil == PaGlobal_FriendMessangerManager_All._messangerList[messangerId] then
