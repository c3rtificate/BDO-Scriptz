function PaGlobal_FriendList_All:initialize()
  ...
  PaGlobal_FriendList_All._ui.stc_Popup2FunctionBG = UI.getChildControl(Panel_FriendList_All, "Static_Function_BG_4")
  ...
  PaGlobal_FriendList_All._isPS4 = ToClient_isPS()
...
function PaGlobal_FriendList_All:initPopup()
  ...
  for i = 0, 1 do
    local control = UI.cloneControl(PaGlobal_FriendList_All._ui.stc_function, PaGlobal_FriendList_All._ui.stc_Popup2FunctionBG, "Static_Funtion_" .. i)
    control:SetPosX(0)
    control:SetPosY(buttonSizeY * i)
    PaGlobal_FriendList_All._ui.stc_Popup2FunctionList[i] = control
  end
  PaGlobal_FriendList_All._ui.stc_Popup2FunctionList[0]:SetText(PAGetString(Defines.StringSheet_RESOURCE, "FRIEND_STCTXT_CHANGEGROUPNAME"))
  PaGlobal_FriendList_All._ui.stc_Popup2FunctionList[1]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_FRIENDGROUP_DELETE"))
  PaGlobal_FriendList_All._ui.stc_Popup2FunctionList[0]:addInputEvent("Mouse_LUp", "PaGlobal_Friend_GroupRename_All:prepareOpen(" .. "false" .. ")")
  PaGlobal_FriendList_All._ui.stc_Popup2FunctionList[1]:addInputEvent("Mouse_LUp", "PaGlobal_FriendList_All:deleteFriendGroup()")
  PaGlobal_FriendList_All._ui.stc_Popup2FunctionBG:SetSize(bgSizeX, buttonSizeY * 2)
...
function PaGlobal_AddFriend_All:registEventHandler()
  ...
  if true == _ContentsGroup_UsePadSnapping then
    ...
    Panel_FriendList_Add_All:registerPadEvent(__eConsoleUIPadEvent_LB, "PaGlobal_AddFriend_All_ChangeNicknameModeConsole()")
    Panel_FriendList_Add_All:registerPadEvent(__eConsoleUIPadEvent_RB, "PaGlobal_AddFriend_All_ChangeNicknameModeConsole()")
  else
    PaGlobal_AddFriend_All._ui.edit_Name:RegistReturnKeyEvent("PaGlobal_AddFriend_All_SendAddFriend()")
...
function PaGlobal_FriendRequest_All:preparePlatform()
  ...
  if true == _ContentsGroup_UsePadSnapping then
    local listContent = UI.getChildControl(PaGlobal_FriendRequest_All._ui.list2_requested, "List2_1_Content")
