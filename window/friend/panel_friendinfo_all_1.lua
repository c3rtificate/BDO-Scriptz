function PaGlobal_FriendInfoList_All:initialize()
  ...
  PaGlobal_FriendInfoList_All._ui.txt_KeyGuide_RT_X = UI.getChildControl(PaGlobal_FriendInfoList_All._ui.stc_BottomBg, "StaticText_KeyGuide_RT_ConsoleUI")
  PaGlobal_FriendInfoList_All._keyGuides = {
    PaGlobal_FriendInfoList_All._ui.txt_KeyGuide_RT_X,
  ...
  PaGlobal_FriendInfoList_All._isPS4 = ToClient_isPS()
  ...
  local chatInputSizeX = PaGlobal_FriendInfoList_All._ui.stc_Edit:GetSizeX() - PaGlobal_FriendInfoList_All._ui.stc_Emo:GetSizeX()
  PaGlobal_FriendInfoList_All._ui.stc_Edit:SetSize(chatInputSizeX, PaGlobal_FriendInfoList_All._ui.stc_Edit:GetSizeY())
...
function PaGlobal_FriendInfoList_All:registEventHandler()
  ...
  if true == _ContentsGroup_UsePadSnapping then
    ...
    PaGlobal_FriendInfoList_All._ui.btn_ScaleResize:setClickMouseCursorType(__eMouseCursorType_ResizeH)
    PaGlobal_FriendInfoList_All._ui.btn_ScaleResize:setOnMouseCursorType(__eMouseCursorType_ResizeH)
  ...
  registerEvent("FromClient_ChangeUserNicknameDirectly", "FromClient_ChangeUserNicknameDirectly_Friend")
end
...
function PaGlobal_FriendRequest_All:registEventHandler()
  ...
  registerEvent("FromClient_CheckChinaProhibitedWord_AddFriendGroup", "FromClient_CheckChinaProhibitedWord_AddFriendGroup")
  registerEvent("FromClient_CheckChinaProhibitedWord_RenameFriendGroup", "FromClient_CheckChinaProhibitedWord_RenameFriendGroup")
end
...
function PaGlobal_Friend_SetTexture(calssIcon, classType)
  ...
  PaGlobalFunc_Util_SetFriendClassTypeIcon(calssIcon, classType)
end
