...
function PaGlobal_FairyInfo_All:initialize()
  ...
  if _ContentsGroup_FiveTierFairy == true then
    self._fairyTierMax = 4
  end
  if _ContentsGroup_ForthTierFairyFiftyLevel == false then
    self.eFairyMaxEquipSkill = 30
    self._InfoDescStr[3] = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_FAIRY_INFO_DESC_4_CONSOLE")
  end
  ...
  self._ui.txt_RateView = UI.getChildControl(self._ui.stc_BasicInfoBG, "StaticText_RateView_Link")
  ...
  self._ui.stc_potionDecoline = UI.getChildControl(self._ui.stc_PotionBG, "Static_DecoLine")
  self._ui.stc_AutoUseBuffItemBG = UI.getChildControl(Panel_FairyInfo_All, "Static_AutoBuffBG")
  self._ui.stc_AutoUseBuffItemLockBG = UI.getChildControl(Panel_FairyInfo_All, "Static_AutoBuffLockBG")
  local autoBuffDesc = UI.getChildControl(self._ui.stc_AutoUseBuffItemBG, "StaticText_AutoBuff_Desc")
  autoBuffDesc:SetTextMode(__eTextMode_AutoWrap)
  autoBuffDesc:SetText(autoBuffDesc:GetText())
  self._ui.btn_toggleAutoUseBuffItem = UI.getChildControl(self._ui.stc_AutoUseBuffItemBG, "CheckButton_AutoBuff")
  self._ui.btn_toggleAutoUseBuffItemSub = UI.getChildControl(self._ui.stc_AutoUseBuffItemBG, "CheckButton_AutoBuff_Sub")
  self._ui.btn_openAutoUseBuffItem = UI.getChildControl(self._ui.stc_AutoUseBuffItemBG, "Button_AutoBuff_Set")
  self._ui.btn_openAutoUseBuffItem:SetTextMode(__eTextMode_AutoWrap)
  self._ui.btn_openAutoUseBuffItem:SetText(self._ui.btn_openAutoUseBuffItem:GetText())
  self._ui.btn_openAutoUseBuffItem:SetShow(not _ContentsGroup_UsePadSnapping)
  if _ContentsGroup_OneButtonBuff == true then
    registerEvent("FromClient_UpdateAutoUseModeToggleState", "FromClient_FairyInfo_UpdateAutoUseBuffItemMode")
    registerEvent("FromClient_ChangedAplliedFairyAutoUseBuffSkill", "FromClient_FairyInfo_ChangedAplliedFairyAutoUseBuffSkill")
    if _ContentsGroup_UsePadSnapping == false then
      self._ui.btn_toggleAutoUseBuffItem:addInputEvent("Mouse_LUp", "HandleEventLUp_AutoUseBuffItem_ToggleAutoUseMode()")
      self._ui.btn_toggleAutoUseBuffItem:addInputEvent("Mouse_On", "PaGlobal_FairyInfo_SimpleTooltip_All(true, 13)")
      self._ui.btn_toggleAutoUseBuffItem:addInputEvent("Mouse_Out", "PaGlobal_FairyInfo_SimpleTooltip_All(false)")
      self._ui.btn_toggleAutoUseBuffItemSub:addInputEvent("Mouse_LUp", "HandleEventLUp_AutoUseBuffItem_ToggleAutoUseMode()")
      self._ui.btn_toggleAutoUseBuffItemSub:addInputEvent("Mouse_On", "PaGlobal_FairyInfo_SimpleTooltip_All(true, 15)")
      self._ui.btn_toggleAutoUseBuffItemSub:addInputEvent("Mouse_Out", "PaGlobal_FairyInfo_SimpleTooltip_All(false)")
      self._ui.btn_openAutoUseBuffItem:addInputEvent("Mouse_LUp", "HandleEventLUp_FairyAll_ShowAutoUseBuffItem()")
      self._ui.btn_openAutoUseBuffItem:addInputEvent("Mouse_On", "PaGlobal_FairyInfo_SimpleTooltip_All(true, 14)")
      self._ui.btn_openAutoUseBuffItem:addInputEvent("Mouse_Out", "PaGlobal_FairyInfo_SimpleTooltip_All(false)")
    end
  end
  local slotConfig = {createIcon = true, createFamilyInvenotry = true}
  self._ui.HpSlot = {}
  SlotItem.new(self._ui.HpSlot, "HpSlot", 0, self._ui.stc_HPPotionBG, slotConfig)
  self._ui.HpSlot:createChild()
  self._ui.HpSlot.icon:SetSize(self._ui.stc_HPPotionBG:GetSizeX(), self._ui.stc_HPPotionBG:GetSizeY())
  self._ui.MpSlot = {}
  SlotItem.new(self._ui.MpSlot, "MpSlot", 0, self._ui.stc_MPPotionBG, slotConfig)
  self._ui.MpSlot:createChild()
  self._ui.MpSlot.icon:SetSize(self._ui.stc_MPPotionBG:GetSizeX(), self._ui.stc_MPPotionBG:GetSizeY())
  ...
  self._ui.stc_potionLockDesc = UI.getChildControl(self._ui.stc_PotionLockBG, "StaticText_LockIcon")
  self._ui.stc_SkinSkillBG = UI.getChildControl(Panel_FairyInfo_All, "Static_FairySkinSkillkBG")
  if _ContentsGroup_OneButtonBuff == false then
    self._ui.stc_SkinSkillBG:SetSpanSize(self._ui.stc_SkinSkillBG:GetSpanSize().x, self._ui.stc_SkinSkillBG:GetSpanSize().y - self._ui.stc_AutoUseBuffItemBG:GetSizeY())
  end
  self._defaultSkillBG_SpanSizeY = self._ui.stc_SkinSkillBG:GetSpanSize().y
  ...
  self._skinSkillBG_SpanSizeY = self._ui.stc_SkillBG:GetSpanSize().y
  ...
  self._ui_pc.btn_ChangeSkillConfirmation = UI.getChildControl(self._ui.stc_SkillBG, "Button_ChangeSkill_Confirmation")
  self._ui_pc.btn_ChangeSkillConfirmation:SetShow(_ContentsGroup_FiveTierFairy)
  ...
  self._ui_console.stc_KeyGuide_RS = UI.getChildControl(self._ui.stc_BottomKeyGuide, "StaticText_RS")
  self._ui_console.stc_KeyGuide_LTX = UI.getChildControl(self._ui.stc_BottomKeyGuide, "StaticText_LTX")
  self._ui_console.stc_KeyGuide_LTY = UI.getChildControl(self._ui.stc_BottomKeyGuide, "StaticText_LTY")
  self._ui_console.stc_KeyGuide_LTA = UI.getChildControl(self._ui.stc_BottomKeyGuide, "StaticText_LTA")
  self._ui_console.stc_KeyGuide_RTX = UI.getChildControl(self._ui.stc_BottomKeyGuide, "StaticText_RTX")
  self._ui_console.stc_KeyGuide_RTY = UI.getChildControl(self._ui.stc_BottomKeyGuide, "StaticText_RTY")
  self._ui_console.stc_KeyGuide_RTA = UI.getChildControl(self._ui.stc_BottomKeyGuide, "StaticText_RTA")
  self._ui_console.stc_KeyGuide_X = UI.getChildControl(self._ui.stc_BottomKeyGuide, "StaticText_X")
  self._ui_console.stc_KeyGuide_Y = UI.getChildControl(self._ui.stc_BottomKeyGuide, "StaticText_Y")
  self._ui_console.stc_KeyGuide_A = UI.getChildControl(self._ui.stc_BottomKeyGuide, "StaticText_A")
  self._ui_console.stc_KeyGuide_B = UI.getChildControl(self._ui.stc_BottomKeyGuide, "StaticText_B")
...
function PaGlobal_FairyInfo_All:AlignKeyGuide()
  ...
  self._keyguide = Array.new()
  if _ContentsGroup_OneButtonBuff == true and _ContentsGroup_FiveTierFairy == true then
    self._keyguide:push_back(self._ui_console.stc_KeyGuide_LTX)
    self._keyguide:push_back(self._ui_console.stc_KeyGuide_LTY)
    self._keyguide:push_back(self._ui_console.stc_KeyGuide_LTA)
    self._keyguide:push_back(self._ui_console.stc_KeyGuide_RTX)
    self._keyguide:push_back(self._ui_console.stc_KeyGuide_RTA)
    if self._learnAutoUseBuffSkill == true then
      self._keyguide:push_back(self._ui_console.stc_KeyGuide_RTY)
    end
    self._keyguide:push_back(self._ui_console.stc_KeyGuide_RS)
    self._keyguide:push_back(self._ui_console.stc_KeyGuide_X)
    self._keyguide:push_back(self._ui_console.stc_KeyGuide_Y)
    self._keyguide:push_back(self._ui_console.stc_KeyGuide_A)
    self._keyguide:push_back(self._ui_console.stc_KeyGuide_B)
  elseif _ContentsGroup_OneButtonBuff == true then
    self._keyguide:push_back(self._ui_console.stc_KeyGuide_LTX)
    self._keyguide:push_back(self._ui_console.stc_KeyGuide_LTY)
    self._keyguide:push_back(self._ui_console.stc_KeyGuide_LTA)
    self._keyguide:push_back(self._ui_console.stc_KeyGuide_RTX)
    ...
    self._keyguide:push_back(self._ui_console.stc_KeyGuide_A)
    self._keyguide:push_back(self._ui_console.stc_KeyGuide_B)
  elseif _ContentsGroup_FiveTierFairy == true then
    self._keyguide:push_back(self._ui_console.stc_KeyGuide_LTX)
    self._keyguide:push_back(self._ui_console.stc_KeyGuide_LTY)
    self._keyguide:push_back(self._ui_console.stc_KeyGuide_LTA)
    self._keyguide:push_back(self._ui_console.stc_KeyGuide_RTX)
  ...
  PaGlobalFunc_ConsoleKeyGuide_SetAlign(self._keyguide, self._ui.stc_BottomKeyGuide, CONSOLEKEYGUID_ALIGN_TYPE.eALIGN_TYPE_RIGHTAUTOWRAP, 50, nil)
  self._ui_console.stc_KeyGuide_RTA:SetShow(_ContentsGroup_FiveTierFairy)
end
function PaGlobal_FairyInfo_All:registEventHandler()
  ...
  if false == _ContentsGroup_UsePadSnapping then
    ...
    if _ContentsGroup_FiveTierFairy == true then
      self._ui_pc.btn_ChangeSkillConfirmation:addInputEvent("Mouse_On", "PaGlobal_FairyInfo_SimpleTooltip_All(true, 12)")
      self._ui_pc.btn_ChangeSkillConfirmation:addInputEvent("Mouse_Out", "PaGlobal_FairyInfo_SimpleTooltip_All(false)")
    end
    self._ui_pc.btn_ChangeSkillConfirmation:SetShow(_ContentsGroup_FiveTierFairy)
    self._ui_pc.btn_LearnableSkill_pc:addInputEvent("Mouse_LUp", "PaGlobalFunc_FairySkill_Open_All(false)")
  else
    Panel_FairyInfo_All:registerPadEvent(__eConsoleUIPadEvent_Up_RSClick, "PaGlobal_FairySkinChange_Open_All()")
    ...
    Panel_FairyInfo_All:registerPadEvent(__eConsoleUIPadEvent_RTPress_X, "PaGlobal_FairyChangeSkill_Open_All(false)")
    if _ContentsGroup_FiveTierFairy == true then
      Panel_FairyInfo_All:registerPadEvent(__eConsoleUIPadEvent_RTPress_A, "PaGlobal_FairyChangeSkill_Open_All(true)")
    end
    if _ContentsGroup_OneButtonBuff == true then
      Panel_FairyInfo_All:registerPadEvent(__eConsoleUIPadEvent_RTPress_Y, "HandleEventLUp_FairyAll_ShowAutoUseBuffItem()")
    end
  end
  self._ui.txt_RateView:addInputEvent("Mouse_LUp", "HandleEventLUp_FairyInfo_OpenRateViewByLink()")
  self._ui.txt_RateView:addInputEvent("Mouse_On", "HandleEventOnOut_FairyInfo_ChangeRateViewButtonText(true)")
  self._ui.txt_RateView:addInputEvent("Mouse_Out", "HandleEventOnOut_FairyInfo_ChangeRateViewButtonText(false)")
  self._ui_pc.btn_ChangeSkill:addInputEvent("Mouse_LUp", "PaGlobal_FairyChangeSkill_Open_All(false)")
  if _ContentsGroup_FiveTierFairy == true then
    self._ui_pc.btn_ChangeSkillConfirmation:addInputEvent("Mouse_LUp", "PaGlobal_FairyChangeSkill_Open_All(true)")
  end
  ...
  self._ui.HpSlot.icon:addInputEvent("Mouse_On", "PaGlobal_FairyInfo_ShowToolTip_All(true, true)")
  self._ui.HpSlot.icon:addInputEvent("Mouse_Out", "PaGlobal_FairyInfo_ShowToolTip_All(true, false)")
  self._ui.MpSlot.icon:addInputEvent("Mouse_Out", "PaGlobal_FairyInfo_ShowToolTip_All(false, false)")
  self._ui.MpSlot.icon:addInputEvent("Mouse_On", "PaGlobal_FairyInfo_ShowToolTip_All(false, true)")
...
function PaGlobal_FairyInfo_All:prepareOpen(noSetPos)
  ...
  if _ContentsGroup_OneButtonBuff == true then
    FromClient_FairyInfo_UpdateAutoUseBuffItemMode(ToClient_getCurrentAutoUseModeToggleState())
    FromClient_FairyInfo_ChangedAplliedFairyAutoUseBuffSkill(ToClient_isAplliedFairySkill())
  end
  ...
  self:AlignKeyGuide()
  HandleEventOnOut_FairyInfo_ChangeRateViewButtonText(false)
  PaGlobal_FairyInfo_All:open()
end
function PaGlobal_FairyInfo_All:recalcPanelPosition(offsetX, offsetY)
  local panel = Panel_FairyInfo_All
  if panel == nil then
    return
  end
  ...
  if _ContentsGroup_UsePadSnapping == true then
    panelSizeY = panelSizeY + self._ui.stc_BottomKeyGuide:GetSizeY()
  end
  local calcPosX = screenCenterX - panelSizeX / 2 + offsetX
  local calcPosY = screenCenterY - panelSizeY / 2 + offsetY
  if calcPosX < 0 then
    calcPosX = 0
  end
  if calcPosY < 0 then
...
function PaGlobal_FairyInfo_All:update()
  ...
  if false == PaGlobal_FairyInfo_All._initialize then
    return
  end
  ...
  local fairyStaticStatus, iconPath, fairyNo_s64, fairyName, fairyLevel, fairyLovely, fairyhungry, fairyMaxLevel, fairyMaxHungry, fairyRace, fairyTier, fairyState, skillType, issive, tempIndex, fairyExp, MaxExp, fairyAttr
  if true == isUnseal then
  ...
  local checkLevel = (fairyTier + 1) * 10
  if _ContentsGroup_ForthTierFairyFiftyLevel == true and fairyTier >= 3 then
    checkLevel = (fairyTier + 2) * 10
  end
  if fairyLevel >= checkLevel then
  ...
  local skillIndex = 0
  local remainTime = 0
  for ii = self.eFairyMaxEquipSkill - 1, 0, -1 do
    if ii ~= 29 and pcFairyData:isFairyEquipSkillLearned(ii) == true then
      self._skillKey[skillIndex] = ii
      skillIndex = skillIndex + 1
      if skillIndex >= self._MaxSkillCount - 1 then
        break
      end
    end
  end
  local uiRow = 0
  local skillSSW = ToClient_Fairy_EquipSkillWrraper(29)
  ...
  if nil ~= self._skillKey then
    for ii = 0, #self._skillKey do
      local key = self._skillKey[ii]
      if nil ~= key then
        ...
        if nil ~= skillSSW then
          ...
          if nil ~= skillTypeSSW then
            ...
            self._ui._skillIcon[uiRow]:addInputEvent("Mouse_On", "FairyInfo_SkillTooltip_All( true, " .. tostring(uiRow) .. ")")
            self._ui._skillIcon[uiRow]:addInputEvent("Mouse_Out", "FairyInfo_SkillTooltip_All( false, " .. tostring(uiRow) .. ")")
            if key >= 20 and key <= 28 then
              self._learnPotionSkill = true
            end
            if key >= 30 and key <= 34 then
              self._learnAutoUseBuffSkill = true
            end
  ...
  if uiRow < self._MaxSkillCount then
    ...
    for index = uiRow + 1, self._MaxSkillCount - 1 do
  ...
  if nil ~= SettingData and true == self._learnPotionSkill then
    ...
    if nil ~= ItemSSW then
      self._ui.HpSlot:setItemByStaticStatus(ItemSSW, 0, -1, false, false, false, 0, 0, false, false, false, CppEnums.ItemWhereType.eFamilyInventory == SettingData._hpWhereType)
    ...
    if nil ~= ItemSSW then
      self._ui.MpSlot:setItemByStaticStatus(ItemSSW, 0, -1, false, false, false, 0, 0, false, false, false, CppEnums.ItemWhereType.eFamilyInventory == SettingData._mpWhereType)
  ...
  if _ContentsGroup_OneButtonBuff == true then
    self._learnAutoUseBuffSkill = ToClient_isLearnedFairySkill()
    self:updateAutoUseBuffItem()
    if ToClient_isConsole() == true and FromClient_TopIcon_AutoUseBuff_ChangeSkillState ~= nil then
      FromClient_TopIcon_AutoUseBuff_ChangeSkillState(self._learnAutoUseBuffSkill)
    end
  else
    self._ui.stc_AutoUseBuffItemLockBG:SetShow(false)
    self._ui.stc_AutoUseBuffItemBG:SetShow(false)
  end
  ...
  self._ui.txt_FairyDesc:SetSize(self._ui.txt_FairyDesc:GetSizeX(), self._ui.txt_FairyDesc:GetTextSizeY())
  self._ui.txt_FairyDesc:SetSpanSize(self._ui.txt_FairyDesc:GetSpanSize().x, self._ui.stc_LevleInfoBG:GetSpanSize().y + self._ui.stc_LevleInfoBG:GetSizeY() - 5)
  self._ui.txt_FairyDesc:ComputePos()
  self._ui.txt_RateView:SetText(self._ui.txt_RateView:GetText())
  self._ui.txt_RateView:SetSize(self._ui.txt_RateView:GetTextSizeX(), self._ui.txt_RateView:GetTextSizeY())
  self._ui.txt_RateView:SetSpanSize(self._ui.txt_RateView:GetSpanSize().x, self._ui.txt_FairyDesc:GetSpanSize().y + self._ui.txt_FairyDesc:GetSizeY())
  self._ui.txt_RateView:ComputePos()
  ...
  if true == isUnseal then
    ...
    self._ui_console.stc_KeyGuide_RTY:SetShow(_ContentsGroup_OneButtonBuff and self._learnAutoUseBuffSkill)
  else
    ...
    self._ui_console.stc_KeyGuide_RTY:SetShow(false)
  end
  PaGlobal_FairyInfo_All:AlignKeyGuide()
  PaGlobal_FairyChangeSkill_FairySkillUpdate(self._skillKey)
  self:refreshPanelSizeY()
end
function PaGlobal_FairyInfo_All:refreshPanelSizeY()
  local panel = Panel_FairyInfo_All
  if panel == nil then
    return
  end
  self._ui.stc_SkillBG:ComputePosAllChild()
  self._ui.chk_Lantern:ComputePos()
  if _ContentsGroup_UsePadSnapping == true then
    panel:SetSize(panel:GetSizeX(), self._ui.stc_SkillBG:GetSpanSize().y + self._ui.stc_SkillBG:GetSizeY() + 10)
    self._ui.stc_BottomKeyGuide:ComputePos()
  else
    panel:SetSize(panel:GetSizeX(), self._ui.stc_SkillBG:GetSpanSize().y + self._ui.stc_SkillBG:GetSizeY() + self._ui.stc_BottomButtonBG:GetSizeY())
    self._ui.stc_BottomButtonBG:ComputePos()
  end
  self._ui.stc_TitleImage:ComputePos()
end
function PaGlobal_FairyInfo_All:updateFairyLook()
  if false == _ContentsGroup_FairyLookChange then
    self:toggleEnableSkinSkill(false)
    return
  end
  ...
  if 1 == isDefault then
    ...
    if true == _ContentsGroup_FairyLookChangeSkill then
      local changeLookSkillKey = lookData:getChangeLookSkillKey()
      if true == changeLookSkillKey:isDefined() then
        local skillSSW = getSkillStaticStatus(changeLookSkillKey:getSkillNo(), changeLookSkillKey:getLevel())
        if nil ~= skillSSW then
          local skillTypeSSW = skillSSW:getSkillTypeStaticStatusWrapper()
          if nil ~= skillTypeSSW then
            self:toggleEnableSkinSkill(true)
            local skillName = skillSSW:getName()
            if nil ~= skillName then
              local skillNameString = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_FAIRY_CHANGELOOK_SKILLNAME", "skillName", skillName)
...
function PaGlobal_FairyInfo_All:validate()
  ...
  self._ui.stc_AutoUseBuffItemBG:isValidate()
  self._ui.stc_AutoUseBuffItemLockBG:isValidate()
  self._ui.btn_toggleAutoUseBuffItem:isValidate()
  self._ui.btn_toggleAutoUseBuffItemSub:isValidate()
  self._ui.btn_openAutoUseBuffItem:isValidate()
  ...
  self._ui_pc.btn_ChangeSkillConfirmation:isValidate()
end
function PaGlobal_FairyInfo_All:Clear()
  ...
  self._ui.stc_PotionLockBG:SetShow(true)
  self._ui.stc_PotionBG:SetShow(false)
  self._ui.stc_AutoUseBuffItemLockBG:SetShow(true)
  self._ui.stc_AutoUseBuffItemBG:SetShow(false)
  self._fairykey = nil
  self._fairyNo = nil
  self._fairyName = nil
  ...
  self._learnAutoUseBuffSkill = false
  self._skillTooltipDesc = {}
  self._currentHpKey = __eTItemEnchantKeyUndefined
  self._currentMpKey = __eTItemEnchantKeyUndefined
  self._ui.txt_HPSet:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_FAIRYINFO_HPNONE"))
  self._ui.txt_MPSet:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_FAIRYINFO_MPNONE"))
...
function PaGlobal_FairyInfo_All:summonFairy()
  ...
  if _ContentsGroup_OneButtonBuff == true and PaGlobalFunc_AutoUseBuffItem_GetShow() == true then
...
function PaGlobal_FairyInfo_All:ShowToolTip(isHp, isShow)
  ...
  local control
  if true == isHp then
    if __eTItemEnchantKeyUndefined == self._currentHpKey then
      return
    end
    ...
    if __eTItemEnchantKeyUndefined == self._currentMpKey then
      return
    end
...
function PaGlobal_FairyInfo_All:SimpleTooltip(isShow, tipType)
  ...
  elseif 12 == tipType then
    name = PAGetString(Defines.StringSheet_GAME, "LUA_FAIRYINFO_SKILLCHANGE_BUTTON_PREMIUM")
    desc = PAGetString(Defines.StringSheet_GAME, "LUA_FAIRYINFO_SKILLCHANGE_DESC_PREMIUM")
    control = self._ui_pc.btn_ChangeSkill
  elseif 13 == tipType then
    ...
    control = self._ui.btn_toggleAutoUseBuffItem
  elseif 14 == tipType then
    name = PAGetString(Defines.StringSheet_GAME, "LUA_TOOLTIP_AUTOBUFF_AVTIVATE_TITLE_1")
    desc = PAGetString(Defines.StringSheet_GAME, "LUA_TOOLTIP_AUTOBUFF_AVTIVATE_DESC_1")
    control = self._ui.btn_openAutoUseBuffItem
  elseif 15 == tipType then
    name = PAGetString(Defines.StringSheet_GAME, "LUA_TOOLTIP_AUTOBUFF_AVTIVATE_TITLE")
    desc = PAGetString(Defines.StringSheet_GAME, "LUA_TOOLTIP_AUTOBUFF_AVTIVATE_DESC")
    control = self._ui.btn_toggleAutoUseBuffItemSub
  end
...
function PaGlobal_FairyInfo_All:toggleEnableSkinSkill(showParam)
  if showParam == true then
    self._ui.stc_SkinSkillBG:SetShow(true)
    self._ui.stc_SkillBG:SetSpanSize(self._ui.stc_SkillBG:GetSpanSize().x, self._defaultSkillBG_SpanSizeY + self._ui.stc_SkinSkillBG:GetSizeY())
  else
    self._ui.stc_SkinSkillBG:SetShow(false)
    local newSpanSizeY = self._skinSkillBG_SpanSizeY
    if _ContentsGroup_OneButtonBuff == false then
      newSpanSizeY = newSpanSizeY - self._ui.stc_AutoUseBuffItemBG:GetSizeY()
    end
    self._ui.stc_SkillBG:SetSpanSize(self._ui.stc_SkillBG:GetSpanSize().x, newSpanSizeY)
  end
  self:refreshPanelSizeY()
end
function PaGlobal_FairyInfo_All:updateAutoUseBuffItem()
  local panel = Panel_FairyInfo_All
  if panel == nil then
    return
  end
  ...
  if self._learnAutoUseBuffSkill == true then
    self._ui.stc_AutoUseBuffItemLockBG:SetShow(false)
    self._ui.stc_AutoUseBuffItemBG:SetShow(true)
    self._ui.btn_openAutoUseBuffItem:SetShow(not _ContentsGroup_UsePadSnapping)
  else
    self._ui.stc_AutoUseBuffItemLockBG:SetShow(true)
    self._ui.stc_AutoUseBuffItemBG:SetShow(false)
    self._ui.btn_openAutoUseBuffItem:SetShow(false)
  end
  self:toggleEnableSkinSkill(self._ui.stc_SkinSkillBG:GetShow())
end
function FromClient_FairyInfo_UpdateAutoUseBuffItemMode(isOn)
  local self = PaGlobal_FairyInfo_All
  if self == nil then
    return
  end
  ...
  self._ui.btn_toggleAutoUseBuffItem:SetCheck(isOn)
  self._ui.btn_toggleAutoUseBuffItem:EraseAllEffect()
  self._ui.btn_toggleAutoUseBuffItemSub:SetCheck(isOn)
  if isOn == true then
    self._ui.btn_toggleAutoUseBuffItem:AddEffect("fui_ingame_widget_autouse_02a", true, 0, 0)
  end
end
function FromClient_FairyInfo_ChangedAplliedFairyAutoUseBuffSkill(isApliedAutoUseItemBuff)
  local self = PaGlobal_FairyInfo_All
  if self == nil then
    return
  end
  ...
  self._ui.btn_openAutoUseBuffItem:SetMonoTone(not isApliedAutoUseItemBuff)
  self._ui.btn_openAutoUseBuffItem:SetIgnore(not isApliedAutoUseItemBuff)
end
function HandleEventLUp_FairyAll_ShowAutoUseBuffItem()
  local self = PaGlobal_FairyInfo_All
  if self == nil then
    return
  end
  ...
  if self._learnAutoUseBuffSkill == false then
    return
  end
  if PaGlobalFunc_AutoUseBuffItem_GetShow() == true then
    PaGlobalFunc_AutoUseBuffItem_Close()
  ...
  self:recalcPanelPosition(-200, -20)
  PaGlobalFunc_AutoUseBuffItem_OpenByFairy()
end
