...
PaGlobal_FairyInfo_All = {
  _ui = {
    ...
    txt_HPSet = nil,
    txt_MPSet = nil,
    stc_potionDecoline = nil,
    stc_AutoUseBuffItemBG = nil,
    stc_AutoUseBuffItemLockBG = nil,
    btn_toggleAutoUseBuffItem = nil,
    btn_toggleAutoUseBuffItemSub = nil,
    btn_openAutoUseBuffItem = nil,
    stc_PotionLockBG = nil,
    stc_potionLockDesc = nil,
    stc_SkillBG = nil,
    _skillIconBg = {},
    _skillIcon = {},
    _skillMasterIcon = {},
  ...
  _ui_pc = {
    ...
    btn_ChangeSkill = nil,
    btn_ChangeSkillConfirmation = nil
  },
  _ui_console = {
  ...
  eFairyMaxEquipSkill = 35,
  _MaxSkillCount = 6,
  _defaultSkillBG_SpanSizeY = 0,
  _skinSkillBG_SpanSizeY = 0,
  _isShowSkillRate = false,
  _fairyAttrStr = {
  ...
  _GenerationStr = {
    ...
    [4] = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_FAIRY_INFO_GENERATION_5")
  },
  _InfoDescStr = {
    ...
    [4] = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_FAIRY_INFO_DESC_5")
  },
  _buttonName = {
...
PaGlobal_FairySkill_All = {
  ...
  _ui_console = {
    ...
    _txt_Y_ConsoleUI = nil
  },
  _defaultPanelSizeY = 0,
  _defaultPcCloseBtnPosY = 0,
  _defaultKeyGuidePosY = 0,
  _defaultBottomDescBGSizeY = 0,
  exceptGroupkey = {},
  _initialize = false
}
...
PaGlobal_FairyChangeSkill_All = {
  ...
  _skillKeyList = nil,
  _skillSlot = {},
  _learnSkillMaxCount = 5,
  _selectSkillKey = nil,
  _selectChangeSkillKey = nil,
  _fairyNo = nil,
  _fairyLevel = nil,
  _changeAniState = nil,
  _aniStartTime = 0,
