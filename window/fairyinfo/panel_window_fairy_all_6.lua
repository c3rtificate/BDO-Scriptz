function PaGlobal_FairyChoiceTheReset_All:initialize()
  ...
  self._ui.stc_BottomKeyGuideCenter = UI.getChildControl(Panel_Window_FairyChoiceTheReset_All, "Static_KeyGuide_Console_Center")
  self._ui_console.stc_KeyGuide_Y = UI.getChildControl(self._ui.stc_BottomKeyGuideCenter, "StaticText_Confirm_Console")
  self._keyguide = {
...
function PaGlobal_FairyChoiceTheReset_All:SetUiSetting()
  ...
  self._ui.stc_BottomKeyGuideCenter:SetShow(_ContentsGroup_UsePadSnapping)
...
function PaGlobal_FairyChoiceTheReset_All:validate()
  ...
  self._ui.stc_BottomKeyGuideCenter:isValidate()
