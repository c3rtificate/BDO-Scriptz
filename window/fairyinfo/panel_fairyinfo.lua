...
function PaGlobal_FairyInfo_EnableFairyTierUpgrade()
  return FairyInfo._enableFairyUpgrade
end
...
function FairyInfo:Update()
  ...
  if _ContentsGroup_FairyTierUpgradeAndRebirth then
    ...
    if true == PaGlobal_FairyInfo_isMaxTier() then
...
function FairyInfo:Initialize()
  ...
  self._UI._button_LearnableSkill:SetTextMode(__eTextMode_AutoWrap)
