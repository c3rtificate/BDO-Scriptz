...
function FairyList:Initialize()
  self.List2_FairyList:registEvent(__ePAUIList2EventType_LuaChangeContent, "FairyListCreate")
  self.List2_FairyList:createChildContent(__ePAUIList2ElementManagerType_List)
