...
function PaGlobal_FairyRegister:init()
  ...
  self._ui.fairyNamingPolicyDesc:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui.fairyRegisterDesc:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui.fairyRegisterDesc:SetText(defaultDesc)
