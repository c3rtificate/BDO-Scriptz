function PaGlobal_FairyChangeSkill_Viewhelper_All:initialize()
  ...
  self._ui.stc_Text_Desc_Premium = UI.getChildControl(self._ui.stc_LineBG, "StaticText_Desc_Premium")
...
function PaGlobal_FairyChangeSkill_Viewhelper_All:prepareOpen(isPremium)
  PaGlobal_FairyChangeSkill_Viewhelper_All:descSetting(isPremium)
...
function PaGlobal_FairyChangeSkill_Viewhelper_All:validate()
  ...
  self._ui.stc_Text_Desc_Premium:isValidate()
  self._ui_pc.btn_Close_pc:isValidate()
end
function PaGlobal_FairyChangeSkill_Viewhelper_All:descSetting(isPremium)
  self._ui.stc_Text_Desc:SetTextMode(__eTextMode_AutoWrap)
  self._ui.stc_Text_Desc_Premium:SetTextMode(__eTextMode_AutoWrap)
  self._ui.stc_Text_Desc:SetText(self._ui.stc_Text_Desc:GetText())
  self._ui.stc_Text_Desc_Premium:SetText(self._ui.stc_Text_Desc_Premium:GetText())
  self._ui.stc_Text_Desc:SetShow(isPremium == false)
  self._ui.stc_Text_Desc_Premium:SetShow(isPremium == true)
  local textDesc = self._ui.stc_Text_Desc
  if isPremium == true then
    textDesc = self._ui.stc_Text_Desc_Premium
  end
  local addLenY = textDesc:GetTextSizeY() - self._ui.stc_LineBG:GetSizeY() + self._ui.stc_LineBG:GetSpanSize().y
