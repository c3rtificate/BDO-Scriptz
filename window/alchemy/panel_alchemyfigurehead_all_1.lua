...
function PaGlobal_AlchemyFigureHead_All:prepareOpen()
  ...
  if true == _ContentsGroup_NewUI_Inventory_All then
    if true == Panel_Window_Inventory_All:IsUISubApp() then
      invenPosX = getScreenSizeX() - Panel_Window_Inventory_All:GetSizeX() - 10
      invenPosY = (getScreenSizeY() - Panel_Window_Inventory_All:GetSizeY()) / 2
    else
  ...
  local posX = invenPosX - Panel_AlchemyFigureHead_All:GetSizeX() - 5
  if posX < 0 then
    posX = invenPosX + Panel_Window_Inventory_All:GetSizeX() + 5
  end
  Panel_AlchemyFigureHead_All:SetPosX(posX)
...
function PaGlobal_AlchemyFigureHead_All:openUiSetting()
  ...
  if false == _ContentsGroup_RenewUI_Manufacture and true == Panel_Window_Manufacture_All:GetShow() then
