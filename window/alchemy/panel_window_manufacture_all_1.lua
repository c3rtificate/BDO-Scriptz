function PaGlobal_Manufacture_All:initialize()
  ...
  PaGlobal_Manufacture_All._ui.stc_craftingNoteIcon = UI.getChildControl(PaGlobal_Manufacture_All._ui.btn_craftingNote, "Static_Icon")
  ...
  PaGlobal_Manufacture_All._ui.btn_rateView = UI.getChildControl(PaGlobal_Manufacture_All._ui.stc_leftBG, "Button_RateView")
  ...
  PaGlobal_Manufacture_All._ui.stc_iconM = UI.getChildControl(PaGlobal_Manufacture_All._ui.stc_keyGuideBg, "StaticText_ConfirmMass")
  PaGlobal_Manufacture_All._ui.stc_iconY = UI.getChildControl(PaGlobal_Manufacture_All._ui.stc_keyGuideBg, "StaticText_Manufacture")
  ...
  PaGlobal_Manufacture_All:initUsingSlotCount()
  PaGlobal_Manufacture_All._initialize = true
end
function PaGlobal_Manufacture_All:initUsingSlotCount()
  if true == ToClient_IsContentsGroupOpen("790") then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.SHAKE].slotCount = 5
  elseif true == ToClient_IsContentsGroupOpen("789") then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.SHAKE].slotCount = 4
  elseif true == ToClient_IsContentsGroupOpen("788") then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.SHAKE].slotCount = 3
  elseif true == ToClient_IsContentsGroupOpen("787") then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.SHAKE].slotCount = 2
  end
  if true == ToClient_IsContentsGroupOpen("792") then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.FIREWOOD].slotCount = 5
  elseif true == ToClient_IsContentsGroupOpen("791") then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.FIREWOOD].slotCount = 4
  end
  if true == ToClient_IsContentsGroupOpen("796") then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.DRY].slotCount = 5
  elseif true == ToClient_IsContentsGroupOpen("795") then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.DRY].slotCount = 4
  elseif true == ToClient_IsContentsGroupOpen("794") then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.DRY].slotCount = 3
  elseif true == ToClient_IsContentsGroupOpen("793") then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.DRY].slotCount = 2
  end
  if true == ToClient_IsContentsGroupOpen("800") then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.THINNING].slotCount = 5
  elseif true == ToClient_IsContentsGroupOpen("799") then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.THINNING].slotCount = 4
  elseif true == ToClient_IsContentsGroupOpen("798") then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.THINNING].slotCount = 3
  elseif true == ToClient_IsContentsGroupOpen("797") then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.THINNING].slotCount = 2
  end
  if true == ToClient_IsContentsGroupOpen("786") then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.HEAT].slotCount = 5
  elseif true == _ContentsGroup_OceanCurrent then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.HEAT].slotCount = 4
  elseif true == _ContentsGroup_BlackStarWeapon then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.HEAT].slotCount = 3
  end
  if true == ToClient_IsContentsGroupOpen("801") then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.COOK].slotCount = 5
  elseif true == ToClient_IsContentsGroupOpen("327") then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.COOK].slotCount = 4
  end
  if true == ToClient_IsContentsGroupOpen("803") then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.RGCOOK].slotCount = 5
  elseif true == ToClient_IsContentsGroupOpen("802") then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.RGCOOK].slotCount = 4
  end
  if true == ToClient_IsContentsGroupOpen("805") then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.RGALCHEMY].slotCount = 5
  elseif true == ToClient_IsContentsGroupOpen("804") then
    self.MANUFACTURE_INFO[self.MANUFACTURE_TYPE.RGALCHEMY].slotCount = 4
  end
end
...
function PaGlobal_Manufacture_All:setBasicSetting()
  ...
  PaGlobal_Manufacture_All._ui.stc_iconY:SetText(PAGetString(Defines.StringSheet_GAME, "ALCHEMY_MANUFACTURE_BTN_MANUFACTURE"))
  if _ContentsGroup_LifeSimulator == true then
    PaGlobal_Manufacture_All._ui.btn_rateView:SetSize(PaGlobal_Manufacture_All._ui.btn_rateView:GetTextSizeX() + 15, PaGlobal_Manufacture_All._ui.btn_rateView:GetSizeY())
  end
...
function PaGlobal_Manufacture_All:registEventHandler()
  ...
  registerEvent("FromClient_EmergencyEvadeActionStart", "FromClient_Manufacture_All_EmergencyEvadeActionStart")
  ...
  if true == PaGlobal_Manufacture_All._isConsole then
    ...
    Panel_Window_Manufacture_All:registerPadEvent(__eConsoleUIPadEvent_Up_Y, "PaGlobal_Manufacture_All_InventoryYFunc()")
    Panel_Window_Manufacture_All:registerPadEvent(__eConsoleUIPadEvent_LTPress_Y, "PaGlobal_Manufacture_All_InventoryLTYFunc()")
  else
    ...
    PaGlobal_Manufacture_All._ui.btn_craftingNote:addInputEvent("Mouse_On", "HandleEventOn_Manufacture_All_BtnTooltip(true, 2)")
    PaGlobal_Manufacture_All._ui.btn_craftingNote:addInputEvent("Mouse_Out", "HandleEventOn_Manufacture_All_BtnTooltip(false)")
    ...
    PaGlobal_Manufacture_All._ui.btn_massManufacture:addInputEvent("Mouse_On", "HandleEventOn_Manufacture_All_BtnTooltip(true, 1)")
    PaGlobal_Manufacture_All._ui.btn_massManufacture:addInputEvent("Mouse_Out", "HandleEventOn_Manufacture_All_BtnTooltip(false)")
  end
  if _ContentsGroup_LifeSimulator == true then
    PaGlobal_Manufacture_All._ui.btn_rateView:addInputEvent("Mouse_LUp", "HandleEventLUp_Manufacture_All_OpenRateViewList(true)")
  end
end
...
function PaGlobal_Manufacture_All:prepareOpen()
  ...
  local isShow = Panel_Window_Manufacture_All:GetShow()
...
function PaGlobal_Manufacture_All:prepareClose()
  ...
  local isShow = Panel_Window_Manufacture_All:GetShow()
  if true == _ContentsGroup_FamilyInventory and true == isShow then
  ...
  if _ContentsGroup_LifeSimulator == true and PaGloabl_Alchemy_RateViewList_Close ~= nil then
...
function PaGlobal_Manufacture_All:clearCurrentRepeatItemKey()
  for i = 0, self._slotMaxCount - 1 do
    self._currentRepeatItemKey[i] = nil
  end
end
