PaGlobal_Alchemy_All = {
  _CheckFormDataForSave = {
    CheckForm_Nothing = 0,
    CheckForm_RecentRecipe = 1,
    CheckForm_KnownRecipe = 2
  },
  _ui = {
    stc_titleBG = nil,
    ...
    stc_searchArea = nil,
    chk_knownRecipe = nil,
    chk_onlyKnownRecipe = nil,
    edit_searchBox = nil,
    stc_LSclick_consoleUI = nil,
    stc_RSclick_consoleUI = nil,
  ...
  _isConsole = false,
  _isWantShowRecentCook = false,
  _isPanelRecentCookOpened = false,
  _initialize = false
}
