...
local isPopUpContentsEnable = _ContentsGroup_PopUp
if splitWindow then
...
ItemMarket.txt_SpecialGoodsDesc:SetTextMode(__eTextMode_AutoWrap)
ItemMarket.txt_SpecialGoodsDesc:SetText(ItemMarket.txt_SpecialGoodsDesc:GetText())
ItemMarket.Selected_ItemName:SetTextMode(__eTextMode_LimitText)
...
function ItemMarket:Initialize()
  ...
  local iconTooltips = UI.createControl(__ePAUIControl_StaticText, Panel_Window_ItemMarket, "ItemMarket_PriceTitleToolTip")
  ...
  iconTooltips:SetTextMode(__eTextMode_AutoWrap)
  ...
  itemlist_ItemName:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._list2:registEvent(__ePAUIList2EventType_LuaChangeContent, "Itemmarket_ListUpdate")
  self._list2:createChildContent(__ePAUIList2ElementManagerType_List)
  self._list2_Inside:changeAnimationSpeed(10)
  self._list2_Inside:registEvent(__ePAUIList2EventType_LuaChangeContent, "Itemmarket_ListUpdate_Inside")
  self._list2_Inside:createChildContent(__ePAUIList2ElementManagerType_List)
  ...
  self._list2_SpecialList:registEvent(__ePAUIList2EventType_LuaChangeContent, "Itemmarket_SpecialListUpdate")
  self._list2_SpecialList:createChildContent(__ePAUIList2ElementManagerType_List)
  ...
  self._list2_SpecialList_Inside:registEvent(__ePAUIList2EventType_LuaChangeContent, "Itemmarket_SpecialListUpdate_Inside")
  self._list2_SpecialList_Inside:createChildContent(__ePAUIList2ElementManagerType_List)
  ...
  tree2:registEvent(__ePAUIList2EventType_LuaChangeContent, "Itemmarket_CategoryUpdate")
  ...
  self.txt_BottomDesc:SetTextMode(__eTextMode_AutoWrap)
...
function Itemmarket_ListUpdate(contents, key)
  ...
  if true == self.isGrouplist then
    ...
    itemlist_ItemName:SetTextMode(__eTextMode_LimitText)
    itemlist_ItemName:SetShow(true)
    ...
    if nil ~= itemMarketSummaryInfo then
      ...
      local itemNameStr = self:SetNameAndEnchantLevel(enchantLevel, iess:getItemType(), iess:getName(), iess:getItemClassify(), iess:isSpecialEnchantItem())
...
function Itemmarket_ListUpdate_Inside(contents, key)
  ...
  if nil ~= sellInfo then
    ...
    local enchantLevel = iess:get()._key:getEnchantLevel()
    local nameColor = self:SetNameColor(nameColorGrade)
    itemlist_SingleItemName:SetTextMode(__eTextMode_LimitText)
...
function Itemmarket_SpecialListUpdate(contents, key)
  ...
  if true == self.isGrouplist then
    ...
    if nil ~= itemMarketSummaryInfo then
      ...
      elseif enchantLevel > 0 and CppEnums.ItemClassifyType.eItemClassify_Accessory == itemMarketSummaryInfo:getItemClassify() and (itemMarketSummaryInfo:isSpecialEnchantItem() == false or itemMarketSummaryInfo:isKingAccessory() == true) then
...
function Itemmarket_SelectedListHeadBGUpdate()
  ...
  if self.isSpecialInside then
    ...
    if nil ~= itemMarketSummaryInfo then
      ...
      local enchantLevel = itemMarketSummaryInfo:get()._key:getEnchantLevel()
      self.Selected_ItemName:SetTextMode(__eTextMode_AutoWrap)
      if 1 == itemMarketSummaryInfo:getItemType() and enchantLevel > 15 then
...
function HandleClicked_ItemMarket_GroupItem(itemIdx, itemEnchantKeyRaw)
  ...
  if true == _ContentsGroup_NewUI_Tooltip_All then
    if Panel_Widget_Tooltip_Item_All:GetShow() or Panel_Widget_Tooltip_Item_Equip_All:GetShow() or Panel_Tooltip_SimpleText:GetShow() then
      Panel_Tooltip_Item_hideTooltip()
      TooltipSimple_Hide()
    end
  elseif Panel_Tooltip_Item:GetShow() or Panel_Tooltip_Item_equipped:GetShow() or Panel_Tooltip_SimpleText:GetShow() then
    Panel_Tooltip_Item_hideTooltip()
    TooltipSimple_Hide()
  end
...
function ItemMarket_UpdateMoneyByWarehouse()
  ...
  local self = ItemMarket
  self.invenMoney:SetText(makeDotMoney(getSelfPlayer():get():getMoneyInventory():getMoney_s64()))
...
function HandleClicked_ItemMarket_RegistItem()
  ...
  HandleEventLUp_Warehouse_All_MarketRegistOpen(true)
  Panel_Window_ItemMarket:SetShow(false)
...
function Panel_ItemMarket_BidDesc_Init()
  ...
  self._txt_Desc:SetTextMode(__eTextMode_AutoWrap)
...
function ItemMarket:registEventHandler()
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(self._buttonQuestion, "\"ItemMarket\"")
