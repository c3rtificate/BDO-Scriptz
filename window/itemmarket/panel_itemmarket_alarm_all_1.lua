...
function PaGlobal_ItemMarketAlarm:prepareOpen(itemKey, price)
  ...
  PaGlobal_ItemMarketAlarm._ui._stc_itemIcon:addInputEvent("Mouse_LUp", "PaGlobalFunc_FromAlarm_Showmarket()")
  PaGlobal_ItemMarketAlarm._ui._txt_itemName:addInputEvent("Mouse_LUp", "PaGlobalFunc_FromAlarm_Showmarket()")
  PaGlobal_ItemMarketAlarm._ui._txt_price:addInputEvent("Mouse_LUp", "PaGlobalFunc_FromAlarm_Showmarket()")
  PaGlobal_ItemMarketAlarm._ui._txt_itemRegistTime:addInputEvent("Mouse_LUp", "PaGlobalFunc_FromAlarm_Showmarket()")
