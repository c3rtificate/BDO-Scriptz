...
function ItemMarketPreBid:Init()
  ...
  self.ui.itemName:SetTextMode(__eTextMode_AutoWrap)
  self.ui.notify:SetTextMode(__eTextMode_AutoWrap)
  self.ui.notify:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_ITEMMARKET_PREBID_REGIST_NOTIFY"))
  self.ui.title_01:SetTextMode(__eTextMode_AutoWrap)
...
function ItemMarketPreBid:Update()
  ...
  if CppEnums.ItemClassifyType.eItemClassify_Accessory == itemSSW:getItemClassify() and (itemSSW:isSpecialEnchantItem() == false or itemSSW:isKingAccessory() == true) then
    ...
    elseif 6 == enchantLevel then
      self.ui.enchantLevel:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMON_ENCHANTLEVEL_6"))
    elseif 7 == enchantLevel then
      self.ui.enchantLevel:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMON_ENCHANTLEVEL_7"))
    elseif 8 == enchantLevel then
      self.ui.enchantLevel:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMON_ENCHANTLEVEL_8"))
    elseif 9 == enchantLevel then
      self.ui.enchantLevel:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMON_ENCHANTLEVEL_9"))
    elseif 10 == enchantLevel then
      self.ui.enchantLevel:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMON_ENCHANTLEVEL_10"))
    end
