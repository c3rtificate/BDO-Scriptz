...
function ItemMarketPreBid_Manager:Init()
  ...
  self.ui.guideMsg:SetTextMode(__eTextMode_AutoWrap)
...
function ItemMarketPreBid_Manager:UpdateSlot(dataIdx, uiIdx)
  ...
  if CppEnums.ItemClassifyType.eItemClassify_Accessory == itemSSW:getItemClassify() and (itemSSW:isSpecialEnchantItem() == false or itemSSW:isKingAccessory() == true) then
    ...
    elseif 6 == enchantLevel then
      ui.level:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMON_ENCHANTLEVEL_6"))
    elseif 7 == enchantLevel then
      ui.level:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMON_ENCHANTLEVEL_7"))
    elseif 8 == enchantLevel then
      ui.level:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMON_ENCHANTLEVEL_8"))
    elseif 9 == enchantLevel then
      ui.level:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMON_ENCHANTLEVEL_9"))
    elseif 10 == enchantLevel then
      ui.level:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMON_ENCHANTLEVEL_10"))
    end
