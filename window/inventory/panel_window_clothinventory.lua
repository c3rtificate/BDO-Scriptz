...
clothInven.desc:SetTextMode(__eTextMode_AutoWrap)
...
function FromClient_ShowInventoryBag(bagType, bagSize, fromWhereType, fromSlotNo)
  ...
  for index = 0, bagSize - 1 do
    if nil == self.bg[index] then
      self.bg[index] = UI.createControl(__ePAUIControl_Static, Panel_Window_ClothInventory, "ColothInventory_SlotBg_" .. index)
  ...
  Panel_Window_ClothInventory:SetPosX(invenPosX - Panel_Window_ClothInventory:GetSizeX())
  Panel_Window_ClothInventory:SetPosY(invenPosY + 80)
