...
function FromClient_luaLoadComplete_InventoryInfo_Init()
  ...
  InventoryInfo._ui.chk_subWeapon:SetCheck(not isShowSubWeapon)
end
...
function InventoryInfo:initEquipmentUIControls()
  ...
  self._ui.chk_autoActive = UI.getChildControl(self._ui.stc_upperGroups[UPPER_TAB_TYPE.EQUIPMENT_TAB], "CheckBox_AlchemyStone")
...
function InventoryInfo:initCostumeUIControls()
  ...
  self._ui.chk_subWeapon = toggleButtons[6]
  ...
  togglesBG[6]:addInputEvent("Mouse_LUp", "Input_InventoryInfo_SubWeapon()")
...
function InventoryInfo:initInformationUIControl()
  ...
  if __eClassType_WizardWoman == classtype or __eClassType_WizardMan == classtype then
...
function InventoryInfo:open(openType)
  ...
  if Defines.UIMode.eUIMode_Default == GetUIMode() then
    if _ContentsGroup_RenewUI_Quest then
      ...
      PaGlobalFunc_Panel_TimeBar_Show(false, false)
...
function InventoryInfo:close()
  ...
  if Defines.UIMode.eUIMode_Default == GetUIMode() and _ContentsGroup_RenewUI_Quest and false == ToClient_IsInstanceFieldPlayerbyContentsType(__eInstanceContentsType_SavageDefence) and true == PaGlobalFunc_Quest_All_GetShow() then
...
function PaGlobalFunc_InventoryInfo_IsItemlockable()
  ...
  local checks = {
    ...
    [18] = nil ~= Panel_Window_StackExtraction_All and Panel_Window_StackExtraction_All:GetShow()
  }
...
function Input_InventoryInfo_SubWeapon()
  ...
  if false == IsSelfPlayerWaitAction() or true == IsSelfPlayerBattleWaitAction() then
    ...
    InventoryInfo._ui.chk_subWeapon:SetCheck(not InventoryInfo._ui.chk_subWeapon:IsCheck())
    return
  end
  selfPlayerShowSubWeapon(not InventoryInfo._ui.chk_subWeapon:IsCheck())
end
...
function InventoryInfo:onInventoryItemRClick(index)
  ...
  if nil ~= itemWrapper and slot.icon:IsEnable() then
    ...
    if selfProxy:doRideMyVehicle() then
      ...
      if false == isMaidCheck and false == isUpperServantTab and itemStatic:isUseToVehicle() then
...
function Input_InventoryInfo_ShowTooltip(index, isShow)
  ...
  if isShow then
    ...
    PaGlobalFunc_TooltipInfo_Open(Defines.TooltipDataType.ItemWrapper, getInventoryItemByType(_lowerTabData[self._currentLowerTab].whereType, self._ui.slot_inven[index].slotNo), Defines.TooltipTargetType.Item, _panel:GetPosX() - self._screenGapSizeX, nil, "Inventory")
    PaGlobalFunc_FloatingTooltip_Close()
  else
    PaGlobalFunc_TooltipInfo_Close()
  end
...
function Input_InventoryInfo_ShowEquipTooltip(slotNo, isShow)
  ...
  _AudioPostEvent_SystemUiForXBOX(50, 0)
  if isShow then
    PaGlobalFunc_TooltipInfo_Open(Defines.TooltipDataType.ItemWrapper, ToClient_getEquipmentItem(slotNo), Defines.TooltipTargetType.ItemWithoutCompare, _panel:GetPosX() - self._screenGapSizeX, nil, "Inventory")
    PaGlobalFunc_FloatingTooltip_Close()
  else
    PaGlobalFunc_TooltipInfo_Close()
  end
...
function InventoryInfo:compareSpec(whereType, slotNo, isAccessory)
  ...
  if isEquip and not Panel_Window_Exchange:GetShow() then
    ...
    if nil ~= equipItemWrapper then
      ...
      if (__eClassType_Warrior == classType or __eClassType_Valkyrie == classType) and (1 == equipType or 8 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        ...
        matchEquip = true
      elseif __eClassType_Giant == classType and (29 == equipType or 34 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        offencePoint = (itemWrapper:getStaticStatus():getMinDamage(0) + itemWrapper:getStaticStatus():getMaxDamage(0)) / 2
        equipOffencePoint = (ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMinDamage(0) + ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMaxDamage(0)) / 2
        matchEquip = true
      elseif (__eClassType_ElfRanger == classType or __eClassType_RangerMan == classType) and (31 == equipType or 32 == equipType or 73 == equipType or 74 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        ...
        matchEquip = true
      elseif __eClassType_Sorcerer == classType and (28 == equipType or 33 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        ...
        matchEquip = true
      elseif __eClassType_Tamer == classType and (2 == equipType or 37 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        offencePoint = (itemWrapper:getStaticStatus():getMinDamage(2) + itemWrapper:getStaticStatus():getMaxDamage(2)) / 2
        equipOffencePoint = (ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMinDamage(2) + ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMaxDamage(2)) / 2
        matchEquip = true
      elseif (__eClassType_Kunoichi == classType or __eClassType_NinjaMan == classType) and (2 == equipType or 56 == equipType or 55 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        offencePoint = (itemWrapper:getStaticStatus():getMinDamage(0) + itemWrapper:getStaticStatus():getMaxDamage(0)) / 2
        equipOffencePoint = (ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMinDamage(0) + ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMaxDamage(0)) / 2
        matchEquip = true
      elseif (__eClassType_BladeMaster == classType or __eClassType_BladeMasterWoman == classType) and (3 == equipType or 36 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        offencePoint = (itemWrapper:getStaticStatus():getMinDamage(0) + itemWrapper:getStaticStatus():getMaxDamage(0)) / 2
        equipOffencePoint = (ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMinDamage(0) + ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMaxDamage(0)) / 2
        matchEquip = true
      elseif (__eClassType_WizardMan == classType or __eClassType_WizardWoman == classType) and (6 == equipType or 32 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        offencePoint = (itemWrapper:getStaticStatus():getMinDamage(2) + itemWrapper:getStaticStatus():getMaxDamage(2)) / 2
        equipOffencePoint = (ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMinDamage(2) + ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMaxDamage(2)) / 2
        matchEquip = true
      elseif __eClassType_DarkElf == classType and (63 == equipType or 34 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        offencePoint = (itemWrapper:getStaticStatus():getMinDamage(2) + itemWrapper:getStaticStatus():getMaxDamage(2)) / 2
        equipOffencePoint = (ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMinDamage(2) + ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMaxDamage(2)) / 2
        matchEquip = true
      elseif __eClassType_Combattant == classType or __eClassType_Mystic == classType and (65 == equipType or 66 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        offencePoint = (itemWrapper:getStaticStatus():getMinDamage(0) + itemWrapper:getStaticStatus():getMaxDamage(0)) / 2
        equipOffencePoint = (ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMinDamage(0) + ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMaxDamage(0)) / 2
        matchEquip = true
      elseif __eClassType_Lhan == classType and (67 == equipType or 70 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        offencePoint = (itemWrapper:getStaticStatus():getMinDamage(0) + itemWrapper:getStaticStatus():getMaxDamage(0)) / 2
        equipOffencePoint = (ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMinDamage(0) + ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMaxDamage(0)) / 2
        matchEquip = true
      elseif __eClassType_ShyWaman == classType and (78 == equipType or 79 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
        offencePoint = (itemWrapper:getStaticStatus():getMinDamage(0) + itemWrapper:getStaticStatus():getMaxDamage(0)) / 2
        equipOffencePoint = (ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMinDamage(0) + ToClient_getEquipmentItem(itemWrapper:getStaticStatus():getEquipSlotNo()):getStaticStatus():getMaxDamage(0)) / 2
        matchEquip = true
      end
    elseif (__eClassType_Warrior == classType or __eClassType_Valkyrie == classType) and (1 == equipType or 8 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
      offencePoint = (itemWrapper:getStaticStatus():getMinDamage(0) + itemWrapper:getStaticStatus():getMaxDamage(0)) / 2
      defencePoint = itemWrapper:getStaticStatus():getDefence(0)
      matchEquip = true
    elseif __eClassType_Giant == classType and (29 == equipType or 34 == equipType or isAwakenWeaponContentsOpen and 57 == equipType) or 13 == equipType or 9 == equipType or 11 == equipType or 12 == equipType then
...
function HandleClickedUseItem(slotNo)
  ...
  local inventoryType = _lowerTabData[InventoryInfo._currentLowerTab].whereType
...
function HandleClicked_Inventory_All_UseMultiBoxes()
  Panel_NumberPad_Show(true, InventoryInfo._multiUseCount_s64, InventoryInfo._multiUseInventoryType, HandleEvent_Inventory_All_UseMultiItems, false, InventoryInfo._multiUseSlotNo, false, nil, nil)
end
function HandleEvent_Inventory_All_UseMultiItems(count, inventoryType, slotNo)
  ...
  InventoryInfo._multiUseCount_s64 = toInt64(0, 1)
  InventoryInfo._multiUseInventoryType = nil
  InventoryInfo._multiUseSlotNo = nil
end
