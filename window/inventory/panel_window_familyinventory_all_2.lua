...
function FailyInventory_updateSlotData()
...
function HandleEventLUp_FamilyInventory_ToggleSortOption()
  if PaGlobal_Inventory_All == nil then
    return
  end
  PaGlobalFunc_AutoSortFunctionPanel_ShowToggle(InvenSortLinkPanelIndex.FamilyInventory)
end
...
function PaGlobal_FamilyInvnetory_IsShow()
  if Panel_Window_FamilyInventory_All == nil then
    return nil
  end
  return Panel_Window_FamilyInventory_All:GetShow()
end
