...
function PaGlobal_FamilyInventory_All:initSlotControl(stc_mainSlotBG, slotGapX, slotGapY)
  ...
  for ii = 0, self._showSlotCount - 1 do
    ...
    UIScroll.InputEventByControl(slotBG.empty, "HandleEventScroll_FamilyInvnetory_UpdateScroll")
    UIScroll.InputEventByControl(slot.icon, "HandleEventScroll_FamilyInvnetory_UpdateScroll")
...
function PaGlobal_FamilyInventory_All:registEventHandler()
  ...
  self._ui._btn_sortOption:addInputEvent("Mouse_LUp", "HandleEventLUp_FamilyInventory_ToggleSortOption()")
  UIScroll.InputEvent(self._ui._scroll, "HandleEventScroll_FamilyInvnetory_UpdateScroll")
  UIScroll.InputEventByControl(self._ui._stc_scrollArea, "HandleEventScroll_FamilyInvnetory_UpdateScroll")
...
function PaGlobal_FamilyInventory_All:prepareOpen()
  ...
  PaGlobalFunc_AutoSortFunctionPanel_LinkPanel(InvenSortLinkPanelIndex.FamilyInventory, Panel_Window_FamilyInventory_All, PaGlobal_FamilyInventory_All._ui._btn_sortOption, PaGlobal_FamilyInventory_All._ui._chkSort, nil, nil)
  PaGlobalFunc_AutoSortFunctionPanel_LoadSortOptionAndDoSort(InvenSortLinkPanelIndex.FamilyInventory)
...
function PaGlobal_FamilyInventory_All:prepareClose(isOpenEquip)
  ...
  if PaGlobalFunc_AutoSortFunctionPanel_GetShow(InvenSortLinkPanelIndex.FamilyInventory) == true then
...
function PaGlobal_FamilyInventory_All:getRealSlotNo(slotIndex)
  if false == PaGlobalFunc_AutoSortFunctionPanel_IsSorted(InvenSortLinkPanelIndex.FamilyInventory) then
  ...
  return selfPlayerWrapper:get():getRealInventorySlotNoNew(__eInventorySortWhereType_FamilyInventory, slotIndex + self._showStartSlot)
end
