...
function PaGlobal_Copyright:init()
  self._Web = UI.createControl(__ePAUIControl_WebControl, Panel_Copyright, "WebControl_Copyright_WebLink")
  ...
  registerEvent("FromClient_CloseCopyRightPanel", "PaGlobal_Copyright_Close")
end
...
function PaGlobal_Copyright_GetShow()
  if Panel_Copyright == nil then
    return false
  end
  return Panel_Copyright:GetShow()
end
