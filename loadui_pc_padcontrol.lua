...
function loadServerSelectUI_PC()
  ...
  basicLoadUI("UI_Data/Window/MessageBox/Panel_KickOff.XML", "Panel_KickOff", UIGroup.PAGameUIGroup_ModalDialog)
  basicLoadUI("UI_Data/UI_Lobby/Panel_Lobby_ChannelDesc_ForNewbie_All.xml", "Panel_Lobby_ChannelDesc_ForNewbie", UIGroup.PAGameUIGroup_ModalDialog)
  basicLoadUI("UI_Data/UI_Lobby/UI_GamerTag.XML", "Panel_GamerTag", UIGroup.PAGameUIGroup_GameSystemMenu, SETRENDERMODE_BITSET_ALLRENDER())
  runLua("UI_Data/Script/Panel_GamerTag.lua")
...
function preLoadGameUI_PC()
  ...
  loadUI("UI_Data/Window/Equipment/Panel_Equipment_CrystalTooltip.XML", "Panel_Equipment_Crystal_Tooltip", UIGroup.PAGameUIGroup_Window_Progress, PAUIRenderModeBitSet({
    RenderMode.eRenderMode_Default,
    RenderMode.eRenderMode_Dialog
  }))
  ...
  if true == _ContentsGroup_SpiritGroupEnchant then
    ...
    loadUI("UI_Data/Window/Enchant/Panel_Widget_PartyEnchant_BubbleText_All.XML", "Panel_Widget_PartyEnchant_BubbleText_All", UIGroup.PAGameUIGroup_Windows, PAUIRenderModeBitSet({
      RenderMode.eRenderMode_Dialog
    }))
  end
  ...
  if _ContentsGroup_Crogdalo == true then
    loadUI("UI_Data/Widget/ServantIcon/Panel_Widget_KrogStable.XML", "Panel_Window_CrogdaloStable", UIGroup.PAGameUIGroup_Widget, PAUIRenderModeBitSet({
      RenderMode.eRenderMode_Default
    }))
  end
  ...
  basicLoadUI("UI_Data/Window/Guild/Panel_Window_Guild_ActivityFunds_Option_All.XML", "Panel_Window_GuildActivityFunds_Option_All", UIGroup.PAGameUIGroup_Window_Progress)
  ...
  basicLoadUI("UI_Data/Window/Guild/Panel_Window_Guild_IncentiveOption_All.XML", "Panel_Window_GuildIncentiveSetting_All", UIGroup.PAGameUIGroup_Window_Progress)
  basicLoadUI("UI_Data/Window/Guild/Panel_Window_Guild_MemberPointDetail_All.XML", "Panel_Window_GuildMemberPointDetail_All", UIGroup.PAGameUIGroup_Window_Progress)
  basicLoadUI("UI_Data/Window/Guild/Panel_Window_Guild_PointOption_All.XML", "Panel_Window_GuildPointOption_All", UIGroup.PAGameUIGroup_Window_Progress)
  ...
  basicLoadUI("UI_Data/Widget/Chatting/Panel_Window_Join_ChannelChat.XML", "Panel_Window_ChannelChat", UIGroup.PAGameUIGroup_Windows, RenderMode.eRenderMode_ElfWar)
  ...
  basicLoadUI("UI_Data/Actor/UI_Actor_LocalWarOccupation_Gauge.XML", "Panel_LocalWar_OccupationGauge", UIGroup.PAGameUIGroup_MainUI)
  ...
  if true == _ContentsGroup_RemasterUI_Main_Alert then
    ...
    loadUI("UI_Data/Widget/AlertArea/Panel_Widget_ChallengeAlert.xml", "Panel_Widget_ChallengeAlert", UIGroup.PAGameUIGroup_MapRegion, PAUIRenderModeBitSet({
      RenderMode.eRenderMode_Default,
      RenderMode.eRenderMode_Sequence,
      RenderMode.eRenderMode_SequencePlayerControl
    }))
  ...
  if _ContentsGroup_ElfWar == true then
    ...
    loadUI("UI_Data/Window/ElfWar/Panel_ElfWar_DeadMessage.XML", "Panel_ElfWar_DeadMessage", UIGroup.PAGameUIGroup_ModalDialog, PAUIRenderModeBitSet({
      RenderMode.eRenderMode_Dialog,
      RenderMode.eRenderMode_Default
    }))
