...
function PaGlobal_TutorialManager:initializeClassBasicSkillPhaseTable()
  for classType = 0, __eClassType_Count - 1 do
    local tutorialPhase_BasicSkill = PaGlobalFunc_Util_GetClassBasicSkillPhaseTable(classType)
    if tutorialPhase_BasicSkill ~= nil then
      self._classBasicSkillPhaseList[classType] = tutorialPhase_BasicSkill
    end
  end
end
