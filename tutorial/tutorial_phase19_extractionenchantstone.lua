PaGlobal_TutorialPhase_ExtractionEnchantStone = {
  ...
  _isPhaseOpen = true,
  _isSkippable = false,
  _buttonExtraction_EnchantStone = nil,
  _buttonExtraction_Crystal = nil,
  _buttonExtraction_Cloth = nil
}
...
function PaGlobal_TutorialPhase_ExtractionEnchantStone:startPhaseXXX(stepNo)
  ...
  self._updateTime = 0
  self._buttonExtraction_EnchantStone = PaGlobal_Extraction_All_GetExtractionButtonEnchantStone()
  self._buttonExtraction_Crystal = PaGlobal_Extraction_All_GetExtractionButtonCrystal()
  self._buttonExtraction_Cloth = PaGlobal_Extraction_All_GetExtractionButtonCloth()
