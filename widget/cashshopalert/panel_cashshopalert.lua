...
function cashShopAlert:initialize()
  ...
  cashShopAlert:registEventHandler()
end
function cashShopAlert:registEventHandler()
  ...
  registerEvent("FromClient_InventoryUpdate", "FromClient_cashShopAlert_InventoryUpdate")
  registerEvent("selfPlayer_regionChanged", "FromClient_cashShopAlert_UpdateRegion")
  registerEvent("FromClient_PetAddSealedList", "FromClient_cashShopAlert_PetAddSealedList")
...
function Panel_CashShopAlert_ShowAni()
  ...
  aniInfo8:SetStartIntensity(1)
  aniInfo8:SetEndIntensity(3)
...
function Panel_CashShopAlert_RePos()
  ...
  Panel_CashShopAlert:SetPosY(getScreenSizeY() - Panel_CashShopAlert:GetSizeY() - 90)
end
function OpenCashShop()
  local recommendType = PaGlobal_RecommendManager:GetNowRecommendType()
  if Recommend_TYPE.TYPE_INVENTORY == recommendType then
    PaGlobal_EasyBuy:Open(5, nil, false)
  elseif Recommend_TYPE.TYPE_WEIGHT == recommendType then
    PaGlobal_EasyBuy:Open(4, nil, false)
  else
    PearlShop_Open()
...
function PaGlobalFunc_CashShopAlert_ChangeTexture(cashShopType)
...
function FromClient_cashShopAlert_InventoryUpdate()
  PaGlobalFunc_RecommendManager_ProcessRecommend()
end
function FromClient_cashShopAlert_UpdateRegion(regionData)
...
function FromClient_cashShopAlert_PetAddSealedList()
  PaGlobalFunc_RecommendManager_ProcessRecommend()
end
function FromClient_cashShopAlert_Init()
  cashShopAlert:initialize()
end
registerEvent("FromClient_luaLoadComplete", "FromClient_cashShopAlert_Init")
