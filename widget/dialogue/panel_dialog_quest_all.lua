PaGlobal_DialogQuest_All = {
  _ui = {
    ...
    stc_removeRewardBg = nil,
    txt_removeReward = nil,
    stc_moneyRewardBG = nil,
    stc_moneyTextValue = nil
  },
  ...
  _removeRewardCount = 0,
  _maxRemoveSlotCount = 16,
  _listRemoveRewardSlots = {},
  _uiBackRemoveRewardBg = {},
