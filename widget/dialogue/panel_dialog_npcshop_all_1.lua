function PaGlobal_NPCShop_ALL:initialize()
  ...
  self._ui._stc_myMoney_Area = UI.getChildControl(self._ui._stc_player_Silver, "Static_MyMoneyArea")
  self._ui._txt_myMoney = UI.getChildControl(self._ui._stc_myMoney_Area, "StaticText_MyMoney")
  self._ui._txt_Money_Value = UI.getChildControl(self._ui._stc_myMoney_Area, "StaticText_MoneyValue")
  self._ui._stc_Money_Icon = UI.getChildControl(self._ui._stc_myMoney_Area, "Static_Icon")
  self._ui._stc_OceanMoney_Icon = UI.getChildControl(self._ui._stc_myMoney_Area, "Static_OceanCoin")
  self._buttonSizeX = self._ui._pc._btn_Buy:GetSizeX()
  self._buttonPosX = self._ui._pc._btn_Buy:GetPosX()
  self._panelSizeY = Panel_Dialog_NPCShop_All:GetSizeY()
  ...
  self._ui._txt_GuildLimitTime = UI.getChildControl(self._ui._pc._stc_TabGroup, "StaticText_GuildLimitTime")
  ...
  self._ui._txt_GuildLimitTime:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_LIMITEDITEMSHOP_SIEGE"))
  ...
  self._ui._stc_OceanMoney_Icon:SetShow(false)
  ...
  if true == self._isPadSnap then
    ...
    local panelConsole = self._ui._stc_TitleBg:GetSizeY() + self._ui._console._stc_TabGroup_Console:GetSizeY() + self._ui._stc_SubBg:GetSizeY() + 15
    ...
    self._ui._btn_Check_Inven_Guild:SetPosY(self._ui._btn_Check_Inven_Guild:GetPosY() - 6)
    ...
    self._ui._btn_Check_Warehouse_Guild:SetPosY(self._ui._btn_Check_Inven_Guild:GetPosY())
...
function PaGlobal_NPCShop_ALL:registerEventHandler()
  ...
  registerEvent("FromClient_SilverChange", "PaGlobalFunc_NPCShop_SilverChange")
...
function PaGlobal_NPCShop_ALL:prepareOpen()
  ...
  self._value._isCamping = false
  if _ContentsGroup_NewUI_Camp_All == true and Panel_Window_Camp_All ~= nil then
    self._value._isCamping = PaGlobalFunc_Camp_All_GetIsCamping()
  elseif PaGlobal_Camp ~= nil then
  ...
  if _ContentsGroup_NewUI_Inventory_All == true and Panel_Window_Inventory_All ~= nil or Panel_Window_Inventory ~= nil then
    if true == _ContentsGroup_SellAtOnceItem and true == _ContentsGroup_RenewUI_InventoryEquip and false == self._value._isCamping then
      local SellAllEtcItem = function()
      ...
      local optionalPadEvent = {
        func = SellAllEtcItem,
        button = __eConsoleUIPadEvent_Up_Y,
        keyGuideString = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_INVENTORY_ETC_ITEM_SELL_ALL")
      }
      Inventory_SetFunctor(PaGlobalFunc_NPCShop_ALL_IsExchangeItem, HandleEventRUp_NPCShop_ALL_InvenItemRClick, HandleEventLUp_NPCShop_ALL_Close, nil, optionalPadEvent)
    else
  ...
  if true == self._ui._txt_GuildLimitTime:GetShow() then
    PaGlobal_NPCShop_ALL:siegeResetTimerRegister()
  end
end
...
function PaGlobal_NPCShop_ALL:pushKeyToList2()
  ...
  if self._isPadSnap == false then
    self._ui._pc._btn_Buy:SetText(self._tabString[self._value._currentTabIndex])
    self._ui._pc._btn_BuySome:SetText(self._tabStringLeft[self._value._currentTabIndex])
  end
end
...
function PaGlobal_NPCShop_ALL:resize()
  ...
  local invenPosX = 0
  local invenPosY = 0
  local inventoryPanelUi
  if _ContentsGroup_NewUI_Inventory_All == true and Panel_Window_Inventory_All ~= nil then
    inventoryPanelUi = Panel_Window_Inventory_All
    isInvenOpen = Panel_Window_Inventory_All:GetShow() == true and Panel_Window_Inventory_All:IsUISubApp() == false
  ...
  elseif Panel_Window_Inventory ~= nil then
    inventoryPanelUi = Panel_Window_Inventory
    isInvenOpen = Panel_Window_Inventory:GetShow() == true and Panel_Window_Inventory:IsUISubApp() == false
  ...
  if isInvenOpen == true then
    ...
    Panel_Dialog_NPCShop_All:SetPosX(invenPosX - Panel_Dialog_NPCShop_All:GetSizeX() - 5)
    Panel_Dialog_NPCShop_All:SetPosY(invenPosY)
    ...
    Panel_Dialog_NPCShop_All:SetPosX(invenPosX - Panel_Dialog_NPCShop_All:GetSizeX() - 5)
    Panel_Dialog_NPCShop_All:SetPosY((screenSizeY - Panel_Npc_Dialog_All:GetSizeY()) / 2 - Panel_Dialog_NPCShop_All:GetSizeY() / 2)
    inventoryPanelUi:SetPosY(Panel_Dialog_NPCShop_All:GetPosY())
  else
    Panel_Dialog_NPCShop_All:SetPosX(screenSizeX / 2 - Panel_Dialog_NPCShop_All:GetSizeX() / 2 - 5)
    Panel_Dialog_NPCShop_All:SetPosY((screenSizeY - Panel_Npc_Dialog_All:GetSizeY()) / 2 - Panel_Dialog_NPCShop_All:GetSizeY() / 2)
    Panel_Dialog_NPCShop_All:ComputePos()
  end
  if true == self._isPadSnap then
...
function PaGlobal_NPCShop_ALL:prepareClose(showAni)
  ...
  if true == self._ui._txt_GuildLimitTime:GetShow() then
    Panel_Dialog_NPCShop_All:ClearUpdateLuaFunc()
  end
  Panel_Tooltip_Item_hideTooltip()
  if PaGlobalFunc_Inventory_All_familyInventoryButtonActive ~= nil then
    Inventory_SetFunctor(nil, nil, nil, nil)
    PaGlobalFunc_Inventory_All_familyInventoryButtonActive(true)
  end
  if true == _ContentsGroup_NewUI_Inventory_All and PaGlobalFunc_Inventory_All_CloseWithSpiritNpcShop ~= nil then
    PaGlobalFunc_Inventory_All_CloseWithSpiritNpcShop()
  elseif InventoryWindow_Close ~= nil then
  ...
  if true == _ContentsGroup_NewUI_Camp_All then
    if Panel_Window_Camp_All ~= nil and PaGlobalFunc_Camp_All_GetIsCamping() then
      if InventoryWindow_Close ~= nil then
        InventoryWindow_Close()
      end
      PaGlobal_Camp_All:open()
    end
  elseif PaGlobal_Camp ~= nil and PaGlobal_Camp:getIsCamping() then
    if InventoryWindow_Close ~= nil then
      InventoryWindow_Close()
    end
    PaGlobal_Camp:open()
...
function PaGlobal_NPCShop_ALL:updateMoney()
  ...
  if true == isGuildFlag then
    ...
    self._ui._pc._btn_Buy:SetSize(self._buttonSizeX, self._ui._pc._btn_Buy:GetSizeY())
    self._ui._pc._btn_BuySome:SetSize(self._buttonSizeX, self._ui._pc._btn_BuySome:GetSizeY())
    self._ui._pc._btn_Buy:SetPosX(self._buttonPosX)
    self._ui._pc._btn_BuySome:SetPosX(self._buttonPosX)
    self._ui._pc._btn_BuySome:SetPosY(self._ui._pc._btn_Buy:GetPosY() + self._ui._pc._btn_Buy:GetSizeY() + 5)
    Panel_Dialog_NPCShop_All:SetSize(Panel_Dialog_NPCShop_All:GetSizeX(), self._panelSizeY)
  else
    PaGlobalFunc_ShopTypeTradePriceIconChange(self._isSavedTradePrice)
    self._ui._pc._btn_Buy:SetSize(220, self._ui._pc._btn_Buy:GetSizeY())
    self._ui._pc._btn_BuySome:SetSize(220, self._ui._pc._btn_BuySome:GetSizeY())
    self._ui._pc._btn_Buy:SetPosX(self._buttonPosX + 100)
    self._ui._pc._btn_BuySome:SetPosY(self._ui._pc._btn_Buy:GetPosY())
    self._ui._pc._btn_BuySome:SetPosX(self._ui._pc._btn_Buy:GetPosX() - 230)
    self._ui._stc_myMoney_Area:SetSize(Panel_Dialog_NPCShop_All:GetSizeX() - self._ui._pc._btn_BuySome:GetSizeX() - self._ui._pc._btn_Buy:GetSizeX() - 50, self._ui._stc_myMoney_Area:GetSizeY())
    self._ui._stc_player_Silver:ComputePos()
    self._ui._txt_Money_Value:ComputePos()
    self._ui._stc_Money_Icon:ComputePos()
    self._ui._stc_OceanMoney_Icon:ComputePos()
    Panel_Dialog_NPCShop_All:SetSize(Panel_Dialog_NPCShop_All:GetSizeX(), self._panelSizeY - self._ui._pc._btn_BuySome:GetSizeY())
  end
end
function PaGlobalFunc_ShopTypeTradePriceIconChange(isTradePrice)
  if nil == isTradePrice then
    return
  end
  local selfPlayer = getSelfPlayer()
  if nil == selfPlayer then
  ...
  local self = PaGlobal_NPCShop_ALL
  if true == isTradePrice then
    self._ui._stc_Money_Icon:SetShow(false)
    self._ui._stc_OceanMoney_Icon:SetShow(true)
    self._ui._txt_myMoney:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_NPCSHOP_MYOCEANCOIN_NAME"))
    ...
    self._ui._txt_Money_Value:SetText(makeDotMoney(mileageValue))
  else
    self._ui._stc_Money_Icon:SetShow(true)
    self._ui._txt_myMoney:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_COMMON_MYMONEY"))
    self._ui._stc_OceanMoney_Icon:SetShow(false)
    self._ui._txt_Money_Value:SetText(makeDotMoney(selfPlayer:get():getMoneyInventory():getMoney_s64()))
  end
end
...
function PaGlobal_NPCShop_ALL:buySome()
  ...
  local money_s64 = getSelfPlayer():get():getMoneyInventory():getMoney_s64()
  ...
  if true == _ContentsGroup_Barter and true == self._isSavedTradePrice then
    local priceItemWrapper = getInventoryItemByType(CppEnums.ItemWhereType.eMoneyInventory, __eInventoryMoneyType_Shell)
...
function PaGlobal_NPCShop_ALL:sellItemAll()
  ...
  local function checkItemMarket()
    if false ~= itemSSW:isDisplayWorldMarket() and 0 ~= shopItemEndurance then
  ...
  if nil ~= itemWrapper then
    ...
    if originalPrice > 1000 and (false == itemWrapper:isMaxEndurance() or itemWrapper:get():getMaxEndurance() ~= checkMaxEndurance) then
...
function PaGlobal_NPCShop_ALL:inventoryShow()
  ...
  if false == self._isConsole and true == _ContentsGroup_RenewUI_ItemMarketPlace_Only and Panel_Window_MarketPlace_WalletInventory ~= nil and Panel_Window_MarketPlace_WalletInventory:GetShow() == true then
    PaGlobalFunc_MarketWallet_ForceClose()
  end
  if true == _ContentsGroup_NewUI_Inventory_All and false == self._value._isCamping then
    if PaGlobalFunc_Inventory_All_OpenWithNpcShop ~= nil then
      PaGlobalFunc_Inventory_All_OpenWithNpcShop()
    end
  else
    if InventoryWindow_Show ~= nil then
      InventoryWindow_Show()
    end
    if true == _ContentsGroup_UsePadSnapping and false == _ContentsGroup_RenewUI and nil ~= Panel_Window_Inventory and true == Panel_Window_Inventory:GetShow() then
...
function PaGlobal_NPCShop_ALL:buyOrSellItem(inputNumber)
  ...
  if self._ENUMTABINDEXBUY == self._value._currentTabIndex then
    ...
    local myInvenMoney = getSelfPlayer():get():getMoneyInventory():getMoney_s64()
    ...
    if dialog_isEventWarehouseNpc() == true then
      myWareHouseMoney = warehouse_moneyFromRegionKey_s64(warehouse_getEventWarehouseRegionKey())
    end
    if true == _ContentsGroup_Barter and true == self._isSavedTradePrice then
    ...
    if Panel_NumberPad_IsPopUp() and Panel_NumberPad_IsType("NpcShop_BuySome") then
      local isSeaCoinItem = true == shopItemWrapper:getStaticStatus():isTradePrice()
      ...
      if true == _ContentsGroup_Barter and true == isSeaCoinItem then
      ...
      local isUsePadSnapping = ToClient_isUsePadSnapping()
      if isSeaCoinItem == true and buyCount > PaGlobal_NPCShop_ALL.POPUP_MESSAGEBOX_SEACOIN then
        MessageBox.showMessageBox(messageboxData, nil, nil, isUsePadSnapping)
      elseif totalPrice >= PaGlobal_NPCShop_ALL.POPUP_MESSAGEBOX_MONEY and npcShop_isGuildShopContents() == false then
        MessageBox.showMessageBox(messageboxData, nil, nil, isUsePadSnapping)
      else
  ...
  elseif self._ENUMTABINDEXSELL == self._value._currentTabIndex then
    do
      ...
      local function checkItemMarket()
        if false ~= shopItemSSW:isDisplayWorldMarket() and 0 ~= shopItemEndurance then
          local messageBoxMemo = PAGetString(Defines.StringSheet_GAME, "LUA_NPCSHOP_ITEMMARKET_USE_MSGMEMO")
          local messageBoxData = {
            title = PAGetString(Defines.StringSheet_GAME, "LUA_NPCSHOP_SELL_ALERT_2"),
            content = messageBoxMemo,
...
function PaGlobal_NPCShop_ALL:InvenItemSell(itemCount, idx)
  ...
  local function checkItemMarket()
    if false ~= itemWrapper:isDisplayWorldMarket() and 0 ~= itemEndurance then
      if true == _ContentsGroup_RenewUI_ItemMarketPlace_Only then
        local messageBoxMemo = PAGetString(Defines.StringSheet_GAME, "LUA_NPCSHOP_ITEMMARKET_USE_MSGMEMO")
        local messageBoxData = {
          title = PAGetString(Defines.StringSheet_GAME, "LUA_NPCSHOP_SELL_ALERT_2"),
...
function PaGlobal_NPCShop_ALL:setItem(dataIndex, itemStaticWrapper, s64_stackCount, s64_price, s64_invenCount, rentTime, Intimacy, disable, isLimitedBuyableCount, remainingCount, resetType, isLimitedByUser, buyableMaxCount)
  ...
  if enable then
    PAGlobalFunc_SetItemTextColor(createdSlot.text, itemStaticWrapper)
  else
  ...
  createdSlot.icon.icon:SetColor(Defines.Color.C_FFFFFFFF)
  if itemStaticWrapper:isUsableServant() == false and itemStaticWrapper:get():isEquipable() == true and PaGlobalFunc_Util_CheckSeasonEquip(itemStaticWrapper) == false or itemStaticWrapper:isUsableServant() == false and itemStaticWrapper:get():isEquipable() == true and false == itemStaticWrapper:get()._usableClassType:isOn(classType) then
    createdSlot.icon.icon:SetColor(Defines.Color.C_FFD20000)
  end
  if self._ENUMTABINDEXBUY == self._value._currentTabIndex and isLimitedBuyableCount then
    ...
    elseif 4 == resetType then
      stringId = stringId .. "SIEGE"
    end
    ...
    if s64_stackCount < self._CONST.s64_0 then
      ...
      if self._ENUMTABINDEXREBUY == self._value._currentTabIndex then
        createdSlot.price:SetText(makeDotMoney(s64_price * s64_stackCount))
      end
    end
  end
  ...
  if Intimacy > 0 and (false == self._value._isCamping or nil == self._value._isCamping) then
  ...
  if dialog_isEventWarehouseNpc() == true then
    myWareHouseMoney_s64 = warehouse_moneyFromRegionKey_s64(warehouse_getEventWarehouseRegionKey())
  end
  if true == _ContentsGroup_Barter then
    ...
    if true == itemStatic:isTradePrice() then
      createdSlot.coinIcon:SetColor(4294967295)
      ...
      createdSlot.coinIcon:SetColor(4292390256)
    ...
    self._isSavedTradePrice = itemStatic:isTradePrice()
    PaGlobalFunc_ShopTypeTradePriceIconChange(itemStatic:isTradePrice())
  ...
  if npcShop_isGuildShopContents() then
    ...
    if nil ~= myGuildListInfo then
      ...
      elseif true == isLimitedBuyableCount and buyableMaxCount > 0 and 0 == remainingCount then
        createdSlot.price:SetFontColor(self._COLORCANNOTBUY)
      else
  ...
  elseif self._ENUMTABINDEXBUY == self._value._currentTabIndex then
    ...
    if true == isBuy then
      if true == isLimitedBuyableCount and buyableMaxCount > 0 and 0 == remainingCount then
        createdSlot.price:SetFontColor(self._COLORCANNOTBUY)
      else
        createdSlot.price:SetFontColor(self._COLORCANBUY)
      end
  ...
  if 4 == resetType then
    self._ui._txt_GuildLimitTime:SetShow(true)
  else
    self._ui._txt_GuildLimitTime:SetShow(false)
  end
end
...
function PaGlobal_NPCShop_ALL:siegeResetTimerRegister()
  if nil == Panel_Dialog_NPCShop_All then
    return
  end
  self._ui._txt_GuildLimitTime:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_LIMITEDITEMSHOP_SIEGE_RESET"))
end
