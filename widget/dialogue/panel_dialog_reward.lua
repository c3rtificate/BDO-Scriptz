...
local expTooltip = UI.createControl(__ePAUIControl_StaticText, Panel_Npc_Quest_Reward, "expTooltip")
...
function QuestReward_Init()
  defaultRewardText:SetTextMode(__eTextMode_AutoWrap)
  ...
  selectRewardText:SetTextMode(__eTextMode_AutoWrap)
...
function FGlobal_SetRewardList(baseReward, selectReward, questData)
  ...
  if nil ~= questData then
    ...
    ToClient_ChangeQuestIconFromIconPath(_uiQuestTitle, questData:getIconPath(), questData:getQuestType())
    ...
    _uiQuestDesc:SetTextMode(__eTextMode_AutoWrap)
...
PaGlobal_Util_RegistHelpTooltipEvent(_buttonQuestion, "\"PanelQuestReward\"")
QuestReward_Init()
