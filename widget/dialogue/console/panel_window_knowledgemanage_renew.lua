...
function KnowledgeManage:initialize()
  ...
  self._ui.list2:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_KnowledgeManage_ListControlCreate")
...
function KnowledgeManage:setTabTo(tabIndex)
  ...
  if TAB_TYPE.KNOWLEDGE == self._currentTab then
    ...
    self._ui.txt_currentAssetVal:SetText(makeDotMoney(getSelfPlayer():get():getMoneyInventory():getMoney_s64()))
...
function KnowledgeManage:updateThemeBook()
  local selfMoney = Int64toInt32(getSelfPlayer():get():getMoneyInventory():getMoney_s64())
