...
function GuildQuestReward:initialize()
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(self._ui.btn_question, "\"PanelQuestReward\"")
  if true == _ContentsOption_CH_Help then
    self._ui.btn_question:SetShow(false)
  end
  self.expTooltip = UI.createControl(__ePAUIControl_StaticText, _panel, "expTooltip")
  ...
  self.expTooltip:SetTextMode(__eTextMode_AutoWrap)
