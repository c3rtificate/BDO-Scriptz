PaGlobal_DialogMain_All = {
  _ui = {
    ...
    stc_caption = nil,
    chk_caption = nil,
    stc_captionSequencing = nil,
    txt_captionTab = nil,
    txt_captionStr = nil,
    stc_captionTabByConsole = nil,
    btn_Mental = nil
  },
  _ui_pc = {
    stc_spaceBar = nil,
  ...
  _iconUpdateType = {
    ...
    CppEnums.ContentsType.Contents_Wanted,
    CppEnums.ContentsType.Contents_Crew,
    __eContents_YachtDice,
    __eContents_PetUpgrade,
    __eContents_ArtifactExchange,
    CppEnums.ContentsType.Contents_Knowledge
  },
  ...
  _blackSpiritGroupEnchant = false,
  ...
  _isOpenForCaphras = false,
  _isDialogVoiceTalking = false,
  _isCacheAutoNextContinue = false,
  _console_overIdx = 1,
