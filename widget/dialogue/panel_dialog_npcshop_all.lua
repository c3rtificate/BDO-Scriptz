PaGlobal_NPCShop_ALL = {
  POPUP_MESSAGEBOX_MONEY = toInt64(0, 30000000),
  POPUP_MESSAGEBOX_SEACOIN = toInt64(0, 500),
  _ui = {
    _stc_TitleBg = nil,
    _stc_SubBg = nil,
    _pc = {
    ...
    _stc_myMoney_Area = nil,
    _txt_Money_Value = nil,
    _stc_Money_Icon = nil,
    _txt_myMoney = nil,
  ...
  _CHKBTN_SIZEX_CONSOLE = 455,
  _OriPanalPosY = 0,
  _NPCSHOP_BUYBTN_POSX = 0,
  _NPCSHOP_SELLBTN_POSX = 0,
  _currentScrollData = {_index = 0, _scroll = 0},
  _tabString = {
    [0] = PAGetString(Defines.StringSheet_GAME, "NPCSHOP_BUY"),
    [1] = PAGetString(Defines.StringSheet_GAME, "NPCSHOP_SELL"),
    [2] = PAGetString(Defines.StringSheet_GAME, "NPCSHOP_REPURCHASE")
  },
  _tabStringLeft = {
    [0] = PAGetString(Defines.StringSheet_RESOURCE, "SHOP_BTN_MULTIBUY"),
    [1] = PAGetString(Defines.StringSheet_RESOURCE, "SHOP_BTN_MULTISELL")
  },
  _buttonPosX = nil,
  _buttonSizeX = nil,
  _panelSizeY = nil,
  _siegeShopResetTime_64 = nil,
  _curTime = nil,
  _isPadSnap = false,
  _isConsole = false,
  _initialize = false,
  _isSavedTradePrice = false
}
