...
function PaGlobal_MentalGame_All:controlTooltip_Init()
  ...
  self._ui_tooltip.txt_npcName:SetTextMode(__eTextMode_AutoWrap)
  self._ui_tooltip.txt_nextBonuse:SetTextMode(__eTextMode_AutoWrap)
  self._baseTooltipInfo._tooltipSizeY = Panel_MentalGameTooltip_All:GetSizeY()
  self._baseTooltipInfo._nameSizeY = self._ui_tooltip.txt_npcName:GetSizeY()
  self._baseTooltipInfo._statusTitlePosY = self._ui_tooltip.txt_statusTitle:GetPosY()
  self._baseTooltipInfo._hitBasePosY = self._ui_tooltip.txt_hitBase:GetPosY()
  self._baseTooltipInfo._hitBonusPosY = self._ui_tooltip.txt_hitBonus:GetPosY()
  self._baseTooltipInfo._valueBasePosY = self._ui_tooltip.txt_valueBase:GetPosY()
  self._baseTooltipInfo._valueBonusPosY = self._ui_tooltip.txt_valueBonus:GetPosY()
  self._baseTooltipInfo._commentTitlePosY = self._ui_tooltip.txt_commentTitle:GetPosY()
  self._baseTooltipInfo._commentInterestPosY = self._ui_tooltip.txt_commentInterest:GetPosY()
  self._baseTooltipInfo._commentFavorablePosY = self._ui_tooltip.txt_commentFavorable:GetPosY()
  self._baseTooltipInfo._nextBonusTitlePosY = self._ui_tooltip.txt_nextBonusTitle:GetPosY()
  self._baseTooltipInfo._nextBonusePosY = self._ui_tooltip.txt_nextBonuse:GetPosY()
end
...
function PaGlobal_MentalGame_All:updateState()
  ...
  if intimacyValuePercent > 100 then
...
function PaGlobal_MentalGame_All:updateTooltipContext(mentalCard, isInserted, slotIndex)
  ...
  self._ui_tooltip.txt_npcName:SetSize(self._ui_tooltip.txt_npcName:GetSizeX(), self._ui_tooltip.txt_npcName:GetTextSizeY())
  ...
  local tooltipGapY = self._ui_tooltip.txt_npcName:GetTextSizeY() - self._baseTooltipInfo._nameSizeY
  self._ui_tooltip.txt_statusTitle:SetPosY(self._baseTooltipInfo._statusTitlePosY + tooltipGapY)
  self._ui_tooltip.txt_hitBase:SetPosY(self._baseTooltipInfo._hitBasePosY + tooltipGapY)
  self._ui_tooltip.txt_hitBonus:SetPosY(self._baseTooltipInfo._hitBonusPosY + tooltipGapY)
  self._ui_tooltip.txt_valueBase:SetPosY(self._baseTooltipInfo._valueBasePosY + tooltipGapY)
  self._ui_tooltip.txt_valueBonus:SetPosY(self._baseTooltipInfo._valueBonusPosY + tooltipGapY)
  self._ui_tooltip.txt_commentTitle:SetPosY(self._baseTooltipInfo._commentTitlePosY + tooltipGapY)
  self._ui_tooltip.txt_commentInterest:SetPosY(self._baseTooltipInfo._commentInterestPosY + tooltipGapY)
  self._ui_tooltip.txt_commentFavorable:SetPosY(self._baseTooltipInfo._commentFavorablePosY + tooltipGapY)
  self._ui_tooltip.txt_nextBonusTitle:SetPosY(self._baseTooltipInfo._nextBonusTitlePosY + tooltipGapY)
  self._ui_tooltip.txt_nextBonuse:SetPosY(self._baseTooltipInfo._nextBonusePosY + tooltipGapY)
  Panel_MentalGameTooltip_All:SetSize(Panel_MentalGameTooltip_All:GetSizeX(), self._baseTooltipInfo._tooltipSizeY + tooltipGapY)
  return true
end
function PaGlobal_MentalGame_All:registEventHandler()
  ...
  registerEvent("progressEventCancelByAttacked", "FromClient_MentalGame_All_CloseFunctorRenderByAttack")
...
function PaGlobal_MentalGame_All:setKeyGuideAndEvent()
  ...
  if 0 == self._gameStep then
    self._ui_console.stc_guideIconY:SetShow(filledCount > 0)
