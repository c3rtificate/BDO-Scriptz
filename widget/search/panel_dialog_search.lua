...
local function initialize()
  ...
  if true == _ContentsOption_CH_GameType then
    ...
    var_UI.StaticText_Q:SetText(keyCustom_GetString_ActionKey(keyIndexSet.button_Q))
    var_UI.StaticText_W:SetText(keyCustom_GetString_ActionKey(keyIndexSet.button_W))
    var_UI.StaticText_E:SetText(keyCustom_GetString_ActionKey(keyIndexSet.button_E))
    var_UI.StaticText_A:SetText(keyCustom_GetString_ActionKey(keyIndexSet.button_A))
    var_UI.StaticText_S:SetText(keyCustom_GetString_ActionKey(keyIndexSet.button_S))
    var_UI.StaticText_D:SetText(keyCustom_GetString_ActionKey(keyIndexSet.button_D))
  end
end
initialize()
