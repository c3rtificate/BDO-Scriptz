function PaGlobal_FadeOut:initialize()
  ...
  PaGlobal_FadeOut._loadingTextEffectName = "UI_Loading_01A"
...
function PaGlobal_FadeOut:initBackGroundImageForException()
  ...
  if true == _ContentsOption_CH_LoadingImage then
    PaGlobal_FadeOut._bgImageTexture = {
      [0] = "Combine/Loading/Balenos_Reboot/2.dds",
      [1] = "Combine/Loading/Balenos_Reboot/3.dds",
      [2] = "Combine/Loading/Balenos_Reboot/4.dds",
      [3] = "Combine/Loading/Balenos_Reboot/5.dds"
    }
    self._totalImageCount = 4
  elseif true == _ContentsGroup_RebootStoryBalenos then
    PaGlobal_FadeOut._bgImageTexture = {
      [0] = "Combine/Loading/Balenos_Reboot/1.dds",
      [1] = "Combine/Loading/Balenos_Reboot/2.dds",
      [2] = "Combine/Loading/Balenos_Reboot/3.dds",
      [3] = "Combine/Loading/Balenos_Reboot/4.dds",
      [4] = "Combine/Loading/Balenos_Reboot/5.dds"
    }
    self._totalImageCount = 5
  elseif true == _ContentsGroup_Corsair then
    PaGlobal_FadeOut._bgImageTexture = {
      [0] = "Combine/Loading/BlackDesert_With_Friends.dds"
    }
    self._totalImageCount = 1
  elseif true == ToClient_IsContentsGroupOpen("7") then
    PaGlobal_FadeOut._bgImageTexture = {
...
function PaGlobal_FadeOut:initBackGroundImage()
  ...
  if tempImagePath ~= nil then
    ...
    PaGlobal_FadeOut:initBackGroundImageForException()
  end
...
function PaGlobal_FadeOut:open()
  ...
  if ToClient_isExitToLobbyState() == false then
    return
  end
  PaGlobal_FadeOut:resize()
  PaGlobal_FadeOut._ui._loadingText:SetShow(true)
  PaGlobal_FadeOut._ui._loadingText:EraseAllEffect()
  PaGlobal_FadeOut._ui._loadingText:AddEffect(PaGlobal_FadeOut._loadingTextEffectName, true, 0, 0)
  ...
  if true == _ContetnsGroup_ChangeLoadingImg then
    for idx = 0, self._totalImageCount - 1 do
      if nil ~= PaGlobal_FadeOut._bgEmptyControl[idx] then
        ...
        PaGlobal_FadeOut._bgEmptyControl[idx]:SetSize(movieSizeX, movieSizeY)
  ...
  if false == PaGlobal_FadeOut._isImageFadeOut then
    ...
    if nil ~= PaGlobal_FadeOut._bgEmptyControl[PaGlobal_FadeOut._currentImageIdx] then
      ...
      if temporaryWrapper ~= nil then
        local bgSizeX = PaGlobal_FadeOut._bgEmptyControl[PaGlobal_FadeOut._currentImageIdx]:GetSizeX()
        local bgSizeY = PaGlobal_FadeOut._bgEmptyControl[PaGlobal_FadeOut._currentImageIdx]:GetSizeY()
        local textPosX = PaGlobal_FadeOut._ui._loadingText:GetPosX()
        local textPosY = PaGlobal_FadeOut._ui._loadingText:GetPosY()
        local loadingText = PaGlobal_FadeOut._ui._loadingText:GetText()
        temporaryWrapper:updateFadeOutSceneInfo(bgSizeX, bgSizeY, textPosX, textPosY, loadingText, PaGlobal_FadeOut._loadingTextEffectName, PaGlobal_FadeOut._bgImageTexture[PaGlobal_FadeOut._currentImageIdx])
      end
    end
