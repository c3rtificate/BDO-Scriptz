function PaGlobal_Widget_Tutorial_GuideUI:initialize()
  ...
  Panel_Widget_Tutorial_GuideUI:SetChildIndex(self._ui._stc_focus, 9998)
  self._initialize = true
end
function PaGlobal_Widget_Tutorial_GuideUI:initClear()
  self._toTime = 0
  self._findControl = nil
  self._selectedPanel = nil
  self._ui._stc_focus:SetShow(false)
...
function PaGlobal_Widget_Tutorial_GuideUI:destroyClear()
  if nil ~= self._selectedPanel then
    self._selectedPanel:unapplyTutorialAttrChild()
  end
  self._selectedPanel = nil
  self:clearEffectList()
  self:hideAllBlackBG()
...
function PaGlobal_Widget_Tutorial_GuideUI:validate()
  self._ui._stc_focus:isValidate()
...
function PaGlobal_Widget_Tutorial_GuideUI:startEvent__XXX(eventKey)
  ...
  if true == useBlackBG then
    ...
    if nil ~= panel then
      ...
      if nil ~= control then
        ...
        _PA_ASSERT(false, "BlackBG\236\151\144\236\132\156 \236\176\190\236\157\132 ChildControl\236\157\180 \236\151\134\236\138\181\235\139\136\235\139\164.")
      end
    else
      _PA_ASSERT(false, "BlackBG\236\151\144 \236\160\129\236\154\169\237\149\160 Panel\236\157\132 \236\176\190\236\157\132 \236\136\152 \236\151\134\236\138\181\235\139\136\235\139\164.")
    end
  ...
  if true == useWhiteBG then
    ...
    if nil ~= findControl then
      ...
      local findIndex = startEventSSW:getWhiteChildControlIndex()
      local panel = ToClient_getPanelByKey(panelID)
      if nil ~= panel then
        local control
        if 0 == childID then
        ...
        if nil ~= control then
          ...
          _PA_ASSERT(false, "WhiteBG\236\151\144\236\132\156 \236\176\190\236\157\132 ChildControl\236\157\180 \236\151\134\236\138\181\235\139\136\235\139\164.")
        end
      else
        _PA_ASSERT(false, "WhiteBG\236\151\144 \236\160\129\236\154\169\237\149\160 Panel\236\157\132 \236\176\190\236\157\132 \236\136\152 \236\151\134\236\138\181\235\139\136\235\139\164.")
      end
    end
  ...
  if nil ~= findControl then
    if true == snappingEffectOn then
      self._effectInfo:setTargetControl(findControl)
    end
    self._findControl = findControl
    self._ui._stc_focus:SetShow(true)
  end
  local selectedPanelID = startEventSSW:getSelectedPanel()
  if 0 ~= selectedPanelID then
    local panel = ToClient_getPanelByKey(selectedPanelID)
    if nil ~= panel then
      panel:applyTutorialAttrChild()
      local maxCount = startEventSSW:getSelectedControlListSize()
      for ii = 0, maxCount - 1 do
        local childID = startEventSSW:getSelectedChildControl(ii)
        local findIndex = startEventSSW:getSelectedChildControlIndex(ii)
        local control = panel:FindControlByIndex(childID, findIndex)
        if nil ~= control then
          panel:SetIgnore(false)
          control:SetIgnore(false)
          control:SetMonoTone(false)
        else
          _PA_ASSERT(0 == childID, "SelectedBG\236\151\144\236\132\156 \236\176\190\236\157\132 ChildControl\236\157\180 \236\151\134\236\138\181\235\139\136\235\139\164. Index = " .. tostring(ii))
        end
      end
      self._selectedPanel = panel
    else
      _PA_ASSERT(false, "SelectedBG\236\151\144 \236\160\129\236\154\169\237\149\160 Panel\236\157\132 \236\176\190\236\157\132 \236\136\152 \236\151\134\236\138\181\235\139\136\235\139\164.")
    end
  end
end
