...
function PersonalIcon_Tooltip()
  local self = personalIcon
  self._btn_NpcNavi:addInputEvent("Mouse_LUp", "PaGlobal_NpcNavi_All_ShowToggle()")
  self._btn_NpcNaviTW:addInputEvent("Mouse_LUp", "PaGlobal_NpcNavi_All_ShowToggle()")
  ...
  self._btn_VoiceChat:addInputEvent("Mouse_LUp", "PaGlobalFunc_SetVoiceChat_All_Toggle()")
