PaGlobal_NpcNavi_All = {
  ...
  _territoryTownData = {
    ...
    [3] = {
      ...
      _isOpen = _ContentsGroup_Calpheon,
    ...
    [5] = {
      ...
      _isOpen = _ContentsGroup_Valencia,
    ...
    [6] = {
      ...
      _isOpen = _ContentsGroup_Kamasilvia,
    ...
    [8] = {
      ...
      _isOpen = _ContentsGroup_Othilita,
    ...
    [9] = {
      ...
      _z = -389618,
      _actorKey = 50865,
      _desc = PAGetString(Defines.StringSheet_GAME, "LUA_TOWNNAVI_WAREHOUSE_9"),
      _isOpen = _ContentsGroup_MountainOfEternalWinter,
      _dds = "renewal/etc/wordmap/territorymark_SnowMountain_large.dds",
      _uv = {
        x1 = 0,
        x2 = 256,
        y1 = 0,
    ...
    [10] = {
      ...
      _z = 1128960,
      _actorKey = 47211,
      _desc = PAGetString(Defines.StringSheet_GAME, "LUA_TOWNNAVI_WAREHOUSE_10"),
      _isOpen = _ContentsGroup_MorningLand,
      _dds = "renewal/etc/wordmap/territorymark_MorningLand_large.dds",
      _uv = {
        x1 = 0,
        x2 = 256,
        y1 = 0,
    ...
    [11] = {
      ...
      _z = -189661,
      _actorKey = 47385,
      _desc = PAGetString(Defines.StringSheet_GAME, "LUA_TOWNNAVI_WAREHOUSE_11"),
      _isOpen = _ContentsGroup_MediaPt2,
      _dds = "renewal/etc/wordmap/territorymark_Ulukita_large.dds",
      _uv = {
        x1 = 0,
        x2 = 256,
        y1 = 0,
  ...
  _iconTextureData = {
    [0] = nil,
    [1] = {
      type = CppEnums.SpawnType.eSpawnType_WareHouse,
      x1 = 116,
      y1 = 116,
      x2 = 171,
      y2 = 171,
    ...
    [2] = {
      type = CppEnums.SpawnType.eSpawnType_ItemMarket,
      x1 = 287,
      y1 = 2,
      x2 = 342,
      y2 = 57,
    ...
    [3] = {
      type = CppEnums.SpawnType.eSpawnType_Stable,
      x1 = 217,
      y1 = 73,
      x2 = 252,
      y2 = 108,
    ...
    [4] = {
      type = CppEnums.SpawnType.eSpawnType_Wharf,
      x1 = 173,
      y1 = 287,
      x2 = 228,
      y2 = 342,
    ...
    [5] = {
      type = CppEnums.SpawnType.eSpawnType_Potion,
      x1 = 361,
      y1 = 73,
      x2 = 396,
      y2 = 108,
    ...
    [6] = {
      type = CppEnums.SpawnType.eSpawnType_ChurchBuff,
      x1 = 217,
      y1 = 721,
      x2 = 252,
      y2 = 756,
    ...
    [7] = {
      type = CppEnums.SpawnType.eSpawnType_ItemRepairer,
      x1 = 37,
      y1 = 109,
      x2 = 72,
      y2 = 144,
    ...
    [8] = {
      type = CppEnums.SpawnType.eSpawnType_Worker,
      x1 = 2,
      y1 = 230,
      x2 = 57,
      y2 = 285,
    ...
    [9] = {
      type = CppEnums.SpawnType.eSpawnType_SkillTrainer,
      x1 = 145,
      y1 = 505,
      x2 = 180,
      y2 = 540,
    ...
    [10] = {
      type = CppEnums.SpawnType.eSpawnType_TraningVehicleShop,
      x1 = 452,
      y1 = 370,
      x2 = 492,
      y2 = 410,
    ...
    [11] = {
      type = CppEnums.SpawnType.eSpawnType_Cook,
      x1 = 109,
      y1 = 73,
      x2 = 144,
      y2 = 108,
    ...
    [12] = {
      type = CppEnums.SpawnType.eSpawnType_Collect,
      x1 = 397,
      y1 = 613,
      x2 = 432,
      y2 = 648,
    ...
    [13] = {
      type = CppEnums.SpawnType.eSpawnType_AbyssOneEnterPosGuide,
      x1 = 181,
      y1 = 685,
      x2 = 216,
      y2 = 720,
    ...
    [14] = {
      type = CppEnums.SpawnType.eSpawnType_SupplyShop,
      x1 = 370,
      y1 = 124,
      x2 = 410,
      y2 = 164,
    ...
    [15] = {
      type = CppEnums.SpawnType.eSpawnType_TradeMerchant,
      x1 = 253,
      y1 = 73,
      x2 = 288,
      y2 = 108,
    ...
    [16] = {
      type = CppEnums.SpawnType.eSpawnType_transfer,
      x1 = 59,
      y1 = 173,
      x2 = 114,
      y2 = 228,
    ...
    [17] = {
      type = CppEnums.SpawnType.eSpawnType_guild,
      x1 = 2,
      y1 = 287,
      x2 = 57,
      y2 = 342,
    ...
    [18] = {
      type = CppEnums.SpawnType.eSpawnType_Weapon,
      x1 = 2,
      y1 = 2,
      x2 = 57,
      y2 = 57,
    ...
    [19] = {
      type = CppEnums.SpawnType.eSpawnType_Jewel,
      x1 = 469,
      y1 = 613,
      x2 = 504,
      y2 = 648,
    ...
    [20] = {
      type = CppEnums.SpawnType.eSpawnType_Furniture,
      x1 = 433,
      y1 = 613,
      x2 = 468,
      y2 = 648,
    ...
    [21] = {
      type = CppEnums.SpawnType.eSpawnType_Fish,
      x1 = 401,
      y1 = 287,
      x2 = 456,
      y2 = 342,
    ...
    [22] = {
      type = CppEnums.SpawnType.eSpawnType_Instrument,
      x1 = 124,
      y1 = 370,
      x2 = 164,
      y2 = 410,
