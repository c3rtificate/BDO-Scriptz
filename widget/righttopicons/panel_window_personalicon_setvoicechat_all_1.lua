...
function PaGlobal_SetVoiceChat_All:controlInit_All()
  ...
  self._ui.btn_teamate = UI.getChildControl(Panel_Window_SetVoiceChat_All, "Button_TeamVoice")
...
function PaGlobal_SetVoiceChat_All:registEventHandler()
  ...
  self._ui.btn_teamate:addInputEvent("Mouse_LUp", "PaGlobal_LocalWarVoiceChat_Open()")
...
function PaGlobal_SetVoiceChat_All:resize()
  ...
  if false == self._isConsole then
    ...
    if _ContentsGroup_LocalWarVoiceChat == true and ToClient_IsOccupationModeInLocalWar() == true then
      Panel_Window_SetVoiceChat_All:SetSize(Panel_Window_SetVoiceChat_All:GetSizeX(), 560)
      self._ui.btn_teamate:SetShow(true)
    end
    ...
    self._ui.btn_teamate:ComputePos()
  else
