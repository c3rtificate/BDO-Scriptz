...
function PaGlobal_MaidList_All_resettingInvenFunc()
  if false == _ContentsGroup_UsePadSnapping and Panel_Window_Inventory_All ~= nil and Panel_Window_Inventory_All:GetShow() == true and Panel_Window_ShipInfo_All ~= nil and Panel_Window_ShipInfo_All:GetShow() == true then
