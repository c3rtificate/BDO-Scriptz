...
function Movable_UI()
  ...
  Panel_NpcNavi_All:SetDragEnable(true)
  if true == _ContentsGroup_NewUI_PartyWidget_All then
    Panel_Widget_Party_All:SetDragAll(true)
    Panel_Widget_Party_All:ChangeTextureInfoName("New_UI_Common_forLua/Default/window_sample_isWidget.dds")
  else
...
function Movable_UI_Cancel()
  ...
  Panel_NpcNavi_All:SetDragEnable(false)
  ...
  if true == _ContentsGroup_NewUI_PartyWidget_All then
    Panel_Widget_Party_All:SetDragEnable(false)
    Panel_Widget_Party_All:ChangeTextureInfoName("New_UI_Common_forLua/Default/window_sample_empty.dds")
  else
