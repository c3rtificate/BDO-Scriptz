...
function Panel_HorseEndurance_Position()
  ...
  self.radarSizeX = FGlobal_Panel_Radar_GetSizeX()
  self.panel:SetPosX(getOriginScreenSizeX() - self.radarSizeX - keyboardGuideX - self.panel:GetSizeX() * 1.7 - gapX)
  ...
  if true == isGameServiceTypeConsole() and nil ~= Panel_NewEquip then
