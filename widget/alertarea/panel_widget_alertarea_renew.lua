...
local _ContentOpen_BlackSpiritAdv_ = ToClient_IsContentsGroupOpen("1497")
local AlwaysOpenType = {
  ...
  eALERT_Spread = 5,
  eALERT_QuestList = 6,
  eALERT_TimeChallengeReward = 7,
  eALERT_MorningLandQuest = 8,
  count = 9
}
local AlertType = {
  eALERT_Hunting = 0,
...
local Panel_Widget_Alert_info = {
  _ui = {
    ...
    Button_MorningLandQuestBoard = nil,
    MessageBg = nil,
    MsgCloseButton = nil,
    MsgIcon = nil,
    MsgTime = nil,
...
function Panel_Widget_Alert_info:registEventHandler()
  ...
  self._ui.Button_MorningLandQuestBoard:addInputEvent("Mouse_LUp", "PaGlobal_MorningLand_QuestBoard_All_Open()")
  self._ui.Button_MorningLandQuestBoard:addInputEvent("Mouse_On", "PaGlobalFunc_Widget_Alert_ButtonTooltipShow(" .. AlwaysOpenType.eALERT_MorningLandQuest .. ")")
  self._ui.Button_MorningLandQuestBoard:addInputEvent("Mouse_Out", "PaGlobalFunc_Widget_Alert_ButtonTooltipHide()")
  ...
  self._ui.btn_blackEffect:addInputEvent("Mouse_On", "PaGlobalFunc_Widget_Alert_HandleOver(15)")
  self._ui.btn_blackEffect:addInputEvent("Mouse_Out", "PaGlobalFunc_Widget_Alert_HandleOut()")
...
function Panel_Widget_Alert_info:registerMessageHandler()
  ...
  registerEvent("FromClient_UpdateQuestCountWidget", "FromClient_UpdateQuestCountWidget")
...
function Panel_Widget_Alert_info:initialize()
  ...
  PaGlobalFunc_Widget_Alert_Info_UnRenderPanel()
end
...
function Panel_Widget_Alert_info:childControl()
  ...
  self._ui.Button_MorningLandQuestBoard = UI.getChildControl(self._ui.Static_Bg, "Button_MorningLand_QuestBoard")
  ...
  self._ui.StaticText_QuestListCount:SetShow(true)
end
function Panel_Widget_Alert_info:setCount(count, control)
  if nil == count then
    control:SetSize(self._originalSizeX, control:GetSizeY())
    return
  end
  if 100 <= tonumber(count) then
    control:SetSize(control:GetTextSizeX() + 12, control:GetSizeY())
  else
    control:SetSize(self._originalSizeX, control:GetSizeY())
  end
  control:ComputePos()
...
function Panel_Widget_Alert_info:updateIcons(forced, ignoerSetDataType1)
  ...
  if self._ui.Button_Spread:IsCheck() then
    ...
    self:setCount(spreadCount, self._ui.StaticText_SpreadCount)
...
function Panel_Widget_Alert_info:open()
  FromClient_Widget_Alert_MorningLandIconShow()
...
function PaGlobalFunc_Widget_Alert_ButtonTooltipShow(buttonType)
  ...
  elseif AlwaysOpenType.eALERT_MorningLandQuest == buttonType then
    uiControl = self._ui.Button_MorningLandQuestBoard
    local selfPlayer = getSelfPlayer()
    name = ""
    if selfPlayer ~= nil then
      name = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_MORNING_QUESTBOARD_TITLE", "charName", selfPlayer:getName())
    end
    desc = PAGetString(Defines.StringSheet_GAME, "LUA_ALERTWIDGET_TOOLTIP_QUESTBOARD_DESC")
  else
    return
  end
  TooltipSimple_Show(uiControl, name, desc)
...
function PaGlobalFunc_Widget_Alert_ClickSpread()
  ...
  if not self._ui.Button_Spread:IsCheck() then
    ...
    self:setCount(showIndex, self._ui.StaticText_SpreadCount)
    self._ui.StaticText_SpreadCount:SetShow(true)
  end
  self._speadCount = showIndex
  TooltipSimple_Hide()
end
function Panel_Widget_Alert_info:AlramShow(alertType, alertOtherText, textMode, logTime)
...
function Panel_Widget_Alert_info:setBubbleShow(isShow, alertType, param, isForce)
  ...
  if alertType == AlertType.eALERT_MyBossMonster or alertType == AlertType.eALERT_TotalReward then
    return
  end
  ...
  if nil ~= self._ui.Static_Bubbles[alertType] and true == self._ui.Static_Bubbles[alertType]:GetShow() then
    ...
    local bubbleEffect = UI.getChildControlNoneAssert(bubbleBg, "Static_BlackSpiritEffet")
    ...
    if nil ~= bubbleEffect then
      bubbleEffect:EraseAllEffect()
      bubbleEffect:AddEffect("fN_DarkSpirit_Gage_01A", true, 0, 0)
    end
  end
end
...
function PaGlobalFunc_Widget_Alert_Check_Hunting()
  ...
  self:setCount(totalCount, self._ui.StaticText_HuntingCount)
  if self._ui.Button_Spread:IsCheck() == false then
    self._alertButton[AlertType.eALERT_Hunting]:SetShow(isHuntingButtonShow)
  end
end
...
function PaGlobalFunc_Widget_Alert_Check_Coupon()
  ...
  self:setCount(count, self._ui.StaticText_CouponCount)
end
function PaGlobalFunc_Widget_Alert_Check_LearnSkill()
  ...
  self:setCount(skillCount, self._ui.StaticText_LearnSkillCount)
...
function PaGlobalFunc_Widget_Alert_Check_NewStoryKnowledge()
  ...
  self:setCount(count, self._ui.StaticText_NewStoryKnowledgeCount)
...
function PaGlobalFunc_Widget_Alert_Check_NewKnowledge()
  ...
  self:setCount(count, self._ui.StaticText_NewKnowledgeCount)
...
function PaGlobalFunc_Widget_Alert_Check_ChallengeReward()
  ...
  self:setCount(challengeRWCount, self._ui.StaticText_ChallengeRewardCount)
...
function PaGlobalFunc_Widget_Alert_Check_Pos()
  ...
  if self._ui.Button_MorningLandQuestBoard:GetShow() then
    self._ui.Button_MorningLandQuestBoard:SetSpanSize(spanX, 0)
    spanX = spanX + 40
  end
...
function PaGlobalFunc_Widget_Alert_Check_RewardList()
  ...
  if itemCount > 0 then
    ...
    self:setCount(tostring(itemCount), self._ui.txt_TotalRewardCount)
...
function PaGlobalFunc_Widget_Alert_Check_AcquireTitle()
  ...
  if acquireTitleForPlaying > 0 then
    ...
    self:setCount(tostring(acquireTitleForPlaying), self._ui.StaticText_TitleCount)
  else
    ...
    self:setCount(tostring(0), self._ui.StaticText_TitleCount)
  end
end
function PaGlobalFunc_Widget_Alert_Check_MarketPlaceMyBiddingUpdate(messageStr, logTime)
  local self = Panel_Widget_Alert_info
  if nil == self then
    return
  end
  ...
  Panel_Widget_Alert_info:AlramShow(AlertType.eALERT_MarketPlace_MyBiddingUpdate, messageStr, __eTextMode_Limit_AutoWrap, logTime)
end
function PaGlobalFunc_Widget_Alert_Check_BlackSpiritAdventureDice()
  if false == _ContentOpen_BlackSpiritAdv_ then
    return
  end
...
function PaGlobalFunc_Widget_Alert_SetUnReadMailCount()
  ...
  if nil ~= mailCount then
    if unReadMailCount + unReadMassMailCount > 0 then
      ...
      self:setCount(tostring(unReadMailCount + unReadMassMailCount), UI.getChildControl(self._ui.Button_Mail, "StaticText_MailCount"))
    else
...
function PaGlobalFunc_Widget_Alert_SetProgressQuestCount()
  ...
  if nil ~= self._ui.StaticText_QuestListCount then
    ...
    self:setCount(self._progressQuestCount, self._ui.StaticText_QuestListCount)
  end
end
...
function PcRoomGift_TimeCheck()
  ...
  if (isPremiumPcRoom or isRussiaPremiumPack) and 0 ~= remainedChallengeCount then
...
function PlayTime_TimeCheck()
  ...
  if 0 ~= remainedChallengeCount then
...
function FGlobal_ItemMarket_SetCount()
  ...
  if false == _ContentsGroup_RenewUI_ItemMarketPlace then
    ...
    self:setCount(alarmCount, self._ui.StaticText_MarketPlaceCount)
...
function FromClient_Widget_Alert_MorningLandIconShow()
  local self = Panel_Widget_Alert_info
  local isShow = self._ui.Button_MorningLandQuestBoard:GetShow()
  if questList_isClearQuest(8502, 4) == true or questList_isClearQuest(8502, 5) == true then
    self._ui.Button_MorningLandQuestBoard:SetShow(true)
    if isShow == false then
      PaGlobalFunc_Widget_Alert_Check_Pos()
    end
    self._ui.Button_MorningLandQuestBoard:EraseAllEffect()
    if questList_isClearQuest(8515, 10) == false then
      self._ui.Button_MorningLandQuestBoard:AddEffect("fUI_Morning_Button_01A", true, 0, 0)
    end
  else
    self._ui.Button_MorningLandQuestBoard:SetShow(false)
    self._ui.Button_MorningLandQuestBoard:EraseAllEffect()
  end
end
...
function FromClient_Widget_Alert_NewFriendAlert(param)
  ...
  if 1 == param then
    if nil ~= self._ui.StaticText_FriendRequestCount:GetText() and "" ~= self._ui.StaticText_FriendRequestCount:GetText() then
      ...
      self:setCount(tostring(requestCount), self._ui.StaticText_FriendRequestCount)
    else
      self._ui.StaticText_FriendRequestCount:SetText("1")
      self:setCount("1", self._ui.StaticText_FriendRequestCount)
    end
...
function FromClient_Widget_Alert_Update_NewFriendCount()
  ...
  if requestCount > 0 then
    ...
    self:setCount("0", self._ui.StaticText_FriendRequestCount)
  end
end
function FromClient_Widget_Alert_BlackSpiritQuest()
  local self = Panel_Widget_Alert_info
  PaGlobalFunc_Widget_Alert_Check_BlackSpiritQuest()
  self:updateIconsSpecifyIcon(AlertType.eALERT_BlackSpiritQuest)
  FromClient_Widget_Alert_MorningLandIconShow()
end
function FromClient_UpdateQuestCountWidget()
  PaGlobalFunc_Widget_Alert_SetProgressQuestCount()
end
...
function FromClient_updateReservePersonalMonster(characterKey, positionIndex)
  ...
  if showMonsterCount > 0 then
    ...
    self:setCount(showMonsterCount, self._ui.StaticText_BossMonsterCount)
    self:setButtonShow(AlertType.eALERT_MyBossMonster, true)
    self._ui.btn_blackEffect:SetShow(true)
    self._ui.btn_blackEffect:EraseAllEffect()
...
function FromClient_Widget_Alert_Title(titleKeyRaw, lastAquireCount)
  ...
  Panel_Widget_Alert_info:setCount(tostring(acquireTitleForPlaying), Panel_Widget_Alert_info._ui.StaticText_TitleCount)
...
function PaGlobalFunc_Widget_Alert_ButtonTitleAcquire()
  ...
  Panel_Widget_Alert_info:setButtonShow(AlertType.eALERT_Acquire_Title, false)
  Panel_Widget_Alert_info._ui.StaticText_TitleCount:SetText(tostring(0))
  Panel_Widget_Alert_info:setCount(tostring(0), Panel_Widget_Alert_info._ui.StaticText_TitleCount)
  Panel_Widget_Alert_info:updateIcons(false, false)
end
...
function FromClient_NotifySeasonBanner()
  if Panel_Widget_Alert_info == nil then
    return
  end
  if _ContentsGroup_SeasonContents == false and _ContentsGroup_PreSeason == false then
    return
  end
  if Panel_Widget_Alert_info:isShowSeasonBannerToday() == false then
    return
  end
  if Panel_Widget_Alert_info._ui.Static_SeasonBanner == nil then
    return
  end
...
function FromClient_NotifySeasonBanner_Global()
  if isGameServiceTypeGlobal() == false then
    return
  end
  if Panel_Widget_Alert_info:isShowSeasonBannerToday() == false then
    return
...
function PaGlobalFunc_Widget_Alert_Info_UnRenderPanel()
  if nil == Panel_UIMain then
  ...
  if true == bHide then
    Panel_UIMain:SetRenderAndEventHide(true)
  else
    Panel_UIMain:SetRenderAndEventHide(false)
  end
end
function Panel_Widget_Alert_info_GetTotalRewardPositionX()
  if nil == Panel_Widget_Alert_info then
    return 0
  end
  if nil == Panel_Widget_Alert_info._alertButton[AlertType.eALERT_TotalReward] then
  ...
  return Panel_Widget_Alert_info._alertButton[AlertType.eALERT_TotalReward]:GetPosX()
end
function Panel_Widget_Alert_info_GetTotalRewardPositionY()
  if nil == Panel_Widget_Alert_info then
    return 0
  end
  if nil == Panel_Widget_Alert_info._alertButton[AlertType.eALERT_TotalReward] then
  ...
  return Panel_Widget_Alert_info._alertButton[AlertType.eALERT_TotalReward]:GetPosY()
end
function Panel_Widget_Alert_info_GetPanelPositionX()
  if nil == Panel_UIMain then
    return 0
  end
  return Panel_UIMain:GetPosX()
end
function Panel_Widget_Alert_info_GetPanelPositionY()
  if nil == Panel_UIMain then
    return
  end
  return Panel_UIMain:GetPosY()
end
function Panel_Widget_Alert_info_AddRewardNoticeEffect()
  if nil == Panel_UIMain then
    return
  end
  if false == Panel_UIMain:GetShow() then
  ...
  if false == Panel_Widget_Alert_info._alertButton[AlertType.eALERT_TotalReward]:GetShow() then
    return
  end
  Panel_Widget_Alert_info._alertButton[AlertType.eALERT_TotalReward]:EraseAllEffect()
  Panel_Widget_Alert_info._alertButton[AlertType.eALERT_TotalReward]:AddEffect("fUI_BlackSpirit_Pass_Icon_Cast_01C", false, 0, 0)
end
