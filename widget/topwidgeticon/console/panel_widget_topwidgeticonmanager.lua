...
local TopWidgetIconManager_info = {
  ...
  _panelTable = {
    ...
    [TopWidgetIconType.AutoUseBuffItem] = Panel_Widget_FairyAutoUseBuffItemIcon_Renew
  },
  _openFunction = {
    ...
    [TopWidgetIconType.AutoUseBuffItem] = nil
  },
  _closeFunction = {
...
function PaGlobalFunc_TopIcon_CheckShow(IconType)
  ...
  elseif TopWidgetIconType.AutoUseBuffItem == IconType then
    if PaGlobal_FairyInfo_All == nil then
      return false
    end
    PaGlobal_FairyInfo_All:update()
    return ToClient_isLearnedFairySkill()
  end
  return false
end
