...
function PaGlobal_TopIcon_Garden:registEventHandler()
  ...
  registerEvent("FromClient_SetSelfTent", "PaGlobalFunc_GardenIcon_Update")
  registerEvent("FromClient_InterActionHarvest", "PaGlobalFunc_GardenIcon_Update")
  registerEvent("FromClient_InteractionSeedHarvest", "PaGlobalFunc_GardenIcon_Update")
  registerEvent("FromClient_RenderModeChangeState", "PaGlobalFunc_GardenIcon_Update")
end
...
function PaGlobal_TopIcon_Garden:prepareClose()
  ...
  PaGlobal_TopIcon_Garden._harvestEffectAllOn = false
...
function PaGlobal_TopIcon_Garden:updateHarvestStatus(gardenCount)
  ...
  if true == isReadyToHarvested then
    if true == isAllAlert then
      if false == PaGlobal_TopIcon_Garden._harvestEffectAllOn then
        PaGlobal_TopIcon_Garden._ui.static_GardenIcon_Template:EraseAllEffect()
        PaGlobal_TopIcon_Garden._ui.static_GardenIcon_Template:AddEffect(PaGlobal_TopIcon_Garden._harvestAllEffect, true, 0, -2)
        PaGlobal_TopIcon_Garden._harvestEffectAllOn = true
      end
    else
