Panel_ConsoleLobbyKeyGuide:SetShow(_ContentsGroup_UsePadSnapping)
...
function PaGlobalFunc_ConsoleKeyGuide_SetPos()
  _panel:SetPosX(getOriginScreenSizeX() - _panel:GetSizeX() - 50)
  _panel:SetPosY(getOriginScreenSizeY() - _panel:GetSizeY() - 50)
end
