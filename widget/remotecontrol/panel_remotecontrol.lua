...
function remoteControl:Show(openType)
  ...
  if self.openType.fishing == openType then
    ...
    if true == _ContentsGroup_NewUI_Fishing_All then
      self.fishing.doFishing:SetShow(PaGlobal_Fishing_All_GetShowPanel())
    else
...
function FGlobal_EquipFishingToolCheck()
  if true == _ContentsGroup_NewUI_Fishing_All then
    if remoteControl.fishing.doFishing:GetShow() ~= PaGlobal_Fishing_All_GetShowPanel() then
      remoteControl:Show(1)
    end
  elseif remoteControl.fishing.doFishing:GetShow() ~= Panel_Fishing:GetShow() then
    remoteControl:Show(1)
  end
end
...
function RemoteControl_Interaction_ShowToggloe()
  ...
  if Panel_Npc_Dialog_All:IsUse() then
    return
  end
  self.interaction:SetShow(true)
  if isShow then
...
function RemoteControl_DoFishing()
  if true == _ContentsGroup_NewUI_Fishing_All then
    if false == PaGlobal_Fishing_All_GetShowPanel() then
  ...
  elseif not Panel_Fishing:GetShow() then
    Proc_ShowMessage_Ack("\235\130\154\236\139\175\235\140\128\235\165\188 \236\158\165\235\185\132\237\149\180\236\163\188\236\132\184\236\154\148.")
  end
