...
function PaGlobal_ThornCastle_DeadMessage:prepareOpen(killerActorKey, reviveCoolTime)
  ...
  self._ui._reviveBtn[2]:SetShow(false)
...
function ThornCastle_DeadMessage_Resize()
  ...
  self._ui._deadBG:SetSize(getScreenSizeX(), getScreenSizeY())
  self._ui._dangerBG:SetSize(getScreenSizeX(), getScreenSizeY())
...
function PaGlobal_ThornCastle_DeadMessage:registEventHandler()
  ...
  registerEvent("onScreenResize", "ThornCastle_DeadMessage_Resize")
