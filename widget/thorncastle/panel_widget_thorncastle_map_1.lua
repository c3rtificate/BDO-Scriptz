...
function PaGlobal_ThornCastle_Map:setIconPos(control, percentX, percentZ)
  ...
  if percentX < 0 or percentX > 1 or percentZ < 0 or percentZ > 1 then
    self._ui._selfIcon:SetShow(false)
  else
    self._ui._selfIcon:SetShow(true)
...
function PaGlobal_ThornCastle_Map:updateNpcIcon()
  ...
  if false == ToClient_GetOthilitaIsSpawnNpc() then
    self._ui._npcIcon:SetShow(false)
    return
  end
