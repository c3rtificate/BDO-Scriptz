...
PaGlobal_Menu_Renew._categoryData = {
  ...
  [PaGlobal_Menu_Renew._xbox._bookShelf] = {
    ...
    txt_hotKey = "",
    _isVisible = _ContentsGroup_AchievementQuest,
  ...
  [PaGlobal_Menu_Renew._xbox._alchemyStone] = {
    ...
    txt_hotKey = "",
    _isVisible = ToClient_IsContentsGroupOpen("35"),
    _path = "Combine/Console/Combine_Console_ESCMenuIcon.dds",
    _x1 = 116,
    _y1 = 400,
    _x2 = 171,
  ...
  [PaGlobal_Menu_Renew._xbox._dropItem] = {
    ...
    txt_hotKey = "",
    _isVisible = _ContentsGroup_DropItem,
    _path = "Combine/Console/Combine_Console_ESCMenuIcon.dds",
    _x1 = 173,
    _y1 = 344,
    _x2 = 228,
  ...
  [PaGlobal_Menu_Renew._xbox._alchemyFigureHead] = {
    ...
    txt_hotKey = "",
    _isVisible = _ContentsGroup_AlchemyFigureHead,
    _path = "Combine/Console/Combine_Console_ESCMenuIcon.dds",
    _x1 = 344,
    _y1 = 344,
    _x2 = 399,
  ...
  [PaGlobal_Menu_Renew._xbox._arshaPvP] = {
    ...
    txt_hotKey = "",
    _isVisible = _ContentsGroup_Arsha,
    _path = "Combine/Console/Combine_Console_ESCMenuIcon.dds",
    _x1 = 116,
    _y1 = 287,
    _x2 = 171,
  ...
  [PaGlobal_Menu_Renew._xbox._totalReward] = {
    ...
    txt_hotKey = "",
    _isVisible = _ContentsGroup_TotalReward,
    _path = "Combine/Console/Combine_Console_ESCMenuIcon.dds",
    _x1 = 59,
    _y1 = 287,
    _x2 = 114,
...
function PaGlobal_Menu_Renew:HandleClicked_MenuButton(index)
  ...
  elseif self._xbox._escape == index then
    ...
    elseif _ContentsGroup_PersonalAtoraxion == true then
      if ToClient_IsInstanceFieldPlayerbyContentsType(__eInstanceContentsType_PersonalAtoraxion) == true then
        Proc_ShowMessage_Ack(PAGetString(Defines.StringSheet_SymbolNo, "eErrNoRestrictContentsByRegion"))
        return
      end
    elseif _ContentsGroup_PersonalField == true then
      if ToClient_IsEnterMirrorField(__eMirrorFieldContentsKey_PersonalField) == true then
        ...
        return
      elseif ToClient_CheckMirrorFieldDelayTime(true) == true then
        return
      end
    end
...
function Panel_Window_Menu_ShowToggle()
  ...
  if false == isShow and nil ~= Panel_DeadMessage_All and Panel_DeadMessage_All:GetShow() then
    return
  end
