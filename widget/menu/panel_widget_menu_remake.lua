PaGlobal_Menu_Remake = {
  ...
  _beforeTitleShape1SpanX = 0,
  _beforeTitleShape2SpanX = 0,
  _defaultKeyGuideBGSizeX = 0,
  _consoleChangeOptionTime = Defines.s64_const.s64_0,
  _IDX_FAVORITE = 1,
  _MAX_FAVORITEMENU = 15,
  _recentGroup = {},
  _recentSubMenuIdx = 0,
  _recentSubMenuGroupIdx = 0,
  _recentFixedCount = 0,
  _startHeaderIndex = 0,
  _MAX_HEADERINDEX = 1,
  _MAX_SUBMENU = 16,
  _MAX_SUBMENUHOTKEY_COUNT = 10,
  _MAX_HEADERMENU = 8,
  ...
  _contentsGroup = {
    ...
    _isMarketPlaceOpen = true == _ContentsGroup_RenewUI or _ContentsGroup_RenewUI_ItemMarketPlace,
    ...
    _isAltarRankOpen = ToClient_IsContentsGroupOpen("551"),
    _isOceanCurrentOpen = ToClient_IsContentsGroupOpen("504") and _ContentsGroup_NewUI_XXX,
    _isChannelChatOpen = ToClient_IsContentsGroupOpen("600"),
    _isTotalReward = _ContentsGroup_TotalReward,
    _isCopyright = true,
    _isEventMarbleGame = ToClient_IsContentsGroupOpen("1745"),
    _isYachtPVPMode = _ContentsGroup_MiniGame_YachtDice_PVP,
    _isGrowthPassOpen = true == _ContentsGroup_GrowthPass and (true == ToClient_isConsole() or true == _ContentsGroup_UsePadSnapping),
    _isArtifactOpen = true == _ContentsGroup_ArtifactItem
  },
  _conditionGroup = {},
  numberKeySetting = {
  ...
  DEFAULT_HEADER_MENU_INDEX_CONSOLE = {
    76,
    23,
    26,
    68,
  ...
  FAVORITE_MENU = {
    ...
    [9] = __eFavoriteMenu8,
    [10] = __eFavoriteMenu9,
    [11] = __eFavoriteMenu10,
    [12] = __eFavoriteMenu11,
    [13] = __eFavoriteMenu12,
    [14] = __eFavoriteMenu13,
    [15] = __eFavoriteMenu14
  },
