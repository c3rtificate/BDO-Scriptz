PaGlobal_Menu = {
  ...
  _contentsGroup = {
    ...
    _isContentsArsha = _ContentsGroup_Arsha,
...
PaGlobal_Menu._bannerData = {
  _hot = {
    ...
    [PaGlobal_Menu._bannerHot._itemMarket] = {
      ...
      _x2 = 376,
      _y2 = 116,
      _isContentOpen = false == _ContentsGroup_RenewUI_ItemMarketPlace_Only
    },
    ...
    [PaGlobal_Menu._bannerHot._update] = {
      ...
      _x2 = 376,
      _y2 = 464,
      _isContentOpen = (isGameTypeKorea() or isGameTypeTaiwan() or isGameTypeTR() or isGameTypeID() or isGameTypeASIA() or isGameTypeTH() or isGameTypeASIA() or isGameServiceTypeDev()) and not PaGlobal_Menu._contentsGroup._isTestServer
    },
    ...
    [PaGlobal_Menu._bannerHot._marketPlace] = {
      ...
      _x2 = 376,
      _y2 = 116,
      _isContentOpen = true == PaGlobal_Menu._contentsGroup._isMarketPlaceOpen
    },
  ...
  _new = {
    ...
    [PaGlobal_Menu._bannerNew._blackDesertTv] = {
      ...
      _x2 = 188,
      _y2 = 58,
      _isContentOpen = false == PaGlobal_Menu._contentsGroup._isTestServer and false == _ContentsOption_CH_GameType
    },
...
PaGlobal_Menu._categoryData = {
  [0] = {
    ...
    [PaGlobal_Menu._main._inven] = {
      ...
      _hotKey = keyCustom_GetString_UiKey(__eUiInputType_Inventory),
      _path = "Renewal/Button/Console_Btn_ESCMenu_01.dds",
      _x1 = 449,
      _y1 = 3,
      _x2 = 509,
    ...
    [PaGlobal_Menu._main._cashShop] = {
      _string = PAGetString(Defines.StringSheet_GAME, "LUA_MENU_MENUBUTTONTEXTID_CASHSHOP"),
      _hotKey = keyCustom_GetString_UiKey(__eUiInputType_CashShop),
      _path = "Renewal/Button/Console_Btn_ESCMenu_01.dds",
      _x1 = 449,
      _y1 = 189,
      _x2 = 509,
    ...
    [PaGlobal_Menu._main._homepage] = {
      _string = PAGetString(Defines.StringSheet_GAME, "LUA_MENU_HOMEPAGE_TITLE2"),
      _hotKey = "",
      _path = "Renewal/Button/Console_Btn_ESCMenu.dds",
      _x1 = 560,
      _y1 = 560,
  ...
  [1] = {
    ...
    [PaGlobal_Menu._contents._dye] = {
      ...
      _hotKey = keyCustom_GetString_UiKey(__eUiInputType_Dyeing),
      _path = "Renewal/Button/Console_Btn_ESCMenu.dds",
      _x1 = 188,
      _y1 = 188,
      _x2 = 248,
    ...
    [PaGlobal_Menu._contents._blackSpirit] = {
      ...
      _hotKey = keyCustom_GetString_UiKey(__eUiInputType_BlackSpirit),
      _path = "Renewal/Button/Console_Btn_ESCMenu.dds",
      _x1 = 2,
      _y1 = 64,
      _x2 = 62,
    ...
    [PaGlobal_Menu._contents._questInfo] = {
      ...
      _hotKey = keyCustom_GetString_UiKey(__eUiInputType_QuestHistory),
      _path = "Renewal/Button/Console_Btn_ESCMenu.dds",
      _x1 = 64,
      _y1 = 64,
      _x2 = 124,
    ...
    [PaGlobal_Menu._contents._skill] = {
      ...
      _hotKey = keyCustom_GetString_UiKey(__eUiInputType_Skill),
      _path = "Renewal/Button/Console_Btn_ESCMenu.dds",
      _x1 = 188,
      _y1 = 2,
      _x2 = 248,
    ...
    [PaGlobal_Menu._contents._manufacture] = {
      ...
      _hotKey = keyCustom_GetString_UiKey(__eUiInputType_Manufacture),
      _path = "Renewal/Button/Console_Btn_ESCMenu.dds",
      _x1 = 126,
      _y1 = 188,
      _x2 = 186,
    ...
    [PaGlobal_Menu._contents._achievementBookshelf] = {
      ...
      _x2 = 186,
      _y2 = 558,
      _isContentOpen = PaGlobal_Menu._contentsGroup._isAchievementBookshelfOpen,
      _isNew = true,
      _isHot = false,
      _index = 71
    },
  ...
  [3] = {
    ...
    [PaGlobal_Menu._infomation._productNote] = {
      ...
      _hotKey = keyCustom_GetString_UiKey(__eUiInputType_ProductionNote),
      _path = "Renewal/Button/Console_Btn_ESCMenu.dds",
      _x1 = 188,
      _y1 = 64,
      _x2 = 248,
    ...
    [PaGlobal_Menu._infomation._myInfo] = {
      ...
      _hotKey = keyCustom_GetString_UiKey(__eUiInputType_PlayerInfo),
      _path = "Renewal/Button/Console_Btn_ESCMenu.dds",
      _x1 = 64,
      _y1 = 2,
      _x2 = 124,
    ...
    [PaGlobal_Menu._infomation._knowledge] = {
      ...
      _hotKey = keyCustom_GetString_UiKey(__eUiInputType_MentalKnowledge),
      _path = "Renewal/Button/Console_Btn_ESCMenu.dds",
      _x1 = 126,
      _y1 = 64,
      _x2 = 186,
    ...
    [PaGlobal_Menu._infomation._worldMap] = {
      ...
      _hotKey = keyCustom_GetString_UiKey(__eUiInputType_WorldMap),
      _path = "Renewal/Button/Console_Btn_ESCMenu.dds",
      _x1 = 312,
      _y1 = 2,
      _x2 = 372,
    ...
    [PaGlobal_Menu._infomation._event] = {
      ...
      _x2 = 310,
      _y2 = 248,
      _isContentOpen = not _ContentsOption_CH_GameType and not isGameTypeEnglish() and not PaGlobal_Menu._contentsGroup._isTestServer,
      _isNew = false,
      _isHot = true,
      _index = 37
    },
    [PaGlobal_Menu._infomation._steam] = {
      ...
      _x2 = 434,
      _y2 = 248,
      _isContentOpen = _ContentsGroup_SteamOpen,
      _isNew = false,
      _isHot = false,
      _index = 38
    },
    [PaGlobal_Menu._infomation._update] = {
      ...
      _x2 = 186,
      _y2 = 372,
      _isContentOpen = (isGameTypeKorea() or isGameTypeTaiwan() or isGameTypeTR() or isGameTypeTH() or isGameTypeID() or isGameTypeASIA() or isGameServiceTypeDev()) and not PaGlobal_Menu._contentsGroup._isTestServer,
      _isNew = false,
      _isHot = true,
      _index = 39
    },
    ...
    [PaGlobal_Menu._infomation._knownIssue] = {
      ...
      _x2 = 558,
      _y2 = 372,
      _isContentOpen = (isGameTypeKorea() or isGameTypeTaiwan() or isGameTypeTH() or isGameTypeASIA() or isGameTypeID()) and not PaGlobal_Menu._contentsGroup._isTestServer,
      _isNew = false,
      _isHot = false,
      _index = 62
    },
    [PaGlobal_Menu._infomation._bossAlert] = {
      ...
      _x2 = 558,
      _y2 = 496,
      _isContentOpen = _ContetnsGroup_BossAlert,
      _isNew = false,
      _isHot = false,
      _index = 64
    },
  ...
  [4] = {
    [PaGlobal_Menu._community._guild] = {
      _string = PAGetString(Defines.StringSheet_GAME, "LUA_MENU_MENUBUTTONTEXTID_GUILD"),
      _hotKey = keyCustom_GetString_UiKey(__eUiInputType_Guild),
      _path = "Renewal/Button/Console_Btn_ESCMenu.dds",
      _x1 = 250,
      _y1 = 2,
      _x2 = 310,
    ...
    [PaGlobal_Menu._community._friend] = {
      ...
      _hotKey = keyCustom_GetString_UiKey(__eUiInputType_FriendList),
      _path = "Renewal/Button/Console_Btn_ESCMenu.dds",
      _x1 = 250,
      _y1 = 64,
      _x2 = 310,
    ...
    [PaGlobal_Menu._community._mail] = {
      ...
      _hotKey = keyCustom_GetString_UiKey(__eUiInputType_Mail),
      _path = "Renewal/Button/Console_Btn_ESCMenu.dds",
      _x1 = 312,
      _y1 = 64,
      _x2 = 372,
  ...
  [5] = {
    [PaGlobal_Menu._banner._blackDesertTv] = {
      ...
      _x2 = 124,
      _y2 = 62,
      _isContentOpen = not PaGlobal_Menu._contentsGroup._isTestServer and false == _ContentsOption_CH_GameType,
      _isNew = false,
      _isHot = false,
      _index = 51
    },
...
if isGameTypeTaiwan() or isGameTypeTR() or isGameTypeTH() or isGameTypeASIA() or isGameTypeID() or isGameTypeRussia() then
...
function PaGlobal_Menu:Init()
  ...
  for index = 0, self._categoryCount - 1 do
    ...
    self._ui._radioButtonGroup[index]:SetTextMode(__eTextMode_AutoWrap)
    self._ui._radioButtonGroup[index]:SetText(self._categoryData[index + 1]._name)
  end
  self._ui._radioButtonCustom:SetCheck(false)
  self._ui._radioButtonCustom:SetTextMode(__eTextMode_AutoWrap)
    ...
    for mIndex = 0, self._categoryData[cIndex]._count - 1 do
      ...
      if categoryData._isContentOpen then
        if nil == self._ui._customButtonBg[realIndex] then
          self._ui._customButtonBg[realIndex] = UI.createControl(__ePAUIControl_Static, self._ui._customWindow, "CustomButtonBg_" .. realIndex)
        ...
        if nil == self._ui._customButton[realIndex] then
          self._ui._customButton[realIndex] = UI.createControl(__ePAUIControl_Button, self._ui._customWindow, "CustomButton_" .. realIndex)
  ...
  for menuIndex = 0, count - 1 do
    if nil ~= self._categoryData[index][menuIndex] and self._categoryData[index][menuIndex]._isContentOpen then
      ...
      if nil ~= self._ui._subButton[viewableCount + realIndex] then
        self._ui._subButton[viewableCount + realIndex]:SetTextMode(__eTextMode_AutoWrap)
  ...
  for menuIndex = 0, count - 1 do
    ...
    if nil ~= temp then
      if self._categoryData[temp._categoryIndex][temp._menuIndex]._isContentOpen then
        self._ui._subButton[menuIndex + realIndex]:SetTextMode(__eTextMode_AutoWrap)
...
function PaGlobal_Menu:HandleClicked_MenuButton(index, categoryIndex, uiIndex)
  ...
  if 0 == categoryIndex then
    ...
    elseif PaGlobal_Menu._main._homepage == index then
