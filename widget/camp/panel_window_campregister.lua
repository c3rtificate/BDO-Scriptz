...
function PaGlobal_CampRegister:CampRegister_init()
  ...
  if isGameTypeEnglish() or isGameTypeTaiwan() or isGameTypeTR() or isGameTypeTH() or isGameTypeASIA() or isGameTypeID() then
    self._ui._staticCreateServantName:SetTextMode(__eTextMode_AutoWrap)
  ...
  if isGameTypeEnglish() or isGameTypeTaiwan() or isGameTypeASIA() then
  ...
  self._ui._campRegisterDesc:SetTextMode(__eTextMode_AutoWrap)
end
...
function PaGlobal_CampRegister:CampRegister_InputCampName(fromWhereType, fromSlotNo)
  ...
  self._ui._campRegisterDesc:SetText(defaultDesc)
