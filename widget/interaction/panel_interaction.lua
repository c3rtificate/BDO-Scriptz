...
local _rideOff = UI.getChildControl(_globalGuide, "StaticText_RideOff")
...
INETRACTION_BUTTON_TEXT[__eInteractionType_BattleHardCorePrison] = PAGetString(Defines.StringSheet_RESOURCE, "INTERACTION_BTN_PVPBATTLE")
local BUTTON_ID = {
  [0] = "Button_GamePlay",
  "Button_CharInfo",
  "Button_Exchange",
  ...
  "Button_Refair_Tool",
  "Button_ElephantRecovery",
  "Button_UnbuildAdvancedBaseTower",
  "Button_FromClientLuaEvent"
}
local UI_BUTTON = {}
...
local _isInteractionActorMagnus = false
local otherUIList = {
  ...
  [CppEnums.InteractionType.InteractionType_ClearDeadCountInElephantBarn] = UI.getChildControl(Panel_Interaction, "Button_ElephantRecovery"),
  [CppEnums.InteractionType.InteractionType_UnbuildAdvancedBaseTower] = UI.getChildControl(Panel_Interaction, "Button_UnbuildAdvancedBaseTower"),
  [CppEnums.InteractionType.InteractionType_FromClientLuaEvent] = UI.getChildControl(Panel_Interaction, "Button_FromClientLuaEvent"),
  [__eInteractionType_BattleHardCorePrison] = UI.getChildControl(Panel_Interaction, "Button_HardCorePrisonBattle")
}
...
otherUIList[CppEnums.InteractionType.InteractionType_GuildDrill]:addInputEvent("Mouse_LUp", "Interaction_ButtonPushed(" .. CppEnums.InteractionType.InteractionType_GuildDrill .. ")")
otherUIList[CppEnums.InteractionType.InteractionType_GuildDrill]:addInputEvent("Mouse_On", "Interaction_ButtonOver(" .. CppEnums.InteractionType.InteractionType_GuildDrill .. ", true)")
otherUIList[CppEnums.InteractionType.InteractionType_GuildDrill]:addInputEvent("Mouse_Out", "Interaction_ButtonOver(" .. CppEnums.InteractionType.InteractionType_GuildDrill .. ", false)")
...
otherUIList[CppEnums.InteractionType.InteractionType_ClearDeadCountInElephantBarn]:addInputEvent("Mouse_LUp", "Interaction_ButtonPushed(" .. CppEnums.InteractionType.InteractionType_ClearDeadCountInElephantBarn .. ")")
otherUIList[CppEnums.InteractionType.InteractionType_ClearDeadCountInElephantBarn]:addInputEvent("Mouse_On", "Interaction_ButtonOver(" .. CppEnums.InteractionType.InteractionType_ClearDeadCountInElephantBarn .. ", true)")
otherUIList[CppEnums.InteractionType.InteractionType_ClearDeadCountInElephantBarn]:addInputEvent("Mouse_Out", "Interaction_ButtonOver(" .. CppEnums.InteractionType.InteractionType_ClearDeadCountInElephantBarn .. ", false)")
otherUIList[CppEnums.InteractionType.InteractionType_ClearDeadCountInElephantBarn]:SetShow(true)
otherUIList[CppEnums.InteractionType.InteractionType_UnbuildAdvancedBaseTower]:addInputEvent("Mouse_LUp", "Interaction_ButtonPushed(" .. CppEnums.InteractionType.InteractionType_UnbuildAdvancedBaseTower .. ")")
otherUIList[CppEnums.InteractionType.InteractionType_UnbuildAdvancedBaseTower]:addInputEvent("Mouse_On", "Interaction_ButtonOver(" .. CppEnums.InteractionType.InteractionType_UnbuildAdvancedBaseTower .. ", true)")
otherUIList[CppEnums.InteractionType.InteractionType_UnbuildAdvancedBaseTower]:addInputEvent("Mouse_Out", "Interaction_ButtonOver(" .. CppEnums.InteractionType.InteractionType_UnbuildAdvancedBaseTower .. ", false)")
otherUIList[CppEnums.InteractionType.InteractionType_UnbuildAdvancedBaseTower]:SetShow(true)
otherUIList[CppEnums.InteractionType.InteractionType_FromClientLuaEvent]:addInputEvent("Mouse_LUp", "Interaction_ButtonPushed(" .. CppEnums.InteractionType.InteractionType_FromClientLuaEvent .. ")")
otherUIList[CppEnums.InteractionType.InteractionType_FromClientLuaEvent]:addInputEvent("Mouse_On", "Interaction_ButtonOver(" .. CppEnums.InteractionType.InteractionType_FromClientLuaEvent .. ", true)")
otherUIList[CppEnums.InteractionType.InteractionType_FromClientLuaEvent]:addInputEvent("Mouse_Out", "Interaction_ButtonOver(" .. CppEnums.InteractionType.InteractionType_FromClientLuaEvent .. ", false)")
otherUIList[CppEnums.InteractionType.InteractionType_FromClientLuaEvent]:SetShow(true)
local otherTextList = {
  ...
  [CppEnums.InteractionType.InteractionType_ClearDeadCountInElephantBarn] = PAGetString(Defines.StringSheet_GAME, "LUA_INTERACTION_ELEPHANTRECOVERY_BTN"),
  [CppEnums.InteractionType.InteractionType_UnbuildAdvancedBaseTower] = PAGetString(Defines.StringSheet_GAME, "LUA_SIEGE_ADVANCEDBASE_DESTROY"),
  [CppEnums.InteractionType.InteractionType_FromClientLuaEvent] = PAGetString(Defines.StringSheet_GAME, "INTERACTION_TEXT91"),
  [__eInteractionType_BattleHardCorePrison] = PAGetString(Defines.StringSheet_RESOURCE, "INTERACTION_BTN_PVPBATTLE")
}
local otherFunctionList = {
  ...
  [CppEnums.InteractionType.InteractionType_ClearDeadCountInElephantBarn] = function(actor, index)
    if nil == actor then
      return getDefaultButtonInfo(actor, index)
    end
    if nil == otherUIList[index] or nil == otherTextList[index] then
    ...
    return otherUIList[CppEnums.InteractionType.InteractionType_ClearDeadCountInElephantBarn], otherTextList[CppEnums.InteractionType.InteractionType_ClearDeadCountInElephantBarn]
  end,
  [CppEnums.InteractionType.InteractionType_UnbuildAdvancedBaseTower] = function(actor, index)
    if nil == actor then
      return getDefaultButtonInfo(actor, index)
    end
    if nil == otherUIList[index] or nil == otherTextList[index] then
    ...
    return otherUIList[CppEnums.InteractionType.InteractionType_UnbuildAdvancedBaseTower], otherTextList[CppEnums.InteractionType.InteractionType_UnbuildAdvancedBaseTower]
  end,
  [CppEnums.InteractionType.InteractionType_FromClientLuaEvent] = function(actor, index)
    if nil == actor then
      return getDefaultButtonInfo(actor, index)
    end
    if nil == otherUIList[index] or nil == otherTextList[index] then
    ...
    if nil == npcActorProxyWrapper then
      return otherUIList[CppEnums.InteractionType.InteractionType_FromClientLuaEvent], PAGetString(Defines.StringSheet_GAME, "INTERACTION_TEXT91")
    end
    local dialogIndex = npcActorProxyWrapper:get():getDialogIndex()
    local btnName = PAGetString(Defines.StringSheet_GAME, "INTERACTION_MENU91_" .. tostring(dialogIndex))
    return otherUIList[CppEnums.InteractionType.InteractionType_FromClientLuaEvent], btnName
  end
}
...
function Interaction_Update(deltaTime)
  ...
  if Defines.UIMode.eUIMode_Cutscene == uiMode then
    if false == FGlobal_GetIsCutScenePlayerControlMode() then
      Interaction_Close()
      return
    end
  elseif Defines.UIMode.eUIMode_Default ~= uiMode and Defines.UIMode.eUIMode_SequencePlayerControl ~= uiMode and Defines.UIMode.eUIMode_Tutorial ~= uiMode then
    Interaction_Close()
    return
  end
  if selfPlayer == nil or selfPlayer:isDead() == true or PaGloabl_Looting_All_GetShowPanel ~= nil and PaGloabl_Looting_All_GetShowPanel() == true or Panel_Window_Exchange ~= nil and true == Panel_Window_Exchange:GetShow() then
    Interaction_Close()
    return
  end
  ...
  if nil ~= actor then
    ...
    elseif UI_Character_InterActionGathering_All ~= nil and UI_Character_InterActionGathering_All:GetShow() == true then
      PaGlobal_InteractionGathering_All:update(deltaTime)
    end
  end
...
function Interaction_Show(actor)
  ...
  if nil ~= actor and true == actor:get():isPlayer() and true == ToClient_IsInstanceFieldPlayerbyContentsType(__eInstanceContentsType_Solare) then
    return
  end
  if true == ToClient_isSimpleBuildMode() then
    Interaction_Close()
  ...
  if true == houseShow and true == ToClient_IsInstanceFieldPlayerbyContentsType(__eInstanceContentsType_LocalWar) then
    Panel_Interaction_House:SetShow(false)
    Panel_Interaction:SetShow(false)
  end
  local actor = interaction_getInteractable()
  local actorKey = 0
  _isInteractionActorMagnus = false
  ...
  elseif actor:get():isNpc() then
    ...
    if _ContentsGroup_MagnusEasyTeleport == true and charWrapper ~= nil and charWrapper:isAttrSet(__eForFromClientEvent) then
      _isInteractionActorMagnus = true
  ...
  PaGlobal_InteractionGathering_All_Close()
  ...
  for ii = 0, #interactionTargetUIList do
    ...
    if isShow then
      ...
      if _ContentsGroup_CollectToolBox == true and ii == CppEnums.InteractionType.InteractionType_Collect and PaGlobal_InteractionGathering_All_Open() == true then
        Panel_Interaction:SetShow(false)
        return
      end
      ...
      if 0 == SHOW_BUTTON_COUNT then
        ...
        elseif CppEnums.InteractionType.InteractionType_Talk == ii then
          local talkButtonString = keyCustom_GetString_ActionKey(CppEnums.ActionInputType.ActionInputType_Interaction)
          interactionTargetUIList[ii]:SetText(interactionTargetTextList[ii] .. " <PAColor0xFFFFD543>(" .. talkButtonString .. ")<PAOldColor>")
          if actor:getCharacterStaticStatusWrapper():get():isSummonedCharacterBySiegeObject() then
        ...
        elseif CppEnums.InteractionType.InteractionType_Ride == ii then
          if FGlobal_Interaction_CheckIsNotMyHorse() == true then
            interactionTargetUIList[ii]:SetText(interactionTargetTextList[ii] .. " <PAColor0xFFFFD543>(" .. " Shift + " .. keyCustom_GetString_ActionKey(CppEnums.ActionInputType.ActionInputType_Interaction) .. " )<PAOldColor>")
          else
  ...
  if nil ~= Panel_HorseHp and true == Panel_HorseHp:GetShow() then
    _globalGuide:SetSize(_globalGuide:GetSizeX(), 50)
    _rideOff:SetShow(true)
  else
    _globalGuide:SetSize(_globalGuide:GetSizeX(), 23)
    _rideOff:SetShow(false)
  end
...
function Interaction_isSetInteractableFragLua(actor, index)
  ...
  elseif index == CppEnums.InteractionType.InteractionType_ClearDeadCountInElephantBarn then
    isShow = actor:isSetInteracatbleFrag(__eInteractionType_ClearDeadCountInElephantBarn)
  elseif index == CppEnums.InteractionType.InteractionType_UnbuildAdvancedBaseTower then
    isShow = actor:isSetInteracatbleFrag(__eInteractionType_UnbuildAdvancedBaseTower)
  elseif index == CppEnums.InteractionType.InteractionType_FromClientLuaEvent then
    isShow = _ContentsGroup_MagnusEasyTeleport and actor:isSetInteracatbleFrag(__eInteractionType_FromClientLuaEvent)
  elseif index == 48 then
    if _ContentsGroup_PVPServer == true and actor:IsNeedHideNameForPVPServer() == true then
      isShow = false
    end
  elseif index == 51 and _ContentsGroup_PVPServer == true and actor:IsNeedHideNameForPVPServer() == true then
    isShow = false
  end
  return isShow
end
...
function Interaction_Close()
  if Panel_Interaction:IsShow() == true or Panel_Interaction_House:IsShow() == true or UI_Character_InterActionGathering_All:IsShow() == true then
    Panel_Interaction:SetShow(false)
    Panel_Interaction_House:SetShow(false)
    INTERACTABLE_ACTOR_KEY = 0
    _globalGuide:SetShow(false)
    if Panel_Interaction_HouseRanke_Close ~= nil then
      Panel_Interaction_HouseRanke_Close()
    end
    if FriendHouseRank_Close ~= nil then
...
function Interaction_PositionUpdate(actor)
  ...
  if pos2d.x < 0 and 0 > pos2d.y then
    ...
    if UI_Character_InterActionGathering_All:IsShow() == true then
      UI_Character_InterActionGathering_All:SetPosX(-1000)
      UI_Character_InterActionGathering_All:SetPosY(-1000)
    end
    ...
    if UI_Character_InterActionGathering_All:IsShow() == true then
      UI_Character_InterActionGathering_All:SetPosX(pos2d.x + 0)
      UI_Character_InterActionGathering_All:SetPosY(pos2d.y - 100)
    end
    local addPosY = 0
    if _isInteractionActorMagnus == true then
      addPosY = -50
    end
    Panel_Interaction:SetPosX(pos2d.x + 0)
    Panel_Interaction:SetPosY(pos2d.y - 100 + addPosY)
  end
end
...
function Interaction_ButtonPushed(interactionType)
  if FGlobal_GetIsCutScenePlay ~= nil and true == FGlobal_GetIsCutScenePlay() and false == FGlobal_GetIsCutScenePlayerControlMode() then
    return
  end
  ...
  if isFirstFieldEnterMode() == true then
    return
  end
  ...
  elseif CppEnums.InteractionType.InteractionType_InvitedParty == interactionType then
    if true == ToClient_IsInstanceRandomMatching() then
      ...
      return
    elseif ToClient_isHardCoreChannel() == true then
      Proc_ShowMessage_Ack(PAGetString(Defines.StringSheet_SymbolNo, "eErrNoCantInvitePartyHardCoreServer"))
      return
    else
      local actor = interaction_getInteractable()
      if nil == actor then
          ...
          if __eChatNameType_NickName == nameType then
            if nil ~= playerActorProxyWrapper then
              ...
              if nil ~= playerActorProxyWrapper and true == playerActorProxyWrapper:get():isHideCharacterName() and false == playerActorProxyWrapper:get():isFlashBanged() then
                targetNickName = PAGetString(Defines.StringSheet_GAME, "LUA_CHARACTERNAME_CAMO")
              end
              if _ContentsGroup_PVPServer == true and actor:IsNeedHideNameForPVPServer() == true then
                targetNickName = PaGlobalFunc_getAnonymousNameString(0)
              end
            ...
            if nil ~= playerActorProxyWrapper and true == playerActorProxyWrapper:get():isHideCharacterName() and false == playerActorProxyWrapper:get():isFlashBanged() then
              targetName = PAGetString(Defines.StringSheet_GAME, "LUA_CHARACTERNAME_CAMO")
            end
            if _ContentsGroup_PVPServer == true and actor:IsNeedHideNameForPVPServer() == true then
              targetName = PaGlobalFunc_getAnonymousNameString(0)
            end
  ...
  elseif CppEnums.InteractionType.InteractionType_PvPBattle == interactionType then
    ...
    elseif true == ToClient_doExistWorldBossMonsterAtRegion() then
      ...
      if nil ~= playerActorProxyWrapper and playerActorProxyWrapper:get():isHideCharacterName() then
        targetCharacterName = PAGetString(Defines.StringSheet_GAME, "LUA_CHARACTERNAME_CAMO")
      end
      if _ContentsGroup_PVPServer == true and actor:IsNeedHideNameForPVPServer() == true then
        targetNickName = PaGlobalFunc_getAnonymousNameString(0)
      end
  ...
  elseif CppEnums.InteractionType.InteractionType_Ride == interactionType then
    ...
    if vehicleWrapper ~= nil then
      ...
      if vehicleActorProxy ~= nil then
        ...
        if vehicleWrapper:isShip() == true and getSelfPlayer():get():isPreemptiveStrikeBeing() == true then
  ...
  elseif CppEnums.InteractionType.InteractionType_RepairTool == interactionType then
    ...
    return
  elseif CppEnums.InteractionType.InteractionType_ClearDeadCountInElephantBarn == interactionType then
    interaction_processInteraction(__eInteractionType_ClearDeadCountInElephantBarn)
    return
  elseif CppEnums.InteractionType.InteractionType_UnbuildAdvancedBaseTower == interactionType then
    interaction_processInteraction(__eInteractionType_UnbuildAdvancedBaseTower)
    return
  elseif CppEnums.InteractionType.InteractionType_FromClientLuaEvent == interactionType then
    interaction_processInteraction(__eInteractionType_FromClientLuaEvent)
    return
  end
...
function Interaction_UpdateDesc(indteractionType)
  ...
  elseif indteractionType == CppEnums.InteractionType.InteractionType_ClearDeadCountInElephantBarn then
    interactionDesc = PAGetString(Defines.StringSheet_GAME, "LUA_INTERACTION_ELEPHANTRECOVERY_DESC")
  elseif indteractionType == CppEnums.InteractionType.InteractionType_Ride and FGlobal_Interaction_CheckIsNotMyHorse() == true and _ContentsGroup_UsePadSnapping == false then
    local actionKeyString = keyCustom_GetString_ActionKey(CppEnums.ActionInputType.ActionInputType_Interaction)
    actionKeyString = "Shift + " .. actionKeyString
    interactionDesc = PAGetStringParam2(Defines.StringSheet_GAME, "LUA_INTERACTION_PURPOSE_0", "interactionkey", actionKeyString, "interaction", interactionTargetTextList[indteractionType])
  end
...
function FromClient_NotifyObserverModeEnd()
  if _ContentsGroup_RenewUI_WatchMode == false then
  ...
  local isElfWarParticipate = false
  if ToClient_IsParticipateInElfWar() == true then
    isElfWarParticipate = true
  end
  if selfPlayer:isDead() == true then
    if isElfWarParticipate == true then
      if PaGlobal_ElfWarDeadMessage_ReOpen ~= nil then
        PaGlobal_ElfWarDeadMessage_ReOpen()
      end
    elseif ToClient_isPlayingSequence() == true then
      if PaGlobal_SequenceDeadMessage_BGShow ~= nil then
        PaGlobal_SequenceDeadMessage_BGShow(true)
      end
    elseif PaGlobalFunc_DeadMessage_All_Open ~= nil then
...
registerEvent("FromClient_InteractionElephantBarnTalk", "FromClient_Interaction_ElephantBarnTalk")
...
function FGlobal_Interaction_CheckIsNotMyHorse()
  ...
  if UI_BUTTON[CppEnums.InteractionType.InteractionType_Ride] == nil then
    return false
  end
  if UI_BUTTON[CppEnums.InteractionType.InteractionType_Ride]:GetShow() == false then
    return false
  end
  local actor = interaction_getInteractable()
  if actor == nil then
  ...
  if actor:get():isPlayer() == true then
    return true
  end
  local actorKeyRaw = actor:get():getActorKeyRaw()
  local vehicleWrapper = getVehicleActor(actorKeyRaw)
  ...
  local vehicleType = vehicleActorProxy:getVehicleType()
  if __eVehicleType_Horse ~= vehicleType then
    return false
  end
  if ToClient_getTamingServantActorKey() == vehicleActorProxy:getActorKeyRaw() then
    return false
  end
  if vehicleActorProxy:isOwnerSelfPlayer() == false then
    local subType = vehicleActorProxy:getVehicleSubType()
    if subType == __eTVehicleSubType_MasterlessHorse then
      if vehicleActorProxy:isSelfVehicle() == true then
        return false
      end
    elseif subType == __eTVehicleSubType_AlteregoHorse then
      if vehicleActorProxy:getDreamHorseOwnerUserNo() == getSelfPlayer():getUserNo() then
        return false
      else
        return true
      end
    end
    if vehicleActorProxy:getOwnerActorKeyRaw() == 0 then
      return false
    end
    return true
  end
...
function FGlobal_Interaction_CheckAndGetPressedKeyCode()
  ...
  if keyCustom_IsDownOnce_Action(keyCode) == true then
    if FGlobal_Interaction_CheckIsNotMyHorse() == true and isKeyPressed(CppEnums.VirtualKeyCode.KeyCode_SHIFT) == false then
      return nil
    end
    return keyCode
  end
...
function Interaction_MatchingIndex(interactionType)
  ...
  elseif __eInteractionType_ClearDeadCountInElephantBarn == interactionType then
    return CppEnums.InteractionType.InteractionType_ClearDeadCountInElephantBarn
  elseif __eInteractionType_UnbuildAdvancedBaseTower == interactionType then
    return CppEnums.InteractionType.InteractionType_UnbuildAdvancedBaseTower
  elseif __eInteractionType_FromClientLuaEvent == interactionType then
    return CppEnums.InteractionType.InteractionType_FromClientLuaEvent
  end
...
function FromClient_Interaction_ElephantBarnTalk()
