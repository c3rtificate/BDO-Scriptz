...
function PaGlobal_CommandGuide:setData()
  ...
  elseif 3 == isDataType then
    ...
    if _ContentsGroup_ProjectAbyssOne == true and ToClient_isInAbyssOne() == true then
      PaGlobal_CommandGuide._ui._txt_commandKeyDesc[1]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_DESC_CRANK_UP"))
      PaGlobal_CommandGuide._ui._txt_commandKeyDesc[2]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_DESC_CRANK_DOWN"))
    else
  ...
  elseif 5 == isDataType then
    PaGlobal_CommandGuide._ui._txt_commandKey[1]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_CROUCHORSKILL"))
    PaGlobal_CommandGuide._ui._txt_commandKeyDesc[1]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_POSITIONCHANGE"))
    PaGlobal_CommandGuide._ui._txt_commandKey[2]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_MOVEFRONT"))
    PaGlobal_CommandGuide._ui._txt_commandKeyDesc[2]:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_COMMANDGUIDE_POSITIONCHANGE_UNSET"))
    PaGlobal_CommandGuide._ui._txt_commandKey[3]:SetShow(false)
    PaGlobal_CommandGuide._ui._txt_commandKey[4]:SetShow(false)
    PaGlobal_CommandGuide._ui._txt_commandKey[5]:SetShow(false)
    PaGlobal_CommandGuide._ui._txt_commandKey[6]:SetShow(false)
...
function PaGlobal_CommandGuide:setBGSize()
  ...
  for _, control in pairs(PaGlobal_CommandGuide._ui._txt_commandKeyDesc) do
    if true == control:GetShow() then
      ...
      maxBgSizeX = math.max(maxBgSizeX, control:GetPosX() + control:GetTextSizeX())
    end
  end
