...
function Panel_Interaction_HouseRank_MakeControl()
  ...
  for index = 0, rankCount - 1 do
    local ui = {}
    ui._rank = UI.createControl(__ePAUIControl_StaticText, Panel_Interaction_HouseRank, "StaticText_Rank_" .. index)
    CopyBaseProperty(copyUi._copyRank, ui._rank)
    ui._ranker = UI.createControl(__ePAUIControl_StaticText, Panel_Interaction_HouseRank, "StaticText_Ranker_" .. index)
    CopyBaseProperty(copyUi._copyRanker, ui._ranker)
    ui._score = UI.createControl(__ePAUIControl_StaticText, Panel_Interaction_HouseRank, "StaticText_Score_" .. index)
    CopyBaseProperty(copyUi._copyScore, ui._score)
    ui._screenShot = UI.createControl(__ePAUIControl_Button, Panel_Interaction_HouseRank, "Button_ScreenShot_" .. index)
...
PaGlobal_Util_RegistHelpTooltipEvent(_buttonQuestion, "\"HouseRank\"")
