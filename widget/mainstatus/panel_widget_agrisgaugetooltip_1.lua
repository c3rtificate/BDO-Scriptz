...
function PaGlobal_AgrisGaugeTooltip:prepareOpen(posX, posY)
  ...
  local desc = PAGetStringParam3(Defines.StringSheet_GAME, "LUA_AGRISSPOINT_ICON_TOOLTIP", "addFeverPoint", addFeverPoint, "maxFeverPoint", maxFeverPoint, "feverDropRate", feverDropRate)
  ...
  self._ui.txt_tooltipDesc:SetText(desc)
