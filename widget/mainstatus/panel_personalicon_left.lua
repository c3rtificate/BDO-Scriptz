...
function PackageIconPosition()
  ...
  if applyMemoryOfMaestro and memoryOfMaestroTime > 0 then
...
function FromClient_PackageIconUpdate()
  ...
  if true == isPremiumPcRoom and not isRussiaArea and not isGameTypeEnglish() and not isGameTypeSA() and not isGameTypeTR() then
