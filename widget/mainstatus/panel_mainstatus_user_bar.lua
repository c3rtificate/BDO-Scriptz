...
function selfPlayerStatusBar:unRenderInInstance()
  if nil == Panel_MainStatus_User_Bar then
    _PA_ASSERT_NAME(false, "Panel_MainStatus_User_Bar\236\157\180 nil \236\158\133\235\139\136\235\139\164.", "\234\176\156\235\176\156\236\158\144")
    return
  end
  ...
  if true == bHide then
    Panel_MainStatus_User_Bar:SetRenderAndEventHide(true)
  else
    Panel_MainStatus_User_Bar:SetRenderAndEventHide(false)
  end
end
function selfPlayerStatusBar:init()
  ...
  selfPlayerStatusBar:unRenderInInstance()
end
...
function FromClient_StartSequencePlayerControlable_MainStatusUserBar()
  Panel_MainStatus_User_Bar:SetAlpha(0)
  local aniInfo = UIAni.AlphaAnimation(1, Panel_MainStatus_User_Bar, 0, 0.8)
  aniInfo:SetDisableWhileAni(true)
end
registerEvent("FromClient_RenderModeChangeState", "renderModeChange_checkHpAlertPostEvent")
registerEvent("FromClient_StartSequencePlayerControlable", "FromClient_StartSequencePlayerControlable_MainStatusUserBar")
...
function FGlobal_User_Bar_Show(isShow, isAni, isForce)
  if true == PaGlobalFunc_IsRemasterUIOption() then
    isShow = false
  end
  if true == isForce then
    if Panel_MainStatus_User_Bar:GetShow() == isShow then
      return
    end
