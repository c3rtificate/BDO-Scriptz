...
local function registEventHandler()
  ...
  if nil ~= PaGlobalFunc_SkillGroup_Open then
    _staticSkillPoint:addInputEvent("Mouse_LUp", "PaGlobalFunc_SkillGroup_Open()")
    _staticSkillPointMain:addInputEvent("Mouse_LUp", "PaGlobalFunc_SkillGroup_Open()")
  end
...
function UserSkillPoint_Update()
  ...
  _staticSkillPointMain:SetText(tostring(skillPoint .. " (" .. skillPointExp .. "%)"))
  ...
  _staticSkillPointMain:SetSize(_staticSkillPointMain:GetTextSizeX(), _staticSkillPointMain:GetSizeY())
  _staticSkillPointMain:SetSpanSize(defaultSkillPointMainSpanX - _staticSkillPointMain:GetTextSizeX(), _staticSkillPointMain:GetSpanSize().y)
