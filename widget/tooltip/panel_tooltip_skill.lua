local ToolTipSkillUI = {
  ...
  reusability = UI.getChildControl(Panel_Tooltip_Skill, "Tooltip_Skill_UseCondition_reusability"),
  ...
  skill_Movie = UI.createControl(__ePAUIControl_WebControl, Panel_Tooltip_Skill, "WebControl_Skill_Movie"),
...
local ToolTipSkillUI_learning = {
  ...
  reusability = UI.getChildControl(Panel_Tooltip_Skill_forLearning, "Tooltip_Skill_UseCondition_reusability"),
  ...
  skill_Movie = UI.createControl(__ePAUIControl_WebControl, Panel_Tooltip_Skill_forLearning, "WebControl_Skill_Movie")
}
local ToolTipSkillUI_blackSpirit = {
  ...
  reusability = UI.getChildControl(Panel_Tooltip_Skill_forBlackSpirit, "Tooltip_Skill_UseCondition_reusability"),
  ...
  skill_Movie = UI.createControl(__ePAUIControl_WebControl, Panel_Tooltip_Skill_forBlackSpirit, "WebControl_Skill_Movie")
}
local ToolTipSkillUI_linkedToolTipSkill = {
  main = Panel_Tooltip_Skill_forLinkTooltip,
  btmbg = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Static_BtmBg"),
  skillName = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_Name"),
  skillIcon = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_Icon"),
  skillLevel = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_Level"),
  useCondition_category = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_UseCondition_category"),
  useCondition_category_panel = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_UseCondition_panel"),
  needHP = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_UseCondition_needHP"),
  needHP_value = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_UseCondition_needHP_value"),
  needMP = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_UseCondition_needMP"),
  needMP_value = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_UseCondition_needMP_value"),
  needSP = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_UseCondition_needSP"),
  needSP_value = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_UseCondition_needSP_value"),
  needItem = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_UseCondition_needItem"),
  needItem_value = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_UseCondition_needItem_value"),
  reuseCycle = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_UseCondition_reuseCycle"),
  reuseCycle_value = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_UseCondition_reuseCycle_value"),
  reusability = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_UseCondition_reusability"),
  useMethod = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_UseMethod"),
  skillEffect_category = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_SkillEffect_category"),
  skillEffect_panel = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_SkillEffect_panel"),
  skillEffect_value = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_SkillEffect_buff_value"),
  awakeningEffect_category = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_AwakeningEffect_category"),
  awakeningEffect_panel = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_AwakeningEffect_panel"),
  awakeningeffect = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_AwakeningEffect_effect"),
  skillDescription = UI.getChildControl(Panel_Tooltip_Skill_forLinkTooltip, "Tooltip_Skill_Description"),
  skill_Movie = UI.createControl(__ePAUIControl_WebControl, Panel_Tooltip_Skill_forLinkTooltip, "WebControl_Skill_Movie")
}
...
local function initialize()
  ...
  ToolTipSkillUI_linkedToolTipSkill.main:SetShow(false, false)
  ToolTipSkillUI_linkedToolTipSkill.main:setMaskingChild(true)
  ToolTipSkillUI_linkedToolTipSkill.main:SetIgnore(true)
  ToolTipSkillUI_linkedToolTipSkill.main:setGlassBackground(true)
  ToolTipSkillUI_linkedToolTipSkill.skill_Movie:SetHorizonCenter()
  ToolTipSkillUI_linkedToolTipSkill.skill_Movie:SetSize(320, 240)
  ToolTipSkillUI_linkedToolTipSkill.skill_Movie:SetSpanSize(0, 0)
  ToolTipSkillUI_linkedToolTipSkill.skill_Movie:SetShow(false)
end
function Panel_SkillTooltip_Hide()
  ...
  if Panel_Tooltip_Skill_forLinkTooltip:IsShow() then
    Panel_Tooltip_Skill_forLinkTooltip:SetShow(false, false)
    if Panel_Tooltip_Skill_forLinkTooltip:IsUISubApp() then
      Panel_Tooltip_Skill_forLinkTooltip:CloseUISubApp()
    end
    currMovieName = nil
    currentTooltip.slotNo = -1
  end
...
function Panel_SkillTooltip_GetShow()
  if nil == Panel_Tooltip_Skill then
    return false
  end
  return Panel_Tooltip_Skill:GetShow()
end
function Panel_SkillTooltip_Show(slotNo, isShowNextLevel, SlotType, isReserveSkill, isResetable)
  ...
  if nil ~= skillStatic then
    ...
    if nil ~= linkToolTipSkillTypeSS and linkToolTipSkillTypeSS:isValidLocalizing() then
      Tooltip_SkillData:showTooltip_Skill_Real(ToolTipSkillUI_linkedToolTipSkill, linkToolTipSkillNo, linkToolTipSkillTypeSS, false, false)
    end
  end
  ...
  local tooltipLinkedSize = {width = 0, height = 0}
  ...
  if Panel_Tooltip_Skill_forLinkTooltip:GetShow() then
    tooltipLinkedSize.width = Panel_Tooltip_Skill_forLinkTooltip:GetSizeX()
    tooltipLinkedSize.height = Panel_Tooltip_Skill_forLinkTooltip:GetSizeY()
    sumSize.width = sumSize.width + tooltipLinkedSize.width
    sumSize.height = math.max(sumSize.height, tooltipLinkedSize.height)
  end
  if not isLeft then
  ...
  if Panel_Tooltip_Skill_forLinkTooltip:GetShow() then
    if isLeft then
      posX = posX - tooltipLinkedSize.width
    end
    Panel_Tooltip_Skill_forLinkTooltip:SetPosX(posX)
    Panel_Tooltip_Skill_forLinkTooltip:SetPosY(blackSkillPosY)
    if not isLeft then
      posX = posX + tooltipLinkedSize.width
    end
    if isUISubAppMode then
      Panel_Tooltip_Skill_forLinkTooltip:OpenUISubApp()
    end
  end
end
...
function Tooltip_SkillData:showTooltip_Skill_Real(target, skillNo, skillTypeSS, isShowNextLevel, isReserveSkillOn, isResetable)
  ...
  local isNextLvWidget = target.main ~= Panel_Tooltip_Skill and target.main ~= Panel_Tooltip_Skill_forBlackSpirit and target.main ~= Panel_Tooltip_Skill_forLinkTooltip
  ...
  if isShowNeedHp or isShowNeedMp or isShowNeedSp or isShowNeedItem or isShowReuseCycle then
    ...
    if isShowReuseCycle then
      ...
      TooltipYPos = Tooltip_SkillData:GetBottomPos(target.reuseCycle_value) + elementgap - 2
      target.reusability:SetPosY(TooltipYPos)
      TooltipYPos = Tooltip_SkillData:GetBottomPos(target.reusability) + elementgap + target.reusability:GetTextSizeY() - target.reusability:GetSizeY()
    end
  ...
  if "QuickSlot" == callTooltipType or "LevelupInfoLearnable" == callTooltipType or "LevelupInfoLearn" == callTooltipType then
    currMovieName = nil
