...
PaGlobal_Tooltip_BattlePoint._ui._battlePoint._staticText_Desc2:SetTextMode(__eTextMode_AutoWrap)
...
function PaGlobal_Tooltip_BattlePoint:SetPos()
  ...
  if true == equipPanel:IsUISubApp() then
    equipPosX = equipPanel:GetScreenParentPosX()
    equipPosY = equipPanel:GetScreenParentPosY()
  else
    equipPosX = equipPanel:GetPosX()
    equipPosY = equipPanel:GetPosY()
  end
  local posX = equipPosX - self._panel:GetSizeX()
  if posX < 0 then
    posX = equipPosX + equipPanel:GetSizeX()
  end
  local posY = equipPosY + equipPanel:GetSizeY() - self._panel:GetSizeY() - 10
  if posY < 0 then
    posY = 0
...
function PaGlobal_Tooltip_BattlePoint:equipPointUIPos()
  ...
  self._ui._equipPoint._staticText_StatExtraParam1Title:SetShow(false)
  self._ui._equipPoint._staticText_StatExtraParam1Value:SetShow(false)
  self._ui._equipPoint._staticText_StatExtraParam2Title:SetShow(false)
  self._ui._equipPoint._staticText_StatExtraParam2Value:SetShow(false)
  self._ui._equipPoint._staticText_StatExtraParam3Title:SetShow(false)
  self._ui._equipPoint._staticText_StatExtraParam3Value:SetShow(false)
  ...
  if true == isShyWomen then
    ...
    self._ui._equipPoint._staticText_EquipAwakenAttackValue:SetShow(false)
    self._ui._equipPoint._staticText_EquipAwakenAttackTitle:SetShow(false)
    self._ui._equipPoint._staticText_StatExtraParam1Title:SetShow(true)
    self._ui._equipPoint._staticText_StatExtraParam1Value:SetShow(true)
  end
  local posY = 5
...
function PaGlobal_Tooltip_BattlePoint:updateData()
  ...
  ui._equipPoint._staticText_StatExtraParam1Value:SetText(awakenOffenceValue .. " (" .. PAGetStringParam1(Defines.StringSheet_GAME, "LUA_ADDED_AWAKENOFFENCE_VALUE", "value", equipAddedAwakenOffence) .. ")")
end
...
function Fglobal_Init_Tooltip_BattlePoint()
  ...
  ui._equipPoint._staticText_StatExtraParam1Title = UI.getChildControl(ui._equipPoint._equip_BonusStat, "StaticText_ShyStat1_Title")
  ui._equipPoint._staticText_StatExtraParam2Title = UI.getChildControl(ui._equipPoint._equip_BonusStat, "StaticText_ShyStat2_Title")
  ui._equipPoint._staticText_StatExtraParam3Title = UI.getChildControl(ui._equipPoint._equip_BonusStat, "StaticText_ShyStat3_Title")
  ui._equipPoint._staticText_StatExtraParam1Value = UI.getChildControl(ui._equipPoint._equip_BonusStat, "StaticText_ShyStat1_Value")
  ui._equipPoint._staticText_StatExtraParam2Value = UI.getChildControl(ui._equipPoint._equip_BonusStat, "StaticText_ShyStat2_Value")
  ui._equipPoint._staticText_StatExtraParam3Value = UI.getChildControl(ui._equipPoint._equip_BonusStat, "StaticText_ShyStat3_Value")
  ...
  if false == awakenWeaponContentsOpen then
    ...
    ui._equipPoint._staticText_StatExtraParam1Title:SetShow(false)
    ui._equipPoint._staticText_StatExtraParam1Value:SetShow(false)
    ui._equipPoint._staticText_StatExtraParam2Title:SetShow(false)
    ui._equipPoint._staticText_StatExtraParam2Value:SetShow(false)
    ui._equipPoint._staticText_StatExtraParam3Title:SetShow(false)
    ui._equipPoint._staticText_StatExtraParam3Value:SetShow(false)
...
function FGlobal_EquipmentUpdate()
  ...
  if false == PaGlobal_Tooltip_BattlePoint._panel:GetShow() then
    return
  end
