...
local isConsole = _ContentsGroup_RenewUI
...
function default_PosY_Size:Init()
  ...
  self._Result_Name_SpanX = default_Control._Result_Name:GetSpanSize().x
  ...
  self._Resource_Name_SpanX = default_Control._Resource_Name:GetSpanSize().x
  self._Resource_Name_SpanY = default_Control._Resource_Name:GetSpanSize().y
  self._Resource_IconBG_SpanX = default_Control._Resource_IconBG:GetSpanSize().x
  self._Resource_IconBG_SpanY = default_Control._Resource_IconBG:GetSpanSize().y
  self._Resource_Icon_SpanX = default_Control._Resource_Icon:GetSpanSize().x
  self._Resource_Icon_SpanY = default_Control._Resource_Icon:GetSpanSize().y
  self._ResultBG_MinSizeY = default_Control._Result_BG:GetSizeY() + default_Control._Result_Title:GetTextSizeY()
end
...
local function Create_Control(index, isInit)
  ...
  self._Work_Name = UI.createControl(__ePAUIControl_StaticText, self._Panel, "StaticText_Work_Title_" .. tostring(idx))
  self._Work_Type = UI.createControl(__ePAUIControl_StaticText, self._Panel, "StaticText_Work_Type_" .. tostring(idx))
  self._Work_Des = UI.createControl(__ePAUIControl_StaticText, self._Panel, "StaticText_Work_Description_" .. tostring(idx))
  self._Result_BG = UI.createControl(__ePAUIControl_Static, self._Panel, "Static_WorkResult_BG_" .. tostring(idx))
  self._Resource_BG = UI.createControl(__ePAUIControl_Static, self._Panel, "Static_WorkResource_BG_" .. tostring(idx))
  self._WorkVolume_BG = UI.createControl(__ePAUIControl_Static, self._Panel, "Static_WorkVolume_BG_" .. tostring(idx))
  ...
  self._Work_Name:SetTextMode(__eTextMode_AutoWrap)
  self._Result_Title = UI.createControl(__ePAUIControl_StaticText, self._Result_BG, "Result_Title" .. tostring(idx))
  self._Result_IconBG = UI.createControl(__ePAUIControl_Static, self._Result_BG, "Result_IconBG" .. tostring(idx))
  self._Result_Icon = UI.createControl(__ePAUIControl_Static, self._Result_BG, "Result_Icon" .. tostring(idx))
  self._Result_Name = UI.createControl(__ePAUIControl_StaticText, self._Result_BG, "Result_Name" .. tostring(idx))
  self._Resource_Title = UI.createControl(__ePAUIControl_StaticText, self._Resource_BG, "Resource_Title" .. tostring(idx))
  self._WorkVolume_Title = UI.createControl(__ePAUIControl_StaticText, self._WorkVolume_BG, "WorkVolume_Title" .. tostring(idx))
  self._WorkVolume_Value = UI.createControl(__ePAUIControl_StaticText, self._WorkVolume_BG, "WorkVolume_Value" .. tostring(idx))
  self._WorkVolume_Guide = UI.createControl(__ePAUIControl_StaticText, self._WorkVolume_BG, "WorkVolume_Guide" .. tostring(idx))
  ...
  self._WorkVolume_Guide:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._Result_IconBG:SetSpanSize(self._Result_IconBG:GetSpanSize().x - spanX, self._Result_IconBG:GetSpanSize().y - spanY + 10)
  if true == isInit then
    default_PosY_Size._Result_IconBG_SpanY = self._Result_IconBG:GetSpanSize().y
    self._Guide = UI.createControl(__ePAUIControl_StaticText, self._Panel, "StaticText_Guide_" .. tostring(idx))
    CopyBaseProperty(default_Control._Guide, self._Guide)
    self._Guide:SetTextMode(__eTextMode_AutoWrap)
    ...
    if true == _ContentsGroup_RenewUI then
      self._Work_Type:SetTextHorizonRight()
      self._Work_Type:SetText("")
      self._Work_Type:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_WORLDMAP_GUILDHOUSE_WORKINGINFO"))
    else
      self._Work_Type:SetSpanSize(self._Work_Type:GetSpanSize().x - 11, self._Work_Type:GetSpanSize().y)
    end
  elseif false == isInit and false == isConsole then
    self._Btn_Close = UI.createControl(__ePAUIControl_Button, self._Panel, "Btn_Colse_" .. tostring(idx))
  ...
  self._Result_Icon:SetSpanSize(self._Result_Icon:GetSpanSize().x - spanX, self._Result_Icon:GetSpanSize().y - spanY + 10)
  self._Result_Name:SetTextMode(__eTextMode_AutoWrap)
  ...
  for key = 0, defalut_Param.resourceMaxCount - 1 do
    self._Resource_IconBG[key] = UI.createControl(__ePAUIControl_Static, self._Resource_BG, "Resource_IconBG" .. tostring(idx) .. "_" .. tostring(key))
    self._Resource_Icon[key] = UI.createControl(__ePAUIControl_Static, self._Resource_BG, "Resource_Icon" .. tostring(idx) .. "_" .. tostring(key))
    self._Resource_Name[key] = UI.createControl(__ePAUIControl_StaticText, self._Resource_BG, "Resource_Name" .. tostring(idx) .. "_" .. tostring(key))
...
local function Set_Control_SizePoS(controlIndex, isTooltip)
  ...
  target._Result_BG:SetPosY(self._AdjustPosY_SubPanel_1 + default_PosY_Size._TopPaddingY)
  target._Result_BG:SetSize(target._Result_BG:GetSizeX(), self._AdjustPosY_SubPanel_2)
  target._Resource_BG:SetPosY(target._Result_BG:GetPosY() + target._Result_BG:GetSizeY() + 10)
  target._Resource_BG:SetSize(target._Resource_BG:GetSizeX(), self._Resource_BG_SizeY + self._AdjustPosY_SubPanel_3)
  target._WorkVolume_BG:SetPosY(target._Resource_BG:GetPosY() + target._Resource_BG:GetSizeY() + 10)
  target._WorkVolume_BG:SetSize(target._WorkVolume_BG:GetSizeX(), self._WorkVolume_BG_SizeY + self._AdjustPosY_SubPanel_4)
  if nil ~= target._Guide then
    target._Guide:SetPosY(target._WorkVolume_BG:GetPosY() + target._WorkVolume_BG:GetSizeY() + 5)
  end
  local panelSizeY = self._AdjustPosY_SubPanel_1 + self._AdjustPosY_SubPanel_2 + self._AdjustPosY_SubPanel_3 + self._Resource_BG_SizeY + default_PosY_Size._TopPaddingY + 20
  if target._WorkVolume_BG:GetShow() == true then
    panelSizeY = panelSizeY + self._WorkVolume_BG_SizeY + self._AdjustPosY_SubPanel_4 + 10
  end
  if target._Guide ~= nil and target._Guide:GetShow() == true then
    panelSizeY = panelSizeY + target._Guide:GetTextSizeY() + 10
  end
  target._Panel:SetSize(Panel_Tooltip_Work:GetSizeX(), panelSizeY)
end
...
local function Insert_Tooltip_Work_Data(esSSW, isToolTip, controlIndex, nodeInfo, nodeType, isGuildManufactureSelect)
  ...
  if nodeType == CppEnums.NpcWorkingType.eNpcWorkingType_PlantBuliding then
    ...
    local itemSSW = esSSW:getResultItemStaticStatusWrapper()
    PAGlobalFunc_SetItemTextColor(self._Work_Name, itemSSW)
    self._Work_Name:SetPosY(default_PosY_Size._TopPaddingY)
    local workDes = esSSW:getDetailDescription()
    if workDes == nil then
      self._Work_Des:SetShow(false)
      default_PosY_Size._AdjustPosY_SubPanel_1 = self._Work_Name:GetTextSizeY()
    else
      self._Work_Des:SetShow(true)
      self._Work_Des:SetTextMode(__eTextMode_AutoWrap)
      self._Work_Des:SetAutoResize(true)
      self._Work_Des:SetText(workDes)
      self._Work_Des:SetPosY(self._Work_Name:GetTextSizeY() + default_PosY_Size._TopPaddingY + 10)
      default_PosY_Size._AdjustPosY_SubPanel_1 = self._Work_Name:GetTextSizeY() + self._Work_Des:GetTextSizeY() + 10
    end
    ...
    if false == esSSW:getUseExchangeIcon() then
      ...
      local secondDropGroup = esSS:getSecondDropGroup()
      if secondDropGroup ~= nil then
        local secondItemStatic = secondDropGroup:getItemStaticStatus()
        if secondItemStatic ~= nil then
          resultName = getItemName(secondItemStatic)
          ResultItemEventInfoList[controlIndex] = secondItemStatic._key
          self._Result_IconBG:addInputEvent("Mouse_On", "Copy_Item_Tooltip_Show(" .. controlIndex .. ", resourceIndex, true, " .. tostring(isToolTip) .. " )")
          self._Result_IconBG:addInputEvent("Mouse_Out", "Copy_Item_Tooltip_Hide()")
        end
      end
    ...
    PAGlobalFunc_SetItemTextColor(self._Result_Name, itemSSW)
    self._Result_Name:SetSpanSize(default_PosY_Size._Result_Name_SpanX - 10, default_PosY_Size._Result_IconBG_SpanY)
    local resultNameTextSizeY = self._Result_Name:GetTextSizeY()
    if resultNameTextSizeY > default_PosY_Size._Result_IconBG_SizeY then
      self._Result_Name:SetPosY(self._Result_Name:GetPosY() - (resultNameTextSizeY - default_PosY_Size._Result_IconBG_SizeY) / 2)
    else
      self._Result_Name:SetPosY(self._Result_Name:GetPosY() + (default_PosY_Size._Result_IconBG_SizeY - resultNameTextSizeY) / 2)
    end
    default_PosY_Size._AdjustPosY_SubPanel_2 = self._Result_Name:GetTextSizeY() + 10
    default_PosY_Size._AdjustPosY_SubPanel_2 = math.max(default_PosY_Size._ResultBG_MinSizeY, default_PosY_Size._AdjustPosY_SubPanel_2)
    clearResource(self)
    ...
    for idx = 0, eSSCount - 1 do
      ...
      if enchantLevel > 0 then
        ...
        itemName = printenchantLevel .. " " .. itemName
      end
      self._Resource_Icon[idx]:ChangeTextureInfoName(itemIcon)
      self._Resource_Name[idx]:SetTextMode(__eTextMode_AutoWrap)
      self._Resource_Name[idx]:SetText(itemName .. " ( " .. tostring(needCount) .. " )")
      PAGlobalFunc_SetItemTextColor(self._Resource_Name[idx], esSSW:getResourceItemStaticStatusWrapper(idx))
    ...
    local resSpanX = self._Resource_BG:GetSpanSize().x
    local resSpanY = self._Resource_BG:GetSpanSize().y
    local resourceTextSizeY = -10
    for idx = 0, eSSCount - 1 do
      resourceTextSizeY = resourceTextSizeY + self._Resource_Name[idx]:GetTextSizeY() / 2
      self._Resource_IconBG[idx]:SetSpanSize(default_PosY_Size._Resource_IconBG_SpanX - resSpanX, default_PosY_Size._Resource_IconBG_SpanY - resSpanY + resourceTextSizeY + default_PosY_Size._Resource_gapY * idx)
      self._Resource_Icon[idx]:SetSpanSize(default_PosY_Size._Resource_Icon_SpanX - resSpanX, default_PosY_Size._Resource_Icon_SpanY - resSpanY + resourceTextSizeY + default_PosY_Size._Resource_gapY * idx)
      self._Resource_Name[idx]:SetSpanSize(default_PosY_Size._Resource_Name_SpanX - resSpanX, default_PosY_Size._Resource_Name_SpanY - resSpanY + resourceTextSizeY + default_PosY_Size._Resource_gapY * idx)
      resourceTextSizeY = resourceTextSizeY + self._Resource_Name[idx]:GetTextSizeY() / 2
    end
    if eSSCount > 0 then
      default_PosY_Size._AdjustPosY_SubPanel_3 = resourceTextSizeY + default_PosY_Size._Resource_gapY * (eSSCount - 1) - 10
      control_Tooltip._Resource_BG:SetShow(true)
    else
      default_PosY_Size._AdjustPosY_SubPanel_3 = default_PosY_Size._Resource_BG_PosY - default_PosY_Size._WorkVolume_BG_PosY
    ...
    if false == _ContentsGroup_GuildManufacture then
      default_PosY_Size._AdjustPosY_SubPanel_4 = self._WorkVolume_Guide:GetSizeY() - default_PosY_Size._WorkVolume_Guide_SizeY
    elseif true == esSSW:isGuildManufactureItem() then
      default_PosY_Size._AdjustPosY_SubPanel_4 = self._Resource_Name[eSSCount - 1]:GetSizeY() - default_PosY_Size._Resource_BG_SizeY
    ...
    if nil ~= self._Guide then
      if true == isGuildManufactureSelect then
        ...
        default_PosY_Size._AdjustPosY_SubPanel_4 = default_PosY_Size._AdjustPosY_SubPanel_4 - self._Guide:GetSizeY()
      else
