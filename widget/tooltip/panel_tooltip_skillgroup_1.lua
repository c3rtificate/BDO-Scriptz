...
function PaGlobal_TooltipSkill_All:commonControlInit(tooltipInfo)
  ...
  tooltipInfo.siegeResource = UI.getChildControl(tooltipInfo.main, "Tooltip_Skill_AngryPoint")
  tooltipInfo.siegeResource_value = UI.getChildControl(tooltipInfo.main, "Tooltip_Skill_AngryPoint_value")
...
function PaGlobal_TooltipSkill_All:showTooltip(target, skillNo, skillTypeSS, isShowNextLevel, isReserveSkillOn, isResetable, isForceResetable, isItemSkillTooltip)
  ...
  if true == _ContentsGroup_DevelopKeyView then
    target.skillName:SetText(skillTypeSSW:getName() .. " (" .. skillNo .. ")")
  else
