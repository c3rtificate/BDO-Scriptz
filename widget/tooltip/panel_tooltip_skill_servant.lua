...
function PaGlobal_Tooltip_Servant:Open(skillInfo, slot, isSlotIcon, isShowStallionSkillTooltip)
  ...
  if screenSizeY < Panel_Tooltip_Skill_Servant:GetSizeY() + Panel_Tooltip_Skill_Servant:GetPosY() + 20 then
    Panel_Tooltip_Skill_Servant:SetPosY(screenSizeY - Panel_Tooltip_Skill_Servant:GetSizeY() - 20)
  end
...
function PaGlobal_Tooltip_Servant_Open(skillInfo, slot, isSlotIcon, isShowStallionSkillTooltip)
  PaGlobal_Tooltip_Servant:Open(skillInfo, slot, isSlotIcon, isShowStallionSkillTooltip)
end
