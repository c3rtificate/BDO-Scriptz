...
partyItemList._itemName:SetTextMode(__eTextMode_AutoWrap)
...
function Panel_PartyItemList_SlotInit()
  ...
  for index = 0, self._viewableCount - 1 do
    local temp = {}
    temp._itemListBg = UI.createControl(__ePAUIControl_Button, Panel_Party_ItemList, "Static_ItemListBg_" .. index)
    ...
    temp._itemSlotBg = UI.createControl(__ePAUIControl_Static, temp._itemListBg, "Static_ItemSlotBg_" .. index)
    ...
    temp._itemName = UI.createControl(__ePAUIControl_StaticText, temp._itemListBg, "StaticText_ItemName_" .. index)
    ...
    temp._itemPrice = UI.createControl(__ePAUIControl_StaticText, temp._itemListBg, "StaticText_ItemPrice_" .. index)
    ...
    temp._btnBuy = UI.createControl(__ePAUIControl_Button, temp._itemListBg, "Button_Buy_" .. index)
    ...
    temp._btnDice = UI.createControl(__ePAUIControl_Button, temp._itemListBg, "Button_Dice_" .. index)
    ...
    temp._btnGiveUp = UI.createControl(__ePAUIControl_Button, temp._itemListBg, "Button_GiveUp_" .. index)
  ...
  self.bottomDesc:SetTextMode(__eTextMode_AutoWrap)
...
function partyItemList:update()
  ...
  self._txtBag:SetText(makeDotMoney(getSelfPlayer():get():getMoneyInventory():getMoney_s64()))
...
function Panel_Party_ItemList_Open()
  ...
  if true == _ContentsGroup_NewUI_PartyWidget_All then
    Panel_Party_ItemList:SetPosX(Panel_Widget_Party_All:GetPosX() + Panel_Widget_Party_All:GetSizeX() + 10)
    Panel_Party_ItemList:SetPosY(Panel_Widget_Party_All:GetPosY())
  else
