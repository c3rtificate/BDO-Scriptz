...
function NewKnowledgePopup:initialize()
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(self._buttonQuestion, "\"PanelImportantKnowledge\"")
  if true == _ContentsOption_CH_Help then
    self._buttonQuestion:SetShow(false)
  end
  self._staticDesc:SetTextMode(__eTextMode_AutoWrap)
  self._staticTitle:SetTextMode(__eTextMode_AutoWrap)
end
