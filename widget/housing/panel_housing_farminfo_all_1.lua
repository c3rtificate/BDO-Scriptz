function PaGlobal_FarmInfo_All:initialize()
  ...
  self._ui._btn_close = UI.getChildControl(Panel_Housing_FarmInfo_All, "Button_Win_Close")
  self._ui._btn_question = UI.getChildControl(Panel_Housing_FarmInfo_All, "Button_Question")
  ...
  self:initIconUV()
  self._ui._txt_title:SetTextMode(__eTextMode_LimitText)
