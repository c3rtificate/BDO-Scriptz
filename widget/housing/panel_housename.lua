...
function EventHousingShowVisitHouse(isShow, houseName, userNickname, point, isMine)
  ...
  local isMansion = houseWrapper:isMansion()
  if true == isMansion then
    local desc = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_HOUSING_HOUSENAME_BIGHOUSE", "user_nickname", userNickname) .. "( " .. houseName .. " ) " .. tostring(point)
