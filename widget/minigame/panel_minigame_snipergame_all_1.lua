function PaGlobal_MiniGame_SniperGame_All:initialize()
  ...
  self._ui._hole = UI.getChildControl(Panel_MiniGame_SniperGame_All, "Static_BG_SniperGame")
  self._ui._crossHair = UI.getChildControl(Panel_MiniGame_SniperGame_All, "Static_CrossHair")
  self._ui._crossHairGrid = UI.getChildControl(Panel_MiniGame_SniperGame_All, "Static_CrossHairGrid")
  self._ui._crossHairGridGoodText = UI.getChildControl(self._ui._crossHairGrid, "Static_Result_Good")
  self._ui._crossHairGridBadText = UI.getChildControl(self._ui._crossHairGrid, "Static_Result_Bad")
  self._ui._deviationMark = UI.getChildControl(Panel_MiniGame_SniperGame_All, "Static_Deviation")
  self._ui._blackboxes = {}
  self._ui._deviationHit = {}
  self._ui._deviationMiss = {}
  self._ui._breathContainer = UI.getChildControl(Panel_MiniGame_SniperGame_All, "Static_BG_BreathContainer")
  ...
  self._ui._fade = UI.getChildControl(Panel_MiniGame_SniperGame_All, "Static_Fade")
  self._ui._fadeCircle = UI.getChildControl(self._ui._hole, "Static_FadeCircle")
  self._ui._debugText = UI.getChildControl(Panel_MiniGame_SniperGame_All, "MultilineText_Debug")
  self._ui._middlePointDev = UI.getChildControl(Panel_MiniGame_SniperGame_All, "Static_MiddlePoint_ForDev")
  self._ui._sniperScopeBG = UI.getChildControl(Panel_MiniGame_SniperGame_All, "Static_ScopeBG")
  self._ui._blackboxes = {
  ...
  self._ui._sniperPerfectShotGuide = UI.getChildControl(self._ui._sniperScopeBG, "StaticText_Sniper_Guide")
...
function PaGlobal_MiniGame_SniperGame_All:basicSetting()
  ...
  self._ui._crossHairGrid:SetShow(false)
  self._ui._crossHairGridGoodText:SetShow(false)
  self._ui._crossHairGridBadText:SetShow(false)
  self._ui._sniperScopeBG:SetShow(false)
  ...
  if _ContentsGroup_NewSniperMode == true then
    ToClient_SniperGame_SetCrossHairRadiusParam(self._config._scopeRadiusMin, self._config._scopeRadiusMax, self._config._criticalSectionMin, self._config._criticalSectionMax)
  else
...
function PaGlobal_MiniGame_SniperGame_All:registerEventHandler()
  ...
  registerEvent("FromClient_SniperGame_SetPerfectShotUI", "FromClient_SniperGame_SetPerfectShotUI")
...
function PaGlobal_MiniGame_SniperGame_All:prepareOpen()
  ...
  if ToClient_SniperGame_IsPlaying() == false then
    return
  end
  if PaGlobal_MiniGame_SniperShotResult_All_SetShowResultPanel ~= nil then
    PaGlobal_MiniGame_SniperShotResult_All_SetShowResultPanel(false)
  end
  if PaGlobal_MiniGame_SniperShotResult_All_Close ~= nil and ToClient_isEquipNewSniperRifle() == false then
    PaGlobal_MiniGame_SniperShotResult_All_Close()
  end
  PaGlobal_MiniGame_SniperGame_All:setPerfectShotResult(0)
...
function PaGlobal_MiniGame_SniperGame_All:validate()
  ...
  self._ui._hole:isValidate()
  self._ui._crossHair:isValidate()
  self._ui._crossHairGrid:isValidate()
  self._ui._crossHairGridGoodText:isValidate()
  self._ui._crossHairGridBadText:isValidate()
  self._ui._deviationMark:isValidate()
  self._ui._breathContainer:isValidate()
  self._ui._fade:isValidate()
  self._ui._debugText:isValidate()
  self._ui._middlePointDev:isValidate()
  self._ui._sniperScopeBG:isValidate()
  self._ui._sniperPerfectShotGuide:isValidate()
end
function PaGlobal_MiniGame_SniperGame_All:UpdatePerFrame(deltaTime)
  ...
  self._ui._crossHairGrid:SetPosXY(crossHairPosX - self._ui._crossHairGrid:GetSizeX() * 0.5, crossHairPosY - self._ui._crossHairGrid:GetSizeY() * 0.5)
  ...
  if _ContentsGroup_NewSniperMode == true then
    self:SetCircularPositioning(math.abs(gameInfo:getRadius()))
  else
  ...
  local breathGaugeSize = gameInfo:getRemainedBreathing() / gameInfo:getMaxBreathing()
...
function PaGlobal_MiniGame_SniperGame_All:setPerfectShotResult(type)
  if Panel_MiniGame_SniperGame_All == nil then
    return
  end
  if _ContentsGroup_NewSniperMode == false then
    return
  end
  self._ui._crossHairGrid:EraseAllEffect()
  if type == 1 then
    self._ui._crossHairGrid:AddEffect("fUI_Sniper_MiniGame_Good_01A", false, 0, 0)
    self._ui._crossHairGrid:ChangeTextureInfoTextureIDKey("Combine_Etc_HuntingGame_CircleAiming_Grid_Re_Good")
    self._ui._crossHairGridGoodText:SetShow(false)
    self._ui._crossHairGridBadText:SetShow(false)
    audioPostEvent_SystemUi(10, 6)
    _AudioPostEvent_SystemUiForXBOX(10, 6)
  elseif type == 2 then
    self._ui._crossHairGrid:AddEffect("fUI_Sniper_MiniGame_Bad_01A", false, 0, 0)
    self._ui._crossHairGrid:ChangeTextureInfoTextureIDKey("Combine_Etc_HuntingGame_CircleAiming_Grid_Re_Bad")
    self._ui._crossHairGridGoodText:SetShow(false)
    self._ui._crossHairGridBadText:SetShow(false)
    audioPostEvent_SystemUi(10, 7)
    _AudioPostEvent_SystemUiForXBOX(10, 7)
  else
    self._ui._crossHairGrid:ChangeTextureInfoTextureIDKey("Combine_Etc_HuntingGame_CircleAiming_Grid_Re")
    self._ui._crossHairGridGoodText:SetShow(false)
    self._ui._crossHairGridBadText:SetShow(false)
  end
  self._ui._crossHairGrid:setRenderTexture(self._ui._crossHairGrid:getBaseTexture())
end
