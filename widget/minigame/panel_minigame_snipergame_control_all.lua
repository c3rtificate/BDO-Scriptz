...
function PaGlobal_MiniGame_SniperGame_Control_All:registEventHandler()
  ...
  registerEvent("FromClient_SniperGame_MissShotResultPanel", "FromClient_SniperGame_All_MissShotResultPanel")
  registerEvent("FromClient_SniperGame_UpdateShotResultPanel", "FromClient_SniperGame_All_UpdateShotResultPanel")
end
...
function PaGlobalFunc_SniperGame_All_EndSniperGame()
  ...
  if PaGlobal_MiniGame_SniperShotResult_All_SetShowResultPanel ~= nil and ToClient_SniperGame_CheckSniperTargetExist() == true and ToClient_isEquipNewSniperRifle() == true then
    PaGlobal_MiniGame_SniperShotResult_All_SetShowResultPanel(true)
  end
  ToClient_SniperGame_StopPlay()
  ToClient_SniperGame_ChangeState(__eSniperGameState_None)
end
function PaGlobalFunc_SniperGame_All_StartSearching()
  PaGlobal_MiniGame_SniperGame_All_SetShowPerfectShotKeyGuide(true)
  ToClient_SniperGame_ChangeState(__eSniperGameState_Searching)
end
function PaGlobalFunc_SniperGame_All_StartAimMini()
  PaGlobal_MiniGame_SniperGame_All_SetShowPerfectShotKeyGuide(false)
...
function FromClient_SniperGame_All_MissShotResultPanel()
  PaGlobal_MiniGame_SniperGame_Result_All_MissShotResultPanel()
end
function FromClient_SniperGame_All_UpdateShotResultPanel(isPerfectShot, isCriticalShot)
  PaGlobal_MiniGame_SniperGame_Result_All_UpdateShotResultPanel(isPerfectShot, isCriticalShot)
end
