...
function PaGlobal_MiniGame_SniperGame_All_GetShow()
  if nil == Panel_MiniGame_SniperGame_All then
    return false
  end
  return Panel_MiniGame_SniperGame_All:GetShow()
end
...
function PaGlobal_MiniGame_SniperGame_All_StartAimMiniGame()
  ...
  PaGlobal_MiniGame_SniperGame_All._ui._crossHairGrid:SetShow(_ContentsGroup_NewSniperMode)
  PaGlobal_MiniGame_SniperGame_All._ui._sniperScopeBG:SetShow(_ContentsGroup_NewSniperMode)
...
function PaGlobal_MiniGame_SniperGame_All_EndAimMiniGame()
  ...
  if _ContentsGroup_NewSniperMode == false then
    ...
    PaGlobal_MiniGame_SniperGame_All._ui._crossHairGrid:SetShow(false)
    PaGlobal_MiniGame_SniperGame_All._ui._crossHairGridGoodText:SetShow(false)
    PaGlobal_MiniGame_SniperGame_All._ui._crossHairGridBadText:SetShow(false)
    PaGlobal_MiniGame_SniperGame_All._ui._sniperScopeBG:SetShow(false)
  end
...
function PaGlobal_MiniGame_SniperGame_All_StartSearchMode(withAnimation)
  ...
  PaGlobal_MiniGame_SniperGame_All._ui._crossHair:SetShow(_ContentsGroup_NewSniperMode)
  PaGlobal_MiniGame_SniperGame_All._ui._crossHairGrid:SetShow(_ContentsGroup_NewSniperMode)
  PaGlobal_MiniGame_SniperGame_All._ui._sniperScopeBG:SetShow(_ContentsGroup_NewSniperMode)
  PaGlobal_MiniGame_SniperGame_All._ui._deviationMark:SetShow(false)
...
function FromClient_Minigame_SniperGame_All_OnScreenSize()
  ...
  PaGlobal_MiniGame_SniperGame_All._ui._sniperScopeBG:SetSize(screenSizeX, screenSizeY)
  ...
  PaGlobal_MiniGame_SniperGame_All._ui._sniperPerfectShotGuide:ComputePos()
end
function FromClient_SniperGame_SetPerfectShotUI(flag)
  if Panel_MiniGame_SniperGame_All == nil then
    return
  end
  if flag == true then
    PaGlobal_MiniGame_SniperGame_All:setPerfectShotResult(1)
  elseif flag == false then
    PaGlobal_MiniGame_SniperGame_All:setPerfectShotResult(2)
  else
    PaGlobal_MiniGame_SniperGame_All:setPerfectShotResult(0)
  end
end
function PaGlobal_MiniGame_SniperGame_All_SetShowPerfectShotKeyGuide(flag)
  if Panel_MiniGame_SniperGame_All == nil then
    return
  end
  if _ContentsGroup_NewSniperMode == false then
  ...
  if flag == true then
    PaGlobal_MiniGame_SniperGame_All._ui._sniperPerfectShotGuide:SetShow(true)
  else
    PaGlobal_MiniGame_SniperGame_All._ui._sniperPerfectShotGuide:SetShow(false)
  end
end
