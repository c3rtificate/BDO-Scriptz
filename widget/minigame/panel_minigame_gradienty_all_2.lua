...
function PaGlobal_MiniGame_GradientY_All_GetShow()
  if nil == Panel_Minigame_GradientY_All then
    return false
  end
  return Panel_Minigame_GradientY_All:GetShow()
end
...
function PaGlobal_MiniGame_GradientY_All_HideHallowinIcon()
  PaGlobal_MiniGame_GradientY_All._ui.txt_purposeText:SetShow(true)
  PaGlobal_MiniGame_GradientY_All._ui.stc_icon:SetShow(true)
  PaGlobal_MiniGame_GradientY_All._ui.stc_hallowinIcon:SetShow(false)
end
function PaGlobal_MiniGame_GradientY_All_StartGame()
  local isHallowin = FGlobal_isPlaying_DropHallowin()
  PaGlobal_MiniGame_GradientY_All._ui.txt_purposeText:SetShow(not isHallowin)
  PaGlobal_MiniGame_GradientY_All._ui.stc_icon:SetShow(not isHallowin)
  PaGlobal_MiniGame_GradientY_All._ui.stc_hallowinIcon:SetShow(isHallowin)
  if true == isHallowin then
    PaGlobal_MiniGame_GradientY_All._sequenceKeyTimeSpan = 1
    PaGlobal_MiniGame_GradientY_All._KeyTimeSpanMaxWeight = 0.17
    PaGlobal_MiniGame_GradientY_All._KeyTimeSpanMinWeight = 0.15
    PaGlobal_MiniGame_GradientY_All._speedWeight = 2.8
  else
    PaGlobal_MiniGame_GradientY_All._sequenceKeyTimeSpan = 1.1
    PaGlobal_MiniGame_GradientY_All._KeyTimeSpanMaxWeight = 0.25
    PaGlobal_MiniGame_GradientY_All._KeyTimeSpanMinWeight = 0.15
    PaGlobal_MiniGame_GradientY_All._speedWeight = 5
  end
...
function PaGlobal_MiniGame_GradientY_All_EndGame()
  PaGlobal_MiniGame_GradientY_All_HideHallowinIcon()
