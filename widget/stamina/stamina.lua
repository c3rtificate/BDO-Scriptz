...
registerEvent("FromClient_StartSequencePlayerControlable", "FromClient_StartSequencePlayerControlable_Stamina")
function FromClient_StartSequencePlayerControlable_Stamina()
  Panel_Stamina:SetAlpha(0)
  local aniInfo = UIAni.AlphaAnimation(1, Panel_Stamina, 0, 0.8)
...
function PaGlobal_Stamina_ResetPosition()
  ...
  elseif relativePosX == 0 and relativePosY == 0 then
    ...
    local bias = 0.9
    local bposY = math.floor(getOriginScreenSizeY() * relativePosY - Panel_Stamina:GetSizeY() / 2 + bias)
