...
local expTooltip = UI.createControl(__ePAUIControl_StaticText, Panel_CheckedQuestInfo, "expTooltip_ForQuestWidgetInfo")
...
expTooltip:SetTextMode(__eTextMode_AutoWrap)
...
function FGlobal_QuestInfoDetail(groupId, questId, uiCondition, groupTitle, questGroupCount, fromQuestWidget, isRecommand, isNextQuest, isCleared)
  ...
  questInfoWindow_groupTitle:SetTextMode(__eTextMode_Limit_AutoWrap)
  ...
  questInfoWindow_questTitle:SetTextMode(__eTextMode_Limit_AutoWrap)
  ...
  ToClient_ChangeQuestIconFromIconPath(questInfoWindow_questIcon, questInfo:getIconPath(), questInfo:getQuestType())
  ...
  questInfoWindow_questCondition:SetTextMode(__eTextMode_AutoWrap)
  ...
  txt_isQuestDesc:SetTextMode(__eTextMode_AutoWrap)
