...
PaGlobal_MainQuest = {
  _uiGroupBG = UI.getChildControl(_static_active, "Static_GroupBG"),
  _uiQuestCompleteNpc = UI.getChildControl(_static_active, "StaticText_Quest_ClearNpc"),
  _uiQuestGroupTitle = UI.getChildControl(_static_active, "StaticText_WidgetGroupTitle"),
  _uiQuestTypeIcon = UI.getChildControl(_static_active, "Static_Quest_Type"),
  _uiQuestTitle = UI.getChildControl(_static_active, "StaticText_Quest_Title"),
  _uiAutoNaviBtn = UI.getChildControl(_static_active, "CheckButton_AutoNavi"),
  _uiNaviBtn = UI.getChildControl(_static_active, "Checkbox_Quest_Navi"),
  _uiQuestClearIcon = UI.getChildControl(_static_active, "Static_Quest_Icon_ClearCheck"),
  _uiQuestTopDeco = UI.getChildControl(_static_active, "Static_TopDeco"),
  _uiQuestBottomDeco = UI.getChildControl(_static_active, "Static_BottomDeco"),
  _uiTooltip = UI.getChildControl(_static_active, "StaticText_Notice_1"),
  _uiConsoleGuideLine = UI.getChildControl(_static_active, "Static_BottomLine_ConsoleUI"),
  _uiQuestConditions = Array.new(),
  _maxConditionCnt = 5,
  _closeableLevel = 50
}
function PaGlobal_MainQuest:initialize()
  local uiCondition = UI.getChildControl(_static_active, "StaticText_Quest_Demand")
  uiCondition:SetShow(false)
  for ii = 0, self._maxConditionCnt - 1 do
    self._uiQuestConditions[ii] = UI.createAndCopyBasePropertyControl(_static_active, "StaticText_Quest_Demand", _static_active, "uiConditions_" .. ii)
  ...
  _static_active:SetChildIndex(self._uiAutoNaviBtn, 9999)
  _static_active:SetChildIndex(self._uiNaviBtn, 9999)
  ...
  _static_active:SetSize(Panel_MainQuest:GetSizeX(), 60)
