...
local CheckedQuestOptionPanel = {
  ...
  _mainBg = UI.getChildControl(Panel_Window_Quest_New_Option, "Static_MainBg"),
...
local panelMainBgSizeY = CheckedQuestOptionPanel._mainBg:GetSizeY()
function CheckedQuestOptionPanel:Initialize()
  ...
  for ii = 0, _favorType.Count - 1 do
    ...
    self._favorCheckBoxButton[ii]:SetTextMode(__eTextMode_Limit_AutoWrap)
  ...
  self._favorDesc:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._mainBg:SetSize(self._mainBg:GetSizeX(), panelMainBgSizeY + (textSizeY + 8))
