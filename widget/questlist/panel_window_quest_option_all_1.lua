function PaGlobal_Quest_Option_All:initialize()
  ...
  self._ui.favorCheckBoxButton[__eQuestSelectType_Count] = UI.getChildControl(self._ui.stc_option_displayBG, "Checkbox_0")
  self._ui.favorCheckBoxButton[__eQuestSelectType_Main] = nil
  self._ui.favorCheckBoxButton[__eQuestSelectType_BlackSpirit] = UI.getChildControl(self._ui.stc_option_displayBG, "Checkbox_1")
  self._ui.favorCheckBoxButton[__eQuestSelectType_Sub] = UI.getChildControl(self._ui.stc_option_displayBG, "Checkbox_2")
  self._ui.favorCheckBoxButton[__eQuestSelectType_Adventure] = UI.getChildControl(self._ui.stc_option_displayBG, "Checkbox_3")
  self._ui.favorCheckBoxButton[__eQuestSelectType_Life] = UI.getChildControl(self._ui.stc_option_displayBG, "Checkbox_4")
  self._ui.favorCheckBoxButton[__eQuestSelectType_Contents] = UI.getChildControl(self._ui.stc_option_displayBG, "Checkbox_5")
  self._ui.favorCheckBoxButton[__eQuestSelectType_Event] = UI.getChildControl(self._ui.stc_option_displayBG, "Checkbox_6")
  self._ui.favorCheckBoxButton[__eQuestSelectType_Etc] = UI.getChildControl(self._ui.stc_option_displayBG, "Checkbox_7")
  ...
  if true == _ContentsGroup_ChinaFontColor then
    self._ui.stc_option_displayBG:SetShow(false)
    Panel_Window_Quest_Option_All:SetSize(Panel_Window_Quest_Option_All:GetSizeX(), Panel_Window_Quest_Option_All:GetSizeY() - self._ui.stc_option_displayBG:GetSizeY())
    self._ui.stc_mainBG:SetSize(self._ui.stc_mainBG:GetSizeX(), self._ui.stc_mainBG:GetSizeY() - self._ui.stc_option_displayBG:GetSizeY())
    Panel_Window_Quest_Option_All:ComputePosAllChild()
    self._ui.stc_option_sortBG:SetSpanSize(self._ui.stc_option_sortBG:GetSpanSize().x, self._ui.stc_option_displayBG:GetSpanSize().y)
    self._ui.stc_option_sortBG:ComputePos()
    self._ui.stc_option_recentBG:SetSpanSize(self._ui.stc_option_recentBG:GetSpanSize().x, self._ui.stc_option_sortBG:GetSizeY())
    self._ui.stc_option_recentBG:ComputePos()
  end
...
function PaGlobal_Quest_Option_All:registEventHandler()
  ...
  for ii = 0, __eQuestSelectType_Count do
    if self._ui.favorCheckBoxButton[ii] ~= nil then
...
function PaGlobal_Quest_Option_All:confirm()
  local QuestListInfo = ToClient_GetQuestList()
  if nil ~= QuestListInfo then
    for index = 0, __eQuestSelectType_Count - 1 do
      if self._ui.favorCheckBoxButton[index] ~= nil then
...
function PaGlobal_Quest_Option_All:setFavorButtonCheckAll()
  local isCheck = self._ui.favorCheckBoxButton[__eQuestSelectType_Count]:IsCheck()
  for ii = 0, __eQuestSelectType_Count do
    if self._ui.favorCheckBoxButton[ii] ~= nil then
...
function PaGlobal_Quest_Option_All:updateFavorButton()
  ...
  self._ui.favorCheckBoxButton[__eQuestSelectType_Count]:SetCheck(isAllCheck)
end
