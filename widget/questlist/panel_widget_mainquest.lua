...
local mainQuestWidget = {
  _ui = {
    ...
    _bubbleCtrlBg = nil,
    _bubbleCtrlText = nil,
    _btn_option = UI.getChildControl(Panel_MainQuest, "Button_Option"),
    _stc_bottomLine = UI.getChildControl(Panel_MainQuest, "Static_BottomLine")
  },
  ...
  eUPDATE_FUNCTYPE = {UPDATE = 1, UPDATE_RENEW = 2},
  _tutorialShowLevelLimit = 30,
  _tutorialDesc = {
  ...
  _blabla = {
    ...
    [68] = {
      ...
      _questId = 29,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_120")
      }
    },
    [69] = {
      _questGroup = 21111,
      _questId = 9,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_121"),
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_122")
      }
    },
    [70] = {
      _questGroup = 21121,
      _questId = 1,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_123"),
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_124")
      }
    },
    [71] = {
      _questGroup = 21121,
      _questId = 2,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_125"),
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_126")
      }
    },
    [72] = {
      _questGroup = 21121,
      _questId = 3,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_127"),
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_128")
      }
    },
    [73] = {
      _questGroup = 21121,
      _questId = 4,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_129"),
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_130")
      }
    },
    [74] = {
      _questGroup = 21121,
      _questId = 5,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_131"),
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_132")
      }
    },
    [75] = {
      _questGroup = 21121,
      _questId = 7,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_133"),
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_134")
      }
    },
    [76] = {
      _questGroup = 21121,
      _questId = 8,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_135"),
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_136")
      }
    },
    [77] = {
      _questGroup = 21121,
      _questId = 9,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_137"),
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_138")
      }
    },
    [78] = {
      _questGroup = 21121,
      _questId = 10,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_139"),
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_140")
      }
    },
    [79] = {
      _questGroup = 21121,
      _questId = 11,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_141"),
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_142")
      }
    },
    [80] = {
      _questGroup = 21121,
      _questId = 12,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_143"),
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_144")
      }
    },
    [81] = {
      _questGroup = 21121,
      _questId = 13,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_145"),
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_146")
      }
    },
    [82] = {
      _questGroup = 21121,
      _questId = 14,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_147"),
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_148")
      }
    },
    [83] = {
      _questGroup = 21121,
      _questId = 15,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_149"),
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_150")
      }
    },
    [84] = {
      _questGroup = 21121,
      _questId = 16,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_151"),
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_152")
      }
    },
    [85] = {
      _questGroup = 21121,
      _questId = 17,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_153"),
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_154")
      }
    },
    [86] = {
      _questGroup = 21121,
      _questId = 18,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_155"),
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_156")
      }
    },
    [87] = {
      _questGroup = 21121,
      _questId = 22,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_157"),
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_158")
      }
    },
    [88] = {
      _questGroup = 21121,
      _questId = 19,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_159"),
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_160")
      }
    },
    [89] = {
      _questGroup = 5529,
      _questId = 2,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_161")
      }
    },
    [90] = {
      _questGroup = 5529,
      _questId = 13,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_162")
      }
    },
    [91] = {
      _questGroup = 5529,
      _questId = 14,
      _message = {
        PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_BLABLADESC_163")
      }
    }
  }
}
...
function mainQuestWidget:hidePanelConditionCheck()
  if nil == Panel_MainQuest then
    _PA_ASSERT_NAME(false, "Panel_MainQuest\236\157\180 nil \236\158\133\235\139\136\235\139\164.", "\236\160\149\236\167\128\237\152\156")
    return
  end
  ...
  if true == bHide then
    Panel_MainQuest:SetRenderAndEventHide(true)
  else
    Panel_MainQuest:SetRenderAndEventHide(false)
  end
end
function mainQuestWidget:createControl()
  ...
  self._ui._bubbleText:SetTextMode(__eTextMode_AutoWrap)
...
function mainQuestWidget:initControl()
  ...
  Panel_MainQuest:addInputEvent("Mouse_On", "PaGlobalFunc_MainQuestWidget_MouseOnEvent()")
  ...
  self._ui._btn_option:addInputEvent("Mouse_LUp", "HandleEventLUp_MainQuestWidget_OptionButton()")
  self._ui._btn_option:addInputEvent("Mouse_On", "HandleEventOnOut_MainQuestWidget_ShowOptionTooltip(true)")
  self._ui._btn_option:addInputEvent("Mouse_Out", "HandleEventOnOut_MainQuestWidget_ShowOptionTooltip(false)")
...
function mainQuestWidget:update(groupNo, questNo)
  ...
  if nil ~= uiQuestInfo then
    if uiQuestInfo:isHaveBackEndData() == false then
      self:pushQuestLoadingData(uiQuestInfo, self.eUPDATE_FUNCTYPE.UPDATE)
    end
...
function mainQuestWidget:updateRenew(groupNo, questNo)
  ...
  if mainQuestInfo:isHaveBackEndData() == false then
    self:pushQuestLoadingData(mainQuestInfo, self.eUPDATE_FUNCTYPE.UPDATE_RENEW)
  end
...
function PaGlobal_MainQuestWidget_CheckQuestEffect()
  ...
  mainQuestWidget._ui._static_Quest_Type:AddEffect("fUI_BlackSpirit_Pass_Icon_Cast_01B")
  mainQuestWidget._ui._static_Quest_Type:AddEffect("UI_BlackSpirit_Pass_Icon_Cast_01B")
...
function mainQuestWidget:clearAll()
  ...
  self._ui._clearNpcEffect:SetSize(300, 35)
  self._ui._clearNpcEffect2:SetSize(300, 35)
  self._ui._staticText_Quest_Demand:SetShow(false)
...
function mainQuestWidget:clearQuestLoadingTable()
  if Panel_MainQuest == nil or _ContentsGroup_QuestBackEndLoading == false then
    return
  end
  self._questLoadingDataList = Array.new()
end
function mainQuestWidget:pushQuestLoadingData(uiQuestInfo, updateFuncType)
  if Panel_MainQuest == nil or _ContentsGroup_QuestBackEndLoading == false or uiQuestInfo == nil or updateFuncType == nil then
    return
  end
  ...
  if self:isExistLoadingDataAnyOne() == true then
    for index = #self._questLoadingDataList, 1, -1 do
      ...
      if value ~= nil then
        ...
        elseif value._updateFuncType ~= newLoadingData.updateFuncType then
          table.remove(self._questLoadingDataList, index)
        end
      end
    end
...
function mainQuestWidget:isExistLoadingDataAnyOne()
  if Panel_MainQuest == nil or _ContentsGroup_QuestBackEndLoading == false then
    return false
  end
  if self._questLoadingDataList == nil then
...
function mainQuestWidget:setQuestTitleInfo(uiQuestInfo)
  ...
  if true == ToClient_GetIsEnableSeasonUIMode() then
    local currentSeasonUIType = ToClient_GetCurrentSeasonUIType()
    if __eSeasonUIType_Summer == currentSeasonUIType then
      self._ui._staticText_Quest_Title:useGlowFont(true, "BaseFont_10_Glow", 4286302433)
    elseif __eSeasonUIType_Winter == currentSeasonUIType then
      self._ui._staticText_Quest_Title:useGlowFont(true, "BaseFont_10_Glow", 4287145957)
    elseif __eSeasonUIType_Spring == currentSeasonUIType then
      self._ui._staticText_Quest_Title:useGlowFont(true, "BaseFont_10_Glow", 4287735905)
    elseif __eSeasonUIType_MorningLand == currentSeasonUIType then
      self._ui._staticText_Quest_Title:useGlowFont(true, "BaseFont_10_Glow", 4293302882)
    else
  ...
  Panel_MainQuest:addInputEvent("Mouse_LUp", "HandleClicked_ShowMainQuestDetail( " .. questNo._group .. ", " .. questNo._quest .. ", " .. checkCondition .. ", \"" .. groupTitle .. "\", " .. questGroupCnt .. ", " .. isAccepted .. " )")
...
function mainQuestWidget:setConditionInfo(uiQuestInfo, startPosY)
  ...
  local effectAreaSizeY = _static_active:GetSizeY() - self._ui._static_TitleBG:GetSizeY() - 10
  self._ui._clearNpcEffect:SetSize(300, effectAreaSizeY)
  self._ui._clearNpcEffect2:SetSize(300, effectAreaSizeY)
  self._ui._stc_NoQuest:ComputePos()
...
function mainQuestWidget:SetTutorial(index)
  ...
  local isNaviShow = ToClient_WorldMapNaviEmpty()
  if isNaviShow == false then
    return
  end
  if self._tutorialShowLevelLimit < selfProxy:get():getLevel() then
    return
  end
  ...
  local clearNpcPos = self._ui._staticText_Quest_ClearNpc:GetPosY()
  self._ui._clearNpcEffect:ComputePos()
  self._ui._clearNpcEffect2:ComputePos()
  self._ui._mouseR:SetPosY(self._ui._clearNpcEffect:GetPosY() + 8)
...
function HandleClicked_MainQuest_FindWay(gruopNo, questNo, questCondition, isAuto, checkAcceptable, control)
  ...
  if false == ToClient_IsShowNaviGuideGroup(0) then
    self:tutorialSetText(PAGetString(Defines.StringSheet_GAME, "LUA_MAINQUEST_TUTORIALDESC_2"))
  end
end
...
function mainQuestWidget:mouseOverToMaindQuestWidget(isMouseOver, isAcceptedQuest)
  ...
  if true == isMouseOver then
    ...
    self._ui._checkButton_AutoNavi:SetShow(isMouseOn)
    self._ui._checkbox_Quest_Navi:SetShow(isMouseOn)
    if nil ~= PaGlobal_CheckedQuest_UpdateBackSpaceQuest then
      PaGlobal_CheckedQuest_UpdateBackSpaceQuest()
    end
...
function PaGlobalFunc_MainQuestWidget_ShowBackSpaceKeyGuid(isShow)
  if nil == Panel_MainQuest then
    return
  end
  ...
  mainQuestWidget._ui._static_BackSpace:SetShow(isShow)
end
function PaGlobalFunc_MainQuestWidget_CheckPosition()
  ...
  Rect2.left = Panel_MainQuest:GetPosX()
  Rect2.top = Panel_MainQuest:GetPosY()
  Rect2.right = Rect2.left + Panel_MainQuest:GetSizeX()
  Rect2.bottom = Rect2.top + Panel_MainQuest:GetSizeY()
  if Rect1.left < Rect2.right and Rect1.top < Rect2.bottom and Rect1.right > Rect2.left and Rect1.bottom > Rect2.top then
    Panel_MainQuest:SetPosY(Rect1.bottom + 5)
  end
end
function FromClient_MainQuestWidget_ResetPosition()
  local relativePosX = Panel_MainQuest:GetRelativePosX()
  local relativePosY = Panel_MainQuest:GetRelativePosY()
  local panelSizeX = Panel_MainQuest:GetSizeX()
  local panelSizeY = Panel_MainQuest:GetSizeY()
  ...
  elseif relativePosX == 0 and relativePosY == 0 then
    Panel_MainQuest:SetPosX(getScreenSizeX() - panelSizeX - 16)
    ...
    Panel_MainQuest:SetPosX(originalPosX)
    Panel_MainQuest:SetPosY(originalPosY)
  end
  if -1 < ToClient_GetUiInfo(CppEnums.PAGameUIType.PAGameUIPanel_MainQuest, 0, CppEnums.PanelSaveType.PanelSaveType_IsShow) then
    if 0 < ToClient_GetUiInfo(CppEnums.PAGameUIType.PAGameUIPanel_MainQuest, 0, CppEnums.PanelSaveType.PanelSaveType_IsShow) then
      Panel_MainQuest:SetShow(true)
...
function FromClient_MainQuestWidget_TutorialCheck(prevMode, currentMode)
  ...
  if self._ui._bubbleBg == nil then
    return
  end
  if self._ui._bubbleCtrlBg == nil then
    return
  end
  if self._ui._bubbleCtrlText == nil then
    return
  end
  if self._isTutorialAni == true then
    return
  end
  if self._isBlabla == true then
    return
  end
  if self._isQuestGuide == true then
    return
  end
  if self._ui._bubbleBg:GetShow() == false then
...
function FromClient_MainQuestWidget_QuestBackEndLoadComplete(s32_questNoRaw)
  if Panel_MainQuest == nil or _ContentsGroup_QuestBackEndLoading == false then
    return
  end
  if Panel_MainQuest:GetShow() == false then
    return
  end
  if mainQuestWidget:isExistLoadingDataAnyOne() == false then
    return
  end
  local updateFuncType
  for index = 1, #mainQuestWidget._questLoadingDataList do
    local value = mainQuestWidget._questLoadingDataList[index]
    if value ~= nil and value._questNoRaw == s32_questNoRaw then
      updateFuncType = value._updateFuncType
      table.remove(mainQuestWidget._questLoadingDataList, index)
      break
    end
  end
  if mainQuestWidget:isExistLoadingDataAnyOne() == false then
    ...
    if updateFuncType == mainQuestWidget.eUPDATE_FUNCTYPE.UPDATE then
      mainQuestWidget:update(questGroup, questId)
    elseif updateFuncType == mainQuestWidget.eUPDATE_FUNCTYPE.UPDATE_RENEW then
      mainQuestWidget:updateRenew(questGroup, questId)
    else
      return
    end
  end
...
function mainQuestWidget:registEventHandler()
  ...
  registerEvent("FromClient_DeleteNavigationGuide", "FromClient_CheckTutorial")
  if _ContentsGroup_QuestBackEndLoading == true then
    registerEvent("FromClient_QuestBackEndLoadComplete", "FromClient_MainQuestWidget_QuestBackEndLoadComplete")
  end
end
function FromClient_CheckTutorial()
...
function HandleEventLUp_MainQuestWidget_OptionButton()
...
function HandleEventOnOut_MainQuestWidget_ShowOptionTooltip(isShow)
  ...
  TooltipSimple_Show(mainQuestWidget._ui._btn_option, name, desc)
end
