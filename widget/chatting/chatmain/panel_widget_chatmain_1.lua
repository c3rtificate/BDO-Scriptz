...
function PaGlobal_ChatMain:registEventHandler()
  ...
  registerEvent("FromClient_ApplyUISettingPanelInfo", "Chatting_OnResize")
...
function PaGlobal_ChatMain:update(chatPanel, panelIndex, forceUpdate)
  if true == ToClient_isContentsOpenNewChatMain() then
    self:update_New(chatPanel, panelIndex, forceUpdate)
    chatPanel:setUpdated(false)
  else
    self:update_Old(chatPanel, panelIndex, forceUpdate)
  end
end
function PaGlobal_ChatMain:update_Old(chatPanel, panelIndex, forceUpdate)
  ...
  if false == chatPanel:isUpdated() and true ~= forceUpdate then
    return
  end
  if nil == getSelfPlayer() or nil == getSelfPlayer():get() then
    return
  end
  PaGlobal_ChatMain:checkJoinChannelChat()
  PaGlobal_ChatMain:tabUpdate(chatPanel, panelIndex)
  local result = PaGlobal_ChatMain:poolUpdate(chatPanel, panelIndex)
  if false == result then
    chatPanel:setUpdated(false)
    return
  end
  PaGlobal_ChatMain:scrollUpdate(chatPanel, panelIndex)
  chatPanel:setUpdated(false)
end
function PaGlobal_ChatMain:checkUpdate(chatPanel, panelIndex, forceUpdate)
  UI.ASSERT_NAME(nil ~= chatPanel, "PaGlobal_ChatMain:update chatPanel nil", "\235\176\149\234\183\156\235\130\152")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:update panelIndex nil", "\235\176\149\234\183\156\235\130\152")
  UI.ASSERT_NAME(nil ~= PaGlobal_ChatMain._mainPanelSelectPanelIndex, "\235\185\132\236\160\149\236\131\129\236\158\133\235\139\136\235\139\164.", "\235\176\149\234\183\156\235\130\152")
  if false == chatPanel:isUpdated() and true ~= forceUpdate then
    return false
  end
  if nil == getSelfPlayer() or nil == getSelfPlayer():get() then
  ...
  if true == chatPanel:isCombinedToMainPanel() and panelIndex ~= self._mainPanelSelectPanelIndex then
    return false
  end
  return true
end
function PaGlobal_ChatMain:update_New(chatPanel, panelIndex, forceUpdate)
  self:checkJoinChannelChat()
  self:tabUpdate(chatPanel, panelIndex)
  if self:checkUpdate(chatPanel, panelIndex, forceUpdate) == true then
    local result = self:poolUpdate(chatPanel, panelIndex)
    if false == result then
      return
    end
  else
  ...
  self:scrollUpdate(chatPanel, panelIndex)
end
function PaGlobal_ChatMain:checkJoinChannelChat()
  if false == isChatOpen then
    local myChannelChatRoomInfo = ToClient_getMyChannelChatRoom(__eChannelChatRoomType_System)
    if nil == myChannelChatRoomInfo then
      return
    end
    if 0 == myChannelChatRoomInfo._chatRoomNo then
      local isExistCacheData = ToClient_getGameUIManagerWrapper():hasLuaCacheDataList(__eChannelChat)
      if true == isExistCacheData then
...
function PaGlobal_ChatMain:tabUpdate(chatPanel, panelIndex)
  UI.ASSERT_NAME(nil ~= chatPanel, "PaGlobal_ChatMain:tabUpdate chatPanel\236\157\180 nil\236\157\180\235\169\180 \236\149\136 \235\144\169\235\139\136\235\139\164.", "\236\154\176\236\160\149\235\172\180")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:tabUpdate panelIndex\236\157\180 nil\236\157\180\235\169\180 \236\149\136 \235\144\169\235\139\136\235\139\164.", "\236\154\176\236\160\149\235\172\180")
...
function PaGlobal_ChatMain:poolUpdate(chatPanel, panelIndex)
  UI.ASSERT_NAME(nil ~= chatPanel, "PaGlobal_ChatMain:poolUpdate chatPanel\236\157\180 nil\236\157\180\235\169\180 \236\149\136 \235\144\169\235\139\136\235\139\164.", "\236\154\176\236\160\149\235\172\180")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:poolUpdate panelIndex\236\157\180 nil\236\157\180\235\169\180 \236\149\136 \235\144\169\235\139\136\235\139\164.", "\236\154\176\236\160\149\235\172\180")
  local isCombinedMainPanel = chatPanel:isCombinedToMainPanel()
  local drawPanelIndex = panelIndex
  if true == isCombinedMainPanel then
    drawPanelIndex = 0
  end
  local currentDrawPanel = PaGlobal_ChatMain:getPanel(drawPanelIndex)
  local poolCurrentUI = PaGlobal_ChatMain:getPool(drawPanelIndex)
  local bgAlpha = PaGlobal_ChatMain._transparency[panelIndex]
  local isShow = false
  if PaGlobal_ChatMain._isMouseOnChattingViewIndex ~= nil and PaGlobal_ChatMain._isMouseOnChattingViewIndex == drawPanelIndex then
    isShow = PaGlobal_ChatMain._isMouseOn
    if isShow then
    ...
    isShow = UI.checkIsInMouseAndEventPanel(currentDrawPanel)
  end
  if nil ~= currentDrawPanel then
    currentDrawPanel:SetColor(UI_color.C_00000000)
  end
  local currentPanel = PaGlobal_ChatMain:getPanel(panelIndex)
  if nil == currentPanel then
    return
  end
  if true == isCombinedMainPanel then
    if 0 ~= panelIndex then
      currentPanel:SetShow(false)
      currentPanel:SetIgnore(true)
    end
  else
    local isShowSetting = ToClient_GetUiInfo(CppEnums.PAGameUIType.PAGameUIPanel_ChattingWindow, panelIndex, CppEnums.PanelSaveType.PanelSaveType_IsShow)
    if chatPanel:isOpen() == true and PaGlobal_ChatMain:getPanel(0):GetShow() == true and isShowSetting ~= 0 then
      currentPanel:SetShow(true)
      currentPanel:SetIgnore(false)
    else
      currentPanel:SetShow(false)
      currentPanel:SetIgnore(true)
    end
  ...
  local isActivePanel = panelIndex == PaGlobal_ChatMain._mainPanelSelectPanelIndex
  if true == isCombinedMainPanel and false == isActivePanel then
    return false
  end
  if true == isChangeFontSize() then
    local fontType = chatPanel:getChatFontSizeType()
    ToClient_getFontWrapper("BaseFont_10_Chat"):changeFontSize(PaGlobal_ChatMain:convertChatFontTypeToFontSize(fontType))
  end
  PaGlobal_ChatMain:chattingPoolUpdate(poolCurrentUI, currentDrawPanel, panelIndex, drawPanelIndex, isShow, bgAlpha, false)
  return true
end
function PaGlobal_ChatMain:scrollUpdate(chatPanel, panelIndex)
  UI.ASSERT_NAME(nil ~= chatPanel, "PaGlobal_ChatMain:scrollUpdate\236\157\152 chatPanel\236\157\180 nil\236\157\180\235\169\180 \236\149\136 \235\144\169\235\139\136\235\139\164.", "\236\154\176\236\160\149\235\172\180")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:scrollUpdate\236\157\152 panelIndex\236\157\180 nil\236\157\180\235\169\180 \236\149\136 \235\144\169\235\139\136\235\139\164.", "\236\154\176\236\160\149\235\172\180")
  ...
  if true == PaGlobal_ChatMain._issmoothupMessage then
    if true == chatPanel:isCombinedToMainPanel() then
      ...
      for combinePanelIndex = 0, count - 1 do
        local checkPanel = ToClient_getChattingPanel(combinePanelIndex)
        if true == checkPanel:isCombinedToMainPanel() then
          addMessageCount = PaGlobal_ChatMain:getCheckAddMessageCount(checkPanel, combinePanelIndex)
...
function PaGlobal_ChatMain:addTabCheck(currentPanelIndex)
  if ToClient_getOpenChattingPanelCount() < __eChatPanelMaxCount then
    ...
    if nil == panel_addTab then
      UI.ASSERT_NAME(nil ~= panel_addTab, "PaGlobal_ChatMain:addTabCheck panel_addTab\236\157\180 nil\236\157\180\235\169\180 \236\149\136 \235\144\169\235\139\136\235\139\164.", "\236\154\176\236\160\149\235\172\180")
      return
    end
    ...
    if true == getEnableSimpleUI() then
      if true == PaGlobal_ChatMain._cacheSimpleUI then
  ...
  if isCombinedMainPanel then
    if isActivePanel then
      ...
      if true == _ContentsGroup_ChatOption_All then
        settingButton:addInputEvent("Mouse_LUp", "PaGlobalFunc_ChatOption_All_Open( " .. panelIndex .. ", " .. drawPanelIndex .. ", " .. tostring(isCombinedMainPanel) .. " )")
      else
...
function PaGlobal_ChatMain:chattingPoolUpdate(poolCurrentUI, currentPanel, panelIndex, drawPanelIndex, isShow, bgAlpha, isClear)
  ...
  panel_resizeButton:setClickMouseCursorType(__eMouseCursorType_ResizeLeft)
  panel_resizeButton:setOnMouseCursorType(__eMouseCursorType_ResizeLeft)
  ...
  panel_Scroll:addInputEvent("Mouse_UpScroll", "Chatting_ScrollEvent( " .. panelIndex .. ", true )")
  panel_Scroll:addInputEvent("Mouse_DownScroll", "Chatting_ScrollEvent( " .. panelIndex .. ", false )")
  ...
  panel_ScrollBtn:addInputEvent("Mouse_UpScroll", "Chatting_ScrollEvent( " .. panelIndex .. ", true )")
  panel_ScrollBtn:addInputEvent("Mouse_DownScroll", "Chatting_ScrollEvent( " .. panelIndex .. ", false )")
...
function PaGlobal_ChatMain:UpdateSmoothChattingContent(chattingUpTime)
  ...
  for panelIndex = 0, count - 1 do
    ...
    if chatPanel:isOpen() then
      ...
      elseif isCombinedMainPanel == true and chatPanel:isOpen() == true and PaGlobal_ChatMain:getPanel(0):GetShow() == true then
      ...
      if false == isCombinedMainPanel or true == isActivePanel then
        if false == isCombinedMainPanel then
          PaGlobal_ChatMain:getPool(panelIndex):chatClear()
        else
          PaGlobal_ChatMain:getPool(0):chatClear()
        end
...
function PaGlobal_ChatMain:UpdateSmoothScrollContent()
  ...
  for panelIndex = 0, count - 1 do
    ...
    if chatPanel:isOpen() then
      ...
      elseif isCombinedMainPanel == false and chatPanel:isOpen() == true and PaGlobal_ChatMain:getPanel(0):GetShow() == true then
        PaGlobal_ChatMain:getPanel(panelIndex):SetShow(true)
        PaGlobal_ChatMain:getPanel(panelIndex):SetIgnore(false)
      elseif false == isCombinedMainPanel and false == chatPanel:isOpen() then
        PaGlobal_ChatMain:getPanel(panelIndex):SetShow(false)
...
function PaGlobal_ChatMain:UpdateSmoothResetScrollContent(chattingScrollingTime)
  ...
  if false == PaGlobal_ChatMain._isResetsmoothscroll then
    ...
    for panelIndex = 0, count - 1 do
      local chatPanel = ToClient_getChattingPanel(panelIndex)
      PaGlobal_ChatMain:getPool(panelIndex):allClear()
      if chatPanel:isOpen() then
        PaGlobal_ChatMain:update(chatPanel, panelIndex, true)
      end
    end
  end
end
function PaGlobal_ChatMain:UpdateSmoothWheelScrollContent(wheelScrollingTime)
  ...
  if true == ToClient_isContentsOpenNewChatMain() then
    self:UpdateSmoothWheelScrollContent_New(wheelScrollingTime)
  else
    self:UpdateSmoothWheelScrollContent_Old(wheelScrollingTime)
  end
end
function PaGlobal_ChatMain:UpdateSmoothWheelScrollContent_Old(wheelScrollingTime)
  FromClient_ChatUpdate(true, nil, true)
  local count = ToClient_getChattingPanelCount()
  for panelIndex = 0, count - 1 do
    local chatPanel = ToClient_getChattingPanel(panelIndex)
    if chatPanel:isOpen() then
...
function PaGlobal_ChatMain:UpdateSmoothWheelScrollContent_New(wheelScrollingTime)
  _PA_ASSERT(nil ~= self._scrollIndex, "\235\185\132\236\160\149\236\131\129\236\158\133\235\139\136\235\139\164.")
  if true ~= self._issmoothWheelscroll then
    return
  end
  local drawIndex = self._scrollIndex
  local panelIndex = drawIndex
  if 0 == drawIndex then
    panelIndex = PaGlobal_ChatMain._mainPanelSelectPanelIndex
  end
  local chatPanel = ToClient_getChattingPanel(panelIndex)
  if false == chatPanel:isOpen() then
    return
  end
  self:getPool(drawIndex):chatClear()
  local poolScrollUI = self:getPool(drawIndex)
  if self._isUpDown then
    poolScrollUI._list_Scroll[0]:SetControlPos(poolScrollUI._list_Scroll[0]:GetControlPos() - 1 / (self._MAX_HISTORYCOUNT - 1) * self:getScrollSpeed(wheelScrollingTime))
  else
    poolScrollUI._list_Scroll[0]:SetControlPos(poolScrollUI._list_Scroll[0]:GetControlPos() + 1 / (self._MAX_HISTORYCOUNT - 1) * self:getScrollSpeed(wheelScrollingTime))
  end
  ...
  local index = math.floor((1 - poolScrollUI._list_Scroll[0]:GetControlPos()) * (self._MAX_HISTORYCOUNT - 1))
  if 0 == index then
    self._deltascrollPosy[panelIndex] = (1 - poolScrollUI._list_Scroll[0]:GetControlPos()) * (self._MAX_HISTORYCOUNT - 1) % 1
  else
    self._deltascrollPosy[panelIndex] = ((1 - poolScrollUI._list_Scroll[0]:GetControlPos()) * (self._MAX_HISTORYCOUNT - 1) - index) % 1
  end
  self._preScrollControlPos[panelIndex] = poolScrollUI._list_Scroll[0]:GetControlPos()
  self._srollPosition[panelIndex] = index
  self._scroll_BTNPos[panelIndex] = poolScrollUI._list_Scroll[0]:GetControlPos()
  self:updateChatMessage(chatPanel, panelIndex, drawIndex, 0)
end
function PaGlobal_ChatMain:updatePanel(panelIndex, isForce)
  local chatPanel = ToClient_getChattingPanel(panelIndex)
  if false == chatPanel:isOpen() then
    return
  end
  local drawIndex = panelIndex
  if true == chatPanel:isCombinedToMainPanel() then
    drawIndex = 0
  end
  self._tabButton_PosX = 0
  self:getPool(drawIndex):allClear()
  self:update(chatPanel, panelIndex, isForce)
end
function PaGlobal_ChatMain:convertChatFontTypeToFontSize(chattingFontType)
  local fontSize = 14
...
function PaGlobal_Chat_UpdatTopClipingPanel(panelIndex, addClipSizeY)
  ...
  chatUI._list_ResizeButton[0]:SetPosY(chatUI._list_PanelBG[0]:GetPosY() + addClipSizeY)
end
