...
function Chatnew_CreateChattingContent(chattingMessage, poolCurrentUI, PosY, messageIndex, panelIndex, deltascrollPosy, cacheSimpleUI, chattingUpTime)
  ...
  local LinkedPartyStart = 1000000
  local LinkedPartyEnd = -1
  if true == isLinkedPartyRecruit then
    LinkedPartyStart = chattingMessage:getLinkedPartyRecruitStartIndex()
    LinkedPartyEnd = chattingMessage:getLinkedPartyRecruitEndIndex()
    checkFinishItemWebSite = true
  end
  local j = 1
  local isWhile = false
  ...
  if 0 ~= emoticonCount then
    ...
    while emoticonCount >= emoNum do
      ...
      elseif false == isChattingAt and false == isLinkedItem and false == isLinkedGuild and false == isLinkedWebSite and false == isLinkedMentalCard and false == isLinkedPartyRecruit then
        ...
        elseif true == isLinkedPartyRecruit then
          if true == isChattingAt and chattingatCount >= chattingatNum then
            if LinkedPartyStart < chattingMessage:getChattingAtStartIndex(chattingatNum - 1) and true == checkFinishItemWebSite then
              checkitemwebat = 6
            else
              atStart = chattingMessage:getChattingAtStartIndex(chattingatNum - 1)
              atend = chattingMessage:getChattingAtEndIndex(chattingatNum - 1)
          ...
          if 6 == checkitemwebat then
            if LinkedPartyStart >= drawstart and LinkedPartyEnd <= drawend then
        ...
        elseif true == isChattingAt and chattingatCount >= chattingatNum then
          atStart = chattingMessage:getChattingAtStartIndex(chattingatNum - 1)
          atEnd = chattingMessage:getChattingAtEndIndex(chattingatNum - 1)
    ...
    chatting_contents, contentindex = CreateContentWithMsgLength(reciver, poolCurrentUI, chatType, chattingMessage, isChattingAt, isLinkedItem, isLinkedGuild, isLinkedWebSite, isLinkedMentalCard, contentindex, chatting_contents, chatting_Icon, chatting_sender, msg, msgColor, msgstartindex, panelSizeX, chattingatNum, chattingatCount, checkFinishItemWebSite, messageIndex, itemGradeColor, isLinkedPartyRecruit)
    ...
    chatting_contents, contentindex = CreateContentWithMsgLength(reciver, poolCurrentUI, chatType, chattingMessage, isChattingAt, isLinkedItem, isLinkedGuild, isLinkedWebSite, isLinkedMentalCard, contentindex, chatting_contents, chatting_Icon, chatting_sender, msg, msgColor, msgstartindex, panelSizeX, chattingatNum, chattingatCount, true, messageIndex, itemGradeColor, isLinkedPartyRecruit)
    for index = contentindex - 1, 1, -1 do
...
function CreateContentWithMsgLength(reciver, poolCurrentUI, chatType, chattingMessage, isChattingAt, isLinkedItem, isLinkedGuild, isLinkedWebSite, isLinkedMentalCard, contentindex, chatting_contents, chatting_Icon, chatting_sender, msg, msgColor, msgstartindex, panelSizeX, chattingatNum, chattingatCount, isFinishItemWebSite, messageIndex, itemGradeColor, isLinkedPartyRecruit)
  local checkFinishItemWebSite = false
  local atStart = 1000000
  local atEnd = -1
  local isChattingAt = false
  ...
  while msgstartindex < string.len(msg) do
    if false == isChattingAt and false == isLinkedItem and false == isLinkedGuild and false == isLinkedWebSite and false == isLinkedMentalCard and false == isLinkedPartyRecruit then
      ...
      elseif true == isLinkedPartyRecruit then
        if isChattingAt and chattingatCount >= chattingatNum then
          if LinkedPartyStart < chattingMessage:getChattingAtStartIndex(chattingatNum - 1) and checkFinishItemWebSite then
            checkitemwebat = 6
          else
            atStart = chattingMessage:getChattingAtStartIndex(chattingatNum - 1)
            atEnd = chattingMessage:getChattingAtEndIndex(chattingatNum - 1)
