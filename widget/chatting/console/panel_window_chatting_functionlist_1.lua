function PaGlobal_Chatting_FunctionList:initialize()
  ...
  PaGlobal_Chatting_FunctionList._chatFunc = {
    ...
    [PaGlobal_Chatting_FunctionList._CHAT_FUNCTYPE.CHATREPORT] = {
      _title = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_CHATSUBMENU_REPORTCHAT"),
      _excuteFunc = PaGlobal_Chatting_FunctionList_ReportChat_Open,
      _isShow = true,
      _getSenderFunc = PaGlobalFunc_ChattingHistory_GetSelectedSender,
      _checkGameManager = true
    }
  }
...
function PaGlobal_Chatting_FunctionList:prepareOpen()
  ...
  if nil ~= familyName and "" ~= familyName and nil ~= characterName and "" ~= characterName then
    ...
    PaGlobal_Chatting_FunctionList._ui.txt_famillyName:SetPosY(13)
    PaGlobal_Chatting_FunctionList._ui.txt_characterName:SetPosY(43)
  else
    ...
    PaGlobal_Chatting_FunctionList._ui.txt_famillyName:SetPosY(30)
  end
...
function PaGlobalFunc_ChattingInfo_PushFunction(content, key)
  ...
  content:registerPadEvent(__eConsoleUIPadEvent_Up_Y, "PaGlobal_Chatting_FunctionList_ExcuteChattingFunc(" .. index .. ")")
end
function PaGlobal_Chatting_FunctionList:initChattingFuncList()
  ...
  for ii = 1, #PaGlobal_Chatting_FunctionList._chatFunc do
    ...
    if PaGlobal_Chatting_FunctionList._chatFunc[ii]._checkGameManager ~= nil and PaGlobal_Chatting_FunctionList._chatFunc[ii]._checkGameManager == true and PaGlobalFunc_ChattingHistory_GetSelectedSenderIsGameManager() == true then
      isShow = false
    end
    if true == isShow then
