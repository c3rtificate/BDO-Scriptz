...
function preLoadGameUI_PC()
  ...
  loadUI("UI_Data/Window/AbyssOne/Panel_Menu_AbyssOne.XML", "Panel_Menu_AbyssOne", UIGroup.PAGameUIGroup_Windows, SETRENDERMODE_BITSET_ALLRENDER())
  ...
  basicLoadUI("UI_Data/Widget/AbyssOne/UI_KeyGuide_AbyssOne_4017.XML", "Panel_AbyssOne_4017_KeyGuide", UIGroup.PAGameUIGroup_Widget)
...
function loadGameUI_PC()
  ...
  runLua("UI_Data/Script/AbyssOne/Region/Panel_AbyssOne_KeyGuide_4017.lua")
