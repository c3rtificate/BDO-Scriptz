...
function CloseManager_RegisterExeptionList()
  PaGlobal_panelExceptionList = {
    ...
    Panel_Global_Manual,
    Panel_Fishing,
    Panel_Widget_Fishing_All,
    Panel_MiniGame_IceFishing_All,
    Panel_MyHouseNavi,
    Panel_Endurance,
    Panel_SniperGame,
    ...
    Panel_SkillCoolTimeQuickSlot_10,
    Panel_SkillCoolTimeQuickSlot_11,
    Panel_SkillCoolTimeQuickSlot_12,
    Panel_SkillCoolTimeQuickSlot_13,
    Panel_SkillCoolTimeQuickSlot_14,
    Panel_SkillCoolTimeQuickSlot_15,
    Panel_SkillCoolTimeQuickSlot_16,
    Panel_SkillCoolTimeQuickSlot_17,
    Panel_SkillCoolTimeQuickSlot_18,
    Panel_SkillCoolTimeQuickSlot_19,
    Panel_ArshaSkillCooltime,
    Panel_HouseName,
    ...
    Panel_House_InstallationMode_List_All,
    Panel_House_InstallationMode_All,
    Panel_House_InstallationMode_ObjectControl_All,
    Panel_House_InstallationMode_SeedList_All,
    Panel_House_InstallationMode_WarInfomation_All,
    Panel_House_InstallationMode_War_All,
    Panel_House_Name_All,
    ...
    Panel_MiniGame_PowerControl_All,
    Panel_RhythmGame,
    Panel_RhythmGame_Drum,
    Panel_SinGauge,
    Panel_MiniGame_SinGauge_All,
    Panel_Command,
    Panel_MiniGame_Command_All,
    Panel_MiniGame_Gradient_Y,
    Panel_FillGauge,
    Panel_MiniGame_Steal,
    Panel_MiniGame_Jaksal,
    Panel_MiniGame_Jaksal_All,
    Panel_MiniGame_GalleyPaddle_All,
    Panel_SteeringWheel,
    Panel_Hammer_New,
    Panel_SkillCommand,
    Panel_SkillCommand_Cutscene,
    Panel_Combo_Guide,
    Panel_ComboCommand,
    Panel_ConsoleCombo,
    Panel_Dialog_Search,
    Panel_Widget_Dialog_Search_All,
    ...
    UI_Character_InterActionGathering_All,
    Panel_WatchingMode,
    Panel_TutorialMenu,
    ...
    Panel_RescueShip,
    Panel_SummonGamos,
    Panel_Widget_SummonZod,
    Panel_Widget_SummonBelmorn,
    Panel_TamingBubble,
    Panel_FirstLogin,
    ...
    Panel_Equipment_SetEffect_Tooltip,
    ...
    Panel_Twitch,
    Panel_Widget_KillLog,
    Panel_BuyDrink,
    Panel_BonusEnchant,
    Panel_LinkedHorse_Skill,
    Panel_Window_LinkedSkill_All,
    ...
    Panel_Guild_Warfare,
    Panel_Guild_Skill,
    Panel_Window_GuildJoinRequestList,
    Panel_Guild_JoinRequestSet,
    Panel_Guild_ApplyJoinList,
    ...
    Panel_Window_Extraction_All,
    Panel_Window_Extraction_Crystal,
    Panel_Window_Extraction_Crystal_All,
    Panel_Window_Extraction_EnchantStone,
    Panel_Window_Extraction_Cloth,
    Panel_Window_Extraction_Artifacts_All,
    ...
    Panel_Friend_TalkMessanger_All,
    Panel_Widget_Friends_Floating,
    Panel_Widget_Friends_FloatingAlert,
    ...
    Panel_UI_Setting,
    Panel_Window_UIModify_All,
    Panel_modifyPool,
    Panel_Window_SavePreset_All,
    ...
    Panel_Tooltip_Skill_forLinkTooltip,
    Panel_Tooltip_Skill_Servant,
    Panel_Tooltip_SkillGroup,
    Panel_Tooltip_SkillGroup_forLearning,
    Panel_Tooltip_SkillGroup_forBlackSpirit,
    Panel_Tooltip_SkillGroup_forLinkTooltip,
    Panel_Tooltip_Skill_NextLevel_All,
    Panel_Tooltip_Guild_Introduce,
    Panel_Tooltip_Work,
    Panel_ExitConfirm_Old,
    Panel_Window_TrayConfirm_All,
    ...
    Panel_Worldmap_GuildHouseManagement,
    ...
    Panel_Equipment_Crystal_Tooltip,
    Panel_Equipment_Artifacts_Tooltip,
    ...
    Panel_Window_Barter_Search_Special,
    Panel_Window_Barter_Refresh,
    ...
    Panel_Window_BloodAltar_Retry_All,
    Panel_Widget_BloodAltar_RandomMatch,
    Panel_Window_WorkerRandomSelectOption_All,
    Panel_Window_WorkerRandomSelectOption_Grade_All,
    Panel_Npc_Dialog_All,
    Panel_Npc_Intimacy_All,
    Panel_Interest_Knowledge_All,
    Panel_Dialog_List_All,
    Panel_Dialog_Quest_All,
    Panel_Dialog_WidgetList_All,
    Panel_Dialog_Exchange_All,
    Panel_Dialog_PetLeader_All,
    Panel_Dialog_PetLeader_List_All,
    Panel_Dialog_Simple_All,
    Panel_Dialog_SimpleDesc_All,
    Panel_Window_Extraction_EnchantStone_All,
    Panel_Widget_OceanCurrent,
    Panel_Widget_OceanWind,
    Panel_Widget_ShipSpeedGauge,
    Panel_Widget_GalleyBoost,
    Panel_Widget_GalleyMember,
    Panel_Window_Extraction_Costume_All,
    Panel_MentalGameLeft_All,
    Panel_MentalGameRight_All,
    Panel_MentalGameSelect_All,
    Panel_MentalGameTooltip_All,
    Panel_Dialog_Trade_Tooltip_All,
    Panel_Dialog_Trade_MyBasket_All,
    Panel_Dialog_Trade_MarketItemList_All,
    Panel_Dialog_Trade_NoLink_All,
    Panel_Dialog_Trade_BiddingGame_All,
    Panel_Masterpiece_Auction_Bid_All,
    Panel_Masterpiece_Auction_All,
    Panel_Dialog_ServantList_All,
    Panel_Dialog_ServantInfo_All,
    Panel_Dialog_ServantLookChange_All,
    Panel_Dialog_ServantRegist_All,
    Panel_Dialog_ServantTransferList_All,
    Panel_Dialog_ServantSwiftResult_All,
    Panel_Window_CargoLoading_ALL,
    Panel_Dialog_ServantOnlyList_All,
    Panel_Dialog_ServantFantasySkin,
    Panel_Widget_Servant_FantasySkin_Complete_All,
    Panel_Window_DeadMessage_All,
    Panel_Cash_Revival_BuyItem_All,
    Panel_Window_PossibleEnchant_All,
    Panel_Widget_GreatSeaEvent,
    Panel_Widget_GreatSeaEvent_ProgressBar,
    Panel_Dialog_Repair_Function_All,
    Panel_Widget_EmployeeHireItem_All,
    Panel_Widget_FairyIcon_Renew,
    Panel_Widget_FairyAutoUseBuffItemIcon_Renew,
    Panel_Window_Banner,
    Panel_Window_ServantUpgradeInfo,
    Panel_Window_GuildWareHouseHistory,
    Panel_Window_WareHouseHistory,
    Panel_Window_GuildBossSpawn,
    Panel_Window_SkillGroup,
    Panel_Window_SkillGroup_Controller,
    Panel_Window_SkillGroup_QuickSlot,
    Panel_Widget_ShipCannon_Left,
    Panel_Widget_ShipCannon_Right,
    Panel_Widget_SeafaringResearch,
    Panel_Window_Warehouse,
    Panel_Window_TotalSearch,
    Panel_Window_ExplorePoint_UsingInfo,
    Panel_Widget_SailControl,
    Panel_Window_EnchantStackConfirm_All,
    Panel_Window_OTPConfirm_All,
    Panel_Window_SimpleInventory,
    Panel_Window_SimpleInventory_SearchResult,
    Panel_Widget_Voice,
    Panel_Minigame_Gradient_All,
    Panel_Minigame_GradientY_All,
    Panel_MiniGame_Timing_All,
    Panel_MiniGame_Horse_Trained_All,
    Panel_MiniGame_Rhythm_All,
    Panel_MiniGame_Rhythm_Drum_All,
    Panel_MiniGame_Find_All,
    Panel_PersonalMonsterInfo_All,
    Panel_PersonalMonsterMessage_All,
    Panel_FriendList_Add_All,
    Panel_Friend_RequestList_All,
    Panel_Friend_GroupRename_All,
    Panel_FriendList_All,
    Panel_Widget_SummonIcon_Renew,
    Panel_Widget_MaidIcon_Renew,
    Panel_Widget_Party_All,
    Panel_Widget_Raid_All,
    Panel_Window_TotalRewardHistory_All,
    ...
    Panel_CharacterInfoFamilySkill_All,
    Panel_CharacterInfoCashBuff_All,
    Panel_Change_Nickname_All,
    Panel_Widget_FarmingTimer_All,
    Panel_Widget_PlayMusic_All,
    Panel_Widget_GuardianEffect,
    Panel_Widget_PetControl_All,
    Panel_GuildInfo_All,
    Panel_GuildWarfare_All,
    Panel_GuildWarfareNew_All,
    Panel_Guild_History_All,
    Panel_Guild_BossSummon_All,
    Panel_GuildQuest_All,
    Panel_Guild_Manufacture_All,
    Panel_GuildAlliance_All,
    Panel_GuildAllianceList_All,
    Panel_GuildSkill_All,
    Panel_GuildMemeberList_All,
    Panel_GuildAllianceInvite_All,
    Panel_GuildJoinRequestList_All,
    Panel_GuildMatch_All,
    Panel_Window_GuildMatchScore_All,
    Panel_Widget_GuildMatch_Countdown,
    Panel_GuildVolunteerList_All,
    Panel_GuildFunctionPanel_All,
    Panel_GuildChangeMark_All,
    Panel_Widget_AgrisGauge,
    Panel_Widget_AgrisGaugeTooltip,
    Panel_MiniGame_SniperReload_All,
    Panel_MiniGame_SniperGame_All,
    Panel_MiniGame_SniperGame_Result_All,
    Panel_MacroCheckQuiz_All,
    Panel_MacroCheckQuizPad_All,
    Panel_Widget_Dye_All,
    Panel_Window_BlackspiritPass,
    Panel_Window_BlackspiritPassTooltip,
    Panel_Widget_Tooltip_BlackSpiritPass_Quest,
    Panel_Widget_Tooltip_Item_All,
    Panel_Widget_Tooltip_Item_Equip_All,
    Panel_Widget_GuildServantIcon_Renew,
    Panel_Widget_ThornCastle_Member,
    Panel_Widget_ThornCastle_Nak_Sub_Boss,
    Panel_Widget_ThornCastle_Nak_Sub_Enemy,
    Panel_Widget_ThornCastle_Nak_Sub_Friendly,
    Panel_Widget_ThornCastle_Nak_Point,
    Panel_Widget_ThornCastle_Nak_Main,
    Panel_Widget_ThornCastle_ScorePanel,
    Panel_Widget_ThornCastle_DeadMessage,
    Panel_Widget_ThornCastle_Reward_Win,
    Panel_Widget_ThornCastle_Reward_Lose,
    Panel_Widget_ThornCastle_Enter,
    Panel_Widget_ThornCastle_Matching,
    Panel_Widget_ThornCastle_Map,
    Panel_Widget_Arsha_Hud_All,
    Panel_Widget_Arsha_Party_All,
    Panel_Window_ArshaSelectMember_All,
    Panel_Window_PowerSave_All,
    Panel_Arena_Battle,
    Panel_Window_Equip_CharacterTag_ItemCopy,
    Panel_Window_DescBox_ItemCopy,
    Panel_HorseRacing_Gear,
    Panel_Window_UIModify_All_Console,
    Panel_HorseRacing_Time,
    Panel_HorseRacing_CountDown,
    Panel_HorceRacing_CheckPoint,
    Panel_HorceRacing_WaitingNak,
    Panel_HorceRacing_StartNak,
    Panel_HorseRacing_Score,
    Panel_HorseRacing_Match_All,
    Panel_HorseRacing_Match_Confirm,
    Panel_Window_FamilyInventory_All,
    Panel_Window_TimerCount,
    Panel_Widget_HopeGaugeOnOff,
    Panel_HorseRacing_KeyGuide,
    Panel_HorseRacing_HelpIcon,
    Panel_HorseRacing_Waiting2,
    Panel_HorseRacing_WaitingCheck,
    Panel_Widget_AttackWayCorrection_KeyGuide,
    Panel_Worldmap_MainCitadelSelect,
    Panel_Widget_CrewMatch_ScoreTab,
    Panel_Widget_CrewMatch_Count,
    Panel_CharacterActionStatus,
    Panel_SiegeWar_CastleInfo,
    Panel_Window_ProductionModify_All,
    Panel_Window_ProductionTimeline_All,
    Panel_Window_ProductionCamera_All,
    Panel_Window_ProductionRecord_All,
    Panel_Window_ReplayLoadList_All,
    Panel_Widget_NewTutorial_Key,
    Panel_Widget_NewTutorial_Quest,
    Panel_Widget_NewTutorial_SkillGuide,
    Panel_GuildItemShare_Message,
    Panel_NakMessage_Life,
    Panel_SiegeWar_AngerGage,
    Panel_Window_CutSceneSkip,
    Panel_Window_CutSceneScript,
    Panel_Window_SelectBox,
    Panel_Window_MessageBox_ForReward,
    Panel_Window_ItemMoveSet,
    Panel_RentInstanceField_List,
    Panel_RentInstanceField_Option,
    Panel_RentInstanceField_Time,
    Panel_Window_FairyRateDesc,
    Panel_Worldmap_NodeTooltip_VillageWar_All,
    Panel_Widget_MiniGame_Tooltip_MyDeck,
    Panel_Widget_MiniGame_Tooltip,
    Panel_Widget_Tutorial_GuideUI,
    Panel_Window_MessageBox_Tutorial,
    Panel_Window_Production_Main,
    Panel_Atoraxion_WeaponChange,
    Panel_Atoraxion_NakClear,
    Panel_Atoraxion_RegionChange,
    Panel_ItemMarket_Alarm_All,
    Panel_GuildInvite_Alert,
    Panel_Window_MessageBoxElvia_All,
    Panel_Widget_TownSimpleNavi_All,
    Panel_CreateRandomFaceBoneForDEV,
    Panel_Widget_StaminaAutoRun,
    Panel_Widget_GuildWarAlert_All,
    Worldmap_Grand_Guildwar_ColorList,
    Panel_House_InstallationMode_KeyGuide_All,
    Panel_ActionMessage_New,
    Panel_Widget_FunctionButton_Console,
    Panel_Tooltip_Author,
    Panel_Widget_CameraMode_All,
    Panel_Actor_DummyCharacter_CC,
    Panel_LocalWar_OccupationGauge,
    Panel_LocalWar_CurrentOccupationGauge,
    Panel_ImageSlider_All,
    Panel_NakMessage_Erether_All,
    Panel_NakMessage_Sequence,
    Panel_Widget_NakMessageChoice_All,
    Panel_Widget_Awakening_Succession_Select_All,
    Panel_Popup_Solare_MatchConfirm,
    Panel_Widget_Solare_Hud,
    Panel_Widget_Solare_PlayerStatus,
    Panel_Window_Solrare_RoundNotice,
    Panel_Window_Solare_Finding_Match,
    Panel_Widget_Solare_Countdown,
    Panel_Solrare_EquipPresetBlockBg,
    Panel_Popup_Solare_CrystalConfirm_All,
    Panel_Widget_Solare_WaitOther,
    Panel_Popup_Solare_BuyEquipment_All,
    Panel_Widget_Solare_TierUpgrade,
    Panel_Event_TicketShop_Nak,
    Panel_Widget_Ping_All,
    Panel_Window_Inventory_AutoSortFunction,
    Panel_HorseSubMp_All,
    Panel_VoiceChat_Talker_New,
    Panel_Widget_QuestAlert,
    Panel_Window_StartBranch,
    Panel_Widget_GotoShop_Banner,
    Panel_SequenceTutorial_Quest,
    Panel_Widget_PersonalField_Mini,
    Panel_Window_PersonalField_Main,
    Panel_Widget_PersonalField_Enter,
    Panel_IngameCashSHop_ReturnBack,
    Panel_SimpleBuildMode,
    Panel_PhotoMode_Main,
    Panel_PhotoMode_KeyFunction,
    Panel_PhotoMode_CenterFunction,
    Panel_PhotoMode_Preset,
    Panel_Sequence_HpMpBar,
    Panel_Sequence_Adrenallin,
    Panel_Sequence_Stamina,
    Panel_Window_QuickTimeEvent_CircleKeyDown,
    Panel_Widget_RadioPlayer,
    Panel_Widget_RadioPlayer_Mini,
    Panel_Widget_RadioPlayer_ChannelName,
    Panel_ContentsTutorial_All,
    Panel_LocalWarIntro_PapuCrio,
    Panel_Event_Termian_Welcom_All,
    Panel_Actor_SolareBuffStateUI,
    Panel_Stamina_Auto,
    Panel_Dialog_HorseWithoutOwner_All,
    Panel_ImperialSupply_Horse_Confirm,
    Panel_Popup_AbyssOne_BuyEquipment_All,
    Panel_AbyssOne_EquipPresetList,
    Panel_AbyssOne_EquipPresetBlockBg,
    Panel_AbyssOne_Enter,
    Panel_Window_AbyssOneInfo,
    Panel_AbyssOne_Nak,
    Panel_AbyssOne_Resurrection,
    Panel_AbyssOne_EnterSceneEffect,
    Panel_Menu_AbyssOne,
    Panel_Widget_HadumField_Enter,
    Panel_Widget_MainQuest_AbyssOne,
    NakMessage_Warehouse_Clear,
    Panel_Widget_Nak_AbyssOneSkill,
    Panel_AbyssOne_Help,
    Panel_AbyssOne_4017_KeyGuide,
    Panel_AbyssOne_FirstClearMessage,
    Panel_Window_AtoraxionInfo,
    Panel_SequenceMain,
    Panel_Sequence_SubTitle,
    Panel_SequenceNotifier,
    Panel_Sequence_LetterBox,
    Panel_Sequence_TitleTexture,
    Panel_Sequence_KeyGuide,
    Panel_Sequence_SkillCommandGuide,
    Panel_Widget_BossLooting,
    Panel_Widget_GuildBossField_Enter,
    Panel_Window_JewelPreset_Inven_All,
    Panel_Window_JewelPreset_All,
    Panel_Window_Guide_All,
    Panel_Knowledge_ViewHistory,
    Panel_Window_BeginnerRoadmap,
    Panel_SceneEdit_Radar,
    Panel_Window_JewelPreset_Tooltip_All,
    Panel_Window_Bromide_All,
    Panel_SequenceSkip,
    Panel_SequenceSkipPopUp,
    Panel_SequenceSkipEscPopUp,
    Panel_Sequence_DeadMessage,
    Panel_Sequence_R_SkipMessageBox,
    Panel_Sequence_SkillTutorial,
    Panel_MiniGame_MorningSlaughter_All,
    Panel_MiniGame_MorningSyringe_All,
    Panel_MiniGame_MorningLeather_All,
    Panel_MiniGame_MorningMining_All,
    Panel_MiniGame_MorningLogging_All,
    Panel_MiniGame_MorningHomi_All,
    Panel_TimeLog_All,
    Panel_MorningLand_ConquestGiveUp,
    Panel_Addiction_Prevention_All,
    Panel_MorningLand_QuestBoardAlert_All,
    Panel_MorningLandSuccessMsg_All,
    Panel_JobInfo,
    Panel_ElfWar_Command,
    Panel_ElfWar_MissionWidget,
    Panel_ElfWar_MissionAccept,
    Panel_ElfWar_Region,
    Panel_ElfWar_EditParty_Drag,
    Panel_ElfWar_TeamSkill,
    Panel_ElfWar_TeamBuff,
    Panel_ElfWar_ScoreBoardWidget,
    Panel_Window_MessageBox_Edit_All,
    Panel_Window_MonsterBuffZone,
    Panel_Widget_PartyEnchant_Member1_All,
    Panel_Widget_PartyEnchant_Member2_All,
    Panel_Widget_PartyEnchant_Member3_All,
    Panel_Widget_PartyEnchant_Member4_All,
    Panel_Widget_PartyEnchant_BubbleText_All,
    Panel_Window_CrogdaloStable,
    Panel_Widget_KeyboardGuide,
    Panel_Window_DropItem_ImageTooltip_All,
    Panel_Widget_RabbitLiverScrambleTimer,
    Panel_Widget_LifeRingMenu_All,
    Panel_ElfWar_DeadMessage,
    Panel_ElfWar_Nak_WarLog,
    Panel_ElfWar_Nak_WarLog_L,
    Panel_ElfWar_Nak_Teleport,
    Panel_Season_Graduation_MSG,
    Panel_Widget_OnOffShip,
    Panel_Window_DamageConsoleView,
    Panel_NakMessage_KillCombo,
    Panel_Window_MagnusEasyTeleport_Effect,
    Panel_Widget_Nak_AccessoryStepUp_All,
    Panel_Loading,
    Panel_WareHouseFunctionPanel_All,
    Panel_Widget_QuestRewardItem,
    Panel_Widget_VillageSiegeState_All,
